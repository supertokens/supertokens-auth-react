...
export default [
    ...
    // `file` and `format` for each target)
    {
        input: {
            ...
            emailverificationPreBuiltUIRoutes: "lib/ts/recipe/emailverification/preBuiltUI.tsx",
            emailpassword: "lib/ts/recipe/emailpassword/index.ts",
            emailpasswordPreBuiltUIRoutes: "lib/ts/recipe/emailpassword/preBuiltUI.tsx",
            passwordless: "lib/ts/recipe/passwordless/index.ts",
            passwordlessPreBuiltUIRoutes: "lib/ts/recipe/passwordless/preBuiltUI.tsx",
            thirdparty: "lib/ts/recipe/thirdparty/index.ts",
            thirdpartyPreBuiltUIRoutes: "lib/ts/recipe/thirdparty/preBuiltUI.tsx",
            thirdpartyemailpassword: "lib/ts/recipe/thirdpartyemailpassword/index.ts",
            thirdpartyemailpasswordPreBuiltUIRoutes: "lib/ts/recipe/thirdpartyemailpassword/preBuiltUI.tsx",
            thirdpartypasswordless: "lib/ts/recipe/thirdpartypasswordless/index.ts",
            thirdpartypasswordlessPreBuiltUIRoutes: "lib/ts/recipe/thirdpartypasswordless/preBuiltUI.tsx",
