...
import {SignInAndUp, SignInAndUpTheme} from 'supertokens-auth-react/recipe/emailpassword';
  ...
  return (
    ...
    <nav className="menu__body">
      <ul className="menu__list">
        ...
        <li key="custom"><a className="menu__link" style={{ textDecoration: 'none' }} href="/custom-supertokens-login?disableDefault=1">Blue style</a></li>
        <li key="custom"><a className="menu__link" style={{ textDecoration: 'none' }} href="/custom-props">Custom login with props methods</a></li>
        <li key="custom"><a className="menu__link" style={{ textDecoration: 'none' }} href="/custom-theme">Custom theme</a></li>
        <li key="custom"><a className="menu__link" style={{ textDecoration: 'none' }} href="/session-exist">Session already exist.</a></li>
      </ul>
    </nav>
  </div>
  )
