...
import { CREATE_CODE_API, SOMETHING_WENT_WRONG_ERROR, TEST_APPLICATION_SERVER_BASE_URL } from "../constants";
...
describe("SuperTokens SignIn w/ MFA", function () {
    ...
    describe("chooser screen", () => {
        ...
        // TODO: for some reason this doesn't hit the error boundary
        it.skip("should show throw if the only next option is an unknown factor id", async () => {
            await setMFAInfo({
            ...
            function getOTPTests(contactMethod, factorId) {
                ...
                it("should enable you to change the contact info during setup", async () => {
                    ...
                    const changeContact = await waitForSTElement(
                        page,
                        "[data-supertokens~=secondaryLinkWithLeftArrow]:nth-child(1)"
                    );
