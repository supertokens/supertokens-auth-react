...
/**
 *
 * This affects social login sign ups only
 *
 ...
 *
 * After copying the contents, we modify the API logic to disallow session creation if this is sign up. To see the custom logic, search for "CUSTOM LOGIC BELOW"
 */
...
async function signInUpPOST(input) {
    ...
    ///////// CUSTOM LOGIC BELOW ////////////////
    // We create a new session only if this is sign in
