...
function getOTPBody(appName, codeLifetime, userInputCode) {
    return `
        <tr>
...
function getURLLinkBody(appName, codeLifetime, urlWithLinkCode) {
    return `
        <tr>
            <td style="text-align: center; font-size: 17px; line-height: 24px; color: #000000;">
...
module.exports.getEmailBody = (appName, codeLifetime, urlWithLinkCode, userInputCode, email) => {
    let mainBody = ``;
    if (userInputCode !== undefined) {
        mainBody += getOTPBody(appName, codeLifetime, userInputCode);
    }
