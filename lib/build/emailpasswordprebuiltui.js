...
var EmailPasswordResetPasswordEmail = uiEntry.withOverride("EmailPasswordResetPasswordEmail", function (props) {
    var t = translationContext.useTranslation();
    var userContext = uiEntry.useUserContext();
    var _a = React.useState(""),
        emailFieldValue = _a[0],
        setEmailFieldValue = _a[1];
                        ...
                        { "data-supertokens": "primaryText enterEmailSuccessMessage" },
                        {
                            children: [
                                ...
                                jsxRuntime.jsx(
                                    "span",
                                    genericComponentOverrideContext.__assign(
                                        { "data-supertokens": "link resendEmailLink", onClick: props.resend },
...
var ResetPasswordEmail = function (props) {
    ...
    return jsxRuntime.jsx(
        "div",
        genericComponentOverrideContext.__assign(
            { "data-supertokens": "container ".concat(status === "SENT" ? "" : "resetPasswordEmailForm") },
            {
