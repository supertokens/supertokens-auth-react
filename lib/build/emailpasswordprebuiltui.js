...
var componentOverrideContext$1 = require('./emailpassword-shared2.js');
...
function BackToSignInButton(_a) {
    ...
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: onClick }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-secondaryText))" }), t("EMAIL_PASSWORD_RESET_SIGN_IN_LINK")] })));
}
...
var EmailPasswordResetPasswordEmail = function (props) {
    ...
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "container resetPasswordEmailForm" }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "row" }, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "headerTitle withBackButton" }, { children: [jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackButtonClicked }), t("EMAIL_PASSWORD_RESET_HEADER_TITLE"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("EMAIL_PASSWORD_RESET_HEADER_SUBTITLE") })), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onError: props.onError, formFields: formFields, buttonLabel: "EMAIL_PASSWORD_RESET_SEND_BTN", onSuccess: onSuccess, callAPI: function (formFields) { return utils.__awaiter(void 0, void 0, void 0, function () {
                    ...
                    }); }, showLabels: true, validateOnBlur: true, footer: props.footer })] })) })));
};
...
var EmailPasswordSubmitNewPassword = function (props) {
    ...
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "container resetPasswordPasswordForm" }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "row" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle" }, { children: t("EMAIL_PASSWORD_RESET_SUBMIT_PW_HEADER_TITLE") })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("EMAIL_PASSWORD_RESET_SUBMIT_PW_HEADER_SUBTITLE") })), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsx(formBase.FormBase, { formFields: formFields, clearError: props.clearError, onError: props.onError, buttonLabel: "EMAIL_PASSWORD_RESET_SUBMIT_PW_CHANGE_PW_BTN", onSuccess: onSuccess, validateOnBlur: true, callAPI: function (fields) { return utils.__awaiter(void 0, void 0, void 0, function () {
                    ...
                    }); }, showLabels: true, footer: props.footer })] })) })));
};
...
var ResetPasswordUsingToken$1 = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsEmailPassword }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(ResetPasswordUsingTokenThemeWrapper, utils.__assign({}, childProps)), props.children &&
...
var SignInForm = uiEntry.withOverride("EmailPasswordSignInForm", function EmailPasswordSignInForm(props) {
    var _this = this;
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsx(formBase.FormBase, { formFields: props.formFields, clearError: props.clearError, onError: props.onError, onFetchError: props.onFetchError, buttonLabel: "EMAIL_PASSWORD_SIGN_IN_SUBMIT_BTN", onSuccess: props.onSuccess, callAPI: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
            var validationErrors, response;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils.validateForm(formFields, props.config.signInAndUpFeature.signInForm.formFields)];
                    case 1:
                        validationErrors = _a.sent();
                        if (validationErrors.length > 0) {
                            return [2 /*return*/, {
...
function SignInTheme(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(translations.ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(SignInForm, utils.__assign({}, props)) })) })));
}
...
function useChildProps$1(recipe$1, onAuthSuccess, error, onError, clearError, userContext, navigate) {
    ...
    var recipeImplementation = React.useMemo(function () { return getModifiedRecipeImplementation$1(recipe$1.webJSRecipe); }, [recipe$1]);
    var rethrowInRender = utils.useRethrowInRender();
    var t = translationContext.useTranslation();
    var onSignInSuccess = React.useCallback(function () { return utils.__awaiter(_this, void 0, void 0, function () {
    ...
    return React.useMemo(function () {
        var onForgotPasswordClick = function () {
            return recipe$1.redirect({ action: "RESET_PASSWORD", tenantIdFromQueryParams: utils.getTenantIdFromQueryParams() }, navigate, undefined, userContext);
        };
...
var SignInFeature = function (props) {
    ...
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInTheme, utils.__assign({}, childProps)), props.children &&
                    React__namespace.Children.map(props.children, function (child) {
                        if (React__namespace.isValidElement(child)) {
...
var getModifiedRecipeImplementation$1 = function (origImpl) {
    return utils.__assign(utils.__assign({}, origImpl), { signIn: function (input) {
            return utils.__awaiter(this, void 0, void 0, function () {
                var response;
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, origImpl.signIn(utils.__assign(utils.__assign({}, input), { shouldTryLinkingWithSessionUser: false }))];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, response];
                    }
            ...
            return utils.__awaiter(this, void 0, void 0, function () {
                ...
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, origImpl.signUp(utils.__assign(utils.__assign({}, input), { shouldTryLinkingWithSessionUser: false }))];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, response];
                    }
...
var SignUpForm = uiEntry.withOverride("EmailPasswordSignUpForm", function EmailPasswordSignUpForm(props) {
    var _this = this;
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsx(formBase.FormBase, { formFields: props.formFields, clearError: props.clearError, onError: props.onError, onFetchError: props.onFetchError, buttonLabel: "EMAIL_PASSWORD_SIGN_UP_SUBMIT_BTN", onSuccess: props.onSuccess, callAPI: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
            var validationErrors, res;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils.validateForm(formFields, props.config.signInAndUpFeature.signUpForm.formFields)];
                    case 1:
                        validationErrors = _a.sent();
                        if (validationErrors.length > 0) {
                            return [2 /*return*/, {
...
function SignUpTheme(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(translations.ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(SignUpForm, utils.__assign({}, props)) })) })));
}
...
function useChildProps(recipe, onAuthSuccess, error, onError, clearError, userContext, navigate) {
    ...
    var rethrowInRender = utils.useRethrowInRender();
    var onSignUpSuccess = React.useCallback(function (result) { return utils.__awaiter(_this, void 0, void 0, function () {
        var payloadAfterCall;
        return utils.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
...
var SignUpFeature = function (props) {
    ...
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignUpTheme, utils.__assign({}, childProps)), props.children &&
                    React__namespace.Children.map(props.children, function (child) {
                        if (React__namespace.isValidElement(child)) {
                            return React__namespace.cloneElement(child, utils.__assign({}, childProps));
                        }
...
function getThemeSignUpFeatureFormFields(formFields, recipe, userContext) {
    ...
    return formFields.map(function (field) { return (utils.__assign(utils.__assign({}, field), { showIsRequired: (function () {
            ...
            return function (value) { return utils.__awaiter(_this, void 0, void 0, function () {
...
var EmailPasswordPreBuiltUI = /** @class */ (function (_super) {
    ...
    function EmailPasswordPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "resetpassword") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ResetPasswordUsingToken$1, utils.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            else {
        ...
        return [
            {
                ...
                displayOrder: 2,
                type: "SIGN_UP",
                component: function (props) { return (jsxRuntime.jsx(SignUpFeature, utils.__assign({ recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext }, props), "emailpassword-sign-up")); },
            },
            {
                factorIds: [types.FactorIds.EMAILPASSWORD],
                displayOrder: 2,
                type: "SIGN_IN",
                component: function (props) { return (jsxRuntime.jsx(SignInFeature, utils.__assign({ recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext }, props), "emailpassword-sign-in")); },
            },
        ];
    };
    // For tests
    ...
    EmailPasswordPreBuiltUI.languageTranslations = defaultTranslationsEmailPassword;
