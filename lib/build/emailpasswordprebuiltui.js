        ...
        return [
            {
                ...
                displayOrder: 2,
                type: "SIGN_UP",
                component: function (props) { return (jsxRuntime.jsx(SignUpFeature, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext.useContext }, props), "emailpassword-sign-up")); },
            },
            {
                factorIds: [types.FactorIds.EMAILPASSWORD],
                displayOrder: 2,
                type: "SIGN_IN",
                component: function (props) { return (jsxRuntime.jsx(SignInFeature, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext.useContext }, props), "emailpassword-sign-in")); },
            },
        ];
    };
    // For tests
