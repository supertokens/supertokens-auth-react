...
function BackToSignInButton(_a) {
    ...
    return (jsxRuntime.jsxs("div", logger.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: onClick }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-secondaryText))" }), t("EMAIL_PASSWORD_RESET_SIGN_IN_LINK")] })));
}
...
var EmailPasswordResetPasswordEmail = function (props) {
    ...
    return (jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "container resetPasswordEmailForm" }, { children: jsxRuntime.jsxs("div", logger.__assign({ "data-supertokens": "row" }, { children: [jsxRuntime.jsxs("div", logger.__assign({ "data-supertokens": "headerTitle withBackButton" }, { children: [jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackButtonClicked }), t("EMAIL_PASSWORD_RESET_HEADER_TITLE"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] })), jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("EMAIL_PASSWORD_RESET_HEADER_SUBTITLE") })), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onError: props.onError, formFields: formFields, buttonLabel: "EMAIL_PASSWORD_RESET_SEND_BTN", onSuccess: onSuccess, callAPI: function (formFields) { return logger.__awaiter(void 0, void 0, void 0, function () {
                        ...
                        return logger.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, genericComponentOverrideContext.validateForm(formFields, props.config.resetPasswordUsingTokenFeature.enterEmailForm.formFields)];
                                case 1:
...
var EmailPasswordSubmitNewPassword = function (props) {
    ...
    return (jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "container resetPasswordPasswordForm" }, { children: jsxRuntime.jsxs("div", logger.__assign({ "data-supertokens": "row" }, { children: [jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "headerTitle" }, { children: t("EMAIL_PASSWORD_RESET_SUBMIT_PW_HEADER_TITLE") })), jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("EMAIL_PASSWORD_RESET_SUBMIT_PW_HEADER_SUBTITLE") })), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsx(formBase.FormBase, { formFields: formFields, clearError: props.clearError, onError: props.onError, buttonLabel: "EMAIL_PASSWORD_RESET_SUBMIT_PW_CHANGE_PW_BTN", onSuccess: onSuccess, validateOnBlur: true, callAPI: function (fields) { return logger.__awaiter(void 0, void 0, void 0, function () {
                        ...
                        return logger.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, genericComponentOverrideContext.validateForm(fields, props.config.resetPasswordUsingTokenFeature.submitNewPasswordForm.formFields)];
                                case 1:
                                    validationErrors = _a.sent();
                                    if (validationErrors.length > 0) {
                                        return [2 /*return*/, {
...
function ResetPasswordUsingTokenTheme(props) {
    ...
    if (props.submitNewPasswordForm !== undefined) {
        return jsxRuntime.jsx(SubmitNewPassword, logger.__assign({}, props.submitNewPasswordForm));
    }
    // Otherwise, return EnterEmail.
    return jsxRuntime.jsx(ResetPasswordEmail, logger.__assign({}, props.enterEmailForm));
}
...
var defaultTranslationsEmailPassword = {
    en: logger.__assign(logger.__assign(logger.__assign({}, uiEntry.defaultTranslationsCommon.en), translations.defaultTranslationsEmailVerification.en), { EMAIL_PASSWORD_EMAIL_LABEL: "Email", EMAIL_PASSWORD_EMAIL_PLACEHOLDER: "Email address", EMAIL_PASSWORD_PASSWORD_LABEL: "Password", EMAIL_PASSWORD_PASSWORD_PLACEHOLDER: "Password", EMAIL_PASSWORD_SIGN_IN_FORGOT_PW_LINK: "Forgot password?", EMAIL_PASSWORD_SIGN_IN_SUBMIT_BTN: "SIGN IN", EMAIL_PASSWORD_SIGN_IN_WRONG_CREDENTIALS_ERROR: "Incorrect email and password combination", EMAIL_PASSWORD_SIGN_UP_SUBMIT_BTN: "SIGN UP", EMAIL_PASSWORD_EMAIL_ALREADY_EXISTS: "This email already exists. Please sign in instead", EMAIL_PASSWORD_RESET_HEADER_TITLE: "Reset your password", EMAIL_PASSWORD_RESET_HEADER_SUBTITLE: "We will send you an email to reset your password", EMAIL_PASSWORD_RESET_SEND_FALLBACK_EMAIL: "your account", EMAIL_PASSWORD_RESET_SEND_BEFORE_EMAIL: "A password reset email has been sent to ", EMAIL_PASSWORD_RESET_SEND_AFTER_EMAIL: ", if it exists in our system. ", EMAIL_PASSWORD_RESET_RESEND_LINK: "Resend or change email", EMAIL_PASSWORD_RESET_SEND_BTN: "Email me", EMAIL_PASSWORD_RESET_SIGN_IN_LINK: "Sign In", EMAIL_PASSWORD_RESET_SUBMIT_PW_SUCCESS_HEADER_TITLE: "Success!", EMAIL_PASSWORD_RESET_SUBMIT_PW_SUCCESS_DESC: "Your password has been updated successfully", EMAIL_PASSWORD_RESET_SUBMIT_PW_SUCCESS_SIGN_IN_BTN: "SIGN IN", EMAIL_PASSWORD_NEW_PASSWORD_LABEL: "New password", EMAIL_PASSWORD_NEW_PASSWORD_PLACEHOLDER: "New password", EMAIL_PASSWORD_CONFIRM_PASSWORD_LABEL: "Confirm password", EMAIL_PASSWORD_CONFIRM_PASSWORD_PLACEHOLDER: "Confirm your password", EMAIL_PASSWORD_RESET_SUBMIT_PW_HEADER_TITLE: "Change your password", EMAIL_PASSWORD_RESET_SUBMIT_PW_HEADER_SUBTITLE: "Enter a new password below to change your password", EMAIL_PASSWORD_RESET_SUBMIT_PW_CHANGE_PW_BTN: "CHANGE PASSWORD", EMAIL_PASSWORD_RESET_PASSWORD_INVALID_TOKEN_ERROR: "Invalid password reset token", ERROR_EMAIL_NON_STRING: "Email must be of type string", ERROR_EMAIL_INVALID: "Email is invalid", ERROR_PASSWORD_NON_STRING: "Password must be of type string", ERROR_PASSWORD_TOO_SHORT: "Password must contain at least 8 characters, including a number", ERROR_PASSWORD_TOO_LONG: "Password's length must be lesser than 100 characters", ERROR_PASSWORD_NO_ALPHA: "Password must contain at least one alphabet", ERROR_PASSWORD_NO_NUM: "Password must contain at least one number", ERROR_CONFIRM_PASSWORD_NO_MATCH: "Confirmation password doesn't match", ERROR_NON_OPTIONAL: "Field is not optional", 
         ...
         */
        "This email already exists. Please sign in instead.": undefined, "Field is not optional": undefined, "Password must contain at least 8 characters, including a number": undefined, "Password's length must be lesser than 100 characters": undefined, "Password must contain at least one alphabet": undefined, "Password must contain at least one number": undefined, "Email is invalid": undefined, "Reset password link was not created because of account take over risk. Please contact support. (ERR_CODE_001)": undefined, "Cannot sign up due to security reasons. Please try logging in, use a different login method or contact support. (ERR_CODE_007)": undefined, "Cannot sign in due to security reasons. Please try resetting your password, use a different login method or contact support. (ERR_CODE_008)": undefined, "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_009)": undefined, "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_010)": undefined, "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_011)": undefined, "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_012)": undefined, "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_013)": undefined, "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_014)": undefined, "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_015)": undefined, "Cannot sign in / up due to security reasons. Please contact support. (ERR_CODE_016)": undefined }),
};
...
var ResetPasswordUsingToken$1 = function (props) {
    ...
    var submitNewPasswordForm = token === undefined || token === null
        ? undefined
        : {
            error: error,
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsEmailPassword }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(ResetPasswordUsingTokenThemeWrapper, logger.__assign({}, childProps)), props.children &&
...
var SignInForm = uiEntry.withOverride("EmailPasswordSignInForm", function EmailPasswordSignInForm(props) {
    var _this = this;
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsx(formBase.FormBase, { formFields: props.formFields, clearError: props.clearError, onError: props.onError, onFetchError: props.onFetchError, buttonLabel: "EMAIL_PASSWORD_SIGN_IN_SUBMIT_BTN", onSuccess: props.onSuccess, callAPI: function (formFields) { return logger.__awaiter(_this, void 0, void 0, function () {
            var validationErrors, response;
            return logger.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, genericComponentOverrideContext.validateForm(formFields, props.config.signInAndUpFeature.signInForm.formFields)];
                    case 1:
                        validationErrors = _a.sent();
                        if (validationErrors.length > 0) {
                            return [2 /*return*/, {
...
function SignInTheme(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(translations.ThemeBase, logger.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(SignInForm, logger.__assign({}, props)) })) })));
}
...
function useChildProps$1(recipe$2, onAuthSuccess, error, onError, clearError, userContext, navigate) {
    ...
    var recipeImplementation = React.useMemo(function () { return getModifiedRecipeImplementation$1(recipe$2.webJSRecipe); }, [recipe$2]);
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    var t = translationContext.useTranslation();
    var onSignInSuccess = React.useCallback(function () { return logger.__awaiter(_this, void 0, void 0, function () {
    ...
    return React.useMemo(function () {
        var onForgotPasswordClick = function () {
            return recipe$2.redirect({ action: "RESET_PASSWORD", tenantIdFromQueryParams: genericComponentOverrideContext.getTenantIdFromQueryParams() }, navigate, undefined, userContext);
        };
...
var SignInFeature = function (props) {
    var childProps = useChildProps$1(props.recipe, props.onAuthSuccess, props.error, props.onError, props.clearError, props.userContext, props.navigate);
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, logger.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInTheme, logger.__assign({}, childProps)), props.children &&
                    React__namespace.Children.map(props.children, function (child) {
                        if (React__namespace.isValidElement(child)) {
...
var getModifiedRecipeImplementation$1 = function (origImpl) {
    return logger.__assign(logger.__assign({}, origImpl), { signIn: function (input) {
            return logger.__awaiter(this, void 0, void 0, function () {
                var response;
                return logger.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, origImpl.signIn(logger.__assign(logger.__assign({}, input), { shouldTryLinkingWithSessionUser: false }))];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, response];
                    }
            ...
            return logger.__awaiter(this, void 0, void 0, function () {
                ...
                return logger.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, origImpl.signUp(logger.__assign(logger.__assign({}, input), { shouldTryLinkingWithSessionUser: false }))];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, response];
                    }
...
var SignUpForm = uiEntry.withOverride("EmailPasswordSignUpForm", function EmailPasswordSignUpForm(props) {
    var _this = this;
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsx(formBase.FormBase, { formFields: props.formFields, clearError: props.clearError, onError: props.onError, onFetchError: props.onFetchError, buttonLabel: "EMAIL_PASSWORD_SIGN_UP_SUBMIT_BTN", onSuccess: props.onSuccess, callAPI: function (formFields) { return logger.__awaiter(_this, void 0, void 0, function () {
            var validationErrors, res;
            return logger.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, genericComponentOverrideContext.validateForm(formFields, props.config.signInAndUpFeature.signUpForm.formFields)];
                    case 1:
                        validationErrors = _a.sent();
                        if (validationErrors.length > 0) {
                            return [2 /*return*/, {
...
function SignUpTheme(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(translations.ThemeBase, logger.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(SignUpForm, logger.__assign({}, props)) })) })));
}

function useChildProps(recipe, onAuthSuccess, error, onError, clearError, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React.useMemo(function () { return recipe && getModifiedRecipeImplementation(recipe.webJSRecipe); }, [recipe]);
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    var onSignUpSuccess = React.useCallback(function (result) { return logger.__awaiter(_this, void 0, void 0, function () {
        var payloadAfterCall;
        return logger.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
...
var SignUpFeature = function (props) {
    ...
    var childProps = useChildProps(props.recipe, props.onAuthSuccess, props.error, props.onError, props.clearError, userContext, props.navigate);
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, logger.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignUpTheme, logger.__assign({}, childProps)), props.children &&
                    React__namespace.Children.map(props.children, function (child) {
                        if (React__namespace.isValidElement(child)) {
                            return React__namespace.cloneElement(child, logger.__assign({}, childProps));
                        }
...
function getThemeSignUpFeatureFormFields(formFields, recipe, userContext) {
    ...
    return formFields.map(function (field) { return (logger.__assign(logger.__assign({}, field), { showIsRequired: (function () {
            ...
            return function (value) { return logger.__awaiter(_this, void 0, void 0, function () {
                var error, emailExists, err_1;
                return logger.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, field.validate(value)];
                        case 1:
                            error = _a.sent();
                            if (error !== undefined) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, recipe.webJSRecipe.doesEmailExist({
                                    email: value,
                                    userContext: userContext,
                                })];
                        case 3:
...
var EmailPasswordPreBuiltUI = /** @class */ (function (_super) {
    logger.__extends(EmailPasswordPreBuiltUI, _super);
    function EmailPasswordPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.resetPasswordUsingTokenFeature.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(constants.DEFAULT_RESET_PASSWORD_PATH));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: genericComponentOverrideContext.matchRecipeIdUsingQueryParams(_this.recipeInstance.config.recipeId),
                    component: function (props) { return _this.getFeatureComponent("resetpassword", props, useComponentOverrides); },
                    recipeID: recipe.EmailPassword.RECIPE_ID,
                };
            }
            return features;
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "resetpassword") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ResetPasswordUsingToken$1, logger.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            else {
    ...
    EmailPasswordPreBuiltUI.getFeatureComponent = function (componentName, props, useComponentOverrides) {
        if (useComponentOverrides === void 0) { useComponentOverrides = componentOverrideContext.useContext; }
        return EmailPasswordPreBuiltUI.getInstanceOrInitAndGetInstance().getFeatureComponent(componentName, props, useComponentOverrides);
    };
        ...
        return [
            {
                ...
                displayOrder: 2,
                type: "SIGN_UP",
                component: function (props) { return (jsxRuntime.jsx(SignUpFeature, logger.__assign({ recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext.useContext }, props), "emailpassword-sign-up")); },
            },
            {
                factorIds: [types.FactorIds.EMAILPASSWORD],
                displayOrder: 2,
                type: "SIGN_IN",
                component: function (props) { return (jsxRuntime.jsx(SignInFeature, logger.__assign({ recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext.useContext }, props), "emailpassword-sign-in")); },
            },
        ];
    };
    // For tests
