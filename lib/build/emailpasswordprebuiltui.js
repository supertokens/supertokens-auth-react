...
var defaultTranslationsEmailPassword = {
    en: superTokens.__assign(
        superTokens.__assign(
            superTokens.__assign({}, uiEntry.defaultTranslationsCommon.en),
    ...
    return React.useMemo(
        function () {
            var onForgotPasswordClick = function () {
                return recipe$2.redirect({ action: "RESET_PASSWORD" }, navigate, undefined, userContext);
            };
            ...
            var formFields = signInFeature.formFields.map(function (f) {
                return f.id !== "password"
                    ? f
                    : superTokens.__assign(superTokens.__assign({}, f), {
        ...
        superTokens.__assign(
            { recipeComponentOverrides: recipeComponentOverrides },
            {
                children: jsxRuntime.jsxs(React.Fragment, {
                    children: [
                        props.children === undefined &&
                            jsxRuntime.jsx(SignInTheme, superTokens.__assign({}, childProps)),
                        props.children &&
                            React__namespace.Children.map(props.children, function (child) {
                                if (React__namespace.isValidElement(child)) {
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    superTokens.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignUpForm, superTokens.__assign({}, props)) }
                    )
                ),
            }
        )
        ...
        superTokens.__assign(
            { recipeComponentOverrides: recipeComponentOverrides },
            {
                children: jsxRuntime.jsxs(React.Fragment, {
                    children: [
                        props.children === undefined &&
                            jsxRuntime.jsx(SignUpTheme, superTokens.__assign({}, childProps)),
                        props.children &&
                            React__namespace.Children.map(props.children, function (child) {
                                if (React__namespace.isValidElement(child)) {
                                    return React__namespace.cloneElement(child, superTokens.__assign({}, childProps));
