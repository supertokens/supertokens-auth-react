...
function useChildProps$1(recipe$2, onAuthSuccess, error, onError, clearError, userContext, navigate) {
    ...
    return React.useMemo(function () {
        var onForgotPasswordClick = function () {
            return recipe$2.redirect({ action: "RESET_PASSWORD", tenantIdFromQueryParams: utils.getTenantIdFromQueryParams() }, navigate, undefined, userContext);
        };
        ...
        return [
            {
                ...
                displayOrder: 2,
                type: "SIGN_UP",
                component: function (props) { return (jsxRuntime.jsx(SignUpFeature, utils.__assign({ recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext.useContext }, props), "emailpassword-sign-up")); },
            },
            {
                factorIds: [types.FactorIds.EMAILPASSWORD],
                displayOrder: 2,
                type: "SIGN_IN",
                component: function (props) { return (jsxRuntime.jsx(SignInFeature, utils.__assign({ recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext.useContext }, props), "emailpassword-sign-in")); },
            },
        ];
    };
    // For tests
