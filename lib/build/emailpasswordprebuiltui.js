...
function BackToSignInButton(_a) {
    ...
    return jsxRuntime.jsxs(
        ...
        genericComponentOverrideContext.__assign(
            ...
            {
                children: [
                    jsxRuntime.jsx(sessionprebuiltui.ArrowLeftIcon, { color: "rgb(var(--palette-secondaryText))" }),
...
var ResetPasswordEmail = sessionprebuiltui.withOverride(
...
var SubmitNewPassword = sessionprebuiltui.withOverride(
...
var SignInForm = sessionprebuiltui.withOverride("EmailPasswordSignInForm", function EmailPasswordSignInForm(props) {
    var _this = this;
    var userContext = sessionprebuiltui.useUserContext();
...
var SignUpForm = sessionprebuiltui.withOverride("EmailPasswordSignUpForm", function EmailPasswordSignUpForm(props) {
    var _this = this;
    var userContext = sessionprebuiltui.useUserContext();
    return jsxRuntime.jsx(formBase.FormBase, {
        formFields: props.formFields,
