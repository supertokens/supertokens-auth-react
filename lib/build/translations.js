...
var ErrorBoundary = /** @class */ (function (_super) {
    thirdparty.__extends(ErrorBoundary, _super);
...
function FeatureWrapper(_a) {
    ...
    var _b = React.useState(
            thirdparty.SuperTokens.usesDynamicLoginMethods === false ||
                thirdparty.Multitenancy.getInstanceOrThrow().getLoadedDynamicLoginMethods() !== undefined
        ),
        loadedDynamicLoginMethods = _b[0],
        setLoadedDynamicLoginMethods = _b[1];
    var st = thirdparty.SuperTokens.getInstanceOrThrow();
    React.useEffect(function () {
        var handler = function () {
            return setLoadedDynamicLoginMethods(true);
        };
        thirdparty.SuperTokens.uiController.on("LoginMethodsLoaded", handler);
    }, []);
    ...
    return jsxRuntime.jsx(ErrorBoundary, {
        children: jsxRuntime.jsx(
            thirdparty.TranslationContextProvider,
            thirdparty.__assign(
                {
                    defaultLanguage: st.languageTranslations.defaultLanguage,
                    defaultStore: thirdparty.mergeObjects(defaultStore, st.languageTranslations.userTranslationStore),
                ...
                },
                {
                    children: jsxRuntime.jsx(
                        ...
                        thirdparty.__assign({ useShadowDom: useShadowDom }, { children: children })
                    ),
                }
            )
        ),
...
function WithShadowDom(_a) {
    ...
    return jsxRuntime.jsx(
        "div",
        thirdparty.__assign(
            { id: thirdparty.ST_ROOT_ID, ref: rootDiv },
...
var withOverride = function (overrideKey, DefaultComponent) {
    ...
    return function (props) {
        ...
        if (OverrideComponent !== null) {
            return jsxRuntime.jsx(
                OverrideComponent,
                thirdparty.__assign({ DefaultComponent: DefaultComponent }, props)
            );
        }
        return jsxRuntime.jsx(DefaultComponent, thirdparty.__assign({}, props));
    };
};
