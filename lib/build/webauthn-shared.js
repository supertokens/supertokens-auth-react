...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImp), { getEmailExists: function (input) {
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                var response;
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, originalImp.getEmailExists(input)];
                        case 1:
                            response = _a.sent();
            ...
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, originalImp.registerCredential(input)];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
                                onHandleEvent({
            ...
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, originalImp.authenticateCredential(input)];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
                                onHandleEvent({
            ...
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, originalImp.registerCredentialWithSignUp(input)];
                        case 1:
                            response = _a.sent();
...
function normaliseWebauthnConfig(config) {
    ...
    return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, utils.normaliseAuthRecipe(config)), { signInAndUpFeature: normalisePasskeyBaseConfig(config.signInAndUpFeature), recoveryFeature: normalisePasskeyBaseConfig(config.recoveryFeature), override: override });
}
...
var Webauthn = /** @class */ (function (_super) {
    ...
    function Webauthn(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = WebauthnWebJS__default.default; }
        ...
        _this.getDefaultRedirectionURL = function (context) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            return genericComponentOverrideContext.__generator(this, function (_a) {
                if (context.action === "SEND_RECOVERY_EMAIL") {
                    return [2 /*return*/, genericComponentOverrideContext.getDefaultRedirectionURLForPath(this.config, DEFAULT_WEBAUTHN_SEND_RECOVERY_EMAIL_PATH, context)];
                }
    ...
    Webauthn.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                Webauthn.instance = new Webauthn(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Webauthn.RECIPE_ID }));
                return Webauthn.instance;
            },
            webJS: WebauthnWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
...
var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext(undefined, Webauthn.RECIPE_ID), useContext = _a[0], Provider = _a[1];
