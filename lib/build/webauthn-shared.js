...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (utils.__assign(utils.__assign({}, originalImp), { getEmailExists: function (input) {
...
function normaliseWebauthnConfig(config) {
    ...
    return utils.__assign(utils.__assign({}, utils$1.normaliseAuthRecipe(config)), { signInAndUpFeature: normalisePasskeyBaseConfig(config.signInAndUpFeature), recoveryFeature: normalisePasskeyBaseConfig(config.recoveryFeature), override: override });
}
        ...
        _this.getDefaultRedirectionURL = function (context) { return utils.__awaiter(_this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                if (context.action === "SEND_RECOVERY_EMAIL") {
                    return [2 /*return*/, utils.getDefaultRedirectionURLForPath(this.config, DEFAULT_WEBAUTHN_SEND_RECOVERY_EMAIL_PATH, context)];
                }
    ...
    Webauthn.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                Webauthn.instance = new Webauthn(utils.__assign(utils.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Webauthn.RECIPE_ID }));
                return Webauthn.instance;
            },
            webJS: WebauthnWebJS__default.default.init(utils.__assign(utils.__assign({}, normalisedConfig), { override: {
