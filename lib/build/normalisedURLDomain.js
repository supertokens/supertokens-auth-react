 ...
 * under the License.
 */
var NormalisedURLDomain = function NormalisedURLDomain(url) {
    var _this = this;

    _classCallCheck(this, NormalisedURLDomain);
...
function normaliseURLDomainOrThrowError(input) {
    var ignoreProtocol = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
