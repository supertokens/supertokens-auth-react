...
var TranslationContextProvider = function (_a) {
    ...
    var _c = React.useState(undefined), currentLanguage = _c[0], setCurrentLanguage = _c[1];
        ...
        function loadLanguageFromCookies() {
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, genericComponentOverrideContext.getCurrentLanguageFromCookie()];
                        case 1:
                            cookieLang = _a.sent();
    ...
    React.useEffect(function () {
        ...
        var loadHandler = function (_eventName, detail) {
            setTranslationStore(function (os) { return genericComponentOverrideContext.mergeObjects(os, detail); });
        };
    ...
    return jsxRuntime.jsx(TranslationContext.Provider, genericComponentOverrideContext.__assign({ value: { translate: translateFunc } }, { children: children }));
};
