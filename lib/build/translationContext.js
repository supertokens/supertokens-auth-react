...
var TranslationContextProvider = function (_a) {
    ...
    React.useEffect(function () {
        ...
        var loadHandler = function (_eventName, detail) {
            setTranslationStore(function (os) { return utils.mergeObjects(os, detail); });
        };
    ...
    return jsxRuntime.jsx(TranslationContext.Provider, utils.__assign({ value: { translate: translateFunc } }, { children: children }));
};
