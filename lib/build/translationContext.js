...
var TranslationContextProvider = function (_a) {
            ...
            function loadLanguageFromCookies() {
                return assets.__awaiter(this, void 0, void 0, function () {
                    ...
                    return assets.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                return [4 /*yield*/, authRecipe.getCurrentLanguageFromCookie()];
                            case 1:
                                cookieLang = _a.sent();
    ...
    React.useEffect(function () {
        ...
        var loadHandler = function (_eventName, detail) {
            setTranslationStore(function (os) {
                return authRecipe.mergeObjects(os, detail);
            });
        };
    ...
    return jsxRuntime.jsx(
        ...
        assets.__assign({ value: { translate: translateFunc } }, { children: children })
    );
};
