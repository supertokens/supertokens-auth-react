...
var MultitenancyDynamicLoginMethodsSpinnerTheme = function () {
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "container delayedRender" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "row" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "spinner delayedRender" }, { children: jsxRuntime.jsx(SpinnerIcon, {}) })) })) })));
};
...
var DynamicLoginMethodsSpinnerTheme = function (props) {
    ...
    return (jsxRuntime.jsx(ThemeBase$1, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsxRuntime.jsx(DynamicLoginMethodsSpinnerThemeWithOverride, {}) })));
};
...
var DynamicLoginMethodsSpinner = function () {
    ...
    return (jsxRuntime.jsx(ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(WithOrWithoutShadowDom, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom }, { children: jsxRuntime.jsx(DynamicLoginMethodsSpinnerTheme, { config: recipe.config }) })) })));
};
...
var DynamicLoginMethodsProvider = function (_a) {
    ...
    return jsxRuntime.jsx(dynamicLoginMethodsContext.Provider, utils.__assign({ value: contextValue }, { children: children }));
};
...
var UserContextProvider = function (_a) {
    ...
    return jsxRuntime.jsx(UserContextContext.Provider, utils.__assign({ value: currentUserContext }, { children: children }));
};
...
function FeatureWrapper(_a) {
    ...
    return (jsxRuntime.jsx(DynamicLoginMethodsProvider, utils.__assign({ value: loadedDynamicLoginMethods }, { children: jsxRuntime.jsx(translationContext.TranslationContextProvider, utils.__assign({ defaultLanguage: st.languageTranslations.defaultLanguage, defaultStore: utils.mergeObjects(defaultStore, st.languageTranslations.userTranslationStore), translationControlEventSource: st.languageTranslations.translationEventSource, userTranslationFunc: st.languageTranslations.userTranslationFunc }, { children: jsxRuntime.jsx(WithOrWithoutShadowDom, utils.__assign({ useShadowDom: useShadowDom }, { children: children })) })) })));
}
function WithShadowDom(_a) {
    ...
    return (jsxRuntime.jsx("div", utils.__assign({ id: utils.ST_ROOT_ID, ref: rootDiv }, { children: shadowRoot && reactDom.createPortal(children, shadowRoot) })));
}
function WithOrWithoutShadowDom(_a) {
    ...
    if (useShadowDom === false) {
        return (jsxRuntime.jsxs("div", utils.__assign({ id: utils.ST_ROOT_ID }, { children: [children, jsxRuntime.jsx(DisableAutoFillInput, {})] })));
    }
...
function DisableAutoFillInput() {
    ...
    return (jsxRuntime.jsx("style", utils.__assign({ type: "text/css" }, { children: "input.supertokens-input:-webkit-autofill,input.supertokens-input:-webkit-autofill:focus,input.supertokens-input:-webkit-autofill:hover,select:-webkit-autofill,select:-webkit-autofill:focus,select:-webkit-autofill:hover,textarea:-webkit-autofill,textarea:-webkit-autofill:focus,textarea:-webkit-autofill:hover{transition:background-color 5000s ease-in-out 0s}" })));
...
function SuperTokensBranding() {
    ...
    return (jsxRuntime.jsxs("a", utils.__assign({ "data-supertokens": "superTokensBranding", href: "https://supertokens.com?utm_campaign=poweredby", target: "_blank" }, { children: [t("BRANDING_POWERED_BY_START"), jsxRuntime.jsx("strong", { children: "SuperTokens" }), t("BRANDING_POWERED_BY_END")] })));
}
...
function UserContextWrapper(props) {
    ...
    if (props.userContext !== undefined) {
        return jsxRuntime.jsx(UserContextProvider, utils.__assign({ userContext: props.userContext }, { children: props.children }));
    }
...
var AuthPageComponentList = withOverride("AuthPageComponentList", function AuthPageComponentList(props) {
    ...
    var _loop_1 = function (i) {
        list.push(function () { return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "dividerWithOr" }, { children: [jsxRuntime.jsx("div", { "data-supertokens": "divider" }), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "dividerText" }, { children: t("DIVIDER_OR") })), jsxRuntime.jsx("div", { "data-supertokens": "divider" })] }), "divider-".concat(i))); });
        list.push(props.authComponents[i]);
    };
    for (var i = 1; i < props.authComponents.length; ++i) {
        _loop_1(i);
    }
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "authComponentList" }, { children: list.map(function (i) {
...
function BackButton(_a) {
    ...
    return (jsxRuntime.jsx("button", utils.__assign({ onClick: onClick, "data-supertokens": "backButton backButtonCommon" }, { children: jsxRuntime.jsx(HeavyArrowLeftIcon, { color: "rgb(var(--palette-textTitle))" }) })));
}
...
var AuthPageInner = function (props) {
    ...
    utils.useOnMountAPICall(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        var oauth2Recipe;
    ...
    }); }, function (info) { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            if (info !== undefined) {
                if (info.status === "OK") {
                ...
                if (props.onSessionAlreadyExists !== undefined) {
                    ...
                    if (loginChallenge !== null && oauth2Recipe_1 !== undefined) {
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection({
                                                ...
                                                }, types.Session.RECIPE_ID, utils.getRedirectToPathFromURL(), userContext, props.navigate)];
                                    }
                                });
                            });
                        ...
                        void types.Session.getInstanceOrThrow()
                            .validateGlobalClaimsAndHandleSuccessRedirection(undefined, types.Session.RECIPE_ID, utils.getRedirectToPathFromURL(), userContext, props.navigate)
                            .catch(rethrowInRender);
                    }
                }
                else {
    ...
    var onAuthSuccess = React.useCallback(function (ctx) { return utils.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (loginChallenge === null || oauth2Recipe === undefined) {
                        return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(utils.__assign(utils.__assign({}, ctx), { action: "SUCCESS", tenantIdFromQueryParams: utils.getTenantIdFromQueryParams(), redirectToPath: utils.getRedirectToPathFromURL() }), ctx.recipeId, utils.getRedirectToPathFromURL(), userContext, props.navigate)];
                    }
                ...
                case 1:
                    frontendRedirectTo = (_a.sent()).frontendRedirectTo;
                    return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(utils.__assign(utils.__assign({}, ctx), { action: "SUCCESS_OAUTH2", tenantIdFromQueryParams: utils.getTenantIdFromQueryParams(), frontendRedirectTo: frontendRedirectTo }), ctx.recipeId, utils.getRedirectToPathFromURL(), userContext, props.navigate)];
            }
        });
    }); }, [loginChallenge]);
    var childProps = authComponentListInfo !== undefined &&
        ...
        ? utils.__assign(utils.__assign({}, authComponentListInfo), { oauth2ClientInfo: oauth2ClientInfo, onAuthSuccess: onAuthSuccess, error: error, onError: function (err) {
                setError(err);
        ...
        return utils.__generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    ...
                    firstFactors = (_c = (_a = factorListState !== null && factorListState !== void 0 ? factorListState : loadedDynamicLoginMethods === null || loadedDynamicLoginMethods === void 0 ? void 0 : loadedDynamicLoginMethods.firstFactors) !== null && _a !== void 0 ? _a : (_b = recipe$1.MultiFactorAuth.getInstance()) === null || _b === void 0 ? void 0 : _b.config.firstFactors) !== null && _c !== void 0 ? _c : authRecipesInited.reduce(function (acc, recipe) { return utils.__spreadArray(utils.__spreadArray([], acc, true), recipe.getFirstFactorsForAuthPage(), true); }, []);
...
function chooseComponentBasedOnFirstFactors(firstFactors, routeComponents) {
        ...
        if (firstFactors.every(function (factor) { return factorsProvided.includes(factor); })) {
            ...
            if (matchingComp) {
                ...
                if (firstFactors.length === factorsProvided.length) {
                    utils.logDebugMessage("Rendering ".concat(rid, " because it matches factors: ").concat(firstFactors, " exactly"));
    ...
    */
    ...
    utils.logDebugMessage("Choosing component using fallback logic w/ ".concat(enabledLoginMethods.join(", "), " enabled"));
...
function getSuperTokensRoutesForReactRouterDom$1(_a) {
    ...
    var routes = Object.values(recipeList.reduce(function (routes, recipe) {
        ...
        Object.keys(pathsToFeatureComponentWithRecipeIdMap).forEach(function (path) {
            ...
            if (!(path in routes)) {
                routes[path] = (jsxRuntime.jsx(Route, utils.__assign({ exact: true, path: pathForRouter }, { children: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }), "st-".concat(path)));
            }
        });
        return routes;
    }, {}));
    ...
    for (var _i = 0, pluginRouteHandlers_1 = pluginRouteHandlers; _i < pluginRouteHandlers_1.length; _i++) {
        ...
        routes.push(jsxRuntime.jsx(Route, utils.__assign({ exact: true, path: path }, { children: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }), "st-plugin-".concat(path)));
    }
    if (!superTokens.SuperTokens.getInstanceOrThrow().disableAuthRoute &&
        ...
        routes.push(jsxRuntime.jsx(Route, utils.__assign({ exact: true, path: getPathForRouter$1(basePath, path) }, { children: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }), "st-/auth"));
    }
    return routes;
}
...
var UI = /** @class */ (function () {
    ...
    UI.canHandleRoute = function (preBuiltUiClassList) {
        ...
        return (RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList(utils.getCurrentNormalisedUrlPath(), recipeList, true) !== undefined);
    };
    UI.getRoutingComponent = function (preBuiltUiClassList) {
        var recipeList = preBuiltUiClassList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); });
        return (jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: UI.getReactRouterDomWithCustomHistory, path: utils.getCurrentNormalisedUrlPath().getAsStringDangerous(), preBuiltUIList: recipeList }));
    };
    ...
    UI.AuthPage = function (props) { return (jsxRuntime.jsx(AuthPageWrapper, utils.__assign({}, props, { preBuiltUIList: props.preBuiltUIList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); }) }))); };
...
var SessionAuth = function (_a) {
    var _b;
    var children = _a.children, props = utils.__rest(_a, ["children"]);
    ...
    var buildContext = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
    ...
    var setInitialContextAndMaybeRedirect = React.useCallback(function (toSetContext) { return utils.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 7:
                    if (props.accessDeniedScreen !== undefined && failureRedirectInfo.failedClaim !== undefined) {
                        ...
                        return [2 /*return*/, setContextIfChanged(utils.__assign(utils.__assign({}, toSetContext), { accessDeniedValidatorError: failureRedirectInfo.failedClaim }))];
                    }
                    _a.label = 8;
                case 8:
                    setContextIfChanged(toSetContext);
                ...
                return utils.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            setContextIfChanged(utils.__assign(utils.__assign({}, event.sessionContext), { loading: false, invalidClaims: invalidClaims }));
                            return [3 /*break*/, 7];
                        ...
                        case 9:
                            if (props.accessDeniedScreen !== undefined && failureRedirectInfo.failedClaim !== undefined) {
                                ...
                                return [2 /*return*/, setContextIfChanged(utils.__assign(utils.__assign({}, event.sessionContext), { loading: false, invalidClaims: invalidClaims, accessDeniedValidatorError: failureRedirectInfo.failedClaim }))];
                            }
                            _b.label = 10;
                        case 10:
                            setContextIfChanged(utils.__assign(utils.__assign({}, event.sessionContext), { loading: false, invalidClaims: invalidClaims }));
                            return [2 /*return*/];
                        case 11:
                            setContextIfChanged(utils.__assign(utils.__assign({}, event.sessionContext), { loading: false, invalidClaims: [] }));
                            return [2 /*return*/];
                        case 12:
                            setContextIfChanged(utils.__assign(utils.__assign({}, event.sessionContext), { loading: false, invalidClaims: [] }));
...
var SessionAuthWrapper = function (props) {
    return (jsxRuntime.jsx(UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(SessionAuth, utils.__assign({}, props)) })));
};
...
var SuperTokensAPIWrapper = /** @class */ (function () {
    ...
    SuperTokensAPIWrapper.redirectToAuth = function (options) { return utils.__awaiter(void 0, void 0, void 0, function () {
        var _b;
        return utils.__generator(_a, function (_c) {
            return [2 /*return*/, superTokens.SuperTokens.getInstanceOrThrow().redirectToAuth(utils.__assign(utils.__assign({}, options), { redirectBack: (_b = options === null || options === void 0 ? void 0 : options.redirectBack) !== null && _b !== void 0 ? _b : true, userContext: utils.getNormalisedUserContext(options === null || options === void 0 ? void 0 : options.userContext) }))];
        });
    }); };
