...
function RoutingComponent(props) {
    ...
    React.useEffect(function () {
        var handler = function () {
            if (
                loadedDynamicLoginMethods === false &&
                (componentToRender === null || componentToRender === void 0 ? void 0 : componentToRender.recipeID)
            ) {
                ...
                var enabled =
                    (dynamicLoginMethods === null || dynamicLoginMethods === void 0
                        ? void 0
                        : dynamicLoginMethods[
                              componentToRender === null || componentToRender === void 0
                                  ? void 0
                                  : componentToRender.recipeID
                          ]) !== undefined;
                if (enabled === false) {
                    for (var id in dynamicLoginMethods) {
...
var UI = /** @class */ (function () {
    ...
    UI.canHandleRoute = function (preBuiltUiClassList) {
        ...
        return (
            RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList(
                thirdparty.getCurrentNormalisedUrlPath(),
                recipeList
            ) !== undefined
        );
    };
    UI.getRoutingComponent = function (preBuiltUiClassList) {
        ...
        return jsxRuntime.jsx(RoutingComponent, {
            getReactRouterDomWithCustomHistory: UI.getReactRouterDomWithCustomHistory,
            path: thirdparty.getCurrentNormalisedUrlPath().getAsStringDangerous(),
            preBuiltUIList: recipeList,
        });
    };
