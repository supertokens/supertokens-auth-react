...
function chooseComponentBasedOnFirstFactors(firstFactors, routeComponents) {
    ...
    for (var _b = 0, priorityOrder_2 = priorityOrder; _b < priorityOrder_2.length; _b++) {
        var _c = priorityOrder_2[_b],
            rid = _c.rid,
            factorsProvided = _c.factorsProvided;
...
var RecipeRouter = /** @class */ (function () {
    ...
    RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList = function (
        ...
        // We first try to find an exact match
        for (var _i = 0, priorityOrder_3 = priorityOrder; _i < priorityOrder_3.length; _i++) {
            var _b = priorityOrder_3[_i],
                rid = _b.rid,
        ...
        for (var _c = 0, priorityOrder_4 = priorityOrder; _c < priorityOrder_4.length; _c++) {
            var _d = priorityOrder_4[_c],
                rid = _d.rid,
