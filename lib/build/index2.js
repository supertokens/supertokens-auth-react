...
function FeatureWrapper(_a) {
    ...
    var _c = React.useState(
            genericComponentOverrideContext.SuperTokens.usesDynamicLoginMethods === false ||
                genericComponentOverrideContext.Multitenancy.getInstanceOrThrow().getLoadedDynamicLoginMethods() !==
                    undefined
        ),
    ...
    React.useEffect(
        function () {
            ...
            if (
                ...
                void genericComponentOverrideContext.Multitenancy.getInstanceOrThrow()
            ...
            genericComponentOverrideContext.SuperTokens.uiController.on("LoginMethodsLoaded", handler);
        },
            ...
            genericComponentOverrideContext.__assign(
                ...
                },
                {
                    children: jsxRuntime.jsx(
                        ...
                        genericComponentOverrideContext.__assign({ useShadowDom: useShadowDom }, { children: children })
                    ),
                }
            )
        ),
...
// This is a special cased "feature" component: it's used
