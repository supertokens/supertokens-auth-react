...
function RoutingComponent(props) {
    ...
    var _c = React.useState(
            superTokens.SuperTokens.usesDynamicLoginMethods === false ||
                superTokens.Multitenancy.getInstanceOrThrow().dynamicLoginMethods !== undefined
        ),
    ...
    React.useEffect(function () {
        var handler = function () {
            ...
            if (
                ...
                if (enabled === false) {
                    for (var id in superTokens.Multitenancy.getInstanceOrThrow().dynamicLoginMethods) {
