...
function chooseComponentBasedOnFirstFactors(firstFactors, routeComponents, allowSubRecipeComp) {
    var fallbackRid;
    var fallbackComponent;
    var subRecipeRid;
    var subRecipeComponent;
    var _loop_1 = function (rid, factorsProvided) {
        if (
            ...
            allowSubRecipeComp &&
            factorsProvided.some(function (factor) {
                return firstFactors.includes(factor);
            })
        ) {
            var matchingComp = routeComponents.find(function (comp) {
                return comp.recipeID === rid;
    ...
    if (fallbackComponent === undefined) {
        if (subRecipeComponent) {
            genericComponentOverrideContext.logDebugMessage(
                "Rendering "
                    .concat(subRecipeRid, " because it overlaps factors: ")
                    .concat(firstFactors, " and we are not rendering the auth page")
            );
    ...
    genericComponentOverrideContext.logDebugMessage(
        "Rendering ".concat(fallbackRid, " to cover ").concat(firstFactors)
    );
...
var RecipeRouter = /** @class */ (function () {
    ...
    RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList = function (
        ...
        var enabledRecipeCount = Object.keys(dynamicLoginMethods).filter(function (key) {
            var _a;
            return ((_a = dynamicLoginMethods[key]) === null || _a === void 0 ? void 0 : _a.enabled) === true;
        }).length;
        ...
        for (var _i = 0, priorityOrder_2 = priorityOrder; _i < priorityOrder_2.length; _i++) {
            var _b = priorityOrder_2[_i],
                rid = _b.rid,
        ...
        for (var _c = 0, priorityOrder_3 = priorityOrder; _c < priorityOrder_3.length; _c++) {
            var _d = priorityOrder_3[_c],
                rid = _d.rid,
                ...
                switch (_b.label) {
                    case 0:
                        if (session.current === undefined) {
                            session.current = recipe$1.Session.getInstanceOrThrow();
                        }
                        return [
                            4 /*yield*/,
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                recipe$1.getFailureRedirectionInfo({
