...
var DynamicLoginMethodsProvider = function (_a) {
    ...
    return jsxRuntime.jsx(
        ...
        superTokens.__assign({ value: contextValue }, { children: children })
    );
};
...
var AuthPageHeader = withOverride("AuthPageHeader", function AuthPageHeader(_a) {
    var onSignInUpSwitcherClick = _a.onSignInUpSwitcherClick,
        ...
        clientAppName = _a.clientAppName;
    var t = translationContext.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsxs(
                ...
                superTokens.__assign(
                    { "data-supertokens": "headerTitle withBackButton" },
                    {
                        children: [
                            ...
                            clientAppName &&
                                "".concat(t("AUTH_PAGE_HEADER_TITLE_SIGN_IN_UP_TO_APP")).concat(t(clientAppName)),
...
var AuthPageInner = function (props) {
    ...
    React.useEffect(
        function () {
            ...
            var oauth2Recipe = recipe.OAuth2Provider.getInstance();
            if (oauth2Recipe !== undefined && loginChallenge !== null) {
                void recipe.OAuth2Provider.getInstanceOrThrow()
                    .webJSRecipe.getLoginChallengeInfo({ loginChallenge: loginChallenge, userContext: userContext })
                    .then(function (_a) {
                        var info = _a.info;
                        return setOAuth2ClientInfo(info);
                    });
            }
        },
    ...
    var onAuthSuccess = React.useCallback(
        function (ctx) {
            return types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                loginChallenge !== null
                    ? superTokens.__assign(superTokens.__assign({}, ctx), {
                          action: "SUCCESS_OAUTH2",
                          loginChallenge: loginChallenge,
                      })
                    : superTokens.__assign(superTokens.__assign({}, ctx), {
    ...
    var childProps =
        authComponentListInfo !== undefined && (loginChallenge === null || oauth2ClientInfo !== undefined)
            ? superTokens.__assign(superTokens.__assign({}, authComponentListInfo), {
                  clientAppName:
                      oauth2ClientInfo === null || oauth2ClientInfo === void 0 ? void 0 : oauth2ClientInfo.clientName,
...
function buildAndSetChildProps(
    ...
    return superTokens.__awaiter(this, void 0, void 0, function () {
        var authRecipesInited,
            ...
            partialAuthComps,
            selectedComponents;
        return superTokens.__generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                        ...
                        (_c =
                            ...
                            : authRecipesInited.reduce(function (acc, recipe) {
                                  return superTokens.__spreadArray(
                                      superTokens.__spreadArray([], acc, true),
