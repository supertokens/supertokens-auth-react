...
function FeatureWrapper(_a) {
    ...
    return jsxRuntime.jsx(
        ...
        genericComponentOverrideContext.__assign(
            ...
            {
                children: jsxRuntime.jsx(
                    recipe.TranslationContextProvider,
                    genericComponentOverrideContext.__assign(
                        {
            ...
            switch (_f.label) {
                case 0:
                    ...
                    if (firstFactors.includes(types.FactorIds.THIRDPARTY)) {
                        try {
                            thirdPartyRecipe = recipe.ThirdParty.getInstanceOrThrow();
                            if (
                                recipe.mergeProviders({
                                    tenantProviders:
                                        loadedDynamicLoginMethods === null || loadedDynamicLoginMethods === void 0
                                            ? void 0
                                            : loadedDynamicLoginMethods.thirdparty.providers,
