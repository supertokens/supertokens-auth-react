...
var withOverride = function (overrideKey, DefaultComponent) {
    ...
    return function (props) {
        ...
        if (OverrideComponent !== null) {
            return jsxRuntime.jsx(OverrideComponent, genericComponentOverrideContext.__assign({ DefaultComponent: DefaultComponent }, props));
        }
...
var DynamicLoginMethodsSpinnerTheme = function (props) {
    ...
    return (jsxRuntime.jsx(ThemeBase$1, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsxRuntime.jsx(DynamicLoginMethodsSpinnerThemeWithOverride, {}) })));
};
...
var DynamicLoginMethodsSpinner = function () {
    ...
    return (jsxRuntime.jsx(ComponentOverrideContext.Provider, genericComponentOverrideContext.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(WithOrWithoutShadowDom, genericComponentOverrideContext.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom }, { children: jsxRuntime.jsx(DynamicLoginMethodsSpinnerTheme, { config: recipe.config }) })) })));
};
...
var DynamicLoginMethodsProvider = function (_a) {
    ...
    return jsxRuntime.jsx(dynamicLoginMethodsContext.Provider, genericComponentOverrideContext.__assign({ value: contextValue }, { children: children }));
};
...
var UserContextProvider = function (_a) {
    ...
    return jsxRuntime.jsx(UserContextContext.Provider, genericComponentOverrideContext.__assign({ value: currentUserContext }, { children: children }));
};
...
function FeatureWrapper(_a) {
    ...
    var _b = React.useState(undefined), loadedDynamicLoginMethods = _b[0], setLoadedDynamicLoginMethods = _b[1];
    ...
    return (jsxRuntime.jsx(DynamicLoginMethodsProvider, genericComponentOverrideContext.__assign({ value: loadedDynamicLoginMethods }, { children: jsxRuntime.jsx(translationContext.TranslationContextProvider, genericComponentOverrideContext.__assign({ defaultLanguage: st.languageTranslations.defaultLanguage, defaultStore: genericComponentOverrideContext.mergeObjects(defaultStore, st.languageTranslations.userTranslationStore), translationControlEventSource: st.languageTranslations.translationEventSource, userTranslationFunc: st.languageTranslations.userTranslationFunc }, { children: jsxRuntime.jsx(WithOrWithoutShadowDom, genericComponentOverrideContext.__assign({ useShadowDom: useShadowDom }, { children: children })) })) })));
}
function WithShadowDom(_a) {
    ...
    return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ id: genericComponentOverrideContext.ST_ROOT_ID, ref: rootDiv }, { children: shadowRoot && reactDom.createPortal(children, shadowRoot) })));
}
function WithOrWithoutShadowDom(_a) {
    ...
    if (useShadowDom === false) {
        return (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ id: genericComponentOverrideContext.ST_ROOT_ID }, { children: [children, jsxRuntime.jsx(DisableAutoFillInput, {})] })));
    }
...
function DisableAutoFillInput() {
    ...
    return (jsxRuntime.jsx("style", genericComponentOverrideContext.__assign({ type: "text/css" }, { children: "input.supertokens-input:-webkit-autofill,input.supertokens-input:-webkit-autofill:focus,input.supertokens-input:-webkit-autofill:hover,select:-webkit-autofill,select:-webkit-autofill:focus,select:-webkit-autofill:hover,textarea:-webkit-autofill,textarea:-webkit-autofill:focus,textarea:-webkit-autofill:hover{transition:background-color 5000s ease-in-out 0s}" })));
...
var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext({}, "authRecipe"), useContext = _a[0], Provider = _a[1];

function SuperTokensBranding() {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs("a", genericComponentOverrideContext.__assign({ "data-supertokens": "superTokensBranding", href: "https://supertokens.com?utm_campaign=poweredby", target: "_blank" }, { children: [t("BRANDING_POWERED_BY_START"), jsxRuntime.jsx("strong", { children: "SuperTokens" }), t("BRANDING_POWERED_BY_END")] })));
}
...
function UserContextWrapper(props) {
    ...
    if (props.userContext !== undefined) {
        return jsxRuntime.jsx(UserContextProvider, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: props.children }));
    }
    return (jsxRuntime.jsx(UserContextContext.Consumer, { children: function (value) {
            /**
...
function GeneralError(_a) {
    var error = _a.error;
    var t = translationContext.useTranslation();
    return jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "generalError" }, { children: t(error) }));
}
...
function AuthPageTheme(props) {
    if (props.fullPageCompWithPreloadedInfo) {
        return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: props.fullPageCompWithPreloadedInfo.component(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, props), { preloadInfo: props.fullPageCompWithPreloadedInfo.preloadInfo, showBackButton: props.showBackButton })) }));
    }
...
function AuthPageThemeWrapper(props) {
    var rootStyle = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().rootStyle;
    return (jsxRuntime.jsx(UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle] }, { children: jsxRuntime.jsx(AuthPageTheme, genericComponentOverrideContext.__assign({}, props)) })) })));
}
...
var AuthPageInner = function (props) {
    ...
    var userContext = useUserContext();
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    var _f = React.useState(undefined), loadedDynamicLoginMethods = _f[0], setLoadedDynamicLoginMethods = _f[1];
    var _g = React.useState(undefined), oauth2ClientInfo = _g[0], setOAuth2ClientInfo = _g[1];
    ...
    var _l = React.useState((_e = (_d = props.isSignUp) !== null && _d !== void 0 ? _d : isSignUpFromQS) !== null && _e !== void 0 ? _e : st.defaultToSignUp), isSignUp = _l[0], setIsSignUp = _l[1];
    ...
    var onSignInUpSwitcherClick = React.useCallback(function () {
    ...
    genericComponentOverrideContext.useOnMountAPICall(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        var oauth2Recipe;
    ...
    }); }, function (info) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        return genericComponentOverrideContext.__generator(this, function (_a) {
            if (info !== undefined) {
                if (info.status === "OK") {
                ...
                if (props.onSessionAlreadyExists !== undefined) {
                    ...
                    if (loginChallenge !== null && oauth2Recipe_1 !== undefined) {
                                ...
                                return genericComponentOverrideContext.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection({
                                                ...
                                                }, types.Session.RECIPE_ID, genericComponentOverrideContext.getRedirectToPathFromURL(), userContext, props.navigate)];
                                    }
                                });
                            });
                        ...
                        void types.Session.getInstanceOrThrow()
                            .validateGlobalClaimsAndHandleSuccessRedirection(undefined, types.Session.RECIPE_ID, genericComponentOverrideContext.getRedirectToPathFromURL(), userContext, props.navigate)
                            .catch(rethrowInRender);
                    }
                }
                else {
    ...
    var onAuthSuccess = React.useCallback(function (ctx) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (loginChallenge === null || oauth2Recipe === undefined) {
                        return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, ctx), { action: "SUCCESS", tenantIdFromQueryParams: genericComponentOverrideContext.getTenantIdFromQueryParams(), redirectToPath: genericComponentOverrideContext.getRedirectToPathFromURL() }), ctx.recipeId, genericComponentOverrideContext.getRedirectToPathFromURL(), userContext, props.navigate)];
                    }
                ...
                case 1:
                    frontendRedirectTo = (_a.sent()).frontendRedirectTo;
                    return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, ctx), { action: "SUCCESS_OAUTH2", tenantIdFromQueryParams: genericComponentOverrideContext.getTenantIdFromQueryParams(), frontendRedirectTo: frontendRedirectTo }), ctx.recipeId, genericComponentOverrideContext.getRedirectToPathFromURL(), userContext, props.navigate)];
            }
        });
    }); }, [loginChallenge]);
    var childProps = authComponentListInfo !== undefined &&
        ...
        ? genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, authComponentListInfo), { oauth2ClientInfo: oauth2ClientInfo, onAuthSuccess: onAuthSuccess, error: error, onError: function (err) {
                setError(err);
    ...
    var mergedTranslations = React.useMemo(function () {
        var res = genericComponentOverrideContext.defaultTranslationsCommon;
...
function buildAndSetChildProps(recipeRouters, loadedDynamicLoginMethods, userContext, factorListState, isSignUpState, setComponentListInfo, abort) {
    ...
    return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
        ...
        return genericComponentOverrideContext.__generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    authRecipesInited = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().recipeList.filter(function (recipe) { return "firstFactorIds" in recipe; });
                    firstFactors = (_c = (_a = factorListState !== null && factorListState !== void 0 ? factorListState : loadedDynamicLoginMethods === null || loadedDynamicLoginMethods === void 0 ? void 0 : loadedDynamicLoginMethods.firstFactors) !== null && _a !== void 0 ? _a : (_b = recipe$1.MultiFactorAuth.getInstance()) === null || _b === void 0 ? void 0 : _b.config.firstFactors) !== null && _c !== void 0 ? _c : authRecipesInited.reduce(function (acc, recipe) { return genericComponentOverrideContext.__spreadArray(genericComponentOverrideContext.__spreadArray([], acc, true), recipe.getFirstFactorsForAuthPage(), true); }, []);
                    if (factorListState === undefined &&
                        ...
                        ((_d = recipe$1.MultiFactorAuth.getInstance()) === null || _d === void 0 ? void 0 : _d.config.firstFactors) === undefined) {
                    ...
                    if (firstFactors.includes(types.FactorIds.THIRDPARTY)) {
                        thirdPartyPreBuiltUI = recipeRouters.find(function (r) { return r.recipeInstance.recipeID === types.FactorIds.THIRDPARTY; });
                        ...
                        if (thirdPartyPreBuiltUI !== undefined) {
                            ...
                            if (thirdPartyPreBuiltUI.recipeInstance.config.signInAndUpFeature.providers.length === 0 &&
                                (!genericComponentOverrideContext.SuperTokens.usesDynamicLoginMethods || loadedDynamicLoginMethods.thirdparty.providers.length === 0)) {
                                firstFactors = firstFactors.filter(function (f) { return f !== types.FactorIds.THIRDPARTY; });
                                if (firstFactors.length === 0) {
                    ...
                    if (selectedComponents === undefined) {
                        ...
                        source = factorListState !== undefined
                            ...
                            : (loadedDynamicLoginMethods === null || loadedDynamicLoginMethods === void 0 ? void 0 : loadedDynamicLoginMethods.firstFactors) !== undefined
                                ...
                                : ((_e = recipe$1.MultiFactorAuth.getInstance()) === null || _e === void 0 ? void 0 : _e.config.firstFactors) !== undefined
...
var priorityOrder = [
    ...
    { rid: "emailpassword", includes: ["emailpassword"], factorsProvided: [types.FactorIds.EMAILPASSWORD] },
    {
        ...
        factorsProvided: [types.FactorIds.OTP_PHONE, types.FactorIds.OTP_EMAIL, types.FactorIds.LINK_PHONE, types.FactorIds.LINK_EMAIL],
    },
...
function chooseComponentBasedOnFirstFactors(firstFactors, routeComponents) {
    ...
    var _loop_1 = function (rid, factorsProvided) {
        if (firstFactors.every(function (factor) { return factorsProvided.includes(factor); })) {
            var matchingComp = routeComponents.find(function (comp) { return comp.recipeID === rid; });
            if (matchingComp) {
                fallbackRid = rid;
                fallbackComponent = matchingComp;
                if (firstFactors.length === factorsProvided.length) {
                    genericComponentOverrideContext.logDebugMessage("Rendering ".concat(rid, " because it matches factors: ").concat(firstFactors, " exactly"));
    ...
    */
    ...
    if (fallbackComponent !== undefined) {
        genericComponentOverrideContext.logDebugMessage("Rendering ".concat(fallbackRid, " to cover ").concat(firstFactors, " as a fallback"));
    ...
    if ([types.FactorIds.OTP_PHONE, types.FactorIds.OTP_EMAIL, types.FactorIds.LINK_PHONE, types.FactorIds.LINK_EMAIL].some(function (pwlessFactorId) {
        return firstFactors.includes(pwlessFactorId);
    })) {
        enabledLoginMethods.push("passwordless");
    }
    genericComponentOverrideContext.logDebugMessage("Choosing component using fallback logic w/ ".concat(enabledLoginMethods.join(", "), " enabled"));
    var enabledRecipeCount = enabledLoginMethods.length;
    var _loop_2 = function (rid, includes) {
        if (enabledRecipeCount === includes.length &&
            includes.every(function (subRId) { return enabledLoginMethods.includes(subRId); })) {
            var matchingComp = routeComponents.find(function (comp) { return comp.recipeID === rid; });
            if (matchingComp) {
                return { value: matchingComp };
            }
    ...
    var _loop_3 = function (rid, includes) {
        if (includes.some(function (subRId) { return enabledLoginMethods.includes(subRId); })) {
            var matchingComp = routeComponents.find(function (comp) { return comp.recipeID === rid; });
            if (matchingComp) {
                return { value: matchingComp };
            }
...
var RecipeRouter = /** @class */ (function () {
    ...
    RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList = function (normalisedUrl, preBuiltUIList, defaultToStaticList, dynamicLoginMethods) {
        ...
        var routeComponents = preBuiltUIList.reduce(function (components, c) {
            ...
            var _loop_4 = function (routePath, routeComps) {
                if (routePath === path ||
                    ...
                    components = components.concat(routeComps.map(function (c) {
        ...
        var componentMatchingRid = routeComponents.find(function (c) { return c.comp.matches(); });
        ...
        var matchingNonAuthComponent = routeComponents.find(function (comp) {
            var ridlist = priorityOrder.map(function (a) { return a.rid; });
            return (!ridlist.includes(comp.comp.recipeID) ||
                comp.route !== genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().appInfo.websiteBasePath.getAsStringDangerous());
        });
        ...
        if (genericComponentOverrideContext.SuperTokens.usesDynamicLoginMethods === false) {
            ...
            if (isAuthPage && mfaRecipe && mfaRecipe.config.firstFactors !== undefined) {
                return chooseComponentBasedOnFirstFactors(mfaRecipe.config.firstFactors, routeComponents.map(function (c) { return c.comp; }));
            }
            else {
                return defaultComp;
            }
        ...
        if (dynamicLoginMethods === undefined) {
            throw new Error("Should never come here: dynamic login methods info has not been loaded but recipeRouter rendered");
        }
        ...
        if (componentMatchingRid && // if we find a component matching by rid
            (!priorityOrder.map(function (a) { return a.rid; }).includes(componentMatchingRid.comp.recipeID) || // from a non-auth recipe
                priorityOrder.some(function (a) {
                    return a.rid === componentMatchingRid.comp.recipeID &&
                        a.factorsProvided.some(function (factorId) { return dynamicLoginMethods.firstFactors.includes(factorId); });
        ...
        // Embedded components are not affected, since this is only called by the routing component.
        if (isAuthPage) {
            return chooseComponentBasedOnFirstFactors(dynamicLoginMethods.firstFactors, routeComponents.map(function (c) { return c.comp; }));
        }
        return undefined;
    };
    return RecipeRouter;
...
function RoutingComponent(props) {
    ...
    var userContext = useUserContext();
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    var _c = React.useState(undefined), loadedDynamicLoginMethods = _c[0], setLoadedDynamicLoginMethods = _c[1];
    var navigate = (_a = props.getReactRouterDomWithCustomHistory()) === null || _a === void 0 ? void 0 : _a.useHistoryCustom();
    var path = props.path;
    var isAuthPage = path === genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().appInfo.websiteBasePath.getAsStringDangerous();
    var pluginRouteHandlers = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().pluginRouteHandlers;
    var location = (_b = props.getReactRouterDomWithCustomHistory()) === null || _b === void 0 ? void 0 : _b.useLocation();
    var componentToRender = React__default.default.useMemo(function () {
        if (isAuthPage) {
            return;
        }
        var normalizedPath = new NormalisedURLPath__default.default(path);
        var matchingPluginRouteHandler = pluginRouteHandlers.find(function (handler) { return handler.path === path; });
        ...
        if (loadedDynamicLoginMethods !== undefined || genericComponentOverrideContext.SuperTokens.usesDynamicLoginMethods === false) {
    ...
    if (isAuthPage) {
        return (jsxRuntime.jsx(AuthPageWrapper, { preBuiltUIList: props.preBuiltUIList, navigate: navigate, useSignUpStateFromQueryString: true }));
    }
    if (genericComponentOverrideContext.SuperTokens.usesDynamicLoginMethods && loadedDynamicLoginMethods === undefined) {
        return jsxRuntime.jsx(DynamicLoginMethodsSpinner, {});
    }
...
function getSuperTokensRoutesForReactRouterDom$1(_a) {
    ...
    var routes = Object.values(recipeList.reduce(function (routes, recipe) {
        ...
        Object.keys(pathsToFeatureComponentWithRecipeIdMap).forEach(function (path) {
            ...
            if (!(path in routes)) {
                routes[path] = (jsxRuntime.jsx(Route, genericComponentOverrideContext.__assign({ exact: true, path: pathForRouter }, { children: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }), "st-".concat(path)));
            }
        });
        return routes;
    }, {}));
    ...
    for (var _i = 0, pluginRouteHandlers_1 = pluginRouteHandlers; _i < pluginRouteHandlers_1.length; _i++) {
        ...
        routes.push(jsxRuntime.jsx(Route, genericComponentOverrideContext.__assign({ exact: true, path: path }, { children: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }), "st-plugin-".concat(path)));
    }
    if (!genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().disableAuthRoute &&
        ...
        routes.push(jsxRuntime.jsx(Route, genericComponentOverrideContext.__assign({ exact: true, path: getPathForRouter$1(basePath, path) }, { children: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }), "st-/auth"));
    }
    return routes;
}
...
function getSuperTokensRoutesForReactRouterDomV6(_a) {
    ...
    var routes = Object.values(recipeList.reduce(function (routes, recipe) {
        ...
        Object.keys(pathsToFeatureComponentWithRecipeIdMap).forEach(function (path) {
            ...
            if (!(path in routes)) {
                routes[path] = (jsxRuntime.jsx(Route, { path: pathForRouter, element: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }, "st-".concat(path)));
            }
        });
        return routes;
    }, {}));
    ...
    for (var _i = 0, pluginRouteHandlers_1 = pluginRouteHandlers; _i < pluginRouteHandlers_1.length; _i++) {
        var handler = pluginRouteHandlers_1[_i];
        var path = handler.path;
        routes.push(jsxRuntime.jsx(Route, { path: path, element: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }, "st-plugin-".concat(path)));
    }
    if (!genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().disableAuthRoute &&
        recipeList.some(function (ui) { return ui.getAuthComponents().length !== 0; })) {
        var path = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow()
            .appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default$1.default("/"))
            .getAsStringDangerous();
        routes.push(jsxRuntime.jsx(Route, { path: getPathForRouter(basePath, path), element: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }, "st-/auth"));
    }
    return routes;
}
...
var UI = /** @class */ (function () {
    ...
    UI.getSuperTokensRoutesForReactRouterDom = function (reactRouterDom, preBuiltUiClassList, basePath) {
        if (preBuiltUiClassList === void 0) { preBuiltUiClassList = []; }
        ...
        var recipeList = preBuiltUiClassList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); });
        ...
        if (UI.reactRouterDomIsV6) {
            if (UI.reactRouterDom === undefined) {
                ...
                var useNavigateHookForRRDV6 = function () {
                    ...
                    var _a = React__default.default.useState(undefined), to = _a[0], setTo = _a[1];
    ...
    UI.canHandleRoute = function (preBuiltUiClassList) {
        ...
        return (RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList(genericComponentOverrideContext.getCurrentNormalisedUrlPath(), recipeList, true) !== undefined);
    };
    UI.getRoutingComponent = function (preBuiltUiClassList) {
        var recipeList = preBuiltUiClassList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); });
        return (jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: UI.getReactRouterDomWithCustomHistory, path: genericComponentOverrideContext.getCurrentNormalisedUrlPath().getAsStringDangerous(), preBuiltUIList: recipeList }));
    };
    UI.languageTranslations = genericComponentOverrideContext.defaultTranslationsCommon;
    UI.getReactRouterDomWithCustomHistory = function () {
        return UI.reactRouterDom;
    };
    UI.AuthPage = function (props) { return (jsxRuntime.jsx(AuthPageWrapper, genericComponentOverrideContext.__assign({}, props, { preBuiltUIList: props.preBuiltUIList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); }) }))); };
...
var SessionAuth = function (_a) {
    ...
    var setContextIfChanged = React.useCallback(function (newValue) {
    ...
    var navigateHookRef = React.useRef((_b = UI.getReactRouterDomWithCustomHistory()) === null || _b === void 0 ? void 0 : _b.useHistoryCustom);
    var navigate;
    try {
    ...
    var redirectToLogin = React.useCallback(function () {
        void genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirectToAuth({ navigate: navigate, userContext: userContext, redirectBack: true });
    }, []);
    var buildContext = React.useCallback(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
    ...
    var setInitialContextAndMaybeRedirect = React.useCallback(function (toSetContext) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        ...
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, types.getFailureRedirectionInfo({
                ...
                case 2:
                    ...
                    if (!types.validateAndCompareOnFailureRedirectionURLToCurrent(failureRedirectInfo.redirectPath)) return [3 /*break*/, 3];
                    setContextIfChanged(toSetContext);
                    return [2 /*return*/];
                case 3: return [4 /*yield*/, genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirectToUrl(failureRedirectInfo.redirectPath, navigate)];
                ...
                case 7:
                    if (props.accessDeniedScreen !== undefined && failureRedirectInfo.failedClaim !== undefined) {
                        ...
                        return [2 /*return*/, setContextIfChanged(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, toSetContext), { accessDeniedValidatorError: failureRedirectInfo.failedClaim }))];
                    }
                    _a.label = 8;
                case 8:
                    setContextIfChanged(toSetContext);
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            if (!types.validateAndCompareOnFailureRedirectionURLToCurrent(failureRedirectInfo.redirectPath)) return [3 /*break*/, 5];
                            setContextIfChanged(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, event.sessionContext), { loading: false, invalidClaims: invalidClaims }));
                            return [3 /*break*/, 7];
                        case 5: return [4 /*yield*/, genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirectToUrl(failureRedirectInfo.redirectPath, navigate)];
                        ...
                        case 9:
                            if (props.accessDeniedScreen !== undefined && failureRedirectInfo.failedClaim !== undefined) {
                                ...
                                return [2 /*return*/, setContextIfChanged(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, event.sessionContext), { loading: false, invalidClaims: invalidClaims, accessDeniedValidatorError: failureRedirectInfo.failedClaim }))];
                            }
                            _b.label = 10;
                        case 10:
                            setContextIfChanged(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, event.sessionContext), { loading: false, invalidClaims: invalidClaims }));
                            return [2 /*return*/];
                        case 11:
                            setContextIfChanged(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, event.sessionContext), { loading: false, invalidClaims: [] }));
                            return [2 /*return*/];
                        case 12:
                            setContextIfChanged(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, event.sessionContext), { loading: false, invalidClaims: [] }));
    ...
    if (!context.loading && context.accessDeniedValidatorError && props.accessDeniedScreen) {
        return (jsxRuntime.jsx(props.accessDeniedScreen, { userContext: userContext, navigate: navigate, validationError: context.accessDeniedValidatorError }));
    }
    return jsxRuntime.jsx(SessionContext.Provider, genericComponentOverrideContext.__assign({ value: context }, { children: children }));
};
var SessionAuthWrapper = function (props) {
    return (jsxRuntime.jsx(UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(SessionAuth, genericComponentOverrideContext.__assign({}, props)) })));
};

var SuperTokensWrapper = function (props) {
    return jsxRuntime.jsx(SessionAuthWrapper, genericComponentOverrideContext.__assign({}, props, { requireAuth: false, doRedirection: false }));
};
