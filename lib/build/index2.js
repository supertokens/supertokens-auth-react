...
function AuthPageTheme(props) {
    if (props.fullPageCompWithPreloadedInfo) {
        return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: props.fullPageCompWithPreloadedInfo.component(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, props), { preloadInfo: props.fullPageCompWithPreloadedInfo.preloadInfo })) }));
    }
