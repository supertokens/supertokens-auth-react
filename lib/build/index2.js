...
function chooseComponentBasedOnFirstFactors(firstFactors, routeComponents) {
    ...
    var _loop_1 = function (rid, factorsProvided) {
        if (
            ...
            factorsProvided.every(function (factor) {
    ...
    var _loop_2 = function (rid, factorsProvided) {
    ...
    for (var _b = 0, _c = priorityOrder.reverse(); _b < _c.length; _b++) {
        var _d = _c[_b],
            rid = _d.rid,
            factorsProvided = _d.factorsProvided;
        _loop_2(rid, factorsProvided);
    }
    return component;
}
var RecipeRouter = /** @class */ (function () {
    ...
    RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList = function (
        ...
        for (var _i = 0, priorityOrder_2 = priorityOrder; _i < priorityOrder_2.length; _i++) {
            ...
            var state_2 = _loop_3(rid, includes);
            if (typeof state_2 === "object") return state_2.value;
        }
        var _loop_4 = function (rid, includes) {
            if (
        ...
        for (var _c = 0, priorityOrder_3 = priorityOrder; _c < priorityOrder_3.length; _c++) {
            ...
            var state_3 = _loop_4(rid, includes);
