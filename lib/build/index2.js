...
var DynamicLoginMethodsSpinner = function () {
    ...
    return (jsxRuntime.jsx(ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(WithOrWithoutShadowDom, logger.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom }, { children: jsxRuntime.jsx(DynamicLoginMethodsSpinnerTheme, { config: recipe.config }) })) })));
};
...
function WithShadowDom(_a) {
    ...
    return (jsxRuntime.jsx("div", logger.__assign({ id: superTokens.ST_ROOT_ID, ref: rootDiv }, { children: shadowRoot && reactDom.createPortal(children, shadowRoot) })));
}
function WithOrWithoutShadowDom(_a) {
    ...
    if (useShadowDom === false) {
        return (jsxRuntime.jsxs("div", logger.__assign({ id: superTokens.ST_ROOT_ID }, { children: [children, jsxRuntime.jsx(DisableAutoFillInput, {})] })));
    }
...
var AuthPageInner = function (props) {
    ...
    superTokens.useOnMountAPICall(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        var oauth2Recipe;
        ...
        superTokens.clearQueryParams(["loginChallenge"]);
        setError("SOMETHING_WENT_WRONG_ERROR");
    });
    React.useEffect(function () {
                ...
                if (props.onSessionAlreadyExists !== undefined) {
                    ...
                    if (loginChallenge !== null && oauth2Recipe_1 !== undefined) {
                                    ...
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection({
                                                ...
                                                }, types.Session.RECIPE_ID, superTokens.getRedirectToPathFromURL(), userContext, props.navigate)];
                                    }
                                });
                            });
                        ...
                        void types.Session.getInstanceOrThrow()
                            .validateGlobalClaimsAndHandleSuccessRedirection(undefined, types.Session.RECIPE_ID, superTokens.getRedirectToPathFromURL(), userContext, props.navigate)
                            .catch(rethrowInRender);
                    }
                }
                else {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (loginChallenge === null || oauth2Recipe === undefined) {
                        return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(logger.__assign(logger.__assign({}, ctx), { action: "SUCCESS", tenantIdFromQueryParams: superTokens.getTenantIdFromQueryParams(), redirectToPath: superTokens.getRedirectToPathFromURL() }), ctx.recipeId, superTokens.getRedirectToPathFromURL(), userContext, props.navigate)];
                    }
                ...
                case 1:
                    frontendRedirectTo = (_a.sent()).frontendRedirectTo;
                    return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(logger.__assign(logger.__assign({}, ctx), { action: "SUCCESS_OAUTH2", tenantIdFromQueryParams: superTokens.getTenantIdFromQueryParams(), frontendRedirectTo: frontendRedirectTo }), ctx.recipeId, superTokens.getRedirectToPathFromURL(), userContext, props.navigate)];
            }
        });
    }); }, [loginChallenge]);
    ...
    var mergedTranslations = React.useMemo(function () {
        ...
        if (authComponentListInfo !== undefined) {
            for (var _i = 0, _a = props.preBuiltUIList; _i < _a.length; _i++) {
                var ui = _a[_i];
                res = superTokens.mergeObjects(res, ui.languageTranslations);
            }
        }
        res = superTokens.mergeObjects(res, st.languageTranslations.userTranslationStore);
        return res;
...
function buildAndSetChildProps(recipeRouters, loadedDynamicLoginMethods, userContext, factorListState, isSignUpState, setComponentListInfo, abort) {
    ...
    return logger.__awaiter(this, void 0, void 0, function () {
        ...
        return logger.__generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    authRecipesInited = superTokens.SuperTokens.getInstanceOrThrow().recipeList.filter(function (recipe) { return "firstFactorIds" in recipe; });
                    ...
                    if (firstFactors.includes(types.FactorIds.THIRDPARTY)) {
                        ...
                        if (thirdPartyPreBuiltUI !== undefined) {
                            ...
                            if (thirdPartyPreBuiltUI.recipeInstance.config.signInAndUpFeature.providers.length === 0 &&
                                (!superTokens.SuperTokens.usesDynamicLoginMethods || loadedDynamicLoginMethods.thirdparty.providers.length === 0)) {
...
var RecipeRouter = /** @class */ (function () {
    ...
    RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList = function (normalisedUrl, preBuiltUIList, defaultToStaticList, dynamicLoginMethods) {
        ...
        var isAuthPage = path === superTokens.SuperTokens.getInstanceOrThrow().appInfo.websiteBasePath.getAsStringDangerous();
        ...
        var matchingNonAuthComponent = routeComponents.find(function (comp) {
            ...
            return (!ridlist.includes(comp.comp.recipeID) ||
                comp.route !== superTokens.SuperTokens.getInstanceOrThrow().appInfo.websiteBasePath.getAsStringDangerous());
        });
...
function getSuperTokensRoutesForReactRouterDom$1(_a) {
    ...
    if (!superTokens.SuperTokens.getInstanceOrThrow().disableAuthRoute &&
...
var UI = /** @class */ (function () {
    ...
    UI.canHandleRoute = function (preBuiltUiClassList) {
        var recipeList = preBuiltUiClassList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); });
        var path = superTokens.getCurrentNormalisedUrlPath().getAsStringDangerous();
        var isAuthPage = path === superTokens.SuperTokens.getInstanceOrThrow().appInfo.websiteBasePath.getAsStringDangerous();
        if (isAuthPage) {
            return !superTokens.SuperTokens.getInstanceOrThrow().disableAuthRoute;
        }
        return (RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList(superTokens.getCurrentNormalisedUrlPath(), recipeList, true) !== undefined);
    };
    UI.getRoutingComponent = function (preBuiltUiClassList) {
        var recipeList = preBuiltUiClassList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); });
        return (jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: UI.getReactRouterDomWithCustomHistory, path: superTokens.getCurrentNormalisedUrlPath().getAsStringDangerous(), preBuiltUIList: recipeList }));
    };
...
var SessionAuth = function (_a) {
    ...
    var redirectToLogin = React.useCallback(function () {
        void superTokens.SuperTokens.getInstanceOrThrow().redirectToAuth({ navigate: navigate, userContext: userContext, redirectBack: true });
    }, []);
        ...
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/];
                case 3: return [4 /*yield*/, superTokens.SuperTokens.getInstanceOrThrow().redirectToUrl(failureRedirectInfo.redirectPath, navigate)];
                ...
                return logger.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            return [3 /*break*/, 7];
                        case 5: return [4 /*yield*/, superTokens.SuperTokens.getInstanceOrThrow().redirectToUrl(failureRedirectInfo.redirectPath, navigate)];
...
var SuperTokensAPIWrapper = /** @class */ (function () {
    ...
    SuperTokensAPIWrapper.redirectToAuth = function (options) { return logger.__awaiter(void 0, void 0, void 0, function () {
        ...
        return logger.__generator(_a, function (_c) {
            return [2 /*return*/, superTokens.SuperTokens.getInstanceOrThrow().redirectToAuth(logger.__assign(logger.__assign({}, options), { redirectBack: (_b = options === null || options === void 0 ? void 0 : options.redirectBack) !== null && _b !== void 0 ? _b : true, userContext: superTokens.getNormalisedUserContext(options === null || options === void 0 ? void 0 : options.userContext) }))];
        });
    }); };
