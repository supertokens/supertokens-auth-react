        ...
        children: [
            jsxRuntime.jsx(
                ...
                genericComponentOverrideContext.__assign(
                    { "data-supertokens": "headerTitle" },
                    {
                        children: !hasSeparateSignUpView
...
function AuthPageTheme(props) {
    var t = translationContext.useTranslation();
    var authCompList = React.useMemo(
        function () {
    ...
    return jsxRuntime.jsxs(
        "div",
        genericComponentOverrideContext.__assign(
            { "data-supertokens": "container auth-page" },
            {
                children: [
                    jsxRuntime.jsxs(
                        "div",
...
var AuthPageInner = function (props) {
    ...
    var factorsStringFromQS = search.get("factors");
    var factorListFromQS = factorsStringFromQS ? factorsStringFromQS.split(",") : undefined;
    var signUpStringFromQS = search.get("signUp");
    var isSignUpFromQS =
    ...
    var _h = React.useState(false),
        sessionLoadedAndDidNotExist = _h[0],
        setSessionLoadedAndDidNotExist = _h[1];
    var st = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow();
    ...
    var onSignInUpSwitcherClick = React.useCallback(
        function () {
            genericComponentOverrideContext.updateQueryParam("signUp", isSignUp ? "false" : "true");
            setError(undefined);
        ...
        authComponentListInfo !== undefined
            ? genericComponentOverrideContext.__assign(
                  genericComponentOverrideContext.__assign({}, authComponentListInfo),
                  {
                      ...
                      showUseAnotherLink: showUseAnotherLink,
    ...
    var mergedTranslations = React.useMemo(
        function () {
            ...
            if (authComponentListInfo !== undefined) {
                for (var _i = 0, _a = authComponentListInfo.translations; _i < _a.length; _i++) {
                    var store = _a[_i];
                    res = genericComponentOverrideContext.mergeObjects(res, store);
                }
            }
...
function buildAndSetChildProps(
    ...
    return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
        ...
        return genericComponentOverrideContext.__generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    authRecipesInList = recipeRouters
                        .map(function (r) {
                            return r.recipeInstance;
                        })
                        .filter(function (router) {
                            return "firstFactorIds" in router;
                        });
                    firstFactors =
                        (_d =
                            (_b =
                                (_a =
                                    factorListState !== null && factorListState !== void 0
                                        ? factorListState
                                        : factorListFromQS) !== null && _a !== void 0
                                    ? _a
                                    : loadedDynamicLoginMethods === null || loadedDynamicLoginMethods === void 0
                                    ? void 0
                                    : loadedDynamicLoginMethods.firstFactors) !== null && _b !== void 0
                                ? _b
                                : (_c = recipe.MultiFactorAuth.getInstance()) === null || _c === void 0
                                ? void 0
                                : _c.config.firstFactors) !== null && _d !== void 0
                            ? _d
                            : authRecipesInList.reduce(function (acc, recipe) {
                ...
                case 4:
                    ...
                    setComponentListInfo({
                        ...
                        translations: selectedComponents.map(function (c) {
...
function RoutingComponent(props) {
    ...
    if (isAuthPage) {
        return jsxRuntime.jsx(AuthPageWrapper, { preBuiltUIList: props.preBuiltUIList, navigate: navigate });
    }
    if (
        genericComponentOverrideContext.SuperTokens.usesDynamicLoginMethods &&
        loadedDynamicLoginMethods === undefined
...
function getSuperTokensRoutesForReactRouterDom$1(_a) {
    ...
    if (
        recipeList.some(function (ui) {
            return ui.getAuthComponents().length !== 0 && ui.recipeInstance.getFirstFactorsForAuthPage().length !== 0;
        })
    ) {
...
var UI = /** @class */ (function () {
    ...
    UI.canHandleRoute = function (preBuiltUiClassList) {
        ...
        if (isAuthPage) {
            // TODO: cleanup
            return recipeList.some(function (v) {
                return v.getAuthComponents().length !== 0 && v.recipeInstance.getFirstFactorsForAuthPage().length !== 0;
            });
        }
        return (
