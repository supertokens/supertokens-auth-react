...
var _a$1 = genericComponentOverrideContext.createGenericComponentsOverrideContext(),
    useContext$1 = _a$1[0],
    Provider$1 = _a$1[1];
            ...
            jsxRuntime.jsxs(
                ...
                genericComponentOverrideContext.__assign(
                    { "data-supertokens": "headerTitle withBackButton" },
                    {
                        children: [
                            showBackButton
                                ? jsxRuntime.jsx(BackButton$1, { onClick: resetFactorList })
                                : jsxRuntime.jsx("span", {
...
var AuthPageWrapper = function (props) {
    var authRecipeComponentOverrides = useContext$1();
    return jsxRuntime.jsx(
        UserContextProvider,
        genericComponentOverrideContext.__assign(
            { userContext: props.userContext },
...
var AccessDeniedThemeWithOverride = withOverride("SessionAccessDenied", AccessDeniedScreen$2);
...
var defaultTranslationsSession = {
    en: genericComponentOverrideContext.__assign(
        genericComponentOverrideContext.__assign({}, defaultTranslationsCommon.en),
...
function RoutingComponent(props) {
        ...
        function () {
            ...
            genericComponentOverrideContext.Multitenancy.getInstanceOrThrow()
                ...
                .then(
                    ...
                    function (err) {
                        var translatedMessage = t("TENANT_LOGIN_METHODS_ERROR");
                        var message = "".concat(translatedMessage, ": ").concat(err.message);
                        if (err.status === 500) {
    ...
    if (errMsg !== undefined) {
        return jsxRuntime.jsx(AccessDeniedScreen, { error: errMsg });
    }
    if (isAuthPage) {
...
var UI = /** @class */ (function () {
    ...
    UI.AuthRecipeComponentsOverrideContextProvider = Provider$1;
    return UI;
})();
