...
var withOverride = function (overrideKey, DefaultComponent) {
    ...
    return function (props) {
        ...
        if (OverrideComponent !== null) {
            return jsxRuntime.jsx(OverrideComponent, logger.__assign({ DefaultComponent: DefaultComponent }, props));
        }
        return jsxRuntime.jsx(DefaultComponent, logger.__assign({}, props));
    };
};
...
var MultitenancyDynamicLoginMethodsSpinnerTheme = function () {
    return (jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "container delayedRender" }, { children: jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "row" }, { children: jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "spinner delayedRender" }, { children: jsxRuntime.jsx(SpinnerIcon, {}) })) })) })));
};
...
var DynamicLoginMethodsSpinnerTheme = function (props) {
    ...
    return (jsxRuntime.jsx(ThemeBase$1, logger.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsxRuntime.jsx(DynamicLoginMethodsSpinnerThemeWithOverride, {}) })));
};
...
var DynamicLoginMethodsSpinner = function () {
    ...
    return (jsxRuntime.jsx(ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(WithOrWithoutShadowDom, logger.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom }, { children: jsxRuntime.jsx(DynamicLoginMethodsSpinnerTheme, { config: recipe.config }) })) })));
};
...
var DynamicLoginMethodsProvider = function (_a) {
    ...
    return jsxRuntime.jsx(dynamicLoginMethodsContext.Provider, logger.__assign({ value: contextValue }, { children: children }));
};
...
var UserContextProvider = function (_a) {
    ...
    return jsxRuntime.jsx(UserContextContext.Provider, logger.__assign({ value: currentUserContext }, { children: children }));
};
...
function FeatureWrapper(_a) {
    ...
    return (jsxRuntime.jsx(DynamicLoginMethodsProvider, logger.__assign({ value: loadedDynamicLoginMethods }, { children: jsxRuntime.jsx(translationContext.TranslationContextProvider, logger.__assign({ defaultLanguage: st.languageTranslations.defaultLanguage, defaultStore: genericComponentOverrideContext.mergeObjects(defaultStore, st.languageTranslations.userTranslationStore), translationControlEventSource: st.languageTranslations.translationEventSource, userTranslationFunc: st.languageTranslations.userTranslationFunc }, { children: jsxRuntime.jsx(WithOrWithoutShadowDom, logger.__assign({ useShadowDom: useShadowDom }, { children: children })) })) })));
}
function WithShadowDom(_a) {
    ...
    return (jsxRuntime.jsx("div", logger.__assign({ id: genericComponentOverrideContext.ST_ROOT_ID, ref: rootDiv }, { children: shadowRoot && reactDom.createPortal(children, shadowRoot) })));
}
function WithOrWithoutShadowDom(_a) {
    ...
    if (useShadowDom === false) {
        return (jsxRuntime.jsxs("div", logger.__assign({ id: genericComponentOverrideContext.ST_ROOT_ID }, { children: [children, jsxRuntime.jsx(DisableAutoFillInput, {})] })));
    }
...
function DisableAutoFillInput() {
    ...
    return (jsxRuntime.jsx("style", logger.__assign({ type: "text/css" }, { children: "input.supertokens-input:-webkit-autofill,input.supertokens-input:-webkit-autofill:focus,input.supertokens-input:-webkit-autofill:hover,select:-webkit-autofill,select:-webkit-autofill:focus,select:-webkit-autofill:hover,textarea:-webkit-autofill,textarea:-webkit-autofill:focus,textarea:-webkit-autofill:hover{transition:background-color 5000s ease-in-out 0s}" })));
...
function SuperTokensBranding() {
    ...
    return (jsxRuntime.jsxs("a", logger.__assign({ "data-supertokens": "superTokensBranding", href: "https://supertokens.com?utm_campaign=poweredby", target: "_blank" }, { children: [t("BRANDING_POWERED_BY_START"), jsxRuntime.jsx("strong", { children: "SuperTokens" }), t("BRANDING_POWERED_BY_END")] })));
}
...
function UserContextWrapper(props) {
    ...
    if (props.userContext !== undefined) {
        return jsxRuntime.jsx(UserContextProvider, logger.__assign({ userContext: props.userContext }, { children: props.children }));
    }
...
function GeneralError(_a) {
    var error = _a.error;
    var t = translationContext.useTranslation();
    return jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "generalError" }, { children: t(error) }));
}
...
var AuthPageComponentList = withOverride("AuthPageComponentList", function AuthPageComponentList(props) {
    ...
    var _loop_1 = function (i) {
        list.push(function () { return (jsxRuntime.jsxs("div", logger.__assign({ "data-supertokens": "dividerWithOr" }, { children: [jsxRuntime.jsx("div", { "data-supertokens": "divider" }), jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "dividerText" }, { children: t("DIVIDER_OR") })), jsxRuntime.jsx("div", { "data-supertokens": "divider" })] }), "divider-".concat(i))); });
        list.push(props.authComponents[i]);
    };
    for (var i = 1; i < props.authComponents.length; ++i) {
        _loop_1(i);
    }
    return (jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "authComponentList" }, { children: list.map(function (i) {
            return i(logger.__assign({}, props));
        }) })));
});
...
function BackButton(_a) {
    ...
    return (jsxRuntime.jsx("button", logger.__assign({ onClick: onClick, "data-supertokens": "backButton backButtonCommon" }, { children: jsxRuntime.jsx(HeavyArrowLeftIcon, { color: "rgb(var(--palette-textTitle))" }) })));
}
...
function AuthPageTheme(props) {
    if (props.fullPageCompWithPreloadedInfo) {
        return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: props.fullPageCompWithPreloadedInfo.component(logger.__assign(logger.__assign({}, props), { preloadInfo: props.fullPageCompWithPreloadedInfo.preloadInfo })) }));
    }
...
var AuthPageInner = function (props) {
    ...
    genericComponentOverrideContext.useOnMountAPICall(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        var oauth2Recipe;
    ...
    }); }, function (info) { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(this, function (_a) {
            if (info !== undefined) {
                if (info.status === "OK") {
    ...
    var onAuthSuccess = React.useCallback(function (ctx) { return logger.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (loginChallenge === null || oauth2Recipe === undefined) {
                        return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(logger.__assign(logger.__assign({}, ctx), { action: "SUCCESS", tenantIdFromQueryParams: genericComponentOverrideContext.getTenantIdFromQueryParams(), redirectToPath: genericComponentOverrideContext.getRedirectToPathFromURL() }), ctx.recipeId, genericComponentOverrideContext.getRedirectToPathFromURL(), userContext, props.navigate)];
                    }
                ...
                case 1:
                    frontendRedirectTo = (_a.sent()).frontendRedirectTo;
                    return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(logger.__assign(logger.__assign({}, ctx), { action: "SUCCESS_OAUTH2", tenantIdFromQueryParams: genericComponentOverrideContext.getTenantIdFromQueryParams(), frontendRedirectTo: frontendRedirectTo }), ctx.recipeId, genericComponentOverrideContext.getRedirectToPathFromURL(), userContext, props.navigate)];
            }
        });
    }); }, [loginChallenge]);
    var childProps = authComponentListInfo !== undefined &&
        ...
        ? logger.__assign(logger.__assign({}, authComponentListInfo), { oauth2ClientInfo: oauth2ClientInfo, onAuthSuccess: onAuthSuccess, error: error, onError: function (err) {
                setError(err);
        ...
        return logger.__generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    ...
                    firstFactors = (_c = (_a = factorListState !== null && factorListState !== void 0 ? factorListState : loadedDynamicLoginMethods === null || loadedDynamicLoginMethods === void 0 ? void 0 : loadedDynamicLoginMethods.firstFactors) !== null && _a !== void 0 ? _a : (_b = recipe$1.MultiFactorAuth.getInstance()) === null || _b === void 0 ? void 0 : _b.config.firstFactors) !== null && _c !== void 0 ? _c : authRecipesInited.reduce(function (acc, recipe) { return logger.__spreadArray(logger.__spreadArray([], acc, true), recipe.getFirstFactorsForAuthPage(), true); }, []);
...
function chooseComponentBasedOnFirstFactors(firstFactors, routeComponents) {
        ...
        if (firstFactors.every(function (factor) { return factorsProvided.includes(factor); })) {
            ...
            if (matchingComp) {
                ...
                if (firstFactors.length === factorsProvided.length) {
                    logger.logDebugMessage("Rendering ".concat(rid, " because it matches factors: ").concat(firstFactors, " exactly"));
    ...
    */
    ...
    if (fallbackComponent !== undefined) {
        logger.logDebugMessage("Rendering ".concat(fallbackRid, " to cover ").concat(firstFactors, " as a fallback"));
    ...
    logger.logDebugMessage("Choosing component using fallback logic w/ ".concat(enabledLoginMethods.join(", "), " enabled"));
...
function getSuperTokensRoutesForReactRouterDom$1(_a) {
    ...
    var routes = Object.values(recipeList.reduce(function (routes, recipe) {
        ...
        Object.keys(pathsToFeatureComponentWithRecipeIdMap).forEach(function (path) {
            ...
            if (!(path in routes)) {
                routes[path] = (jsxRuntime.jsx(Route, logger.__assign({ exact: true, path: pathForRouter }, { children: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }), "st-".concat(path)));
            }
        });
        return routes;
    }, {}));
    if (!genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().disableAuthRoute &&
        ...
        routes.push(jsxRuntime.jsx(Route, logger.__assign({ exact: true, path: getPathForRouter$1(basePath, path) }, { children: jsxRuntime.jsx(RoutingComponent, { getReactRouterDomWithCustomHistory: getReactRouterDomWithCustomHistory, preBuiltUIList: recipeList, path: path }) }), "st-/auth"));
    }
    return routes;
}
...
var UI = /** @class */ (function () {
    ...
    UI.AuthPage = function (props) { return (jsxRuntime.jsx(AuthPageWrapper, logger.__assign({}, props, { preBuiltUIList: props.preBuiltUIList.map(function (r) { return r.getInstanceOrInitAndGetInstance(); }) }))); };
...
var SessionAuth = function (_a) {
    var _b;
    var children = _a.children, props = logger.__rest(_a, ["children"]);
    ...
    var buildContext = React.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
    ...
    var setInitialContextAndMaybeRedirect = React.useCallback(function (toSetContext) { return logger.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 7:
                    if (props.accessDeniedScreen !== undefined && failureRedirectInfo.failedClaim !== undefined) {
                        ...
                        return [2 /*return*/, setContextIfChanged(logger.__assign(logger.__assign({}, toSetContext), { accessDeniedValidatorError: failureRedirectInfo.failedClaim }))];
                    }
                    _a.label = 8;
                case 8:
                    setContextIfChanged(toSetContext);
                ...
                return logger.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            setContextIfChanged(logger.__assign(logger.__assign({}, event.sessionContext), { loading: false, invalidClaims: invalidClaims }));
                            return [3 /*break*/, 7];
                        ...
                        case 9:
                            if (props.accessDeniedScreen !== undefined && failureRedirectInfo.failedClaim !== undefined) {
                                ...
                                return [2 /*return*/, setContextIfChanged(logger.__assign(logger.__assign({}, event.sessionContext), { loading: false, invalidClaims: invalidClaims, accessDeniedValidatorError: failureRedirectInfo.failedClaim }))];
                            }
                            _b.label = 10;
                        case 10:
                            setContextIfChanged(logger.__assign(logger.__assign({}, event.sessionContext), { loading: false, invalidClaims: invalidClaims }));
                            return [2 /*return*/];
                        case 11:
                            setContextIfChanged(logger.__assign(logger.__assign({}, event.sessionContext), { loading: false, invalidClaims: [] }));
                            return [2 /*return*/];
                        case 12:
                            setContextIfChanged(logger.__assign(logger.__assign({}, event.sessionContext), { loading: false, invalidClaims: [] }));
    ...
    return jsxRuntime.jsx(SessionContext.Provider, logger.__assign({ value: context }, { children: children }));
};
var SessionAuthWrapper = function (props) {
    return (jsxRuntime.jsx(UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(SessionAuth, logger.__assign({}, props)) })));
};

var SuperTokensWrapper = function (props) {
    return jsxRuntime.jsx(SessionAuthWrapper, logger.__assign({}, props, { requireAuth: false, doRedirection: false }));
};
...
var SuperTokensAPIWrapper = /** @class */ (function () {
    ...
    SuperTokensAPIWrapper.redirectToAuth = function (options) { return logger.__awaiter(void 0, void 0, void 0, function () {
        var _b;
        return logger.__generator(_a, function (_c) {
            return [2 /*return*/, genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirectToAuth(logger.__assign(logger.__assign({}, options), { redirectBack: (_b = options === null || options === void 0 ? void 0 : options.redirectBack) !== null && _b !== void 0 ? _b : true, userContext: genericComponentOverrideContext.getNormalisedUserContext(options === null || options === void 0 ? void 0 : options.userContext) }))];
        });
    }); };
