...
function AuthPageTheme(props) {
    if (props.fullPageCompWithPreloadedInfo) {
        return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: props.fullPageCompWithPreloadedInfo.component(utils.__assign(utils.__assign({}, props), { preloadInfo: props.fullPageCompWithPreloadedInfo.preloadInfo })) }));
    }
