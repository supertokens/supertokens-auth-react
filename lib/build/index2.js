        ...
        return jsxRuntime.jsx(jsxRuntime.Fragment, {
            children: props.fullPageCompWithPreloadedInfo.component(
                genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, props), {
                    ...
                    originalFactorIds: (_a = props.originalFactorIds) !== null && _a !== void 0 ? _a : [],
                })
            ),
        });
    }
...
var AuthPageInner = function (props) {
    ...
    var _m = React.useState(props.factors),
        originalFactorIds = _m[0],
        setOriginalFactorIds = _m[1];
    // We use this to signal that we need to update the components we show on screen
    var _o = React.useState(0),
        rebuildReqCount = _o[0],
        setRebuildReqCount = _o[1];
    ...
    var _p = React.useState(),
        authComponentListInfo = _p[0],
        setAuthComponentListInfo = _p[1];
        ...
        function () {
            ...
            if (
                ...
                void buildAndSetChildProps(
                    ...
                    setOriginalFactorIds(
                        authComponentListInfo === null || authComponentListInfo === void 0
                            ? void 0
                            : authComponentListInfo.factorIds
                    );
                }, rethrowInRender);
            }
            return function () {
