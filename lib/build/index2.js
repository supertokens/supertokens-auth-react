                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(toSetContext.invalidClaims.length !== 0)) return [3 /*break*/, 5];
                            return [
                                4 /*yield*/,
                        ...
                        case 1:
                            ...
                            if (!(failureRedirectInfo.redirectPath !== undefined)) return [3 /*break*/, 4];
                            if (!types.compareRedirectionURLToCurrentURL(failureRedirectInfo.redirectPath))
                                return [3 /*break*/, 2];
                ...
                return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                    ...
                    return genericComponentOverrideContext.__generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                invalidClaims = _b.sent();
                                if (!(props.doRedirection !== false)) return [3 /*break*/, 7];
                                return [
                                    4 /*yield*/,
                                    types.getFailureRedirectionInfo({
                                        invalidClaims: invalidClaims,
                            ...
                            case 3:
                                ...
                                if (!failureRedirectInfo.redirectPath) return [3 /*break*/, 6];
                                if (!types.compareRedirectionURLToCurrentURL(failureRedirectInfo.redirectPath))
                                    return [3 /*break*/, 4];
                                setContext(
                                    genericComponentOverrideContext.__assign(
