...
var Querier = /** @class */ (function () {
    function Querier(recipeId, appInfo) {
        var _this = this;
        this.get = function (path, config, queryParams, preAPIHook) {
        ...
        this.post = function (path, config, preAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                this.fetch(this.getFullUrl(path), __assign({ method: "POST" }, config), preAPIHook),
                            ];
                        case 1:
                            result = _a.sent();
                            if (result.status >= 300) {
        ...
        this.delete = function (path, config, preAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                this.fetch(this.getFullUrl(path), __assign({ method: "DELETE" }, config), preAPIHook),
                            ];
                        case 1:
                            result = _a.sent();
                            if (result.status >= 300) {
        ...
        this.put = function (path, config, preAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                this.fetch(this.getFullUrl(path), __assign({ method: "PUT" }, config), preAPIHook),
                            ];
                        case 1:
                            result = _a.sent();
                            if (result.status >= 300) {
        ...
        this.fetch = function (url, config, preAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
