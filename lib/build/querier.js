...
var recipe_1 = __importDefault(require("./recipe/session/recipe"));
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            result = _c.sent();
                            if (!(result.status === recipe_1.default.getInstanceOrThrow().sessionExpiredStatusCode))
                                return [3 /*break*/, 4];
                            return [
                                4 /*yield*/,
                                recipe_1.default.getInstanceOrThrow().recipeImpl.handleSessionExpiry(),
                            ];
                        case 3:
                            _c.sent();
                            _c.label = 4;
                        case 4:
                            ...
                            if (!(postAPIHook === undefined)) return [3 /*break*/, 5];
                            _b = result;
                            return [3 /*break*/, 7];
                        case 5:
                            return [
