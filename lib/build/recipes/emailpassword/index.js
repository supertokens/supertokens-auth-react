...
var EmailPassword = /** @class */ (function(_super) {
    ...
    function EmailPassword(config) {
        return (
            _super.call(
                this,
                __assign({}, config, { recipeId: EmailPassword.recipeId, routes: EmailPassword.routes })
            ) || this
        );
    }
    ...
    EmailPassword.getInstanceIfDefined = function() {
        if (EmailPassword.instance === undefined)
            throw Error(
                "No instance of " + EmailPassword.constructor.name + ' found. Make sure to call "init" method.'
            ); // TODO Add relevant doc.
        return EmailPassword.instance;
    };
    EmailPassword.recipeId = "email-password";
    EmailPassword.routes = [""];
