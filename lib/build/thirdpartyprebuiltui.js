...
var ThirdPartySignInAndUpProvidersForm = function (props) {
    ...
    var signInClick = function (providerId) { return logger.__awaiter(void 0, void 0, void 0, function () {
        ...
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, recipe.redirectToThirdPartyLogin({
    ...
    return (jsxRuntime.jsx(React.Fragment, { children: props.providers.map(function (provider) {
            return (jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "providerContainer" }, { children: jsxRuntime.jsx("span", logger.__assign({ onClick: function () { return signInClick(provider.id); } }, { children: provider.getButton() })) }), "provider-".concat(provider.id)));
        }) }));
};
...
var SignInAndUpThemeWrapper = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, logger.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.signInAndUpFeature.style] }, { children: jsxRuntime.jsx(ProvidersForm, logger.__assign({}, props)) })) })));
};

function useChildProps(recipe$1, onAuthSuccess, error, onError, clearError, rebuildAuthPage, setFactorList, navigate, userContext) {
    var recipeImplementation = React.useMemo(function () { return recipe$1 && getModifiedRecipeImplementation(recipe$1.webJSRecipe); }, [recipe$1]);
...
var SignInAndUpFeature = function (props) {
    ...
    var themeProps = logger.__assign(logger.__assign({}, childProps), { providers: childProps.providers });
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInAndUpThemeWrapper, logger.__assign({}, themeProps)), props.children &&
...
var SignInAndUpFeatureWrapper = function (props) {
    ...
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, logger.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignInAndUpFeature, logger.__assign({}, props)) })));
};
var getModifiedRecipeImplementation = function (origImpl) {
    return logger.__assign({}, origImpl);
};
...
var ThirdPartySignInAndUpCallbackTheme = /** @class */ (function (_super) {
    logger.__extends(ThirdPartySignInAndUpCallbackTheme, _super);
    function ThirdPartySignInAndUpCallbackTheme() {
        ...
        _this.render = function () {
            return (jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "container" }, { children: jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "row" }, { children: jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "spinner" }, { children: jsxRuntime.jsx(uiEntry.SpinnerIcon, {}) })) })) })));
        };
        return _this;
    }
...
var SignInAndUpCallbackTheme = function (props) {
    var rootStyle = superTokens.SuperTokens.getInstanceOrThrow().rootStyle;
    return (jsxRuntime.jsx(ThemeBase, logger.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.signInAndUpFeature.style] }, { children: jsxRuntime.jsx(SignInAndUpCallbackThemeWithOverride, {}) })));
};

var defaultTranslationsThirdParty = {
    en: logger.__assign(logger.__assign({}, uiEntry.defaultTranslationsCommon.en), { THIRD_PARTY_PROVIDER_DEFAULT_BTN_START: "Continue with ", THIRD_PARTY_PROVIDER_DEFAULT_BTN_END: "", THIRD_PARTY_ERROR_NO_EMAIL: "Could not retrieve email. Please try a different method.", 
        /*
...
var SignInAndUpCallback$1 = function (props) {
    ...
    var verifyCode = React.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
    ...
    var handleVerifyResponse = React.useCallback(function (_a) {
        ...
        return logger.__awaiter(void 0, void 0, void 0, function () {
            ...
            return logger.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(logger.__assign(logger.__assign({}, ctx), { action: "SUCCESS_OAUTH2", frontendRedirectTo: frontendRedirectTo }), props.recipe.recipeID, redirectToPath, userContext, props.navigate)];
                    case 7:
                        e_1 = _c.sent();
                        rethrowInRender(e_1);
                        return [3 /*break*/, 8];
                    ...
                    case 9: return [2 /*return*/, types.Session.getInstanceOrThrow()
                            .validateGlobalClaimsAndHandleSuccessRedirection(logger.__assign(logger.__assign({}, ctx), { action: "SUCCESS" }), props.recipe.recipeID, redirectToPath, userContext, props.navigate)
    ...
    var handleError = React.useCallback(function (err) { return logger.__awaiter(void 0, void 0, void 0, function () {
    ...
    superTokens.useOnMountAPICall(verifyCode, handleVerifyResponse, handleError);
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsThirdParty }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInAndUpCallbackTheme, { config: props.recipe.config }), props.children] }) })) })));
};

var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    logger.__extends(ThirdPartyPreBuiltUI, _super);
    function ThirdPartyPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            features[normalisedFullPath.getAsStringDangerous()] = {
                matches: function () { return recipe.matchRecipeIdUsingState(_this.recipeInstance, {}); },
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "signinupcallback") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, logger.__assign({ requireAuth: false, doRedirection: false }, { children: jsxRuntime.jsx(SignInAndUpCallback$1, logger.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })) })));
            }
            else {
    ...
    ThirdPartyPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        return [
            {
                component: function (props) { return (jsxRuntime.jsx(SignInAndUpFeatureWrapper, logger.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe.useContext }), "thirdparty-signinup")); },
                displayOrder: 1,
