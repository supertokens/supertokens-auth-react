...
var SignInAndUpCallback$1 = function (props) {
    ...
    var handleVerifyResponse = React.useCallback(
        function (_a) {
            ...
            return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
                var payloadAfterCall, stateResponse, redirectToPath, loginChallenge, frontendRedirectTo, e_1;
                return genericComponentOverrideContext.__generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                        ...
                        case 4:
                            ...
                            if (!(loginChallenge !== undefined)) return [3 /*break*/, 9];
                            _c.label = 5;
                        case 5:
                            _c.trys.push([5, 7, , 8]);
                            return [
                                4 /*yield*/,
                                recipe$1.OAuth2Provider.getInstanceOrThrow().webJSRecipe.getRedirectURLToContinueOAuthFlow(
                                    {
