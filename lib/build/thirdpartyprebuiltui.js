...
function useChildProps(recipe$1, onAuthSuccess, error, onError, clearError, rebuildAuthPage, setFactorList, navigate, userContext, resetFactorList, onSignInUpSwitcherClick, showBackButton) {
...
var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    ...
    ThirdPartyPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        return [
            {
                component: function (props) { return (jsxRuntime.jsx(SignInAndUpFeatureWrapper, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe.useContext }), "thirdparty-signinup")); },
                displayOrder: 1,
