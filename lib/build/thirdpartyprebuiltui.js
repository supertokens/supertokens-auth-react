...
var ThirdPartySignInAndUpProvidersForm = function (props) {
    ...
    var signInClick = function (providerId) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsx(React.Fragment, { children: props.providers.map(function (provider) {
            return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "providerContainer" }, { children: jsxRuntime.jsx("span", genericComponentOverrideContext.__assign({ onClick: function () { return signInClick(provider.id); } }, { children: provider.getButton() })) }), "provider-".concat(provider.id)));
        }) }));
};
...
var SignInAndUpThemeWrapper = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.signInAndUpFeature.style] }, { children: jsxRuntime.jsx(ProvidersForm, genericComponentOverrideContext.__assign({}, props)) })) })));
};

function useChildProps(recipe, onAuthSuccess, error, onError, clearError, rebuildAuthPage, setFactorList, navigate, userContext) {
...
var SignInAndUpFeature = function (props) {
    var childProps = useChildProps(props.recipe, props.onAuthSuccess, props.error, props.onError, props.clearError, props.rebuildAuthPage, props.setFactorList, props.navigate, props.userContext);
    var themeProps = genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, childProps), { providers: childProps.providers });
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInAndUpThemeWrapper, genericComponentOverrideContext.__assign({}, themeProps)), props.children &&
...
var SignInAndUpFeatureWrapper = function (props) {
    ...
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, genericComponentOverrideContext.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignInAndUpFeature, genericComponentOverrideContext.__assign({}, props)) })));
};
...
var SignInAndUpCallbackTheme = function (props) {
    var rootStyle = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().rootStyle;
    return (jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.signInAndUpFeature.style] }, { children: jsxRuntime.jsx(SignInAndUpCallbackThemeWithOverride, {}) })));
};

var defaultTranslationsThirdParty = {
    en: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, uiEntry.defaultTranslationsCommon.en), { THIRD_PARTY_PROVIDER_DEFAULT_BTN_START: "Continue with ", THIRD_PARTY_PROVIDER_DEFAULT_BTN_END: "", THIRD_PARTY_ERROR_NO_EMAIL: "Could not retrieve email. Please try a different method.", 
        /*
...
var SignInAndUpCallback$1 = function (props) {
    ...
    var verifyCode = React.useCallback(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
            ...
            return genericComponentOverrideContext.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, ctx), { action: "SUCCESS_OAUTH2", frontendRedirectTo: frontendRedirectTo }), props.recipe.recipeID, redirectToPath, userContext, props.navigate)];
                    case 7:
                        e_1 = _c.sent();
                        rethrowInRender(e_1);
                        return [3 /*break*/, 8];
                    ...
                    case 9: return [2 /*return*/, types.Session.getInstanceOrThrow()
                            .validateGlobalClaimsAndHandleSuccessRedirection(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, ctx), { action: "SUCCESS" }), props.recipe.recipeID, redirectToPath, userContext, props.navigate)
    ...
    var handleError = React.useCallback(function (err) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
    ...
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, genericComponentOverrideContext.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, genericComponentOverrideContext.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsThirdParty }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInAndUpCallbackTheme, { config: props.recipe.config }), props.children] }) })) })));
};
...
var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    ...
    ThirdPartyPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        return [
            {
                component: function (props) { return (jsxRuntime.jsx(SignInAndUpFeatureWrapper, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext.useContext }), "thirdparty-signinup")); },
                displayOrder: 1,
