...
var defaultTranslationsThirdParty = {
    en: utils.__assign(utils.__assign({}, uiEntry.defaultTranslationsCommon.en), { THIRD_PARTY_PROVIDER_DEFAULT_BTN_START: "Continue with ", THIRD_PARTY_PROVIDER_DEFAULT_BTN_END: "", THIRD_PARTY_ERROR_NO_EMAIL: "Could not retrieve email. Please try a different method.", 
        /*
...
var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    ...
    ThirdPartyPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        return [
            {
                component: function (props) { return (jsxRuntime.jsx(SignInAndUpFeatureWrapper, utils.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe.useContext }), "thirdparty-signinup")); },
                displayOrder: 1,
