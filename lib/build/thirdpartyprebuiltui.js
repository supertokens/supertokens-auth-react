...
var componentOverrideContext$1 = require('./emailverification-shared.js');
...
var ThirdPartySignInAndUpProvidersForm = function (props) {
    ...
    var signInClick = function (providerId) { return utils.__awaiter(void 0, void 0, void 0, function () {
        ...
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, componentOverrideContext.redirectToThirdPartyLogin({
    ...
    return (jsxRuntime.jsx(React.Fragment, { children: props.providers.map(function (provider) {
            return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "providerContainer" }, { children: jsxRuntime.jsx("span", utils.__assign({ onClick: function () { return signInClick(provider.id); } }, { children: provider.getButton() })) }), "provider-".concat(provider.id)));
        }) }));
};
...
var SignInAndUpThemeWrapper = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.signInAndUpFeature.style] }, { children: jsxRuntime.jsx(ProvidersForm, utils.__assign({}, props)) })) })));
};

function useChildProps(recipe, onAuthSuccess, error, onError, clearError, rebuildAuthPage, setFactorList, navigate, userContext, resetFactorList, onSignInUpSwitcherClick, showBackButton) {
    ...
    return React.useMemo(function () {
        var tenantProviders;
        if (superTokens.SuperTokens.usesDynamicLoginMethods) {
        ...
        return {
            ...
            providers: componentOverrideContext.mergeProviders({
...
var SignInAndUpFeature = function (props) {
    var childProps = useChildProps(props.recipe, props.onAuthSuccess, props.error, props.onError, props.clearError, props.rebuildAuthPage, props.setFactorList, props.navigate, props.userContext, props.resetFactorList, props.onSignInUpSwitcherClick, props.showBackButton);
    var themeProps = utils.__assign(utils.__assign({}, childProps), { providers: childProps.providers });
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInAndUpThemeWrapper, utils.__assign({}, themeProps)), props.children &&
...
var SignInAndUpFeatureWrapper = function (props) {
    ...
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignInAndUpFeature, utils.__assign({}, props)) })));
};
...
var ThirdPartySignInAndUpCallbackTheme = /** @class */ (function (_super) {
    utils.__extends(ThirdPartySignInAndUpCallbackTheme, _super);
    function ThirdPartySignInAndUpCallbackTheme() {
        ...
        _this.render = function () {
            return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "container" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "row" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "spinner" }, { children: jsxRuntime.jsx(uiEntry.SpinnerIcon, {}) })) })) })));
        };
        return _this;
    }
    return ThirdPartySignInAndUpCallbackTheme;
}(React.PureComponent));
var SignInAndUpCallbackThemeWithOverride = uiEntry.withOverride("ThirdPartySignInAndUpCallbackTheme", ThirdPartySignInAndUpCallbackTheme);
var SignInAndUpCallbackTheme = function (props) {
    var rootStyle = superTokens.SuperTokens.getInstanceOrThrow().rootStyle;
    return (jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.signInAndUpFeature.style] }, { children: jsxRuntime.jsx(SignInAndUpCallbackThemeWithOverride, {}) })));
};

var defaultTranslationsThirdParty = {
    en: utils.__assign(utils.__assign({}, superTokens.defaultTranslationsCommon.en), { THIRD_PARTY_PROVIDER_DEFAULT_BTN_START: "Continue with ", THIRD_PARTY_PROVIDER_DEFAULT_BTN_END: "", THIRD_PARTY_ERROR_NO_EMAIL: "Could not retrieve email. Please try a different method.", 
        /*
...
var SignInAndUpCallback$1 = function (props) {
    ...
    var verifyCode = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        ...
        return utils.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, props.recipe.webJSRecipe.signInAndUp({
                            userContext: userContext,
                        })];
                case 4: return [2 /*return*/, (_b.response = _c.sent(),
                        _b)];
            }
        });
    }); }, [props.recipe, userContext]);
    var handleVerifyResponse = React.useCallback(function (_a) {
        var response = _a.response, payloadBeforeCall = _a.payloadBeforeCall;
        return utils.__awaiter(void 0, void 0, void 0, function () {
            var payloadAfterCall, stateResponse, redirectToPath, loginChallenge, ctx, oauth2Recipe, frontendRedirectTo, e_1;
            return utils.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 4:
                        ...
                        loginChallenge = stateResponse === null || stateResponse === void 0 ? void 0 : stateResponse.oauth2LoginChallenge;
                        ctx = {
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(utils.__assign(utils.__assign({}, ctx), { action: "SUCCESS_OAUTH2", frontendRedirectTo: frontendRedirectTo }), props.recipe.recipeID, redirectToPath, userContext, props.navigate)];
                    case 7:
                        e_1 = _c.sent();
                        rethrowInRender(e_1);
                        return [3 /*break*/, 8];
                    case 8: return [3 /*break*/, 10];
                    case 9: return [2 /*return*/, types.Session.getInstanceOrThrow()
                            .validateGlobalClaimsAndHandleSuccessRedirection(utils.__assign(utils.__assign({}, ctx), { action: "SUCCESS" }), props.recipe.recipeID, redirectToPath, userContext, props.navigate)
    ...
    var handleError = React.useCallback(function (err) { return utils.__awaiter(void 0, void 0, void 0, function () {
        var invalidClaims, evInstance;
        return utils.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!("status" in err && err.status === types.Session.getInstanceOrThrow().config.invalidClaimStatusCode)) return [3 /*break*/, 5];
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    evInstance = componentOverrideContext$1.EmailVerification.getInstanceOrThrow();
    ...
    utils.useOnMountAPICall(verifyCode, handleVerifyResponse, handleError);
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsThirdParty }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInAndUpCallbackTheme, { config: props.recipe.config }), props.children] }) })) })));
};

var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    utils.__extends(ThirdPartyPreBuiltUI, _super);
    function ThirdPartyPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default("/callback/:id"));
            features[normalisedFullPath.getAsStringDangerous()] = {
                matches: function () { return componentOverrideContext.matchRecipeIdUsingState(_this.recipeInstance, {}); },
                component: function (prop) { return _this.getFeatureComponent("signinupcallback", prop, useComponentOverrides); },
                recipeID: componentOverrideContext.ThirdParty.RECIPE_ID,
            };
            return features;
        };
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "signinupcallback") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, utils.__assign({ requireAuth: false, doRedirection: false }, { children: jsxRuntime.jsx(SignInAndUpCallback$1, utils.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })) })));
            }
            else {
    ...
    ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (ThirdPartyPreBuiltUI.instance === undefined) {
            var recipeInstace = componentOverrideContext.ThirdParty.getInstanceOrThrow();
    ...
    ThirdPartyPreBuiltUI.getFeatureComponent = function (componentName, props, useComponentOverrides) {
        if (useComponentOverrides === void 0) { useComponentOverrides = componentOverrideContext.useContext; }
        return ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance().getFeatureComponent(componentName, props, useComponentOverrides);
    };
    ThirdPartyPreBuiltUI.prototype.getAuthComponents = function () {
        var _this = this;
        return [
            {
                component: function (props) { return (jsxRuntime.jsx(SignInAndUpFeatureWrapper, utils.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext.useContext }), "thirdparty-signinup")); },
                displayOrder: 1,
    ...
    ThirdPartyPreBuiltUI.languageTranslations = defaultTranslationsThirdParty;
