 ...
 * under the License.
 */
var webUtils_1 = require("supertokens-website/utils/webUtils");
exports.WindowUtilities = __assign(__assign({}, webUtils_1.WindowUtilities), {
    location: __assign(__assign({}, webUtils_1.WindowUtilities.location), {
        get search() {
            if (webUtils_1.isRunningInElectron()) {
                /**
                ...
                var currentURL = webUtils_1.getWindowOrThrow().location.href;
            ...
            // eslint-disable-next-line supertokens-auth-react/no-direct-getwindoworthrow-object
            return webUtils_1.getWindowOrThrow().location.search;
        },
    }),
});
