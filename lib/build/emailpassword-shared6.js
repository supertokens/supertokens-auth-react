...
function ResetPasswordUsingTokenTheme(props) {
    ...
    if (props.submitNewPasswordForm !== undefined) {
        return jsxRuntime.jsx(SubmitNewPassword, thirdparty.__assign({}, props.submitNewPasswordForm));
    }
    // Otherwise, return EnterEmail.
    return jsxRuntime.jsx(ResetPasswordEmail, thirdparty.__assign({}, props.enterEmailForm));
}
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    thirdparty.__assign(
                        ...
                        { children: jsxRuntime.jsx(ResetPasswordUsingTokenTheme, thirdparty.__assign({}, props)) }
                    )
                ),
            }
        )
...
var defaultTranslationsEmailPassword = {
    en: thirdparty.__assign(
        thirdparty.__assign(
            thirdparty.__assign({}, translations.defaultTranslationsCommon.en),
...
var ResetPasswordUsingToken$1 = function (props) {
    var token = thirdparty.getQueryParams("token");
        ...
        token === undefined || token === null
            ...
            : {
                  ...
                  onSignInClicked: function () {
                      void thirdparty.SuperTokens.getInstanceOrThrow().redirectToAuth({
                          show: "signin",
...
var SignInAndUpTheme = function (props) {
    ...
    if (props.featureState.isSignUp) {
        return jsxRuntime.jsx(
            SignUp,
            thirdparty.__assign({}, props.signUpForm, {
    ...
    return jsxRuntime.jsx(
        SignIn,
        thirdparty.__assign({}, props.signInForm, {
    ...
    return React__namespace.useReducer(
        function (oldState, action) {
            switch (action.type) {
                ...
                case "setSignUp":
                    return thirdparty.__assign(thirdparty.__assign({}, oldState), { error: undefined, isSignUp: true });
                case "setError":
        ...
        function (initArg) {
            var show = thirdparty.getQueryParams("show");
...
function getThemeSignUpFeatureFormFields(formFields, recipe, userContext) {
    ...
    return formFields.map(function (field) {
        return thirdparty.__assign(thirdparty.__assign({}, field), {
...
var EmailPasswordPreBuiltUI = /** @class */ (function (_super) {
    thirdparty.__extends(EmailPasswordPreBuiltUI, _super);
