...
var recipe = require("./emailpassword-shared4.js");
...
function BackToSignInButton(_a) {
    ...
    return jsxRuntime.jsxs(
        ...
        uiEntry.__assign(
            ...
            {
                children: [
                    jsxRuntime.jsx(uiEntry.ArrowLeftIcon, { color: "rgb(var(--palette-secondaryText))" }),
...
function ResetPasswordUsingTokenTheme(props) {
    ...
    if (props.submitNewPasswordForm !== undefined) {
        return jsxRuntime.jsx(SubmitNewPassword, uiEntry.__assign({}, props.submitNewPasswordForm));
    }
    // Otherwise, return EnterEmail.
    return jsxRuntime.jsx(ResetPasswordEmail, uiEntry.__assign({}, props.enterEmailForm));
}
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    uiEntry.__assign(
                        ...
                        { children: jsxRuntime.jsx(ResetPasswordUsingTokenTheme, uiEntry.__assign({}, props)) }
                    )
                ),
            }
        )
...
var defaultTranslationsEmailPassword = {
    en: uiEntry.__assign(
        uiEntry.__assign(
            uiEntry.__assign({}, uiEntry.defaultTranslationsCommon.en),
...
var ResetPasswordUsingToken$1 = function (props) {
    var token = uiEntry.getQueryParams("token");
        ...
        token === undefined || token === null
            ...
            : {
                  ...
                  onSignInClicked: function () {
                      void uiEntry.SuperTokens.getInstanceOrThrow().redirectToAuth({
                          show: "signin",
                ...
                return uiEntry.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                uiEntry.validateForm(formFields, props.config.signInAndUpFeature.signInForm.formFields),
                            ];
                        case 1:
                            validationErrors = _a.sent();
                            if (validationErrors.length > 0) {
                ...
                return uiEntry.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                uiEntry.validateForm(formFields, props.config.signInAndUpFeature.signUpForm.formFields),
                            ];
                        case 1:
                            validationErrors = _a.sent();
                            if (validationErrors.length > 0) {
...
var SignInAndUpTheme = function (props) {
    ...
    if (props.featureState.isSignUp) {
        return jsxRuntime.jsx(
            SignUp,
            uiEntry.__assign({}, props.signUpForm, {
    ...
    return jsxRuntime.jsx(
        SignIn,
        uiEntry.__assign({}, props.signInForm, {
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    uiEntry.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignInAndUpTheme, uiEntry.__assign({}, props)) }
                    )
                ),
            }
        )
...
var useFeatureReducer = function (recipe) {
    return React__namespace.useReducer(
        function (oldState, action) {
            switch (action.type) {
                case "setSignIn":
                    return uiEntry.__assign(uiEntry.__assign({}, oldState), { error: undefined, isSignUp: false });
                case "setSignUp":
                    return uiEntry.__assign(uiEntry.__assign({}, oldState), { error: undefined, isSignUp: true });
                case "setError":
        ...
        function (initArg) {
            var show = uiEntry.getQueryParams("show");
...
var getModifiedRecipeImplementation = function (origImpl) {
    return uiEntry.__assign({}, origImpl);
};
function getThemeSignUpFeatureFormFields(formFields, recipe, userContext) {
    ...
    return formFields.map(function (field) {
        return uiEntry.__assign(uiEntry.__assign({}, field), {
...
var EmailPasswordPreBuiltUI = /** @class */ (function (_super) {
    uiEntry.__extends(EmailPasswordPreBuiltUI, _super);
...
//# sourceMappingURL=emailpassword-shared6.js.map
