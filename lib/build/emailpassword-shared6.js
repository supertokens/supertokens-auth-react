...
function InputError(_a) {
    ...
    return jsxRuntime.jsx(
        "div",
        superTokens.__assign({ "data-supertokens": "inputErrorMessage" }, { children: t(error) })
    );
}
...
function Label(_a) {
    ...
    return jsxRuntime.jsxs(
        "div",
        superTokens.__assign({ "data-supertokens": "label" }, { children: [t(value), showIsRequired && " *"] })
    );
}
...
var FormBase = function (props) {
            ...
            setFieldStates(function (os) {
                ...
                if (field === undefined) {
                    return superTokens.__spreadArray(
                        superTokens.__spreadArray([], os, true),
                        [update({ id: id, value: "" })],
                        false
                    );
                }
    ...
    var onInputFocus = React.useCallback(
        function (field) {
            updateFieldState(field.id, function (os) {
                return superTokens.__assign(superTokens.__assign({}, os), { validated: false });
            });
        },
        [updateFieldState]
    );
                ...
                return superTokens.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            error = _a;
                            updateFieldState(field.id, function (os) {
                                return superTokens.__assign(superTokens.__assign({}, os), {
                                    error: error,
    ...
    var onInputChange = React.useCallback(
        function (field) {
            updateFieldState(field.id, function (os) {
                return superTokens.__assign(superTokens.__assign({}, os), { value: field.value, error: undefined });
            });
            props.clearError();
        },
        [updateFieldState]
                        ...
                        case 0:
                            ...
                            setFieldStates(function (os) {
                                return os.map(function (fs) {
                                    return superTokens.__assign(superTokens.__assign({}, fs), { error: undefined });
                                });
                            });
                            ...
                            if (generalError !== undefined) {
                                ...
                                if (result.status === "FIELD_ERROR") {
                                    ...
                                    setFieldStates(function (os) {
                                        return os.map(function (fs) {
                                            var _a;
                                            return superTokens.__assign(superTokens.__assign({}, fs), {
                                                error:
