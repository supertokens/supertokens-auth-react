...
function InputError(_a) {
    ...
    return jsxRuntime.jsx(
        "div",
        thirdparty.__assign({ "data-supertokens": "inputErrorMessage" }, { children: t(error) })
    );
}
...
function Label(_a) {
    ...
    return jsxRuntime.jsxs(
        "div",
        thirdparty.__assign({ "data-supertokens": "label" }, { children: [t(value), showIsRequired && " *"] })
    );
}
...
var FormBase = function (props) {
    ...
    var updateFieldState = React.useCallback(
        function (id, update) {
            setFieldStates(function (os) {
                ...
                if (field === undefined) {
                    return thirdparty.__spreadArray(
                        thirdparty.__spreadArray([], os, true),
                        [update({ id: id, value: "" })],
                        false
                    );
                }
    ...
    var onInputFocus = React.useCallback(
        function (field) {
            updateFieldState(field.id, function (os) {
                return thirdparty.__assign(thirdparty.__assign({}, os), { validated: false });
            });
        },
        [updateFieldState]
    );
                ...
                return thirdparty.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            error = _a;
                            updateFieldState(field.id, function (os) {
                                return thirdparty.__assign(thirdparty.__assign({}, os), {
                                    error: error,
    ...
    var onInputChange = React.useCallback(
        function (field) {
            updateFieldState(field.id, function (os) {
                return thirdparty.__assign(thirdparty.__assign({}, os), { value: field.value, error: undefined });
            });
            props.clearError();
        },
        [updateFieldState]
                        ...
                        case 0:
                            ...
                            setFieldStates(function (os) {
                                return os.map(function (fs) {
                                    return thirdparty.__assign(thirdparty.__assign({}, fs), { error: undefined });
                                });
                            });
                            ...
                            if (generalError !== undefined) {
                                ...
                                if (result.status === "FIELD_ERROR") {
                                    ...
                                    setFieldStates(function (os) {
                                        return os.map(function (fs) {
                                            var _a;
                                            return thirdparty.__assign(thirdparty.__assign({}, fs), {
                                                error:
