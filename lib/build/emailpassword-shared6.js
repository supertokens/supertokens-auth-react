...
function BackToSignInButton(_a) {
    ...
    return jsxRuntime.jsxs(
        ...
        utils.__assign(
            ...
            {
                children: [
                    jsxRuntime.jsx(recipe.ArrowLeftIcon, { color: "rgb(var(--palette-secondaryText))" }),
...
var ResetPasswordEmail = recipe.withOverride("EmailPasswordResetPasswordEmail", EmailPasswordResetPasswordEmail);
...
var SubmitNewPassword = recipe.withOverride("EmailPasswordSubmitNewPassword", EmailPasswordSubmitNewPassword);
...
var defaultTranslationsEmailPassword = {
    en: utils.__assign(
        utils.__assign(
            utils.__assign({}, recipe.defaultTranslationsCommon.en),
        ...
        token === undefined || token === null
            ...
            : {
                  ...
                  onSignInClicked: function () {
                      void utils$1.SuperTokens.getInstanceOrThrow().redirectToAuth({
                          show: "signin",
...
var SignInFooter = recipe.withOverride("EmailPasswordSignInFooter", function EmailPasswordSignInFooter(_a) {
    var onClick = _a.onClick;
    var t = recipe.useTranslation();
    return jsxRuntime.jsx(
        "div",
...
var SignInForm = recipe.withOverride("EmailPasswordSignInForm", function EmailPasswordSignInForm(props) {
    var _this = this;
    var userContext = recipe.useUserContext();
...
var SignInHeader = recipe.withOverride("EmailPasswordSignInHeader", function EmailPasswordSignInHeader(_a) {
    var onClick = _a.onClick;
    var t = recipe.useTranslation();
...
var SignIn = recipe.withOverride("EmailPasswordSignIn", function EmailPasswordSignIn(props) {
    return jsxRuntime.jsxs(
        "div",
        utils.__assign(
            { "data-supertokens": "container" },
...
var SignUpFooter = recipe.withOverride("EmailPasswordSignUpFooter", function EmailPasswordSignUpFooter(_a) {
 ...
 * Component.
 */
var SignUpForm = recipe.withOverride("EmailPasswordSignUpForm", function EmailPasswordSignUpForm(props) {
    var _this = this;
    var userContext = recipe.useUserContext();
    return jsxRuntime.jsx(formBase.FormBase, {
        formFields: props.formFields,
...
var SignUpHeader = recipe.withOverride("EmailPasswordSignUpHeader", function EmailPasswordSignUpHeader(_a) {
    var onClick = _a.onClick;
    var t = recipe.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
...
var SignUp = recipe.withOverride("EmailPasswordSignUp", function EmailPasswordSignUp(props) {
    return jsxRuntime.jsxs(
        "div",
        utils.__assign(
            { "data-supertokens": "container" },
