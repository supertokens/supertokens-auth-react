...
var superTokensUrl_1 = require("./superTokensUrl");
var utils_1 = require("./utils");
var getSuperTokensRoutesForReactDomRouter = require("./components/superTokensRoute")
...
var SuperTokens = /** @class */ (function() {
    ...
    function SuperTokens(config) {
        ...
        this.appInfo = {
            ...
            apiDomain: utils_1.normaliseURLDomainOrThrowError(config.appInfo.apiDomain),
            websiteDomain: utils_1.normaliseURLDomainOrThrowError(config.appInfo.websiteDomain),
    ...
    SuperTokens.getNormalisedURLPathOrDefault = function(defaultPath, path) {
        if (path !== undefined) {
            return utils_1.normaliseURLPathOrThrowError(path);
        } else {
            return defaultPath;
        }
    };
    SuperTokens.getSuperTokensRoutesForReactDomRouter = function() {
