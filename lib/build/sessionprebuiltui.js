...
function BackButton(_a) {
    ...
    return (jsxRuntime.jsx("button", utils.__assign({ onClick: onClick, "data-supertokens": "buttonBase backButton" }, { children: t("GO_BACK") })));
}
...
function LogoutButton(_a) {
    var onClick = _a.onClick;
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs("button", utils.__assign({ onClick: onClick, "data-supertokens": "buttonBase logoutButton" }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textGray))" }), jsxRuntime.jsx("span", { children: t("LOGOUT") })] })));
}
...
var AccessDeniedScreen$2 = function (props) {
    ...
    var t = translationContext.useTranslation();
    var onLogout = function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, props.recipe.signOut({ userContext: userContext })];
                case 1:
                    _a.sent();
    ...
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "center accessDenied" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "container" }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "row" }, { children: [jsxRuntime.jsx(ErrorRoundIcon, {}), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle" }, { children: t("ACCESS_DENIED") })), jsxRuntime.jsx("div", { "data-supertokens": "divider" }), props.error && jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "primaryText accessDeniedError" }, { children: [" ", props.error] })), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "buttonsGroup" }, { children: [jsxRuntime.jsx(BackButton, { onClick: onBackButtonClicked }), jsxRuntime.jsx(LogoutButton, { onClick: onLogout })] }))] })) })) })));
};
...
var AccessDeniedScreenTheme = function (props) {
    ...
    return (jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.accessDeniedScreen.style] }, { children: jsxRuntime.jsx(AccessDeniedThemeWithOverride, utils.__assign({}, props)) })));
};

var defaultTranslationsSession = {
    en: utils.__assign(utils.__assign({}, superTokens.defaultTranslationsCommon.en), { ACCESS_DENIED: "Access denied", GO_BACK: "Go back", LOGOUT: "Log out" }),
};

var AccessDeniedScreen$1 = function (props) {
    var _a, _b, _c;
    var recipeComponentOverrides = props.useComponentOverrides();
    var navigate = (_a = props.navigate) !== null && _a !== void 0 ? _a : (_b = uiEntry.UI.getReactRouterDomWithCustomHistory()) === null || _b === void 0 ? void 0 : _b.useHistoryCustom();
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ defaultStore: defaultTranslationsSession, useShadowDom: (_c = props.useShadowDom) !== null && _c !== void 0 ? _c : superTokens.SuperTokens.getInstanceOrThrow().useShadowDom }, { children: jsxRuntime.jsx(AccessDeniedScreenTheme, { config: props.recipe.config, navigate: navigate, recipe: props.recipe, error: props.error }) })) })));
};

var SessionPreBuiltUI = /** @class */ (function (_super) {
    utils.__extends(SessionPreBuiltUI, _super);
    function SessionPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "accessDenied") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(AccessDeniedScreen$1, { recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides, error: props.error, useShadowDom: props.useShadowDom }) })));
            }
    ...
    SessionPreBuiltUI.languageTranslations = defaultTranslationsSession;
