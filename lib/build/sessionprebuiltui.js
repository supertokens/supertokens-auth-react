...
function BackButton(_a) {
    ...
    return (jsxRuntime.jsx("button", genericComponentOverrideContext.__assign({ onClick: onClick, "data-supertokens": "buttonBase backButton" }, { children: t("GO_BACK") })));
}
...
function LogoutButton(_a) {
    var onClick = _a.onClick;
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs("button", genericComponentOverrideContext.__assign({ onClick: onClick, "data-supertokens": "buttonBase logoutButton" }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textGray))" }), jsxRuntime.jsx("span", { children: t("LOGOUT") })] })));
}
...
var AccessDeniedScreen$2 = function (props) {
    ...
    var t = translationContext.useTranslation();
    var onLogout = function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
...
var defaultTranslationsSession = {
    en: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, genericComponentOverrideContext.defaultTranslationsCommon.en), { ACCESS_DENIED: "Access denied", GO_BACK: "Go back", LOGOUT: "Log out" }),
};
...
var AccessDeniedScreen$1 = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, genericComponentOverrideContext.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, genericComponentOverrideContext.__assign({ defaultStore: defaultTranslationsSession, useShadowDom: (_c = props.useShadowDom) !== null && _c !== void 0 ? _c : genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom }, { children: jsxRuntime.jsx(AccessDeniedScreenTheme, { config: props.recipe.config, navigate: navigate, recipe: props.recipe, error: props.error }) })) })));
};
    ...
    function SessionPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "accessDenied") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(AccessDeniedScreen$1, { recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides, error: props.error, useShadowDom: props.useShadowDom }) })));
            }
