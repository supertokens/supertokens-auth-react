...
var AccessDeniedThemeWithOverride = translations.withOverride("SessionAccessDenied", AccessDeniedScreen$2);
var AccessDeniedScreenTheme = function (props) {
    ...
    return jsxRuntime.jsx(
        ...
        thirdparty.__assign(
            ...
            { children: jsxRuntime.jsx(AccessDeniedThemeWithOverride, thirdparty.__assign({}, props)) }
        )
    );
};
...
var SessionPreBuiltUI = /** @class */ (function (_super) {
    thirdparty.__extends(SessionPreBuiltUI, _super);
    ...
    SessionPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (SessionPreBuiltUI.instance === undefined) {
            var recipeInstance = thirdparty.Session.getInstanceOrThrow();
