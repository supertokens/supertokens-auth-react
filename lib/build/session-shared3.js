...
var SessionAPIWrapper = /** @class */ (function () {
    ...
    SessionAPIWrapper.ComponentsOverrideProvider = recipe.Provider;
    SessionAPIWrapper.AccessDeniedTheme = recipe.AccessDeniedTheme;
    SessionAPIWrapper.AccessDenied = function (prop) {
        if (prop === void 0) {
            prop = {};
        }
        return recipe.Session.getInstanceOrThrow().getFeatureComponent("accessDenied", prop);
    };
