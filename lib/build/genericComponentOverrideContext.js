...
function applyPlugins(recipeId, config, plugins) {
    ...
    if (functionLayers.length > 0) {
        _config.override = exports.__assign(exports.__assign({}, _config.override), {
...
function getPublicConfig(config) {
    config.experimental;
    config.recipeList;
    var publicConfig = __rest(config, ["experimental", "recipeList"]);
    return publicConfig;
}
    ...
    Multitenancy.init = function (config) {
        return {
            ...
            authReact: function (appInfo, _, overrideMaps) {
                var normalisedConfig = normaliseMultitenancyConfig(
                    applyPlugins(
                        Multitenancy.RECIPE_ID,
                        config,
