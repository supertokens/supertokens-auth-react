...
var loginMethodTypes = ["emailpassword", "thirdparty", "passwordless"];
...
function hasIntersectingRecipes(tenantMethods, recipeList) {
    ...
    for (var _i = 0, loginMethodTypes_1 = loginMethodTypes; _i < loginMethodTypes_1.length; _i++) {
        var key = loginMethodTypes_1[_i];
...
var Multitenancy = /** @class */ (function (_super) {
    ...
    Multitenancy.getDynamicLoginMethods = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, emailPassword, passwordless, thirdParty, firstFactors;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
