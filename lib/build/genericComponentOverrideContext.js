...
var SuperTokens = /** @class */ (function () {
    ...
    function SuperTokens(config, plugins) {
        ...
        for (var _i = 0, plugins_1 = plugins; _i < plugins_1.length; _i++) {
            ...
            if (plugin.overrideMap !== undefined) {
                for (var _k = 0, _l = Object.keys(plugin.overrideMap); _k < _l.length; _k++) {
                    var t = _l[_k];
                    if ((_b = plugin.overrideMap[t]) === null || _b === void 0 ? void 0 : _b.components) {
                        this.componentOverrides[t] = exports.__assign(exports.__assign({}, this.componentOverrides[t]), (_c = plugin.overrideMap[t]) === null || _c === void 0 ? void 0 : _c.components);
                    }
                }
            }
            this.componentOverrides.authRecipe = exports.__assign(exports.__assign({}, ((_d = this.componentOverrides.authRecipe) !== null && _d !== void 0 ? _d : {})), ((_e = plugin.generalAuthRecipeComponentOverrides) !== null && _e !== void 0 ? _e : {}));
            if (plugin.routeHandlers) {
                (_a = this.pluginRouteHandlers).push.apply(_a, plugin.routeHandlers);
            }
        }
        ...
        this.rootStyle = (_f = config.style) !== null && _f !== void 0 ? _f : "";
        this.privacyPolicyLink = config.privacyPolicyLink;
        this.termsOfServiceLink = config.termsOfServiceLink;
        this.useShadowDom = (_g = config.useShadowDom) !== null && _g !== void 0 ? _g : true;
        this.defaultToSignUp = (_h = config.defaultToSignUp) !== null && _h !== void 0 ? _h : false;
        this.disableAuthRoute = (_j = config.disableAuthRoute) !== null && _j !== void 0 ? _j : false;
    }
    /*
     * Static Methods.
     */
    SuperTokens.init = function (config) {
        ...
        var finalPluginList = [];
        if (config.plugins) {
            for (var _i = 0, _b = config.plugins; _i < _b.length; _i++) {
                var plugin = _b[_i];
                ...
                if (plugin.dependencies) {
                    var result = plugin.dependencies(finalPluginList, package_version);
