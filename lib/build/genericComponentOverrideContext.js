 ...
 * under the License.
 */
var package_version = "0.49.1-canary-plugins.0";
...
var getTranslationFunction = function () {
    ...
    var _store = __spreadArray(
        __spreadArray([defaultTranslationsCommon], stores, true),
    ...
    getCurrentLanguageFromCookie().then(function (cookieLanguage) {
        ...
        for (var _i = 0, plugins_1 = plugins; _i < plugins_1.length; _i++) {
            ...
            if (plugin.overrideMap !== undefined) {
                for (var _j = 0, _k = Object.keys(plugin.overrideMap); _j < _k.length; _j++) {
                    var t = _k[_j];
                    this.componentOverrides[t] = exports.__assign(
                        exports.__assign({}, this.componentOverrides[t]),
            ...
            this.componentOverrides.authRecipe = exports.__assign(
                exports.__assign({}, (_c = this.componentOverrides.authRecipe) !== null && _c !== void 0 ? _c : {}),
    ...
    SuperTokens.init = function (config) {
        ...
        if ((_b = config.experimental) === null || _b === void 0 ? void 0 : _b.plugins) {
            for (var _i = 0, _c = config.experimental.plugins; _i < _c.length; _i++) {
                ...
                if (plugin.compatibleAuthReactSDKVersions) {
                    ...
                    if (!versionCheck) {
                        throw new Error(
                            "Plugin AuthReact SDK version mismatch. Version "
                                .concat(package_version, " not found in compatible versions: ")
        ...
        for (var _d = 0, finalPluginList_1 = finalPluginList; _d < finalPluginList_1.length; _d++) {
            ...
            if (plugin.config) {
                var pluginConfig =
                    plugin.config(
                        getPublicConfig(exports.__assign(exports.__assign({}, config), { appInfo: normalisedAppInfo }))
                    ) || {};
        ...
        SuperTokens.instance = new SuperTokens(
            exports.__assign(exports.__assign({}, config), { recipeList: recipes }),
            finalPluginList
        );
...
var createGenericComponentsOverrideContext = function (v, key) {
    ...
    var useComponentsOverrideContext = function () {
        ...
        return exports.__assign(
            exports.__assign(
                {},
                (_a = SuperTokens.getInstance()) === null || _a === void 0 ? void 0 : _a.componentOverrides[key]
            ),
            contextValue
        );
    };
