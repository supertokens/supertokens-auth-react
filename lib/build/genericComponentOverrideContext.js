...
var SuperTokens = /** @class */ (function () {
    ...
    function SuperTokens(config, plugins) {
        ...
        for (var _i = 0, plugins_1 = plugins; _i < plugins_1.length; _i++) {
            ...
            if (plugin.overrideMap !== undefined) {
                for (var _j = 0, _k = Object.keys(plugin.overrideMap); _j < _k.length; _j++) {
                    var t = _k[_j];
                    if ((_a = plugin.overrideMap[t]) === null || _a === void 0 ? void 0 : _a.components) {
                        this.componentOverrides[t] = exports.__assign(
                            exports.__assign({}, this.componentOverrides[t]),
                            (_b = plugin.overrideMap[t]) === null || _b === void 0 ? void 0 : _b.components
                        );
                    }
                }
            }
        ...
        var _loop_1 = function (pluginIndex) {
            ...
            if (pluginRouteHandlers) {
                ...
                (_l = this_1.pluginRouteHandlers).push.apply(_l, result.routeHandlers);
            }
        };
        var this_1 = this;
    ...
    SuperTokens.init = function (config) {
        ...
        for (var _d = 0, finalPluginList_1 = finalPluginList; _d < finalPluginList_1.length; _d++) {
            ...
            if (plugin.config) {
                config = exports.__assign(exports.__assign({}, config), plugin.config(config));
            }
        }
