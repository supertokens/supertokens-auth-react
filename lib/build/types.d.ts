...
export declare type CreateRecipeFunction<T, S, R, N extends NormalisedRecipeModuleConfig<T, S, R>> = (appInfo: NormalisedAppInfo, enableDebugLogs: boolean, overrideMaps: NonNullable<SuperTokensPlugin["overrideMap"]>[]) => BaseRecipeModule<T, S, R, N>;
