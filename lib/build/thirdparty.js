...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.getStateAndOtherInfoFromStorage = function (input) {
        return componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.getStateAndOtherInfoFromStorage(
    ...
    Wrapper.setStateAndOtherInfoToStorage = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.setStateAndOtherInfoToStorage(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.getAuthorisationURLWithQueryParamsAndSetState = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.getAuthorisationURLWithQueryParamsAndSetState(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.getAuthorisationURLFromBackend = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.getAuthorisationURLFromBackend(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.signInAndUp = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.signInAndUp(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.generateStateToSendToOAuthProvider = function (input) {
        return componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.generateStateToSendToOAuthProvider(
            utils.__assign(utils.__assign({}, input), {
                userContext: utils.getNormalisedUserContext(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.verifyAndGetStateOrThrowError = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.verifyAndGetStateOrThrowError(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.getAuthCodeFromURL = function (input) {
        return componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.getAuthCodeFromURL(
            utils.__assign(utils.__assign({}, input), {
                userContext: utils.getNormalisedUserContext(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.getAuthErrorFromURL = function (input) {
        return componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.getAuthErrorFromURL(
            utils.__assign(utils.__assign({}, input), {
                userContext: utils.getNormalisedUserContext(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.getAuthStateFromURL = function (input) {
        return componentOverrideContext.ThirdParty.getInstanceOrThrow().recipeImpl.getAuthStateFromURL(
            utils.__assign(utils.__assign({}, input), {
                userContext: utils.getNormalisedUserContext(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.ComponentsOverrideProvider = componentOverrideContext.Provider$1;
    return Wrapper;
})();
