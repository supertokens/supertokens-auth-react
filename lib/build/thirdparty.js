    ...
    function ActiveDirectory(config) {
        var _this =
            _super.call(this, {
                ...
                getFrontendRedirectURI: config === null || config === void 0 ? void 0 : config.getFrontendRedirectURI,
            }) || this;
...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.init = function (config) {
        return superTokens.ThirdParty.init(config);
    };
    Wrapper.signOut = function (input) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    superTokens.ThirdParty.getInstanceOrThrow().signOut({
    ...
    Wrapper.redirectToThirdPartyLogin = function (input) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            var recipeInstance;
            return superTokens.__generator(this, function (_a) {
                recipeInstance = superTokens.ThirdParty.getInstanceOrThrow();
                return [
                    2 /*return*/,
    ...
    Wrapper.getStateAndOtherInfoFromStorage = function (input) {
        return superTokens.ThirdParty.getInstanceOrThrow().webJSRecipe.getStateAndOtherInfoFromStorage(
    ...
    Wrapper.getAuthorisationURLWithQueryParamsAndSetState = function (input) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    superTokens.ThirdParty.getInstanceOrThrow().webJSRecipe.getAuthorisationURLWithQueryParamsAndSetState(
                        superTokens.__assign(superTokens.__assign({}, input), {
                            userContext: superTokens.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.signInAndUp = function (input) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    superTokens.ThirdParty.getInstanceOrThrow().webJSRecipe.signInAndUp(
                        superTokens.__assign(superTokens.__assign({}, input), {
                            userContext: superTokens.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
