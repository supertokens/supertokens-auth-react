        ...
        function () {
            ...
            return {
                ...
                onFactorChooserButtonClicked: function () {
                    return recipe$1.MultiFactorAuth.getInstanceOrThrow().redirectToFactorChooser(history);
                },
    ...
    React.useEffect(
        function () {
            if (state.loaded && state.isSetupAllowed === false && state.loginAttemptInfo === undefined) {
                void recipe$1.MultiFactorAuth.getInstanceOrThrow().redirectToFactorChooser();
            }
        },
