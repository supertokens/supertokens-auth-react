...
var MFAFooter = uiEntry.withOverride("PasswordlessMFAFooter", function PasswordlessMFAFooter(props) {
    ...
    return jsxRuntime.jsxs(
        "div",
        genericComponentOverrideContext.__assign(
            { "data-supertokens": "footerLinkGroupVert pwlessMFAFooter" },
            {
                children: [
                    claim.loading === false &&
...
var MFAOTPFooter = uiEntry.withOverride("PasswordlessMFAOTPFooter", function PasswordlessMFAOTPFooter(_a) {
    ...
    return jsxRuntime.jsxs(
        "div",
        genericComponentOverrideContext.__assign(
            { "data-supertokens": "footerLinkGroupVert pwlessMFAOTPFooter" },
            {
                children: [
                    isSetupAllowed
                        ? jsxRuntime.jsx(
...
var MFATheme = function (_a) {
    ...
    return activeScreen === MFAScreens.CloseTab
        ...
        : jsxRuntime.jsxs(
              "div",
              genericComponentOverrideContext.__assign(
                  { "data-supertokens": "container pwlessMFA" },
                  {
                      children: [
                          jsxRuntime.jsx(
                              "div",
...
function useOnLoad(props, recipeImplementation, dispatch, userContext) {
    ...
    var onLoad = React__namespace.useCallback(
        function (mfaInfo) {
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                var error, errorQueryParam, doSetup, loginAttemptInfo, isAlreadySetup, isAllowedToSetup;
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            error = undefined;
                        ...
                        case 1:
                            ...
                            if (!(props.contactMethod === "EMAIL")) return [3 /*break*/, 8];
                            if (!(isAlreadySetup && doSetup !== "true")) return [3 /*break*/, 6];
                            _a.label = 2;
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                        ...
                        case 7:
                            return [3 /*break*/, 14];
                        case 8:
                            if (!(isAlreadySetup && doSetup !== "true")) return [3 /*break*/, 13];
                            _a.label = 9;
                        case 9:
