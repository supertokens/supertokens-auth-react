...
var MFAFooter = uiEntry.withOverride("PasswordlessMFAFooter", function PasswordlessMFAFooter(props) {
    ...
    return jsxRuntime.jsxs(
        "div",
        genericComponentOverrideContext.__assign(
            { "data-supertokens": "footerLinkGroup pwlessMFAFooter" },
            {
                children: [
                    claim.loading === false &&
                            ...
                            genericComponentOverrideContext.__assign(
                                {
                                    "data-supertokens": "secondaryText secondaryLinkWithLeftArrow",
                                    onClick: function () {
                                        return props.onFactorChooserButtonClicked;
                                    },
                                },
...
var MFAOTPFooter = uiEntry.withOverride("PasswordlessMFAOTPFooter", function PasswordlessMFAOTPFooter(_a) {
    ...
    return jsxRuntime.jsxs(
        "div",
        genericComponentOverrideContext.__assign(
            { "data-supertokens": "footerLinkGroup pwlessMFAOTPFooter" },
            {
                children: [
                    isSetupAllowed
                        ? jsxRuntime.jsxs(
                              ...
                              genericComponentOverrideContext.__assign(
                                  {
                                      "data-supertokens": "secondaryText secondaryLinkWithLeftArrow",
                                      onClick: function () {
                                          return onFactorChooserButtonClicked;
                                      },
                                  },
                                  { children: t("PWLESS_MFA_FOOTER_CHOOSER_ANOTHER") }
                              )
...
function useChildProps$1(recipe$2, recipeImplementation, state, contactMethod, userContext, history) {
    ...
    return React.useMemo(
        function () {
            if (!recipe$2 || !recipeImplementation) {
                return undefined;
            }
            return {
                onSuccess: function () {
    ...
    React.useEffect(
        function () {
            if (state.loaded && state.isSetupAllowed === false && state.loginAttemptInfo === undefined) {
                void recipe$1.MultiFactorAuth.getInstanceOrThrow().redirectToFactorChooser(false, props.history);
            }
        },
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!!loginAttemptInfo) return [3 /*break*/, 9];
                            if (!(props.contactMethod === "EMAIL")) return [3 /*break*/, 5];
                            if (!(isAlreadySetup && doSetup !== "true")) return [3 /*break*/, 3];
                        ...
                        case 4:
                            return [3 /*break*/, 8];
                        case 5:
                            if (!(isAlreadySetup && doSetup !== "true")) return [3 /*break*/, 7];
                            // createCode also dispatches the necessary events
                            return [
                                4 /*yield*/,
                                recipeImplementation.createCode({
...
function getActiveScreen(props, currentDynamicLoginMethods) {
    var _a;
    var contactMethod = props.config.contactMethod;
    ...
    if (currentDynamicLoginMethods.loaded && currentDynamicLoginMethods.loginMethods.firstFactors) {
        ...
        firstFactors =
            (_a = recipe$1.MultiFactorAuth.getInstance()) === null || _a === void 0 ? void 0 : _a.getFirstFactors();
    }
    ...
    if (enabledContactMethods.length === 0) {
        throw new Error("No overlap between first factors and enabled contact methods"); // redirect to access denied?
    }
    if (props.featureState.successInAnotherTab) {
