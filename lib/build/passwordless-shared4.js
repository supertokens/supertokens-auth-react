...
var validators$1 = require("./passwordless-shared3.js");
...
var PhoneForm = uiEntry.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    ...
    React.useEffect(function () {
        ...
        void validators$1.preloadPhoneNumberUtils();
    }, []);
                    ...
                    formFields: [
                        {
                            ...
                            placeholder: "",
                            validate: validators$1.userInputCodeValidate,
                        },
                    ],
                    onSuccess: props.onSuccess,
                    buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON",
...
var LoadingScreen = uiEntry.withOverride("OTPLoadingScreen", OTPLoadingScreen);
    ...
    return jsxRuntime.jsxs(
        ...
        genericComponentOverrideContext.__assign(
            { "data-supertokens": "footerLinkGroupVert pwless-mfa footer" },
            {
                children: [
                    claim.loading === false &&
                        ((_b = (_a = claim.value) === null || _a === void 0 ? void 0 : _a.n.length) !== null &&
                        _b !== void 0
                            ? _b
                            : 0) > 1 &&
                        jsxRuntime.jsx(
                            "div",
                            genericComponentOverrideContext.__assign(
                                { "data-supertokens": "secondaryText", onClick: props.onFactorChooserButtonClicked },
                                { children: t("PWLESS_MFA_FOOTER_CHOOSER_ANOTHER") }
                            )
                        ),
                    jsxRuntime.jsxs(
                        "div",
            ...
            jsxRuntime.jsxs(
                ...
                genericComponentOverrideContext.__assign(
                    { "data-supertokens": "headerTitle withBackButton pwless-mfa header" },
                    {
                        children: [
                            claim.loading === false &&
                            ((_a = claim.value) === null || _a === void 0 ? void 0 : _a.n.length) === 0
...
var MFAOTPFooter = uiEntry.withOverride("PasswordlessMFAOTPFooter", function PasswordlessMFAOTPFooter(_a) {
    ...
    var loginAttemptInfo = _a.loginAttemptInfo,
        ...
        isSetupAllowed = _a.isSetupAllowed;
    var t = translationContext.useTranslation();
    var claim = session.useClaimValue(multifactorauth.MultiFactorAuthClaim);
    var userContext = uiEntry.useUserContext();
    return jsxRuntime.jsxs(
                    ...
                    isSetupAllowed
                        ...
                        : claim.loading === false &&
                          ...
                          jsxRuntime.jsx(
                              "div",
                              genericComponentOverrideContext.__assign(
                                  { "data-supertokens": "secondaryText", onClick: onFactorChooserButtonClicked },
                                  { children: t("PWLESS_MFA_FOOTER_CHOOSER_ANOTHER") }
                              )
                          ),
                    jsxRuntime.jsxs(
            ...
            jsxRuntime.jsxs(
                ...
                genericComponentOverrideContext.__assign(
                    { "data-supertokens": "headerTitle withBackButton pwless-mfa otpHeader" },
                    {
                        children: [
                            claim.loading === false &&
                            ((_b = claim.value) === null || _b === void 0 ? void 0 : _b.n.length) === 0 &&
                            isSetupAllowed === false
                                ? jsxRuntime.jsx(backButton.BackButton, { onClick: onBackButtonClicked })
                                : jsxRuntime.jsx("span", {
                                      "data-supertokens": "backButtonPlaceholder backButtonCommon",
                                  }),
...
var MFATheme = function (_a) {
    ...
    return activeScreen === MFAScreens.CloseTab
        ...
        ? jsxRuntime.jsx(sessionprebuiltui.AccessDeniedScreen, { useShadowDom: false, error: t(featureState.error) })
        : jsxRuntime.jsxs(
              "div",
              genericComponentOverrideContext.__assign(
                                          ...
                                          children: [
                                              activeScreen === MFAScreens.UserInputCodeForm
                                                  ...
                                                  : jsxRuntime.jsx(MFAHeader, {
                                                        onBackButtonClicked: onBackButtonClicked,
                                                        contactMethod:
                                                            activeScreen === MFAScreens.EmailForm ? "EMAIL" : "PHONE",
                                                    }),
...
function MFAThemeWrapper(props) {
    var hasFont = translations.hasFontDefined(props.config.rootStyle);
    var activeScreen = getActiveScreen$1(props);
    var activeStyle;
...
function getActiveScreen$1(props) {
...
var useSuccessInAnotherTabChecker$1 = function (callingConsumeCodeRef, recipeImpl, state, dispatch, userContext) {
    React.useEffect(
        function () {
            ...
            if (state.loginAttemptInfo && !state.successInAnotherTab) {
                var checkSessionIntervalHandle_1 = setInterval(function () {
                    return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
                        var currLoginAttempt;
                        var _a;
                        return genericComponentOverrideContext.__generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    if (!(callingConsumeCodeRef.current === false)) return [3 /*break*/, 2];
                                    return [4 /*yield*/, recipeImpl.getLoginAttemptInfo({ userContext: userContext })];
                                case 1:
                                    currLoginAttempt = _b.sent();
                                    if (
                                        currLoginAttempt === undefined ||
                                        currLoginAttempt.deviceId !==
...
var useFeatureReducer$1 = function () {
        ...
        function (oldState, action) {
            switch (action.type) {
                ...
                case "setError":
                    return genericComponentOverrideContext.__assign(
                        genericComponentOverrideContext.__assign({}, oldState),
                        { loaded: true, error: action.error }
                    );
                case "startVerify":
                    return genericComponentOverrideContext.__assign(
                        genericComponentOverrideContext.__assign({}, oldState),
...
function useChildProps$1(recipe$2, recipeImplementation, state, contactMethod, userContext, history) {
    var _this = this;
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
        ...
        function () {
            return {
                onSuccess: function () {
                    ...
                    return recipe.Session.getInstanceOrThrow()
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [
                                        4 /*yield*/,
                                        recipe.Session.getInstanceOrThrow().signOut({ userContext: userContext }),
                                    ];
                                case 1:
                                    _a.sent();
                                    return [
                ...
                onFactorChooserButtonClicked: function () {
                    return recipe$1.MultiFactorAuth.getInstanceOrThrow().redirectToFactorChooser(false, history);
                },
...
var MFAFeatureInner = function (props) {
    ...
    var recipeImplementation = React__namespace.useMemo(
        function () {
            return (
                props.recipe &&
                getModifiedRecipeImplementation$1(
    ...
    useSuccessInAnotherTabChecker$1(callingConsumeCodeRef, recipeImplementation, state, dispatch, userContext);
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(
        ...
        function () {
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    return [
                        2 /*return*/,
                        recipe$1.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.getMFAInfo({
                            userContext: userContext,
                        }),
                    ];
                });
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            enabledContactMethods = recipe$2.getEnabledContactMethods(
                        ...
                        case 3:
                            ...
                            if (!(props.contactMethod === "EMAIL")) return [3 /*break*/, 10];
                            if (!(isAlreadySetup && doSetup !== "true")) return [3 /*break*/, 8];
                            createResp = void 0;
                            _a.label = 4;
                        case 4:
                            _a.trys.push([4, 6, , 7]);
                        ...
                        case 7:
                            ...
                            return [3 /*break*/, 9];
                        case 8:
                            if (!mfaInfo.factors.isAllowedToSetup.includes("otp-email")) {
                                dispatch({
                                    type: "load",
                                ...
                                dispatch({
                                    ...
                                    loginAttemptInfo: loginAttemptInfo,
                                    error: error,
                                    isAllowedToSetup: true,
                                }); // since loginAttemptInfo is undefined, this will ask the user for the email
                            }
                            _a.label = 9;
                        case 9:
                            return [3 /*break*/, 16];
                        case 10:
                            if (!(isAlreadySetup && doSetup !== "true")) return [3 /*break*/, 15];
                            _a.label = 11;
                        case 11:
                            ...
                            return [
                                4 /*yield*/,
                                recipeImplementation.createCode({
                                    phoneNumber: mfaInfo.phoneNumber,
                                    userContext: userContext,
                                }),
                            ];
                        case 12:
                        ...
                        case 14:
                            return [3 /*break*/, 16];
                        case 15:
                            if (!mfaInfo.factors.isAllowedToSetup.includes("otp-phone")) {
                                dispatch({
                                    type: "load",
                                    loginAttemptInfo: loginAttemptInfo,
                                    isAllowedToSetup: false,
                                ...
                                dispatch({
                                    ...
                                    error: error,
                                    isAllowedToSetup: true,
                                }); // since loginAttemptInfo is undefined, this will ask the user for the phone number
                            }
                            _a.label = 16;
                        case 16:
                            return [3 /*break*/, 18];
                        case 17:
                            ...
                            dispatch({
                                ...
                                loginAttemptInfo: loginAttemptInfo,
                                error: error,
                                isAllowedToSetup: isAllowedToSetup,
                            });
                            _a.label = 18;
                        case 18:
                            return [2 /*return*/];
...
function getModifiedRecipeImplementation$1(originalImpl, config, dispatch, callingConsumeCodeRef) {
    var _this = this;
        ...
        createCode: function (input) {
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, validators$1.getPhoneNumberUtils()];
                        case 1:
            ...
            formFields: [
                {
                    ...
                    validate: validators$1.defaultValidate,
                },
            ],
            buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON",
            onSuccess: props.onSuccess,
                    ...
                    return genericComponentOverrideContext.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, validators$1.defaultEmailValidator(emailOrPhone)];
                            case 1:
...
function SignInUpThemeWrapper(props) {
    var hasFont = translations.hasFontDefined(props.config.rootStyle);
    var currentDynamicLoginMethods = uiEntry.useDynamicLoginMethods();
    var activeScreen = getActiveScreen(props, currentDynamicLoginMethods);
    var activeStyle;
...
function getActiveScreen(props, currentDynamicLoginMethods) {
    var enabledContactMethods = recipe$2.getEnabledContactMethods(
        props.config.contactMethod,
...
var useFeatureReducer = function (recipeImpl, contactMethod, userContext) {
    var dynamicLoginMethods = uiEntry.useDynamicLoginMethods();
    ...
    React.useEffect(
        function () {
            ...
            function load() {
                return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                    var error, errorQueryParam, messageQueryParam, loginAttemptInfo, enabledContactMethods;
                    return genericComponentOverrideContext.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                error = undefined;
                            ...
                            case 1:
                                ...
                                if (
                                    !(
                                        loginAttemptInfo &&
                                        !enabledContactMethods.includes(loginAttemptInfo.contactMethod)
                                    )
                                )
                                    return [3 /*break*/, 3];
                                return [
                                    ...
                                    recipeImpl === null || recipeImpl === void 0
                                        ? void 0
                                        : recipeImpl.clearLoginAttemptInfo({ userContext: userContext }),
                                ];
                            case 2:
                                _a.sent();
                                loginAttemptInfo = undefined;
...
var SignInUpFeatureInner = function (props) {
    var userContext = uiEntry.useUserContext();
    var _a = useFeatureReducer(props.recipe.webJSRecipe, props.recipe.config.contactMethod, userContext),
        state = _a[0],
        dispatch = _a[1];
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    ...
    PasswordlessPreBuiltUI.MfaOtpPhone = function (prop) {
        return _a.getFeatureComponent("otp-phone", prop);
    };
    PasswordlessPreBuiltUI.MfaOtpEmail = function (prop) {
        return _a.getFeatureComponent("otp-email", prop);
    };
