...
var multifactorauth = require("./multifactorauth.js");
...
var MFAFooter = uiEntry.withOverride("PasswordlessMFAFooter", function PasswordlessMFAFooter(props) {
    ...
    return jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [
            claim.loading === false &&
                ((_b = (_a = claim.value) === null || _a === void 0 ? void 0 : _a.n.length) !== null && _b !== void 0
                    ? _b
                    : 0) > 1 &&
                jsxRuntime.jsx(
                    "div",
...
function useOnLoad(props, recipeImplementation, dispatch, userContext) {
    ...
    var handleLoadError = React__namespace.useCallback(
        ...
        function () {
            return dispatch({ type: "setError", error: "Getting mfaInfo failed!" });
        },
        [dispatch]
