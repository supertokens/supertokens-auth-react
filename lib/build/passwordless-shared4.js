...
function useChildProps$1(recipe$2, recipeImplementation, state, contactMethod, userContext, navigate) {
    var _this = this;
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
        ...
        function () {
            return {
                ...
                onFactorChooserButtonClicked: function () {
                    return recipe$1.MultiFactorAuth.getInstanceOrThrow().redirectToFactorChooser(
                        false,
                        undefined,
                        history
                    );
...
var MFAFeatureInner = function (props) {
    ...
    var recipeImplementation = React__namespace.useMemo(
        function () {
            return (
                props.recipe &&
                getModifiedRecipeImplementation$1(props.recipe.webJSRecipe, props.recipe.config, dispatch)
            );
        },
        [props.recipe]
    );
            ...
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            loginAttemptInfo = _a.sent();
                            factorId = props.contactMethod === "EMAIL" ? "otp-email" : "otp-phone";
                            isAlreadySetup = mfaInfo.factors.isAlreadySetup.includes(factorId);
                            isAllowedToSetup = mfaInfo.factors.isAllowedToSetup.includes(factorId);
                        ...
                        case 2:
                            ...
                            _a.label = 3;
                        case 3:
                            if (!!loginAttemptInfo) return [3 /*break*/, 13];
                            createCodeInfo =
                                props.contactMethod === "EMAIL"
                                    ? { email: mfaInfo.email }
                                    : { phoneNumber: mfaInfo.phoneNumber };
                            if (!(isAlreadySetup && doSetup !== "true")) return [3 /*break*/, 11];
                            _a.label = 4;
                        case 4:
                            _a.trys.push([4, 9, , 10]);
                            createResp = void 0;
                        ...
                        case 10:
                            return [3 /*break*/, 12];
                        case 11:
                            if (!mfaInfo.factors.isAllowedToSetup.includes(factorId)) {
                                dispatch({
                                    type: "load",
                                    loginAttemptInfo: undefined,
...
function getModifiedRecipeImplementation$1(originalImpl, config, dispatch) {
    var _this = this;
...
(function (SignInUpScreens) {
    SignInUpScreens[(SignInUpScreens["LinkSent"] = 0)] = "LinkSent";
    SignInUpScreens[(SignInUpScreens["EmailForm"] = 1)] = "EmailForm";
    SignInUpScreens[(SignInUpScreens["PhoneForm"] = 2)] = "PhoneForm";
    SignInUpScreens[(SignInUpScreens["EmailOrPhoneForm"] = 3)] = "EmailOrPhoneForm";
    SignInUpScreens[(SignInUpScreens["UserInputCodeForm"] = 4)] = "UserInputCodeForm";
...
var SignInUpTheme = function (_a) {
    ...
    return activeScreen === exports.SignInUpScreens.LinkSent
        ? jsxRuntime.jsx(
              LinkSent,
              genericComponentOverrideContext.__assign({}, commonProps, {
                  loginAttemptInfo: featureState.loginAttemptInfo,
...
function SignInUpThemeWrapper(props) {
    ...
    var activeStyle;
    if (activeScreen === exports.SignInUpScreens.LinkSent) {
...
function useChildProps(recipe$1, dispatch, state, userContext, navigate) {
    var recipeImplementation = React__namespace.useMemo(
        function () {
            return recipe$1 && getModifiedRecipeImplementation(recipe$1.webJSRecipe, recipe$1.config, dispatch);
        },
        [recipe$1]
    );
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
...
var SignInUpFeatureInner = function (props) {
    ...
    var _a = useFeatureReducer(props.recipe.webJSRecipe, props.recipe.config.contactMethod, userContext),
        state = _a[0],
        dispatch = _a[1];
    var childProps = useChildProps(props.recipe, dispatch, state, userContext, props.navigate);
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(
                        ...
                        genericComponentOverrideContext.__assign(
                            { userContext: props.userContext },
                            {
                                children: jsxRuntime.jsx(
                                    ...
                                    genericComponentOverrideContext.__assign(
                                        { authRecipe: _this.recipeInstance, navigate: props.navigate },
                                        {
                                            children: jsxRuntime.jsx(
                                                SignInUpFeature,
                                                genericComponentOverrideContext.__assign(
...
exports.MFAThemeWrapper = MFAThemeWrapper;
