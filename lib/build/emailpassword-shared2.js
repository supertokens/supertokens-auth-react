...
var SignUpFooter = genericComponentOverrideContext.withOverride(
    "EmailPasswordSignUpFooter",
    function EmailPasswordSignUpFooter(_a) {
...
var SignUpHeader = genericComponentOverrideContext.withOverride(
 ...
 * Component.
 */
var SignUpForm = genericComponentOverrideContext.withOverride(
...
var SignUp = genericComponentOverrideContext.withOverride("EmailPasswordSignUp", function EmailPasswordSignUp(props) {
    return jsxRuntime.jsxs(
        "div",
        sessionAuth.__assign(
...
var SignInFooter = genericComponentOverrideContext.withOverride(
...
var SignInForm = genericComponentOverrideContext.withOverride(
...
var SignInHeader = genericComponentOverrideContext.withOverride(
    "EmailPasswordSignInHeader",
    function EmailPasswordSignInHeader(_a) {
        var onClick = _a.onClick;
        var t = translationContext.useTranslation();
        return jsxRuntime.jsxs(React.Fragment, {
            children: [
...
var SignIn = genericComponentOverrideContext.withOverride("EmailPasswordSignIn", function EmailPasswordSignIn(props) {
    return jsxRuntime.jsxs(
        "div",
        sessionAuth.__assign(
            { "data-supertokens": "container" },
...
var defaultTranslationsEmailPassword = {
    en: sessionAuth.__assign(
        sessionAuth.__assign(
            sessionAuth.__assign({}, genericComponentOverrideContext.defaultTranslationsCommon.en),
...
var ResetPasswordEmail = genericComponentOverrideContext.withOverride(
...
var SubmitNewPassword = genericComponentOverrideContext.withOverride(
            ...
            var submitNewPasswordForm =
                _this.state.token === undefined
                    ...
                    : {
                          ...
                          recipeImplementation: _this.props.recipe.webJSRecipe,
