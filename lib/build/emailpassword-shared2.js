...
function BackButton(_a) {
    ...
    return jsxRuntime.jsx(
        ...
        session.__assign(
            ...
            { children: jsxRuntime.jsx(session.HeavyArrowLeftIcon, { color: "rgb(var(--palette-textTitle))" }) }
        )
    );
}
...
var ResetPasswordEmail = session.withOverride("EmailPasswordResetPasswordEmail", EmailPasswordResetPasswordEmail);
...
var SubmitNewPassword = session.withOverride("EmailPasswordSubmitNewPassword", EmailPasswordSubmitNewPassword);
...
function ResetPasswordUsingTokenTheme(props) {
    ...
    if (props.submitNewPasswordForm !== undefined) {
        return jsxRuntime.jsx(SubmitNewPassword, session.__assign({}, props.submitNewPasswordForm));
    }
    // Otherwise, return EnterEmail.
    return jsxRuntime.jsx(ResetPasswordEmail, session.__assign({}, props.enterEmailForm));
}
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    session.__assign(
                        ...
                        { children: jsxRuntime.jsx(ResetPasswordUsingTokenTheme, session.__assign({}, props)) }
                    )
                ),
            }
        )
...
var SignInFooter = session.withOverride("EmailPasswordSignInFooter", function EmailPasswordSignInFooter(_a) {
    var onClick = _a.onClick;
    var t = session.useTranslation();
    return jsxRuntime.jsx(
        "div",
...
var SignInForm = session.withOverride("EmailPasswordSignInForm", function EmailPasswordSignInForm(props) {
    var _this = this;
    var userContext = session.useUserContext();
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                session.validateForm(formFields, props.config.signInAndUpFeature.signInForm.formFields),
                            ];
                        case 1:
                            validationErrors = _a.sent();
                            if (validationErrors.length > 0) {
...
var SignInHeader = session.withOverride("EmailPasswordSignInHeader", function EmailPasswordSignInHeader(_a) {
    var onClick = _a.onClick;
    var t = session.useTranslation();
...
var SignIn = session.withOverride("EmailPasswordSignIn", function EmailPasswordSignIn(props) {
    return jsxRuntime.jsxs(
        "div",
        session.__assign(
            { "data-supertokens": "container" },
...
var SignUpFooter = session.withOverride("EmailPasswordSignUpFooter", function EmailPasswordSignUpFooter(_a) {
 ...
 * Component.
 */
var SignUpForm = session.withOverride("EmailPasswordSignUpForm", function EmailPasswordSignUpForm(props) {
    var _this = this;
    var userContext = session.useUserContext();
    return jsxRuntime.jsx(validators.FormBase, {
        formFields: props.formFields,
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                session.validateForm(formFields, props.config.signInAndUpFeature.signUpForm.formFields),
                            ];
                        case 1:
                            validationErrors = _a.sent();
                            if (validationErrors.length > 0) {
...
var SignUpHeader = session.withOverride("EmailPasswordSignUpHeader", function EmailPasswordSignUpHeader(_a) {
    var onClick = _a.onClick;
    var t = session.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
...
var SignUp = session.withOverride("EmailPasswordSignUp", function EmailPasswordSignUp(props) {
    return jsxRuntime.jsxs(
        "div",
        session.__assign(
            { "data-supertokens": "container" },
...
var SignInAndUpTheme = function (props) {
    ...
    if (props.featureState.isSignUp) {
        return jsxRuntime.jsx(
            SignUp,
            session.__assign({}, props.signUpForm, {
    ...
    return jsxRuntime.jsx(
        SignIn,
        session.__assign({}, props.signInForm, {
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    session.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignInAndUpTheme, session.__assign({}, props)) }
                    )
                ),
            }
        )
...
var defaultTranslationsEmailPassword = {
    en: session.__assign(
        session.__assign(
            session.__assign({}, session.defaultTranslationsCommon.en),
...
var ResetPasswordUsingToken = function (props) {
    var token = session.getQueryParams("token");
        ...
        token === undefined || token === null
            ...
            : {
                  ...
                  onSignInClicked: function () {
                      void session.SuperTokens.getInstanceOrThrow().redirectToAuth({
                          show: "signin",
...
var useFeatureReducer = function (recipe) {
    return React__namespace.useReducer(
        function (oldState, action) {
            switch (action.type) {
                case "setSignIn":
                    return session.__assign(session.__assign({}, oldState), { error: undefined, isSignUp: false });
                case "setSignUp":
                    return session.__assign(session.__assign({}, oldState), { error: undefined, isSignUp: true });
                case "setError":
        ...
        function (initArg) {
            var show = session.getQueryParams("show");
...
var getModifiedRecipeImplementation = function (origImpl) {
    return session.__assign({}, origImpl);
};
function getThemeSignUpFeatureFormFields(formFields, recipe, userContext) {
    ...
    return formFields.map(function (field) {
        return session.__assign(session.__assign({}, field), {
                        ...
                        case 0:
                            return [
                                ...
                                webJsImplementation.submitNewPassword.bind(this)(
                                    session.__assign(session.__assign({}, input), { formFields: [input.formFields[0]] })
                                ),
                            ];
                        case 1:
                            response = _a.sent();
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.sendPasswordResetEmail.bind(this)(session.__assign({}, input)),
                            ];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
        ...
        signUp: function (input) {
            return session.__awaiter(this, void 0, void 0, function () {
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJsImplementation.signUp.bind(this)(session.__assign({}, input))];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
                                recipeInput.onHandleEvent({
        ...
        signIn: function (input) {
            return session.__awaiter(this, void 0, void 0, function () {
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJsImplementation.signIn.bind(this)(session.__assign({}, input))];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
                                recipeInput.onHandleEvent({
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.doesEmailExist.bind(this)(session.__assign({}, input)),
                            ];
                        case 1:
                            return [2 /*return*/, _a.sent()];
                    }
...
function normaliseSignInAndUpFeature(config) {
    ...
    var defaultSignInFields = signUpForm.formFields.reduce(function (signInFieldsAccumulator, field) {
        if (field.id === "email") {
            return session.__spreadArray(session.__spreadArray([], signInFieldsAccumulator, true), [field], false);
        }
        if (field.id === "password") {
            return session.__spreadArray(
                session.__spreadArray([], signInFieldsAccumulator, true),
                [
                    session.__assign(session.__assign({}, field), {
...
function normaliseSignInFormFeatureConfig(defaultFormFields, config) {
    ...
    if (config.formFields !== undefined) {
        userFormFields = config.formFields
            ...
            .map(function (field) {
                return session.__assign(session.__assign({}, field), { optional: false });
            });
    }
    var formFields = mergeFormFields(defaultFormFields, userFormFields);
    var style = config.style !== undefined ? config.style : "";
...
function normaliseResetPasswordUsingTokenFeature(signUpPasswordFieldValidate, signUpEmailField, config) {
    ...
    var enterEmailForm = {
        ...
        formFields: [
            session.__assign(session.__assign({}, getDefaultEmailFormField()), {
    ...
    for (var i = 0; i < userFormFields.length; i++) {
        ...
        for (var j = 0; j < mergedFormFields.length; j++) {
            ...
            if (userField.id === mergedField.id) {
                ...
                // Merge.
                mergedFormFields[j] = session.__assign(
                    session.__assign(session.__assign({}, mergedFormFields[j]), userField),
                    { optional: optional }
                );
                isNewField = false;
                break;
...
var EmailPassword = /** @class */ (function (_super) {
    session.__extends(EmailPassword, _super);
    ...
    EmailPassword.init = function (config) {
        return function (appInfo) {
            EmailPassword.instance = new EmailPassword(
                session.__assign(session.__assign({}, config), { appInfo: appInfo, recipeId: EmailPassword.RECIPE_ID })
            );
