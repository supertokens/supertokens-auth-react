...
var SignUpFooter = index.withOverride("EmailPasswordSignUpFooter", function EmailPasswordSignUpFooter(_a) {
...
var SignUpHeader = index.withOverride("EmailPasswordSignUpHeader", function EmailPasswordSignUpHeader(_a) {
 ...
 * Component.
 */
var SignUpForm = index.withOverride("EmailPasswordSignUpForm", function EmailPasswordSignUpForm(props) {
    var _this = this;
...
var SignUp = index.withOverride("EmailPasswordSignUp", function EmailPasswordSignUp(props) {
    return jsxRuntime.jsxs(
        "div",
        sessionAuth.__assign(
...
var SignInFooter = index.withOverride("EmailPasswordSignInFooter", function EmailPasswordSignInFooter(_a) {
    var onClick = _a.onClick;
    var t = translationContext.useTranslation();
...
var SignInForm = index.withOverride("EmailPasswordSignInForm", function EmailPasswordSignInForm(props) {
    var _this = this;
    var userContext = sessionAuth.useUserContext();
    return jsxRuntime.jsx(arrowLeftIcon.FormBase, {
        formFields: props.formFields,
...
var SignInHeader = index.withOverride("EmailPasswordSignInHeader", function EmailPasswordSignInHeader(_a) {
    var onClick = _a.onClick;
    var t = translationContext.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
...
var SignIn = index.withOverride("EmailPasswordSignIn", function EmailPasswordSignIn(props) {
    return jsxRuntime.jsxs(
        "div",
        sessionAuth.__assign(
            { "data-supertokens": "container" },
...
var defaultTranslationsEmailPassword = {
    en: sessionAuth.__assign(
        sessionAuth.__assign(
            sessionAuth.__assign({}, index.defaultTranslationsCommon.en),
                    ...
                    return sessionAuth.__awaiter(_this, void 0, void 0, function () {
                        ...
                        return sessionAuth.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 4:
                                    err_1 = _a.sent();
                                    if (index.STGeneralError.isThisError(err_1)) {
...
var ResetPasswordEmail = index.withOverride("EmailPasswordResetPasswordEmail", EmailPasswordResetPasswordEmail);
...
var SubmitNewPassword = index.withOverride("EmailPasswordSubmitNewPassword", EmailPasswordSubmitNewPassword);
...
function getRecipeImplementation(recipeInput) {
    var webJsImplementation = recipeImplementation$1.getRecipeImplementation({
            ...
            return sessionAuth.__awaiter(_this, void 0, void 0, function () {
                ...
                return sessionAuth.__generator(this, function (_a) {
                    if (context.action === "RESET_PASSWORD") {
                        resetPasswordPath = new sessionAuth.NormalisedURLPath(
