    ...
    if (config.formFields !== undefined) {
        userFormFields = config.formFields
            ...
            .filter(function (field) {
                return arrowLeftIcon.MANDATORY_FORM_FIELDS_ID_ARRAY.includes(field.id);
            })
...
var SignUpFooter = sessionAuth.withOverride("EmailPasswordSignUpFooter", function EmailPasswordSignUpFooter(_a) {
...
var SignUpHeader = sessionAuth.withOverride("EmailPasswordSignUpHeader", function EmailPasswordSignUpHeader(_a) {
 ...
 * Component.
 */
var SignUpForm = sessionAuth.withOverride("EmailPasswordSignUpForm", function EmailPasswordSignUpForm(props) {
    var _this = this;
...
var SignUp = sessionAuth.withOverride("EmailPasswordSignUp", function EmailPasswordSignUp(props) {
    return jsxRuntime.jsxs(
        "div",
        sessionAuth.__assign(
...
var SignInFooter = sessionAuth.withOverride("EmailPasswordSignInFooter", function EmailPasswordSignInFooter(_a) {
    var onClick = _a.onClick;
    var t = sessionAuth.useTranslation();
...
var SignInForm = sessionAuth.withOverride("EmailPasswordSignInForm", function EmailPasswordSignInForm(props) {
    var _this = this;
    var userContext = sessionAuth.useUserContext();
    return jsxRuntime.jsx(arrowLeftIcon.FormBase, {
        formFields: props.formFields,
...
var SignInHeader = sessionAuth.withOverride("EmailPasswordSignInHeader", function EmailPasswordSignInHeader(_a) {
    var onClick = _a.onClick;
    var t = sessionAuth.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
...
var SignIn = sessionAuth.withOverride("EmailPasswordSignIn", function EmailPasswordSignIn(props) {
    return jsxRuntime.jsxs(
        "div",
        sessionAuth.__assign(
            { "data-supertokens": "container" },
...
var defaultTranslationsEmailPassword = {
    en: sessionAuth.__assign(
        sessionAuth.__assign(
            sessionAuth.__assign({}, sessionAuth.defaultTranslationsCommon.en),
...
var ResetPasswordEmail = sessionAuth.withOverride("EmailPasswordResetPasswordEmail", EmailPasswordResetPasswordEmail);
...
var SubmitNewPassword = sessionAuth.withOverride("EmailPasswordSubmitNewPassword", EmailPasswordSubmitNewPassword);
...
var ResetPasswordUsingToken = /** @class */ (function (_super) {
    sessionAuth.__extends(ResetPasswordUsingToken, _super);
    /*
     * Constructor.
     */
                    ...
                    : {
                          ...
                          onError: function (error) {
                              return _this.setState(function (os) {
                                  return sessionAuth.__assign(sessionAuth.__assign({}, os), { error: error });
                              });
                          },
                          clearError: function () {
                              return _this.setState(function (os) {
                                  return sessionAuth.__assign(sessionAuth.__assign({}, os), { error: undefined });
                              });
                          },
    ...
    function EmailPassword(config) {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.config.resetPasswordUsingTokenFeature.disableDefaultUI !== true) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(
                    new NormalisedURLPath__default.default(arrowLeftIcon.DEFAULT_RESET_PASSWORD_PATH)
                );
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: sessionAuth.matchRecipeIdUsingQueryParams(_this.config.recipeId),
                    component: function (props) {
