...
var getFunctionOverrides = function (recipeId, onHandleEvent) {
    return function (originalImp) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImp), { signInAndUp: function (input) {
                ...
                return genericComponentOverrideContext.__generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            ...
                            return [3 /*break*/, 3];
                        case 3: return [4 /*yield*/, originalImp.signInAndUp(input)];
                        case 4:
                            response = _c.sent();
            ...
            var _a;
            var loginChallenge = (_a = genericComponentOverrideContext.getQueryParams("loginChallenge")) !== null && _a !== void 0 ? _a : undefined;
            return originalImp.setStateAndOtherInfoToStorage({
                state: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, input.state), { rid: recipeId, oauth2LoginChallenge: loginChallenge, redirectToPath: genericComponentOverrideContext.getRedirectToPathFromURL() }),
                userContext: input.userContext,
            });
        } })); };
};
...
function ProviderButton(_a) {
    ...
    return (jsxRuntime.jsxs("button", genericComponentOverrideContext.__assign({ "data-supertokens": "button providerButton ".concat(providerStyleName) }, { children: [logo !== undefined && (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "providerButtonLeft" }, { children: jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "providerButtonLogo" }, { children: jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "providerButtonLogoCenter" }, { children: logo })) })) }))), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "providerButtonText", ref: buttonTextContainerRef }, { children: jsxRuntime.jsxs("span", { children: [t("THIRD_PARTY_PROVIDER_DEFAULT_BTN_START"), displayName, t("THIRD_PARTY_PROVIDER_DEFAULT_BTN_END")] }) }))] })));
}
        ...
        this.getButton = function (name) {
            if (_this.config.buttonComponent !== undefined) {
                if (typeof _this.config.buttonComponent === "function") {
                    return jsxRuntime.jsx(_this.config.buttonComponent, { name: name !== null && name !== void 0 ? name : _this.name });
                }
                return _this.config.buttonComponent;
            }
            var providerName = name !== undefined ? name : _this.name;
            return jsxRuntime.jsx(ProviderButton, { logo: _this.getLogo(), providerName: providerName, displayName: providerName });
        };
    }
...
var Bitbucket = /** @class */ (function (_super) {
    ...
    function Bitbucket(config) {
        var _this = _super.call(this, genericComponentOverrideContext.__assign({ id: "bitbucket", name: "Bitbucket" }, config)) || this;
        _this.getLogo = function () {
            return (jsxRuntime.jsxs("svg", genericComponentOverrideContext.__assign({ width: "19", height: "17", viewBox: "0 0 19 17", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, { children: [jsxRuntime.jsx("path", { d: "M0.59534 0.0522702C0.229457 0.0522702 -0.0841565 0.365883 0.0203815 0.73174L2.58156 16.2556C2.63383 16.6738 2.99971 16.9351 3.3656 16.9351H15.6488C15.9624 16.9351 16.1715 16.726 16.2238 16.4124L18.7849 0.679471C18.8372 0.313614 18.5759 0 18.21 0L0.59534 0.0522702ZM11.3628 11.2901H7.44258L6.3972 5.74956H12.3036L11.3628 11.2901Z", fill: "#2684FF" }), jsxRuntime.jsx("path", { d: "M17.9502 5.76172H12.3052L11.3643 11.3022H7.44415L2.84448 16.7905C2.84448 16.7905 3.05356 16.9996 3.36717 16.9996H15.6504C15.964 16.9996 16.1731 16.7905 16.2253 16.4769L17.9502 5.76172Z", fill: "url(#paint0_linear_4108_67124)" }), jsxRuntime.jsx("defs", { children: jsxRuntime.jsxs("linearGradient", genericComponentOverrideContext.__assign({ id: "paint0_linear_4108_67124", x1: "19.2748", y1: "7.29202", x2: "9.92001", y2: "14.5943", gradientUnits: "userSpaceOnUse" }, { children: [jsxRuntime.jsx("stop", { offset: "0.176", stopColor: "#0052CC" }), jsxRuntime.jsx("stop", { offset: "1", stopColor: "#2684FF" })] })) })] })));
        };
        return _this;
    }
    /*
...
var BoxySAML = /** @class */ (function (_super) {
    ...
    function BoxySAML(config) {
        var _this = _super.call(this, genericComponentOverrideContext.__assign({ id: "boxy-saml", name: "BoxySAML" }, config)) || this;
        _this.getLogo = function () {
...
var GoogleWorkspaces = /** @class */ (function (_super) {
    ...
    function GoogleWorkspaces(config) {
        var _this = _super.call(this, genericComponentOverrideContext.__assign({ id: "google-workspaces", name: "Google Workspaces" }, config)) || this;
        _this.getLogo = function () {
            return (jsxRuntime.jsxs("svg", genericComponentOverrideContext.__assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 48 48", width: "18px", height: "18px" }, { children: [jsxRuntime.jsx("path", { fill: "#FFC107", d: "M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12c0-6.627,5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24c0,11.045,8.955,20,20,20c11.045,0,20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z" }), jsxRuntime.jsx("path", { fill: "#FF3D00", d: "M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z" }), jsxRuntime.jsx("path", { fill: "#4CAF50", d: "M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z" }), jsxRuntime.jsx("path", { fill: "#1976D2", d: "M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z" })] })));
        };
        return _this;
    }
    /*
...
var LinkedIn = /** @class */ (function (_super) {
    ...
    function LinkedIn(config) {
        ...
        _this.getLogo = function () {
            return (jsxRuntime.jsxs("svg", genericComponentOverrideContext.__assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 48 48", width: "20", height: "20" }, { children: [jsxRuntime.jsx("path", { fill: "#0288D1", d: "M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z" }), jsxRuntime.jsx("path", { fill: "#FFF", d: "M12 19H17V36H12zM14.485 17h-.028C12.965 17 12 15.888 12 14.499 12 13.08 12.995 12 14.514 12c1.521 0 2.458 1.08 2.486 2.499C17 15.887 16.035 17 14.485 17zM36 36h-5v-9.099c0-2.198-1.225-3.698-3.192-3.698-1.501 0-2.313 1.012-2.707 1.99C24.957 25.543 25 26.511 25 27v9h-5V19h5v2.616C25.721 20.5 26.85 19 29.738 19c3.578 0 6.261 2.25 6.261 7.274L36 36 36 36z" })] })));
        };
        return _this;
    }
    /*
...
var Twitter = /** @class */ (function (_super) {
    ...
    function Twitter(config) {
        var _this = this;
        var name = "X";
        var normalisedUseLegacyTwitterLogo = (config === null || config === void 0 ? void 0 : config.useLegacyTwitterLogo) === true;
        if (normalisedUseLegacyTwitterLogo) {
            name = "Twitter";
        }
        _this = _super.call(this, genericComponentOverrideContext.__assign({ id: "twitter", name: name }, config)) || this;
        _this.useLegacyTwitterLogo = false;
        _this.getLogo = function () {
            if (_this.useLegacyTwitterLogo === true) {
                return (jsxRuntime.jsx("svg", genericComponentOverrideContext.__assign({ xmlns: "http://www.w3.org/2000/svg", width: "20.129", height: "16.356", viewBox: "0 0 20.129 16.356" }, { children: jsxRuntime.jsx("g", { children: jsxRuntime.jsx("g", { children: jsxRuntime.jsx("path", { fill: "#04ABEE", d: "M45.232 35.964a8.242 8.242 0 0 1-2.372.649 4.141 4.141 0 0 0 1.816-2.284 8.268 8.268 0 0 1-2.623 1 4.133 4.133 0 0 0-7.037 3.771 11.724 11.724 0 0 1-8.516-4.317 4.133 4.133 0 0 0 1.282 5.517 4.1 4.1 0 0 1-1.87-.517v.052a4.132 4.132 0 0 0 3.313 4.049 4.147 4.147 0 0 1-1.865.071 4.134 4.134 0 0 0 3.858 2.868 8.338 8.338 0 0 1-6.114 1.71 11.745 11.745 0 0 0 18.08-9.894q0-.268-.012-.534a8.374 8.374 0 0 0 2.061-2.137z", transform: "translate(34.799 -7.41) translate(2.201 4.266) translate(-62.103 -30.883)" }) }) }) })));
            }
            return (jsxRuntime.jsx("svg", genericComponentOverrideContext.__assign({ xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 1200 1227" }, { children: jsxRuntime.jsx("path", { d: "M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z", fill: "#000" }) })));
        };
...
function normaliseThirdPartyConfig(config) {
    ...
    var oAuthCallbackScreen = config.oAuthCallbackScreen === undefined ? {} : { style: config.oAuthCallbackScreen.style };
    var override = genericComponentOverrideContext.__assign({ functions: function (originalImplementation) { return originalImplementation; } }, config.override);
    return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, utils.normaliseAuthRecipe(config)), { signInAndUpFeature: signInAndUpFeature, oAuthCallbackScreen: oAuthCallbackScreen, override: override });
}
function normaliseSignInAndUpFeature(config) {
     ...
     */
    var providers = Array.from(new Set(providersWithCustom.map(function (provider) { return provider.id; }))).map(function (id) { return providersWithCustom.find(function (provider) { return provider.id === id; }); });
    return {
        style: style,
        providers: providers,
    };
...
function redirectToThirdPartyLogin(input) {
    return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
        ...
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, genericComponentOverrideContext.Multitenancy.getInstanceOrThrow().getCurrentDynamicLoginMethods({
                        userContext: input.userContext,
                    })];
                case 1:
                    loginMethods = _a.sent();
                    tenantProviders = (loginMethods === null || loginMethods === void 0 ? void 0 : loginMethods.firstFactors.includes(types.FactorIds.THIRDPARTY))
                    ...
                    provider = providers.find(function (p) { return p.id === input.thirdPartyId; });
                    if (provider === undefined) {
                        return [2 /*return*/, { status: "ERROR" }];
                    }
                    return [4 /*yield*/, input.recipeImplementation.getAuthorisationURLWithQueryParamsAndSetState({
...
var mergeProviders = function (_a) {
    var _b = _a.tenantProviders, tenantProviders = _b === void 0 ? [] : _b, _c = _a.clientProviders, clientProviders = _c === void 0 ? [] : _c;
    ...
    var _loop_1 = function (tenantProvider) {
        ...
        if (provider !== undefined) {
            providers.push(Custom.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, provider.config), { id: tenantProvider.id, name: tenantProvider.name, buttonComponent: provider.getButton(tenantProvider.name) })));
        }
        else {
...
var ThirdParty = /** @class */ (function (_super) {
    ...
    function ThirdParty(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = ThirdpartyWebJS__default.default; }
        var _this = this;
         ...
         * Instance methods.
         */
        _this.getDefaultRedirectionURL = function (context) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            return genericComponentOverrideContext.__generator(this, function (_a) {
    ...
    ThirdParty.init = function (config) {
        return {
            ...
            authReact: function (appInfo, _, overrideMaps) {
                var normalisedConfig = normaliseThirdPartyConfig(genericComponentOverrideContext.applyPlugins(ThirdParty.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : []));
                ThirdParty.instance = new ThirdParty(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: ThirdParty.RECIPE_ID }));
            ...
            webJS: function () {
                ...
                var init = ThirdpartyWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
...
var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext(undefined, ThirdParty.RECIPE_ID), useContext = _a[0], Provider = _a[1];
