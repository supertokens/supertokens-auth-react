                        ...
                        uiEntry.__assign(
                            { "data-supertokens": "row" },
                            {
                                children: [
                                    ...
                                    jsxRuntime.jsx(ProvidersForm, uiEntry.__assign({}, props)),
        ...
        function () {
            ...
            if (errorQueryParam !== null) {
                if (errorQueryParam === "signin") {
                    ...
                    var customError = uiEntry.getQueryParams("message");
                    if (customError === null) {
                        error = "SOMETHING_WENT_WRONG_ERROR";
                    } else {
                        error = customError;
...
var SignInAndUpFeature = function (props) {
    ...
    var themeProps = uiEntry.__assign(uiEntry.__assign({}, childProps), { providers: providers });
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(
                    SignInAndUpThemeWrapper,
                    uiEntry.__assign({}, themeProps, { featureState: state, dispatch: dispatch })
                ),
            props.children &&
            ...
            { value: recipeComponentOverrides },
            {
                children: jsxRuntime.jsx(
                    ...
                    uiEntry.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignInAndUpFeature, uiEntry.__assign({}, props)) }
                    )
                ),
            }
        )
...
var ThirdPartySignInAndUpCallbackTheme = /** @class */ (function (_super) {
    uiEntry.__extends(ThirdPartySignInAndUpCallbackTheme, _super);
...
var SignInAndUpCallback$1 = function (props) {
    ...
    uiEntry.useOnMountAPICall(verifyCode, handleVerifyResponse, handleError);
    var recipeComponentOverrides = props.useComponentOverrides();
    return jsxRuntime.jsx(
        uiEntry.ComponentOverrideContext.Provider,
        uiEntry.__assign(
...
var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    uiEntry.__extends(ThirdPartyPreBuiltUI, _super);
    function ThirdPartyPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            if (useComponentOverrides === void 0) {
                useComponentOverrides = uiEntry.useContext$1;
            }
            var features = {};
            if (_this.recipeInstance.config.signInAndUpFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    recipeID: uiEntry.ThirdParty.RECIPE_ID,
                };
            }
            ...
            _this.recipeInstance.config.signInAndUpFeature.providers.forEach(function (provider) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: function () {
                        return uiEntry.matchRecipeIdUsingState(_this.recipeInstance, {});
                    },
                    component: function (prop) {
    ...
    ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (ThirdPartyPreBuiltUI.instance === undefined) {
            var recipeInstace = uiEntry.ThirdParty.getInstanceOrThrow();
