...
var ThirdParty = /** @class */ (function (_super) {
    ...
    ThirdParty.init = function (config) {
        ...
        return {
            ...
            webJS: ThirdpartyWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
