...
var ActiveDirectory = /** @class */ (function (_super) {
    superTokens.__extends(ActiveDirectory, _super);
    /*
     * Constructor.
     */
    function ActiveDirectory(config) {
        var _this =
            _super.call(this, superTokens.__assign({ id: "active-directory", name: "Active Directory" }, config)) ||
            this;
...
var Apple = /** @class */ (function (_super) {
    superTokens.__extends(Apple, _super);
    /*
     * Constructor.
     */
    function Apple(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "apple", name: "Apple" }, config)) || this;
        _this.getLogo = function () {
...
var Bitbucket = /** @class */ (function (_super) {
    superTokens.__extends(Bitbucket, _super);
    /*
     * Constructor.
     */
    function Bitbucket(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "bitbucket", name: "Bitbucket" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsxs(
                "svg",
                superTokens.__assign(
...
var BoxySAML = /** @class */ (function (_super) {
    superTokens.__extends(BoxySAML, _super);
    /*
     * Constructor.
     */
    function BoxySAML(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "boxy-saml", name: "BoxySAML" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsx(
                "svg",
                superTokens.__assign(
...
var Discord = /** @class */ (function (_super) {
    superTokens.__extends(Discord, _super);
    /*
     * Constructor.
     */
    function Discord(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "discord", name: "Discord" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsxs(
                "svg",
                superTokens.__assign(
...
var Facebook = /** @class */ (function (_super) {
    superTokens.__extends(Facebook, _super);
    /*
     * Constructor.
     */
    function Facebook(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "facebook", name: "Facebook" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsx(
                "svg",
                superTokens.__assign(
...
var Github = /** @class */ (function (_super) {
    superTokens.__extends(Github, _super);
    /*
     * Constructor.
     */
    function Github(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "github", name: "GitHub" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsx(
                "svg",
                superTokens.__assign(
...
var Gitlab = /** @class */ (function (_super) {
    superTokens.__extends(Gitlab, _super);
    /*
     * Constructor.
     */
    function Gitlab(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "gitlab", name: "Gitlab" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsxs(
                "svg",
                superTokens.__assign(
...
var Google = /** @class */ (function (_super) {
    superTokens.__extends(Google, _super);
    /*
     * Constructor.
     */
    function Google(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "google", name: "Google" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsxs(
                "svg",
                superTokens.__assign(
...
var GoogleWorkspaces = /** @class */ (function (_super) {
    superTokens.__extends(GoogleWorkspaces, _super);
    function GoogleWorkspaces(config) {
        var _this =
            _super.call(this, superTokens.__assign({ id: "google-workspaces", name: "Google Workspaces" }, config)) ||
            this;
        _this.getLogo = function () {
            return jsxRuntime.jsxs(
                "svg",
...
var LinkedIn = /** @class */ (function (_super) {
    superTokens.__extends(LinkedIn, _super);
    /*
     * Constructor.
     */
    function LinkedIn(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "linkedin", name: "LinkedIn" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsxs(
                "svg",
                superTokens.__assign(
...
var Okta = /** @class */ (function (_super) {
    superTokens.__extends(Okta, _super);
    /*
     * Constructor.
     */
    function Okta(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "okta", name: "Okta" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsx(
                "svg",
                superTokens.__assign(
...
var Twitter = /** @class */ (function (_super) {
    superTokens.__extends(Twitter, _super);
    /*
     * Constructor.
     */
    function Twitter(config) {
        ...
        _this = _super.call(this, superTokens.__assign({ id: "twitter", name: name }, config)) || this;
    ...
    return function (originalImp) {
        return superTokens.__assign(superTokens.__assign({}, originalImp), {
            ...
            setStateAndOtherInfoToStorage: function (input) {
                var _a;
                var loginChallenge =
                    (_a = superTokens.getQueryParams("loginChallenge")) !== null && _a !== void 0 ? _a : undefined;
        ...
        return superTokens.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [
                        4 /*yield*/,
                        superTokens.Multitenancy.getInstanceOrThrow().getCurrentDynamicLoginMethods({
                            userContext: input.userContext,
                        }),
                    ];
                case 1:
...
var mergeProviders = function (_a) {
    ...
    var _loop_1 = function (tenantProvider) {
        ...
        if (provider !== undefined) {
            providers.push(
                Custom.init(
                    superTokens.__assign(superTokens.__assign({}, provider.config), {
