...
var Provider$1 = /** @class */ (function () {
    ...
    Provider.prototype.defaultGetRedirectURL = function () {
        var domain = utils.SuperTokens.getInstanceOrThrow().appInfo.websiteDomain.getAsStringDangerous();
        var callbackPath = new NormalisedURLPath__default.default("/callback/".concat(this.id));
        var path = utils.SuperTokens.getInstanceOrThrow()
...
function getRecipeImplementation(recipeInput) {
    ...
    return {
        ...
        signInAndUp: function (input) {
            return utils.__awaiter(this, void 0, void 0, function () {
                ...
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJsImplementation.signInAndUp.bind(this)(utils.__assign({}, input))];
                        case 1:
                            response = _a.sent();
        ...
        generateStateToSendToOAuthProvider: function (input) {
            return webJsImplementation.generateStateToSendToOAuthProvider.bind(this)(utils.__assign({}, input));
        },
    ...
    ThirdParty.init = function (config) {
        return function (appInfo) {
            ThirdParty.instance = new ThirdParty(
                utils.__assign(utils.__assign({}, config), { appInfo: appInfo, recipeId: ThirdParty.RECIPE_ID })
            );
