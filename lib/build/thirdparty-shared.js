...
function ProviderButton(_a) {
    ...
    function startAnimation() {
        ...
        var buttonText = buttonTextRef.current;
        var BUFFER = 10;
        if (!buttonTextContainer || !buttonText || !buttonTextContainer.classList.contains("scroll-text-animation")) {
            return;
        }
        var keyframes = [
    ...
    var stopAnimation = function () {
        ...
        buttonText.getAnimations().forEach(function (animation) {
    ...
    React.useEffect(function () {
        ...
        if (buttonTextContainer && isTextOverflowing(buttonTextContainer)) {
            buttonTextContainer.classList.add("scroll-text-animation");
        }
        var handleResize = function () {
            if (buttonTextContainer) {
                if (isTextOverflowing(buttonTextContainer)) {
                    ...
                    buttonTextContainer.classList.remove("scroll-text-animation");
                }
            }
        };
