...
var ProvidersForm = sessionAuth.withOverride("ThirdPartySignInAndUpProvidersForm", ThirdPartySignInAndUpProvidersForm);

var SignInAndUpHeader = sessionAuth.withOverride("ThirdPartySignInAndUpHeader", function ThirdPartySignInAndUpHeader() {
    var t = sessionAuth.useTranslation();
    return jsxRuntime.jsx(
        "div",
        sessionAuth.__assign(
...
var SignUpFooter = sessionAuth.withOverride("ThirdPartySignUpFooter", function ThirdPartySignUpFooter(_a) {
...
var SignInAndUpCallbackThemeWithOverride = sessionAuth.withOverride(
