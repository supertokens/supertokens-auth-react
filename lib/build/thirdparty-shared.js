...
var getFunctionOverrides = function (recipeId, onHandleEvent) {
    return function (originalImp) { return (utils.__assign(utils.__assign({}, originalImp), { signInAndUp: function (input) {
            ...
            return originalImp.setStateAndOtherInfoToStorage({
                state: utils.__assign(utils.__assign({}, input.state), { rid: recipeId, oauth2LoginChallenge: loginChallenge, redirectToPath: utils.getRedirectToPathFromURL() }),
                userContext: input.userContext,
            });
        } })); };
};
...
function ProviderButton(_a) {
    ...
    return (jsxRuntime.jsxs("button", utils.__assign({ "data-supertokens": "button providerButton ".concat(providerStyleName) }, { children: [logo !== undefined && (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "providerButtonLeft" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "providerButtonLogo" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "providerButtonLogoCenter" }, { children: logo })) })) }))), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "providerButtonText", ref: buttonTextContainerRef }, { children: jsxRuntime.jsxs("span", { children: [t("THIRD_PARTY_PROVIDER_DEFAULT_BTN_START"), displayName, t("THIRD_PARTY_PROVIDER_DEFAULT_BTN_END")] }) }))] })));
}
...
var Facebook = /** @class */ (function (_super) {
    ...
    function Facebook(config) {
        var _this = _super.call(this, utils.__assign({ id: "facebook", name: "Facebook" }, config)) || this;
        _this.getLogo = function () {
            return (jsxRuntime.jsx("svg", utils.__assign({ fill: "#1777F2", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 30 30", width: "24px", height: "24px" }, { children: jsxRuntime.jsx("path", { d: "M15,3C8.373,3,3,8.373,3,15c0,6.016,4.432,10.984,10.206,11.852V18.18h-2.969v-3.154h2.969v-2.099c0-3.475,1.693-5,4.581-5 c1.383,0,2.115,0.103,2.461,0.149v2.753h-1.97c-1.226,0-1.654,1.163-1.654,2.473v1.724h3.593L19.73,18.18h-3.106v8.697 C22.481,26.083,27,21.075,27,15C27,8.373,21.627,3,15,3z" }) })));
        };
        return _this;
    }
    /*
...
var Google = /** @class */ (function (_super) {
    ...
    function Google(config) {
        var _this = _super.call(this, utils.__assign({ id: "google", name: "Google" }, config)) || this;
        _this.getLogo = function () {
            return googleLogo;
        };
        return _this;
...
var LinkedIn = /** @class */ (function (_super) {
    ...
    function LinkedIn(config) {
        var _this = _super.call(this, utils.__assign({ id: "linkedin", name: "LinkedIn" }, config)) || this;
        _this.getLogo = function () {
            return (jsxRuntime.jsxs("svg", utils.__assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 48 48", width: "20", height: "20" }, { children: [jsxRuntime.jsx("path", { fill: "#0288D1", d: "M42,37c0,2.762-2.238,5-5,5H11c-2.761,0-5-2.238-5-5V11c0-2.762,2.239-5,5-5h26c2.762,0,5,2.238,5,5V37z" }), jsxRuntime.jsx("path", { fill: "#FFF", d: "M12 19H17V36H12zM14.485 17h-.028C12.965 17 12 15.888 12 14.499 12 13.08 12.995 12 14.514 12c1.521 0 2.458 1.08 2.486 2.499C17 15.887 16.035 17 14.485 17zM36 36h-5v-9.099c0-2.198-1.225-3.698-3.192-3.698-1.501 0-2.313 1.012-2.707 1.99C24.957 25.543 25 26.511 25 27v9h-5V19h5v2.616C25.721 20.5 26.85 19 29.738 19c3.578 0 6.261 2.25 6.261 7.274L36 36 36 36z" })] })));
        };
        return _this;
    }
    /*
...
var Okta = /** @class */ (function (_super) {
    ...
    function Okta(config) {
        var _this = _super.call(this, utils.__assign({ id: "okta", name: "Okta" }, config)) || this;
        _this.getLogo = function () {
            return oktaLogo;
        };
        return _this;
...
function normaliseThirdPartyConfig(config) {
    ...
    var override = utils.__assign({ functions: function (originalImplementation) { return originalImplementation; } }, config.override);
    return utils.__assign(utils.__assign({}, utils$1.normaliseAuthRecipe(config)), { signInAndUpFeature: signInAndUpFeature, oAuthCallbackScreen: oAuthCallbackScreen, override: override });
}
...
function redirectToThirdPartyLogin(input) {
    return utils.__awaiter(this, void 0, void 0, function () {
        ...
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, superTokens.Multitenancy.getInstanceOrThrow().getCurrentDynamicLoginMethods({
                        userContext: input.userContext,
                    })];
                case 1:
...
var mergeProviders = function (_a) {
    ...
    var usesDynamicLoginMethods = superTokens.SuperTokens.usesDynamicLoginMethods === true;
    ...
    var _loop_1 = function (tenantProvider) {
        ...
        if (provider !== undefined) {
            providers.push(Custom.init(utils.__assign(utils.__assign({}, provider.config), { id: tenantProvider.id, name: tenantProvider.name, buttonComponent: provider.getButton(tenantProvider.name) })));
        }
        else {
...
var ThirdParty = /** @class */ (function (_super) {
    ...
    function ThirdParty(config, webJSRecipe) {
        ...
        var _this = this;
        if (superTokens.SuperTokens.usesDynamicLoginMethods === false && config.signInAndUpFeature.providers.length === 0) {
            throw new Error("ThirdParty signInAndUpFeature providers array cannot be empty.");
        }
         ...
         * Instance methods.
         */
        _this.getDefaultRedirectionURL = function (context) { return utils.__awaiter(_this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
    ...
    ThirdParty.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                ThirdParty.instance = new ThirdParty(utils.__assign(utils.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: ThirdParty.RECIPE_ID }));
                return ThirdParty.instance;
            },
            webJS: ThirdpartyWebJS__default.default.init(utils.__assign(utils.__assign({}, normalisedConfig), { override: {
