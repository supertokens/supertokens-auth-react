...
var Twitter = /** @class */ (function (_super) {
    ...
    function Twitter(config) {
        var _this = _super.call(this, superTokens.__assign({ id: "twitter", name: "Twitter" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsx(
                "svg",
                superTokens.__assign(
...
function redirectToThirdPartyLogin(input) {
    var _a;
    return superTokens.__awaiter(this, void 0, void 0, function () {
        var providers, provider, response;
        return superTokens.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    providers = mergeProviders({
                        tenantProviders:
                            (_a = superTokens.Multitenancy.getInstanceOrThrow().getLoadedDynamicLoginMethods()) ===
                                null || _a === void 0
                                ? void 0
                                : _a.thirdparty.providers,
