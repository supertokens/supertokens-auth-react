...
var Provider = /** @class */ (function () {
    ...
    Provider.prototype.defaultGetRedirectURL = function () {
        var domain = authRecipe.SuperTokens.getInstanceOrThrow().appInfo.websiteDomain.getAsStringDangerous();
        var callbackPath = new authRecipe.NormalisedURLPath("/callback/".concat(this.id));
        var path = authRecipe.SuperTokens.getInstanceOrThrow()
...
var Custom = /** @class */ (function (_super) {
    assets.__extends(Custom, _super);
    /*
     * Constructor.
     */
    ...
    return assets.__awaiter(this, void 0, void 0, function () {
        ...
        return assets.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    authRecipe.redirectWithFullPageReload(response);
...
var SignUpFooter = querier.withOverride("ThirdPartySignUpFooter", function ThirdPartySignUpFooter(_a) {
...
var ProvidersForm = querier.withOverride("ThirdPartySignInAndUpProvidersForm", ThirdPartySignInAndUpProvidersForm);

var SignInAndUpHeader = querier.withOverride("ThirdPartySignInAndUpHeader", function ThirdPartySignInAndUpHeader() {
    var t = translationContext.useTranslation();
    return jsxRuntime.jsx(
        "div",
        assets.__assign(
                            ...
                            { "data-supertokens": "row" },
                            {
                                children: [
                                    ...
                                    props.featureState.error &&
                                        jsxRuntime.jsx(querier.GeneralError, { error: props.featureState.error }),
                                    jsxRuntime.jsx(ProvidersForm, assets.__assign({}, props)),
        ...
        function () {
            ...
            if (errorQueryParam !== null) {
                if (errorQueryParam === "signin") {
                    ...
                    var customError = authRecipe.getQueryParams("message");
                    if (customError === null) {
                        error = "SOMETHING_WENT_WRONG_ERROR";
                    } else {
                        error = customError;
...
var ThirdPartySignInAndUpCallbackTheme = /** @class */ (function (_super) {
    assets.__extends(ThirdPartySignInAndUpCallbackTheme, _super);
...
var SignInAndUpCallbackTheme = querier.withOverride(
...
var SignInAndUpCallback$1 = function (props) {
    ...
    authRecipe.useOnMountAPICall(verifyCode, handleVerifyResponse, handleError);
    var componentOverrides = props.recipe.config.override.components;
    return jsxRuntime.jsx(
        querier.ComponentOverrideContext.Provider,
        assets.__assign(
        ...
        return {
            getStateAndOtherInfoFromStorage: function () {
                ...
                var stateFromStorage =
                    authRecipe.windowHandler.WindowHandlerReference.getReferenceOrThrow().windowHandler.sessionStorage.getItemSync(
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [
                                    4 /*yield*/,
                                    authRecipe.windowHandler.WindowHandlerReference.getReferenceOrThrow().windowHandler.sessionStorage.setItem(
                                        "supertokens-oauth-state-2",
                                        value
                                    ),
                                ];
                        ...
                        switch (_a.label) {
                            ...
                            case 2:
                                ...
                                urlWithState = alreadyContainsRedirectURI
                                    ? (0, authRecipe.utils.appendQueryParamsToURL)(urlResponse.url, {
                        ...
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                if (jsonBody.status === "FIELD_ERROR") {
                                    throw new querier.error.default(jsonBody.error);
                                }
                                return [
                                    2 /*return*/,
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        ...
                        if (input.stateObjectFromStorage.expiresAt < Date.now()) {
                            throw new Error(
                                "Auth state verification failed. The auth provider took too long to respond"
                            );
                        }
            ...
            getAuthCodeFromURL: function () {
                var authCodeFromURL = (0, authRecipe.utils.getQueryParams)("code");
            ...
            getAuthErrorFromURL: function () {
                return (0, authRecipe.utils.getQueryParams)("error");
            },
            getAuthStateFromURL: function () {
                var stateFromURL = (0, authRecipe.utils.getQueryParams)("state");
    ...
    return {
                ...
                return assets.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.signInAndUp.bind(this)(assets.__assign({}, input)),
                            ];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
        ...
        setStateAndOtherInfoToStorage: function (input) {
            return webJsImplementation.setStateAndOtherInfoToStorage.bind(this)({
                state: assets.__assign(assets.__assign({}, input.state), {
        ...
        generateStateToSendToOAuthProvider: function (input) {
            return webJsImplementation.generateStateToSendToOAuthProvider.bind(this)(assets.__assign({}, input));
        },
        verifyAndGetStateOrThrowError: function (input) {
...
var ThirdParty = /** @class */ (function (_super) {
    assets.__extends(ThirdParty, _super);
    function ThirdParty(config) {
        ...
        _this.getFeatures = function () {
            ...
            _this.config.signInAndUpFeature.providers.forEach(function (provider) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(
                    new authRecipe.NormalisedURLPath("/callback/".concat(provider.id))
                );
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: function () {
        ...
        _this.getFeatureComponent = function (componentName, props) {
            if (componentName === "signinup") {
                ...
                return jsxRuntime.jsx(
                    ...
                    assets.__assign(
                        { userContext: props.userContext },
                        { children: jsxRuntime.jsx(SignInAndUpCallback$1, assets.__assign({ recipe: _this }, props)) }
                    )
                );
            } else {
    ...
    ThirdParty.init = function (config) {
        return function (appInfo) {
            ThirdParty.instance = new ThirdParty(
                assets.__assign(assets.__assign({}, config), { appInfo: appInfo, recipeId: ThirdParty.RECIPE_ID })
            );
...
var Google = /** @class */ (function (_super) {
    assets.__extends(Google, _super);
    /*
     * Constructor.
     */
...
var Facebook = /** @class */ (function (_super) {
    assets.__extends(Facebook, _super);
    /*
     * Constructor.
     */
...
var Github = /** @class */ (function (_super) {
    assets.__extends(Github, _super);
    /*
     * Constructor.
     */
