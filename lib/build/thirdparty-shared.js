    ...
    return function (originalImp) {
        return utils.__assign(utils.__assign({}, originalImp), {
            ...
            setStateAndOtherInfoToStorage: function (input) {
                var _a;
                var loginChallenge =
                    (_a = utils.getQueryParams("loginChallenge")) !== null && _a !== void 0 ? _a : undefined;
...
var ActiveDirectory = /** @class */ (function (_super) {
    ...
    function ActiveDirectory(config) {
        var _this =
            _super.call(this, utils.__assign({ id: "active-directory", name: "Active Directory" }, config)) || this;
...
var GoogleWorkspaces = /** @class */ (function (_super) {
    ...
    function GoogleWorkspaces(config) {
        var _this =
            _super.call(this, utils.__assign({ id: "google-workspaces", name: "Google Workspaces" }, config)) || this;
        _this.getLogo = function () {
            return jsxRuntime.jsxs(
                "svg",
                utils.__assign(
...
var mergeProviders = function (_a) {
    ...
    var _loop_1 = function (tenantProvider) {
        ...
        if (provider !== undefined) {
            providers.push(
                Custom.init(
                    utils.__assign(utils.__assign({}, provider.config), {
...
var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext(undefined, ThirdParty.RECIPE_ID),
    useContext = _a[0],
    Provider = _a[1];
