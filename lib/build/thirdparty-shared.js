...
var Provider = /** @class */ (function () {
    ...
    Provider.prototype.defaultGetRedirectURL = function () {
        var domain = session.SuperTokens.getInstanceOrThrow().appInfo.websiteDomain.getAsStringDangerous();
        var callbackPath = new NormalisedURLPath__default.default("/callback/".concat(this.id));
        var path = session.SuperTokens.getInstanceOrThrow()
...
var Custom = /** @class */ (function (_super) {
    session.__extends(Custom, _super);
    /*
     * Constructor.
     */
    ...
    return session.__awaiter(this, void 0, void 0, function () {
        ...
        return session.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    session.redirectWithFullPageReload(response);
...
var ProvidersForm = session.withOverride("ThirdPartySignInAndUpProvidersForm", ThirdPartySignInAndUpProvidersForm);

var SignInAndUpHeader = session.withOverride("ThirdPartySignInAndUpHeader", function ThirdPartySignInAndUpHeader() {
    var t = session.useTranslation();
    return jsxRuntime.jsx(
        "div",
        session.__assign(
...
var SignUpFooter = session.withOverride("ThirdPartySignUpFooter", function ThirdPartySignUpFooter(_a) {
                        ...
                        session.__assign(
                            { "data-supertokens": "row" },
                            {
                                children: [
                                    ...
                                    jsxRuntime.jsx(ProvidersForm, session.__assign({}, props)),
...
var ThirdPartySignInAndUpCallbackTheme = /** @class */ (function (_super) {
    session.__extends(ThirdPartySignInAndUpCallbackTheme, _super);
...
var SignInAndUpCallbackThemeWithOverride = session.withOverride(
...
var Apple = /** @class */ (function (_super) {
    session.__extends(Apple, _super);
    /*
     * Constructor.
     */
...
var Facebook = /** @class */ (function (_super) {
    session.__extends(Facebook, _super);
    /*
     * Constructor.
     */
...
var Github = /** @class */ (function (_super) {
    session.__extends(Github, _super);
    /*
     * Constructor.
     */
...
var Google = /** @class */ (function (_super) {
    session.__extends(Google, _super);
    /*
     * Constructor.
     */
        ...
        function () {
            ...
            if (errorQueryParam !== null) {
                if (errorQueryParam === "signin") {
                    ...
                    var customError = session.getQueryParams("message");
                    if (customError === null) {
                        error = "SOMETHING_WENT_WRONG_ERROR";
                    } else {
                        error = customError;
...
var SignInAndUpCallback$1 = function (props) {
    ...
    session.useOnMountAPICall(verifyCode, handleVerifyResponse, handleError);
    var recipeComponentOverrides = props.useComponentOverrides();
    return jsxRuntime.jsx(
        session.ComponentOverrideContext.Provider,
        session.__assign(
    ...
    return {
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.signInAndUp.bind(this)(session.__assign({}, input)),
                            ];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
        ...
        setStateAndOtherInfoToStorage: function (input) {
            return webJsImplementation.setStateAndOtherInfoToStorage.bind(this)({
                state: session.__assign(session.__assign({}, input.state), {
        ...
        generateStateToSendToOAuthProvider: function (input) {
            return webJsImplementation.generateStateToSendToOAuthProvider.bind(this)(session.__assign({}, input));
        },
...
var ThirdParty = /** @class */ (function (_super) {
    session.__extends(ThirdParty, _super);
    ...
    ThirdParty.init = function (config) {
        return function (appInfo) {
            ThirdParty.instance = new ThirdParty(
                session.__assign(session.__assign({}, config), { appInfo: appInfo, recipeId: ThirdParty.RECIPE_ID })
            );
