                        ...
                        thirdparty.__assign(
                            { "data-supertokens": "row" },
                            {
                                children: [
                                    ...
                                    jsxRuntime.jsx(ProvidersForm, thirdparty.__assign({}, props)),
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    thirdparty.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignInAndUpTheme, thirdparty.__assign({}, props)) }
                    )
                ),
            }
        )
        ...
        function () {
            ...
            if (errorQueryParam !== null) {
                if (errorQueryParam === "signin") {
                    ...
                    var customError = thirdparty.getQueryParams("message");
                    if (customError === null) {
                        error = "SOMETHING_WENT_WRONG_ERROR";
                    } else {
                        error = customError;
...
var SignInAndUpFeature = function (props) {
    ...
    var themeProps = thirdparty.__assign(thirdparty.__assign({}, childProps), { providers: providers });
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(
                    SignInAndUpThemeWrapper,
                    thirdparty.__assign({}, themeProps, { featureState: state, dispatch: dispatch })
                ),
            props.children &&
            ...
            { value: recipeComponentOverrides },
            {
                children: jsxRuntime.jsx(
                    ...
                    thirdparty.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignInAndUpFeature, thirdparty.__assign({}, props)) }
                    )
                ),
            }
        )
...
var getModifiedRecipeImplementation = function (origImpl) {
    return thirdparty.__assign({}, origImpl);
};
...
var ThirdPartySignInAndUpCallbackTheme = /** @class */ (function (_super) {
    thirdparty.__extends(ThirdPartySignInAndUpCallbackTheme, _super);
...
var SignInAndUpCallback$1 = function (props) {
    ...
    thirdparty.useOnMountAPICall(verifyCode, handleVerifyResponse, handleError);
    var recipeComponentOverrides = props.useComponentOverrides();
    return jsxRuntime.jsx(
        translations.ComponentOverrideContext.Provider,
        thirdparty.__assign(
...
var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    thirdparty.__extends(ThirdPartyPreBuiltUI, _super);
    function ThirdPartyPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            if (useComponentOverrides === void 0) {
                useComponentOverrides = thirdparty.useContext;
            }
            var features = {};
            if (_this.recipeInstance.config.signInAndUpFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    recipeID: thirdparty.ThirdParty.RECIPE_ID,
                };
            }
            ...
            _this.recipeInstance.config.signInAndUpFeature.providers.forEach(function (provider) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: function () {
                        return thirdparty.matchRecipeIdUsingState(_this.recipeInstance, {});
                    },
                    component: function (prop) {
    ...
    ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (ThirdPartyPreBuiltUI.instance === undefined) {
            var recipeInstace = thirdparty.ThirdParty.getInstanceOrThrow();
