        ...
        return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImp), {
            resyncSessionAndFetchMFAInfo: function (input) {
                return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                    var stWindow, stored, parsed, val;
                    return genericComponentOverrideContext.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                val = _a.sent();
                                if (!(val.status === "OK")) return [3 /*break*/, 4];
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (nextFactorOptions.length === 1) {
                                return [
                                    2 /*return*/,
                                    getRedirectURL(
                                        { action: "GO_TO_FACTOR", factorId: nextFactorOptions[0] },
                                        userContext
                                    ),
                                ];
                            } else {
                        ...
                        case 1:
                            return [
                                4 /*yield*/,
                                getRecipeImpl().resyncSessionAndFetchMFAInfo({ userContext: userContext }),
                            ];
                        case 2:
                            mfaInfo = _b.sent();
...
var MultiFactorAuth = /** @class */ (function (_super) {
    ...
    function MultiFactorAuth(config, webJSRecipe) {
        ...
        postSuperTokensInitCallbacks.PostSuperTokensInitCallbacks.addPostInitCallback(function () {
            ...
            recipe.Session.getInstanceOrThrow().addEventListener(function () {
