...
var Session = /** @class */ (function (_super) {
    ...
    Session.init = function (config) {
        ...
        return {
            ...
            webJS: WebJSSessionRecipe__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { onHandleEvent: function (event) {
