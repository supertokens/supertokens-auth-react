...
var MultiFactorAuthClaimClass = /** @class */ (function () {
    function MultiFactorAuthClaimClass(getRecipeImpl, getRedirectURL, onFailureRedirection) {
        ...
        var defaultOnFailureRedirection = function (_a) {
            ...
            var nextFactorOptions = reason.nextFactorOptions || reason.oneOf || reason.allOf || [reason.factorId];
...
var MultiFactorAuth = /** @class */ (function (_super) {
    ...
    MultiFactorAuth.prototype.redirectToFactor = function (factorId, forceSetup, redirectBack, history) {
            ...
            return genericComponentOverrideContext.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            this.getRedirectUrl({ action: "GO_TO_FACTOR", forceSetup: forceSetup, factorId: factorId }),
                        ];
                    case 1:
                        url = _b.sent();
                        if (redirectBack) {
    ...
    MultiFactorAuth.prototype.redirectToFactorChooser = function (redirectBack, nextFactorOptions, history) {
        if (redirectBack === void 0) {
            redirectBack = false;
        }
            ...
            return genericComponentOverrideContext.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            this.getRedirectUrl({ action: "FACTOR_CHOOSER", nextFactorOptions: nextFactorOptions }),
                        ];
                    case 1:
                        url = _b.sent();
                        if (redirectBack) {
    ...
    MultiFactorAuth.MultiFactorAuthClaim = new MultiFactorAuthClaimClass(
        ...
        function (context) {
            return _a.getInstanceOrThrow().getRedirectUrl(context);
        }
    );
