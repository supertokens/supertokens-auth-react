...
var getFailureRedirectionInfo = function (_a) {
    ...
    return utils.__awaiter(void 0, void 0, void 0, function () {
        ...
        return utils.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    globalValidators = utils$1.getGlobalClaimValidators({
...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config, webJSRecipe) {
        ...
        _this.getAccessTokenPayloadSecurely = function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
        ...
        _this.attemptRefreshingSession = function () { return utils.__awaiter(_this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
        ...
        successRedirectContext, fallbackRecipeId, redirectToPath, userContext, navigate) { return utils.__awaiter(_this, void 0, void 0, function () {
            ...
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, utils.setLocalStorage("supertokens-success-redirection-context", jsonContext)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, utils.removeFromLocalStorage("supertokens-success-redirection-context")];
                    case 10:
                        _a.sent();
                        return [7 /*endfinally*/];
         ...
         * @returns "/"
         */
        _this.getDefaultRedirectionURL = function () { return utils.__awaiter(_this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                // We do not use the util here, since we are redirecting outside of the SDK routes
                return [2 /*return*/, "/"];
            });
        }); };
        _this.notifyListeners = function (event) { return utils.__awaiter(_this, void 0, void 0, function () {
            var sessionContext;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    Session.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                Session.instance = new Session(utils.__assign(utils.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Session.RECIPE_ID }));
                return Session.instance;
            },
            webJS: WebJSSessionRecipe__default.default.init(utils.__assign(utils.__assign({}, normalisedConfig), { onHandleEvent: function (event) {
                ...
                }, preAPIHook: function (context) { return utils.__awaiter(_this, void 0, void 0, function () {
                    var response;
                    return utils.__generator(this, function (_a) {
                        response = utils.__assign(utils.__assign({}, context), { requestInit: utils.__assign(utils.__assign({}, context.requestInit), { headers: utils.__assign(utils.__assign({}, context.requestInit.headers), { rid: Session.RECIPE_ID }) }) });
