                    ...
                    switch (_b.label) {
                        case 0:
                            genericComponentOverrideContext.logDebugMessage(
                                "validateGlobalClaimsAndHandleSuccessRedirection called"
                            );
                        ...
                        case 1:
                            ...
                            genericComponentOverrideContext.logDebugMessage(
                                "validateGlobalClaimsAndHandleSuccessRedirection validating claims"
                            );
                            return [4 /*yield*/, this.validateClaims({ userContext: userContext })];
                        case 2:
                            invalidClaims = _b.sent();
                            genericComponentOverrideContext.logDebugMessage(
                                "validateGlobalClaimsAndHandleSuccessRedirection: invalid claims: ".concat(
                                    invalidClaims.map(function (c) {
                                        return c.id;
                                    })
                                )
                            );
                            ...
                            genericComponentOverrideContext.logDebugMessage(
                                "validateGlobalClaimsAndHandleSuccessRedirection: saving successRedirectContext"
                            );
                        ...
                        case 5:
                            ...
                            if (failureRedirectInfo.redirectPath !== undefined) {
                                genericComponentOverrideContext.logDebugMessage(
                                    "validateGlobalClaimsAndHandleSuccessRedirection: failureRedirection: "
                                        .concat(failureRedirectInfo.redirectPath, " (")
                                        .concat(
                                            (_a = failureRedirectInfo.failedClaim) === null || _a === void 0
                                                ? void 0
                                                : _a.id,
                                            ")"
                                        )
                        ...
                        case 13:
                            ...
                            genericComponentOverrideContext.logDebugMessage(
                                "validateGlobalClaimsAndHandleSuccessRedirection: redirecting with context: ".concat(
                                    JSON.stringify(successRedirectContext)
                                )
                            );
                            return [
                                2 /*return*/,
