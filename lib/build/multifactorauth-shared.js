...
function normaliseSessionConfig(config) {
    ...
    return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, genericComponentOverrideContext.normaliseRecipeModuleConfig(config)), { 
...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = WebJSSessionRecipe__default.default; }
        ...
        _this.getAccessTokenPayloadSecurely = function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        ...
        _this.attemptRefreshingSession = function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            return genericComponentOverrideContext.__generator(this, function (_a) {
        ...
        successRedirectContext, fallbackRecipeId, redirectToPath, userContext, navigate) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            ...
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        jsonContext = JSON.stringify({ successRedirectContext: successRedirectContext, redirectToPath: redirectToPath });
                        return [4 /*yield*/, genericComponentOverrideContext.setLocalStorage("supertokens-success-redirection-context", jsonContext)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, getFailureRedirectionInfo({
                    ...
                    case 5:
                        ...
                        if (failureRedirectInfo.redirectPath !== undefined) {
                            ...
                            if (validateAndCompareOnFailureRedirectionURLToCurrent(failureRedirectInfo.redirectPath)) {
                                throw new Error("onFailureRedirectionURL returned the current URL (".concat(failureRedirectInfo.redirectPath, ") during success redirection. This indicates that the user is in a stuck state."));
                            }
                            return [2 /*return*/, genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirectToUrl(failureRedirectInfo.redirectPath, navigate)];
                        }
                        _a.label = 6;
                    case 6:
                        if (!(successRedirectContext === undefined)) return [3 /*break*/, 13];
                        return [4 /*yield*/, genericComponentOverrideContext.getLocalStorage("supertokens-success-redirection-context")];
                    case 7:
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, genericComponentOverrideContext.removeFromLocalStorage("supertokens-success-redirection-context")];
                    case 10:
                        _a.sent();
                        return [7 /*endfinally*/];
                    ...
                    case 13:
                        ...
                        if (successRedirectContext.action === "SUCCESS_OAUTH2") {
                            return [2 /*return*/, recipe.OAuth2Provider.getInstanceOrThrow().redirect(successRedirectContext, navigate, {}, userContext)];
                        }
                        if (successRedirectContext.action === "SUCCESS" && redirectToPath !== undefined) {
                            successRedirectContext.redirectToPath = redirectToPath;
                        }
                        return [2 /*return*/, genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirect(successRedirectContext, navigate, {}, userContext)];
                }
            });
        }); };
        /**
         ...
         * @returns "/"
         */
        _this.getDefaultRedirectionURL = function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            return genericComponentOverrideContext.__generator(this, function (_a) {
                // We do not use the util here, since we are redirecting outside of the SDK routes
                return [2 /*return*/, "/"];
            });
        }); };
        _this.notifyListeners = function (event) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            var sessionContext;
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getSessionContext(event)];
                    case 1:
                        ...
                        Array.from(this.eventListeners).forEach(function (listener) {
                            return listener(genericComponentOverrideContext.__assign({ sessionContext: sessionContext }, event));
                        });
                        return [2 /*return*/];
                }
            });
                ...
                switch (_c.label) {
                    case 0:
                        if (!(action === "SESSION_CREATED" ||
                            ...
                            action === "ACCESS_TOKEN_PAYLOAD_UPDATED")) return [3 /*break*/, 2];
    ...
    Session.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo, _, overrideMaps) {
                var normalisedConfig = normaliseSessionConfig(genericComponentOverrideContext.applyPlugins(Session.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : []));
                Session.instance = new Session(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Session.RECIPE_ID }));
            ...
            webJS: function () {
                ...
                var init = WebJSSessionRecipe__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { onHandleEvent: function (event) {
                    ...
                    }, preAPIHook: function (context) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                        var response;
                        return genericComponentOverrideContext.__generator(this, function (_a) {
                            response = genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, context), { requestInit: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, context.requestInit), { headers: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, context.requestInit.headers), { rid: Session.RECIPE_ID }) }) });
