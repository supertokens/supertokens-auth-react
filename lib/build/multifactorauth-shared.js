...
function normaliseSessionConfig(config) {
    ...
    return logger.__assign(logger.__assign({}, genericComponentOverrideContext.normaliseRecipeModuleConfig(config)), { 
...
var Session = /** @class */ (function (_super) {
    logger.__extends(Session, _super);
    function Session(config, webJSRecipe) {
        ...
        _this.getAccessTokenPayloadSecurely = function (input) { return logger.__awaiter(_this, void 0, void 0, function () {
        ...
        _this.attemptRefreshingSession = function () { return logger.__awaiter(_this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
        ...
        successRedirectContext, fallbackRecipeId, redirectToPath, userContext, navigate) { return logger.__awaiter(_this, void 0, void 0, function () {
         ...
         * @returns "/"
         */
        _this.getDefaultRedirectionURL = function () { return logger.__awaiter(_this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                // We do not use the util here, since we are redirecting outside of the SDK routes
                return [2 /*return*/, "/"];
            });
        }); };
        _this.notifyListeners = function (event) { return logger.__awaiter(_this, void 0, void 0, function () {
            var sessionContext;
            return logger.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        Array.from(this.eventListeners).forEach(function (listener) {
                            return listener(logger.__assign({ sessionContext: sessionContext }, event));
                        });
                        return [2 /*return*/];
                }
            });
    ...
    Session.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                Session.instance = new Session(logger.__assign(logger.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Session.RECIPE_ID }));
                return Session.instance;
            },
            webJS: WebJSSessionRecipe__default.default.init(logger.__assign(logger.__assign({}, normalisedConfig), { onHandleEvent: function (event) {
                ...
                }, preAPIHook: function (context) { return logger.__awaiter(_this, void 0, void 0, function () {
                    var response;
                    return logger.__generator(this, function (_a) {
                        response = logger.__assign(logger.__assign({}, context), { requestInit: logger.__assign(logger.__assign({}, context.requestInit), { headers: logger.__assign(logger.__assign({}, context.requestInit.headers), { rid: Session.RECIPE_ID }) }) });
