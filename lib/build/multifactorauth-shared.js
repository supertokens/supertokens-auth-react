...
var MultiFactorAuth = /** @class */ (function (_super) {
    ...
    MultiFactorAuth.prototype.getFirstFactors = function () {
        var _b;
        return (_b = this.config.firstFactors) !== null && _b !== void 0 ? _b : this.firstFactors;
    };
    MultiFactorAuth.prototype.getSecondaryFactors = function () {
        return this.config.getFactorInfo(this.secondaryFactors);
    };
    MultiFactorAuth.prototype.redirectToFactor = function (factorId, history) {
        return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
            var _b, _c;
            return genericComponentOverrideContext.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = (_b = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow()).redirectToUrl;
                        return [4 /*yield*/, this.getRedirectUrl({ action: "GO_TO_FACTOR", factorId: factorId })];
                    case 1:
                        return [2 /*return*/, _c.apply(_b, [_d.sent(), history])];
                }
            });
        });
    };
    MultiFactorAuth.prototype.redirectToFactorChooser = function (history) {
        return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
            var _b, _c;
            return genericComponentOverrideContext.__generator(this, function (_d) {
                switch (_d.label) {
