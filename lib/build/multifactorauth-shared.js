                ...
                return superTokens.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [
                                4 /*yield*/,
                                superTokens.setLocalStorage("supertokens-success-redirection-context", jsonContext),
                            ];
                        case 3:
                            _a.sent();
                            _a.label = 4;
                        ...
                        case 6:
                            ...
                            return [
                                4 /*yield*/,
                                superTokens.getLocalStorage("supertokens-success-redirection-context"),
                            ];
                        case 7:
                        ...
                        case 9:
                            return [
                                4 /*yield*/,
                                superTokens.removeFromLocalStorage("supertokens-success-redirection-context"),
                            ];
                        case 10:
                            _a.sent();
                            return [7 /*endfinally*/];
                        ...
                        case 13:
                            ...
                            if (successRedirectContext.action === "SUCCESS_OAUTH2") {
                                return [
                                    2 /*return*/,
                                    recipe.OAuth2.getInstanceOrThrow().redirect(
                                        successRedirectContext,
                                        navigate,
                                        {},
                                        userContext
                            ...
                            return [
                                2 /*return*/,
                                superTokens.SuperTokens.getInstanceOrThrow().redirect(
                                    successRedirectContext,
                                    navigate,
                                    {},
                                    userContext
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            Array.from(this.eventListeners).forEach(function (listener) {
                                return listener(superTokens.__assign({ sessionContext: sessionContext }, event));
                            });
                            return [2 /*return*/];
                    }
                });
                ...
                superTokens.__assign(superTokens.__assign({}, normalisedConfig), {
                    ...
                    preAPIHook: function (context) {
                        return superTokens.__awaiter(_this, void 0, void 0, function () {
                            var response;
                            return superTokens.__generator(this, function (_a) {
                                response = superTokens.__assign(superTokens.__assign({}, context), {
                                    requestInit: superTokens.__assign(superTokens.__assign({}, context.requestInit), {
                                        headers: superTokens.__assign(
                                            superTokens.__assign({}, context.requestInit.headers),
