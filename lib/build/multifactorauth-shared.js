...
function normaliseSessionConfig(config) {
    ...
    return logger.__assign(logger.__assign({}, superTokens.normaliseRecipeModuleConfig(config)), { 
...
function validateAndCompareOnFailureRedirectionURLToCurrent(redirectURL) {
    ...
    try {
        ...
        var appInfo = superTokens.SuperTokens.getInstanceOrThrow().appInfo;
    ...
    function Session(config, webJSRecipe) {
        ...
        successRedirectContext, fallbackRecipeId, redirectToPath, userContext, navigate) { return logger.__awaiter(_this, void 0, void 0, function () {
            ...
            return logger.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userContext = superTokens.getNormalisedUserContext(userContext);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, superTokens.setLocalStorage("supertokens-success-redirection-context", jsonContext)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    ...
                    case 5:
                        ...
                        if (failureRedirectInfo.redirectPath !== undefined) {
                            ...
                            return [2 /*return*/, superTokens.SuperTokens.getInstanceOrThrow().redirectToUrl(failureRedirectInfo.redirectPath, navigate)];
                        }
                        _a.label = 6;
                    case 6:
                        if (!(successRedirectContext === undefined)) return [3 /*break*/, 13];
                        return [4 /*yield*/, superTokens.getLocalStorage("supertokens-success-redirection-context")];
                    case 7:
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, superTokens.removeFromLocalStorage("supertokens-success-redirection-context")];
                    case 10:
                        _a.sent();
                        return [7 /*endfinally*/];
                    ...
                    case 13:
                        ...
                        return [2 /*return*/, superTokens.SuperTokens.getInstanceOrThrow().redirect(successRedirectContext, navigate, {}, userContext)];
                }
            });
        }); };
        /**
