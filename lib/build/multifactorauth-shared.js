...
var OAuth2 = /** @class */ (function (_super) {
    genericComponentOverrideContext.__extends(OAuth2, _super);
            ...
            authReact: function (appInfo) {
                OAuth2.instance = new OAuth2(
                    genericComponentOverrideContext.__assign(
                        ...
                        { appInfo: appInfo, recipeId: OAuth2.RECIPE_ID }
                    )
                );
                return OAuth2.instance;
            },
            webJS: OAuth2WebJS__default.default.init(genericComponentOverrideContext.__assign({}, normalisedConfig)),
        };
    };
                    ...
                    switch (_a.label) {
                        ...
                        case 13:
                            ...
                            if (successRedirectContext.action === "SUCCESS_OAUTH2") {
                                return [
                                    2 /*return*/,
                                    OAuth2.getInstanceOrThrow().redirect(
                                        successRedirectContext,
                                        navigate,
                                        {},
                                        userContext
