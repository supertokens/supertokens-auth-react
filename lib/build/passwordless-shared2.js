...
function normalizeSignInUpFeatureConfig(signInUpInput, config) {
    ...
    var signInUpFeature = superTokens.__assign(superTokens.__assign({}, signInUpInput), {
...
function normalisePasswordlessBaseConfig(config) {
    ...
    return superTokens.__assign(superTokens.__assign({}, config), { style: style });
}
...
var Passwordless = /** @class */ (function (_super) {
    superTokens.__extends(Passwordless, _super);
