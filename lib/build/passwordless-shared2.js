...
function normalizeSignInUpFeatureConfig(signInUpInput, config) {
    ...
    var signInUpFeature = thirdparty.__assign(thirdparty.__assign({}, signInUpInput), {
...
function normalisePasswordlessBaseConfig(config) {
    ...
    return thirdparty.__assign(thirdparty.__assign({}, config), { style: style });
}
...
var Passwordless = /** @class */ (function (_super) {
    thirdparty.__extends(Passwordless, _super);
