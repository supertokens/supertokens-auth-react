...
function getEnabledContactMethods(contactMethod, currentDynamicLoginMethods) {
    ...
    if (firstFactors !== undefined) {
        if (enabledContactMethods.includes("PHONE")) {
            ...
            if (firstFactors.includes(types.FactorIds.OTP_PHONE) || firstFactors.includes(types.FactorIds.LINK_PHONE)) {
                throw new Error(
        ...
        if (enabledContactMethods.includes("EMAIL")) {
            ...
            if (firstFactors.includes(types.FactorIds.OTP_EMAIL) || firstFactors.includes(types.FactorIds.LINK_EMAIL)) {
                throw new Error(
