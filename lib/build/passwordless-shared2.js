...
function normalizeSignInUpFeatureConfig(signInUpInput, config) {
    ...
    var signInUpFeature = uiEntry.__assign(uiEntry.__assign({}, signInUpInput), {
...
function normalisePasswordlessBaseConfig(config) {
    ...
    return uiEntry.__assign(uiEntry.__assign({}, config), { style: style });
}
...
var Passwordless = /** @class */ (function (_super) {
    uiEntry.__extends(Passwordless, _super);
...
//# sourceMappingURL=passwordless-shared2.js.map
