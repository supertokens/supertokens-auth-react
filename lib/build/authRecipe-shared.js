 ...
 * under the License.
 */
class AuthRecipe extends sessionAuth.RecipeModule {
    constructor(config) {
        super(config);
        ...
        this.signOut = (input) =>
            sessionAuth.__awaiter(this, void 0, void 0, function* () {
                return yield sessionAuth.Session.getInstanceOrThrow().signOut({
        ...
        this.doesSessionExist = (input) =>
            sessionAuth.__awaiter(this, void 0, void 0, function* () {
                return yield sessionAuth.Session.getInstanceOrThrow().doesSessionExist({
                    userContext: sessionAuth.getNormalisedUserContext(
                        input === null || input === void 0 ? void 0 : input.userContext
                    ),
                });
        ...
        sessionAuth.postSuperTokensInitCallbacks$1.PostSuperTokensInitCallbacks.addPostInitCallback(() => {
            const session = sessionAuth.Session.getInstance();
 ...
 */
const AuthWidgetWrapper = (props) => {
    return jsxRuntime.jsx(
        session.SessionAuth,
        Object.assign(
            { requireAuth: false, doRedirection: false },
            { children: jsxRuntime.jsx(Redirector, Object.assign({}, props)) }
        )
    );
};
const Redirector = (props) => {
    ...
    const [alwaysShow, updateAlwaysShow] = React.useState(false);
    React.useEffect(() => {
