...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.isEmailVerified = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    componentOverrideContext.EmailVerification.getInstanceOrThrow().recipeImpl.isEmailVerified(
    ...
    Wrapper.verifyEmail = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    componentOverrideContext.EmailVerification.getInstanceOrThrow().recipeImpl.verifyEmail(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.sendVerificationEmail = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    componentOverrideContext.EmailVerification.getInstanceOrThrow().recipeImpl.sendVerificationEmail(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.getEmailVerificationTokenFromURL = function (input) {
        return componentOverrideContext.EmailVerification.getInstanceOrThrow().recipeImpl.getEmailVerificationTokenFromURL(
            utils.__assign(utils.__assign({}, input), {
                userContext: utils.getNormalisedUserContext(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
