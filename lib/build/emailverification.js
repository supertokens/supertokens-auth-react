...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.isEmailVerified = function (input) {
        return logger.__awaiter(this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                return [2 /*return*/, recipe.EmailVerification.getInstanceOrThrow().webJSRecipe.isEmailVerified(logger.__assign(logger.__assign({}, input), { userContext: genericComponentOverrideContext.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }))];
            });
        });
    };
    Wrapper.verifyEmail = function (input) {
        return logger.__awaiter(this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                return [2 /*return*/, recipe.EmailVerification.getInstanceOrThrow().webJSRecipe.verifyEmail(logger.__assign(logger.__assign({}, input), { userContext: genericComponentOverrideContext.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }))];
            });
        });
    };
    Wrapper.sendVerificationEmail = function (input) {
        return logger.__awaiter(this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                return [2 /*return*/, recipe.EmailVerification.getInstanceOrThrow().webJSRecipe.sendVerificationEmail(logger.__assign(logger.__assign({}, input), { userContext: genericComponentOverrideContext.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }))];
            });
        });
    };
    Wrapper.getEmailVerificationTokenFromURL = function (input) {
        return recipe.EmailVerification.getInstanceOrThrow().webJSRecipe.getEmailVerificationTokenFromURL(logger.__assign(logger.__assign({}, input), { userContext: genericComponentOverrideContext.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
