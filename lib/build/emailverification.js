                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(EmailVerificationTheme, sessionAuth.__assign({}, childProps)),
                                    props.children &&
...
function getRecipeImplementation(recipeInput) {
    var webJsImplementation = getRecipeImplementation_1(recipeInput);
    return {
...
var supertokens_js_override_1 = recipe$1.requireBuild$1();
...
var sessionClaimValidatorStoreExports = recipe$1.requireSessionClaimValidatorStore();
...
var EmailVerification$1 = /** @class */ (function (_super) {
    ...
    function EmailVerification(config) {
        ...
        sessionAuth.PostSuperTokensInitCallbacks_1.addPostInitCallback(function () {
            sessionClaimValidatorStoreExports.SessionClaimValidatorStore.addClaimValidatorFromOtherRecipe(
