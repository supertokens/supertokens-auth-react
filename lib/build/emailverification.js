...
var SendVerifyEmail = genericComponentOverrideContext.withOverride(
...
var VerifyEmailLinkClicked = genericComponentOverrideContext.withOverride(
...
var EmailVerification$2 = function (props) {
    ...
    var modifiedRecipeImplementation = React.useMemo(
        function () {
            return sessionAuth.__assign(sessionAuth.__assign({}, props.recipe.webJSRecipe), {
...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.isEmailVerified = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    EmailVerification$1.getInstanceOrThrow().webJSRecipe.isEmailVerified(
    ...
    Wrapper.verifyEmail = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    EmailVerification$1.getInstanceOrThrow().webJSRecipe.verifyEmail(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.sendVerificationEmail = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    EmailVerification$1.getInstanceOrThrow().webJSRecipe.sendVerificationEmail(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.getEmailVerificationTokenFromURL = function (input) {
        return EmailVerification$1.getInstanceOrThrow().webJSRecipe.getEmailVerificationTokenFromURL(
            sessionAuth.__assign(sessionAuth.__assign({}, input), {
                userContext: sessionAuth.getNormalisedUserContext(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
