...
var EmailVerificationSendVerifyEmail = function (props) {
            ...
            return session.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            session.Session.getInstanceOrThrow().doesSessionExist({ userContext: userContext }),
                        ];
                    case 1:
    ...
    session.useOnMountAPICall(sendVerificationEmail, checkSendResponse, handleSendError);
    return jsxRuntime.jsx(
        "div",
        session.__assign(
...
var SendVerifyEmail = session.withOverride("EmailVerificationSendVerifyEmail", EmailVerificationSendVerifyEmail);
                            ...
                            session.__assign(
                                ...
                                },
                                {
                                    children: jsxRuntime.jsx(
                                        "tspan",
                                        session.__assign({ x: "0", y: "0" }, { children: "!" })
                                    ),
                                }
                            )
                        ),
...
var EmailVerificationVerifyEmailLinkClicked = function (props) {
    ...
    session.useOnMountAPICall(verifyEmailOnMount, handleVerifyResp, handleError, sessionContext.loading === false);
...
var VerifyEmailLinkClicked = session.withOverride(
...
function EmailVerificationTheme(props) {
    ...
    if (props.verifyEmailLinkClickedScreen === undefined) {
        return jsxRuntime.jsx(SendVerifyEmail, session.__assign({}, props.sendVerifyEmailScreen));
    }
    // Otherwise, return VerifyEmailLinkClicked.
    return jsxRuntime.jsx(VerifyEmailLinkClicked, session.__assign({}, props.verifyEmailLinkClickedScreen));
}
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    session.__assign(
                        ...
                        { children: jsxRuntime.jsx(EmailVerificationTheme, session.__assign({}, props)) }
                    )
                ),
            }
        )
...
var EmailVerificationClaimClass = /** @class */ (function (_super) {
    session.__extends(EmailVerificationClaimClass, _super);
    function EmailVerificationClaimClass(getRecipeImpl, onSuccessRedirection, onFailureRedirection) {
        ...
        var validatorsWithCallbacks = session.__assign({}, _this.validators);
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return session.__assign(session.__assign({}, validator.apply(void 0, args)), {
                    ...
                    onFailureRedirection: function (args) {
                        ...
                        var recipe = EmailVerification$1.getInstanceOrThrow();
...
})(emailverification.EmailVerificationClaimClass);
...
var EmailVerification$2 = function (props) {
    ...
    var modifiedRecipeImplementation = React.useMemo(
        function () {
            return session.__assign(session.__assign({}, props.recipe.recipeImpl), {
                    ...
                    return session.__awaiter(void 0, void 0, void 0, function () {
                        ...
                        return session.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    response = _a.sent();
                                    session.clearQueryParams(["token"]);
                ...
                return session.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            token = (_a = session.getQueryParams("token")) !== null && _a !== void 0 ? _a : undefined;
        ...
        function () {
            return session.__awaiter(void 0, void 0, void 0, function () {
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            session$1 = session.Session.getInstanceOrThrow();
                            return [4 /*yield*/, session$1.signOut(props.userContext)];
                        case 1:
                            _a.sent();
    ...
    var token = (_a = session.getQueryParams("token")) !== null && _a !== void 0 ? _a : undefined;
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(EmailVerificationThemeWrapper, session.__assign({}, childProps)),
                                    props.children &&
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.verifyEmail.bind(this)(session.__assign({}, input)),
                            ];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.sendVerificationEmail.bind(this)(session.__assign({}, input)),
                            ];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.isEmailVerified.bind(this)(session.__assign({}, input)),
                            ];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, response];
...
function normaliseEmailVerificationFeature(config) {
    ...
    return session.__assign(session.__assign({}, session.normaliseRecipeModuleConfig(config)), {
...
var EmailVerification$1 = /** @class */ (function (_super) {
    session.__extends(EmailVerification, _super);
                    ...
                    { userContext: props.userContext },
                    {
                        children: jsxRuntime.jsx(
                            ...
                            session.__assign(
                                ...
                                {
                                    children: jsxRuntime.jsx(session.UserContextContext.Consumer, {
                                        children: function (value) {
                                            return jsxRuntime.jsx(
                                                EmailVerification$2,
                                                session.__assign(
                                                    { recipe: _this, useComponentOverrides: useComponentOverrides },
                                                    session.__assign(session.__assign({}, props), {
    ...
    EmailVerification.init = function (config) {
        return function (appInfo) {
            EmailVerification.instance = new EmailVerification(
                session.__assign(session.__assign({}, config), {
                    appInfo: appInfo,
