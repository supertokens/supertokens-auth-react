...
function FeatureWrapper(_a) {
     ...
     * Render.
     */
    var isEmbedded = _a.isEmbedded, children = _a.children, useShadowDom = _a.useShadowDom;
    /*
...
function WithOrWithoutShadowDom(_a) {
    ...
    if (useShadowDom === false) {
        return (React.createElement("div", { id: constants_1.ST_ROOT_ID },
    ...
    return (React.createElement(emotion_1.default.div, { id: constants_1.ST_ROOT_ID },
        children,
        React.createElement(DisableAutoFillInput, null)));
}
function DisableAutoFillInput() {
    return (React.createElement("style", { type: "text/css" }, "input.supertokens-input:-webkit-autofill,input.supertokens-input:-webkit-autofill:focus,input.supertokens-input:-webkit-autofill:hover,select:-webkit-autofill,select:-webkit-autofill:focus,select:-webkit-autofill:hover,textarea:-webkit-autofill,textarea:-webkit-autofill:focus,textarea:-webkit-autofill:hover{transition:background-color 5000s ease-in-out 0s}"));
}
