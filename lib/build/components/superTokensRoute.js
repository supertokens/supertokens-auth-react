...
function getSuperTokensRoutesForReactRouterDom() {
    ...
    var Route = superTokens_1.default.getInstanceOrThrow().reactRouterDom.Route;
    var withRouter = superTokens_1.default.getInstanceOrThrow().reactRouterDom.withRouter;
...
function SuperTokensRouteWithRecipeId(_a) {
    ...
    var Component = superTokens_1.default
        .getInstanceOrThrow()
