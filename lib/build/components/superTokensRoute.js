...
function getSuperTokensRoutesForReactRouterDom(supertokensInstance) {
    ...
    return Object.keys(pathsToFeatureComponentWithRecipeIdMap).map(function (path) {
        ...
        return React.createElement(
            ...
            React.createElement(SuperTokensRouteWithRecipeId, { supertokensInstance: supertokensInstance, path: path })
        );
    });
}
...
function SuperTokensRouteWithRecipeId(_a) {
    ...
    var _b;
    var history =
        (_b = supertokensInstance.getReactRouterDom()) === null || _b === void 0 ? void 0 : _b.useHistoryCustom();
