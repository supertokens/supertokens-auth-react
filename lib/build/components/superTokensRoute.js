...
function getSuperTokensRoutesForReactRouterDom() {
    ...
    var pathsToFeatureComponentWithRecipeIdMap = superTokens_1.default.getInstanceOrThrow().getPathsToFeatureComponentWithRecipeIdMap();
    return Object.keys(pathsToFeatureComponentWithRecipeIdMap).map(function (path) {
        return (React.createElement(Route, { exact: true, key: "st-" + path, path: path },
...
function SuperTokensRouteWithRecipeId(_a) {
    ...
    var featureComponentWithRecipeId = superTokens_1.default.getInstanceOrThrow().getMatchingComponentForRouteAndRecipeId(normalisedPath);
