...
function SuperTokensRouteWithRecipeId(_a) {
    ...
    var featureComponentWithRecipeId = React.useMemo(
        function () {
            return superTokens_1.default.getInstanceOrThrow().getMatchingComponentForRouteAndRecipeId(normalisedPath);
        },
        [normalisedPath.getAsStringDangerous()]
    );
    var WithRouterComponent = React.useRef(
    ...
    return React.createElement(WithRouterComponent.current, null);
}
