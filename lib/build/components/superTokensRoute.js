...
function getSuperTokensRoutesForReactRouterDom() {
    try {
        ...
        var pathsToComponentWithRecipeIdMap = _superTokens["default"]
            .getInstanceOrThrow()
...
function SuperTokensRouteWithRecipeId(_ref) {
    ...
    var Component = _superTokens["default"]
        .getInstanceOrThrow()
    ...
    return /*#__PURE__*/ React.createElement(WithRouterComponent, null);
}
