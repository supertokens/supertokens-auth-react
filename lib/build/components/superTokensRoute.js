    ...
    try {
        ...
        _superTokens["default"].getRecipeList().map(function(recipe) {
            ...
            return Object.keys(features).map(function(featurePath) {
                var fullPath = _superTokens["default"]
                    .getAppInfo()
                    .websiteBasePath.appendPath(new _normalisedURLPath["default"](featurePath))
                    .getAsStringDangerous(); // If no components yet for this route, initialize empty array.
