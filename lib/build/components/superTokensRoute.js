...
function SuperTokensRouteWithRecipeId(path, routeComponents) {
    ...
    var recipeId = (0, _utils.getRecipeIdFromSearch)(window.location.search); // If no recipe Id provided, return first matching component.
...
function UnknownRecipeId() {
    ...
    return /*#__PURE__*/ React.createElement("div", {
        id: _constants.CLASS_UNKNOWN_RECIPE_ID
    });
}
