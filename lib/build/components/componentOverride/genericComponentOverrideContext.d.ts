...
export declare const createGenericComponentsOverrideContext: <T extends Record<string, unknown>>(v: T | undefined, key: keyof AllRecipeComponentOverrides) => readonly [() => T | ({
    ...
    PasswordlessEPComboEmailForm_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/passwordless/types").SignInUpEPComboEmailFormProps & {
        footer?: JSX.Element | undefined;
    }>> | undefined;
    PasswordlessEPComboEmailOrPhoneForm_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/passwordless/types").SignInUpEPComboEmailOrPhoneFormProps & {
        footer?: JSX.Element | undefined;
    }>> | undefined;
    ...
    PasswordlessLinkSent_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/passwordless/types").LinkSentThemeProps>> | undefined;
    ...
    PasswordlessMFAOTPLoadingScreen_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<{}>> | undefined;
} & T) | ({
    ...
    TOTPLoadingScreen_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<{}>> | undefined;
    ...
    WebauthnContinueWithPasskey_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/types").ContinueWithPasskeyProps>> | undefined;
    WebauthnPasskeyNotSupportedError_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<unknown>> | undefined;
    WebauthnPasskeyRecoveryEmailSent_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/types").EmailSentProps>> | undefined;
    WebauthnRecoverAccountForm_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/types").RecoverFormProps & {
        setError: React.Dispatch<React.SetStateAction<string | undefined>>;
    }>> | undefined;
    WebauthnRecoverAccount_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/types").RecoverFormProps>> | undefined;
    WebauthnPasskeyConfirmation_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/types").SignUpFormProps & {
    ...
    WebauthnPasskeyFeatureBlock_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/types").FeatureBlockDetailProps>> | undefined;
    WebauthnContinueWithoutPasskey_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<{
        onClick: () => void;
    }>> | undefined;
    WebauthnPasskeySignUpForm_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/types").SignUpFormProps & {
        footer?: JSX.Element | undefined;
        onContinueClick: (params: import("../../recipe/webauthn/types").ContinueOnSuccessParams) => void;
        setActiveScreen: React.Dispatch<React.SetStateAction<import("../../recipe/webauthn/components/themes/signUp/signUpForm").SignUpScreen>>;
        onRecoverAccountClick: () => void;
    }>> | undefined;
    WebauthnPasskeySignUpSomethingWentWrong_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<{
        onClick: () => void;
    }>> | undefined;
    WebauthnMFASignIn_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/components/themes/mfa/mfaSignIn").MFASignInProps>> | undefined;
    WebauthnMFALoadingScreen_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<unknown>> | undefined;
    WebauthnMFASignUp_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/components/themes/mfa/mfaSignUp").MFASignUpProps>> | undefined;
    WebauthnMFASignUpConfirmation_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/components/themes/mfa/mfaSignUpConfirmation").MFASignUpConfirmationProps>> | undefined;
    WebauthnMFAFooter_Override?: import("./componentOverride").ComponentOverride<React.ComponentType<import("../../recipe/webauthn/components/themes/mfa/mfaFooter").WebauthnMFAFooterProps>> | undefined;
