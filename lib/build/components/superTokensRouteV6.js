...
function SuperTokensRouteWithRecipeId(_a) {
    var supertokensInstance = _a.supertokensInstance,
        path = _a.path;
    var history = useNavigateHookForRRDV6(supertokensInstance.getReactRouterDom());
...
function useNavigateHookForRRDV6(reactRouterDom) {
...
exports.useNavigateHookForRRDV6 = useNavigateHookForRRDV6;
