...
function superTokensMiddleware(config, withSession) {
    var _this = this;
    var usesTheNextjsApiAsTheAuthenticationServer = config.appInfo.apiDomain === config.appInfo.websiteDomain;
    return function (request) { return logger.__awaiter(_this, void 0, void 0, function () {
        ...
        return logger.__generator(this, function (_a) {
            ...
            if (requestUrl.pathname.startsWith("/api") && usesTheNextjsApiAsTheAuthenticationServer) {
                ...
                return [2 /*return*/, withSession(request, function (err, session) { return logger.__awaiter(_this, void 0, void 0, function () {
                        var response;
                        return logger.__generator(this, function (_a) {
                            if (err) {
                                return [2 /*return*/, new Response(JSON.stringify(err), {
                                        status: 500,
...
function refreshSession(config, request) {
    return logger.__awaiter(this, void 0, void 0, function () {
        var redirectAttemptNumber, requestUrl, redirectTo, tokens, hasRequiredCookies, redirectUrl, finalResponse, err_1;
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    requestUrl = new URL(request.url);
                    redirectTo = requestUrl.searchParams.get(constants.REDIRECT_PATH_PARAM_NAME) || "/";
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
