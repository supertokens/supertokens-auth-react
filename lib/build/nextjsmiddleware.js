...
function superTokensMiddleware(config) {
    var _this = this;
    var usesTheNextjsApiAsTheAuthenticationServer = compareUrlHost(
            ...
            return utils.__generator(this, function (_a) {
                ...
                if (!isInternalPath(requestUrl.pathname)) {
                    response.headers.append(
                        "set-cookie",
                        ""
                            .concat(constants.CURRENT_PATH_COOKIE_NAME, "=")
                            .concat(requestUrl.pathname, "; Path=/; HttpOnly; SameSite=Strict")
                    );
                }
...
function refreshSession(request) {
    return utils.__awaiter(this, void 0, void 0, function () {
        var redirectAttemptNumber,
            requestUrl,
            urlParamRedirectPath,
            redirectTo,
            _a,
            cookies,
            headers,
        ...
        return utils.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (
                        !getCookie(request, constants.REFRESH_TOKEN_COOKIE_NAME) &&
                        !getCookie(request, constants.REFRESH_TOKEN_HEADER_NAME)
                    ) {
                    ...
                    redirectTo =
                        urlParamRedirectPath && isValidUrlPath(urlParamRedirectPath) ? urlParamRedirectPath : "/";
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 3, , 4]);
                ...
                case 2:
                    ...
                    finalResponse.headers.append(
                        "set-cookie",
                        ""
                            .concat(constants.REDIRECT_ATTEMPT_COUNT_COOKIE_NAME, "=")
                            .concat(redirectAttemptNumber + 1, "; Path=/; Max-Age=10; HttpOnly; SameSite=Strict")
                    );
                    finalResponse.headers.append(
                        "set-cookie",
                        "".concat(
                            constants.SSR_REFRESH_SESSION_INDICATOR_COOKIE_NAME,
                            "=true; Path=/; HttpOnly; SameSite=Strict; Max-Age=5"
                        )
                    );
        ...
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    accessToken =
                        getCookie(request, constants.ACCESS_TOKEN_COOKIE_NAME) ||
                        getCookie(request, constants.ACCESS_TOKEN_HEADER_NAME);
                    if (!accessToken) {
                        throw new Error("No access token found in the request");
                    }
                    signOutURL = new URL(
                        "".concat(AppInfo.apiBasePath.getAsStringDangerous(), "/signout"),
                    ...
                    refreshRequestHeaders.append(
                        "Cookie",
                        "".concat(constants.REFRESH_TOKEN_COOKIE_NAME, "=").concat(accessToken)
                    );
                ...
                case 4:
                    ...
                    response.headers.append(
                        "set-cookie",
                        "".concat(
                            constants.ACCESS_TOKEN_HEADER_NAME,
                            "=; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax"
                        )
                    );
                    response.headers.append(
                        "set-cookie",
                        "".concat(
                            constants.FRONT_TOKEN_COOKIE_NAME,
                            "=; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax"
                        )
                    );
                    response.headers.append(
                        "set-cookie",
                        "".concat(
                            constants.ANTI_CSRF_TOKEN_COOKIE_NAME,
                            "=; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax"
                        )
                    );
                    response.headers.append(
                        "set-cookie",
                        "".concat(
                            constants.ANTI_CSRF_TOKEN_HEADER_NAME,
                            "=; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax"
                        )
                    );
                    refreshPath = getRefreshAPIPath();
                    response.headers.append(
                        "set-cookie",
                        ""
                            .concat(constants.REFRESH_TOKEN_COOKIE_NAME, "=; Path=")
                            .concat(refreshPath, "; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax")
                    );
                    response.headers.append(
                        "set-cookie",
                        ""
                            .concat(constants.REFRESH_TOKEN_HEADER_NAME, "=; Path=")
                            .concat(refreshPath, "; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax")
                    );
                    response.headers.append(
                        "set-cookie",
                        "".concat(
                            constants.SSR_REVOKE_SESSION_INDICATOR_COOKIE_NAME,
                            "=true; Path=/; HttpOnly; SameSite=Strict; Max-Age=5"
                        )
                    );
                    return [2 /*return*/, response];
...
function fetchNewTokens(request) {
    return utils.__awaiter(this, void 0, void 0, function () {
        ...
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    refreshApiURL = new URL(
                        "".concat(AppInfo.apiBasePath.getAsStringDangerous(), "/session/refresh"),
                        AppInfo.apiDomain.getAsStringDangerous()
                    );
                    ...
                    if (cookieRefreshToken) {
                        refreshRequestHeaders.append(
                            "Cookie",
                            "".concat(constants.REFRESH_TOKEN_COOKIE_NAME, "=").concat(cookieRefreshToken)
                        );
                ...
                case 1:
                    ...
                    if (!refreshResponse.ok) {
                        throw new Error(
                            "Refresh request returned an invalid status code: ".concat(refreshResponse.status)
                        );
                    }
                    ...
                    cookies.push(
                        "".concat(constants.FRONT_TOKEN_COOKIE_NAME, "=").concat(tokens.frontToken, "; Path=/")
                    );
                    ...
                    if (
                        !cookies.some(function (cookie) {
                            return cookie.includes(constants.ACCESS_TOKEN_COOKIE_NAME);
                        })
                    ) {
                        cookies.push(
                            ""
                                .concat(constants.ACCESS_TOKEN_HEADER_NAME, "=")
                                .concat(tokens.accessToken, "; Path=/; HttpOnly; SameSite=Lax")
                        );
                    }
                    if (
                        !cookies.some(function (cookie) {
                            return cookie.includes(constants.REFRESH_TOKEN_COOKIE_NAME);
                        })
                    ) {
                        cookies.push(
                            ""
                                .concat(constants.REFRESH_TOKEN_HEADER_NAME, "=")
                                .concat(tokens.refreshToken, "; Path=/api/auth/session/refresh; HttpOnly; SameSite=Lax")
                        );
                    }
                    if (
                        !cookies.some(function (cookie) {
                            return cookie.includes(constants.ANTI_CSRF_TOKEN_COOKIE_NAME);
                        }) &&
                        tokens.antiCsrfToken
                    ) {
                        cookies.push(
                            ""
                                .concat(constants.ANTI_CSRF_TOKEN_HEADER_NAME, "=")
                                .concat(tokens.antiCsrfToken, "; Path=/; HttpOnly; SameSite=Lax")
                        );
                    }
                    headers = [];
