    ...
    return function (request) { return utils.__awaiter(_this, void 0, void 0, function () {
        ...
        return utils.__generator(this, function (_a) {
            ...
            if (!isInternalPath(requestUrl.pathname)) {
                response.headers.append("set-cookie", "".concat(constants.CURRENT_PATH_COOKIE_NAME, "=").concat(requestUrl.pathname, "; Path=/; HttpOnly; SameSite=Strict; Max-Age=60;"));
            }
...
function revokeSession(request) {
    return utils.__awaiter(this, void 0, void 0, function () {
        var response, accessToken, signOutURL, signoutRequestHeaders, err_2, refreshPath;
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 4:
                    ...
                    response.headers.append("set-cookie", "".concat(constants.ACCESS_TOKEN_COOKIE_SESSION_COOKIE_NAME, "=; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax"));
                    ...
                    response.headers.append("set-cookie", "".concat(constants.FRONT_TOKEN_COOKIE_SESSION_COOKIE_NAME, "=; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax"));
                    ...
                    refreshPath = getRefreshAPIPath();
                    response.headers.append("set-cookie", "".concat(constants.REFRESH_TOKEN_COOKIE_SESSION_COOKIE_NAME, "=; Path=").concat(refreshPath, "; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax"));
                    response.headers.append("set-cookie", "".concat(constants.REFRESH_TOKEN_HEADER_SESSION_COOKIE_NAME, "=; Path=").concat(refreshPath, "; Expires=Thu, 01 Jan 1970 00:00:00 GMT; HttpOnly; SameSite=Lax"));
        ...
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    cookies.push("".concat(constants.FRONT_TOKEN_COOKIE_SESSION_COOKIE_NAME, "=").concat(frontToken, "; Path=/"));
                    if (tokenTransferMethod === "cookie") {
                        ...
                        if (accessToken) {
                            ...
                            cookies.push("".concat(constants.ACCESS_TOKEN_HEADER_SESSION_COOKIE_NAME, "=").concat(accessToken, "; Path=/; HttpOnly; SameSite=Lax"));
                        }
                        else {
                        ...
                        if (refreshToken) {
                            ...
                            cookies.push("".concat(constants.REFRESH_TOKEN_HEADER_SESSION_COOKIE_NAME, "=").concat(refreshToken, "; Path=").concat(getRefreshAPIPath(), "; HttpOnly; SameSite=Lax"));
                        }
                        else {
                        ...
                        if (antiCsrfToken) {
                            ...
                            cookies.push("".concat(constants.ANTI_CSRF_TOKEN_HEADER_NAME, "=").concat(antiCsrfToken, "; Path=/; HttpOnly; SameSite=Lax"));
                        }
                    }
