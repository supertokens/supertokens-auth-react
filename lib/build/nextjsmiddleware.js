        ...
        return utils.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (
                        !getCookie(request, constants.REFRESH_TOKEN_COOKIE_SESSION_COOKIE_NAME) &&
        ...
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    accessToken =
                        getCookie(request, constants.ACCESS_TOKEN_COOKIE_SESSION_COOKIE_NAME) ||
                ...
                case 0:
                    ...
                    if (cookieRefreshToken) {
                        refreshRequestHeaders.append(
                            "Cookie",
                            ""
                                .concat(constants.REFRESH_TOKEN_COOKIE_SESSION_COOKIE_NAME, "=")
                                .concat(cookieRefreshToken)
                        );
...
function buildSetCookieHeader(cookie) {
    var name = cookie.name,
        ...
        path = _a === void 0 ? "/" : _a,
        _b = cookie.sameSite,
        sameSite = _b === void 0 ? "lax" : _b,
        _c = cookie.httpOnly,
        httpOnly = _c === void 0 ? true : _c,
