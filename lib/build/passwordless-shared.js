...
var PasswordlessCloseTabScreen = function () {
    var t = sessionAuth.useTranslation();
...
var CloseTabScreen = sessionAuth.withOverride("PasswordlessCloseTabScreen", PasswordlessCloseTabScreen);

var SignInUpFooter = sessionAuth.withOverride("PasswordlessSignInUpFooter", function PasswordlessSignInUpFooter(_a) {
...
var EmailForm = sessionAuth.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    var _this = this;
...
function PhoneNumberInput(_a) {
    ...
    React.useEffect(function () {
        if (inputRef.current !== null && inputRef.current.dataset["intl-tel-input-id"] === undefined) {
            ...
            var anyIti = iti;
            if (anyIti.isMobile) {
                var root = document.getElementById(sessionAuth.ST_ROOT_ID);
...
var phoneNumberInputWithInjectedProps = function (injectedProps) {
    return function (props) {
        return jsxRuntime.jsx(PhoneNumberInput, sessionAuth.__assign({}, injectedProps, props));
    };
};

var EmailOrPhoneForm = sessionAuth.withOverride(
...
var ResendButton = sessionAuth.withOverride("PasswordlessResendButton", function PasswordlessResendButton(_a) {
                            ...
                            children: [
                                ...
                                jsxRuntime.jsxs(
                                    ...
                                    sessionAuth.__assign(
                                        ...
                                        {
                                            children: [
                                                jsxRuntime.jsx(sessionAuth.ArrowLeftIcon, {
                                                    color: "rgb(var(--palette-textPrimary))",
                                                }),
                                                props.loginAttemptInfo.contactMethod === "EMAIL"
...
var LinkSent = sessionAuth.withOverride("PasswordlessLinkSent", PasswordlessLinkSent);

var PhoneForm = sessionAuth.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    var _this = this;
    var userContext = sessionAuth.useUserContext();
    React.useEffect(function () {
        // We preload this here, since it will be used almost for sure, but loading it
...
var SignInUpHeader = sessionAuth.withOverride("PasswordlessSignInUpHeader", function PasswordlessSignInUpHeader() {
    var t = sessionAuth.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsx(
...
var UserInputCodeFormFooter = sessionAuth.withOverride(
        ...
        return jsxRuntime.jsx(React.Fragment, {
            children: jsxRuntime.jsxs(
                ...
                sessionAuth.__assign(
                    ...
                    {
                        children: [
                            jsxRuntime.jsx(sessionAuth.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }),
                            loginAttemptInfo.contactMethod === "EMAIL"
                                ? t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_EMAIL")
                                : t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_PHONE"),
                        ],
...
var UserInputCodeForm = sessionAuth.withOverride(
...
var UserInputCodeFormHeader = sessionAuth.withOverride(
...
function SignInUpThemeWrapper(props) {
    var hasFont = sessionAuth.hasFontDefined(props.config.rootStyle);
...
var LinkClickedScreenWithOverride = sessionAuth.withOverride(
...
var LinkClickedScreen$1 = function (props) {
    ...
    return jsxRuntime.jsx(
        ...
        sessionAuth.__assign(
            ...
            { children: jsxRuntime.jsx(LinkClickedScreenWithOverride, sessionAuth.__assign({}, props)) }
        )
    );
};

var defaultTranslationsPasswordless = {
    en: sessionAuth.__assign(sessionAuth.__assign({}, sessionAuth.defaultTranslationsCommon.en), {
...
var LinkClickedScreen = function (props) {
    ...
    return jsxRuntime.jsx(
        sessionAuth.ComponentOverrideContext.Provider,
        sessionAuth.__assign(
            { value: recipeComponentOverrides },
            {
                children: jsxRuntime.jsx(
                    sessionAuth.FeatureWrapper,
                    sessionAuth.__assign(
                        {
