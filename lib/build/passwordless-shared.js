...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImp), { createCode: function (input) {
            ...
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    return [2 /*return*/, originalImp.setLoginAttemptInfo(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, input), { attemptInfo: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, input.attemptInfo), input.userContext.additionalAttemptInfo) }))];
                });
            });
        } })); };
};
...
function normalisePasswordlessBaseConfig(config) {
    ...
    return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, config), { style: style });
}
function checkAdditionalLoginAttemptInfoProperties(loginAttemptInfo) {
    if (loginAttemptInfo.contactInfo === undefined ||
...
var Passwordless = /** @class */ (function (_super) {
    ...
    function Passwordless(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = PasswordlessWebJS__default.default; }
        var _this = _super.call(this, config) || this;
        _this.webJSRecipe = webJSRecipe;
        _this.recipeID = Passwordless.RECIPE_ID;
        _this.firstFactorIds = [types.FactorIds.OTP_EMAIL, types.FactorIds.OTP_PHONE, types.FactorIds.LINK_EMAIL, types.FactorIds.LINK_PHONE];
    ...
    Passwordless.init = function (config) {
        return {
            ...
            authReact: function (appInfo, _, overrideMaps) {
                var normalisedConfig = normalisePasswordlessConfig(genericComponentOverrideContext.applyPlugins(Passwordless.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : []));
                Passwordless.instance = new Passwordless(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Passwordless.RECIPE_ID }));
            ...
            webJS: function () {
                ...
                var init = PasswordlessWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
...
var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext(undefined, Passwordless.RECIPE_ID), useContext = _a[0], Provider = _a[1];
