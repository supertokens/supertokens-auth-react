...
var Passwordless = /** @class */ (function (_super) {
    ...
    Passwordless.init = function (config) {
        ...
        return {
            ...
            webJS: PasswordlessWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
