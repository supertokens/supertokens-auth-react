...
var CloseTabScreen = genericComponentOverrideContext.withOverride(
    "PasswordlessCloseTabScreen",
    PasswordlessCloseTabScreen
);

var SignInUpFooter = genericComponentOverrideContext.withOverride(
    "PasswordlessSignInUpFooter",
    function PasswordlessSignInUpFooter(_a) {
...
var EmailForm = genericComponentOverrideContext.withOverride(
    "PasswordlessEmailForm",
    function PasswordlessEmailForm(props) {
        var _this = this;
...
var intlTelInput = /*@__PURE__*/ getDefaultExportFromCjs(intlTelInput$2.exports);
...
var EmailOrPhoneForm = genericComponentOverrideContext.withOverride(
...
var ResendButton = genericComponentOverrideContext.withOverride(
                ...
                children: jsxRuntime.jsxs(
                    ...
                    sessionAuth.__assign(
                        { "data-supertokens": "row" },
                        {
                            children: [
                                status === "ERROR" &&
                                    jsxRuntime.jsx(genericComponentOverrideContext.GeneralError, {
...
var LinkSent = genericComponentOverrideContext.withOverride("PasswordlessLinkSent", PasswordlessLinkSent);

var PhoneForm = genericComponentOverrideContext.withOverride(
    "PasswordlessPhoneForm",
    function PasswordlessPhoneForm(props) {
        var _this = this;
        var userContext = sessionAuth.useUserContext();
        React.useEffect(function () {
            // We preload this here, since it will be used almost for sure, but loading it
...
var SignInUpHeader = genericComponentOverrideContext.withOverride(
    "PasswordlessSignInUpHeader",
    function PasswordlessSignInUpHeader() {
        var t = translationContext.useTranslation();
        return jsxRuntime.jsxs(React.Fragment, {
            children: [
                jsxRuntime.jsx(
...
var UserInputCodeFormFooter = genericComponentOverrideContext.withOverride(
...
var UserInputCodeForm = genericComponentOverrideContext.withOverride(
...
var UserInputCodeFormHeader = genericComponentOverrideContext.withOverride(
...
function SignInUpThemeWrapper(props) {
    var hasFont = genericComponentOverrideContext.hasFontDefined(props.config.rootStyle);
...
var defaultTranslationsPasswordless = {
    en: sessionAuth.__assign(sessionAuth.__assign({}, genericComponentOverrideContext.defaultTranslationsCommon.en), {
...
var SignInUpFeature = function (props) {
    ...
    return jsxRuntime.jsx(
        genericComponentOverrideContext.ComponentOverrideContext.Provider,
        sessionAuth.__assign(
            { value: recipeComponentOverrides },
            {
                children: jsxRuntime.jsx(
                    genericComponentOverrideContext.FeatureWrapper,
                    sessionAuth.__assign(
                        {
                            ...
                            return [
                                ...
                                originalImpl.createCode(
                                    sessionAuth.__assign(sessionAuth.__assign({}, input), {
                                        userContext: sessionAuth.__assign(sessionAuth.__assign({}, input.userContext), {
...
var LinkClickedScreenWithOverride = genericComponentOverrideContext.withOverride(
...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) {
        return sessionAuth.__assign(sessionAuth.__assign({}, originalImp), {
            createCode: function (input) {
                return sessionAuth.__awaiter(this, void 0, void 0, function () {
                    var response;
                    return sessionAuth.__generator(this, function (_a) {
                    ...
                    return sessionAuth.__generator(this, function (_a) {
                        return [
                            ...
                            originalImp.setLoginAttemptInfo(
                                sessionAuth.__assign(sessionAuth.__assign({}, input), {
                                    attemptInfo: sessionAuth.__assign(
                                        sessionAuth.__assign({}, input.attemptInfo),
        ...
        return {
            authReact: function (appInfo) {
                Passwordless.instance = new Passwordless(
                    sessionAuth.__assign(sessionAuth.__assign({}, normalisedConfig), {
                        appInfo: appInfo,
