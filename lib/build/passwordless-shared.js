...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (logger.__assign(logger.__assign({}, originalImp), { createCode: function (input) {
            ...
            return logger.__awaiter(this, void 0, void 0, function () {
                return logger.__generator(this, function (_a) {
                    return [2 /*return*/, originalImp.setLoginAttemptInfo(logger.__assign(logger.__assign({}, input), { attemptInfo: logger.__assign(logger.__assign({}, input.attemptInfo), input.userContext.additionalAttemptInfo) }))];
                });
            });
        } })); };
};
...
function normalisePasswordlessBaseConfig(config) {
    ...
    return logger.__assign(logger.__assign({}, config), { style: style });
}
...
var Passwordless = /** @class */ (function (_super) {
    logger.__extends(Passwordless, _super);
    function Passwordless(config, webJSRecipe) {
        ...
        _this.getDefaultRedirectionURL = function (context) { return logger.__awaiter(_this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
    ...
    Passwordless.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                Passwordless.instance = new Passwordless(logger.__assign(logger.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Passwordless.RECIPE_ID }));
                return Passwordless.instance;
            },
            webJS: PasswordlessWebJS__default.default.init(logger.__assign(logger.__assign({}, normalisedConfig), { override: {
