...
var recipeImplementation = require("supertokens-web-js/recipe/passwordless/recipeImplementation");
...
var _a = session.createGenericComponentsOverrideContext(),
    useContext = _a[0],
    Provider = _a[1];
...
var CloseTabScreen = session.withOverride("PasswordlessCloseTabScreen", PasswordlessCloseTabScreen);

var SignInUpFooter = session.withOverride("PasswordlessSignInUpFooter", function PasswordlessSignInUpFooter(_a) {
...
var EmailForm = session.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    var _this = this;
    ...
    return jsxRuntime.jsx(validators.FormBase, {
        ...
        callAPI: function (formFields) {
            return session.__awaiter(_this, void 0, void 0, function () {
                ...
                var _a;
                return session.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            email =
...
var intlTelInput = /*@__PURE__*/ index.getDefaultExportFromCjs(intlTelInputExports$1);
...
function PhoneNumberInput(_a) {
    ...
    React.useEffect(function () {
        if (inputRef.current !== null && inputRef.current.dataset["intl-tel-input-id"] === undefined) {
            ...
            var anyIti = iti;
            if (anyIti.isMobile) {
                var root = document.getElementById(session.ST_ROOT_ID);
                                    ...
                                    hasError === true &&
                                        jsxRuntime.jsx(
                                            ...
                                            session.__assign(
                                                ...
                                                { children: jsxRuntime.jsx(validators.ErrorIcon, {}) }
                                            )
                                        ),
                                ],
                            }
...
var phoneNumberInputWithInjectedProps = function (injectedProps) {
    return function (props) {
        return jsxRuntime.jsx(PhoneNumberInput, session.__assign({}, injectedProps, props));
    };
};

var EmailOrPhoneForm = session.withOverride(
...
var ResendButton = session.withOverride("PasswordlessResendButton", function PasswordlessResendButton(_a) {
...
var PasswordlessLinkSent = function (props) {
    ...
    var resendEmail = React.useCallback(
        function () {
            return session.__awaiter(void 0, void 0, void 0, function () {
                            ...
                            children: [
                                ...
                                jsxRuntime.jsxs(
                                    ...
                                    session.__assign(
                                        ...
                                        {
                                            children: [
                                                jsxRuntime.jsx(validators.ArrowLeftIcon, {
                                                    color: "rgb(var(--palette-textPrimary))",
                                                }),
                                                props.loginAttemptInfo.contactMethod === "EMAIL"
...
var LinkSent = session.withOverride("PasswordlessLinkSent", PasswordlessLinkSent);

var PhoneForm = session.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    var _this = this;
    var userContext = session.useUserContext();
    React.useEffect(function () {
        // We preload this here, since it will be used almost for sure, but loading it
...
var SignInUpHeader = session.withOverride("PasswordlessSignInUpHeader", function PasswordlessSignInUpHeader() {
    var t = session.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsx(
...
var UserInputCodeFormFooter = session.withOverride(
        ...
        return jsxRuntime.jsx(React.Fragment, {
            children: jsxRuntime.jsxs(
                ...
                session.__assign(
                    ...
                    {
                        children: [
                            jsxRuntime.jsx(validators.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }),
                            loginAttemptInfo.contactMethod === "EMAIL"
                                ? t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_EMAIL")
                                : t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_PHONE"),
                        ],
...
var UserInputCodeForm = session.withOverride(
            ...
            children: [
                ...
                jsxRuntime.jsx(validators.FormBase, {
                    ...
                    formFields: [
                        {
                            ...
                            labelComponent: jsxRuntime.jsxs(
                                ...
                                session.__assign(
                                    ...
                                    {
                                        children: [
                                            jsxRuntime.jsx(validators.Label, {
                    ...
                    footer: jsxRuntime.jsx(
                        ...
                        session.__assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })
                    ),
                }),
            ],
        });
...
var UserInputCodeFormHeader = session.withOverride(
...
var SignInUpTheme = function (_a) {
    var activeScreen = _a.activeScreen,
        ...
        props = session.__rest(_a, ["activeScreen", "featureState"]);
    var commonProps = {
    ...
    return activeScreen === exports.SignInUpScreens.CloseTab
        ? jsxRuntime.jsx(CloseTabScreen, session.__assign({}, commonProps))
        : activeScreen === exports.SignInUpScreens.LinkSent
        ? jsxRuntime.jsx(
              LinkSent,
              session.__assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo })
          )
        : jsxRuntime.jsxs(
              "div",
              session.__assign(
                                          ...
                                          jsxRuntime.jsxs(React__namespace.default.Fragment, {
                                              children: [
                                                  ...
                                                  activeScreen === exports.SignInUpScreens.EmailForm
                                                      ? jsxRuntime.jsx(EmailForm, session.__assign({}, commonProps))
                                                      : activeScreen === exports.SignInUpScreens.PhoneForm
                                                      ? jsxRuntime.jsx(PhoneForm, session.__assign({}, commonProps))
...
function SignInUpThemeWrapper(props) {
    var hasFont = session.hasFontDefined(props.config.rootStyle);
                ...
                children: jsxRuntime.jsx(
                    ...
                    session.__assign(
                        { loadDefaultFont: !hasFont, userStyles: [props.config.rootStyle, activeStyle] },
                        {
                            children: jsxRuntime.jsx(
                                SignInUpTheme,
                                session.__assign({}, props, { activeScreen: activeScreen })
                            ),
                        }
                    )
                ),
...
function normalisePasswordlessConfig(config) {
    ...
    return session.__assign(session.__assign({}, utils.normaliseAuthRecipe(config)), {
...
function normalizeSignInUpFeatureConfig(signInUpInput, config) {
    ...
    var signInUpFeature = session.__assign(session.__assign({}, signInUpInput), {
        resendEmailOrSMSGapInSeconds:
...
function normalisePasswordlessBaseConfig(config) {
    ...
    return session.__assign(session.__assign({}, config), { style: style });
}
...
var LinkClickedScreenWithOverride = session.withOverride(
...
var LinkClickedScreen$1 = function (props) {
    ...
    return jsxRuntime.jsx(
        ...
        session.__assign(
            ...
            { children: jsxRuntime.jsx(LinkClickedScreenWithOverride, session.__assign({}, props)) }
        )
    );
};

var defaultTranslationsPasswordless = {
    en: session.__assign(session.__assign({}, session.defaultTranslationsCommon.en), {
...
var LinkClickedScreen = function (props) {
        ...
        function () {
            return session.__awaiter(void 0, void 0, void 0, function () {
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            preAuthSessionId = session.getQueryParams("preAuthSessionId");
                            linkCode = session.getURLHash();
                            if (!(preAuthSessionId === null || preAuthSessionId.length === 0 || linkCode.length === 0))
                                return [3 /*break*/, 2];
                            return [
                                4 /*yield*/,
                                session.SuperTokens.getInstanceOrThrow().redirectToAuth({
                ...
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [
                                2 /*return*/,
                                session.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                                    {
    ...
    var handleConsumeError = React.useCallback(
        function (err) {
            if (STGeneralError__default.default.isThisError(err)) {
                return session.SuperTokens.getInstanceOrThrow().redirectToAuth({
                    history: props.history,
                    queryParams: {
                        error: "custom",
                        message: err.message,
    ...
    session.useOnMountAPICall(consumeCodeAtMount, handleConsumeResp, handleConsumeError);
    ...
    return jsxRuntime.jsx(
        session.ComponentOverrideContext.Provider,
        session.__assign(
            { value: recipeComponentOverrides },
            {
                children: jsxRuntime.jsx(
                    session.FeatureWrapper,
                    session.__assign(
                        {
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(LinkClickedScreen$1, session.__assign({}, childProps)),
                                    props.children &&
...
var useFeatureReducer = function (recipeImpl, userContext) {
    var _a = React__namespace.useReducer(
            function (oldState, action) {
                switch (action.type) {
                    ...
                    case "resendCode":
                        ...
                        return session.__assign(session.__assign({}, oldState), {
                            error: undefined,
                            loginAttemptInfo: session.__assign(session.__assign({}, oldState.loginAttemptInfo), {
                    ...
                    case "setError":
                        return session.__assign(session.__assign({}, oldState), { error: action.error });
                    case "startLogin":
                        return session.__assign(session.__assign({}, oldState), {
                            loginAttemptInfo: action.loginAttemptInfo,
                            error: undefined,
                    ...
                    case "successInAnotherTab":
                        return session.__assign(session.__assign({}, oldState), { successInAnotherTab: true });
                    default:
                        return oldState;
                }
            },
            ...
            function (initArg) {
                var error = undefined;
                var errorQueryParam = session.getQueryParams("error");
                var messageQueryParam = session.getQueryParams("message");
                ...
                return session.__assign(session.__assign({}, initArg), { error: error });
            }
        ),
        state = _a[0],
        dispatch = _a[1];
                ...
                return session.__awaiter(this, void 0, void 0, function () {
                    ...
                    return session.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                error = undefined;
                                errorQueryParam = session.getQueryParams("error");
                                messageQueryParam = session.getQueryParams("message");
                                if (errorQueryParam !== null) {
                                    if (errorQueryParam === "signin") {
                                        error = "SOMETHING_WENT_WRONG_ERROR";
                                    } else if (errorQueryParam === "restart_link") {
        ...
        function () {
            ...
            return {
                onSuccess: function (result) {
                    return session.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                        {
                                        ...
                                        React__namespace.Children.map(props.children, function (child) {
                                            if (React__namespace.isValidElement(child)) {
                                                return React__namespace.cloneElement(
                                                    child,
                                                    session.__assign(session.__assign({}, childProps), {
                                                        featureState: state,
                                                        dispatch: dispatch,
                                                    })
                                                );
...
function getModifiedRecipeImplementation(originalImpl, config, dispatch, callingConsumeCodeRef) {
    var _this = this;
    return session.__assign(session.__assign({}, originalImpl), {
        createCode: function (input) {
            return session.__awaiter(_this, void 0, void 0, function () {
                var contactInfo, phoneNumberUtils, res, contactMethod, loginAttemptInfo;
                return session.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, getPhoneNumberUtils()];
                        ...
                        case 2:
                            ...
                            return [
                                ...
                                setLoginAttemptInfo({
                                    recipeImplementation: originalImpl,
                                    userContext: input.userContext,
                                    attemptInfo: session.__assign(session.__assign({}, loginAttemptInfo), {
...
var Passwordless = /** @class */ (function (_super) {
    session.__extends(Passwordless, _super);
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.config.signInUpFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: session.matchRecipeIdUsingQueryParams(_this.config.recipeId),
                                ...
                                children: jsxRuntime.jsx(
                                    ...
                                    session.__assign(
                                        { authRecipe: _this, history: props.history },
                                        {
                                            children: jsxRuntime.jsx(
                                                SignInUpFeature,
                                                session.__assign({ recipe: _this }, props, {
    ...
    Passwordless.init = function (config) {
        return function (appInfo) {
            Passwordless.instance = new Passwordless(
                session.__assign(session.__assign({}, config), { appInfo: appInfo, recipeId: Passwordless.RECIPE_ID })
            );
