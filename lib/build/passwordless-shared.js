    ...
    Passwordless.init = function (config) {
        return {
            ...
            authReact: function (appInfo, _, overrideMaps) {
                var normalisedConfig = normalisePasswordlessConfig(
                    genericComponentOverrideContext.applyPlugins(
                        Passwordless.RECIPE_ID,
                        config,
            ...
            webJS: function () {
                ...
                var init = PasswordlessWebJS__default.default.init(
                    genericComponentOverrideContext.__assign(
                        genericComponentOverrideContext.__assign({}, normalisedConfig),
                        {
                            override: {
...
var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext(undefined, Passwordless.RECIPE_ID),
    useContext = _a[0],
    Provider = _a[1];
