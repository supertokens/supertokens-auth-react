...
function getPhoneNumberUtils() {
    return sessionAuth.__awaiter(this, void 0, void 0, function* () {
        yield preloadPhoneNumberUtils();
        const global =
            recipe.windowHandler.WindowHandlerReference.getReferenceOrThrow().windowHandler.getWindowUnsafe();
...
function defaultPhoneNumberValidator(value) {
    return sessionAuth.__awaiter(this, void 0, void 0, function* () {
        ...
        value = value.trim();
        const intlTelInputUtils = yield getPhoneNumberUtils();
...
function defaultGuessInternationPhoneNumberFromInputPhoneNumber(value, defaultCountryFromConfig) {
    return sessionAuth.__awaiter(this, void 0, void 0, function* () {
        ...
        const countryData = recipe.windowHandler.WindowHandlerReference.getReferenceOrThrow()
            .windowHandler.getWindowUnsafe()
            .intlTelInputGlobals.getCountryData();
        const matchingCountryCodes = countryData.filter((c) => onlyNumbers.startsWith(c.dialCode)).map((c) => c.iso2);
...
function normalisePasswordlessConfig(config) {
    ...
    let validatePhoneNumber = defaultPhoneNumberValidator;
    if (
...
function normalizeSignInUpFeatureConfig(signInUpInput, config) {
    ...
    const signInUpFeature = Object.assign(Object.assign({}, signInUpInput), {
...
function normalisePasswordlessBaseConfig(config) {
    ...
    return Object.assign(Object.assign({}, config), { style });
}
function getLoginAttemptInfo(input) {
    return sessionAuth.__awaiter(this, void 0, void 0, function* () {
        return yield input.recipeImplementation.getLoginAttemptInfo({
            userContext: input.userContext,
        });
    });
}
function setLoginAttemptInfo(input) {
    return sessionAuth.__awaiter(this, void 0, void 0, function* () {
        return yield input.recipeImplementation.setLoginAttemptInfo({
            userContext: input.userContext,
...
function getRecipeImplementation(recipeInput) {
    ...
    return {
        createCode: function (input) {
            return sessionAuth.__awaiter(this, void 0, void 0, function* () {
                const response = yield webJsImplementation.createCode.bind(this)(input);
        ...
        resendCode: function (input) {
            return sessionAuth.__awaiter(this, void 0, void 0, function* () {
                const response = yield webJsImplementation.resendCode.bind(this)(input);
        ...
        consumeCode: function (input) {
            return sessionAuth.__awaiter(this, void 0, void 0, function* () {
                const response = yield webJsImplementation.consumeCode.bind(this)(input);
                if (response.status === "RESTART_FLOW_ERROR") {
                    recipeInput.onHandleEvent({
                        action: "PASSWORDLESS_RESTART_FLOW",
                    });
        ...
        doesEmailExist: function (input) {
            return sessionAuth.__awaiter(this, void 0, void 0, function* () {
                return yield webJsImplementation.doesEmailExist.bind(this)(input);
            });
        },
        doesPhoneNumberExist: function (input) {
            return sessionAuth.__awaiter(this, void 0, void 0, function* () {
                return yield webJsImplementation.doesPhoneNumberExist.bind(this)(input);
            });
        },
...
const PasswordlessCloseTabScreen = () => {
...
const CloseTabScreen = index.withOverride("PasswordlessCloseTabScreen", PasswordlessCloseTabScreen);

const SignInUpFooter = index.withOverride(
    "PasswordlessSignInUpFooter",
    function PasswordlessSignInUpFooter({ termsOfServiceLink, privacyPolicyLink }) {
        const t = translationContext.useTranslation();
...
const EmailForm = index.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    ...
    return jsxRuntime.jsx(arrowLeftIcon.FormBase, {
        ...
        callAPI: (formFields) =>
            sessionAuth.__awaiter(this, void 0, void 0, function* () {
                var _a;
                const email =
                    (_a = formFields.find((field) => field.id === "email")) === null || _a === void 0
                        ? void 0
                        : _a.value;
                if (email === undefined) {
                    throw new index.STGeneralError("GENERAL_ERROR_EMAIL_UNDEFINED");
                }
                const validationRes = yield props.config.validateEmailAddress(email);
                if (validationRes !== undefined) {
                    throw new index.STGeneralError(validationRes);
                }
                const response = yield props.recipeImplementation.createCode({
                    email,
                    userContext,
                });
                return response;
...
const phoneNumberInputWithInjectedProps = function (injectedProps) {
    return (props) => jsxRuntime.jsx(PhoneNumberInput, Object.assign({}, injectedProps, props));
};

const EmailOrPhoneForm = index.withOverride(
    ...
    function PasswordlessEmailOrPhoneForm(props) {
        ...
        const emailOrPhoneInput = React.useMemo(
            () =>
                isPhoneNumber
        ...
        return jsxRuntime.jsx(arrowLeftIcon.FormBase, {
            ...
            buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON",
            onSuccess: props.onSuccess,
            callAPI: (formFields, setValue) =>
                sessionAuth.__awaiter(this, void 0, void 0, function* () {
                    var _a;
                    const emailOrPhone =
                        (_a = formFields.find((field) => field.id === "emailOrPhone")) === null || _a === void 0
                            ? void 0
                            : _a.value;
                    ...
                    if ((yield defaultEmailValidator(emailOrPhone)) === undefined) {
                        const emailValidationRes = yield props.config.validateEmailAddress(emailOrPhone);
                        ...
                        const phoneValidationRes = yield props.config.validatePhoneNumber(emailOrPhone);
                        ...
                        const intPhoneNumber =
                            yield props.config.signInUpFeature.guessInternationPhoneNumberFromInputPhoneNumber(
                                emailOrPhone,
                                props.config.signInUpFeature.defaultCountry
                            );
                        if (intPhoneNumber && isPhoneNumber !== true) {
                            const phoneValidationResAfterGuess = yield props.config.validatePhoneNumber(intPhoneNumber);
                            if (phoneValidationResAfterGuess === undefined) {
                                try {
                                    return yield props.recipeImplementation.createCode({
...
const ResendButton = index.withOverride(
        ...
        () =>
            sessionAuth.__awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    let generalError;
                    try {
                        response = yield props.recipeImplementation.resendCode({
...
const LinkSent = index.withOverride("PasswordlessLinkSent", PasswordlessLinkSent);

const PhoneForm = index.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    const userContext = sessionAuth.useUserContext();
    React.useEffect(() => {
        // We preload this here, since it will be used almost for sure, but loading it
        void preloadPhoneNumberUtils();
    ...
    return jsxRuntime.jsx(arrowLeftIcon.FormBase, {
        ...
        callAPI: (formFields) =>
            sessionAuth.__awaiter(this, void 0, void 0, function* () {
                var _a;
                const phoneNumber =
                    (_a = formFields.find((field) => field.id === "phoneNumber")) === null || _a === void 0
                        ? void 0
                        : _a.value;
                if (phoneNumber === undefined) {
                    throw new index.STGeneralError("GENERAL_ERROR_PHONE_UNDEFINED");
                }
                const validationRes = yield props.config.validatePhoneNumber(phoneNumber);
                if (validationRes !== undefined) {
                    throw new index.STGeneralError(validationRes);
                }
                const response = yield props.recipeImplementation.createCode({
...
const SignInUpHeader = index.withOverride("PasswordlessSignInUpHeader", function PasswordlessSignInUpHeader() {
    const t = translationContext.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsx(
                "div",
                Object.assign({ "data-supertokens": "headerTitle" }, { children: t("PWLESS_SIGN_IN_UP_HEADER_TITLE") })
            ),
            jsxRuntime.jsx("div", { "data-supertokens": "divider" }),
        ],
    });
...
const UserInputCodeFormFooter = index.withOverride(
...
const UserInputCodeForm = index.withOverride(
                ...
                jsxRuntime.jsx(arrowLeftIcon.FormBase, {
                    ...
                    callAPI: (formFields) =>
                        sessionAuth.__awaiter(this, void 0, void 0, function* () {
                            var _a;
                            const userInputCode =
                                (_a = formFields.find((field) => field.id === "userInputCode")) === null ||
                                _a === void 0
                                    ? void 0
                                    : _a.value;
                            ...
                            const response = yield props.recipeImplementation.consumeCode({
                                deviceId: props.loginAttemptInfo.deviceId,
                                preAuthSessionId: props.loginAttemptInfo.preAuthSessionId,
                                userInputCode,
                                userContext,
                    ...
                    footer: jsxRuntime.jsx(
                        ...
                        Object.assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })
                    ),
                }),
            ],
        });
...
const UserInputCodeFormHeader = index.withOverride(
 ...
 * Component.
 */
const SignInUpTheme = (_a) => {
    var { activeScreen, featureState } = _a,
        props = sessionAuth.__rest(_a, ["activeScreen", "featureState"]);
    const commonProps = {
        recipeImplementation: props.recipeImplementation,
        config: props.config,
        clearError: () => props.dispatch({ type: "setError", error: undefined }),
        onError: (error) => props.dispatch({ type: "setError", error }),
        error: featureState.error,
    };
    return activeScreen === exports.SignInUpScreens.CloseTab
        ? jsxRuntime.jsx(CloseTabScreen, Object.assign({}, commonProps))
        : activeScreen === exports.SignInUpScreens.LinkSent
        ? jsxRuntime.jsx(LinkSent, Object.assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo }))
        : jsxRuntime.jsxs(
              "div",
              Object.assign(
                  { "data-supertokens": "container" },
                                          ...
                                          jsxRuntime.jsxs(React.Fragment, {
                                              children: [
                                                  ...
                                                  activeScreen === exports.SignInUpScreens.EmailForm
                                                      ? jsxRuntime.jsx(EmailForm, Object.assign({}, commonProps))
                                                      : activeScreen === exports.SignInUpScreens.PhoneForm
                                                      ? jsxRuntime.jsx(PhoneForm, Object.assign({}, commonProps))
                                                      : activeScreen === exports.SignInUpScreens.EmailOrPhoneForm
                                                      ? jsxRuntime.jsx(EmailOrPhoneForm, Object.assign({}, commonProps))
                                                      : activeScreen === exports.SignInUpScreens.UserInputCodeForm
                                                      ? jsxRuntime.jsx(
                                                            UserInputCodeForm,
                                                            Object.assign({}, commonProps, {
                ...
                children: jsxRuntime.jsx(
                    ...
                    Object.assign(
                        { loadDefaultFont: !hasFont, userStyles: [props.config.rootStyle, activeStyle] },
                        {
                            children: jsxRuntime.jsx(
                                SignInUpTheme,
                                Object.assign({}, props, { activeScreen: activeScreen })
                            ),
                        }
                    )
                ),
...
const useSuccessInAnotherTabChecker = (state, dispatch, userContext) => {
    const callingConsumeCodeRef = React.useRef(false);
    React.useEffect(() => {
        ...
        if (state.loginAttemptInfo && !state.successInAnotherTab) {
            const checkSessionIntervalHandle = setInterval(
                () =>
                    sessionAuth.__awaiter(void 0, void 0, void 0, function* () {
                        if (callingConsumeCodeRef.current === false) {
                            const hasSession = yield session.SessionAPIWrapper.doesSessionExist({
                                userContext,
                            });
                            if (hasSession) {
...
const useFeatureReducer = (recipeImpl, userContext) => {
    const [state, dispatch] = React__namespace.useReducer(
        (oldState, action) => {
            switch (action.type) {
                case "load":
                    return {
                ...
                case "resendCode":
                    ...
                    return Object.assign(Object.assign({}, oldState), {
                        error: undefined,
                        loginAttemptInfo: Object.assign(Object.assign({}, oldState.loginAttemptInfo), {
                ...
                case "successInAnotherTab":
                    return Object.assign(Object.assign({}, oldState), { successInAnotherTab: true });
                default:
                    return oldState;
            }
        },
        ...
        (initArg) => {
            ...
            const messageQueryParam = sessionAuth.getQueryParams("message");
            ...
            return Object.assign(Object.assign({}, initArg), { error });
        }
    );
    React.useEffect(() => {
        ...
        function load() {
            return sessionAuth.__awaiter(this, void 0, void 0, function* () {
                ...
                const loginAttemptInfo = yield getLoginAttemptInfo({
...
function getModifiedRecipeImplementation(originalImpl, config, dispatch, callingConsumeCodeRef) {
    return Object.assign(Object.assign({}, originalImpl), {
        createCode: (input) =>
            sessionAuth.__awaiter(this, void 0, void 0, function* () {
                let contactInfo;
                const phoneNumberUtils = yield getPhoneNumberUtils();
                if ("email" in input) {
                ...
                const res = yield originalImpl.createCode(input);
                if (res.status === "OK") {
        ...
        resendCode: (input) =>
            sessionAuth.__awaiter(this, void 0, void 0, function* () {
                 ...
                 */
                const res = yield originalImpl.resendCode(input);
                if (res.status === "OK") {
                    const loginAttemptInfo = yield getLoginAttemptInfo({
                        recipeImplementation: originalImpl,
                        userContext: input.userContext,
                    ...
                    if (loginAttemptInfo !== undefined && loginAttemptInfo.deviceId === input.deviceId) {
                        ...
                        yield setLoginAttemptInfo({
                            recipeImplementation: originalImpl,
                            userContext: input.userContext,
                            attemptInfo: Object.assign(Object.assign({}, loginAttemptInfo), { lastResend: timestamp }),
                        });
                        dispatch({ type: "resendCode", timestamp });
                    }
                } else if (res.status === "RESTART_FLOW_ERROR") {
                    yield originalImpl.clearLoginAttemptInfo({
                        userContext: input.userContext,
                    });
        ...
        consumeCode: (input) =>
            sessionAuth.__awaiter(this, void 0, void 0, function* () {
                ...
                const res = yield originalImpl.consumeCode(input);
...
const LinkClickedScreenWithOverride = index.withOverride(
...
const LinkClickedScreen$1 = (props) => {
    ...
    return jsxRuntime.jsx(
        ...
        Object.assign(
            ...
            { children: jsxRuntime.jsx(LinkClickedScreenWithOverride, Object.assign({}, props)) }
        )
    );
};
...
const LinkClickedScreen = (props) => {
    ...
    const consumeCodeAtMount = React.useCallback(
        () =>
            sessionAuth.__awaiter(void 0, void 0, void 0, function* () {
                const preAuthSessionId = sessionAuth.getQueryParams("preAuthSessionId");
                const linkCode = sessionAuth.getURLHash();
                if (preAuthSessionId === null || preAuthSessionId.length === 0 || linkCode.length === 0) {
                    yield sessionAuth.SuperTokens.getInstanceOrThrow().redirectToAuth({
                ...
                const loginAttemptInfo = yield props.recipe.recipeImpl.getLoginAttemptInfo({ userContext });
                if (
        ...
        (response) =>
            sessionAuth.__awaiter(void 0, void 0, void 0, function* () {
                ...
                if (response.status === "OK") {
                    ...
                    yield props.recipe.recipeImpl.clearLoginAttemptInfo({
                        userContext,
                    });
                    return sessionAuth.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                        {
    ...
    const childProps = {
        ...
        consumeCode: () =>
            sessionAuth.__awaiter(void 0, void 0, void 0, function* () {
                ...
                try {
                    const consumeResp = yield props.recipe.recipeImpl.consumeCode({
                        preAuthSessionId,
                        linkCode,
                        userContext,
                    });
                    yield handleConsumeResp(consumeResp);
                } catch (err) {
                    ...
                    Object.assign(
                        ...
                        },
                        {
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(LinkClickedScreen$1, Object.assign({}, childProps)),
                                    props.children &&
 ...
 * Class.
 */
class Passwordless extends authWidgetWrapper.AuthRecipe {
    constructor(config) {
        ...
        this.getFeatureComponent = (componentName, props) => {
            if (componentName === "signInUp") {
                if (props.redirectOnSessionExists !== false) {
                    ...
                    return jsxRuntime.jsx(
                        ...
                        Object.assign(
                            { userContext: props.userContext },
                            { children: jsxRuntime.jsx(SignInUpFeature, Object.assign({ recipe: this }, props)) }
                        )
                    );
                }
            }
            if (componentName === "linkClickedScreen") {
                return jsxRuntime.jsx(
                    ...
                    Object.assign(
                        { userContext: props.userContext },
                        { children: jsxRuntime.jsx(LinkClickedScreen, Object.assign({ recipe: this }, props)) }
                    )
                );
            } else {
