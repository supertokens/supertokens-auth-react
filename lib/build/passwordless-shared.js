...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (utils.__assign(utils.__assign({}, originalImp), { createCode: function (input) {
            ...
            return utils.__awaiter(this, void 0, void 0, function () {
                return utils.__generator(this, function (_a) {
                    return [2 /*return*/, originalImp.setLoginAttemptInfo(utils.__assign(utils.__assign({}, input), { attemptInfo: utils.__assign(utils.__assign({}, input.attemptInfo), input.userContext.additionalAttemptInfo) }))];
                });
            });
        } })); };
};
    ...
    Passwordless.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                Passwordless.instance = new Passwordless(utils.__assign(utils.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: Passwordless.RECIPE_ID }));
                return Passwordless.instance;
            },
            webJS: PasswordlessWebJS__default.default.init(utils.__assign(utils.__assign({}, normalisedConfig), { override: {
