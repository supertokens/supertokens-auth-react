...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config) {
        var _this = this;
        var normalizedConfig = utils.__assign(utils.__assign({}, config), utils.normaliseRecipeModuleConfig(config));
                ...
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            return [
                                2 /*return*/,
                                utils.SuperTokens.getInstanceOrThrow().redirectToUrl(invalidClaimRedirectPath, history),
                            ];
                        case 5:
        ...
        _this.webJsRecipe = new recipe.Recipe(
            utils.__assign(utils.__assign({}, normalizedConfig), {
