...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config, webJSRecipe) {
        ...
        _this.validateGlobalClaimsAndHandleSuccessRedirection = function (redirectInfo, userContext, navigate) {
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 13:
                            ...
                            if (authRecipeRedirectHandler !== undefined) {
                                ...
                                return [
                                    ...
                                    authRecipeRedirectHandler(
                                        redirectInfo.successRedirectContext,
                                        navigate,
                                        undefined,
                                        userContext
                                    ),
                            ...
                            return [
                                2 /*return*/,
                                this.redirect(redirectInfo.successRedirectContext, navigate, undefined, userContext),
                            ];
                    }
                });
            });
