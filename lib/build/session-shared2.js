...
var componentOverrideContext = require("./session-shared3.js");
...
var BooleanClaim = /** @class */ (function (_super) {
    thirdparty.__extends(BooleanClaim, _super);
    function BooleanClaim(config) {
        var _this = _super.call(this, config) || this;
        var validatorsWithCallbacks = thirdparty.__assign({}, _this.validators);
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return thirdparty.__assign(thirdparty.__assign({}, validator.apply(void 0, args)), {
...
var PrimitiveArrayClaim = /** @class */ (function (_super) {
    thirdparty.__extends(PrimitiveArrayClaim, _super);
...
var PrimitiveClaim = /** @class */ (function (_super) {
    thirdparty.__extends(PrimitiveClaim, _super);
...
var SessionAPIWrapper = /** @class */ (function () {
    ...
    SessionAPIWrapper.init = function (config) {
        return thirdparty.Session.init(config);
    };
    SessionAPIWrapper.getUserId = function (input) {
        return thirdparty.__awaiter(this, void 0, void 0, function () {
            return thirdparty.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    thirdparty.Session.getInstanceOrThrow().getUserId({
    ...
    SessionAPIWrapper.getAccessToken = function (input) {
        return thirdparty.__awaiter(this, void 0, void 0, function () {
            return thirdparty.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    thirdparty.Session.getInstanceOrThrow().getAccessToken({
                        userContext: thirdparty.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.getAccessTokenPayloadSecurely = function (input) {
        return thirdparty.__awaiter(this, void 0, void 0, function () {
            return thirdparty.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    thirdparty.Session.getInstanceOrThrow().getAccessTokenPayloadSecurely({
                        userContext: thirdparty.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.attemptRefreshingSession = function () {
        return thirdparty.__awaiter(this, void 0, void 0, function () {
            return thirdparty.__generator(this, function (_a) {
                return [2 /*return*/, thirdparty.Session.getInstanceOrThrow().attemptRefreshingSession()];
            });
        });
    };
    SessionAPIWrapper.doesSessionExist = function (input) {
        return thirdparty.__awaiter(this, void 0, void 0, function () {
            return thirdparty.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    thirdparty.Session.getInstanceOrThrow().doesSessionExist({
                        userContext: thirdparty.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.addAxiosInterceptors = function (axiosInstance, userContext) {
        return thirdparty.Session.addAxiosInterceptors(axiosInstance, thirdparty.getNormalisedUserContext(userContext));
    };
    SessionAPIWrapper.signOut = function (input) {
        return thirdparty.__awaiter(this, void 0, void 0, function () {
            return thirdparty.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    thirdparty.Session.getInstanceOrThrow().signOut({
                        userContext: thirdparty.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.validateClaims = function (input) {
        return thirdparty.Session.getInstanceOrThrow().validateClaims({
    ...
    SessionAPIWrapper.getInvalidClaimsFromResponse = function (input) {
        return thirdparty.Session.getInstanceOrThrow().getInvalidClaimsFromResponse(input);
    };
    SessionAPIWrapper.getClaimValue = function (input) {
        return thirdparty.Session.getInstanceOrThrow().getClaimValue({
            claim: input.claim,
            userContext: thirdparty.getNormalisedUserContext(
                input === null || input === void 0 ? void 0 : input.userContext
            ),
