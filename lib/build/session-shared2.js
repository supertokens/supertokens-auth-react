...
var BooleanClaim = /** @class */ (function (_super) {
    sessionAuth.__extends(BooleanClaim, _super);
    function BooleanClaim(config) {
        var _this = _super.call(this, config) || this;
        var validatorsWithCallbacks = sessionAuth.__assign({}, _this.validators);
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return sessionAuth.__assign(sessionAuth.__assign({}, validator.apply(void 0, args)), {
...
var PrimitiveArrayClaim = /** @class */ (function (_super) {
    sessionAuth.__extends(PrimitiveArrayClaim, _super);
...
var PrimitiveClaim = /** @class */ (function (_super) {
    sessionAuth.__extends(PrimitiveClaim, _super);
...
var SessionAPIWrapper = /** @class */ (function () {
    ...
    SessionAPIWrapper.ComponentsOverrideProvider = sessionAuth.Provider;
    SessionAPIWrapper.AccessDeniedTheme = sessionAuth.AccessDeniedTheme;
    SessionAPIWrapper.AccessDenied = function (prop) {
        if (prop === void 0) {
            prop = {};
        }
        return sessionAuth.Session.getInstanceOrThrow().getFeatureComponent("accessDenied", prop);
    };
