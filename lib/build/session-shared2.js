...
var BooleanClaim = /** @class */ (function (_super) {
    uiEntry.__extends(BooleanClaim, _super);
    function BooleanClaim(config) {
        var _this = _super.call(this, config) || this;
        var validatorsWithCallbacks = uiEntry.__assign({}, _this.validators);
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return uiEntry.__assign(uiEntry.__assign({}, validator.apply(void 0, args)), {
...
var PrimitiveArrayClaim = /** @class */ (function (_super) {
    uiEntry.__extends(PrimitiveArrayClaim, _super);
...
var PrimitiveClaim = /** @class */ (function (_super) {
    uiEntry.__extends(PrimitiveClaim, _super);
...
var SessionAPIWrapper = /** @class */ (function () {
    ...
    SessionAPIWrapper.init = function (config) {
        return uiEntry.Session.init(config);
    };
    SessionAPIWrapper.getUserId = function (input) {
        return uiEntry.__awaiter(this, void 0, void 0, function () {
            return uiEntry.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    uiEntry.Session.getInstanceOrThrow().getUserId({
    ...
    SessionAPIWrapper.getAccessToken = function (input) {
        return uiEntry.__awaiter(this, void 0, void 0, function () {
            return uiEntry.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    uiEntry.Session.getInstanceOrThrow().getAccessToken({
                        userContext: uiEntry.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.getAccessTokenPayloadSecurely = function (input) {
        return uiEntry.__awaiter(this, void 0, void 0, function () {
            return uiEntry.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    uiEntry.Session.getInstanceOrThrow().getAccessTokenPayloadSecurely({
                        userContext: uiEntry.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.attemptRefreshingSession = function () {
        return uiEntry.__awaiter(this, void 0, void 0, function () {
            return uiEntry.__generator(this, function (_a) {
                return [2 /*return*/, uiEntry.Session.getInstanceOrThrow().attemptRefreshingSession()];
            });
        });
    };
    SessionAPIWrapper.doesSessionExist = function (input) {
        return uiEntry.__awaiter(this, void 0, void 0, function () {
            return uiEntry.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    uiEntry.Session.getInstanceOrThrow().doesSessionExist({
                        userContext: uiEntry.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.addAxiosInterceptors = function (axiosInstance, userContext) {
        return uiEntry.Session.addAxiosInterceptors(axiosInstance, uiEntry.getNormalisedUserContext(userContext));
    };
    SessionAPIWrapper.signOut = function (input) {
        return uiEntry.__awaiter(this, void 0, void 0, function () {
            return uiEntry.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    uiEntry.Session.getInstanceOrThrow().signOut({
                        userContext: uiEntry.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.validateClaims = function (input) {
        return uiEntry.Session.getInstanceOrThrow().validateClaims({
    ...
    SessionAPIWrapper.getInvalidClaimsFromResponse = function (input) {
        return uiEntry.Session.getInstanceOrThrow().getInvalidClaimsFromResponse(input);
    };
    SessionAPIWrapper.getClaimValue = function (input) {
        return uiEntry.Session.getInstanceOrThrow().getClaimValue({
            claim: input.claim,
            userContext: uiEntry.getNormalisedUserContext(
                input === null || input === void 0 ? void 0 : input.userContext
            ),
    ...
    SessionAPIWrapper.ComponentsOverrideProvider = uiEntry.Provider;
    SessionAPIWrapper.AccessDeniedTheme = uiEntry.AccessDeniedTheme;
    SessionAPIWrapper.AccessDenied = function (prop) {
        if (prop === void 0) {
            prop = {};
        }
        return uiEntry.Session.getInstanceOrThrow().getFeatureComponent("accessDenied", prop);
    };
...
var AccessDenied = SessionAPIWrapper.AccessDenied;
