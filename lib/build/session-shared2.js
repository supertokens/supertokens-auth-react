...
var SessionAPIWrapper = /** @class */ (function () {
    ...
    SessionAPIWrapper.init = function (config) {
        return superTokens.Session.init(config);
    };
    SessionAPIWrapper.getUserId = function (input) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    superTokens.Session.getInstanceOrThrow().getUserId({
    ...
    SessionAPIWrapper.getAccessToken = function (input) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    superTokens.Session.getInstanceOrThrow().getAccessToken({
                        userContext: superTokens.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.getAccessTokenPayloadSecurely = function (input) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    superTokens.Session.getInstanceOrThrow().getAccessTokenPayloadSecurely({
                        userContext: superTokens.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.attemptRefreshingSession = function () {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_a) {
                return [2 /*return*/, superTokens.Session.getInstanceOrThrow().attemptRefreshingSession()];
            });
        });
    };
    SessionAPIWrapper.doesSessionExist = function (input) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    superTokens.Session.getInstanceOrThrow().doesSessionExist({
                        userContext: superTokens.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.addAxiosInterceptors = function (axiosInstance, userContext) {
        return superTokens.Session.addAxiosInterceptors(
            axiosInstance,
            superTokens.getNormalisedUserContext(userContext)
        );
    };
    SessionAPIWrapper.signOut = function (input) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    superTokens.Session.getInstanceOrThrow().signOut({
                        userContext: superTokens.getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.validateClaims = function (input) {
        return superTokens.Session.getInstanceOrThrow().validateClaims({
    ...
    SessionAPIWrapper.getInvalidClaimsFromResponse = function (input) {
        return superTokens.Session.getInstanceOrThrow().getInvalidClaimsFromResponse(input);
    };
    SessionAPIWrapper.getClaimValue = function (input) {
        return superTokens.Session.getInstanceOrThrow().getClaimValue({
            claim: input.claim,
            userContext: superTokens.getNormalisedUserContext(
                input === null || input === void 0 ? void 0 : input.userContext
            ),
