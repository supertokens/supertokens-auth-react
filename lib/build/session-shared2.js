...
var Session = /** @class */ (function (_super) {
                ...
                return superTokens.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            invalidClaimRedirectPath = superTokens.popInvalidClaimRedirectPathFromContext(userContext);
    ...
    Session.init = function (config) {
        var _this = this;
        var normalisedConfig = superTokens.normaliseRecipeModuleConfig(config);
        return {
