    ...
    function EmailVerificationClaimClass(getRecipeImpl, onFailureRedirection) {
        ...
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, validator.apply(void 0, args)), { onFailureRedirection: function (args) {
                        ...
                        if (recipe.config.mode === "REQUIRED") {
                            return recipe.getRedirectUrl({ action: "VERIFY_EMAIL", tenantIdFromQueryParams: genericComponentOverrideContext.getTenantIdFromQueryParams() }, args.userContext);
                        }
                        return undefined;
...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImp), { verifyEmail: function (input) {
...
function normaliseEmailVerificationFeature(config) {
    ...
    return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, genericComponentOverrideContext.normaliseRecipeModuleConfig(config)), { disableDefaultUI: disableDefaultUI, mode: mode, sendVerifyEmailScreen: sendVerifyEmailScreen, verifyEmailLinkClickedScreen: verifyEmailLinkClickedScreen, override: override });
}
...
var EmailVerification = /** @class */ (function (_super) {
    ...
    function EmailVerification(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = EmailVerificationWebJS__default.default; }
        ...
        _this.getDefaultRedirectionURL = function (context) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            return genericComponentOverrideContext.__generator(this, function (_a) {
                if (context.action === "VERIFY_EMAIL") {
                    return [2 /*return*/, genericComponentOverrideContext.getDefaultRedirectionURLForPath(this.config, DEFAULT_VERIFY_EMAIL_PATH, context)];
                }
                else {
                    return [2 /*return*/, "/"];
                }
    ...
    EmailVerification.init = function (config) {
        return {
            ...
            authReact: function (appInfo, _, overrideMaps) {
                var normalisedConfig = normaliseEmailVerificationFeature(genericComponentOverrideContext.applyPlugins(EmailVerification.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : []));
                EmailVerification.instance = new EmailVerification(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: EmailVerification.RECIPE_ID }));
            ...
            webJS: function () {
                ...
                var init = EmailVerificationWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
    ...
    EmailVerification.prototype.isEmailVerified = function (userContext) {
        return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.webJSRecipe.isEmailVerified({
    ...
    EmailVerification.EmailVerificationClaim = new EmailVerificationClaimClass(function () { return EmailVerification.getInstanceOrThrow().webJSRecipe; });
    return EmailVerification;
}(index.RecipeModule));

var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext(undefined, EmailVerification.RECIPE_ID), useContext = _a[0], Provider = _a[1];
