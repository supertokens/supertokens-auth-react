...
var EmailVerificationClaimClass = /** @class */ (function (_super) {
    thirdparty.__extends(EmailVerificationClaimClass, _super);
...
function normaliseEmailVerificationFeature(config) {
    ...
    return thirdparty.__assign(thirdparty.__assign({}, thirdparty.normaliseRecipeModuleConfig(config)), {
...
var EmailVerification = /** @class */ (function (_super) {
    thirdparty.__extends(EmailVerification, _super);
