    ...
    function EmailVerificationClaimClass(getRecipeImpl, onFailureRedirection) {
        ...
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return logger.__assign(logger.__assign({}, validator.apply(void 0, args)), { onFailureRedirection: function (args) {
...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (logger.__assign(logger.__assign({}, originalImp), { verifyEmail: function (input) {
...
function normaliseEmailVerificationFeature(config) {
    ...
    return logger.__assign(logger.__assign({}, genericComponentOverrideContext.normaliseRecipeModuleConfig(config)), { disableDefaultUI: disableDefaultUI, mode: mode, sendVerifyEmailScreen: sendVerifyEmailScreen, verifyEmailLinkClickedScreen: verifyEmailLinkClickedScreen, override: override });
}
...
var EmailVerification = /** @class */ (function (_super) {
    logger.__extends(EmailVerification, _super);
    ...
    EmailVerification.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                EmailVerification.instance = new EmailVerification(logger.__assign(logger.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: EmailVerification.RECIPE_ID }));
                return EmailVerification.instance;
            },
            webJS: EmailVerificationWebJS__default.default.init(logger.__assign(logger.__assign({}, normalisedConfig), { override: {
