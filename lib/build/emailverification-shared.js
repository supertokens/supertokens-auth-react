...
var EmailVerification = /** @class */ (function (_super) {
    ...
    EmailVerification.init = function (config) {
        ...
        return {
            ...
            webJS: EmailVerificationWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
