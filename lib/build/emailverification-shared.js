            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return logger.__assign(logger.__assign({}, validator.apply(void 0, args)), { onFailureRedirection: function (args) {
                        ...
                        if (recipe.config.mode === "REQUIRED") {
                            return recipe.getRedirectUrl({ action: "VERIFY_EMAIL", tenantIdFromQueryParams: superTokens.getTenantIdFromQueryParams() }, args.userContext);
                        }
                        return undefined;
...
function normaliseEmailVerificationFeature(config) {
    ...
    return logger.__assign(logger.__assign({}, superTokens.normaliseRecipeModuleConfig(config)), { disableDefaultUI: disableDefaultUI, mode: mode, sendVerifyEmailScreen: sendVerifyEmailScreen, verifyEmailLinkClickedScreen: verifyEmailLinkClickedScreen, override: override });
}
        ...
        _this.getDefaultRedirectionURL = function (context) { return logger.__awaiter(_this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                if (context.action === "VERIFY_EMAIL") {
                    return [2 /*return*/, superTokens.getDefaultRedirectionURLForPath(this.config, DEFAULT_VERIFY_EMAIL_PATH, context)];
                }
                else {
                    return [2 /*return*/, "/"];
                }
