    ...
    EmailVerification.init = function (config) {
        return {
            ...
            authReact: function (appInfo, _, overrideMaps) {
                var normalisedConfig = normaliseEmailVerificationFeature(
                    genericComponentOverrideContext.applyPlugins(
                        EmailVerification.RECIPE_ID,
                        config,
            ...
            webJS: function () {
                ...
                var init = EmailVerificationWebJS__default.default.init(
                    genericComponentOverrideContext.__assign(
                        genericComponentOverrideContext.__assign({}, normalisedConfig),
                        {
                            override: {
...
var _a = genericComponentOverrideContext.createGenericComponentsOverrideContext(undefined, EmailVerification.RECIPE_ID),
    useContext = _a[0],
    Provider = _a[1];
