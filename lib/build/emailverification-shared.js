...
var EmailVerificationClaimClass = /** @class */ (function (_super) {
    utils.__extends(EmailVerificationClaimClass, _super);
    function EmailVerificationClaimClass(getRecipeImpl, onFailureRedirection) {
        ...
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return utils.__assign(utils.__assign({}, validator.apply(void 0, args)), { onFailureRedirection: function (args) {
                        ...
                        if (recipe.config.mode === "REQUIRED") {
                            return recipe.getRedirectUrl({ action: "VERIFY_EMAIL", tenantIdFromQueryParams: utils.getTenantIdFromQueryParams() }, args.userContext);
                        }
                        return undefined;
...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (utils.__assign(utils.__assign({}, originalImp), { verifyEmail: function (input) {
...
function normaliseEmailVerificationFeature(config) {
    ...
    return utils.__assign(utils.__assign({}, superTokens.normaliseRecipeModuleConfig(config)), { disableDefaultUI: disableDefaultUI, mode: mode, sendVerifyEmailScreen: sendVerifyEmailScreen, verifyEmailLinkClickedScreen: verifyEmailLinkClickedScreen, override: override });
}
        ...
        _this.getDefaultRedirectionURL = function (context) { return utils.__awaiter(_this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                if (context.action === "VERIFY_EMAIL") {
                    return [2 /*return*/, utils.getDefaultRedirectionURLForPath(this.config, DEFAULT_VERIFY_EMAIL_PATH, context)];
                }
                else {
                    return [2 /*return*/, "/"];
                }
    ...
    EmailVerification.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                EmailVerification.instance = new EmailVerification(utils.__assign(utils.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: EmailVerification.RECIPE_ID }));
                return EmailVerification.instance;
            },
            webJS: EmailVerificationWebJS__default.default.init(utils.__assign(utils.__assign({}, normalisedConfig), { override: {
