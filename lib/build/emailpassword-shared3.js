    ...
    var defaultSignInFields = signUpForm.formFields.reduce(function (signInFieldsAccumulator, field) {
        ...
        if (field.id === "password") {
            return genericComponentOverrideContext.__spreadArray(genericComponentOverrideContext.__spreadArray([], signInFieldsAccumulator, true), [
                genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, field), { autoComplete: "current-password", validate: validators.defaultLoginPasswordValidator }),
            ], false);
        }
...
function mergeFormFields(defaultFormFields, userFormFields) {
    ...
    for (var i = 0; i < userFormFields.length; i++) {
        ...
        if (isNewField) {
            mergedFormFields.push(genericComponentOverrideContext.__assign({ optional: false, placeholder: userField.label, validate: validators.defaultValidate }, userField));
        }
    }
...
var EmailPassword = /** @class */ (function (_super) {
    ...
    EmailPassword.init = function (config) {
        ...
        return {
            ...
            webJS: EmailPasswordWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
