...
var emailpasswordPreBuiltUIRoutes = require("./emailpassword-shared5.js");
...
var Header = translations.withOverride("ThirdPartyEmailPasswordHeader", function ThirdPartyEmailPasswordHeader(_a) {
     ...
     */
    if (isSignUp === true) {
        return jsxRuntime.jsx(emailpasswordPreBuiltUIRoutes.SignUpHeader, {
            onClick: function () {
                return setIsSignUp(false);
            },
        });
    } else {
        return jsxRuntime.jsx(emailpasswordPreBuiltUIRoutes.SignInHeader, {
            onClick: function () {
                                ...
                                children: [
                                    ...
                                    props.epChildProps !== undefined &&
                                        (props.epState.isSignUp
                                            ? jsxRuntime.jsx(
                                                  emailpasswordPreBuiltUIRoutes.SignUpForm,
                                                  utils.__assign({}, props.epChildProps.signUpForm, {
                                                      footer: jsxRuntime.jsx(
                                                          emailpasswordPreBuiltUIRoutes.SignUpFooter,
                                                          {
                                                              privacyPolicyLink:
                                            ...
                                            : jsxRuntime.jsx(
                                                  emailpasswordPreBuiltUIRoutes.SignInForm,
                                                  utils.__assign({}, props.epChildProps.signInForm, {
                                                      footer: jsxRuntime.jsx(
                                                          emailpasswordPreBuiltUIRoutes.SignInFooter,
...
var defaultTranslationsThirdPartyEmailPassword = {
    en: utils.__assign(
        utils.__assign(
            ...
            emailpasswordPreBuiltUIRoutes.defaultTranslationsEmailPassword.en
        ),
...
var SignInAndUp = function (props) {
    var _a = thirdpartyPreBuiltUIRoutes.useFeatureReducer(),
        tpState = _a[0],
        tpDispatch = _a[1];
    var _b = emailpasswordPreBuiltUIRoutes.useFeatureReducer(props.recipe.emailPasswordRecipe),
        epState = _b[0],
        epDispatch = _b[1];
    ...
    var epChildProps = emailpasswordPreBuiltUIRoutes.useChildProps(
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(SignInAndUpThemeWrapper, utils.__assign({}, childProps)),
                                    props.children &&
...
var ThirdPartyEmailPasswordPreBuiltUIRoutes = /** @class */ (function (_super) {
    utils.__extends(ThirdPartyEmailPasswordPreBuiltUIRoutes, _super);
    function ThirdPartyEmailPasswordPreBuiltUIRoutes(recipeInstance) {
        var _this = _super.call(this) || this;
        _this.recipeInstance = recipeInstance;
        _this.getFeatures = function () {
            var features = {};
            if (_this.recipeInstance.emailPasswordRecipe !== undefined) {
                features = utils.__assign(
                    utils.__assign({}, features),
                    emailpasswordPreBuiltUIRoutes.EmailPasswordPreBuiltUIRoutes.getFeatures(
                        _this.recipeInstance.emailPasswordRecipe
                    )
                );
            }
        ...
        _this.getFeatureComponent = function (componentName, props) {
            if (componentName === "signinup") {
                ...
                return emailpasswordPreBuiltUIRoutes.EmailPasswordPreBuiltUIRoutes.getFeatureComponent(
                    componentName,
                    props
                );
    ...
    var _a;
    _a = ThirdPartyEmailPasswordPreBuiltUIRoutes;
    ThirdPartyEmailPasswordPreBuiltUIRoutes.ThirdPartySignInAndUpCallback = function (prop) {
        return _a.getFeatureComponent("signinupcallback", prop);
    };
    ThirdPartyEmailPasswordPreBuiltUIRoutes.ResetPasswordUsingToken = function (prop) {
        return _a.getFeatureComponent("resetpassword", prop);
    };
    ThirdPartyEmailPasswordPreBuiltUIRoutes.SignInAndUp = function (prop) {
        if (prop === void 0) {
            prop = {};
        }
        return _a.getFeatureComponent("signinup", prop);
    };
    ThirdPartyEmailPasswordPreBuiltUIRoutes.ThirdPartySignInAndUpCallbackTheme =
        thirdpartyPreBuiltUIRoutes.SignInAndUpCallbackTheme;
    ThirdPartyEmailPasswordPreBuiltUIRoutes.ResetPasswordUsingTokenTheme =
        emailpasswordPreBuiltUIRoutes.ResetPasswordUsingTokenThemeWrapper;
    ThirdPartyEmailPasswordPreBuiltUIRoutes.SignInAndUpTheme = SignInAndUpThemeWrapper;
    return ThirdPartyEmailPasswordPreBuiltUIRoutes;
})(sessionAuth.RecipeRoutes);

exports.ThirdPartyEmailPasswordPreBuiltUIRoutes = ThirdPartyEmailPasswordPreBuiltUIRoutes;
//# sourceMappingURL=thirdpartyemailpasswordPreBuiltUIRoutes.js.map
