    ...
    function ThirdPartyPasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "signInUp") {
                ...
                return thirdpartyPreBuiltUI.ThirdPartyPreBuiltUI.getFeatureComponent(componentName, props);
            } else {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.passwordlessRecipe !== undefined) {
                features = utils.__assign(
                    ...
                    passwordlessPreBuiltUI.PasswordlessPreBuiltUI.getFeatures(_this.recipeInstance.passwordlessRecipe)
                );
            }
            if (_this.recipeInstance.thirdPartyRecipe !== undefined) {
                features = utils.__assign(
                    utils.__assign({}, features),
                    thirdpartyPreBuiltUI.ThirdPartyPreBuiltUI.getFeatures(_this.recipeInstance.thirdPartyRecipe)
                );
            }
            if (
...
var getFeatures = ThirdPartyPasswordlessPreBuiltUI.getFeatures;
var getFeatureComponent = ThirdPartyPasswordlessPreBuiltUI.getFeatureComponent;
