...
var SignInUpTheme = function (props) {
    ...
    if (props.activeScreen === passwordlessPreBuiltUI.SignInUpScreens.CloseTab) {
        return jsxRuntime.jsx(passwordlessPreBuiltUI.CloseTabScreen, utils.__assign({}, props.pwlessChildProps));
                                ...
                                children:
                                    ...
                                    jsxRuntime.jsxs(React__namespace.Fragment, {
                                        children: [
                                            ...
                                            props.activeScreen === passwordlessPreBuiltUI.SignInUpScreens.EmailForm
                                                ? jsxRuntime.jsx(
...
var defaultTranslationsThirdPartyPasswordless = {
    en: utils.__assign(
        utils.__assign(
            utils.__assign({}, thirdpartyPreBuiltUI.defaultTranslationsThirdParty.en),
...
var ThirdPartyPasswordlessPreBuiltUI = /** @class */ (function (_super) {
    utils.__extends(ThirdPartyPasswordlessPreBuiltUI, _super);
    function ThirdPartyPasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "signInUp") {
                ...
                return passwordlessPreBuiltUI.PasswordlessPreBuiltUI.getFeatureComponent(componentName, props);
                ...
                return thirdpartyPreBuiltUI.ThirdPartyPreBuiltUI.getFeatureComponent(
                    componentName,
                    props,
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.passwordlessRecipe !== undefined) {
                features = utils.__assign(
                    ...
                    passwordlessPreBuiltUI.PasswordlessPreBuiltUI.getFeatures(
            ...
            if (_this.recipeInstance.thirdPartyRecipe !== undefined) {
                features = utils.__assign(
                    utils.__assign({}, features),
                    thirdpartyPreBuiltUI.ThirdPartyPreBuiltUI.getFeatures(
    ...
    ThirdPartyPasswordlessPreBuiltUI.canHandleRoute = function () {
        return ThirdPartyPasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance().canHandleRoute();
    };
    ThirdPartyPasswordlessPreBuiltUI.getRoutingComponent = function () {
        var instance = ThirdPartyPasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance();
        sessionAuth.RecipeRouter.addPrebuiltUI(instance);
        return instance.getRoutingComponent();
    };
    ThirdPartyPasswordlessPreBuiltUI.getFeatures = function () {
        return ThirdPartyPasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance().getFeatures();
    };
    ThirdPartyPasswordlessPreBuiltUI.getFeatureComponent = function (componentName, props) {
        return ThirdPartyPasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance().getFeatureComponent(
            componentName,
            props
        );
    };
    ThirdPartyPasswordlessPreBuiltUI.getReactRouterDomRoutes = function (reactRouterDom) {
...
var canHandleRoute = ThirdPartyPasswordlessPreBuiltUI.canHandleRoute;
var getRoutingComponent = ThirdPartyPasswordlessPreBuiltUI.getRoutingComponent;
var _getFeatures = ThirdPartyPasswordlessPreBuiltUI.getFeatures;
var _getFeatureComponent = ThirdPartyPasswordlessPreBuiltUI.getFeatureComponent;
var getReactRouterDomRoutes = ThirdPartyPasswordlessPreBuiltUI.getReactRouterDomRoutes;
...
//# sourceMappingURL=thirdpartypasswordlessPreBuiltUI.js.map
