...
function useChildProps$1(recipe, recipeImplementation, state, contactMethod, dispatch, userContext, navigate) {
    var _this = this;
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
                                ...
                                case 1:
                                    ...
                                    if (
                                        !invalidClaims.some(function (i) {
                                            return i.validatorId === emailverification.EmailVerificationClaim.id;
                                        })
                                    )
                                        return [3 /*break*/, 5];
                                    _b.label = 2;
...
function getActiveScreen(props, currentDynamicLoginMethods) {
    var enabledContactMethods = recipe.getEnabledContactMethods(props.config.contactMethod, currentDynamicLoginMethods);
                ...
                return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                    ...
                    return genericComponentOverrideContext.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                loginAttemptInfo = _a.sent();
                                enabledContactMethods = recipe.getEnabledContactMethods(
                                    contactMethod,
                                    dynamicLoginMethods
                                );
                                if (
...
function useChildProps(recipe, dispatch, state, userContext, navigate) {
    var _this = this;
    var session$1 = session.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(
        function () {
            return recipe && getModifiedRecipeImplementation(recipe.webJSRecipe, recipe.config, dispatch);
        },
        [recipe]
    );
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
