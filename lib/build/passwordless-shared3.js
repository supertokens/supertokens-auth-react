...
var CloseTabScreen = translations.withOverride("PasswordlessCloseTabScreen", PasswordlessCloseTabScreen);

var SignInUpFooter = translations.withOverride("PasswordlessSignInUpFooter", function PasswordlessSignInUpFooter(_a) {
...
var EmailForm = translations.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    var _this = this;
...
var intlTelInput = /*@__PURE__*/ genericComponentOverrideContext.getDefaultExportFromCjs(intlTelInputExports$1);
...
var phoneNumberInputWithInjectedProps = function (injectedProps) {
    return function (props) {
        return jsxRuntime.jsx(PhoneNumberInput, utils.__assign({}, injectedProps, props));
    };
};

var EmailOrPhoneForm = translations.withOverride(
    ...
    function PasswordlessEmailOrPhoneForm(props) {
        ...
        React.useEffect(function () {
            ...
            void recipe.preloadPhoneNumberUtils();
        }, []);
                    ...
                    return utils.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, recipe.defaultEmailValidator(emailOrPhone)];
                            case 1:
...
var ResendButton = translations.withOverride("PasswordlessResendButton", function PasswordlessResendButton(_a) {
...
var LinkSent = translations.withOverride("PasswordlessLinkSent", PasswordlessLinkSent);

var PhoneForm = translations.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    var _this = this;
    var userContext = sessionAuth.useUserContext();
    React.useEffect(function () {
        // We preload this here, since it will be used almost for sure, but loading it
...
var SignInUpHeader = translations.withOverride("PasswordlessSignInUpHeader", function PasswordlessSignInUpHeader() {
    var t = translationContext.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsx(
                "div",
                utils.__assign({ "data-supertokens": "headerTitle" }, { children: t("PWLESS_SIGN_IN_UP_HEADER_TITLE") })
            ),
            jsxRuntime.jsx("div", { "data-supertokens": "divider" }),
        ],
    });
...
var UserInputCodeFormFooter = translations.withOverride(
...
var UserInputCodeForm = translations.withOverride(
            ...
            children: [
                ...
                jsxRuntime.jsx(arrowLeftIcon.FormBase, {
                    ...
                    formFields: [
                        {
                            ...
                            clearOnSubmit: true,
                            placeholder: "",
                            validate: recipe.userInputCodeValidate,
                        },
                    ],
                    onSuccess: props.onSuccess,
                    buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON",
                    ...
                    footer: jsxRuntime.jsx(
                        ...
                        utils.__assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })
                    ),
                }),
            ],
        });
...
var UserInputCodeFormHeader = translations.withOverride(
...
var SignInUpTheme = function (_a) {
    var activeScreen = _a.activeScreen,
        ...
        props = utils.__rest(_a, ["activeScreen", "featureState"]);
    var commonProps = {
    ...
    return activeScreen === exports.SignInUpScreens.CloseTab
        ? jsxRuntime.jsx(CloseTabScreen, utils.__assign({}, commonProps))
        : activeScreen === exports.SignInUpScreens.LinkSent
        ? jsxRuntime.jsx(LinkSent, utils.__assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo }))
        : jsxRuntime.jsxs(
              "div",
              utils.__assign(
                  { "data-supertokens": "container" },
                                          ...
                                          jsxRuntime.jsxs(React__namespace.default.Fragment, {
                                              children: [
                                                  ...
                                                  activeScreen === exports.SignInUpScreens.EmailForm
                                                      ? jsxRuntime.jsx(EmailForm, utils.__assign({}, commonProps))
                                                      : activeScreen === exports.SignInUpScreens.PhoneForm
                                                      ? jsxRuntime.jsx(PhoneForm, utils.__assign({}, commonProps))
                ...
                children: jsxRuntime.jsx(
                    ...
                    utils.__assign(
                        { loadDefaultFont: !hasFont, userStyles: [props.config.rootStyle, activeStyle] },
                        {
                            children: jsxRuntime.jsx(
                                SignInUpTheme,
                                utils.__assign({}, props, { activeScreen: activeScreen })
                            ),
                        }
                    )
                ),
...
var defaultTranslationsPasswordless = {
    en: utils.__assign(utils.__assign({}, translations.defaultTranslationsCommon.en), {
...
var useFeatureReducer = function (recipeImpl, userContext) {
    var _a = React__namespace.useReducer(
            function (oldState, action) {
                switch (action.type) {
                    ...
                    case "resendCode":
                        ...
                        return utils.__assign(utils.__assign({}, oldState), {
                            error: undefined,
                            loginAttemptInfo: utils.__assign(utils.__assign({}, oldState.loginAttemptInfo), {
                    ...
                    case "successInAnotherTab":
                        return utils.__assign(utils.__assign({}, oldState), { successInAnotherTab: true });
                    default:
                        return oldState;
                }
            },
            ...
            function (initArg) {
                ...
                var messageQueryParam = utils.getQueryParams("message");
                    ...
                    return utils.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                messageQueryParam = utils.getQueryParams("message");
                                if (errorQueryParam !== null) {
                                    if (errorQueryParam === "signin") {
                                        error = "SOMETHING_WENT_WRONG_ERROR";
                                    } else if (errorQueryParam === "restart_link") {
...
function getModifiedRecipeImplementation(originalImpl, config, dispatch, callingConsumeCodeRef) {
    var _this = this;
    return utils.__assign(utils.__assign({}, originalImpl), {
        createCode: function (input) {
            return utils.__awaiter(_this, void 0, void 0, function () {
                ...
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, recipe.getPhoneNumberUtils()];
                        case 1:
                        ...
                        case 2:
                            ...
                            return [
                                ...
                                recipe.setLoginAttemptInfo({
                                    recipeImplementation: originalImpl,
                                    userContext: input.userContext,
                                    attemptInfo: utils.__assign(utils.__assign({}, loginAttemptInfo), {
...
var LinkClickedScreenWithOverride = translations.withOverride(
                ...
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                utils.SuperTokens.getInstanceOrThrow().redirectToAuth({
                    ...
                    utils.__assign(
                        ...
                        },
                        {
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(LinkClickedScreen$1, utils.__assign({}, childProps)),
                                    props.children &&
...
var PasswordlessPreBuiltUIRoutes = /** @class */ (function (_super) {
    utils.__extends(PasswordlessPreBuiltUIRoutes, _super);
    function PasswordlessPreBuiltUIRoutes(recipeInstance) {
    ...
    PasswordlessPreBuiltUIRoutes.init = function (recipeInstance) {
        PasswordlessPreBuiltUIRoutes.instance = new PasswordlessPreBuiltUIRoutes(recipeInstance);
    };
    PasswordlessPreBuiltUIRoutes.getInstanceOrInitAndGetInstance = function (recipeInstance) {
    ...
    PasswordlessPreBuiltUIRoutes.canHandleRoute = function () {
        return PasswordlessPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().canHandleRoute();
    };
    PasswordlessPreBuiltUIRoutes.getRoutingComponent = function () {
        return PasswordlessPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getRoutingComponent();
    };
    PasswordlessPreBuiltUIRoutes.getFeatures = function (recipeInstance) {
        return PasswordlessPreBuiltUIRoutes.getInstanceOrInitAndGetInstance(recipeInstance).getFeatures();
    };
    PasswordlessPreBuiltUIRoutes.getFeatureComponent = function (componentName, props) {
        return PasswordlessPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatureComponent(componentName, props);
    };
    PasswordlessPreBuiltUIRoutes.getRoutes = function (reactRouterDom) {
        return _super.getRoutes.call(
            this,
            reactRouterDom,
            PasswordlessPreBuiltUIRoutes.getInstanceOrInitAndGetInstance()
        );
    };
    var _a;
    _a = PasswordlessPreBuiltUIRoutes;
    PasswordlessPreBuiltUIRoutes.SignInUp = function (prop) {
        if (prop === void 0) {
            prop = {};
        }
        return _a.getFeatureComponent("signInUp", prop);
    };
    PasswordlessPreBuiltUIRoutes.LinkClicked = function (prop) {
        return _a.getFeatureComponent("linkClickedScreen", prop);
    };
    PasswordlessPreBuiltUIRoutes.SignInUpTheme = SignInUpThemeWrapper;
    return PasswordlessPreBuiltUIRoutes;
...
exports.PasswordlessPreBuiltUIRoutes = PasswordlessPreBuiltUIRoutes;
...
//# sourceMappingURL=passwordless-shared3.js.map
