...
function useChildProps$1(recipe$1, recipeImplementation, state, contactMethod, userContext, history) {
    var _this = this;
        ...
        function () {
            return {
                ...
                onFactorChooserButtonClicked: function () {
                    return recipe$2.MultiFactorAuth.getInstanceOrThrow().redirectToFactorChooser(false, history);
                },
        ...
        function () {
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    return [
                        2 /*return*/,
                        recipe$2.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.getMFAInfo({
                            userContext: userContext,
                        }),
                    ];
                });
