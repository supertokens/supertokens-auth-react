...
var useRedirectAfterSuccess = function (state, recipeId, userContext) {
...
var SignInUpFeature = function (props) {
    ...
    var _a = useFeatureReducer(props.recipe.webJSRecipe, userContext),
        state = _a[0],
        dispatch = _a[1];
    var callingConsumeCodeRef = useRedirectAfterSuccess(state, props.recipe.config.recipeId, userContext);
...
exports.useRedirectAfterSuccess = useRedirectAfterSuccess;
