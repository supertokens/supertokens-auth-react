                            ...
                            children: [
                                ...
                                jsxRuntime.jsxs(
                                    ...
                                    utils.__assign(
                                        ...
                                        {
                                            children: [
                                                jsxRuntime.jsx(formBase.ArrowLeftIcon, {
                                                    color: "rgb(var(--palette-textPrimary))",
                                                }),
                                                props.loginAttemptInfo.contactMethod === "EMAIL"
        ...
        return jsxRuntime.jsx(React.Fragment, {
            children: jsxRuntime.jsxs(
                ...
                utils.__assign(
                    ...
                    {
                        children: [
                            jsxRuntime.jsx(formBase.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }),
                            loginAttemptInfo.contactMethod === "EMAIL"
                                ? t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_EMAIL")
                                : t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_PHONE"),
                        ],
...
function useChildProps(recipe$1, dispatch, state, callingConsumeCodeRef, userContext, history) {
    var recipeImplementation = React__namespace.useMemo(
        function () {
            return (
                recipe$1 &&
                getModifiedRecipeImplementation(recipe$1.recipeImpl, recipe$1.config, dispatch, callingConsumeCodeRef)
            );
        },
        [recipe$1]
    );
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    ...
    PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance = function (recipeInstance) {
        if (PasswordlessPreBuiltUI.instance === undefined) {
            var instance =
                recipeInstance !== null && recipeInstance !== void 0
                    ? recipeInstance
                    : recipe$1.Passwordless.getInstanceOrThrow();
            PasswordlessPreBuiltUI.instance = new PasswordlessPreBuiltUI(instance);
        }
        return PasswordlessPreBuiltUI.instance;
    };
    PasswordlessPreBuiltUI.canHandleRoute = function () {
        return PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance().canHandleRoute();
    };
    PasswordlessPreBuiltUI.getRoutingComponent = function () {
        var instance = PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance();
        sessionAuth.RecipeRouter.addPrebuiltUI(instance);
        return instance.getRoutingComponent();
    };
    PasswordlessPreBuiltUI.getFeatures = function (recipeInstance, useComponentOverrides) {
        if (useComponentOverrides === void 0) {
            useComponentOverrides = componentOverrideContext.useContext;
        }
    ...
    PasswordlessPreBuiltUI.getFeatureComponent = function (componentName, props, recipeInstance) {
        return PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance(recipeInstance).getFeatureComponent(
            componentName,
            props
        );
    };
    PasswordlessPreBuiltUI.getReactRouterDomRoutes = function (reactRouterDom) {
        return sessionAuth.RecipeRouter.getRecipeRoutes(
            reactRouterDom,
            PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance()
        );
    };
...
var canHandleRoute = PasswordlessPreBuiltUI.canHandleRoute;
var getRoutingComponent = PasswordlessPreBuiltUI.getRoutingComponent;
var _getFeatures = PasswordlessPreBuiltUI.getFeatures;
var _getFeatureComponent = PasswordlessPreBuiltUI.getFeatureComponent;
var getReactRouterDomRoutes = PasswordlessPreBuiltUI.getReactRouterDomRoutes;
...
exports.getReactRouterDomRoutes = getReactRouterDomRoutes;
