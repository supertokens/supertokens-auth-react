...
var LinkClickedScreenWithOverride = recipe.withOverride("PasswordlessLinkClickedScreen", PasswordlessLinkClickedScreen);
var LinkClickedScreen$1 = function (props) {
    var hasFont = recipe.hasFontDefined(props.config.rootStyle);
    return jsxRuntime.jsx(
        ThemeBase,
        utils.__assign(
            {
...
var defaultTranslationsPasswordless = {
    en: utils.__assign(utils.__assign({}, recipe.defaultTranslationsCommon.en), {
...
var LinkClickedScreen = function (props) {
    var userContext = recipe.useUserContext();
    var _a = React.useState(false),
    ...
    return jsxRuntime.jsx(
        recipe.ComponentOverrideContext.Provider,
        utils.__assign(
            { value: recipeComponentOverrides },
            {
                children: jsxRuntime.jsx(
                    recipe.FeatureWrapper,
                    utils.__assign(
                        {
...
var CloseTabScreen = recipe.withOverride("PasswordlessCloseTabScreen", PasswordlessCloseTabScreen);

var SignInUpFooter = recipe.withOverride("PasswordlessSignInUpFooter", function PasswordlessSignInUpFooter(_a) {
...
var EmailForm = recipe.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    var _this = this;
    var userContext = recipe.useUserContext();
...
var EmailOrPhoneForm = recipe.withOverride(
...
var ResendButton = recipe.withOverride("PasswordlessResendButton", function PasswordlessResendButton(_a) {
                            ...
                            children: [
                                ...
                                jsxRuntime.jsxs(
                                    ...
                                    utils.__assign(
                                        ...
                                        {
                                            children: [
                                                jsxRuntime.jsx(recipe.ArrowLeftIcon, {
                                                    color: "rgb(var(--palette-textPrimary))",
                                                }),
                                                props.loginAttemptInfo.contactMethod === "EMAIL"
...
var LinkSent = recipe.withOverride("PasswordlessLinkSent", PasswordlessLinkSent);

var PhoneForm = recipe.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    var _this = this;
    var userContext = recipe.useUserContext();
    React.useEffect(function () {
        // We preload this here, since it will be used almost for sure, but loading it
...
var SignInUpHeader = recipe.withOverride("PasswordlessSignInUpHeader", function PasswordlessSignInUpHeader() {
    var t = recipe.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsx(
...
var UserInputCodeFormFooter = recipe.withOverride(
        ...
        return jsxRuntime.jsx(React.Fragment, {
            children: jsxRuntime.jsxs(
                ...
                utils.__assign(
                    ...
                    {
                        children: [
                            jsxRuntime.jsx(recipe.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }),
                            loginAttemptInfo.contactMethod === "EMAIL"
                                ? t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_EMAIL")
                                : t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_PHONE"),
                        ],
...
var UserInputCodeForm = recipe.withOverride(
...
var UserInputCodeFormHeader = recipe.withOverride(
