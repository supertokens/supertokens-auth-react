...
var LinkClickedScreen$1 = function (props) {
    ...
    return jsxRuntime.jsx(
        ...
        thirdparty.__assign(
            ...
            { children: jsxRuntime.jsx(LinkClickedScreenWithOverride, thirdparty.__assign({}, props)) }
        )
    );
};

var defaultTranslationsPasswordless = {
    en: thirdparty.__assign(thirdparty.__assign({}, translations.defaultTranslationsCommon.en), {
...
var LinkClickedScreen = function (props) {
        ...
        function () {
            return thirdparty.__awaiter(void 0, void 0, void 0, function () {
                ...
                return thirdparty.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            preAuthSessionId = thirdparty.getQueryParams("preAuthSessionId");
                            linkCode = thirdparty.getURLHash();
                ...
                return thirdparty.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [
                                2 /*return*/,
                                thirdparty.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                                    {
    ...
    var handleConsumeError = React.useCallback(
        function (err) {
            if (STGeneralError__default.default.isThisError(err)) {
                return thirdparty.SuperTokens.getInstanceOrThrow().redirectToAuth({
                    history: props.history,
                    queryParams: {
                        error: "custom",
                        message: err.message,
    ...
    thirdparty.useOnMountAPICall(consumeCodeAtMount, handleConsumeResp, handleConsumeError);
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(LinkClickedScreen$1, thirdparty.__assign({}, childProps)),
                                    props.children &&
    ...
    return jsxRuntime.jsx(formBase.FormBase, {
        ...
        callAPI: function (formFields) {
            return thirdparty.__awaiter(_this, void 0, void 0, function () {
                ...
                var _a;
                return thirdparty.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            email =
...
function PhoneNumberInput(_a) {
    ...
    React.useEffect(function () {
        if (inputRef.current !== null && inputRef.current.dataset["intl-tel-input-id"] === undefined) {
            ...
            var anyIti = iti;
            if (anyIti.isMobile) {
                var root = document.getElementById(thirdparty.ST_ROOT_ID);
...
var phoneNumberInputWithInjectedProps = function (injectedProps) {
    return function (props) {
        return jsxRuntime.jsx(PhoneNumberInput, thirdparty.__assign({}, injectedProps, props));
    };
};
            ...
            children: [
                ...
                jsxRuntime.jsx(formBase.FormBase, {
                    ...
                    footer: jsxRuntime.jsx(
                        ...
                        thirdparty.__assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })
                    ),
                }),
            ],
        });
...
var SignInUpTheme = function (_a) {
    var activeScreen = _a.activeScreen,
        ...
        props = thirdparty.__rest(_a, ["activeScreen", "featureState"]);
    var commonProps = {
    ...
    return activeScreen === exports.SignInUpScreens.CloseTab
        ? jsxRuntime.jsx(CloseTabScreen, thirdparty.__assign({}, commonProps))
        : activeScreen === exports.SignInUpScreens.LinkSent
        ? jsxRuntime.jsx(
              LinkSent,
              thirdparty.__assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo })
          )
        : jsxRuntime.jsxs(
              "div",
              thirdparty.__assign(
                                              ...
                                              children: [
                                                  activeScreen === exports.SignInUpScreens.UserInputCodeForm
                                                      ? jsxRuntime.jsx(
                                                            ...
                                                            thirdparty.__assign({}, commonProps, {
                                                  ...
                                                  activeScreen === exports.SignInUpScreens.EmailForm
                                                      ? jsxRuntime.jsx(EmailForm, thirdparty.__assign({}, commonProps))
                                                      : activeScreen === exports.SignInUpScreens.PhoneForm
                                                      ? jsxRuntime.jsx(PhoneForm, thirdparty.__assign({}, commonProps))
                ...
                children: jsxRuntime.jsx(
                    ...
                    thirdparty.__assign(
                        { loadDefaultFont: !hasFont, userStyles: [props.config.rootStyle, activeStyle] },
                        {
                            children: jsxRuntime.jsx(
                                SignInUpTheme,
                                thirdparty.__assign({}, props, { activeScreen: activeScreen })
                            ),
                        }
                    )
                ),
...
var useFeatureReducer = function (recipeImpl, userContext) {
    var _a = React__namespace.useReducer(
            function (oldState, action) {
                switch (action.type) {
                    ...
                    case "resendCode":
                        ...
                        return thirdparty.__assign(thirdparty.__assign({}, oldState), {
                            error: undefined,
                            loginAttemptInfo: thirdparty.__assign(thirdparty.__assign({}, oldState.loginAttemptInfo), {
                    ...
                    case "setError":
                        return thirdparty.__assign(thirdparty.__assign({}, oldState), { error: action.error });
                    case "startLogin":
                        return thirdparty.__assign(thirdparty.__assign({}, oldState), {
                            loginAttemptInfo: action.loginAttemptInfo,
                            error: undefined,
                    ...
                    case "successInAnotherTab":
                        return thirdparty.__assign(thirdparty.__assign({}, oldState), { successInAnotherTab: true });
                    default:
                        return oldState;
                }
            },
            ...
            function (initArg) {
                var error = undefined;
                var errorQueryParam = thirdparty.getQueryParams("error");
                var messageQueryParam = thirdparty.getQueryParams("message");
                ...
                return thirdparty.__assign(thirdparty.__assign({}, initArg), { error: error });
            }
        ),
        state = _a[0],
        dispatch = _a[1];
                ...
                return thirdparty.__awaiter(this, void 0, void 0, function () {
                    ...
                    return thirdparty.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                error = undefined;
                                errorQueryParam = thirdparty.getQueryParams("error");
                                messageQueryParam = thirdparty.getQueryParams("message");
                                if (errorQueryParam !== null) {
                                    if (errorQueryParam === "signin") {
                                        error = "SOMETHING_WENT_WRONG_ERROR";
                                    } else if (errorQueryParam === "restart_link") {
        ...
        function () {
            ...
            return {
                onSuccess: function (result) {
                    return thirdparty.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                        {
                                ...
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(
                                            ...
                                            thirdparty.__assign({}, childProps, {
                                                featureState: state,
                                                dispatch: dispatch,
                                            })
                                        ),
                                        ...
                                        React__namespace.Children.map(props.children, function (child) {
                                            if (React__namespace.isValidElement(child)) {
                                                return React__namespace.cloneElement(
                                                    child,
                                                    thirdparty.__assign(thirdparty.__assign({}, childProps), {
                                                        featureState: state,
                                                        dispatch: dispatch,
                                                    })
                                                );
...
function getModifiedRecipeImplementation(originalImpl, config, dispatch, callingConsumeCodeRef) {
    var _this = this;
    return thirdparty.__assign(thirdparty.__assign({}, originalImpl), {
                            ...
                            return [
                                ...
                                originalImpl.createCode(
                                    thirdparty.__assign(thirdparty.__assign({}, input), {
                                        userContext: thirdparty.__assign(thirdparty.__assign({}, input.userContext), {
                        ...
                        case 2:
                            ...
                            return [
                                ...
                                recipe.setLoginAttemptInfo({
                                    recipeImplementation: originalImpl,
                                    userContext: input.userContext,
                                    attemptInfo: thirdparty.__assign(thirdparty.__assign({}, loginAttemptInfo), {
            ...
            return thirdparty.__awaiter(_this, void 0, void 0, function () {
                return thirdparty.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            thirdparty.clearErrorQueryParam();
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    thirdparty.__extends(PasswordlessPreBuiltUI, _super);
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.signInUpFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: thirdparty.matchRecipeIdUsingQueryParams(_this.recipeInstance.config.recipeId),
                    component: function (props) {
                        return _this.getFeatureComponent("signInUp", props, useComponentOverrides);
                    },
                    recipeID: recipe.Passwordless.RECIPE_ID,
                };
            }
                ...
                return jsxRuntime.jsx(
                    ...
                    thirdparty.__assign(
                        { userContext: props.userContext },
                        {
                            children: jsxRuntime.jsx(
                                LinkClickedScreen,
                                thirdparty.__assign({ recipe: _this.recipeInstance }, props, {
                                    useComponentOverrides: useComponentOverrides,
                                })
                            ),
                        }
    ...
    PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (PasswordlessPreBuiltUI.instance === undefined) {
            var recipeInstance = recipe.Passwordless.getInstanceOrThrow();
