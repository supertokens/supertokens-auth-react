                    ...
                    { "data-supertokens": "headerTitle resetPasswordHeaderTitle" },
                    {
                        children: [
                            ...
                            ((_a = claim.value) === null || _a === void 0 ? void 0 : _a.n.length) === 0
                                ? jsxRuntime.jsx(formBase.BackButton, { onClick: props.onBackButtonClicked })
                                : jsxRuntime.jsx("span", {
                    ...
                    { "data-supertokens": "headerTitle resetPasswordHeaderTitle" },
                    {
                        children: [
                            ...
                            isSetupAllowed === false
                                ? jsxRuntime.jsx(formBase.BackButton, { onClick: onBackButtonClicked })
                                : jsxRuntime.jsx("span", {
                                      "data-supertokens": "backButtonPlaceholder backButtonCommon",
                                  }),
    ...
    React.useEffect(
        function () {
            if (state.loaded && state.isSetupAllowed === false && state.loginAttemptInfo === undefined) {
                void recipe$2.MultiFactorAuth.getInstanceOrThrow().redirectToFactorChooser();
            }
        },
...
function getActiveScreen(props, currentDynamicLoginMethods) {
    ...
    if (currentDynamicLoginMethods.loaded && currentDynamicLoginMethods.loginMethods.firstFactors) {
        ...
        firstFactors =
            (_a = recipe$2.MultiFactorAuth.getInstance()) === null || _a === void 0 ? void 0 : _a.getFirstFactors();
    }
