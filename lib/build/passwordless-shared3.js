...
function useChildProps$1(recipe$1, recipeImplementation, state, contactMethod, userContext, navigate) {
    var _this = this;
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
        ...
        function () {
            return {
                ...
                onFactorChooserButtonClicked: function () {
                    return recipe$2.MultiFactorAuth.getInstanceOrThrow().redirectToFactorChooser(
                        false,
                        undefined,
                        navigate,
                        userContext
        ...
        function () {
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    return [
                        2 /*return*/,
                        recipe$2.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.resyncSessionAndFetchMFAInfo({
                            userContext: userContext,
                        }),
                    ];
                });
...
function getActiveScreen(props, currentDynamicLoginMethods) {
    var enabledContactMethods = recipe$1.getEnabledContactMethods(
                ...
                return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                    ...
                    return genericComponentOverrideContext.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                loginAttemptInfo = _a.sent();
                                enabledContactMethods = recipe$1.getEnabledContactMethods(
                                    contactMethod,
                                    dynamicLoginMethods
                                );
                                if (
