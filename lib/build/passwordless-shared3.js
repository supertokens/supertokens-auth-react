...
var LinkClickedScreen = function (props) {
    ...
    var handleConsumeResp = React.useCallback(
        function (response) {
            return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
                var payloadAfterSuccess, loginAttemptInfo;
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                                    ...
                                    .validateGlobalClaimsAndHandleSuccessRedirection(
                                        {
                                            ...
                                            newSessionCreated:
                                                ...
                                                session$1.accessTokenPayload.sessionHandle !==
                                                    payloadAfterSuccess.sessionHandle,
            ...
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            showBackButton =
                                recipe$2.getAvailableFactors(
                                    mfaInfo.factors,
                                    undefined,
                                    recipe$2.MultiFactorAuth.getInstanceOrThrow(),
                                    userContext
                                ).length !== 1;
                            contactInfoList =
                                (props.contactMethod === "EMAIL"
                            ...
                            return [
                                ...
                                recipeImplementation.createCode(
                                    genericComponentOverrideContext.__assign(
                                        ...
                                        { factorIds: [factorId], userContext: userContext }
                                    )
                                ),
                            ];
                        case 5:
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            factorId = "email" in input ? "otp-email" : "otp-phone";
                            return [
                                4 /*yield*/,
