...
var PasswordlessLinkClickedScreen = function (props) {
    var t = superTokens.useTranslation();
...
var defaultTranslationsPasswordless = {
    en: superTokens.__assign(superTokens.__assign({}, translations.defaultTranslationsCommon.en), {
                ...
                return superTokens.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [
                                2 /*return*/,
                                superTokens.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                                    {
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(LinkClickedScreen$1, superTokens.__assign({}, childProps)),
                                    props.children &&
...
var phoneNumberInputWithInjectedProps = function (injectedProps) {
    return function (props) {
        return jsxRuntime.jsx(PhoneNumberInput, superTokens.__assign({}, injectedProps, props));
    };
};
            ...
            children: [
                ...
                jsxRuntime.jsx(formBase.FormBase, {
                    ...
                    footer: jsxRuntime.jsx(
                        ...
                        superTokens.__assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })
                    ),
                }),
            ],
        });
...
var SignInUpTheme = function (_a) {
    var activeScreen = _a.activeScreen,
        ...
        props = superTokens.__rest(_a, ["activeScreen", "featureState"]);
    var commonProps = {
    ...
    return activeScreen === exports.SignInUpScreens.CloseTab
        ? jsxRuntime.jsx(CloseTabScreen, superTokens.__assign({}, commonProps))
        : activeScreen === exports.SignInUpScreens.LinkSent
        ? jsxRuntime.jsx(
              LinkSent,
              superTokens.__assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo })
          )
        : jsxRuntime.jsxs(
              "div",
              superTokens.__assign(
                                              ...
                                              children: [
                                                  activeScreen === exports.SignInUpScreens.UserInputCodeForm
                                                      ? jsxRuntime.jsx(
                                                            ...
                                                            superTokens.__assign({}, commonProps, {
                                                  ...
                                                  activeScreen === exports.SignInUpScreens.EmailForm
                                                      ? jsxRuntime.jsx(EmailForm, superTokens.__assign({}, commonProps))
                                                      : activeScreen === exports.SignInUpScreens.PhoneForm
                                                      ? jsxRuntime.jsx(PhoneForm, superTokens.__assign({}, commonProps))
                ...
                children: jsxRuntime.jsx(
                    ...
                    superTokens.__assign(
                        { loadDefaultFont: !hasFont, userStyles: [props.config.rootStyle, activeStyle] },
                        {
                            children: jsxRuntime.jsx(
                                SignInUpTheme,
                                superTokens.__assign({}, props, { activeScreen: activeScreen })
                            ),
                        }
                    )
                ),
...
var useFeatureReducer = function (recipeImpl, userContext) {
    var _a = React__namespace.useReducer(
            function (oldState, action) {
                switch (action.type) {
                    ...
                    case "resendCode":
                        ...
                        return superTokens.__assign(superTokens.__assign({}, oldState), {
                            error: undefined,
                            loginAttemptInfo: superTokens.__assign(
                                superTokens.__assign({}, oldState.loginAttemptInfo),
                    ...
                    case "setError":
                        return superTokens.__assign(superTokens.__assign({}, oldState), { error: action.error });
                    case "startLogin":
                        return superTokens.__assign(superTokens.__assign({}, oldState), {
                            loginAttemptInfo: action.loginAttemptInfo,
                            error: undefined,
                    ...
                    case "successInAnotherTab":
                        return superTokens.__assign(superTokens.__assign({}, oldState), { successInAnotherTab: true });
                    default:
                        return oldState;
                }
            },
            ...
            function (initArg) {
                ...
                var messageQueryParam = superTokens.getQueryParams("message");
                ...
                return superTokens.__assign(superTokens.__assign({}, initArg), { error: error });
            }
        ),
        state = _a[0],
        dispatch = _a[1];
                    ...
                    return superTokens.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                messageQueryParam = superTokens.getQueryParams("message");
                                if (errorQueryParam !== null) {
                                    if (errorQueryParam === "signin") {
                                        error = "SOMETHING_WENT_WRONG_ERROR";
                                    } else if (errorQueryParam === "restart_link") {
        ...
        function () {
            ...
            return {
                onSuccess: function (result) {
                    return superTokens.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                        {
                                ...
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(
                                            ...
                                            superTokens.__assign({}, childProps, {
                                                featureState: state,
                                                dispatch: dispatch,
                                            })
                                        ),
                                        ...
                                        React__namespace.Children.map(props.children, function (child) {
                                            if (React__namespace.isValidElement(child)) {
                                                return React__namespace.cloneElement(
                                                    child,
                                                    superTokens.__assign(superTokens.__assign({}, childProps), {
                                                        featureState: state,
                                                        dispatch: dispatch,
                                                    })
                                                );
...
function getModifiedRecipeImplementation(originalImpl, config, dispatch, callingConsumeCodeRef) {
    var _this = this;
    return superTokens.__assign(superTokens.__assign({}, originalImpl), {
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    superTokens.__extends(PasswordlessPreBuiltUI, _super);
                ...
                return jsxRuntime.jsx(
                    ...
                    superTokens.__assign(
                        { userContext: props.userContext },
                        {
                            children: jsxRuntime.jsx(
                                LinkClickedScreen,
                                superTokens.__assign({ recipe: _this.recipeInstance }, props, {
                                    useComponentOverrides: useComponentOverrides,
                                })
                            ),
                        }
