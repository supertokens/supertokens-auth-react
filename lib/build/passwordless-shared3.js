...
var useRedirectAfterSuccess = function (state, recipeId, userContext, history) {
                                                    ...
                                                    redirectToPath:
                                                        (_b =
                                                            (_a = state.loginAttemptInfo) === null || _a === void 0
                                                                ? void 0
                                                                : _a.redirectToPath) !== null && _b !== void 0
                                                            ? _b
...
var SignInUpFeature = function (props) {
    ...
    var _a = useFeatureReducer(props.recipe.webJSRecipe, userContext),
        state = _a[0],
        dispatch = _a[1];
    var callingConsumeCodeRef = useRedirectAfterSuccess(
        state,
