...
var LinkClickedScreen$1 = function (props) {
    var hasFont = uiEntry.hasFontDefined(props.config.rootStyle);
    return jsxRuntime.jsx(
        ThemeBase,
        uiEntry.__assign(
            {
            ...
            { children: jsxRuntime.jsx(LinkClickedScreenWithOverride, uiEntry.__assign({}, props)) }
        )
    );
};

var defaultTranslationsPasswordless = {
    en: uiEntry.__assign(uiEntry.__assign({}, uiEntry.defaultTranslationsCommon.en), {
...
var LinkClickedScreen = function (props) {
        ...
        function () {
            return uiEntry.__awaiter(void 0, void 0, void 0, function () {
                ...
                return uiEntry.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            preAuthSessionId = uiEntry.getQueryParams("preAuthSessionId");
                            linkCode = uiEntry.getURLHash();
                ...
                return uiEntry.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [
                                2 /*return*/,
                                uiEntry.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                                    {
    ...
    var handleConsumeError = React.useCallback(
        function (err) {
            if (STGeneralError__default.default.isThisError(err)) {
                return uiEntry.SuperTokens.getInstanceOrThrow().redirectToAuth({
                    history: props.history,
                    queryParams: {
                        error: "custom",
                        message: err.message,
    ...
    uiEntry.useOnMountAPICall(consumeCodeAtMount, handleConsumeResp, handleConsumeError);
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(LinkClickedScreen$1, uiEntry.__assign({}, childProps)),
                                    props.children &&
...
var EmailForm = uiEntry.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    ...
    return jsxRuntime.jsx(formBase.FormBase, {
        ...
        callAPI: function (formFields) {
            return uiEntry.__awaiter(_this, void 0, void 0, function () {
                var email, validationRes, response;
                var _a;
                return uiEntry.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            email =
...
function PhoneNumberInput(_a) {
    ...
    React.useEffect(function () {
        if (inputRef.current !== null && inputRef.current.dataset["intl-tel-input-id"] === undefined) {
            ...
            var anyIti = iti;
            if (anyIti.isMobile) {
                var root = document.getElementById(uiEntry.ST_ROOT_ID);
...
var phoneNumberInputWithInjectedProps = function (injectedProps) {
    return function (props) {
        return jsxRuntime.jsx(PhoneNumberInput, uiEntry.__assign({}, injectedProps, props));
    };
};
                            ...
                            children: [
                                ...
                                jsxRuntime.jsxs(
                                    ...
                                    uiEntry.__assign(
                                        ...
                                        {
                                            children: [
                                                jsxRuntime.jsx(uiEntry.ArrowLeftIcon, {
                                                    color: "rgb(var(--palette-textPrimary))",
                                                }),
                                                props.loginAttemptInfo.contactMethod === "EMAIL"
        ...
        return jsxRuntime.jsx(React.Fragment, {
            children: jsxRuntime.jsxs(
                ...
                uiEntry.__assign(
                    ...
                    {
                        children: [
                            jsxRuntime.jsx(uiEntry.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }),
                            loginAttemptInfo.contactMethod === "EMAIL"
                                ? t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_EMAIL")
                                : t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_PHONE"),
                        ],
            ...
            children: [
                ...
                jsxRuntime.jsx(formBase.FormBase, {
                    ...
                    footer: jsxRuntime.jsx(
                        ...
                        uiEntry.__assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })
                    ),
                }),
            ],
        });
...
var SignInUpTheme = function (_a) {
    var activeScreen = _a.activeScreen,
        ...
        props = uiEntry.__rest(_a, ["activeScreen", "featureState"]);
    var commonProps = {
    ...
    return activeScreen === exports.SignInUpScreens.CloseTab
        ? jsxRuntime.jsx(CloseTabScreen, uiEntry.__assign({}, commonProps))
        : activeScreen === exports.SignInUpScreens.LinkSent
        ? jsxRuntime.jsx(
              LinkSent,
              uiEntry.__assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo })
          )
        : jsxRuntime.jsxs(
              "div",
              uiEntry.__assign(
                                          ...
                                          jsxRuntime.jsxs(React__namespace.default.Fragment, {
                                              children: [
                                                  ...
                                                  activeScreen === exports.SignInUpScreens.EmailForm
                                                      ? jsxRuntime.jsx(EmailForm, uiEntry.__assign({}, commonProps))
                                                      : activeScreen === exports.SignInUpScreens.PhoneForm
                                                      ? jsxRuntime.jsx(PhoneForm, uiEntry.__assign({}, commonProps))
                ...
                children: jsxRuntime.jsx(
                    ...
                    uiEntry.__assign(
                        { loadDefaultFont: !hasFont, userStyles: [props.config.rootStyle, activeStyle] },
                        {
                            children: jsxRuntime.jsx(
                                SignInUpTheme,
                                uiEntry.__assign({}, props, { activeScreen: activeScreen })
                            ),
                        }
                    )
                ),
...
var useFeatureReducer = function (recipeImpl, userContext) {
    var _a = React__namespace.useReducer(
            function (oldState, action) {
                switch (action.type) {
                    ...
                    case "resendCode":
                        ...
                        return uiEntry.__assign(uiEntry.__assign({}, oldState), {
                            error: undefined,
                            loginAttemptInfo: uiEntry.__assign(uiEntry.__assign({}, oldState.loginAttemptInfo), {
                    ...
                    case "setError":
                        return uiEntry.__assign(uiEntry.__assign({}, oldState), { error: action.error });
                    case "startLogin":
                        return uiEntry.__assign(uiEntry.__assign({}, oldState), {
                            loginAttemptInfo: action.loginAttemptInfo,
                            error: undefined,
                    ...
                    case "successInAnotherTab":
                        return uiEntry.__assign(uiEntry.__assign({}, oldState), { successInAnotherTab: true });
                    default:
                        return oldState;
                }
            },
            ...
            function (initArg) {
                var error = undefined;
                var errorQueryParam = uiEntry.getQueryParams("error");
                var messageQueryParam = uiEntry.getQueryParams("message");
                ...
                return uiEntry.__assign(uiEntry.__assign({}, initArg), { error: error });
            }
        ),
        state = _a[0],
        dispatch = _a[1];
                ...
                return uiEntry.__awaiter(this, void 0, void 0, function () {
                    ...
                    return uiEntry.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                error = undefined;
                                errorQueryParam = uiEntry.getQueryParams("error");
                                messageQueryParam = uiEntry.getQueryParams("message");
                                if (errorQueryParam !== null) {
                                    if (errorQueryParam === "signin") {
                                        error = "SOMETHING_WENT_WRONG_ERROR";
                                    } else if (errorQueryParam === "restart_link") {
        ...
        function () {
            ...
            return {
                onSuccess: function (result) {
                    return uiEntry.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                        {
                            rid: recipe.config.recipeId,
                            successRedirectContext: {
                                action: "SUCCESS",
                                isNewUser: result.createdNewUser,
                                redirectToPath: uiEntry.getRedirectToPathFromURL(),
                            },
                        },
                        userContext,
                        history
                                        ...
                                        React__namespace.Children.map(props.children, function (child) {
                                            if (React__namespace.isValidElement(child)) {
                                                return React__namespace.cloneElement(
                                                    child,
                                                    uiEntry.__assign(uiEntry.__assign({}, childProps), {
                                                        featureState: state,
                                                        dispatch: dispatch,
                                                    })
                                                );
...
function getModifiedRecipeImplementation(originalImpl, config, dispatch, callingConsumeCodeRef) {
    var _this = this;
    return uiEntry.__assign(uiEntry.__assign({}, originalImpl), {
                            ...
                            return [
                                ...
                                originalImpl.createCode(
                                    uiEntry.__assign(uiEntry.__assign({}, input), {
                                        userContext: uiEntry.__assign(uiEntry.__assign({}, input.userContext), {
                        ...
                        case 2:
                            ...
                            return [
                                ...
                                recipe.setLoginAttemptInfo({
                                    recipeImplementation: originalImpl,
                                    userContext: input.userContext,
                                    attemptInfo: uiEntry.__assign(uiEntry.__assign({}, loginAttemptInfo), {
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    uiEntry.__extends(PasswordlessPreBuiltUI, _super);
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.signInUpFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: uiEntry.matchRecipeIdUsingQueryParams(_this.recipeInstance.config.recipeId),
                ...
                return jsxRuntime.jsx(
                    ...
                    uiEntry.__assign(
                        { userContext: props.userContext },
                        {
                            children: jsxRuntime.jsx(
                                LinkClickedScreen,
                                uiEntry.__assign({ recipe: _this.recipeInstance }, props, {
                                    useComponentOverrides: useComponentOverrides,
                                })
                            ),
                        }
