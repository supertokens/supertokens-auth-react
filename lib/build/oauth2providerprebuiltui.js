...
var OAuth2LogoutScreenInner = sessionprebuiltui.withOverride(
    "OAuth2LogoutScreenInner",
    function OAuth2LogoutScreenInner(props) {
...
var OAuth2LogoutScreen$1 = function (props) {
    if (props.showSpinner) {
        return jsxRuntime.jsx(sessionprebuiltui.DynamicLoginMethodsSpinner, {});
    }
...
var OAuth2LogoutScreen = function (props) {
    ...
    var sessionContext = React__namespace.useContext(sessionprebuiltui.SessionContext);
    ...
    var navigate =
        (_b = props.navigate) !== null && _b !== void 0
            ? _b
            : (_c = sessionprebuiltui.UI.getReactRouterDomWithCustomHistory()) === null || _c === void 0
            ? void 0
            : _c.useHistoryCustom();
        ...
        genericComponentOverrideContext.__assign(
            ...
            },
            {
                children: jsxRuntime.jsxs(React.Fragment, {
                    children: [
                        props.children === undefined &&
                            jsxRuntime.jsx(sessionprebuiltui.DynamicLoginMethodsSpinner, {}),
                        props.children &&
                            React__namespace.Children.map(props.children, function (child) {
                                if (React__namespace.isValidElement(child)) {
                                    return React__namespace.cloneElement(child, childProps);
