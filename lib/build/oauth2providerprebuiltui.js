...
var defaultTranslationsOAuth2Provider = {
    en: utils.__assign(utils.__assign({}, superTokens.defaultTranslationsCommon.en), { LOGGING_OUT: "Logging Out", LOGOUT_CONFIRMATION: "Are you sure you want to log out?", LOGOUT: "LOG OUT" }),
};
...
var OAuth2LogoutScreen = function (props) {
    ...
    var logoutChallenge = (_a = utils.getQueryParams("logoutChallenge")) !== null && _a !== void 0 ? _a : undefined;
    ...
    var onLogout = React__namespace.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsOAuth2Provider }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(OAuth2LogoutScreenTheme, utils.__assign({}, childProps)), props.children &&
...
var TryRefreshPage$1 = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsOAuth2Provider }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(uiEntry.DynamicLoginMethodsSpinner, {}), props.children &&
                    React__namespace.Children.map(props.children, function (child) {
                        if (React__namespace.isValidElement(child)) {
                            return React__namespace.cloneElement(child, childProps);
                        }
...
var OAuth2ProviderPreBuiltUI = /** @class */ (function (_super) {
    utils.__extends(OAuth2ProviderPreBuiltUI, _super);
    function OAuth2ProviderPreBuiltUI(recipeInstance) {
        ...
        componentName, props, useComponentOverrides) {
            ...
            if (componentName === "try-refresh-page") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, utils.__assign({ requireAuth: false, overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(TryRefreshPage$1, utils.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides }, props)) })) })));
            }
            else if (componentName === "oauth2-logout-screen") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, utils.__assign({ requireAuth: false, overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(OAuth2LogoutScreen, utils.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides }, props)) })) })));
            }
