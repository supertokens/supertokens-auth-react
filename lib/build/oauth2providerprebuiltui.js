...
var OAuth2LogoutScreen = function (props) {
    ...
    var logoutChallenge = (_a = superTokens.getQueryParams("logoutChallenge")) !== null && _a !== void 0 ? _a : undefined;
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsOAuth2Provider }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(OAuth2LogoutScreenTheme, logger.__assign({}, childProps)), props.children &&
...
var TryRefreshPage$1 = function (props) {
    ...
    var loginChallenge = (_a = superTokens.getQueryParams("loginChallenge")) !== null && _a !== void 0 ? _a : undefined;
    var userContext = uiEntry.useUserContext();
    if (props.userContext !== undefined) {
        userContext = props.userContext;
    }
    ...
    return (jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsOAuth2Provider }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(uiEntry.DynamicLoginMethodsSpinner, {}), props.children &&
                    React__namespace.Children.map(props.children, function (child) {
                        if (React__namespace.isValidElement(child)) {
                            return React__namespace.cloneElement(child, childProps);
                        }
