...
var TryRefreshPage$1 = function (props) {
    ...
    var loginChallenge =
        (_a = genericComponentOverrideContext.getQueryParams("loginChallenge")) !== null && _a !== void 0
            ...
            : undefined;
    var forceRefresh =
        (_b = genericComponentOverrideContext.getQueryParams("forceRefresh")) !== null && _b !== void 0
            ? _b
            : undefined;
    var userContext = uiEntry.useUserContext();
    if (props.userContext !== undefined) {
                    ...
                    return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    document.cookie =
                                        "st-last-access-token-update=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT";
                                    if (!forceRefresh) return [3 /*break*/, 2];
                                    return [4 /*yield*/, session.attemptRefreshingSession()];
                                case 1:
                                    _a.sent();
                                    _a.label = 2;
                                case 2:
                                    if (!loginChallenge) return [3 /*break*/, 4];
                                    return [
                                        4 /*yield*/,
