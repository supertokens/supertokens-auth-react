...
var defaultTranslationsOAuth2Provider = {
    en: logger.__assign(logger.__assign({}, uiEntry.defaultTranslationsCommon.en), { LOGGING_OUT: "Logging Out", LOGOUT_CONFIRMATION: "Are you sure you want to log out?", LOGOUT: "LOG OUT" }),
};
...
var OAuth2LogoutScreen = function (props) {
    ...
    var onLogout = React__namespace.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsOAuth2Provider }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(OAuth2LogoutScreenTheme, logger.__assign({}, childProps)), props.children &&
...
var TryRefreshPage$1 = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsOAuth2Provider }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(uiEntry.DynamicLoginMethodsSpinner, {}), props.children &&
                    React__namespace.Children.map(props.children, function (child) {
                        if (React__namespace.isValidElement(child)) {
                            return React__namespace.cloneElement(child, childProps);
                        }
...
var OAuth2ProviderPreBuiltUI = /** @class */ (function (_super) {
    logger.__extends(OAuth2ProviderPreBuiltUI, _super);
    function OAuth2ProviderPreBuiltUI(recipeInstance) {
        ...
        componentName, props, useComponentOverrides) {
            ...
            if (componentName === "try-refresh-page") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, logger.__assign({ requireAuth: false, overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(TryRefreshPage$1, logger.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides }, props)) })) })));
            }
            else if (componentName === "oauth2-logout-screen") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, logger.__assign({ requireAuth: false, overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(OAuth2LogoutScreen, logger.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides }, props)) })) })));
            }
