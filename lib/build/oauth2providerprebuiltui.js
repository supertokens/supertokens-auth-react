...
var OAuth2LogoutScreenTheme = function (props) {
    ...
    return (jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.oauth2LogoutScreen.style] }, { children: jsxRuntime.jsx(OAuth2LogoutScreen$1, genericComponentOverrideContext.__assign({}, props)) })));
};

var defaultTranslationsOAuth2Provider = {
    en: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, genericComponentOverrideContext.defaultTranslationsCommon.en), { LOGGING_OUT: "Logging Out", LOGOUT_CONFIRMATION: "Are you sure you want to log out?", LOGOUT: "LOG OUT" }),
};
...
var OAuth2LogoutScreen = function (props) {
    ...
    var _d = React__namespace.useState(false), isLoggingOut = _d[0], setIsLoggingOut = _d[1];
    var recipeComponentOverrides = props.useComponentOverrides();
    var userContext = uiEntry.useUserContext();
    if (props.userContext !== undefined) {
        userContext = props.userContext;
    }
    var logoutChallenge = (_a = genericComponentOverrideContext.getQueryParams("logoutChallenge")) !== null && _a !== void 0 ? _a : undefined;
    var navigate = (_b = props.navigate) !== null && _b !== void 0 ? _b : (_c = uiEntry.UI.getReactRouterDomWithCustomHistory()) === null || _c === void 0 ? void 0 : _c.useHistoryCustom();
    var onLogout = React__namespace.useCallback(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        ...
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 6]);
                    return [4 /*yield*/, recipe.OAuth2Provider.getInstanceOrThrow().webJSRecipe.logOut({
                            logoutChallenge: logoutChallenge,
                            userContext: userContext,
                        })];
                case 2:
                    frontendRedirectTo = (_a.sent()).frontendRedirectTo;
                    return [4 /*yield*/, props.recipe.redirect({
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, genericComponentOverrideContext.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, genericComponentOverrideContext.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsOAuth2Provider }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(OAuth2LogoutScreenTheme, genericComponentOverrideContext.__assign({}, childProps)), props.children &&
...
var TryRefreshPage$1 = function (props) {
            ...
            if (loginChallenge) {
                (function () {
                    return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, props.recipe.webJSRecipe.getRedirectURLToContinueOAuthFlow({
                                        loginChallenge: loginChallenge,
                                        userContext: userContext,
                                    })];
                                case 1:
                                    frontendRedirectTo = (_a.sent()).frontendRedirectTo;
                                    return [2 /*return*/, props.recipe.redirect({
    ...
    return (jsxRuntime.jsx(uiEntry.FeatureWrapper, genericComponentOverrideContext.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsOAuth2Provider }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(uiEntry.DynamicLoginMethodsSpinner, {}), props.children &&
                    React__namespace.Children.map(props.children, function (child) {
                        if (React__namespace.isValidElement(child)) {
                            return React__namespace.cloneElement(child, childProps);
                        }
...
var OAuth2ProviderPreBuiltUI = /** @class */ (function (_super) {
    ...
    function OAuth2ProviderPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.tryRefreshPage.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(DEFAULT_TRY_REFRESH_PATH));
            ...
            if (_this.recipeInstance.config.oauth2LogoutScreen.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(DEFAULT_OAUTH2_LOGOUT_PATH));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: genericComponentOverrideContext.matchRecipeIdUsingQueryParams(_this.recipeInstance.config.recipeId),
        ...
        componentName, props, useComponentOverrides) {
            ...
            if (componentName === "try-refresh-page") {
                ...
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, genericComponentOverrideContext.__assign({ requireAuth: false, overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(OAuth2LogoutScreen, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides }, props)) })) })));
            }
    ...
    OAuth2ProviderPreBuiltUI.languageTranslations = defaultTranslationsOAuth2Provider;
