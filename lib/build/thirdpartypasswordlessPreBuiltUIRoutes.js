...
var passwordlessPreBuiltUIRoutes = require("./passwordless-shared3.js");
var thirdpartyPreBuiltUIRoutes = require("./thirdparty-shared2.js");
var authWidgetWrapper = require("./authRecipe-shared2.js");
var sessionAuth = require("./session-shared.js");
var componentOverrideContext = require("./thirdpartypasswordless-shared.js");
...
var SignInUpTheme = function (props) {
    var t = translationContext.useTranslation();
    if (props.activeScreen === passwordlessPreBuiltUIRoutes.SignInUpScreens.CloseTab) {
        return jsxRuntime.jsx(passwordlessPreBuiltUIRoutes.CloseTabScreen, utils.__assign({}, props.pwlessChildProps));
    } else if (props.activeScreen === passwordlessPreBuiltUIRoutes.SignInUpScreens.LinkSent) {
        return jsxRuntime.jsx(
            passwordlessPreBuiltUIRoutes.LinkSent,
            utils.__assign({}, getCommonPwlessProps(props.pwlessChildProps, props), {
                            ...
                            { "data-supertokens": "row" },
                            {
                                children:
                                    ...
                                    jsxRuntime.jsxs(React__namespace.Fragment, {
                                        children: [
                                            props.activeScreen ===
                                            passwordlessPreBuiltUIRoutes.SignInUpScreens.UserInputCodeForm
                                                ? jsxRuntime.jsx(
                                                      passwordlessPreBuiltUIRoutes.UserInputCodeFormHeader,
                                                      utils.__assign(
                                                          {},
                                            ...
                                            props.tpChildProps !== undefined &&
                                                props.activeScreen !==
                                                    passwordlessPreBuiltUIRoutes.SignInUpScreens.UserInputCodeForm &&
                                                jsxRuntime.jsx(
                                                    thirdpartyPreBuiltUIRoutes.ProvidersForm,
                                                    utils.__assign({}, props.tpChildProps, {
                                            ...
                                            props.activeScreen ===
                                            passwordlessPreBuiltUIRoutes.SignInUpScreens.EmailForm
                                                ? jsxRuntime.jsx(
                                                      passwordlessPreBuiltUIRoutes.EmailForm,
                                                      utils.__assign(
                                                          {},
                                                          getCommonPwlessProps(props.pwlessChildProps, props)
                                                      )
                                                ...
                                                : props.activeScreen ===
                                                  passwordlessPreBuiltUIRoutes.SignInUpScreens.PhoneForm
                                                ? jsxRuntime.jsx(
                                                      passwordlessPreBuiltUIRoutes.PhoneForm,
                                                      utils.__assign(
                                                          {},
                                                          getCommonPwlessProps(props.pwlessChildProps, props)
                                                      )
                                                ...
                                                : props.activeScreen ===
                                                  passwordlessPreBuiltUIRoutes.SignInUpScreens.EmailOrPhoneForm
                                                ? jsxRuntime.jsx(
                                                      passwordlessPreBuiltUIRoutes.EmailOrPhoneForm,
                                                      utils.__assign(
                                                          {},
                                                          getCommonPwlessProps(props.pwlessChildProps, props)
                                                      )
                                                ...
                                                : props.activeScreen ===
                                                  passwordlessPreBuiltUIRoutes.SignInUpScreens.UserInputCodeForm
                                                ? jsxRuntime.jsx(
                                                      passwordlessPreBuiltUIRoutes.UserInputCodeForm,
                                                      utils.__assign(
                                                          {},
                                                          getCommonPwlessProps(props.pwlessChildProps, props),
                                                          {
...
function SignInUpThemeWrapper(props) {
    ...
    var childProps =
        props.passwordlessRecipe !== undefined && props.pwlessChildProps !== undefined
            ? utils.__assign(utils.__assign({}, props), {
                  activeScreen: passwordlessPreBuiltUIRoutes.getActiveScreen({
    ...
    var activeStyle;
    if (childProps.activeScreen === passwordlessPreBuiltUIRoutes.SignInUpScreens.CloseTab) {
        activeStyle = props.passwordlessRecipe.config.signInUpFeature.closeTabScreenStyle;
    } else if (childProps.activeScreen === passwordlessPreBuiltUIRoutes.SignInUpScreens.LinkSent) {
        activeStyle = props.passwordlessRecipe.config.signInUpFeature.linkSentScreenStyle;
    } else if (childProps.activeScreen === passwordlessPreBuiltUIRoutes.SignInUpScreens.UserInputCodeForm) {
    ...
    return jsxRuntime.jsx(
        ...
        utils.__assign(
            ...
            { children: jsxRuntime.jsx(SignInUpTheme, utils.__assign({}, childProps)) }
        )
    );
}
...
var defaultTranslationsThirdPartyPasswordless = {
    en: utils.__assign(
        utils.__assign(
            utils.__assign({}, thirdpartyPreBuiltUIRoutes.defaultTranslationsThirdParty.en),
            passwordlessPreBuiltUIRoutes.defaultTranslationsPasswordless.en
        ),
        {
...
var SignInAndUp = function (props) {
    var _a;
    var _b = thirdpartyPreBuiltUIRoutes.useFeatureReducer(),
        tpState = _b[0],
        tpDispatch = _b[1];
    var userContext = sessionAuth.useUserContext();
    var _c = passwordlessPreBuiltUIRoutes.useFeatureReducer(
    ...
    var _d = React__namespace.useReducer(
            function (state, action) {
                switch (action.type) {
                    ...
                    case "startLogin":
                    case "resendCode":
                        return utils.__assign(utils.__assign({}, state), { error: undefined });
                    case "load":
                        if (action.loginAttemptInfo !== undefined) {
                            return utils.__assign(utils.__assign({}, state), { error: action.error });
                        }
                        return utils.__assign(utils.__assign({}, state), {
    ...
    var tpChildProps = thirdpartyPreBuiltUIRoutes.useChildProps(props.recipe.thirdPartyRecipe);
    ...
    var callingConsumeCodeRef = passwordlessPreBuiltUIRoutes.useSuccessInAnotherTabChecker(
        pwlessState,
        combinedPwlessDispatch,
        userContext
    );
    var pwlessChildProps = passwordlessPreBuiltUIRoutes.useChildProps(
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(SignInUpThemeWrapper, utils.__assign({}, childProps)),
                                    props.children &&
...
var ThirdPartyPasswordlessPreBuiltUIRoutes = /** @class */ (function (_super) {
    utils.__extends(ThirdPartyPasswordlessPreBuiltUIRoutes, _super);
    function ThirdPartyPasswordlessPreBuiltUIRoutes(recipeInstance) {
        ...
        _this.getFeatureComponent = function (componentName, props) {
            if (componentName === "signInUp") {
                ...
                if (_this.recipeInstance.passwordlessRecipe === undefined) {
                    throw new Error(
                ...
                return passwordlessPreBuiltUIRoutes.PasswordlessPreBuiltUIRoutes.getFeatureComponent(
                    componentName,
                    props
                );
            } else if (componentName === "signinupcallback") {
                if (_this.recipeInstance.thirdPartyRecipe === undefined) {
                    throw new Error(
                ...
                return thirdpartyPreBuiltUIRoutes.ThirdPartyPreBuiltUIRoutes.getFeatureComponent(componentName, props);
            } else {
        ...
        _this.getFeatures = function () {
            ...
            var features = {};
            if (_this.recipeInstance.passwordlessRecipe !== undefined) {
                features = utils.__assign(
                    utils.__assign({}, features),
                    passwordlessPreBuiltUIRoutes.PasswordlessPreBuiltUIRoutes.getFeatures(
                        _this.recipeInstance.passwordlessRecipe
                    )
                );
            }
            if (_this.recipeInstance.thirdPartyRecipe !== undefined) {
                features = utils.__assign(
                    utils.__assign({}, features),
                    thirdpartyPreBuiltUIRoutes.ThirdPartyPreBuiltUIRoutes.getFeatures(
                        _this.recipeInstance.thirdPartyRecipe
                    )
                );
            }
            if (
                (_this.recipeInstance.config.passwordlessUserInput !== undefined &&
                    ((_b = _this.recipeInstance.config.passwordlessUserInput.signInUpFeature) === null || _b === void 0
                        ? void 0
                        : _b.disableDefaultUI) !== true) ||
                (_this.recipeInstance.config.thirdpartyUserInput !== undefined &&
                    ((_c = _this.recipeInstance.config.thirdpartyUserInput.signInAndUpFeature) === null || _c === void 0
                        ? void 0
    ...
    var _a;
    _a = ThirdPartyPasswordlessPreBuiltUIRoutes;
    ThirdPartyPasswordlessPreBuiltUIRoutes.SignInAndUp = function (prop) {
        if (prop === void 0) {
            prop = {};
        }
        return _a.getFeatureComponent("signInUp", prop);
    };
    ThirdPartyPasswordlessPreBuiltUIRoutes.ThirdPartySignInAndUpCallback = function (prop) {
        return _a.getFeatureComponent("signinupcallback", prop);
    };
    ThirdPartyPasswordlessPreBuiltUIRoutes.SignInUpTheme = SignInUpThemeWrapper;
    ThirdPartyPasswordlessPreBuiltUIRoutes.PasswordlessLinkClicked = function (prop) {
        return _a.getFeatureComponent("linkClickedScreen", prop);
    };
    return ThirdPartyPasswordlessPreBuiltUIRoutes;
})(sessionAuth.RecipeRoutes);

exports.ThirdPartyPasswordlessPreBuiltUIRoutes = ThirdPartyPasswordlessPreBuiltUIRoutes;
//# sourceMappingURL=thirdpartypasswordlessPreBuiltUIRoutes.js.map
