...
var SignInAndUpTheme = function (props) {
    ...
    var emailPasswordEnabled = props.emailPasswordRecipe !== undefined;
    if (usesDynamicLoginMethods) {
        thirdPartyEnabled = loginMethods.firstFactors.includes(types.FactorIds.THIRDPARTY) && hasProviders;
        emailPasswordEnabled =
            loginMethods.firstFactors.includes(types.FactorIds.EMAILPASSWORD) &&
            props.emailPasswordRecipe !== undefined;
    } else if (mfa !== undefined) {
        thirdPartyEnabled = mfa.isFirstFactorEnabledOnClient(types.FactorIds.THIRDPARTY) && hasProviders;
        emailPasswordEnabled =
            mfa.isFirstFactorEnabledOnClient(types.FactorIds.EMAILPASSWORD) && props.emailPasswordRecipe !== undefined;
    }
                    ...
                    genericComponentOverrideContext.__assign(
                        {
                            ...
                            userStyles: [
                                ...
                                (_a = props.config.signInAndUpFeature.signInForm) === null || _a === void 0
                                    ? void 0
                                    : _a.style,
                            ],
                        },
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.signInAndUpFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    recipeID: recipe$1.ThirdPartyEmailPassword.RECIPE_ID,
                };
            }
            return features;
        };
