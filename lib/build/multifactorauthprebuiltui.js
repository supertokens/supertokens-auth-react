        ...
        superTokens.__assign(
            { "data-supertokens": "factorChooserOption ".concat(id), onClick: onClick },
            {
                children: [
                    jsxRuntime.jsxs(
                        "div",
                        superTokens.__assign({ "data-supertokens": "factorLogo" }, { children: [" ", logo({})] })
                    ),
                    jsxRuntime.jsxs(
                        "div",
                        superTokens.__assign(
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(FactorChooserThemeWrapper, superTokens.__assign({}, childProps)),
                                    props.children &&
...
var MultiFactorAuthPreBuiltUI = /** @class */ (function (_super) {
    superTokens.__extends(MultiFactorAuthPreBuiltUI, _super);
