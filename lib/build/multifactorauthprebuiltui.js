...
var FactorChooser$1 = function (props) {
    ...
    var availableFactors = getAvailableFactors(mfaClaimValue, nextQueryParam, mfaInfo.factors, props, userContext);
    var childProps = {
...
function getAvailableFactors(mfaClaimValue, nextArrayQueryParam, factors, props, userContext) {
    ...
    var availableFactors = props.recipe.getSecondaryFactors(userContext).filter(function (_a) {
        var id = _a.id;
