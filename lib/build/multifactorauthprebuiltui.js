...
var FactorChooser$1 = function (props) {
    ...
    var checkMFAInfo = React.useCallback(
        function (mfaInfo) {
            return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    availableFactors = getAvailableFactors(mfaClaimValue, nextQueryParam, mfaInfo.factors, props);
    ...
    var availableFactors = getAvailableFactors(mfaClaimValue, nextQueryParam, mfaInfo.factors, props);
    var childProps = {
...
function getAvailableFactors(mfaClaimValue, nextQueryParam, factors, props) {
    var _a;
    ...
    var isValid = ((_a = mfaClaimValue.value) === null || _a === void 0 ? void 0 : _a.v) === true;
    var nextArr = nextQueryParam !== undefined ? nextQueryParam.split(",") : factors.next;
