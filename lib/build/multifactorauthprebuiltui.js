...
var FactorList = uiEntry.withOverride("MFAFactorList", function MFAFactorList(_a) {
    ...
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "row factorChooserList" }, { children: availableFactors.map(function (factor) { return (jsxRuntime.jsx(FactorOption, { id: factor.id, name: factor.name, description: factor.description, logo: factor.logo, onClick: function () { return navigateToFactor(factor.id); } }, factor.id)); }) })));
});
...
var FactorChooser$1 = function (props) {
    ...
    var nextQueryParam = (_a = utils.getQueryParams("n")) !== null && _a !== void 0 ? _a : undefined;
    var stepUpQueryParam = utils.getQueryParams("stepUp");
    ...
    var fetchMFAInfo = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () { return utils.__generator(this, function (_a) {
        return [2 /*return*/, props.recipe.webJSRecipe.resyncSessionAndFetchMFAInfo({ userContext: userContext })];
    }); }); }, [props.recipe, userContext]);
    var checkMFAInfo = React.useCallback(function (mfaInfo) { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            if (mfaInfo.factors.next.length === 0 && stepUpQueryParam !== "true") {
                void types.Session.getInstanceOrThrow()
                    .validateGlobalClaimsAndHandleSuccessRedirection(undefined, recipe.MultiFactorAuth.RECIPE_ID, utils.getRedirectToPathFromURL(), userContext, props.navigate)
    ...
    utils.useOnMountAPICall(fetchMFAInfo, checkMFAInfo, handleError, sessionContext.loading === false);
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsMultiFactorAuth }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(FactorChooserThemeWrapper, utils.__assign({}, childProps)), props.children &&
...
var MultiFactorAuthPreBuiltUI = /** @class */ (function (_super) {
    utils.__extends(MultiFactorAuthPreBuiltUI, _super);
    ...
    MultiFactorAuthPreBuiltUI.languageTranslations = defaultTranslationsMultiFactorAuth;
