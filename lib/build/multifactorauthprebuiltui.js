        ...
        utils.__assign(
            { "data-supertokens": "factorChooserOption ".concat(id), onClick: onClick },
            {
                children: [
                    jsxRuntime.jsxs(
                        "div",
                        utils.__assign({ "data-supertokens": "factorLogo" }, { children: [" ", logo({})] })
                    ),
                    jsxRuntime.jsxs(
                        "div",
                        utils.__assign(
                            { "data-supertokens": "factorOptionText" },
                            {
                                children: [
                                    jsxRuntime.jsx(
                                        "h6",
                                        utils.__assign({ "data-supertokens": "factorName" }, { children: t(name) })
                                    ),
                                    jsxRuntime.jsx(
                                        "p",
                                        utils.__assign(
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(FactorChooserThemeWrapper, utils.__assign({}, childProps)),
                                    props.children &&
