...
var FactorChooser$1 = function (props) {
            ...
            return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    ...
                    availableFactors = props.recipe
                        ...
                        .filter(function (_a) {
                            var id = _a.id;
                            return mfaInfo.nextFactors.length === 0 || mfaInfo.nextFactors.includes(id);
                        })
                        .filter(function (_a) {
                            var id = _a.id;
                            return mfaInfo.nextFactors.length === 0 || mfaInfo.nextFactors.includes(id);
                        ...
                        .filter(function (_a) {
                            var id = _a.id;
                            return nextOpts === undefined || nextOpts.length === 0 || nextOpts.includes(id);
                        });
    ...
    var availableFactors = props.recipe
        ...
        .filter(function (_a) {
            var id = _a.id;
            return mfaInfo.factors.isAllowedToSetup.includes(id) || mfaInfo.factors.isAlreadySetup.includes(id);
        })
        .filter(function (_a) {
            var id = _a.id;
            return mfaInfo.nextFactors.length === 0 || mfaInfo.nextFactors.includes(id);
