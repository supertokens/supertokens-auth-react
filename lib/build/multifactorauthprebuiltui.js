...
var FactorList = uiEntry.withOverride("MFAFactorList", function MFAFactorList(_a) {
    ...
    return (jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "row factorChooserList" }, { children: availableFactors.map(function (factor) { return (jsxRuntime.jsx(FactorOption, { id: factor.id, name: factor.name, description: factor.description, logo: factor.logo, onClick: function () { return navigateToFactor(factor.id); } }, factor.id)); }) })));
});

function FactorChooserTheme(props) {
    var t = translationContext.useTranslation();
    if (props.availableFactors.length === 0) {
        return (jsxRuntime.jsx(sessionprebuiltui.AccessDeniedScreen, { useShadowDom: false /* We set this to false, because we are already inside a shadowDom (if required) */, error: props.showBackButton ? t("MFA_NO_AVAILABLE_OPTIONS") : t("MFA_NO_AVAILABLE_OPTIONS_LOGIN") }));
    }
    return (jsxRuntime.jsxs("div", logger.__assign({ "data-supertokens": "container mfa" }, { children: [jsxRuntime.jsx(FactorChooserHeader, { onBackButtonClicked: props.onBackButtonClicked, showBackButton: props.showBackButton }), jsxRuntime.jsx(FactorList, { availableFactors: props.availableFactors, navigateToFactor: props.navigateToFactor }), jsxRuntime.jsx(FactorChooserFooter, { logout: props.onLogoutClicked }), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })));
}
...
var FactorChooser$1 = function (props) {
    ...
    var _b = React.useState(undefined), mfaInfo = _b[0], setMFAInfo = _b[1];
    var userContext = uiEntry.useUserContext();
    if (props.userContext !== undefined) {
        userContext = props.userContext;
    }
    var recipeComponentOverrides = props.useComponentOverrides();
    var nextQueryParam = (_a = genericComponentOverrideContext.getQueryParams("n")) !== null && _a !== void 0 ? _a : undefined;
    ...
    var fetchMFAInfo = React.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () { return logger.__generator(this, function (_a) {
        return [2 /*return*/, props.recipe.webJSRecipe.resyncSessionAndFetchMFAInfo({ userContext: userContext })];
    }); }); }, [props.recipe, userContext]);
    var checkMFAInfo = React.useCallback(function (mfaInfo) { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(this, function (_a) {
            if (mfaInfo.factors.next.length === 0 && stepUpQueryParam !== "true") {
                void types.Session.getInstanceOrThrow()
                    .validateGlobalClaimsAndHandleSuccessRedirection(undefined, recipe.MultiFactorAuth.RECIPE_ID, genericComponentOverrideContext.getRedirectToPathFromURL(), userContext, props.navigate)
    ...
    genericComponentOverrideContext.useOnMountAPICall(fetchMFAInfo, checkMFAInfo, handleError, sessionContext.loading === false);
    var navigateToFactor = React.useCallback(function (factorId) {
    ...
    var onBackButtonClicked = React.useCallback(function () {
        ...
        if (props.navigate === undefined) {
            return windowHandler.WindowHandlerReference.getReferenceOrThrow().windowHandler.getWindowUnsafe().history.back();
        }
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsMultiFactorAuth }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(FactorChooserThemeWrapper, logger.__assign({}, childProps)), props.children &&
...
var MultiFactorAuthPreBuiltUI = /** @class */ (function (_super) {
    logger.__extends(MultiFactorAuthPreBuiltUI, _super);
    function MultiFactorAuthPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(recipe.DEFAULT_FACTOR_CHOOSER_PATH));
