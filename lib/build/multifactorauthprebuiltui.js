...
var FactorChooserFooter = sessionprebuiltui.withOverride("MFAFactorChooserFooter", function MFAChooserFooter(_a) {
...
var FactorChooserHeader = sessionprebuiltui.withOverride(
    "MFAFactorChooserHeader",
    function MFAFactorChooserHeader(props) {
        var t = translationContext.useTranslation();
        return jsxRuntime.jsx(
            "div",
            genericComponentOverrideContext.__assign(
...
var FactorOption = sessionprebuiltui.withOverride("MFAFactorOption", function MFAFactorOption(_a) {
...
var FactorList = sessionprebuiltui.withOverride("MFAFactorList", function MFAFactorList(_a) {
...
var FactorChooser$1 = function (props) {
    var _a;
    var sessionContext = React.useContext(sessionprebuiltui.SessionContext);
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                sessionprebuiltui.redirectToAuth({ redirectBack: false, navigate: props.navigate }),
                            ];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
