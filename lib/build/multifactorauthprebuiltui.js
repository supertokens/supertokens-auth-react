...
var FactorChooser$1 = function (props) {
    ...
    var nextQueryParam = (_a = superTokens.getQueryParams("n")) !== null && _a !== void 0 ? _a : undefined;
    var stepUpQueryParam = superTokens.getQueryParams("stepUp");
        ...
        return logger.__generator(this, function (_a) {
            if (mfaInfo.factors.next.length === 0 && stepUpQueryParam !== "true") {
                void types.Session.getInstanceOrThrow()
                    .validateGlobalClaimsAndHandleSuccessRedirection(undefined, recipe.MultiFactorAuth.RECIPE_ID, superTokens.getRedirectToPathFromURL(), userContext, props.navigate)
    ...
    superTokens.useOnMountAPICall(fetchMFAInfo, checkMFAInfo, handleError, sessionContext.loading === false);
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsMultiFactorAuth }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(FactorChooserThemeWrapper, logger.__assign({}, childProps)), props.children &&
