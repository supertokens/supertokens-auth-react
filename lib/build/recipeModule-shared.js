                ...
                return superTokens.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                this.getRedirectUrl(context, superTokens.getNormalisedUserContext(userContext)),
                            ];
                        case 1:
                            redirectUrl = _a.sent();
                            if (redirectUrl === null) {
                            ...
                            return [
                                2 /*return*/,
                                superTokens.SuperTokens.getInstanceOrThrow().redirectToUrl(redirectUrl, navigate),
                            ];
                    }
                });
            });
