...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.createDevice = function (input) {
        return recipe.TOTP.getInstanceOrThrow().webJSRecipe.createDevice(logger.__assign(logger.__assign({}, input), { userContext: superTokens.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    Wrapper.verifyCode = function (input) {
        return recipe.TOTP.getInstanceOrThrow().webJSRecipe.verifyCode(logger.__assign(logger.__assign({}, input), { userContext: superTokens.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    Wrapper.verifyDevice = function (input) {
        return recipe.TOTP.getInstanceOrThrow().webJSRecipe.verifyDevice(logger.__assign(logger.__assign({}, input), { userContext: superTokens.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    Wrapper.removeDevice = function (input) {
        return recipe.TOTP.getInstanceOrThrow().webJSRecipe.removeDevice(logger.__assign(logger.__assign({}, input), { userContext: superTokens.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    Wrapper.listDevices = function (input) {
        return recipe.TOTP.getInstanceOrThrow().webJSRecipe.listDevices(logger.__assign(logger.__assign({}, input), { userContext: superTokens.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
