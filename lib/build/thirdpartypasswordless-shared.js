                        ...
                        return [
                            ...
                            originalImp.setPasswordlessLoginAttemptInfo(
                                superTokens.__assign(superTokens.__assign({}, input), {
                                    attemptInfo: superTokens.__assign(
                                        superTokens.__assign({}, input.attemptInfo),
...
function normaliseThirdPartyPasswordlessConfig(config) {
    ...
    var disableThirdParty =
        ((_a = config.signInUpFeature) === null || _a === void 0 ? void 0 : _a.providers) === undefined ||
    ...
    var thirdPartyProviderAndEmailOrPhoneFormStyle =
        ((_b = config === null || config === void 0 ? void 0 : config.signInUpFeature) === null || _b === void 0
            ? void 0
            : _b.thirdPartyProviderAndEmailOrPhoneFormStyle) === undefined
            ? ""
    ...
    return superTokens.__assign(superTokens.__assign({}, utils.normaliseAuthRecipe(config)), {
        ...
        thirdpartyConfig: disableThirdParty
            ...
            : recipe.normaliseThirdPartyConfig({
                  ...
                  signInAndUpFeature: superTokens.__assign(superTokens.__assign({}, config.signInUpFeature), {
        ...
        passwordlessConfig: recipe$1.normalisePasswordlessConfig({
            ...
            preAPIHook: config.preAPIHook,
            useShadowDom: config.useShadowDom,
            signInUpFeature: superTokens.__assign(superTokens.__assign({}, config.signInUpFeature), {
...
var ThirdPartyPasswordless = /** @class */ (function (_super) {
    superTokens.__extends(ThirdPartyPasswordless, _super);
    function ThirdPartyPasswordless(config, recipes, webJSRecipe) {
        ...
        _this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : superTokens.SuperTokens.usesDynamicLoginMethods === false && _this.config.disablePasswordless
                ? undefined
                : new recipe$1.Passwordless(
                      superTokens.__assign(superTokens.__assign({}, _this.config.passwordlessConfig), {
