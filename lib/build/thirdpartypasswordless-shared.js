                        ...
                        return [
                            ...
                            originalImp.setPasswordlessLoginAttemptInfo(
                                thirdparty.__assign(thirdparty.__assign({}, input), {
                                    attemptInfo: thirdparty.__assign(
                                        thirdparty.__assign({}, input.attemptInfo),
    ...
    return thirdparty.__assign(thirdparty.__assign({}, thirdparty.normaliseAuthRecipe(config)), {
        ...
        thirdpartyConfig: disableThirdParty
            ...
            : thirdparty.normaliseThirdPartyConfig({
                  ...
                  signInAndUpFeature: thirdparty.__assign(thirdparty.__assign({}, config.signInUpFeature), {
        ...
        passwordlessConfig: recipe.normalisePasswordlessConfig({
            ...
            preAPIHook: config.preAPIHook,
            useShadowDom: config.useShadowDom,
            signInUpFeature: thirdparty.__assign(thirdparty.__assign({}, config.signInUpFeature), {
...
var ThirdPartyPasswordless = /** @class */ (function (_super) {
    thirdparty.__extends(ThirdPartyPasswordless, _super);
    function ThirdPartyPasswordless(config, recipes, webJSRecipe) {
        ...
        var _a;
        if (
            thirdparty.SuperTokens.usesDynamicLoginMethods === false &&
        ...
        _this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : thirdparty.SuperTokens.usesDynamicLoginMethods === false && _this.config.disablePasswordless
                ? undefined
                : new recipe.Passwordless(
                      thirdparty.__assign(thirdparty.__assign({}, _this.config.passwordlessConfig), {
