...
var _a = uiEntry.createGenericComponentsOverrideContext(),
    useContext = _a[0],
    Provider = _a[1];

var getFunctionOverrides = function (recipeId, onHandleEvent) {
    return function (originalImp) {
        return uiEntry.__assign(uiEntry.__assign({}, originalImp), {
            ...
            setThirdPartyStateAndOtherInfoToStorage: function (input) {
                return originalImp.setThirdPartyStateAndOtherInfoToStorage({
                    state: uiEntry.__assign(uiEntry.__assign({}, input.state), {
                        rid: recipeId,
                        ...
                        return [
                            ...
                            originalImp.setPasswordlessLoginAttemptInfo(
                                uiEntry.__assign(uiEntry.__assign({}, input), {
                                    attemptInfo: uiEntry.__assign(
                                        uiEntry.__assign({}, input.attemptInfo),
...
function normaliseThirdPartyPasswordlessConfig(config) {
    ...
    var disableThirdParty =
        ((_b = (_a = config.signInUpFeature) === null || _a === void 0 ? void 0 : _a.providers) === null ||
        _b === void 0
            ? void 0
            : _b.length) === 0;
    var override = uiEntry.__assign(
        {
    ...
    var thirdPartyProviderAndEmailOrPhoneFormStyle =
        ((_c = config === null || config === void 0 ? void 0 : config.signInUpFeature) === null || _c === void 0
            ? void 0
            : _c.thirdPartyProviderAndEmailOrPhoneFormStyle) === undefined
            ? ""
            : config === null || config === void 0
            ? void 0
            : config.signInUpFeature.thirdPartyProviderAndEmailOrPhoneFormStyle;
    return uiEntry.__assign(uiEntry.__assign({}, uiEntry.normaliseAuthRecipe(config)), {
        thirdPartyProviderAndEmailOrPhoneFormStyle: thirdPartyProviderAndEmailOrPhoneFormStyle,
        thirdpartyConfig: disableThirdParty
            ? undefined
            : uiEntry.normaliseThirdPartyConfig({
                  getRedirectionURL: config.getRedirectionURL,
                  style: config.style,
                  onHandleEvent: config.onHandleEvent,
                  preAPIHook: config.preAPIHook,
                  signInAndUpFeature: uiEntry.__assign(uiEntry.__assign({}, config.signInUpFeature), {
        ...
        passwordlessConfig: recipe.normalisePasswordlessConfig({
            ...
            preAPIHook: config.preAPIHook,
            useShadowDom: config.useShadowDom,
            signInUpFeature: uiEntry.__assign(uiEntry.__assign({}, config.signInUpFeature), {
...
var ThirdPartyPasswordless = /** @class */ (function (_super) {
    uiEntry.__extends(ThirdPartyPasswordless, _super);
    function ThirdPartyPasswordless(config, recipes, webJSRecipe) {
        ...
        var _a;
        if (
            uiEntry.SuperTokens.usesDynamicLoginMethods === false &&
            config.disablePasswordless === true &&
            ((_a = config.thirdpartyConfig) === null || _a === void 0
                ? void 0
                : _a.signInAndUpFeature.providers.length) === 0
        ) {
        ...
        _this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : uiEntry.SuperTokens.usesDynamicLoginMethods === false && _this.config.disablePasswordless
                ? undefined
                : new recipe.Passwordless(
                      uiEntry.__assign(uiEntry.__assign({}, _this.config.passwordlessConfig), {
        ...
        _this.thirdPartyRecipe =
            recipes.thirdPartyInstance !== undefined
                ...
                ? undefined
                : new uiEntry.ThirdParty(
                      uiEntry.__assign(uiEntry.__assign({}, _this.config.thirdpartyConfig), {
                          appInfo: _this.config.appInfo,
                          recipeId: _this.config.recipeId,
                      }),
        ...
        return {
            ...
            authReact: function (appInfo) {
                ThirdPartyPasswordless.instance = new ThirdPartyPasswordless(
                    uiEntry.__assign(uiEntry.__assign({}, normalisedConfig), {
                        appInfo: appInfo,
                        recipeId: ThirdPartyPasswordless.RECIPE_ID,
                    }),
                    {
