...
function getRecipeImplementation(recipeInput) {
    var emailpasswordImpl = emailpasswordPreBuiltUI.getRecipeImplementation(utils.__assign({}, recipeInput));
    var thirdPartyImpl = recipe.getRecipeImplementation(utils.__assign({}, recipeInput));
    return {
    ...
    function ThirdPartyEmailPassword(config, recipes) {
        ...
        _this.emailPasswordRecipe =
            recipes.emailPasswordInstance !== undefined
                ...
                ? undefined
                : new emailpasswordPreBuiltUI.EmailPassword({
                      appInfo: _this.config.appInfo,
                      recipeId: _this.config.recipeId,
