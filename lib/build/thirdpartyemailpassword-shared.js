...
function normaliseThirdPartyEmailPasswordConfig(config) {
    ...
    var disableThirdParty =
        ((_b = (_a = config.signInAndUpFeature) === null || _a === void 0 ? void 0 : _a.providers) === null ||
        _b === void 0
            ? void 0
            : _b.length) === 0;
...
function normaliseSignInUpFeatureConfig(config) {
    ...
    return uiEntry.__assign(uiEntry.__assign({}, config), {
...
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    uiEntry.__extends(ThirdPartyEmailPassword, _super);
    function ThirdPartyEmailPassword(config, recipes, webJSRecipe) {
        ...
        _this.emailPasswordRecipe =
            recipes.emailPasswordInstance !== undefined
                ...
                : uiEntry.SuperTokens.usesDynamicLoginMethods === false && _this.config.disableEmailPassword
                ? undefined
                : new recipe.EmailPassword(
                      uiEntry.__assign(uiEntry.__assign({}, _this.config.emailPasswordConfig), {
