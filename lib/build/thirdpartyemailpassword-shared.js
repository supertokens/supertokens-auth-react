...
var recipe$2 = require("./emailpassword-shared4.js");
...
function normaliseThirdPartyEmailPasswordConfig(config) {
    ...
    var thirdpartyNormalisedConfig = recipe$1.normaliseThirdPartyConfig({
    ...
    var emailPasswordNormalisedConfig = recipe$2.normaliseEmailPasswordConfig({
        getRedirectionURL: config.getRedirectionURL,
        onHandleEvent: config.onHandleEvent,
        style: config.style,
        preAPIHook: config.preAPIHook,
...
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    ...
    function ThirdPartyEmailPassword(config, recipes, webJSRecipe) {
        ...
        _this.firstFactorIds = [types.FactorIds.EMAILPASSWORD, types.FactorIds.THIRDPARTY];
