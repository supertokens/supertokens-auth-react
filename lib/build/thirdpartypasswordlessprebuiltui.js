...
var SignInUpTheme = function (props) {
    ...
    var thirdPartyEnabled =
        (props.thirdPartyRecipe !== undefined && superTokens.SuperTokens.usesDynamicLoginMethods === false) ||
        ((_a = superTokens.Multitenancy.getInstanceOrThrow().dynamicLoginMethods) === null || _a === void 0
            ? void 0
            : _a.thirdparty.enabled);
    var passwordlessEnabled =
        (props.passwordlessRecipe !== undefined && superTokens.SuperTokens.usesDynamicLoginMethods === false) ||
        ((_b = superTokens.Multitenancy.getInstanceOrThrow().dynamicLoginMethods) === null || _b === void 0
            ? void 0
            : _b.passwordless.enabled);
    ...
    if (props.activeScreen === passwordlessprebuiltui.SignInUpScreens.CloseTab) {
        return jsxRuntime.jsx(passwordlessprebuiltui.CloseTabScreen, superTokens.__assign({}, props.pwlessChildProps));
    } else if (props.activeScreen === passwordlessprebuiltui.SignInUpScreens.LinkSent) {
        return jsxRuntime.jsx(
            passwordlessprebuiltui.LinkSent,
            superTokens.__assign({}, getCommonPwlessProps(props.pwlessChildProps, props), {
                                        ...
                                        children: [
                                            ...
                                            props.tpChildProps !== undefined &&
                                                ...
                                                jsxRuntime.jsx(
                                                    ...
                                                    superTokens.__assign({}, props.tpChildProps, {
...
function SignInUpThemeWrapper(props) {
    ...
    return jsxRuntime.jsx(
        ...
        superTokens.__assign(
            ...
            { children: jsxRuntime.jsx(SignInUpTheme, superTokens.__assign({}, childProps)) }
        )
    );
}
...
var defaultTranslationsThirdPartyPasswordless = {
    en: superTokens.__assign(
        superTokens.__assign(
            superTokens.__assign({}, thirdpartyprebuiltui.defaultTranslationsThirdParty.en),
...
var SignInAndUp$1 = function (props) {
    ...
    var _d = React__namespace.useReducer(
            function (state, action) {
                switch (action.type) {
                    ...
                    case "startLogin":
                    case "resendCode":
                        return superTokens.__assign(superTokens.__assign({}, state), { error: undefined });
                    case "load":
                        if (action.loginAttemptInfo !== undefined) {
                            return superTokens.__assign(superTokens.__assign({}, state), { error: action.error });
                        }
                        return superTokens.__assign(superTokens.__assign({}, state), {
    ...
    var providers = React__namespace.useMemo(
        function () {
            var _a;
            return superTokens.getProviders({
                tenantProviders:
                    (_a = superTokens.Multitenancy.getInstanceOrThrow().dynamicLoginMethods) === null || _a === void 0
                        ? void 0
    ...
    var themeProps = superTokens.__assign(superTokens.__assign({}, childProps), {
        tpChildProps: superTokens.__assign(superTokens.__assign({}, tpChildProps), { providers: providers }),
    });
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper, superTokens.__assign({}, themeProps)),
            props.children &&
            ...
            { value: recipeComponentOverrides },
            {
                children: jsxRuntime.jsx(
                    ...
                    superTokens.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignInAndUp$1, superTokens.__assign({}, props)) }
                    )
                ),
            }
        )
...
var ThirdPartyPasswordlessPreBuiltUI = /** @class */ (function (_super) {
    superTokens.__extends(ThirdPartyPasswordlessPreBuiltUI, _super);
    function ThirdPartyPasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            var features = {};
            if (_this.passwordlessPreBuiltUI !== undefined) {
                features = superTokens.__assign(
                    superTokens.__assign({}, features),
            ...
            return superTokens.__assign({}, features);
        };
