...
var SignInUpTheme = function (props) {
    var _a;
    var t = uiEntry.useTranslation();
    var usesDynamicLoginMethods = uiEntry.SuperTokens.usesDynamicLoginMethods;
    var dynamicLoginMethods = uiEntry.Multitenancy.getInstanceOrThrow().getLoadedDynamicLoginMethods();
    ...
    if (props.activeScreen === passwordlessprebuiltui.SignInUpScreens.CloseTab) {
        return jsxRuntime.jsx(passwordlessprebuiltui.CloseTabScreen, uiEntry.__assign({}, props.pwlessChildProps));
    } else if (props.activeScreen === passwordlessprebuiltui.SignInUpScreens.LinkSent) {
        return jsxRuntime.jsx(
            passwordlessprebuiltui.LinkSent,
            uiEntry.__assign({}, getCommonPwlessProps(props.pwlessChildProps, props), {
                                        ...
                                        children: [
                                            ...
                                            props.tpChildProps !== undefined &&
                                                ...
                                                jsxRuntime.jsx(
                                                    ...
                                                    uiEntry.__assign({}, props.tpChildProps, {
...
function SignInUpThemeWrapper(props) {
    ...
    var childProps =
        props.passwordlessRecipe !== undefined && props.pwlessChildProps !== undefined
            ? uiEntry.__assign(uiEntry.__assign({}, props), {
    ...
    return jsxRuntime.jsx(
        ...
        uiEntry.__assign(
            ...
            { children: jsxRuntime.jsx(SignInUpTheme, uiEntry.__assign({}, childProps)) }
        )
    );
}
...
var defaultTranslationsThirdPartyPasswordless = {
    en: uiEntry.__assign(
        uiEntry.__assign(
            uiEntry.__assign({}, thirdpartyprebuiltui.defaultTranslationsThirdParty.en),
...
var SignInAndUp$1 = function (props) {
    ...
    var _d = React__namespace.useReducer(
            function (state, action) {
                switch (action.type) {
                    ...
                    case "startLogin":
                    case "resendCode":
                        return uiEntry.__assign(uiEntry.__assign({}, state), { error: undefined });
                    case "load":
                        if (action.loginAttemptInfo !== undefined) {
                            return uiEntry.__assign(uiEntry.__assign({}, state), { error: action.error });
                        }
                        return uiEntry.__assign(uiEntry.__assign({}, state), {
    ...
    var providers = React__namespace.useMemo(
        function () {
            var _a;
            return uiEntry.mergeProviders({
                tenantProviders:
                    (_a = uiEntry.Multitenancy.getInstanceOrThrow().getLoadedDynamicLoginMethods()) === null ||
                    _a === void 0
                        ? void 0
    ...
    var themeProps = uiEntry.__assign(uiEntry.__assign({}, childProps), {
        tpChildProps: uiEntry.__assign(uiEntry.__assign({}, tpChildProps), { providers: providers }),
    });
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper, uiEntry.__assign({}, themeProps)),
            props.children &&
            ...
            { value: recipeComponentOverrides },
            {
                children: jsxRuntime.jsx(
                    ...
                    uiEntry.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignInAndUp$1, uiEntry.__assign({}, props)) }
                    )
                ),
            }
        )
...
var ThirdPartyPasswordlessPreBuiltUI = /** @class */ (function (_super) {
    uiEntry.__extends(ThirdPartyPasswordlessPreBuiltUI, _super);
    function ThirdPartyPasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            var features = {};
            if (_this.passwordlessPreBuiltUI !== undefined) {
                features = uiEntry.__assign(
                    uiEntry.__assign({}, features),
            ...
            return uiEntry.__assign({}, features);
        };
