...
var ThirdPartyPasswordlessPreBuiltUI = /** @class */ (function (_super) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (
                (_this.recipeInstance.config.passwordlessConfig !== undefined &&
                    ((_a = _this.recipeInstance.config.passwordlessConfig.signInUpFeature) === null || _a === void 0
                        ? void 0
                        : _a.disableDefaultUI) !== true) ||
                (_this.recipeInstance.config.thirdpartyConfig !== undefined &&
                    ((_b = _this.recipeInstance.config.thirdpartyConfig.signInAndUpFeature) === null || _b === void 0
                        ? void 0
    ...
    ThirdPartyPasswordlessPreBuiltUI.SignInAndUp = function (prop) {
        ...
        return ThirdPartyPasswordlessPreBuiltUI.getFeatureComponent("signInUp", prop);
    };
    ThirdPartyPasswordlessPreBuiltUI.ThirdPartySignInAndUpCallback = function (prop) {
        return ThirdPartyPasswordlessPreBuiltUI.getFeatureComponent("signinupcallback", prop);
    };
    ...
    ThirdPartyPasswordlessPreBuiltUI.PasswordlessLinkClicked = function (prop) {
        return ThirdPartyPasswordlessPreBuiltUI.getFeatureComponent("linkClickedScreen", prop);
    };
