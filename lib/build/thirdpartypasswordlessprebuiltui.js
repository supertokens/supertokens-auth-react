...
var SignInUpTheme = function (props) {
    var t = translationContext.useTranslation();
    var usesDynamicLoginMethods = superTokens.SuperTokens.usesDynamicLoginMethods;
    var dynamicLoginMethods = superTokens.Multitenancy.getInstanceOrThrow().getDynamicLoginMethods();
    ...
    var providers = React__namespace.useMemo(
        function () {
            ...
            return superTokens.getProviders({
                tenantProviders:
                    (_a = superTokens.Multitenancy.getInstanceOrThrow().getDynamicLoginMethods()) === null ||
                    _a === void 0
                        ? void 0
