...
var thirdpartyprebuiltui = require("./thirdparty-shared.js");
...
var SignInUpTheme = function (props) {
    var _a;
    var t = thirdparty.useTranslation();
    var usesDynamicLoginMethods = thirdparty.SuperTokens.usesDynamicLoginMethods;
    var dynamicLoginMethods = thirdparty.Multitenancy.getInstanceOrThrow().getLoadedDynamicLoginMethods();
    var thirdPartyEnabled =
        ...
        ((dynamicLoginMethods === null || dynamicLoginMethods === void 0
            ...
            ((_a = props.tpChildProps) === null || _a === void 0 ? void 0 : _a.providers.length) !== 0);
    ...
    if (props.activeScreen === passwordlessprebuiltui.SignInUpScreens.CloseTab) {
        return jsxRuntime.jsx(passwordlessprebuiltui.CloseTabScreen, thirdparty.__assign({}, props.pwlessChildProps));
    } else if (props.activeScreen === passwordlessprebuiltui.SignInUpScreens.LinkSent) {
        return jsxRuntime.jsx(
            passwordlessprebuiltui.LinkSent,
            thirdparty.__assign({}, getCommonPwlessProps(props.pwlessChildProps, props), {
                                        ...
                                        children: [
                                            ...
                                            props.tpChildProps !== undefined &&
                                                ...
                                                jsxRuntime.jsx(
                                                    ...
                                                    thirdparty.__assign({}, props.tpChildProps, {
...
function SignInUpThemeWrapper(props) {
    ...
    var childProps =
        props.passwordlessRecipe !== undefined && props.pwlessChildProps !== undefined
            ? thirdparty.__assign(thirdparty.__assign({}, props), {
    ...
    return jsxRuntime.jsx(
        ...
        thirdparty.__assign(
            ...
            { children: jsxRuntime.jsx(SignInUpTheme, thirdparty.__assign({}, childProps)) }
        )
    );
}
...
var defaultTranslationsThirdPartyPasswordless = {
    en: thirdparty.__assign(
        thirdparty.__assign(
            thirdparty.__assign({}, thirdpartyprebuiltui.defaultTranslationsThirdParty.en),
...
var SignInAndUp$1 = function (props) {
    ...
    var _d = React__namespace.useReducer(
            function (state, action) {
                switch (action.type) {
                    ...
                    case "startLogin":
                    case "resendCode":
                        return thirdparty.__assign(thirdparty.__assign({}, state), { error: undefined });
                    case "load":
                        if (action.loginAttemptInfo !== undefined) {
                            return thirdparty.__assign(thirdparty.__assign({}, state), { error: action.error });
                        }
                        return thirdparty.__assign(thirdparty.__assign({}, state), {
    ...
    var providers = React__namespace.useMemo(
        function () {
            var _a;
            return thirdparty.mergeProviders({
                tenantProviders:
                    (_a = thirdparty.Multitenancy.getInstanceOrThrow().getLoadedDynamicLoginMethods()) === null ||
                    _a === void 0
                        ? void 0
    ...
    var themeProps = thirdparty.__assign(thirdparty.__assign({}, childProps), {
        tpChildProps: thirdparty.__assign(thirdparty.__assign({}, tpChildProps), { providers: providers }),
    });
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper, thirdparty.__assign({}, themeProps)),
            props.children &&
            ...
            { value: recipeComponentOverrides },
            {
                children: jsxRuntime.jsx(
                    ...
                    thirdparty.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignInAndUp$1, thirdparty.__assign({}, props)) }
                    )
                ),
            }
        )
...
var ThirdPartyPasswordlessPreBuiltUI = /** @class */ (function (_super) {
    thirdparty.__extends(ThirdPartyPasswordlessPreBuiltUI, _super);
    function ThirdPartyPasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            var features = {};
            if (_this.passwordlessPreBuiltUI !== undefined) {
                features = thirdparty.__assign(
                    thirdparty.__assign({}, features),
            ...
            return thirdparty.__assign({}, features);
        };
