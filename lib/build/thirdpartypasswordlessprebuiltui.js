...
var SignInUpTheme = function (props) {
    ...
    var dynamicLoginMethods = thirdparty.Multitenancy.getInstanceOrThrow().getDynamicLoginMethods();
...
var SignInAndUp$1 = function (props) {
    ...
    var providers = React__namespace.useMemo(
        function () {
            var _a;
            return thirdparty.getProviders({
                tenantProviders:
                    (_a = thirdparty.Multitenancy.getInstanceOrThrow().getDynamicLoginMethods()) === null ||
                    _a === void 0
                        ? void 0
