...
var recipe$2 = require("./thirdpartypasswordless-shared.js");
...
var SignInUpTheme = function (props) {
    ...
    var mfa = recipe$1.MultiFactorAuth.getInstance();
    var thirdPartyEnabled = hasProviders;
    var passwordlessEnabled = props.passwordlessRecipe !== undefined;
    if (usesDynamicLoginMethods) {
        thirdPartyEnabled = loginMethods.firstFactors.includes(types.FactorIds.THIRDPARTY) && hasProviders;
        passwordlessEnabled = recipe.passwordlessFirstFactors.some(function (id) {
            return loginMethods.firstFactors.includes(id);
        });
    } else if (mfa !== undefined) {
        thirdPartyEnabled = thirdPartyEnabled && mfa.isFirstFactorEnabledOnClient(types.FactorIds.THIRDPARTY);
        passwordlessEnabled =
            passwordlessEnabled &&
            recipe.passwordlessFirstFactors.some(function (id) {
                return mfa.isFirstFactorEnabledOnClient(id);
            });
    }
    if (thirdPartyEnabled === false && passwordlessEnabled === false) {
        return null;
    }
    if (props.activeScreen === passwordlessprebuiltui.SignInUpScreens.LinkSent) {
...
function SignInUpThemeWrapper(props) {
    ...
    var validPwlessContactMethodExists;
    try {
        recipe.getEnabledContactMethods(props.config.passwordlessConfig.contactMethod, currentDynamicLoginMethods);
    ...
    var activeStyle;
    if (childProps.activeScreen === passwordlessprebuiltui.SignInUpScreens.LinkSent) {
...
var ThirdPartyPasswordlessPreBuiltUI = /** @class */ (function (_super) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    recipeID: recipe$2.ThirdPartyPasswordless.RECIPE_ID,
                };
            }
    ...
    ThirdPartyPasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (ThirdPartyPasswordlessPreBuiltUI.instance === undefined) {
            var recipeInstance = recipe$2.ThirdPartyPasswordless.getInstanceOrThrow();
    ...
    ThirdPartyPasswordlessPreBuiltUI.MfaOtpPhone = function (prop) {
        return _a.getFeatureComponent("otp-phone", prop);
    };
    ThirdPartyPasswordlessPreBuiltUI.MfaOtpEmail = function (prop) {
        return _a.getFeatureComponent("otp-email", prop);
    };
    ThirdPartyPasswordlessPreBuiltUI.MFAOTPTheme = passwordlessprebuiltui.PasswordlessPreBuiltUI.MFAOTPTheme;
...
var MfaOtpPhone = passwordlessprebuiltui.PasswordlessPreBuiltUI.MfaOtpPhone;
var MfaOtpEmail = passwordlessprebuiltui.PasswordlessPreBuiltUI.MfaOtpEmail;
var MfaOtpTheme = passwordlessprebuiltui.PasswordlessPreBuiltUI.MFAOTPTheme;

exports.MfaOtpEmail = MfaOtpEmail;
exports.MfaOtpPhone = MfaOtpPhone;
exports.MfaOtpTheme = MfaOtpTheme;
