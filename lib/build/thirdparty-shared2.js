    ...
    var providers = React.useMemo(
        function () {
            ...
            if (usesDynamicLoginMethods === false) {
                return props.providers.map(function (provider) {
                    return {
                        id: provider.id,
            ...
            var tenantProviders = superTokens.ThirdParty.tenantProviders || [];
            var providers = [];
            var _loop_1 = function (tenantProvider) {
                var provider = props.providers.find(function (provider) {
                    var id = tenantProviders[tenantProvider].id;
                    return provider.id === id || provider.id.includes(id);
                });
                if (provider === undefined) {
                    provider = props.providers.find(function (provider) {
                        var id = tenantProviders[tenantProvider].id;
            ...
            for (var tenantProvider in tenantProviders) {
                        ...
                        superTokens.__assign(
                            { "data-supertokens": "row" },
                            {
                                children: [
                                    ...
                                    jsxRuntime.jsx(ProvidersForm, superTokens.__assign({}, props)),
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    superTokens.__assign(
                        ...
                        { children: jsxRuntime.jsx(SignInAndUpTheme, superTokens.__assign({}, props)) }
                    )
                ),
            }
        )
        ...
        function () {
            ...
            if (errorQueryParam !== null) {
                if (errorQueryParam === "signin") {
                    ...
                    var customError = superTokens.getQueryParams("message");
                    if (customError === null) {
                        error = "SOMETHING_WENT_WRONG_ERROR";
                    } else {
                        error = customError;
...
var ThirdPartySignInAndUpCallbackTheme = /** @class */ (function (_super) {
    superTokens.__extends(ThirdPartySignInAndUpCallbackTheme, _super);
...
var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    superTokens.__extends(ThirdPartyPreBuiltUI, _super);
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.signInAndUpFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    recipeID: superTokens.ThirdParty.RECIPE_ID,
                };
            }
            ...
            _this.recipeInstance.config.signInAndUpFeature.providers.forEach(function (provider) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: function () {
                        return superTokens.matchRecipeIdUsingState(_this.recipeInstance, {});
                    },
                    component: function (prop) {
    ...
    ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (ThirdPartyPreBuiltUI.instance === undefined) {
            var recipeInstace = superTokens.ThirdParty.getInstanceOrThrow();
