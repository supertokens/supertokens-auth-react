                        ...
                        utils.__assign(
                            { "data-supertokens": "row" },
                            {
                                children: [
                                    ...
                                    jsxRuntime.jsx(ProvidersForm, utils.__assign({}, props)),
        ...
        function () {
            ...
            if (errorQueryParam !== null) {
                if (errorQueryParam === "signin") {
                    ...
                    var customError = utils.getQueryParams("message");
                    if (customError === null) {
                        error = "SOMETHING_WENT_WRONG_ERROR";
                    } else {
                        error = customError;
...
var ThirdPartyPreBuiltUIRoutes = /** @class */ (function (_super) {
    utils.__extends(ThirdPartyPreBuiltUIRoutes, _super);
    function ThirdPartyPreBuiltUIRoutes(recipeInstance) {
        ...
        _this.getFeatures = function () {
            ...
            _this.recipeInstance.config.signInAndUpFeature.providers.forEach(function (provider) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(
                    new NormalisedURLPath__default.default("/callback/".concat(provider.id))
                );
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: function () {
                        return componentOverrideContext.matchRecipeIdUsingState(_this.recipeInstance, {});
                    },
                    component: function (prop) {
    ...
    ThirdPartyPreBuiltUIRoutes.init = function (recipeInstance) {
        ThirdPartyPreBuiltUIRoutes.instance = new ThirdPartyPreBuiltUIRoutes(recipeInstance);
    };
    ThirdPartyPreBuiltUIRoutes.getInstanceOrInitAndGetInstance = function (recipeInstance) {
        if (ThirdPartyPreBuiltUIRoutes.instance === undefined) {
            var instance =
                recipeInstance !== null && recipeInstance !== void 0
                    ? recipeInstance
                    : componentOverrideContext.ThirdParty.getInstanceOrThrow();
            ThirdPartyPreBuiltUIRoutes.init(instance);
        }
        return ThirdPartyPreBuiltUIRoutes.instance;
    };
    ThirdPartyPreBuiltUIRoutes.canHandleRoute = function () {
        return ThirdPartyPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().canHandleRoute();
    };
    ThirdPartyPreBuiltUIRoutes.getRoutingComponent = function () {
        return ThirdPartyPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getRoutingComponent();
    };
    ThirdPartyPreBuiltUIRoutes.getFeatures = function (recipeInstance) {
        return ThirdPartyPreBuiltUIRoutes.getInstanceOrInitAndGetInstance(recipeInstance).getFeatures();
    };
    ThirdPartyPreBuiltUIRoutes.getFeatureComponent = function (componentName, props) {
        return ThirdPartyPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatureComponent(componentName, props);
    };
    ThirdPartyPreBuiltUIRoutes.getRoutes = function (reactRouterDom) {
        return _super.getRoutes.call(
            this,
            reactRouterDom,
            ThirdPartyPreBuiltUIRoutes.getInstanceOrInitAndGetInstance()
        );
    };
    ThirdPartyPreBuiltUIRoutes.SignInAndUp = function (prop) {
        if (prop === void 0) {
            prop = {};
        }
        return ThirdPartyPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatureComponent("signinup", prop);
    };
    ThirdPartyPreBuiltUIRoutes.SignInAndUpCallback = function (prop) {
        return ThirdPartyPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatureComponent(
            "signinupcallback",
            prop
        );
    };
    ThirdPartyPreBuiltUIRoutes.SignInAndUpTheme = SignInAndUpThemeWrapper;
    ThirdPartyPreBuiltUIRoutes.SignInAndUpCallbackTheme = SignInAndUpCallbackTheme;
    return ThirdPartyPreBuiltUIRoutes;
})(sessionAuth.RecipeRoutes);

exports.ProvidersForm = ProvidersForm;
exports.SignInAndUpCallbackTheme = SignInAndUpCallbackTheme;
exports.ThirdPartyPreBuiltUIRoutes = ThirdPartyPreBuiltUIRoutes;
...
//# sourceMappingURL=thirdparty-shared2.js.map
