...
var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    ...
    ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance = function (recipeInstance) {
    ...
    ThirdPartyPreBuiltUI.canHandleRoute = function () {
        return ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance().canHandleRoute();
    };
    ThirdPartyPreBuiltUI.getRoutingComponent = function () {
        var instance = ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance();
        sessionAuth.RecipeRouter.addPrebuiltUI(instance);
        return instance.getRoutingComponent();
    };
    ThirdPartyPreBuiltUI.getFeatures = function (recipeInstance, useComponentOverrides) {
        if (useComponentOverrides === void 0) {
            useComponentOverrides = recipe.useContext;
        }
        return ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance(recipeInstance).getFeatures(useComponentOverrides);
    };
    ThirdPartyPreBuiltUI.getFeatureComponent = function (componentName, props, useComponentOverrides, recipeInstance) {
        if (useComponentOverrides === void 0) {
            useComponentOverrides = recipe.useContext;
        }
    ...
    ThirdPartyPreBuiltUI.getReactRouterDomRoutes = function (reactRouterDom) {
        return sessionAuth.RecipeRouter.getRecipeRoutes(
            reactRouterDom,
            ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance()
        );
    };
...
var canHandleRoute = ThirdPartyPreBuiltUI.canHandleRoute;
var getRoutingComponent = ThirdPartyPreBuiltUI.getRoutingComponent;
var _getFeatures = ThirdPartyPreBuiltUI.getFeatures;
var getReactRouterDomRoutes = ThirdPartyPreBuiltUI.getReactRouterDomRoutes;
