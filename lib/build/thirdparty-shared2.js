    ...
    return React.useMemo(
        function () {
            ...
            if (usesDynamicLoginMethods === false) {
                return superTokens.__assign(superTokens.__assign({}, childProps), {
                    providers: recipe.config.signInAndUpFeature.providers.map(function (provider) {
                        return {
                            id: provider.id,
            ...
            var tenantProviders =
                ((_a = superTokens.Multitenancy.dynamicLoginMethods) === null || _a === void 0
                    ? void 0
                    : _a.thirdparty.providers) || [];
            var providers = [];
            var _loop_1 = function (tenantProvider) {
                var provider = recipe.config.signInAndUpFeature.providers.find(function (provider) {
                    var id = tenantProvider.id;
                    return provider.id === id || provider.id.includes(id);
                });
                if (provider === undefined) {
                    provider = recipe.config.signInAndUpFeature.providers.find(function (provider) {
                        var id = tenantProvider.id;
            ...
            return superTokens.__assign(superTokens.__assign({}, childProps), { providers: providers });
        },
        [recipe]
    );
}
