...
var SignInAndUpCallback$1 = function (props) {
    ...
    var handleVerifyResponse = React.useCallback(
        function (response) {
            return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
                var payloadAfterSuccess, stateResponse, redirectToPath;
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(response.status === "OK")) return [3 /*break*/, 2];
                            return [
                                4 /*yield*/,
                                recipe$1.Session.getInstanceOrThrow().getAccessTokenPayloadSecurely({
                                    userContext: userContext,
                                }),
                            ];
                        case 1:
                            ...
                            return [
                                2 /*return*/,
                                recipe$1.Session.getInstanceOrThrow()
        ...
        [props.recipe, props.navigate, session$1, userContext]
    );
