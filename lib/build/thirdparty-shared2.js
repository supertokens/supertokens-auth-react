...
var ProvidersForm = recipe.withOverride("ThirdPartySignInAndUpProvidersForm", ThirdPartySignInAndUpProvidersForm);

var SignInAndUpHeader = recipe.withOverride("ThirdPartySignInAndUpHeader", function ThirdPartySignInAndUpHeader() {
...
var SignUpFooter = recipe.withOverride("ThirdPartySignUpFooter", function ThirdPartySignUpFooter(_a) {
...
var SignInAndUpCallbackThemeWithOverride = recipe.withOverride(
...
var ThirdPartyPreBuiltUI = /** @class */ (function (_super) {
    ...
    function ThirdPartyPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            _this.recipeInstance.config.signInAndUpFeature.providers.forEach(function (provider) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: function () {
                        return recipe$1.matchRecipeIdUsingState(_this.recipeInstance, {});
                    },
                    component: function (prop) {
    ...
    ThirdPartyPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (ThirdPartyPreBuiltUI.instance === undefined) {
            var recipeInstace = recipe$1.ThirdParty.getInstanceOrThrow();
