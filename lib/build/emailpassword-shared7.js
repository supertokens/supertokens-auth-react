...
function useChildProps(recipe, state, dispatch, userContext, navigate) {
    var _this = this;
        ...
        function () {
            ...
            var signInForm = {
                ...
                forgotPasswordClick: function () {
                    return recipe.redirect({ action: "RESET_PASSWORD" }, navigate, undefined, userContext);
                },
            };
            var signUpForm = {
                recipeImplementation: recipeImplementation,
...
var SignInAndUpFeature = function (props) {
    ...
    var _a = useFeatureReducer(props.recipe),
        state = _a[0],
        dispatch = _a[1];
    var childProps = useChildProps(props.recipe, state, dispatch, userContext, props.navigate);
    var recipeComponentOverrides = props.useComponentOverrides();
    return jsxRuntime.jsx(
        uiEntry.ComponentOverrideContext.Provider,
        genericComponentOverrideContext.__assign(
