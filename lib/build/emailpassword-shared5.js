...
var ResetPasswordUsingToken = /** @class */ (function (_super) {
    utils.__extends(ResetPasswordUsingToken, _super);
    /*
     * Constructor.
     */
    function ResetPasswordUsingToken(props) {
        ...
        _this.render = function () {
                    ...
                    : {
                          ...
                          onError: function (error) {
                              return _this.setState(function (os) {
                                  return utils.__assign(utils.__assign({}, os), { error: error });
                              });
                          },
                          clearError: function () {
                              return _this.setState(function (os) {
                                  return utils.__assign(utils.__assign({}, os), { error: undefined });
                              });
                          },
            ...
            return jsxRuntime.jsx(componentOverrideContext.Consumer, {
...
var EmailPasswordPreBuiltUIRoutes = /** @class */ (function (_super) {
    utils.__extends(EmailPasswordPreBuiltUIRoutes, _super);
    function EmailPasswordPreBuiltUIRoutes(recipeInstance) {
    ...
    EmailPasswordPreBuiltUIRoutes.init = function (recipeInstance) {
        EmailPasswordPreBuiltUIRoutes.instance = new EmailPasswordPreBuiltUIRoutes(recipeInstance);
    };
    EmailPasswordPreBuiltUIRoutes.getInstanceOrInitAndGetInstance = function (recipeInstance) {
    ...
    EmailPasswordPreBuiltUIRoutes.canHandleRoute = function () {
        return EmailPasswordPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().canHandleRoute();
    };
    EmailPasswordPreBuiltUIRoutes.getRoutingComponent = function () {
        return EmailPasswordPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getRoutingComponent();
    };
    EmailPasswordPreBuiltUIRoutes.getFeatures = function (recipeInstance) {
        return EmailPasswordPreBuiltUIRoutes.getInstanceOrInitAndGetInstance(recipeInstance).getFeatures();
    };
    EmailPasswordPreBuiltUIRoutes.getFeatureComponent = function (componentName, props) {
        return EmailPasswordPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatureComponent(
            componentName,
            props
        );
    };
    EmailPasswordPreBuiltUIRoutes.getRoutes = function (reactRouterDom) {
        return _super.getRoutes.call(
            this,
            reactRouterDom,
            EmailPasswordPreBuiltUIRoutes.getInstanceOrInitAndGetInstance()
        );
    };
    EmailPasswordPreBuiltUIRoutes.SignInAndUp = function (prop) {
        if (prop === void 0) {
            prop = {};
        }
        return EmailPasswordPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatureComponent("signinup", prop);
    };
    EmailPasswordPreBuiltUIRoutes.ResetPasswordUsingToken = function (prop) {
        return EmailPasswordPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatureComponent(
            "resetpassword",
            prop
        );
    };
    EmailPasswordPreBuiltUIRoutes.ResetPasswordUsingTokenTheme = ResetPasswordUsingTokenThemeWrapper;
    EmailPasswordPreBuiltUIRoutes.SignInAndUpTheme = SignInAndUpThemeWrapper;
    return EmailPasswordPreBuiltUIRoutes;
})(sessionAuth.RecipeRoutes);

exports.EmailPasswordPreBuiltUIRoutes = EmailPasswordPreBuiltUIRoutes;
