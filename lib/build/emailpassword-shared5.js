...
function FormRow(_a) {
    ...
    return jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": ["formRow", hasError ? "hasError" : ""].join(" ") }, { children: children }));
}
...
var FormBase = function (props) {
    ...
    var _a = React.useState(props.formFields.map(function (f) { return ({ id: f.id, value: fetchDefaultValue(f) }); })), fieldStates = _a[0], setFieldStates = _a[1];
    React.useEffect(function () {
        setFieldStates(function (fs) {
            ...
            if (fieldsWithoutState.length > 0) {
                fs = genericComponentOverrideContext.__spreadArray(genericComponentOverrideContext.__spreadArray([], fs, true), fieldsWithoutState.map(function (f) { return ({ id: f.id, value: fetchDefaultValue(f) }); }), true);
            }
    ...
    var updateFieldState = React.useCallback(function (id, update) {
        setFieldStates(function (os) {
            ...
            if (field === undefined) {
                return genericComponentOverrideContext.__spreadArray(genericComponentOverrideContext.__spreadArray([], os, true), [update({ id: id, value: "" })], false);
            }
            return os.filter(function (f) { return f.id !== field.id; }).concat(update(field));
        });
    }, [setFieldStates]);
    var onInputFocus = React.useCallback(function (field) {
        updateFieldState(field.id, function (os) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, os), { validated: false })); });
    }, [updateFieldState]);
    var onInputBlur = React.useCallback(function (field) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        ...
        return genericComponentOverrideContext.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    error = _a;
                    updateFieldState(field.id, function (os) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, os), { error: error, validated: error === undefined && field.value.length !== 0 })); });
                    return [2 /*return*/];
            }
        });
    ...
    var onInputChange = React.useCallback(function (field) {
        ...
        updateFieldState(field.id, function (os) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, os), { value: field.value, error: undefined })); });
        props.clearError();
    }, [updateFieldState]);
    var onFormSubmit = React.useCallback(function (e) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        var apiFields, fieldUpdates, result, generalError, fetchError, e_1, _loop_1, _i, formFields_1, field, errorFields_1, getErrorMessage_1, e_2;
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // Set loading state.
                    setIsLoading(true);
                    setFieldStates(function (os) { return os.map(function (fs) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, fs), { error: undefined })); }); });
                    apiFields = formFields.map(function (field) {
                        var fieldState = fieldStates.find(function (fs) { return fs.id === field.id; });
                        return {
                            id: field.id,
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, props.callAPI(apiFields, function (id, value) { return fieldUpdates.push({ id: id, value: value }); })];
                case 3:
                    result = _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    ...
                    if (generalError !== undefined || (result !== undefined && result.status !== "OK")) {
                        _loop_1 = function (field) {
                            ...
                            if (update || field.clearOnSubmit === true) {
                                ...
                                updateFieldState(field.id, function (os) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, os), { value: update ? update.value : "" })); });
                            }
                        };
                        ...
                        if (result.status === "FIELD_ERROR") {
                            ...
                            getErrorMessage_1 = function (fs) {
                                ...
                                if (errorMessage === "Field is not optional") {
                                    var fieldConfigData = props.formFields.find(function (f) { return f.id === fs.id; });
                            ...
                            setFieldStates(function (os) { return os.map(function (fs) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, fs), { error: getErrorMessage_1(fs) })); }); });
                        }
                    }
                    return [3 /*break*/, 8];
                case 6:
    ...
    return (jsxRuntime.jsx(FormStateContext.Provider, genericComponentOverrideContext.__assign({ value: fieldStates }, { children: jsxRuntime.jsxs("form", genericComponentOverrideContext.__assign({ autoComplete: "on", noValidate: true, onSubmit: onFormSubmit, "data-supertokens": props.formDataSupertokens }, { children: [formFields
                    ...
                    return (jsxRuntime.jsx(FormRow, genericComponentOverrideContext.__assign({ hasError: fstate.error !== undefined }, { children: jsxRuntime.jsxs(React.Fragment, { children: [showLabels &&
                                    (field.labelComponent !== undefined ? (field.labelComponent) : (jsxRuntime.jsx(Label, { value: field.label, showIsRequired: field.showIsRequired }))), jsxRuntime.jsx(InputComponentWrapper, { type: type, field: field, fstate: fstate, onInputFocus: onInputFocus, onInputBlur: onInputBlur, onInputChange: onInputChange }), fstate.error && jsxRuntime.jsx(InputError, { error: fstate.error })] }) }), field.id));
                }), jsxRuntime.jsx(FormRow, { children: jsxRuntime.jsxs(React.Fragment, { children: [jsxRuntime.jsx(button.Button, { disabled: isLoading, isLoading: isLoading, type: "submit", label: buttonLabel }), footer] }) }, "form-button")] })) })));
};
