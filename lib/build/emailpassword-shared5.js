...
function ResetPasswordUsingTokenTheme(props) {
    ...
    if (props.submitNewPasswordForm !== undefined) {
        return jsxRuntime.jsx(SubmitNewPassword, superTokens.__assign({}, props.submitNewPasswordForm));
    }
    // Otherwise, return EnterEmail.
    return jsxRuntime.jsx(ResetPasswordEmail, superTokens.__assign({}, props.enterEmailForm));
}
...
var defaultTranslationsEmailPassword = {
    en: superTokens.__assign(
        superTokens.__assign(
            superTokens.__assign({}, translations.defaultTranslationsCommon.en),
...
var SignInAndUpTheme = function (props) {
    ...
    if (props.featureState.isSignUp) {
        return jsxRuntime.jsx(
            SignUp,
            superTokens.__assign({}, props.signUpForm, {
    ...
    return jsxRuntime.jsx(
        SignIn,
        superTokens.__assign({}, props.signInForm, {
...
var useFeatureReducer = function (recipe) {
    return React__namespace.useReducer(
        ...
        function (initArg) {
            var show = superTokens.getQueryParams("show");
...
function getThemeSignUpFeatureFormFields(formFields, recipe, userContext) {
    ...
    return formFields.map(function (field) {
        return superTokens.__assign(superTokens.__assign({}, field), {
...
var EmailPasswordPreBuiltUI = /** @class */ (function (_super) {
    superTokens.__extends(EmailPasswordPreBuiltUI, _super);
