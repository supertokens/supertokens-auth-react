...
function FormRow(_a) {
    ...
    return jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": ["formRow", hasError ? "hasError" : ""].join(" ") }, { children: children }));
}
...
function InputError(_a) {
    var error = _a.error;
    var t = translationContext.useTranslation();
    return jsxRuntime.jsx("div", logger.__assign({ "data-supertokens": "inputErrorMessage" }, { children: t(error) }));
}

function Label(_a) {
    var value = _a.value, showIsRequired = _a.showIsRequired;
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs("div", logger.__assign({ "data-supertokens": "label" }, { children: [t(value), showIsRequired && value && value.trim() !== "" && " *"] })));
}
...
var FormBase = function (props) {
    ...
    React.useEffect(function () {
        setFieldStates(function (fs) {
            ...
            if (fieldsWithoutState.length > 0) {
                fs = logger.__spreadArray(logger.__spreadArray([], fs, true), fieldsWithoutState.map(function (f) { return ({ id: f.id, value: fetchDefaultValue(f) }); }), true);
            }
    ...
    var updateFieldState = React.useCallback(function (id, update) {
        setFieldStates(function (os) {
            ...
            if (field === undefined) {
                return logger.__spreadArray(logger.__spreadArray([], os, true), [update({ id: id, value: "" })], false);
            }
            return os.filter(function (f) { return f.id !== field.id; }).concat(update(field));
        });
    }, [setFieldStates]);
    var onInputFocus = React.useCallback(function (field) {
        updateFieldState(field.id, function (os) { return (logger.__assign(logger.__assign({}, os), { validated: false })); });
    }, [updateFieldState]);
    var onInputBlur = React.useCallback(function (field) { return logger.__awaiter(void 0, void 0, void 0, function () {
        ...
        return logger.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    error = _a;
                    updateFieldState(field.id, function (os) { return (logger.__assign(logger.__assign({}, os), { error: error, validated: error === undefined && field.value.length !== 0 })); });
                    return [2 /*return*/];
            }
        });
    ...
    var onInputChange = React.useCallback(function (field) {
        ...
        updateFieldState(field.id, function (os) { return (logger.__assign(logger.__assign({}, os), { value: field.value, error: undefined })); });
        props.clearError();
    }, [updateFieldState]);
    var onFormSubmit = React.useCallback(function (e) { return logger.__awaiter(void 0, void 0, void 0, function () {
        ...
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    // Set loading state.
                    setIsLoading(true);
                    setFieldStates(function (os) { return os.map(function (fs) { return (logger.__assign(logger.__assign({}, fs), { error: undefined })); }); });
                ...
                case 5:
                    ...
                    if (generalError !== undefined || (result !== undefined && result.status !== "OK")) {
                        _loop_1 = function (field) {
                            ...
                            if (update || field.clearOnSubmit === true) {
                                ...
                                updateFieldState(field.id, function (os) { return (logger.__assign(logger.__assign({}, os), { value: update ? update.value : "" })); });
                            }
                        };
                    ...
                    if (generalError !== undefined) {
                        ...
                        if (result.status === "FIELD_ERROR") {
                            ...
                            setFieldStates(function (os) { return os.map(function (fs) { return (logger.__assign(logger.__assign({}, fs), { error: getErrorMessage_1(fs) })); }); });
                        }
                    }
                    return [3 /*break*/, 8];
                case 6:
    ...
    return (jsxRuntime.jsx(FormStateContext.Provider, logger.__assign({ value: fieldStates }, { children: jsxRuntime.jsxs("form", logger.__assign({ autoComplete: "on", noValidate: true, onSubmit: onFormSubmit, "data-supertokens": props.formDataSupertokens }, { children: [formFields
                    ...
                    return (jsxRuntime.jsx(FormRow, logger.__assign({ hasError: fstate.error !== undefined }, { children: jsxRuntime.jsxs(React.Fragment, { children: [showLabels &&
