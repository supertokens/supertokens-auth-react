                                    ...
                                    children: [
                                        jsxRuntime.jsx(
                                            ...
                                            genericComponentOverrideContext.__assign(
                                                ...
                                                { children: t("WEBAUTHN_MFA_REGISTER_PASSKEY_LINK") }
                                            )
                                        ),
                ...
                return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                    return genericComponentOverrideContext.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                setIsLoading(true);
                                return [4 /*yield*/, props.onSignUp(props.email)];
                            case 1:
                                _a.sent();
                                setIsLoading(false);
                                return [2 /*return*/];
...
function MFATheme(props) {
    ...
    var _a = React__namespace.useState(MFAScreens.SignIn),
        activeScreen = _a[0],
                            ...
                            { "data-supertokens": "row" },
                            {
                                children:
                                    activeScreen === MFAScreens.SignIn
                                        ? jsxRuntime.jsx(WebauthnMFASignIn, {
                                              onBackButtonClicked: props.featureState.showBackButton
                                                  ? onBackButtonClicked
                                                  : undefined,
                                        ...
                                        ? jsxRuntime.jsx(WebauthnMFASignUp, {
                                        ...
                                        : jsxRuntime.jsx(WebauthnMFASignUpConfirmation, {
...
function useOnLoad(props, recipeImplementation, dispatch, userContext) {
    ...
    var handleLoadError = React__namespace.useCallback(
        function () {
            return dispatch({ type: "setError", accessDenied: true, error: "SOMETHING_WENT_WRONG_ERROR_RELOAD" });
        },
        [dispatch]
    );
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            return [2 /*return*/];
                        case 4:
                            alreadySetup = mfaInfo.factors.alreadySetup.includes(types.FactorIds.WEBAUTHN);
                            if (alreadySetup) {
                                dispatch({
                                    type: "setError",
                                    accessDenied: true,
                            ...
                            canRegisterPasskey = !mfaInfo.factors.alreadySetup.includes(types.FactorIds.WEBAUTHN);
                            return [
                                4 /*yield*/,
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (
                ...
                var normalisedFullPathForMFA = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(
                    new NormalisedURLPath__default.default(recipe.DEFAULT_WEBAUTHN_MFA_PATH)
                );
