...
var WebauthnMFAFooter = uiEntry.withOverride("WebauthnMFAFooter", function PasswordlessMFAFooter(props) {
    ...
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "footerLinkGroupVert webauthn-mfa footer" }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: props.onSignOutClicked }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }), t("WEBAUTHN_MFA_FOOTER_LOGOUT")] })) })));
});
...
var PasskeyNotSupportedError = uiEntry.withOverride("WebauthnPasskeyNotSupportedError", function () {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "continueWithPasskeyButtonNotSupported" }, { children: t("WEBAUTHN_PASSKEY_NOT_SUPPORTED_BY_BROWSER") })));
});

var WebauthnMFASignIn = uiEntry.withOverride("WebauthnMFASignIn", function WebauthnMFASignIn(props) {
    var _this = this;
    var t = translationContext.useTranslation();
    var _a = React__namespace.useState(false), isLoading = _a[0], setIsLoading = _a[1];
    var onClick = React__namespace.useCallback(function () { return utils.__awaiter(_this, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.onBackButtonClicked ? (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "headerTitle withBackButton webauthn-mfa" }, { children: [jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackButtonClicked }), t("WEBAUTHN_MFA_SIGN_IN_HEADER_TITLE"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] }))) : (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle webauthn-mfa" }, { children: t("WEBAUTHN_MFA_SIGN_IN_HEADER_TITLE") }))), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("WEBAUTHN_MFA_SIGN_IN_HEADER_SUBTITLE") })), jsxRuntime.jsx(button.Button, { disabled: !props.deviceSupported || isLoading, isLoading: isLoading, type: "button", onClick: onClick, label: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", isGreyedOut: !props.deviceSupported, icon: componentOverrideContext.PasskeyIcon }), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), props.canRegisterPasskey && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyMfaSignInDivider" }, { children: [jsxRuntime.jsx("div", { "data-supertokens": "divider" }), jsxRuntime.jsx("span", { children: t("WEBAUTHN_MFA_DIVIDER") }), jsxRuntime.jsx("div", { "data-supertokens": "divider" })] })), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: [jsxRuntime.jsx("span", utils.__assign({ "data-supertokens": "link", onClick: props.onRegisterPasskeyClick }, { children: t("WEBAUTHN_MFA_REGISTER_PASSKEY_TITLE") })), t("WEBAUTHN_MFA_REGISTER_PASSKEY_SUBTITLE")] }))] })), !props.deviceSupported && jsxRuntime.jsx(PasskeyNotSupportedError, {}), jsxRuntime.jsx(WebauthnMFAFooter, utils.__assign({}, props))] }));
});

var WebauthnMFASignUp = uiEntry.withOverride("WebauthnMFASignUp", function WebauthnMFASignUp(props) {
    var _this = this;
    var t = translationContext.useTranslation();
    var onSuccess = React__namespace.useCallback(function (_a) {
        var email = _a.email;
        props.onContinueClick(email);
    }, [props.onContinueClick]);
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.onBackButtonClicked ? (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "headerTitle withBackButton webauthn-mfa" }, { children: [jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackButtonClicked }), t("WEBAUTHN_MFA_REGISTER_PASSKEY_TITLE"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] }))) : (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle webauthn-mfa" }, { children: t("WEBAUTHN_MFA_REGISTER_PASSKEY_TITLE") }))), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "signUpFormInnerContainer" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "cautionMessage" }, { children: t("WEBAUTHN_SIGN_UP_CAUTION_MESSAGE_LABEL") })), jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: [
                            {
                                id: "email",
                                label: "",
                                labelComponent: (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "WEBAUTHN_SIGN_UP_LABEL", "data-supertokens": "emailInputLabel" }), jsxRuntime.jsx("a", utils.__assign({ onClick: props.onRecoverAccountClick, "data-supertokens": "link linkButton formLabelLinkBtn recoverAccountTrigger" }, { children: t("WEBAUTHN_RECOVER_ACCOUNT_LABEL") }))] }))),
                                optional: false,
                                autofocus: true,
                                placeholder: "",
                                getDefaultValue: function () { return props.email; },
                                autoComplete: "email",
                                // We are using the default validator that allows any string
                                validate: validators.defaultEmailValidator,
                            },
                        ], buttonLabel: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", onSuccess: onSuccess, callAPI: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
                            var email;
                            var _a;
                        ...
                        }); }, validateOnBlur: false, showLabels: true, footer: jsxRuntime.jsx(WebauthnMFAFooter, utils.__assign({}, props)) })] }))] }));
});
...
var PasskeyFeatureBlock = uiEntry.withOverride("WebauthnPasskeyFeatureBlock", function FeatureBlock(props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyFeatureBlock" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "passkeyFeatureBlockIcon" }, { children: props.icon })), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyFeatureBlockDetails" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "passkeyFeatureBlockTitle" }, { children: t(props.title) })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "passkeyFeatureBlockSubText" }, { children: t(props.subText) }))] }))] })));
});
var PasskeyFeatureBlockList = function () {
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "passkeyFeatureBlocksContainer" }, { children: blockDetails.map(function (blockDetail, index) { return (jsxRuntime.jsx(PasskeyFeatureBlock, utils.__assign({}, blockDetail), "".concat(blockDetail.title, "-").concat(index))); }) })));
};

var WebauthnMFASignUpConfirmation = uiEntry.withOverride("WebauthnMFASignUpConfirmation", function WebauthnMFASignUpConfirmation(props) {
    var _this = this;
    var t = translationContext.useTranslation();
    var _a = React__namespace.useState(false), isLoading = _a[0], setIsLoading = _a[1];
    var onClick = React__namespace.useCallback(function () { return utils.__awaiter(_this, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.onBackButtonClicked ? (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "headerTitle withBackButton webauthn-mfa" }, { children: [jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackButtonClicked }), t("WEBAUTHN_MFA_REGISTER_PASSKEY_TITLE"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] }))) : (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle webauthn-mfa" }, { children: t("WEBAUTHN_MFA_REGISTER_PASSKEY_TITLE") }))), jsxRuntime.jsx("div", { "data-supertokens": "divider" }), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyConfirmationContainer" }, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyConfirmationEmailContainer" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "continueWithLabel" }, { children: t("WEBAUTHN_CONTINUE_WITH_EMAIL_SUBTEXT") })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "enteredEmailId" }, { children: props.email }))] })), jsxRuntime.jsx(PasskeyFeatureBlockList, {}), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "passkeyConfirmationFooter" }, { children: jsxRuntime.jsx(button.Button, { disabled: isLoading, isLoading: isLoading, type: "button", onClick: onClick, label: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", isGreyedOut: false }) }))] })), jsxRuntime.jsx(WebauthnMFAFooter, utils.__assign({}, props))] }));
});
...
function MFAThemeWrapper(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsxRuntime.jsx(MFATheme, utils.__assign({}, props)) })) })));
}
function MFATheme(props) {
    ...
    if (props.featureState.accessDenied) {
        return (jsxRuntime.jsx(sessionprebuiltui.AccessDeniedScreen, { useShadowDom: false /* We set this to false, because we are already inside a shadowDom (if required) */, error: t(props.featureState.error) }));
    }
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "container webauthn-mfa" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "row" }, { children: jsxRuntime.jsx(MFAThemeRouter, utils.__assign({}, props)) })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })));
}
function MFAThemeRouter(props) {
    var _this = this;
    var onBackButtonClicked = props.onBackButtonClicked, onSignIn = props.onSignIn;
    ...
    }), activeScreen = _a[0], setActiveScreen = _a[1];
    var _b = React__namespace.useState(""), email = _b[0], setEmail = _b[1];
    var signUpEmail = props.featureState.email || email;
    var onSignUpContinue = React__namespace.useCallback(function (email) {
    ...
    var onRegisterPasskeyClick = React__namespace.useCallback(function () {
        if (!props.featureState.canRegisterPasskey) {
            return;
        }
    ...
    var clearError = React__namespace.useCallback(function () {
        props.dispatch({ type: "setError", error: undefined });
    }, [props]);
    var onError = React__namespace.useCallback(function (error) {
        props.dispatch({ type: "setError", error: error });
    }, [props]);
    var onClickSignUpConfirmationBackButton = React__namespace.useCallback(function () {
        if (!props.featureState.email) {
            setActiveScreen(MFAScreens.SignUp);
            return;
        }
    ...
    var showBackButtonOnSignUpConfirmation = React__namespace.useMemo(function () {
    ...
    var onSignUp = React__namespace.useCallback(function () { return utils.__awaiter(_this, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, props.onSignUp(signUpEmail)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var onFetchError = React__namespace.useCallback(function () {
        onError("SOMETHING_WENT_WRONG_ERROR");
    }, [onError]);
    var onClickSignUpBackButton = React__namespace.useCallback(function () {
        if (!props.featureState.hasRegisteredPassKey && !props.featureState.showBackButton) {
            return;
        }
        if (!props.featureState.hasRegisteredPassKey) {
    ...
    var showBackButtonOnSignUp = React__namespace.useMemo(function () {
...
var useFeatureReducer = function () {
    return React__namespace.useReducer(function (oldState, action) {
        switch (action.type) {
            case "setError":
                return utils.__assign(utils.__assign({}, oldState), { loaded: true, error: action.error, accessDenied: action.accessDenied || false });
            case "load":
                return utils.__assign(utils.__assign({}, oldState), { loaded: true, deviceSupported: action.deviceSupported, email: action.email, showBackButton: action.showBackButton, canRegisterPasskey: action.canRegisterPasskey, hasRegisteredPassKey: action.hasRegisteredPassKey });
            default:
                return oldState;
        }
    }, {
...
function useChildProps$2(recipe, recipeImplementation, state, dispatch, userContext, navigate) {
    ...
    var callSignInAPI = React__namespace.useCallback(function (_, __) { return utils.__awaiter(_this, void 0, void 0, function () {
        var response;
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, recipeImplementation.authenticateCredentialWithSignIn({
    ...
    var callSignUpAPI = React__namespace.useCallback(function (email, _, __) { return utils.__awaiter(_this, void 0, void 0, function () {
        var response;
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, recipeImplementation.registerCredentialWithSignUp({
                        email: email,
                        shouldTryLinkingWithSessionUser: true,
                        userContext: userContext,
                    })];
    ...
    var onSuccess = React__namespace.useCallback(function () {
    ...
    return React__namespace.useMemo(function () {
        return {
            onSignIn: function () { return utils.__awaiter(_this, void 0, void 0, function () {
                ...
                return utils.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, utils.handleCallAPI({
                                    apiFields: [],
            ...
            onSignUp: function (email) { return utils.__awaiter(_this, void 0, void 0, function () {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, utils.handleCallAPI({
                                    ...
                                    callAPI: function () {
                                        ...
                                        return callSignUpAPI.apply(void 0, utils.__spreadArray([email], params, false));
                                    },
                                })];
                        case 2:
                            _a = _b.sent(), result = _a.result, generalError = _a.generalError, fetchError = _a.fetchError;
                            ...
                            else if ((result === null || result === void 0 ? void 0 : result.status) === "OK") {
                                dispatch({ type: "setError", error: undefined });
                                void onSuccess();
                            }
                            return [3 /*break*/, 4];
            ...
            onRecoverAccountClick: function () {
                void recipe.redirect({ action: "SEND_RECOVERY_EMAIL", tenantIdFromQueryParams: "" }, navigate, {}, userContext);
            },
...
var MFAFeature = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsWebauthn }, { children: jsxRuntime.jsx(MFAFeatureInner, utils.__assign({}, props)) })) })));
};
var MFAFeatureInner = function (props) {
    ...
    var childProps = useChildProps$2(props.recipe, props.recipe.webJSRecipe, state, dispatch, userContext, props.navigate);
...
function useOnLoad(props, recipeImplementation, dispatch, userContext) {
    ...
    var handleLoadError = React__namespace.useCallback(function () {
    ...
    var onLoad = React__namespace.useCallback(function (mfaInfo) { return utils.__awaiter(_this, void 0, void 0, function () {
        var error, errorQueryParam, doSetup, stepUp, redirectToPath, showBackButton, mfaInfoEmails, email, canRegisterPasskey, hasRegisteredPassKey, browserSupportsWebauthnResponse, deviceSupported;
        return utils.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    error = undefined;
                    ...
                    if (!(mfaInfo.factors.next.length === 0 && stepUp !== "true" && doSetup !== "true")) return [3 /*break*/, 4];
                ...
                case 4:
                    ...
                    return [4 /*yield*/, props.recipe.webJSRecipe.doesBrowserSupportWebAuthn({
                            userContext: userContext,
                        })];
                case 5:
                    browserSupportsWebauthnResponse = _b.sent();
                    deviceSupported = browserSupportsWebauthnResponse.status === "OK" &&
                        (browserSupportsWebauthnResponse === null || browserSupportsWebauthnResponse === void 0 ? void 0 : browserSupportsWebauthnResponse.browserSupportsWebauthn);
                    dispatch({
                        type: "load",
...
var ContinueWithoutPasskey = uiEntry.withOverride("WebauthnContinueWithoutPasskey", function ContinueWithoutPasskeyButton(props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "continueWithoutPasskey" }, { children: jsxRuntime.jsx("a", utils.__assign({ onClick: props.onClick, "data-supertokens": "formLabelLinkBtn continueWithoutPasskeyLabel" }, { children: t("WEBAUTHN_CONTINUE_WITHOUT_PASSKEY_BUTTON") })) })));
});

var PasskeyConfirmation = uiEntry.withOverride("WebauthnPasskeyConfirmation", function PasskeyConfirmation(props) {
    var t = translationContext.useTranslation();
    var showContinueWithoutPasskey = React.useMemo(function () { return props.hideContinueWithoutPasskey !== true && props.showBackButton === true; }, [props]);
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyConfirmationContainer" }, { children: [props.email !== undefined && (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyConfirmationEmailContainer" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "continueWithLabel" }, { children: t("WEBAUTHN_CONTINUE_WITH_EMAIL_SUBTEXT") })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "enteredEmailId" }, { children: props.email }))] }))), jsxRuntime.jsx(PasskeyFeatureBlockList, {}), props.errorMessageLabel !== undefined && props.errorMessageLabel !== "" && (jsxRuntime.jsx(uiEntry.GeneralError, { error: props.errorMessageLabel })), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyConfirmationFooter" }, { children: [jsxRuntime.jsx(button.Button, { disabled: props.isContinueDisabled || !props.isPasskeySupported, isLoading: props.isLoading, type: "button", onClick: props.onContinueClick, label: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", isGreyedOut: !props.isPasskeySupported }), !props.isPasskeySupported && jsxRuntime.jsx(PasskeyNotSupportedError, {}), showContinueWithoutPasskey && props.resetFactorList !== undefined && (jsxRuntime.jsx(ContinueWithoutPasskey, { onClick: props.resetFactorList }))] }))] })));
});
...
function RecoverySuccessIcon() {
    return (jsxRuntime.jsx("svg", utils.__assign({ width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, { children: jsxRuntime.jsx("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M7.08 9.72L5.4 11.4L10.8 16.8L22.8 4.8L21.12 3.12L10.8 13.44L7.08 9.72ZM21.6 12C21.6 17.28 17.28 21.6 12 21.6C6.72 21.6 2.4 17.28 2.4 12C2.4 6.72 6.72 2.4 12 2.4C12.96 2.4 13.8 2.52 14.64 2.76L16.56 0.84C15.12 0.36 13.56 0 12 0C5.4 0 0 5.4 0 12C0 18.6 5.4 24 12 24C18.6 24 24 18.6 24 12H21.6Z", fill: "#40A700" }) })));
}

var PasskeyRecoverAccountSuccess = function () {
    var t = translationContext.useTranslation();
    var onContinueClick = function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uiEntry.redirectToAuth({ show: "signin" })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyRecoverAccountSuccessContainer" }, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "header" }, { children: [jsxRuntime.jsx(RecoverySuccessIcon, {}), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerText" }, { children: t("WEBAUTHN_ACCOUNT_RECOVERY_SUCCESSFUL_LABEL") }))] })), jsxRuntime.jsx("div", { "data-supertokens": "divider" }), jsxRuntime.jsx(button.Button, { disabled: false, isLoading: false, type: "button", onClick: onContinueClick, label: "WEBAUTHN_EMAIL_CONTINUE_BUTTON" })] })));
};
...
function PasskeyRecoverAccountWithTokenTheme(props) {
    ...
    var _a = React.useState(false), isPasskeySupported = _a[0], setIsPasskeySupported = _a[1];
    React.useEffect(function () {
        void (function () { return utils.__awaiter(_this, void 0, void 0, function () {
            var browserSupportsWebauthn;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, props.recipeImplementation.doesBrowserSupportWebAuthn({
                            userContext: userContext,
                        })];
                    case 1:
    ...
    var renderInnerContent = function () {
        ...
        if (props.activeScreen === RecoverAccountScreen.ContinueWithPasskey) {
            return (jsxRuntime.jsx(PasskeyConfirmation, utils.__assign({}, props, { email: ((_a = props.registerOptions) === null || _a === void 0 ? void 0 : _a.user.name) || undefined, onContinueClick: props.onContinueClick, errorMessageLabel: props.errorMessageLabel || undefined, isLoading: props.isLoading, hideContinueWithoutPasskey: true, isContinueDisabled: props.registerOptions === null, isPasskeySupported: isPasskeySupported, showBackButton: false })));
        }
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "container authPage singleFactor" }, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "row" }, { children: [props.activeScreen !== RecoverAccountScreen.Success && (jsxRuntime.jsx(uiEntry.AuthPageHeader, { factorIds: ["webauthn"], isSignUp: true, onSignInUpSwitcherClick: undefined, hasSeparateSignUpView: true, resetFactorList: onResetFactorList, showBackButton: false, oauth2ClientInfo: undefined, headerLabel: props.activeScreen === RecoverAccountScreen.ContinueWithPasskey
                                    ? "WEBAUTHN_CREATE_A_PASSKEY_HEADER"
                                    : undefined, hideSignInSwitcher: true })), renderInnerContent(), props.activeScreen !== RecoverAccountScreen.Success && (jsxRuntime.jsx(uiEntry.AuthPageFooter, { factorIds: [], isSignUp: true, hasSeparateSignUpView: true, privacyPolicyLink: privacyPolicyLink, termsOfServiceLink: termsOfServiceLink }))] })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })) })) })));
}
...
var RecoverAccountUsingToken = function (props) {
    ...
    var _b = React.useState(null), errorMessageLabel = _b[0], setErrorMessageLabel = _b[1];
    var _c = React.useState(null), preloadedRegisterOptions = _c[0], setPreloadedRegisterOptions = _c[1];
    var _d = React.useState(RecoverAccountScreen.ContinueWithPasskey), activeScreen = _d[0], setActiveScreen = _d[1];
    var _e = React.useState(false), isLoading = _e[0], setLoading = _e[1];
    // Get the reset options as soon as the page loads and afterwards use the token
    // with the options.
    var fetchAndStoreRegisterOptions = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2: return [2 /*return*/, props.recipe.webJSRecipe.getRegisterOptions({
                        userContext: props.userContext,
    ...
    utils.useOnMountAPICall(fetchAndStoreRegisterOptions, function (registerOptions) { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
    ...
    var callAPI = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        ...
        return utils.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!(preloadedRegisterOptions !== null && new Date(preloadedRegisterOptions.expiresAt) > new Date())) return [3 /*break*/, 1];
                    _a = preloadedRegisterOptions;
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, props.recipe.webJSRecipe.getRegisterOptions({
                        userContext: props.userContext,
                        recoverAccountToken: token,
                    })];
                case 2:
                ...
                case 3:
                    ...
                    return [4 /*yield*/, props.recipe.webJSRecipe.createCredential({
                ...
                case 4:
                    ...
                    return [4 /*yield*/, props.recipe.webJSRecipe.recoverAccount({
                            token: token,
    ...
    var onContinueClick = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
    ...
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsWebauthn }, { children: jsxRuntime.jsxs(React__namespace.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(PasskeyRecoverAccountWithTokenTheme, utils.__assign({}, childProps)), props.children &&
                        React__namespace.Children.map(props.children, function (child) {
                            if (React__namespace.isValidElement(child)) {
...
var PasskeyRecoveryEmailSent = uiEntry.withOverride("WebauthnPasskeyRecoveryEmailSent", function (props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyEmailSentContainer" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle" }, { children: t("WEBAUTHN_EMAIL_SENT_LABEL") })), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "emailSentDescription" }, { children: [t("WEBAUTHN_EMAIL_SENT_LABEL_PRE_EMAIL"), props.email, t("WEBAUTHN_EMAIL_SENT_LABEL_POST_EMAIL"), jsxRuntime.jsx("a", utils.__assign({ onClick: props.onEmailChangeClick, "data-supertokens": "link linkButton formLabelLinkBtn changeEmailBtn" }, { children: t("WEBAUTHN_RESEND_OR_CHANGE_EMAIL_LABEL") }))] }))] })));
});

var WebauthnRecoverAccountForm = uiEntry.withOverride("WebauthnRecoverAccountForm", function (props) {
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: function () { return props.setError(undefined); }, onFetchError: function () { return props.setError("WEBAUTHN_ACCOUNT_RECOVERY_GENERAL_ERROR"); }, onError: function () { return props.setError("WEBAUTHN_ACCOUNT_RECOVERY_GENERAL_ERROR"); }, formFields: [
            {
                id: "email",
                label: "",
                labelComponent: (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: jsxRuntime.jsx(formBase.Label, { value: "WEBAUTHN_SIGN_UP_LABEL", "data-supertokens": "emailInputLabel" }) }))),
                optional: false,
                autofocus: true,
                placeholder: "",
                autoComplete: "email",
        ...
        ], buttonLabel: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", onSuccess: props.onSuccess, callAPI: function (formFields) { return utils.__awaiter(void 0, void 0, void 0, function () {
            var email, res;
            var _a;
            return utils.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, utils.__assign(utils.__assign({}, res), { email: email })];
                }
            });
...
var WebauthnRecoverAccount = uiEntry.withOverride("WebauthnRecoverAccount", function (props) {
    var t = translationContext.useTranslation();
    var _a = React.useState(undefined), errorLabel = _a[0], setErrorLabel = _a[1];
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyRecoverAccountFormContainer" }, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyRecoverAccountFormHeaderWrapper" }, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeyRecoverAccountFormHeader headerTitle withBackButton" }, { children: [jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackClick }), t("WEBAUTHN_RECOVER_ACCOUNT_LABEL"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "passkeyRecoverAccountFormSubHeader" }, { children: t("WEBAUTHN_RECOVER_ACCOUNT_SUBHEADER_LABEL") }))] })), errorLabel !== undefined && (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "errorContainer" }, { children: jsxRuntime.jsx(uiEntry.GeneralError, { error: errorLabel }) }))), jsxRuntime.jsx(WebauthnRecoverAccountForm, utils.__assign({}, props, { setError: setErrorLabel }))] })));
});

var SendRecoveryEmailFormThemeInner = function (props) {
    return props.activeScreen === SendRecoveryEmailScreen.RecoverAccount ? (jsxRuntime.jsx(WebauthnRecoverAccount, { onSuccess: props.onRecoverAccountFormSuccess, onBackClick: props.onRecoverAccountBackClick, recipeImplementation: props.recipeImplementation })) : props.activeScreen === SendRecoveryEmailScreen.RecoverEmailSent ? (jsxRuntime.jsx(PasskeyRecoveryEmailSent, { email: props.recoverAccountEmail, onEmailChangeClick: props.onEmailChangeClick })) : null;
};
var SendRecoveryEmailFormTheme = function (props) {
    ...
    var privacyPolicyLink = stInstance.privacyPolicyLink;
    var termsOfServiceLink = stInstance.termsOfServiceLink;
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "container authPage recoverAccountWithEmail" }, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "row" }, { children: [props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsx(SendRecoveryEmailFormThemeInner, utils.__assign({}, props, { activeScreen: props.activeScreen, setActiveScreen: props.setActiveScreen })), props.activeScreen !== SendRecoveryEmailScreen.RecoverEmailSent && (jsxRuntime.jsx(uiEntry.AuthPageFooter, { factorIds: [], isSignUp: true, hasSeparateSignUpView: true, privacyPolicyLink: privacyPolicyLink, termsOfServiceLink: termsOfServiceLink }))] })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })) })) })));
};
...
var SendRecoveryEmailForm = function (props) {
    ...
    var _a = React__namespace.useState(), error = _a[0], setError = _a[1];
    var _b = React__namespace.useState(""), recoverAccountEmail = _b[0], setRecoverAccountEmail = _b[1];
    var _c = React__namespace.useState(SendRecoveryEmailScreen.RecoverAccount), activeScreen = _c[0], setActiveScreen = _c[1];
    ...
    var onRecoverAccountBackClick = function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, uiEntry.redirectToAuth({ show: "signup" })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsWebauthn }, { children: jsxRuntime.jsxs(React__namespace.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SendRecoveryEmailFormTheme, utils.__assign({}, childProps)), props.children &&
                        React__namespace.Children.map(props.children, function (child) {
                            if (React__namespace.isValidElement(child)) {
                                return React__namespace.cloneElement(child, childProps);
                            }
...
var ContinueWithPasskey = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "continueWithPasskeyButtonWrapper" }, { children: [jsxRuntime.jsx(button.Button, { isLoading: isLoading, onClick: function () {
                    continueWithPasskeyClicked();
                }, type: "button", label: "WEBAUTHN_COMBO_CONTINUE_WITH_PASSKEY_BUTTON", disabled: !isPasskeySupported, isGreyedOut: !isPasskeySupported, icon: componentOverrideContext.PasskeyIcon }), !isPasskeySupported && jsxRuntime.jsx(PasskeyNotSupportedError, {})] })));
};
...
var ContinueWithPasskeyTheme = function (props) {
    var rootStyle = superTokens.SuperTokens.getInstanceOrThrow().rootStyle;
    return (jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsxRuntime.jsx(ContinueWithPasskeyWithOverride, utils.__assign({}, props)) })));
};

function PasskeySignInTheme(props) {
    var _this = this;
    var userContext = uiEntry.useUserContext();
    var _a = React__namespace.useState(null), error = _a[0], setError = _a[1];
    var _b = React__namespace.useState(false), isLoading = _b[0], setIsLoading = _b[1];
    var callAPI = React__namespace.useCallback(function (_, __) { return utils.__awaiter(_this, void 0, void 0, function () {
        var response;
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    var handleWebauthnSignInClick = function () { return utils.__awaiter(_this, void 0, void 0, function () {
        var fieldUpdates, _a, result, generalError, fetchError;
        return utils.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    var rootStyle = superTokens.SuperTokens.getInstanceOrThrow().rootStyle;
    var activeStyle = props.config.signInAndUpFeature.style;
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "passkeySignInContainer" }, { children: [error !== "" && error !== null && jsxRuntime.jsx(uiEntry.GeneralError, { error: error }), jsxRuntime.jsx(ContinueWithPasskeyTheme, utils.__assign({}, props, { continueWithPasskeyClicked: handleWebauthnSignInClick, config: props.config, continueTo: "SIGN_IN", isLoading: isLoading, isPasskeySupported: props.isPasskeySupported }))] })) })) })));
}

function useChildProps$1(recipe, factorIds, onAuthSuccess, error, onError, userContext, clearError, resetFactorList, onSignInUpSwitcherClick, showBackButton, isPasskeySupported) {
    var _this = this;
    ...
    return React__namespace.useMemo(function () {
        return {
            ...
            onFetchError: function ( /* err: Response*/) { return utils.__awaiter(_this, void 0, void 0, function () {
                return utils.__generator(this, function (_a) {
                    onError("SOMETHING_WENT_WRONG_ERROR");
                    return [2 /*return*/];
                });
...
var SignInFeatureInner = function (props) {
    ...
    var _a = React.useState(true), isPasskeySupported = _a[0], setIsPasskeySupported = _a[1];
    React.useEffect(function () {
        void (function () { return utils.__awaiter(void 0, void 0, void 0, function () {
            var browserSupportsWebauthn;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    var childProps = useChildProps$1(props.recipe, props.factorIds, props.onAuthSuccess, props.error, props.onError, userContext, props.clearError, props.resetFactorList, props.onSignInUpSwitcherClick, props.showBackButton, isPasskeySupported);
    return (jsxRuntime.jsxs(React__namespace.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(PasskeySignInTheme, utils.__assign({}, childProps)), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
...
var SignInWithPasskeyFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignInFeatureInner, utils.__assign({}, props)) })));
};
...
var SignUpFormInner = uiEntry.withOverride("WebauthnPasskeySignUpForm", function PasskeyEmailForm(props) {
    var _this = this;
    var t = translationContext.useTranslation();
    var defaultFooter = props.resetFactorList !== undefined && props.showBackButton ? (jsxRuntime.jsx(ContinueWithoutPasskey, { onClick: props.resetFactorList })) : undefined;
    var onEmailContinueSuccess = React.useCallback(function (params) {
    ...
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "signUpFormInnerContainer" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "cautionMessage" }, { children: t("WEBAUTHN_SIGN_UP_CAUTION_MESSAGE_LABEL") })), jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: onError, formFields: [
                    {
                        id: "email",
                        label: "",
                        labelComponent: (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "WEBAUTHN_SIGN_UP_LABEL", "data-supertokens": "emailInputLabel" }), jsxRuntime.jsx("a", utils.__assign({ onClick: props.onRecoverAccountClick, "data-supertokens": "link linkButton formLabelLinkBtn recoverAccountTrigger" }, { children: t("WEBAUTHN_RECOVER_ACCOUNT_LABEL") }))] }))),
                ...
                ], buttonLabel: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", onSuccess: onEmailContinueSuccess, callAPI: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
                    var email;
                    var _a;
                    return utils.__generator(this, function (_b) {
                        email = (_a = formFields.find(function (field) { return field.id === "email"; })) === null || _a === void 0 ? void 0 : _a.value;
                ...
                }); }, validateOnBlur: false, showLabels: true, footer: props.footer || defaultFooter })] })));
});
var SignUpForm = function (props) {
    var _a = React.useState(null), continueClickResponse = _a[0], setContinueClickResponse = _a[1];
    var userContext = uiEntry.useUserContext();
    var _b = React.useState(undefined), errorLabel = _b[0], setErrorLabel = _b[1];
    var _c = React.useState(false), isLoading = _c[0], setIsLoading = _c[1];
    var _d = React.useState(false), isPasskeySupported = _d[0], setIsPasskeySupported = _d[1];
    React.useEffect(function () {
        void (function () { return utils.__awaiter(void 0, void 0, void 0, function () {
            var browserSupportsWebauthn;
            return utils.__generator(this, function (_a) {
    ...
    var onContinueClickCallback = React.useCallback(function (params) {
        setContinueClickResponse(params);
        props.onContinueClick(params);
    }, [setContinueClickResponse, props]);
    var callAPI = React.useCallback(function (_, __) { return utils.__awaiter(void 0, void 0, void 0, function () {
        var response;
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, props.recipeImplementation.registerCredentialWithSignUp({
    ...
    var onConfirmationClick = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        var fieldUpdates, _a, result, generalError, fetchError, e_1;
        return utils.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    return props.activeScreen === SignUpScreen.SignUpForm ? (jsxRuntime.jsx(SignUpFormInner, utils.__assign({}, props, { onContinueClick: onContinueClickCallback }))) : props.activeScreen === SignUpScreen.PasskeyConfirmation ? (jsxRuntime.jsx(PasskeyConfirmation, utils.__assign({}, props, { email: (continueClickResponse === null || continueClickResponse === void 0 ? void 0 : continueClickResponse.email) || "", onContinueClick: onConfirmationClick, errorMessageLabel: errorLabel, isLoading: isLoading, isPasskeySupported: isPasskeySupported }))) : props.activeScreen === SignUpScreen.Error ? (jsxRuntime.jsx(SignUpSomethingWentWrong, { onClick: function () { return props.setActiveScreen(SignUpScreen.SignUpForm); } })) : null;
};
...
function PasskeySignUpTheme(props) {
    ...
    var privacyPolicyLink = stInstance.privacyPolicyLink;
    var termsOfServiceLink = stInstance.termsOfServiceLink;
    var _a = React.useState(SignUpScreen.SignUpForm), activeScreen = _a[0], setActiveScreen = _a[1];
    var onContinueClick = React.useCallback(function () {
        setActiveScreen(SignUpScreen.PasskeyConfirmation);
    }, [setActiveScreen]);
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "container authPage ".concat(props.factorIds.length > 1 ? "multiFactor" : "singleFactor") }, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "row" }, { children: [![SignUpScreen.Error].includes(activeScreen) && (jsxRuntime.jsx(uiEntry.AuthPageHeader, { factorIds: props.factorIds, isSignUp: true, onSignInUpSwitcherClick: props.onSignInUpSwitcherClick, hasSeparateSignUpView: true, resetFactorList: props.resetFactorList, showBackButton: props.showBackButton, oauth2ClientInfo: undefined, headerLabel: activeScreen === SignUpScreen.PasskeyConfirmation
                                    ? "WEBAUTHN_CREATE_A_PASSKEY_HEADER"
                                    : undefined, hideSignInSwitcher: activeScreen === SignUpScreen.PasskeyConfirmation })), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsx(SignUpForm, utils.__assign({}, props, { onContinueClick: onContinueClick, activeScreen: activeScreen, setActiveScreen: setActiveScreen })), jsxRuntime.jsx(uiEntry.AuthPageFooter, { factorIds: props.factorIds, isSignUp: true, hasSeparateSignUpView: true, privacyPolicyLink: privacyPolicyLink, termsOfServiceLink: termsOfServiceLink })] })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })) })) })));
}
...
var SignUpFeatureInner = function (props) {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(PasskeySignUpTheme, utils.__assign({}, childProps)), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, utils.__assign({}, childProps));
                    }
...
var SignInUpFeatureFullPage = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignUpFeatureInner, utils.__assign({}, props)) })));
};
...
var WebauthnPreBuiltUI = /** @class */ (function (_super) {
    ...
    function WebauthnPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            if (useComponentOverrides === void 0) { useComponentOverrides = componentOverrideContext.useContext; }
            var features = {};
            if (_this.recipeInstance.config.disableDefaultUI !== true &&
                _this.recipeInstance.config.recoveryFeature.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(componentOverrideContext.DEFAULT_WEBAUTHN_RECOVERY_PATH));
                ...
                var normalisedFullPathForRecoveryThroughEmail = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(componentOverrideContext.DEFAULT_WEBAUTHN_SEND_RECOVERY_EMAIL_PATH));
                ...
                var normalisedFullPathForMFA = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(componentOverrideContext.DEFAULT_WEBAUTHN_MFA_PATH));
                features[normalisedFullPathForMFA.getAsStringDangerous()] = {
                    matches: utils.matchRecipeIdUsingQueryParams(_this.recipeInstance.config.recipeId),
                    component: function (props) { return _this.getFeatureComponent("webauthn-mfa", props, useComponentOverrides); },
                    recipeID: componentOverrideContext.Webauthn.RECIPE_ID,
                };
            }
            return features;
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "webauthn-recover-account") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(RecoverAccountUsingToken, utils.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            else if (componentName === "webauthn-send-recovery-email") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(SendRecoveryEmailForm, utils.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            else if (componentName === "webauthn-mfa") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(MFAFeature, utils.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            throw new Error("Should never come here.");
        };
    ...
    WebauthnPreBuiltUI.getFeatureComponent = function (componentName, props, useComponentOverrides) {
        if (useComponentOverrides === void 0) { useComponentOverrides = componentOverrideContext.useContext; }
        return WebauthnPreBuiltUI.getInstanceOrInitAndGetInstance().getFeatureComponent(componentName, props, useComponentOverrides);
    };
        ...
        return [
            {
                ...
                preloadInfoAndRunChecks: function (firstFactors, _, isSignUp) {
                    return utils.__awaiter(this, void 0, void 0, function () {
                        return utils.__generator(this, function (_a) {
                            return [2 /*return*/, {
                                    shouldDisplay: isSignUp && firstFactors.length === 1 && firstFactors.includes(types.FactorIds.WEBAUTHN),
                                    preloadInfo: {},
                                }];
                        });
                    });
                },
                component: function (props) { return (jsxRuntime.jsx(SignInUpFeatureFullPage, utils.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext.useContext, factorIds: [types.FactorIds.WEBAUTHN] }), "webauthnSignUpFullPage")); },
            },
            {
                type: "SIGN_UP",
                factorIds: [types.FactorIds.WEBAUTHN],
                displayOrder: 4,
                component: function (props) { return (jsxRuntime.jsx(SignUpWithPasskeyFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, factorIds: [types.FactorIds.WEBAUTHN], useComponentOverrides: componentOverrideContext.useContext }), "webauthn-sign-up")); },
            },
            {
                type: "SIGN_IN",
                factorIds: [types.FactorIds.WEBAUTHN],
                displayOrder: 4,
                component: function (props) { return (jsxRuntime.jsx(SignInWithPasskeyFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, factorIds: [types.FactorIds.WEBAUTHN], useComponentOverrides: componentOverrideContext.useContext }), "webauthn-sign-in")); },
            },
        ];
    };
    // For tests
