        ...
        utils.__assign(
            { "data-supertokens": "passkeyFeatureBlock" },
            {
                children: [
                    jsxRuntime.jsx(
                        "div",
                        utils.__assign({ "data-supertokens": "passkeyFeatureBlockIcon" }, { children: props.icon })
                    ),
                    jsxRuntime.jsxs(
                        "div",
                        utils.__assign(
            ...
            { "data-supertokens": "container webauthn-mfa" },
            {
                children: [
                    jsxRuntime.jsx(
                        ...
                        utils.__assign(
                            { "data-supertokens": "row" },
                            { children: jsxRuntime.jsx(MFAThemeRouter, utils.__assign({}, props)) }
                        )
                    ),
                                        ...
                                        utils.handleCallAPI({
                                            ...
                                            callAPI: function () {
                                                ...
                                                return callSignUpAPI.apply(
                                                    void 0,
                                                    utils.__spreadArray([email], params, false)
                                                );
                                            },
                                        }),
                                    ];
        ...
        utils.__assign(
            { "data-supertokens": "passkeyRecoverAccountFormContainer" },
            {
                children: [
                    ...
                    jsxRuntime.jsx(WebauthnRecoverAccountForm, utils.__assign({}, props, { setError: setErrorLabel })),
                ],
            }
        )
    );
                    ...
                    utils.__assign(
                        ...
                        },
                        {
                            children: jsxRuntime.jsxs(React__namespace.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(SendRecoveryEmailFormTheme, utils.__assign({}, childProps)),
                                    props.children &&
                                        React__namespace.Children.map(props.children, function (child) {
                                            if (React__namespace.isValidElement(child)) {
                                                return React__namespace.cloneElement(child, childProps);
...
var SignInFeatureInner = function (props) {
    ...
    return jsxRuntime.jsxs(React__namespace.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(PasskeySignInTheme, utils.__assign({}, childProps)),
            props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
...
var SignUpForm = function (props) {
    ...
    return props.activeScreen === SignUpScreen.SignUpForm
        ? jsxRuntime.jsx(SignUpFormInner, utils.__assign({}, props, { onContinueClick: onContinueClickCallback }))
...
var SignUpFeatureInner = function (props) {
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(PasskeySignUpTheme, utils.__assign({}, childProps)),
            props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, utils.__assign({}, childProps));
