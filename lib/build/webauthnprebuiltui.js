...
var PasskeyNotSupportedError = uiEntry.withOverride("WebauthnPasskeyNotSupportedError", function () {
    ...
    return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "continueWithPasskeyButtonNotSupported" }, { children: t("WEBAUTHN_PASSKEY_NOT_SUPPORTED_BY_BROWSER") })));
});
...
var WebauthnMFASignIn = uiEntry.withOverride("WebauthnMFASignIn", function WebauthnMFASignIn(props) {
    ...
    var onClick = React__namespace.useCallback(function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
...
var WebauthnMFASignUp = uiEntry.withOverride("WebauthnMFASignUp", function WebauthnMFASignUp(props) {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.onBackButtonClicked ? (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerTitle withBackButton webauthn-mfa" }, { children: [jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackButtonClicked }), t("WEBAUTHN_MFA_REGISTER_PASSKEY_TITLE"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] }))) : (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerTitle webauthn-mfa" }, { children: t("WEBAUTHN_MFA_REGISTER_PASSKEY_TITLE") }))), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "signUpFormInnerContainer" }, { children: [jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "cautionMessage" }, { children: t("WEBAUTHN_SIGN_UP_CAUTION_MESSAGE_LABEL") })), jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: [
                        ...
                        ], buttonLabel: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", onSuccess: onSuccess, callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                            var email;
                            var _a;
                        ...
                        }); }, validateOnBlur: false, showLabels: true, footer: undefined })] }))] }));
});
...
var PasskeyFeatureBlockList = function () {
    return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "passkeyFeatureBlocksContainer" }, { children: blockDetails.map(function (blockDetail, index) { return (jsxRuntime.jsx(PasskeyFeatureBlock, genericComponentOverrideContext.__assign({}, blockDetail), "".concat(blockDetail.title, "-").concat(index))); }) })));
};
...
function MFAThemeRouter(props) {
    ...
    var showBackButtonOnSignUpConfirmation = React__namespace.useMemo(function () {
        return (!!props.featureState.email || props.featureState.hasRegisteredPassKey || props.featureState.showBackButton);
    }, [props.featureState.email, props.featureState.hasRegisteredPassKey, props.featureState.showBackButton]);
    var onSignUp = React__namespace.useCallback(function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
...
var useFeatureReducer = function () {
    return React__namespace.useReducer(function (oldState, action) {
        switch (action.type) {
            case "setError":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { loaded: true, error: action.error, accessDenied: action.accessDenied || false });
            case "load":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { loaded: true, deviceSupported: action.deviceSupported, email: action.email, showBackButton: action.showBackButton, canRegisterPasskey: action.canRegisterPasskey, hasRegisteredPassKey: action.hasRegisteredPassKey });
            default:
                return oldState;
        }
    }, {
...
function useChildProps$2(recipe, recipeImplementation, state, dispatch, userContext, navigate) {
    ...
    var callSignInAPI = React__namespace.useCallback(function (_, __) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        var response;
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    var callSignUpAPI = React__namespace.useCallback(function (email, _, __) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        var response;
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    return React__namespace.useMemo(function () {
        return {
            onSignIn: function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, genericComponentOverrideContext.handleCallAPI({
                                    apiFields: [],
            ...
            onSignUp: function (email) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, genericComponentOverrideContext.handleCallAPI({
                                    ...
                                    callAPI: function () {
                                        ...
                                        return callSignUpAPI.apply(void 0, genericComponentOverrideContext.__spreadArray([email], params, false));
                                    },
                                })];
                        case 2:
                            _a = _b.sent(), result = _a.result, generalError = _a.generalError, fetchError = _a.fetchError;
...
var MFAFeature = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, genericComponentOverrideContext.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, genericComponentOverrideContext.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsWebauthn }, { children: jsxRuntime.jsx(MFAFeatureInner, genericComponentOverrideContext.__assign({}, props)) })) })));
};
...
var PasskeyRecoverAccountSuccess = function () {
    ...
    return (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "passkeyRecoverAccountSuccessContainer" }, { children: [jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "header" }, { children: [jsxRuntime.jsx(RecoverySuccessIcon, {}), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerText" }, { children: t("WEBAUTHN_ACCOUNT_RECOVERY_SUCCESSFUL_LABEL") }))] })), jsxRuntime.jsx("div", { "data-supertokens": "divider" }), jsxRuntime.jsx(button.Button, { disabled: false, isLoading: false, type: "button", onClick: onContinueClick, label: "WEBAUTHN_EMAIL_CONTINUE_BUTTON" })] })));
};
...
function PasskeyRecoverAccountWithTokenTheme(props) {
    ...
    React.useEffect(function () {
        void (function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "container authPage singleFactor" }, { children: [jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "row" }, { children: [props.activeScreen !== RecoverAccountScreen.Success && (jsxRuntime.jsx(uiEntry.AuthPageHeader, { factorIds: ["webauthn"], isSignUp: true, onSignInUpSwitcherClick: undefined, hasSeparateSignUpView: true, resetFactorList: onResetFactorList, showBackButton: false, oauth2ClientInfo: undefined, headerLabel: props.activeScreen === RecoverAccountScreen.ContinueWithPasskey
...
var RecoverAccountUsingToken = function (props) {
    ...
    // with the options.
    var fetchAndStoreRegisterOptions = React.useCallback(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    genericComponentOverrideContext.useOnMountAPICall(fetchAndStoreRegisterOptions, function (registerOptions) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        return genericComponentOverrideContext.__generator(this, function (_a) {
    ...
    var callAPI = React.useCallback(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
    ...
    var onContinueClick = React.useCallback(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
    ...
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, genericComponentOverrideContext.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, genericComponentOverrideContext.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsWebauthn }, { children: jsxRuntime.jsxs(React__namespace.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(PasskeyRecoverAccountWithTokenTheme, genericComponentOverrideContext.__assign({}, childProps)), props.children &&
                        React__namespace.Children.map(props.children, function (child) {
                            if (React__namespace.isValidElement(child)) {
...
var PasskeyRecoveryEmailSent = uiEntry.withOverride("WebauthnPasskeyRecoveryEmailSent", function (props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "passkeyEmailSentContainer" }, { children: [jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerTitle" }, { children: t("WEBAUTHN_EMAIL_SENT_LABEL") })), jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "emailSentDescription" }, { children: [t("WEBAUTHN_EMAIL_SENT_LABEL_PRE_EMAIL"), props.email, t("WEBAUTHN_EMAIL_SENT_LABEL_POST_EMAIL"), jsxRuntime.jsx("a", genericComponentOverrideContext.__assign({ onClick: props.onEmailChangeClick, "data-supertokens": "link linkButton formLabelLinkBtn changeEmailBtn" }, { children: t("WEBAUTHN_RESEND_OR_CHANGE_EMAIL_LABEL") }))] }))] })));
});
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: function () { return props.setError(undefined); }, onFetchError: function () { return props.setError("WEBAUTHN_ACCOUNT_RECOVERY_GENERAL_ERROR"); }, onError: function () { return props.setError("WEBAUTHN_ACCOUNT_RECOVERY_GENERAL_ERROR"); }, formFields: [
            {
                id: "email",
                label: "",
                labelComponent: (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: jsxRuntime.jsx(formBase.Label, { value: "WEBAUTHN_SIGN_UP_LABEL", "data-supertokens": "emailInputLabel" }) }))),
                optional: false,
                autofocus: true,
                placeholder: "",
                autoComplete: "email",
        ...
        ], buttonLabel: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", onSuccess: props.onSuccess, callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
            var email, res;
            var _a;
            return genericComponentOverrideContext.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, res), { email: email })];
                }
            });
...
var WebauthnRecoverAccount = uiEntry.withOverride("WebauthnRecoverAccount", function (props) {
    ...
    return (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "passkeyRecoverAccountFormContainer" }, { children: [jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "passkeyRecoverAccountFormHeaderWrapper" }, { children: [jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "passkeyRecoverAccountFormHeader headerTitle withBackButton" }, { children: [jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackClick }), t("WEBAUTHN_RECOVER_ACCOUNT_LABEL"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] })), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "passkeyRecoverAccountFormSubHeader" }, { children: t("WEBAUTHN_RECOVER_ACCOUNT_SUBHEADER_LABEL") }))] })), errorLabel !== undefined && (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "errorContainer" }, { children: jsxRuntime.jsx(uiEntry.GeneralError, { error: errorLabel }) }))), jsxRuntime.jsx(WebauthnRecoverAccountForm, genericComponentOverrideContext.__assign({}, props, { setError: setErrorLabel }))] })));
});
...
var SendRecoveryEmailForm = function (props) {
    ...
    var onRecoverAccountBackClick = function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, genericComponentOverrideContext.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, genericComponentOverrideContext.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsWebauthn }, { children: jsxRuntime.jsxs(React__namespace.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SendRecoveryEmailFormTheme, genericComponentOverrideContext.__assign({}, childProps)), props.children &&
                        React__namespace.Children.map(props.children, function (child) {
                            if (React__namespace.isValidElement(child)) {
                                return React__namespace.cloneElement(child, childProps);
                            }
...
var ContinueWithPasskey = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "continueWithPasskeyButtonWrapper" }, { children: [jsxRuntime.jsx(button.Button, { isLoading: isLoading, onClick: function () {
                    continueWithPasskeyClicked();
                }, type: "button", label: "WEBAUTHN_COMBO_CONTINUE_WITH_PASSKEY_BUTTON", disabled: !isPasskeySupported, isGreyedOut: !isPasskeySupported, icon: recipe.PasskeyIcon }), !isPasskeySupported && jsxRuntime.jsx(PasskeyNotSupportedError, {})] })));
};
...
var ContinueWithPasskeyTheme = function (props) {
    var rootStyle = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().rootStyle;
    return (jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsxRuntime.jsx(ContinueWithPasskeyWithOverride, genericComponentOverrideContext.__assign({}, props)) })));
};
...
function PasskeySignInTheme(props) {
    ...
    var callAPI = React__namespace.useCallback(function (_, __) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        var response;
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    var handleWebauthnSignInClick = function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        var fieldUpdates, _a, result, generalError, fetchError;
        return genericComponentOverrideContext.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
...
function useChildProps$1(recipe, factorIds, onAuthSuccess, error, onError, userContext, clearError, resetFactorList, onSignInUpSwitcherClick, showBackButton, isPasskeySupported) {
    ...
    return React__namespace.useMemo(function () {
        return {
            ...
            onFetchError: function ( /* err: Response*/) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    onError("SOMETHING_WENT_WRONG_ERROR");
                    return [2 /*return*/];
                });
...
var SignInFeatureInner = function (props) {
    ...
    React.useEffect(function () {
        void (function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
            var browserSupportsWebauthn;
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    return (jsxRuntime.jsxs(React__namespace.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(PasskeySignInTheme, genericComponentOverrideContext.__assign({}, childProps)), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
...
var SignInWithPasskeyFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, genericComponentOverrideContext.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignInFeatureInner, genericComponentOverrideContext.__assign({}, props)) })));
};
...
var SignUpSomethingWentWrong = uiEntry.withOverride("WebauthnPasskeySignUpSomethingWentWrong", function SomethingWentWrong(props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "somethingWentWrongContainer" }, { children: [jsxRuntime.jsx(SomethingWentWrongIcon, {}), jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "somethingWentWrongErrorDetailsContainer" }, { children: [jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "label" }, { children: t("WEBAUTHN_UNRECOVERABLE_ERROR") })), jsxRuntime.jsx("div", { "data-supertokens": "divider" }), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "errorDetails" }, { children: t("WEBAUTHN_UNRECOVERABLE_ERROR_DETAILS") }))] })), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "goBackButtonContainer" }, { children: jsxRuntime.jsx("a", genericComponentOverrideContext.__assign({ onClick: props.onClick, "data-supertokens": "formLabelLinkBtn errorGoBackLabel" }, { children: t("WEBAUTHN_ERROR_GO_BACK_BUTTON_LABEL") })) }))] })));
});
...
var SignUpFormInner = uiEntry.withOverride("WebauthnPasskeySignUpForm", function PasskeyEmailForm(props) {
    ...
    return (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "signUpFormInnerContainer" }, { children: [jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "cautionMessage" }, { children: t("WEBAUTHN_SIGN_UP_CAUTION_MESSAGE_LABEL") })), jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: onError, formFields: [
                ...
                ], buttonLabel: "WEBAUTHN_EMAIL_CONTINUE_BUTTON", onSuccess: onEmailContinueSuccess, callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                    var email;
                    var _a;
                    return genericComponentOverrideContext.__generator(this, function (_b) {
                        email = (_a = formFields.find(function (field) { return field.id === "email"; })) === null || _a === void 0 ? void 0 : _a.value;
...
var SignUpForm = function (props) {
    ...
    var callAPI = React.useCallback(function (_, __) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        var response;
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var onConfirmationClick = React.useCallback(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        var fieldUpdates, _a, result, generalError, fetchError, e_1;
        return genericComponentOverrideContext.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
...
function PasskeySignUpTheme(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "container authPage ".concat(props.factorIds.length > 1 ? "multiFactor" : "singleFactor") }, { children: [jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "row" }, { children: [![SignUpScreen.Error].includes(activeScreen) && (jsxRuntime.jsx(uiEntry.AuthPageHeader, { factorIds: props.factorIds, isSignUp: true, onSignInUpSwitcherClick: props.onSignInUpSwitcherClick, hasSeparateSignUpView: true, resetFactorList: props.resetFactorList, showBackButton: props.showBackButton, oauth2ClientInfo: undefined, headerLabel: activeScreen === SignUpScreen.PasskeyConfirmation
                                    ? "WEBAUTHN_CREATE_A_PASSKEY_HEADER"
                                    : undefined, hideSignInSwitcher: activeScreen === SignUpScreen.PasskeyConfirmation })), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsx(SignUpForm, genericComponentOverrideContext.__assign({}, props, { onContinueClick: onContinueClick, activeScreen: activeScreen, setActiveScreen: setActiveScreen })), jsxRuntime.jsx(uiEntry.AuthPageFooter, { factorIds: props.factorIds, isSignUp: true, hasSeparateSignUpView: true, privacyPolicyLink: privacyPolicyLink, termsOfServiceLink: termsOfServiceLink })] })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })) })) })));
}
...
var SignUpFeatureInner = function (props) {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(PasskeySignUpTheme, genericComponentOverrideContext.__assign({}, childProps)), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, genericComponentOverrideContext.__assign({}, childProps));
                    }
...
var SignInUpFeatureFullPage = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, genericComponentOverrideContext.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignUpFeatureInner, genericComponentOverrideContext.__assign({}, props)) })));
};
...
var WebauthnPreBuiltUI = /** @class */ (function (_super) {
    ...
    function WebauthnPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            if (useComponentOverrides === void 0) { useComponentOverrides = recipe.useContext; }
            var features = {};
            if (_this.recipeInstance.config.disableDefaultUI !== true &&
                _this.recipeInstance.config.recoveryFeature.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(recipe.DEFAULT_WEBAUTHN_RECOVERY_PATH));
                ...
                var normalisedFullPathForRecoveryThroughEmail = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(recipe.DEFAULT_WEBAUTHN_SEND_RECOVERY_EMAIL_PATH));
                ...
                var normalisedFullPathForMFA = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(recipe.DEFAULT_WEBAUTHN_MFA_PATH));
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "webauthn-recover-account") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(RecoverAccountUsingToken, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            else if (componentName === "webauthn-send-recovery-email") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(SendRecoveryEmailForm, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            else if (componentName === "webauthn-mfa") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(MFAFeature, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })));
            }
            throw new Error("Should never come here.");
        };
        ...
        return [
            {
                ...
                component: function (props) { return (jsxRuntime.jsx(SignInUpFeatureFullPage, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe.useContext, factorIds: [types.FactorIds.WEBAUTHN] }), "webauthnSignUpFullPage")); },
            },
            {
                type: "SIGN_UP",
                factorIds: [types.FactorIds.WEBAUTHN],
                displayOrder: 4,
                component: function (props) { return (jsxRuntime.jsx(SignUpWithPasskeyFeature, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, factorIds: [types.FactorIds.WEBAUTHN], useComponentOverrides: recipe.useContext }), "webauthn-sign-up")); },
            },
            {
                type: "SIGN_IN",
                factorIds: [types.FactorIds.WEBAUTHN],
                displayOrder: 4,
                component: function (props) { return (jsxRuntime.jsx(SignInWithPasskeyFeature, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, factorIds: [types.FactorIds.WEBAUTHN], useComponentOverrides: recipe.useContext }), "webauthn-sign-in")); },
            },
        ];
    };
    // For tests
