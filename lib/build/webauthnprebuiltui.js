...
var PasskeyNotSupportedError = uiEntry.withOverride("PasskeyNotSupportedError", function () {
...
var PasskeyConfirmation = uiEntry.withOverride("PasskeyConfirmation", function PasskeyConfirmation(props) {
    ...
    var showContinueWithoutPasskey = React.useMemo(
        function () {
            var _a;
            return (
                props.hideContinueWithoutPasskey !== true &&
                ((_a = props.originalFactorIds) !== null && _a !== void 0 ? _a : []).length > 1
            );
        },
        [props]
    );
            ...
            void (function () {
                return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return genericComponentOverrideContext.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                return [4 /*yield*/, props.recipeImplementation.doesBrowserSupportWebAuthn()];
                            case 1:
...
var RecoverAccountUsingToken = function (props) {
    ...
    var callAPI = React.useCallback(
        function () {
            return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
                var expiresAtDate, registerCredentialResponse, recoverAccountResponse;
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 3:
                            registerCredentialResponse = _a.sent();
                        ...
                        case 4:
                            recoverAccountResponse = _a.sent();
...
var SendRecoveryEmailFormThemeInner = function (props) {
    return props.activeScreen === SendRecoveryEmailScreen.RecoverAccount
        ...
        ? jsxRuntime.jsx(PasskeyEmailSent, {
...
var ContinueWithPasskey = function (_a) {
    var continueFor = _a.continueFor,
        ...
        _c = _a.isPasskeyNotSupported,
        isPasskeyNotSupported = _c === void 0 ? true : _c;
    return jsxRuntime.jsxs(
        "div",
        genericComponentOverrideContext.__assign(
            { "data-supertokens": "continueWithPasskeyButtonWrapper" },
            {
                children: [
                    ...
                    isPasskeyNotSupported && jsxRuntime.jsx(PasskeyNotSupportedError, {}),
                ],
            }
        )
    );
        ...
        genericComponentOverrideContext.__assign(
            { userStyles: [rootStyle, props.config.recipeRootStyle] },
            {
                children: jsxRuntime.jsx(
                    ...
                    genericComponentOverrideContext.__assign({}, props, {
                        isPasskeyNotSupported: props.isPasskeySupported === false,
                    })
                ),
            }
        )
...
function PasskeySignInTheme(props) {
    ...
    var _c = React.useState(true),
        isPasskeySupported = _c[0],
        setIsPasskeySupported = _c[1];
    React.useEffect(
        function () {
            void (function () {
                return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                                ...
                                genericComponentOverrideContext.__assign(
                                    { "data-supertokens": "passkeySignInContainer" },
                                    {
                                        children: [
                                            error !== "" &&
                                                error !== null &&
                                                jsxRuntime.jsx(RecoverableError, { errorMessageLabel: error }),
                                            jsxRuntime.jsx(
                        ...
                        callAPI: function (formFields) {
                            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return genericComponentOverrideContext.__generator(this, function (_b) {
                                    ...
                                    if (email === "") {
                                        throw new STGeneralError__default$1.default("EMAIL_INPUT_NOT_POPULATED_ERROR");
                                    }
