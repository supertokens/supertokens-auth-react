...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.init = function (config) {
        return emailpasswordPreBuiltUI.EmailPassword.init(config);
    };
    Wrapper.signOut = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    emailpasswordPreBuiltUI.EmailPassword.getInstanceOrThrow().signOut({
    ...
    Wrapper.submitNewPassword = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    emailpasswordPreBuiltUI.EmailPassword.getInstanceOrThrow().recipeImpl.submitNewPassword(
    ...
    Wrapper.sendPasswordResetEmail = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    emailpasswordPreBuiltUI.EmailPassword.getInstanceOrThrow().recipeImpl.sendPasswordResetEmail(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.signUp = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    emailpasswordPreBuiltUI.EmailPassword.getInstanceOrThrow().recipeImpl.signUp(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.signIn = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    emailpasswordPreBuiltUI.EmailPassword.getInstanceOrThrow().recipeImpl.signIn(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.doesEmailExist = function (input) {
        return utils.__awaiter(this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    emailpasswordPreBuiltUI.EmailPassword.getInstanceOrThrow().recipeImpl.doesEmailExist(
                        utils.__assign(utils.__assign({}, input), {
                            userContext: utils.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.getResetPasswordTokenFromURL = function (input) {
        return emailpasswordPreBuiltUI.EmailPassword.getInstanceOrThrow().recipeImpl.getResetPasswordTokenFromURL(
            utils.__assign(utils.__assign({}, input), {
                userContext: utils.getNormalisedUserContext(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.ComponentsOverrideProvider = emailpasswordPreBuiltUI.Provider;
    return Wrapper;
})();
