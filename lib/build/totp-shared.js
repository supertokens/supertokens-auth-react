...
function normaliseMultiFactorAuthFeature(config) {
    ...
    return logger.__assign(logger.__assign({}, superTokens.normaliseRecipeModuleConfig(config)), { totpMFAScreen: logger.__assign({ disableDefaultUI: false, blockedScreenStyle: "", setupScreenStyle: "", verificationScreenStyle: "", loadingScreenStyle: "" }, config.totpMFAScreen), override: override });
}
