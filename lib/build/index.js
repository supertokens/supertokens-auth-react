...
var SuperTokensAPIWrapper = /** @class */ (function () {
    ...
    SuperTokensAPIWrapper.init = function (config) {
        return superTokens.__awaiter(this, void 0, void 0, function () {
            return superTokens.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        return [4 /*yield*/, superTokens.SuperTokens.init(config)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    SuperTokensAPIWrapper.useTranslation = superTokens.useTranslation;
...
exports.useTranslation = superTokens.useTranslation;
