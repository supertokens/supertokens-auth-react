...
exports.useUserContext =
    ...
    exports.redirectToAuthWithoutRedirectToPath =
    exports.redirectToAuthWithRedirectToPath =
...
var SuperTokensAPIWrapper = /** @class */ (function () {
    ...
    SuperTokensAPIWrapper.redirectToAuthWithRedirectToPath = function (show, history, queryParams) {
        return superTokens_1.default.getInstanceOrThrow().redirectToAuthWithRedirectToPath(show, history, queryParams);
    };
    SuperTokensAPIWrapper.redirectToAuthWithoutRedirectToPath = function (show, history, queryParams) {
        return superTokens_1.default
            .getInstanceOrThrow()
            .redirectToAuthWithoutRedirectToPath(show, history, queryParams);
    };
...
exports.redirectToAuthWithRedirectToPath = SuperTokensAPIWrapper.redirectToAuthWithRedirectToPath;
exports.redirectToAuthWithoutRedirectToPath = SuperTokensAPIWrapper.redirectToAuthWithoutRedirectToPath;
