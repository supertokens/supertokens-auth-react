...
var SuperTokensWrapper = function (props) {
    return jsxRuntime.jsx(
        ...
        utils.__assign({}, props, { requireAuth: false, doRedirection: false, useDefaultAccessDeniedScreen: false })
    );
};
...
var SuperTokensAPIWrapper = /** @class */ (function () {
    ...
    SuperTokensAPIWrapper.useTranslation = recipe.useTranslation;
    SuperTokensAPIWrapper.useUserContext = recipe.useUserContext;
...
exports.useTranslation = recipe.useTranslation;
exports.useUserContext = recipe.useUserContext;
