...
var SuperTokensWrapper = function (props) {
    return jsxRuntime.jsx(
        authRecipe.SessionAuthWrapper,
        assets.__assign({}, props, { requireAuth: false, doRedirection: false })
    );
};
...
var SuperTokensAPIWrapper = /** @class */ (function () {
    ...
    SuperTokensAPIWrapper.init = function (config) {
        authRecipe.SuperTokens.init(config);
    };
    SuperTokensAPIWrapper.canHandleRoute = function () {
        return authRecipe.SuperTokens.canHandleRoute();
    };
    SuperTokensAPIWrapper.getRoutingComponent = function () {
        return authRecipe.SuperTokens.getRoutingComponent();
    };
    SuperTokensAPIWrapper.changeLanguage = function (language) {
        return authRecipe.SuperTokens.getInstanceOrThrow().changeLanguage(language);
    };
    SuperTokensAPIWrapper.loadTranslation = function (store) {
        return authRecipe.SuperTokens.getInstanceOrThrow().loadTranslation(store);
    };
    SuperTokensAPIWrapper.getSuperTokensRoutesForReactRouterDom = function (reactRouterDom) {
        return authRecipe.SuperTokens.getSuperTokensRoutesForReactRouterDom(reactRouterDom);
    };
    var _a;
    ...
    SuperTokensAPIWrapper.redirectToAuth = function (options) {
        return assets.__awaiter(void 0, void 0, void 0, function () {
            var _b;
            return assets.__generator(_a, function (_c) {
                return [
                    2 /*return*/,
                    authRecipe.SuperTokens.getInstanceOrThrow().redirectToAuth(
                        assets.__assign(assets.__assign({}, options), {
                            redirectBack:
    ...
    SuperTokensAPIWrapper.useUserContext = authRecipe.useUserContext;
...
exports.useUserContext = authRecipe.useUserContext;
