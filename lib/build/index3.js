...
const ComponentOverrideContext = React.createContext("IS_DEFAULT");
...
const withOverride = (overrideKey, DefaultComponent) => {
    ...
    return (props) => {
        ...
        if (OverrideComponent !== null) {
            return jsxRuntime.jsx(OverrideComponent, Object.assign({ DefaultComponent: DefaultComponent }, props));
        }
        return jsxRuntime.jsx(DefaultComponent, Object.assign({}, props));
    };
};

function GeneralError({ error }) {
    const t = translationContext.useTranslation();
    return jsxRuntime.jsx("div", Object.assign({ "data-supertokens": "generalError" }, { children: t(error) }));
}
...
function FeatureWrapper({ children, useShadowDom, defaultStore }) {
    const st = sessionAuth.SuperTokens.getInstanceOrThrow();
            ...
            Object.assign(
                ...
                },
                {
                    children: jsxRuntime.jsx(
                        ...
                        Object.assign({ useShadowDom: useShadowDom }, { children: children })
                    ),
                }
            )
        ),
