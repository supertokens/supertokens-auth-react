...
var CodeForm = uiEntry.withOverride("TOTPCodeForm", function TOTPCodeForm(props) {
    ...
    return (jsxRuntime.jsx(React__namespace.default.Fragment, { children: jsxRuntime.jsx(formBase.FormBase, { formDataSupertokens: "totp-mfa codeForm", clearError: props.clearError, onError: props.onError, formFields: [
            ...
            ], onSuccess: props.onSuccess, buttonLabel: "TOTP_CODE_CONTINUE_BUTTON", callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                var totp, response;
                var _a;
...
var DeviceInfoSection = uiEntry.withOverride("TOTPDeviceInfoSection", function TOTPDeviceInfoSection(props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "totpDeviceInfoWithQR totp-mfa deviceInfoSection" }, { children: [jsxRuntime.jsx(_default, { value: props.deviceInfo.qrCodeString, "data-supertokens": "totpDeviceQR", level: "L" }), jsxRuntime.jsxs("span", genericComponentOverrideContext.__assign({ "data-supertokens": "showTOTPSecret" }, { children: [t("TOTP_SHOW_SECRET_START"), jsxRuntime.jsx("button", genericComponentOverrideContext.__assign({ type: "button", onClick: props.onShowSecretClicked, "data-supertokens": "link linkButton showTOTPSecretBtn" }, { children: t("TOTP_SHOW_SECRET_LINK") })), t("TOTP_SHOW_SECRET_END")] })), props.showSecret && jsxRuntime.jsx("span", genericComponentOverrideContext.__assign({ "data-supertokens": "totpSecret" }, { children: props.deviceInfo.secret }))] })), jsxRuntime.jsx("div", { "data-supertokens": "divider" })] }));
});

var DeviceSetupFooter = uiEntry.withOverride("TOTPDeviceSetupFooter", function TOTPDeviceSetupFooter(_a) {
    var onSignOutClicked = _a.onSignOutClicked;
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "footerLinkGroupVert totp-mfa deviceSetupFooter" }, { children: jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: onSignOutClicked }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }), t("TOTP_MFA_LOGOUT")] })) })));
});
...
var TOTPMFATheme = function (_a) {
    ...
    return activeScreen === TOTPMFAScreens.Blocked ? (jsxRuntime.jsx(BlockedScreen, { nextRetryAt: featureState.nextRetryAt, onRetry: props.onRetryClicked, onSignOutClicked: props.onSignOutClicked })) : activeScreen === TOTPMFAScreens.AccessDenied ? (jsxRuntime.jsx(sessionprebuiltui.AccessDeniedScreen, { error: t(featureState.error), useShadowDom: false /* We set this to false, because we are already inside a shadowDom (if required) */ })) : activeScreen === TOTPMFAScreens.Loading ? (jsxRuntime.jsx(LoadingScreen, {})) : (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "container totp-mfa" }, { children: [jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "row" }, { children: featureState.loaded && (jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [activeScreen === TOTPMFAScreens.DeviceSetup ? (jsxRuntime.jsx(DeviceSetupHeader, genericComponentOverrideContext.__assign({}, commonProps, { showBackButton: featureState.showBackButton, onBackButtonClicked: props.onBackButtonClicked }))) : (jsxRuntime.jsx(CodeVerificationHeader, genericComponentOverrideContext.__assign({}, commonProps, { showBackButton: featureState.showBackButton, onBackButtonClicked: props.onBackButtonClicked }))), activeScreen === TOTPMFAScreens.DeviceSetup && (jsxRuntime.jsx(DeviceInfoSection, genericComponentOverrideContext.__assign({}, commonProps, { deviceInfo: featureState.deviceInfo, showSecret: featureState.showSecret, onShowSecretClicked: props.onShowSecretClicked }))), featureState.error !== undefined && (jsxRuntime.jsx(uiEntry.GeneralError, { error: getErrorString(featureState.error, featureState, t) })), jsxRuntime.jsx(CodeForm, genericComponentOverrideContext.__assign({}, commonProps, { onSuccess: props.onSuccess, footer: activeScreen === TOTPMFAScreens.DeviceSetup ? (jsxRuntime.jsx(DeviceSetupFooter, genericComponentOverrideContext.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked }))) : (jsxRuntime.jsx(CodeVerificationFooter, genericComponentOverrideContext.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked }))) }))] })) })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })));
};
function TOTPMFAThemeWrapper(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(TOTPMFATheme, genericComponentOverrideContext.__assign({}, props, { activeScreen: activeScreen })) })) })));
}
...
var useFeatureReducer = function () {
    return React__namespace.useReducer(function (oldState, action) {
        ...
        switch (action.type) {
            ...
            case "setBlocked":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { isBlocked: true, nextRetryAt: action.nextRetryAt, error: action.error });
            case "setError":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { loaded: true, maxAttemptCount: (_a = action.maxAttemptCount) !== null && _a !== void 0 ? _a : oldState.maxAttemptCount, currAttemptCount: (_b = action.currAttemptCount) !== null && _b !== void 0 ? _b : oldState.currAttemptCount, showAccessDenied: action.showAccessDenied, error: action.error });
            case "createDevice":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { deviceInfo: action.deviceInfo, isBlocked: false, showSecret: false, nextRetryAt: undefined, error: undefined });
            case "showSecret":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { showSecret: true });
            case "restartFlow":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { isBlocked: false, showSecret: false, nextRetryAt: undefined, error: action.error });
            default:
                return oldState;
        }
    }, {
...
var SignInUpFeature = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, genericComponentOverrideContext.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, genericComponentOverrideContext.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsTOTP }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && (jsxRuntime.jsx(TOTPMFAThemeWrapper, genericComponentOverrideContext.__assign({}, childProps, { featureState: state, dispatch: dispatch }))), props.children &&
...
function getModifiedRecipeImplementation(originalImpl, dispatch) {
    var _this = this;
    return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImpl), { createDevice: function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            var res, deviceInfo;
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
        ...
        }); }, verifyCode: function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            var res;
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
        ...
        }); }, verifyDevice: function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            var res;
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
        ...
        }); }, removeDevice: function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            var res;
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
...
var TOTPPreBuiltUI = /** @class */ (function (_super) {
    ...
    function TOTPPreBuiltUI(recipeInstance) {
        ...
        _, props, useComponentOverrides) {
            if (useComponentOverrides === void 0) { useComponentOverrides = componentOverrideContext.useContext; }
            return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, genericComponentOverrideContext.__assign({ overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(SignInUpFeature, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides }, props)) })) })));
        };
        return _this;
    }
    // Static methods
