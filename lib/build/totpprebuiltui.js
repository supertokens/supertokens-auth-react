...
var componentOverrideContext = require('./totp-shared.js');
...
var RetryButton = function (_a) {
    ...
    var _b = React.useState(getTimeLeft()), secsUntilRetry = _b[0], setSecsUntilRetry = _b[1];
    ...
    return (jsxRuntime.jsx("button", utils.__assign({ type: "button", disabled: secsUntilRetry !== undefined, onClick: onClick, "data-supertokens": "button retryCodeBtn" }, { children: secsUntilRetry !== undefined ? (jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [t("TOTP_MFA_BLOCKED_TIMER_START"), jsxRuntime.jsxs("strong", { children: [Math.floor(secsUntilRetry / 60)
                            .toString()
...
var CodeForm = uiEntry.withOverride("TOTPCodeForm", function TOTPCodeForm(props) {
    ...
    return (jsxRuntime.jsx(React__namespace.default.Fragment, { children: jsxRuntime.jsx(formBase.FormBase, { formDataSupertokens: "totp-mfa codeForm", clearError: props.clearError, onError: props.onError, formFields: [
                {
                    id: "totp",
                    ...
                    placeholder: "",
                    validate: componentOverrideContext.totpCodeValidate,
                },
            ], onSuccess: props.onSuccess, buttonLabel: "TOTP_CODE_CONTINUE_BUTTON", callAPI: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
                var totp, response;
                var _a;
                return utils.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            totp = (_a = formFields.find(function (field) { return field.id === "totp"; })) === null || _a === void 0 ? void 0 : _a.value;
                            ...
                            return [4 /*yield*/, props.recipeImplementation.verifyDevice({
                        ...
                        case 1:
                            response = _b.sent();
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, props.recipeImplementation.verifyCode({
                                totp: totp,
                                userContext: userContext,
                            })];
                        case 3:
...
var CodeVerificationFooter = uiEntry.withOverride("TOTPCodeVerificationFooter", function TOTPCodeVerificationFooter(_a) {
    var onSignOutClicked = _a.onSignOutClicked;
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "footerLinkGroupVert totp-mfa codeVerificationFooter" }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: onSignOutClicked }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }), t("TOTP_MFA_LOGOUT")] })) })));
});

var CodeVerificationHeader = uiEntry.withOverride("TOTPCodeVerificationHeader", function TOTPCodeVerificationHeader(props) {
    var t = translationContext.useTranslation();
...
var DeviceInfoSection = uiEntry.withOverride("TOTPDeviceInfoSection", function TOTPDeviceInfoSection(props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "totpDeviceInfoWithQR totp-mfa deviceInfoSection" }, { children: [jsxRuntime.jsx(_default, { value: props.deviceInfo.qrCodeString, "data-supertokens": "totpDeviceQR", level: "L" }), jsxRuntime.jsxs("span", utils.__assign({ "data-supertokens": "showTOTPSecret" }, { children: [t("TOTP_SHOW_SECRET_START"), jsxRuntime.jsx("button", utils.__assign({ type: "button", onClick: props.onShowSecretClicked, "data-supertokens": "link linkButton showTOTPSecretBtn" }, { children: t("TOTP_SHOW_SECRET_LINK") })), t("TOTP_SHOW_SECRET_END")] })), props.showSecret && jsxRuntime.jsx("span", utils.__assign({ "data-supertokens": "totpSecret" }, { children: props.deviceInfo.secret }))] })), jsxRuntime.jsx("div", { "data-supertokens": "divider" })] }));
});

var DeviceSetupFooter = uiEntry.withOverride("TOTPDeviceSetupFooter", function TOTPDeviceSetupFooter(_a) {
    var onSignOutClicked = _a.onSignOutClicked;
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "footerLinkGroupVert totp-mfa deviceSetupFooter" }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: onSignOutClicked }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }), t("TOTP_MFA_LOGOUT")] })) })));
});

var DeviceSetupHeader = uiEntry.withOverride("TOTPDeviceSetupHeader", function TOTPDeviceSetupHeader(props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs(React.Fragment, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "headerTitle withBackButton totp-mfa deviceSetupHeader" }, { children: [props.showBackButton ? (jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackButtonClicked })) : (jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })), t("TOTP_DEVICE_SETUP_HEADER_TITLE"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("TOTP_DEVICE_SETUP_HEADER_SUBTITLE") })), jsxRuntime.jsx("div", { "data-supertokens": "divider" })] }));
});
...
var TOTPMFATheme = function (_a) {
    var activeScreen = _a.activeScreen, featureState = _a.featureState, props = utils.__rest(_a, ["activeScreen", "featureState"]);
    var t = translationContext.useTranslation();
    var commonProps = {
    ...
    return activeScreen === TOTPMFAScreens.Blocked ? (jsxRuntime.jsx(BlockedScreen, { nextRetryAt: featureState.nextRetryAt, onRetry: props.onRetryClicked, onSignOutClicked: props.onSignOutClicked })) : activeScreen === TOTPMFAScreens.AccessDenied ? (jsxRuntime.jsx(sessionprebuiltui.AccessDeniedScreen, { error: t(featureState.error), useShadowDom: false /* We set this to false, because we are already inside a shadowDom (if required) */ })) : activeScreen === TOTPMFAScreens.Loading ? (jsxRuntime.jsx(LoadingScreen, {})) : (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "container totp-mfa" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "row" }, { children: featureState.loaded && (jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [activeScreen === TOTPMFAScreens.DeviceSetup ? (jsxRuntime.jsx(DeviceSetupHeader, utils.__assign({}, commonProps, { showBackButton: featureState.showBackButton, onBackButtonClicked: props.onBackButtonClicked }))) : (jsxRuntime.jsx(CodeVerificationHeader, utils.__assign({}, commonProps, { showBackButton: featureState.showBackButton, onBackButtonClicked: props.onBackButtonClicked }))), activeScreen === TOTPMFAScreens.DeviceSetup && (jsxRuntime.jsx(DeviceInfoSection, utils.__assign({}, commonProps, { deviceInfo: featureState.deviceInfo, showSecret: featureState.showSecret, onShowSecretClicked: props.onShowSecretClicked }))), featureState.error !== undefined && (jsxRuntime.jsx(uiEntry.GeneralError, { error: getErrorString(featureState.error, featureState, t) })), jsxRuntime.jsx(CodeForm, utils.__assign({}, commonProps, { onSuccess: props.onSuccess, footer: activeScreen === TOTPMFAScreens.DeviceSetup ? (jsxRuntime.jsx(DeviceSetupFooter, utils.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked }))) : (jsxRuntime.jsx(CodeVerificationFooter, utils.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked }))) }))] })) })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })));
};
function TOTPMFAThemeWrapper(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(TOTPMFATheme, utils.__assign({}, props, { activeScreen: activeScreen })) })) })));
}
...
var defaultTranslationsTOTP = {
    en: utils.__assign(utils.__assign({}, superTokens.defaultTranslationsCommon.en), { TOTP_SHOW_SECRET_START: "Unable to scan? Use a", TOTP_SHOW_SECRET_LINK: "secret key", TOTP_SHOW_SECRET_END: "", TOTP_CODE_VERIFICATION_HEADER_TITLE: "Enter TOTP", TOTP_CODE_VERIFICATION_HEADER_SUBTITLE: "Open the two-factor authenticator (TOTP) app on your mobile device to view your authentication code", TOTP_DEVICE_SETUP_HEADER_TITLE: "Add a TOTP device", TOTP_DEVICE_SETUP_HEADER_SUBTITLE: "Please scan the given QR code from a phone app like Google Authenticator.", TOTP_CODE_INPUT_LABEL: "Please enter TOTP", TOTP_CODE_CONTINUE_BUTTON: "Continue", TOTP_BLOCKED_TITLE: "Account locked", TOTP_BLOCKED_SUBTITLE: "Account locked due to multiple failed login attempts.", TOTP_MFA_BLOCKED_TIMER_START: "", TOTP_MFA_BLOCKED_TIMER_END: "", TOTP_MFA_BLOCKED_RETRY: "Try again", TOTP_MFA_LOGOUT: "Logout", ERROR_TOTP_INVALID_CODE: "Invalid TOTP. Please try again.", ERROR_TOTP_INVALID_CODE_RETRY_START: "", 
        // \xA0 is non breaking space.
        // We add it to make sure there is no line break between the number and the rest of the sentence
        ERROR_TOTP_INVALID_CODE_RETRY_END: "\xA0attempt(s) remaining before account is temporarily locked.", ERROR_TOTP_UNKNOWN_DEVICE: "The device was deleted before verification. Please refresh the page to try again.", GENERAL_ERROR_TOTP_NON_STRING: "TOTP code must be of type string", GENERAL_ERROR_TOTP_EMPTY: "TOTP code cannot be empty", GENERAL_ERROR_TOTP_UNDEFINED: "Please fill your TOTP code" }),
};
...
var useFeatureReducer = function () {
    return React__namespace.useReducer(function (oldState, action) {
        ...
        switch (action.type) {
            ...
            case "setBlocked":
                return utils.__assign(utils.__assign({}, oldState), { isBlocked: true, nextRetryAt: action.nextRetryAt, error: action.error });
            case "setError":
                return utils.__assign(utils.__assign({}, oldState), { loaded: true, maxAttemptCount: (_a = action.maxAttemptCount) !== null && _a !== void 0 ? _a : oldState.maxAttemptCount, currAttemptCount: (_b = action.currAttemptCount) !== null && _b !== void 0 ? _b : oldState.currAttemptCount, showAccessDenied: action.showAccessDenied, error: action.error });
            case "createDevice":
                return utils.__assign(utils.__assign({}, oldState), { deviceInfo: action.deviceInfo, isBlocked: false, showSecret: false, nextRetryAt: undefined, error: undefined });
            case "showSecret":
                return utils.__assign(utils.__assign({}, oldState), { showSecret: true });
            case "restartFlow":
                return utils.__assign(utils.__assign({}, oldState), { isBlocked: false, showSecret: false, nextRetryAt: undefined, error: action.error });
            default:
                return oldState;
        }
    }, {
...
function useOnLoad(recipeImpl, dispatch, navigate, userContext) {
    ...
    var onLoad = React__namespace.useCallback(function (mfaInfo) { return utils.__awaiter(_this, void 0, void 0, function () {
        var error, errorQueryParam, doSetup, stepUp, redirectToPath, alreadySetup, showBackButton, deviceInfo, createResp;
        return utils.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(undefined, componentOverrideContext.TOTP.RECIPE_ID, redirectToPath, userContext, navigate)];
                case 2:
                    _c.sent();
                    return [3 /*break*/, 4];
                case 3:
                ...
                case 8:
                    ...
                    deviceInfo = utils.__assign({}, createResp);
                ...
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, recipeImplementation.removeDevice({
            ...
            onSignOutClicked: function () { return utils.__awaiter(_this, void 0, void 0, function () {
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!state.deviceInfo) return [3 /*break*/, 2];
                            return [4 /*yield*/, recipeImplementation.removeDevice({ deviceName: state.deviceInfo.deviceName, userContext: userContext })];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [4 /*yield*/, types.Session.getInstanceOrThrow().signOut({ userContext: userContext })];
                        case 3:
                            _a.sent();
...
var SignInUpFeature = function (props) {
    ...
    var userContext = uiEntry.useUserContext();
    var recipeImplementation = React__namespace.useMemo(function () { return getModifiedRecipeImplementation(props.recipe.webJSRecipe, dispatch); }, [props.recipe]);
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsTOTP }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && (jsxRuntime.jsx(TOTPMFAThemeWrapper, utils.__assign({}, childProps, { featureState: state, dispatch: dispatch }))), props.children &&
...
function getModifiedRecipeImplementation(originalImpl, dispatch) {
    var _this = this;
    return utils.__assign(utils.__assign({}, originalImpl), { createDevice: function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
            var res, deviceInfo;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, originalImpl.createDevice(input)];
                    case 1:
                        res = _a.sent();
                        if (res.status === "OK") {
                            deviceInfo = utils.__assign({}, res);
                            delete deviceInfo.status;
        ...
        }); }, verifyCode: function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
            var res;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, originalImpl.verifyCode(input)];
                    case 1:
                        res = _a.sent();
        ...
        }); }, verifyDevice: function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
            var res;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, originalImpl.verifyDevice(input)];
                    case 1:
                        res = _a.sent();
                        if (res.status === "LIMIT_REACHED_ERROR") {
                            dispatch({
        ...
        }); }, removeDevice: function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
            var res;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, originalImpl.removeDevice(input)];
                    case 1:
                        res = _a.sent();
                        dispatch({ type: "restartFlow", error: undefined });
                        return [2 /*return*/, res];
...
var TOTPPreBuiltUI = /** @class */ (function (_super) {
    utils.__extends(TOTPPreBuiltUI, _super);
    function TOTPPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.totpMFAScreen.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default(DEFAULT_TOTP_PATH));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    recipeID: componentOverrideContext.TOTP.RECIPE_ID,
                };
            }
            return features;
        };
    ...
    TOTPPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (TOTPPreBuiltUI.instance === undefined) {
            var recipeInstance = componentOverrideContext.TOTP.getInstanceOrThrow();
    ...
    TOTPPreBuiltUI.languageTranslations = defaultTranslationsTOTP;
