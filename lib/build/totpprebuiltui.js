...
var SignInUpFeature = function (props) {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsTOTP }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && (jsxRuntime.jsx(TOTPMFAThemeWrapper, logger.__assign({}, childProps, { featureState: state, dispatch: dispatch }))), props.children &&
