...
var recipe$2 = require("./session-shared2.js");
...
var CodeVerificationFooter = uiEntry.withOverride(
    ...
    function TOTPCodeVerificationFooter(_a) {
        var showFactorChooserButton = _a.showFactorChooserButton,
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!(doSetup || !isAlreadySetup)) return [3 /*break*/, 5];
                            createResp = void 0;
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            dispatch({
                                ...
                                showFactorChooserButton: showFactorChooserButton,
                                showAccessDenied: false,
        ...
        function () {
            return {
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    return [
                                        4 /*yield*/,
                                        recipe$2.Session.getInstanceOrThrow().signOut({ userContext: userContext }),
                                    ];
                                case 3:
                                    _a.sent();
                                    return [
                ...
                onSuccess: function () {
                    ...
                    return recipe$2.Session.getInstanceOrThrow()
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.recipeInstance.config.totpMFAScreen.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(
                    new NormalisedURLPath__default.default(recipe.DEFAULT_TOTP_PATH)
                );
