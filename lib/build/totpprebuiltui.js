        ...
        function (oldState, action) {
            switch (action.type) {
                ...
                case "setError":
                    return genericComponentOverrideContext.__assign(
                        genericComponentOverrideContext.__assign({}, oldState),
                        { loaded: true, showAccessDenied: action.showAccessDenied, error: action.error }
                    );
                case "createDevice":
                    return genericComponentOverrideContext.__assign(
                        genericComponentOverrideContext.__assign({}, oldState),
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!(isAllowedToSetup && (doSetup || !isAlreadySetup))) return [3 /*break*/, 5];
                            createResp = void 0;
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, , 4]);
...
function useChildProps(recipe$2, recipeImplementation, state, dispatch, userContext, navigate) {
    var _this = this;
        ...
        function () {
            return {
                ...
                onSuccess: function () {
                    ...
                    return recipe$1.Session.getInstanceOrThrow()
