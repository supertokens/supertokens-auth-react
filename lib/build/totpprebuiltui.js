...
var BlockedScreen = sessionprebuiltui.withOverride("TOTPBlockedScreen", TOTPBlockedScreen);
...
var LoadingScreen = sessionprebuiltui.withOverride("TOTPLoadingScreen", TOTPLoadingScreen);

var CodeForm = sessionprebuiltui.withOverride("TOTPCodeForm", function TOTPCodeForm(props) {
    var _this = this;
...
var CodeVerificationFooter = sessionprebuiltui.withOverride(
...
var CodeVerificationHeader = sessionprebuiltui.withOverride(
                        ...
                        { "data-supertokens": "headerTitle withBackButton totp-mfa codeVerificationHeader" },
                        {
                            children: [
                                props.showBackButton
                                    ? jsxRuntime.jsx(sessionprebuiltui.BackButton, {
...
var DeviceInfoSection = sessionprebuiltui.withOverride("TOTPDeviceInfoSection", function TOTPDeviceInfoSection(props) {
    var t = translationContext.useTranslation();
...
var DeviceSetupFooter = sessionprebuiltui.withOverride("TOTPDeviceSetupFooter", function TOTPDeviceSetupFooter(_a) {
    var onSignOutClicked = _a.onSignOutClicked;
    var t = translationContext.useTranslation();
    return jsxRuntime.jsx(
        "div",
...
var DeviceSetupHeader = sessionprebuiltui.withOverride("TOTPDeviceSetupHeader", function TOTPDeviceSetupHeader(props) {
    var t = translationContext.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsxs(
