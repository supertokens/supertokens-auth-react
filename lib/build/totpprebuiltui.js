    ...
    return React__namespace.useReducer(
        function (oldState, action) {
            ...
            switch (action.type) {
                ...
                case "showSecret":
                    return superTokens.__assign(superTokens.__assign({}, oldState), { showSecret: true });
                case "restartFlow":
                    return superTokens.__assign(superTokens.__assign({}, oldState), {
                        isBlocked: false,
                        showSecret: false,
                ...
                return superTokens.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            deviceInfo = superTokens.__assign({}, createResp);
                ...
                return superTokens.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            res = _a.sent();
                            if (res.status === "OK") {
                                deviceInfo = superTokens.__assign({}, res);
                                delete deviceInfo.status;
...
var TOTPPreBuiltUI = /** @class */ (function (_super) {
    superTokens.__extends(TOTPPreBuiltUI, _super);
