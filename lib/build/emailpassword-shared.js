...
function Button(_a) {
    ...
    return (jsxRuntime.jsxs("button", utils.__assign({ type: type, disabled: disabled, onClick: onClick, "data-supertokens": dataSupertokens }, { children: [icon && jsxRuntime.jsx("div", { children: icon() }), jsxRuntime.jsxs("div", { children: [t(label), isLoading && "..."] })] })));
}
