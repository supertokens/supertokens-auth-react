...
function clearErrorQueryParam() {
    var newURL = new URL(windowHandler_1.default.getInstanceOrThrow().windowHandler.location.getHref());
    newURL.searchParams.delete("error");
    newURL.searchParams.delete("message");
    windowHandler_1.default
        .getInstanceOrThrow()
        .windowHandler.history.replaceState(
            windowHandler_1.default.getInstanceOrThrow().windowHandler.history.getState(),
            "",
            windowHandler_1.default.getInstanceOrThrow().windowHandler.location.getHref()
        );
}
exports.clearErrorQueryParam = clearErrorQueryParam;
function getQueryParams(param) {
    var urlParams = new URLSearchParams(
        windowHandler_1.default.getInstanceOrThrow().windowHandler.location.getSearch()
    );
...
function getURLHash() {
    ...
    return windowHandler_1.default.getInstanceOrThrow().windowHandler.location.getHash().substr(1);
}
...
function getCurrentNormalisedUrlPath() {
    return new normalisedURLPath_1.default(
        windowHandler_1.default.getInstanceOrThrow().windowHandler.location.getPathName()
    );
}
...
function redirectWithFullPageReload(to) {
    ...
    windowHandler_1.default.getInstanceOrThrow().windowHandler.location.setHref(to);
}
...
function isIE() {
    return windowHandler_1.default.getInstanceOrThrow().windowHandler.getDocument().documentMode !== undefined;
}
exports.isIE = isIE;
function setSessionStorage(key, value) {
    windowHandler_1.default.getInstanceOrThrow().windowHandler.getSessionStorage().setItem(key, value);
}
exports.setSessionStorage = setSessionStorage;
function getSessionStorage(key) {
    return windowHandler_1.default.getInstanceOrThrow().windowHandler.getSessionStorage().getItem(key);
}
...
function getLocalStorage(key) {
    var res = windowHandler_1.default.getInstanceOrThrow().windowHandler.getLocalStorage().getItem(key);
...
function setLocalStorage(key, value) {
    windowHandler_1.default.getInstanceOrThrow().windowHandler.getLocalStorage().setItem(key, value);
}
exports.setLocalStorage = setLocalStorage;
function removeFromLocalStorage(key) {
    windowHandler_1.default.getInstanceOrThrow().windowHandler.getLocalStorage().removeItem(key);
}
...
function getDefaultCookieScope() {
    try {
        return normaliseCookieScopeOrThrowError(
            windowHandler_1.default.getInstanceOrThrow().windowHandler.location.getHostName()
        );
    } catch (_a) {
        return undefined;
    }
...
function getCookieValue(name) {
    var value = "; " + cookieHandler_1.default.getInstanceOrThrow().cookieHandler.getCookieSync();
...
function setFrontendCookie(name, value, scope) {
    ...
    if (
        scope === "localhost" ||
        scope === windowHandler_1.default.getInstanceOrThrow().windowHandler.location.getHostName() ||
        scope === undefined
    ) {
