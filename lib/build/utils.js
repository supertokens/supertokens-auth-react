...
function setSessionStorage(key, value) {
    windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.getSessionStorage().setItem(key, value);
}
exports.setSessionStorage = setSessionStorage;
function getSessionStorage(key) {
    return windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.getSessionStorage().getItem(key);
}
...
function getLocalStorage(key) {
    var res = windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.getLocalStorage().getItem(key);
...
function setLocalStorage(key, value) {
    windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.getLocalStorage().setItem(key, value);
}
exports.setLocalStorage = setLocalStorage;
function removeFromLocalStorage(key) {
    windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.getLocalStorage().removeItem(key);
}
...
function getCookieValue(name) {
    var value = "; " + cookieHandler_1.CookieHandlerReference.getReferenceOrThrow().cookieHandler.getCookieSync();
...
function setFrontendCookie(name, value, scope) {
    ...
    if (
        scope === "localhost" ||
        scope === windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.location.getHostName() ||
        scope === undefined
    ) {
        ...
        if (expires !== undefined) {
            cookieHandler_1.CookieHandlerReference.getReferenceOrThrow().cookieHandler.setCookieSync(
...
exports.useOnMountAPICall = function (fetch, handleResponse, handleError) {
    var consumeReq = react_1.useRef();
    react_1.useEffect(
        function () {
