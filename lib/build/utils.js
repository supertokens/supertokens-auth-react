...
var windowUtils_1 = require("./windowUtils");
/*
 * getRecipeIdFromPath
 * Input:
...
function clearErrorQueryParam() {
    var newURL = new URL(windowUtils_1.WindowUtilities.location.href);
    newURL.searchParams.delete("error");
    newURL.searchParams.delete("message");
    windowUtils_1.WindowUtilities.history.replaceState(
        windowUtils_1.WindowUtilities.history.state,
        "",
        windowUtils_1.WindowUtilities.location.href
    );
}
exports.clearErrorQueryParam = clearErrorQueryParam;
function getQueryParams(param) {
    var urlParams = new URLSearchParams(windowUtils_1.WindowUtilities.location.search);
    return urlParams.get(param);
}
exports.getQueryParams = getQueryParams;
function getURLHash() {
    // By default it is returined with the "#" at the beginning, we cut that off here.
    return windowUtils_1.WindowUtilities.location.hash.substr(1);
}
...
function getCurrentNormalisedUrlPath() {
    return new normalisedURLPath_1.default(windowUtils_1.WindowUtilities.location.pathname);
}
...
function matchRecipeIdUsingQueryParams(recipeId) {
    return function () {
        var recipeIdFromSearch = getRecipeIdFromSearch(windowUtils_1.WindowUtilities.location.search);
...
function redirectWithFullPageReload(to) {
    ...
    windowUtils_1.WindowUtilities.location.href = to;
}
...
function isIE() {
    return windowUtils_1.WindowUtilities.document.documentMode !== undefined;
}
exports.isIE = isIE;
function setSessionStorage(key, value) {
    windowUtils_1.WindowUtilities.sessionStorage.setItem(key, value);
}
exports.setSessionStorage = setSessionStorage;
function getSessionStorage(key) {
    return windowUtils_1.WindowUtilities.sessionStorage.getItem(key);
}
exports.getSessionStorage = getSessionStorage;
function getOriginOfPage() {
    return new normalisedURLDomain_1.default(windowUtils_1.WindowUtilities.location.origin);
}
exports.getOriginOfPage = getOriginOfPage;
function getLocalStorage(key) {
    var res = windowUtils_1.WindowUtilities.localStorage.getItem(key);
...
function setLocalStorage(key, value) {
    windowUtils_1.WindowUtilities.localStorage.setItem(key, value);
}
exports.setLocalStorage = setLocalStorage;
function removeFromLocalStorage(key) {
    windowUtils_1.WindowUtilities.localStorage.removeItem(key);
}
...
function getDefaultCookieScope() {
    try {
        return normaliseCookieScopeOrThrowError(windowUtils_1.WindowUtilities.location.hostname);
    } catch (_a) {
        return undefined;
    }
}
...
function getCookieValue(name) {
    var value = "; " + windowUtils_1.WindowUtilities.document.cookie;
...
function setFrontendCookie(name, value, scope) {
    ...
    if (scope === "localhost" || scope === windowUtils_1.WindowUtilities.location.hostname || scope === undefined) {
        ...
        if (expires !== undefined) {
            windowUtils_1.WindowUtilities.document.cookie =
