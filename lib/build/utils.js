...
var constants_2 = require("./recipe/emailpassword/constants");
/*
 * getRecipeIdFromPath
 * Input:
                        ...
                        return __generator(this, function(_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    value = input.value;
                                    if (input.id === constants_2.MANDATORY_FORM_FIELDS_ID.EMAIL) {
                                        value = value.trim();
                                    }
 ...
 */
function redirectToWithReload(url, queryParams) {
 ...
 */
function redirectToInApp(path, history, queryParams) {
    if (path.length === 0) {
        path = "/";
    }
