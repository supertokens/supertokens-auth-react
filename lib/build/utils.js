...
function jwtVerify(token, jwksUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var parts, headerB64, payloadB64, signatureB64, headerStr, header, kid, alg, jwksResponse, jwks, matchingKey, publicKey, signatureInput, signature, cryptoAlg, isValid, payloadStr, payload, now;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    parts = token.split(".");
