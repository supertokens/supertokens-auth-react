    ...
    return genericComponentOverrideContext.__assign(
        ...
        ),
        {
            ...
            oauth2LogoutScreen: {
                style:
                    (_c =
                        (_b = config === null || config === void 0 ? void 0 : config.oauth2LogoutScreen) === null ||
                        _b === void 0
                            ? void 0
...
var OAuth2Provider = /** @class */ (function (_super) {
    ...
    OAuth2Provider.prototype.logOut = function (logoutChallenge, userContext) {
        return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            this.webJSRecipe.logOut({ logoutChallenge: logoutChallenge, userContext: userContext }),
                        ];
                    case 1:
