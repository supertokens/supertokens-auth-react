...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImp), { getLoginChallengeInfo: function (input) {
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                var response;
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, originalImp.getLoginChallengeInfo(input)];
                        case 1:
                            response = _a.sent();
                            onHandleEvent({
            ...
            return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, originalImp.logOut(input)];
                        case 1:
                            response = _a.sent();
                            onHandleEvent({
...
var OAuth2Provider = /** @class */ (function (_super) {
    ...
    function OAuth2Provider(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = OAuth2WebJS__default.default; }
    ...
    OAuth2Provider.init = function (config) {
        return {
            ...
            authReact: function (appInfo, _, overrideMaps) {
                var normalisedConfig = normaliseOAuth2Config(genericComponentOverrideContext.applyPlugins(OAuth2Provider.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : []));
                OAuth2Provider.instance = new OAuth2Provider(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: OAuth2Provider.RECIPE_ID }));
            ...
            webJS: function () {
                ...
                var init = OAuth2WebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
