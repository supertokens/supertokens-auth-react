...
var getFunctionOverrides = function (onHandleEvent) {
    return function (originalImp) { return (logger.__assign(logger.__assign({}, originalImp), { getLoginChallengeInfo: function (input) {
...
var OAuth2Provider = /** @class */ (function (_super) {
    logger.__extends(OAuth2Provider, _super);
    ...
    OAuth2Provider.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                OAuth2Provider.instance = new OAuth2Provider(logger.__assign(logger.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: OAuth2Provider.RECIPE_ID }));
                return OAuth2Provider.instance;
            },
            webJS: OAuth2WebJS__default.default.init(logger.__assign(logger.__assign({}, normalisedConfig), { override: {
