    ...
    function BooleanClaim(config) {
        ...
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, validator.apply(void 0, args)), { onFailureRedirection: config.onFailureRedirection, showAccessDeniedOnFailure: config.showAccessDeniedOnFailure });
            };
        };
