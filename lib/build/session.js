...
var BooleanClaim = /** @class */ (function (_super) {
    utils.__extends(BooleanClaim, _super);
    function BooleanClaim(config) {
        ...
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return utils.__assign(utils.__assign({}, validator.apply(void 0, args)), { onFailureRedirection: config.onFailureRedirection, showAccessDeniedOnFailure: config.showAccessDeniedOnFailure });
            };
        };
...
var PrimitiveArrayClaim = /** @class */ (function (_super) {
    utils.__extends(PrimitiveArrayClaim, _super);
...
var PrimitiveClaim = /** @class */ (function (_super) {
    utils.__extends(PrimitiveClaim, _super);
