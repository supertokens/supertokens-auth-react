...
var BooleanClaim = /** @class */ (function (_super) {
    logger.__extends(BooleanClaim, _super);
    function BooleanClaim(config) {
        ...
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return logger.__assign(logger.__assign({}, validator.apply(void 0, args)), { onFailureRedirection: config.onFailureRedirection, showAccessDeniedOnFailure: config.showAccessDeniedOnFailure });
            };
        };
...
var PrimitiveArrayClaim = /** @class */ (function (_super) {
    logger.__extends(PrimitiveArrayClaim, _super);
...
var PrimitiveClaim = /** @class */ (function (_super) {
    logger.__extends(PrimitiveClaim, _super);
...
var SessionAPIWrapper = /** @class */ (function () {
    ...
    SessionAPIWrapper.getUserId = function (input) {
        return logger.__awaiter(this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                return [2 /*return*/, types.Session.getInstanceOrThrow().getUserId({
    ...
    SessionAPIWrapper.getAccessToken = function (input) {
        return logger.__awaiter(this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                return [2 /*return*/, types.Session.getInstanceOrThrow().getAccessToken({
                        userContext: genericComponentOverrideContext.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext),
                    })];
            });
        });
    ...
    SessionAPIWrapper.getAccessTokenPayloadSecurely = function (input) {
        return logger.__awaiter(this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                return [2 /*return*/, types.Session.getInstanceOrThrow().getAccessTokenPayloadSecurely({
                        userContext: genericComponentOverrideContext.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext),
                    })];
            });
        });
    ...
    SessionAPIWrapper.doesSessionExist = function (input) {
        return logger.__awaiter(this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                return [2 /*return*/, types.Session.getInstanceOrThrow().doesSessionExist({
                        userContext: genericComponentOverrideContext.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext),
                    })];
            });
        });
    ...
    SessionAPIWrapper.addAxiosInterceptors = function (axiosInstance, userContext) {
        return types.Session.addAxiosInterceptors(axiosInstance, genericComponentOverrideContext.getNormalisedUserContext(userContext));
    };
    SessionAPIWrapper.signOut = function (input) {
        return logger.__awaiter(this, void 0, void 0, function () {
            return logger.__generator(this, function (_a) {
                return [2 /*return*/, types.Session.getInstanceOrThrow().signOut({
                        userContext: genericComponentOverrideContext.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext),
                    })];
            });
        });
