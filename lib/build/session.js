...
var useClaimValue$1 = function (claim) {
    var ctx = sessionprebuiltui.useSessionContext();
    if (ctx.loading) {
        return {
            loading: true,
        };
...
var SessionAPIWrapper = /** @class */ (function () {
    ...
    SessionAPIWrapper.useSessionContext = sessionprebuiltui.useSessionContext;
    SessionAPIWrapper.useClaimValue = useClaimValue$1;
    SessionAPIWrapper.SessionAuth = sessionprebuiltui.SessionAuthWrapper;
    SessionAPIWrapper.ComponentsOverrideProvider = sessionprebuiltui.Provider;
...
exports.SessionContext = sessionprebuiltui.SessionContext;
