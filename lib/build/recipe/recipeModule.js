...
var RecipeModule = /** @class */ (function() {
    ...
    function RecipeModule(config) {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 6]);
                            new URL(redirectUrl);
                            return [4 /*yield*/, utils_1.redirectToWithReload(redirectUrl, queryParams)];
                        case 3:
                            // If full URL, use redirectToWithReload
                            return [2 /*return*/, _a.sent()];
                        case 4:
                            e_1 = _a.sent();
                            return [4 /*yield*/, utils_1.redirectToInApp(redirectUrl, history, queryParams)];
                        case 5:
        ...
        this.getRedirectionURL = function(context) {
            return __awaiter(_this, void 0, void 0, function() {
                var getRedirectionURL, redirectUrl;
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
