...
var AuthRecipeModule = /** @class */ (function (_super) {
    ...
    function AuthRecipeModule(config) {
        ...
        _this.getAuthRecipeModuleFeatureComponent = function (componentName) {
            return _this.emailVerification.getFeatureComponent(componentName);
        };
        ...
        _this.emailVerification = new recipe_2.default(
            __assign(
                {
