...
var AuthRecipeModule = /** @class */ (function (_super) {
    ...
    function AuthRecipeModule(config) {
        ...
        _this.getAuthRecipeModuleDefaultRedirectionURL = function (context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (context.action === "SIGN_IN_AND_UP") {
                    return [2 /*return*/, this.config.appInfo.websiteBasePath.getAsStringDangerous() + "?rid=" + this.config.recipeId];
                }
        ...
        _this.signOut = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, api_1.signOut(this)];
        ...
        _this.emailVerification = new recipe_2.default(__assign({ appInfo: config.appInfo, recipeId: config.recipeId, signOut: _this.signOut, postVerificationRedirect: function (history) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.redirect({
                        action: "SUCCESS",
                        isNewUser: false,
            ...
            }); }, redirectToSignIn: function (history) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.redirectToAuthWithoutRedirectToPath(undefined, history);
                    return [2 /*return*/];
                });
            }); }, getRedirectionURL: config.getRedirectionURL, onHandleEvent: config.onHandleEvent, palette: config.palette, preAPIHook: config.preAPIHook, useShadowDom: config.useShadowDom }, config.emailVerificationFeature));
        return _this;
    }
