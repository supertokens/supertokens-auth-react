...
var AuthRecipeModule = /** @class */ (function (_super) {
    ...
    function AuthRecipeModule(config) {
        ...
        _this.redirectToAuth = function (show, history, queryParams) {
        ...
        _this.emailVerification = new recipe_2.default(config.emailVerificationFeature || {
            appInfo: config.appInfo,
            recipeId: config.recipeId,
            signOut: _this.signOut,
            postVerificationRedirect: function (history) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    this.redirect({
                        action: "SUCCESS",
                        isNewUser: false
