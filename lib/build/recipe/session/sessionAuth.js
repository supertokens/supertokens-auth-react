...
var SessionAuth = /** @class */ (function (_super) {
    ...
    function SessionAuth(props) {
        ...
        _this.redirectToLogin = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.render = function () {
            if (_this.state.status === "READY") {
                return (react_1.default.createElement(sessionContext_1.default.Provider, { value: {
    ...
    SessionAuth.prototype.componentDidMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _1.doesSessionExist()];
                    case 1:
                        sessionExists = _a.sent();
                        if (!(sessionExists === false)) return [3 /*break*/, 5];
                        if (!(this.props.requireAuth !== true)) return [3 /*break*/, 2];
                        this.setState(function (oldState) {
                            return __assign({}, oldState, { status: "READY", userId: "", doesSessionExist: false, jwtPayload: {} });
                        });
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.redirectToLogin()];
                    ...
                    case 7:
                        ...
                        this.setState(function (oldState) {
                            return __assign({}, oldState, { status: "READY", userId: userId_1, doesSessionExist: true, jwtPayload: jwtPayload_1 });
                        });
                        _a.label = 8;
