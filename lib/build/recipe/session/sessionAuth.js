...
var SessionAuth = function (_a) {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        case 0:
                            ...
                            return [3 /*break*/, 10];
                        case 1:
                            if (!!hasParentProvider(parentSessionContext)) return [3 /*break*/, 4];
                            _b = setContext;
                            _c = {
                        ...
                        case 4:
                            return [2 /*return*/];
                        case 5:
                            if (!!hasParentProvider(parentSessionContext)) return [3 /*break*/, 7];
                            _d = setContext;
                            _e = {
                                doesSessionExist: true,
    ...
    return react_1.default.createElement(
        ...
        react_1.default.createElement(
            ...
            { requireSession: props.requireAuth !== undefined ? props.requireAuth : false },
            children
        )
    );
};
