...
var SessionAuth = function (_a) {
    ...
    var _b = react_1.useState(),
        sessionContext = _b[0],
        setSessionContext = _b[1];
    var session = recipe_1.default.getInstanceOrThrow();
    var buildSessionContext = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all([session.getJWTPayloadSecurely(), session.getUserId()])];
                    case 2:
    ...
    var updateSessionContext = function () {
        return __awaiter(_this, void 0, void 0, function () {
            var sessionContext;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, buildSessionContext()];
                    case 1:
    ...
    var onHandleEvent = function (ctx) {
        return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (ctx.action) {
                    ...
                    case "SIGN_OUT":
                    case "UNAUTHORISED":
                        return [2 /*return*/, updateSessionContext()];
                    default:
                        return [2 /*return*/];
                }
                return [2 /*return*/];
    ...
    return react_1.default.createElement(sessionContext_1.default.Provider, { value: sessionContext }, children);
};
