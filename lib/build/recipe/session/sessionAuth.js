    ...
    react_1.useEffect(function () {
        ...
        function setInitialContextAndMaybeRedirect() {
            return __awaiter(this, void 0, void 0, function () {
                var toSetContext, _i, _a, claim, ctx, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            return [4 /*yield*/, buildContext()];
                        case 1:
                            toSetContext = _c.sent();
                        ...
                        case 2:
                            if (!(toSetContext.doesSessionExist && props.requiredClaims !== undefined))
                                return [3 /*break*/, 10];
                            (_i = 0), (_a = props.requiredClaims);
                            _c.label = 3;
                        case 3:
                            if (!(_i < _a.length)) return [3 /*break*/, 10];
                            claim = _a[_i];
                            ctx = {};
                            return [4 /*yield*/, claim.shouldRefresh(toSetContext.accessTokenPayload, ctx)];
                        case 4:
                            if (!_c.sent()) return [3 /*break*/, 6];
                            return [4 /*yield*/, claim.refresh(ctx)];
                        case 5:
                            _c.sent();
                            _c.label = 6;
                        case 6:
                            ...
                            return [4 /*yield*/, session.current.getAccessTokenPayloadSecurely()];
                        case 7:
                            _b.accessTokenPayload = _c.sent();
                            // This can happen as a result of claim.refresh
                            if (cancelUseEffect) {
                                return [2 /*return*/];
                            }
                            return [4 /*yield*/, claim.isValid(toSetContext.accessTokenPayload, ctx)];
                        case 8:
                            if (!_c.sent()) {
