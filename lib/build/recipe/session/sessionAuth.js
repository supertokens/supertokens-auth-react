...
var SessionAuth = function (_a) {
    ...
    var requireAuth = props.requireAuth,
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 3:
                            return [2 /*return*/, _b.apply(void 0, [((_c.jwtPayload = _f.sent()), _c)])];
                        case 4:
                            _d = setContext;
                            _e = {
                                doesSessionExist: true,
                            ...
                            return [4 /*yield*/, index_1.getJWTPayloadSecurely()];
                        case 5:
                            return [2 /*return*/, _d.apply(void 0, [((_e.jwtPayload = _f.sent()), _e)])];
                        case 6:
                            setContext({
    ...
    react_1.useEffect(
        function () {
            if (sessionContext_1.isDefaultContext(parentSessionContext)) {
                setInitialContext();
    ...
    return react_1.default.createElement(
        ...
        { value: context },
        react_1.default.createElement(RequireSession_1.RequireSession, { requireSession: requireAuth }, children)
    );
};
