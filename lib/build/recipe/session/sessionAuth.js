...
var SessionAuth = /** @class */ (function (_super) {
    ...
    SessionAuth.prototype.componentDidMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sessionExists, redirectToPath, userId_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(this.props.requireAuth === false)) return [3 /*break*/, 2];
                        this.setState(function (oldState) {
                            return __assign({}, oldState, { status: "READY", userId: "", doesSessionExist: false });
                        });
                        return [3 /*break*/, 4];
                    case 2:
