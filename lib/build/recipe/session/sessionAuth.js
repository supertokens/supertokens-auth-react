...
var SessionAuth = function (_a) {
    ...
    var _b = (0, react_1.useState)({ loading: true }),
        context = _b[0],
        setContext = _b[1];
    ...
    var setInitialContextAndMaybeRedirect = (0, react_1.useCallback)(
        function (toSetContext) {
            return __awaiter(void 0, void 0, void 0, function () {
                var firstRedirectingClaimError;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            firstRedirectingClaimError = toSetContext.invalidClaims.find(function (err) {
                                return err.redirectPath !== undefined;
                            });
                            if (!firstRedirectingClaimError) return [3 /*break*/, 3];
                            return [
                                4 /*yield*/,
                                recipe_1.default
                                    .getInstanceOrThrow()
                                    .redirectToUrl(firstRedirectingClaimError.redirectPath),
                            ];
                        case 2:
                            _a.sent();
                            _a.label = 3;
        ...
        function () {
            function onHandleEvent(event) {
                return __awaiter(this, void 0, void 0, function () {
                    var _a, invalidClaims, firstRedirectingClaimError;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _a = event.action;
