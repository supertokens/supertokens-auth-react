...
var SessionAuth = function (_a) {
    ...
    react_1.useEffect(function () {
        var cancelUseEffect = new AbortController();
        var checkGrants = function (context) {
            return __awaiter(void 0, void 0, void 0, function () {
                var retVal, _i, _a, grant, passes;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            retVal = true;
                            if (!(props.requiredGrants !== undefined)) return [3 /*break*/, 7];
                            (_i = 0), (_a = props.requiredGrants);
                            _b.label = 1;
                        case 1:
                            ...
                            return [
                                4 /*yield*/,
                                grant.checkPayload(context.accessTokenPayload, cancelUseEffect.signal),
                            ];
                        case 2:
                            passes = _b.sent();
                            ...
                            if (!(passes === undefined)) return [3 /*break*/, 4];
                            return [4 /*yield*/, grant.checkAPI(cancelUseEffect.signal)];
                        case 3:
                            passes = _b.sent();
                            if (cancelUseEffect.signal.aborted) {
                                return [2 /*return*/, false];
                            ...
                            _b.label = 4;
                        case 4:
                            if (!(passes !== true)) return [3 /*break*/, 6];
                            return [4 /*yield*/, grant.onFailedCheck({ history: history }, cancelUseEffect.signal)];
                        case 5:
                            _b.sent();
                            retVal = false;
                            if (cancelUseEffect.signal.aborted) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [3 /*break*/, 4];
                        case 2:
                            return [4 /*yield*/, checkGrants(toSetContext)];
                        case 3:
                            _a.sent();
