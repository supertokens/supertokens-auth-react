...
var SessionAuth = function (_a) {
    ...
    var getRedirectPathFromInvalidClaimsOrRedirect = function (claims) {
        return __awaiter(void 0, void 0, void 0, function () {
            var globalValidators, failedClaimValidatorID, _a, _b;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        failedClaimValidatorID =
                            (_c = claims.find(function (claim) {
                                var _a;
                                ...
                                return (
                                    ((_a =
                                        validator === null || validator === void 0 ? void 0 : validator.onFailure) ===
                                        null || _a === void 0
                                        ? void 0
                                ...
                                ? void 0
                                : _c.validatorId;
                        if (!(failedClaimValidatorID === undefined)) return [3 /*break*/, 3];
                    ...
                    case 1:
                        return [4 /*yield*/, _b.apply(_a, [_d.sent(), history])];
                    case 2:
                        _d.sent();
                        return [2 /*return*/];
                    case 3:
                        return [
                            ...
                            globalValidators
                                .find(function (_a) {
                                    var id = _a.id;
                                    return id === failedClaimValidatorID;
                                })
                                .onFailure(),
                        ];
                    case 4:
