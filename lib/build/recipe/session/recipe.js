...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config) {
        ...
        _this.redirectToAuthWithRedirectToPath = function (history, queryParams) {
            ...
            return _this.redirectToAuthWithoutRedirectToPath(history, queryParams);
        };
        _this.redirectToAuthWithoutRedirectToPath = function (history, queryParams) {
            var redirectUrl = (0, utils_1.appendQueryParamsToURL)(_this.config.appInfo.websiteBasePath, queryParams);
            return _this.redirectToUrl(redirectUrl, history);
        };
        ...
        _this.validateGlobalClaimsAndRedirect = function (successEvent, userContext, history) {
            return __awaiter(_this, void 0, void 0, function () {
                var invalidClaims, firstRedirectingClaimError, jsonContext, successContextStr;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            firstRedirectingClaimError = invalidClaims.find(function (err) {
                                return err.redirectPath !== undefined;
                            });
                            if (!firstRedirectingClaimError) return [3 /*break*/, 4];
                            if (!(successEvent !== undefined)) return [3 /*break*/, 3];
                            jsonContext = JSON.stringify(successEvent);
                            return [
                                4 /*yield*/,
                        ...
                        case 2:
                            ...
                            _a.label = 3;
                        case 3:
                            return [2 /*return*/, this.redirectToUrl(firstRedirectingClaimError.redirectPath, history)];
                        case 4:
                            if (!(successEvent === undefined)) return [3 /*break*/, 11];
                            return [4 /*yield*/, (0, utils_1.getLocalStorage)("supertokens-post-email-verification")];
                        case 5:
                            successContextStr = _a.sent();
                            if (!(successContextStr !== null)) return [3 /*break*/, 10];
                            _a.label = 6;
                        case 6:
                            _a.trys.push([6, , 7, 9]);
                        ...
                        case 7:
                            return [
                                4 /*yield*/,
                                (0, utils_1.removeFromLocalStorage)("supertokens-post-email-verification"),
                            ];
                        case 8:
                            _a.sent();
                            return [7 /*endfinally*/];
                        ...
                        case 10:
                            ...
                            _a.label = 11;
                        case 11:
                            return [2 /*return*/, this.redirect(successEvent)];
                    }
                });
            });
        };
