...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config) {
        ...
        _this.getUserId = function () {
            return _this.recipeImpl.getUserId();
        };
        _this.getJWTPayloadSecurely = function () {
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.recipeImpl.getJWTPayloadSecurely()];
                });
            });
        };
        _this.doesSessionExist = function () {
            return _this.recipeImpl.doesSessionExist();
        };
        _this.signOut = function () {
            return _this.recipeImpl.signOut();
        };
        ...
        _this.sessionExpiredStatusCode =
        ...
        _this.recipeImpl = override.functions(new recipeImplementation_1.default(config));
        return _this;
    }
