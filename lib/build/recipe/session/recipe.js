...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config) {
        ...
        _this.validateClaims = function (claimValidators, userContext) {
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            (_i = 0), (claimValidators_1 = claimValidators);
                            _b.label = 2;
                        case 2:
                            if (!(_i < claimValidators_1.length)) return [3 /*break*/, 7];
                            validator = claimValidators_1[_i];
                        ...
                        case 6:
                            ...
                            return [3 /*break*/, 2];
                        case 7:
                            (_a = 0), (claimValidators_2 = claimValidators);
                            _b.label = 8;
                        case 8:
                            if (!(_a < claimValidators_2.length)) return [3 /*break*/, 11];
                            validator = claimValidators_2[_a];
        ...
        _this.addDefaultClaimValidator = function (claimValidator) {
            _this.defaultClaimValidators.push(claimValidator);
        };
        _this.getDefaultClaimValidators = function () {
            return _this.defaultClaimValidators;
        };
        /**
    ...
    Session.prototype.redirectToAuthWithRedirectToPath = function (history, queryParams) {
        var redirectToPath = utils_1.getCurrentNormalisedUrlPath().getAsStringDangerous();
    ...
    Session.prototype.redirectToAuthWithoutRedirectToPath = function (history, queryParams) {
        var redirectUrl = utils_1.appendQueryParamsToURL(this.config.appInfo.websiteBasePath, queryParams);
