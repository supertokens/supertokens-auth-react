        ...
        _this.validateGlobalClaimsAndHandleSuccessRedirection = function (redirectInfo, userContext, history) {
            return __awaiter(_this, void 0, void 0, function () {
                var globalValidators,
                    ...
                    emailVerificationClaimValidator,
                    successRedirectURL,
                    successContextStr,
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            findClaimValidator = function (claimID) {
                                return globalValidators.find(function (_a) {
                                    var id = _a.id;
                                    return id === claimID;
                                });
                            };
                        ...
                        case 3:
                            ...
                            _c.label = 4;
                        case 4:
                            failedClaim = findClaimValidator(invalidClaims[0].validatorId);
                            if (!(failedClaim.onFailure === undefined)) return [3 /*break*/, 6];
                            _b = (_a = superTokens_1.default.getInstanceOrThrow()).redirectToUrl;
                            return [
                                4 /*yield*/,
                                Session.getInstanceOrThrow().getRedirectUrl({ userContext: userContext }),
                            ];
                        case 5:
                            return [2 /*return*/, _b.apply(_a, [_c.sent(), history])];
                        case 6:
                            invalidClaimRedirectPath = failedClaim.onFailure();
                        ...
                        case 7:
                            emailVerificationClaimValidator = findClaimValidator("st-ev");
                            return [4 /*yield*/, emailVerificationClaimValidator.onSuccess()];
                        case 8:
                            successRedirectURL = _c.sent();
                            if (successRedirectURL) {
                                ...
                                return [
                                    ...
                                    superTokens_1.default
                                        .getInstanceOrThrow()
                                        .redirectToUrl(successRedirectURL, history),
                                ];
                            }
