...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config) {
        ...
        _this.redirectToAuthWithoutRedirectToPath = function (history, queryParams) {
            var redirectUrl = (0, utils_1.appendQueryParamsToURL)(
                _this.config.appInfo.websiteBasePath.getAsStringDangerous(),
                queryParams
            );
        ...
        _this.validateGlobalClaimsAndRedirect = function (successEvent, userContext, history) {
            return __awaiter(_this, void 0, void 0, function () {
                var invalidClaims, invalidClaimRedirectPath, jsonContext, successContextStr;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 2:
                            ...
                            _a.label = 3;
                        case 3:
                            return [2 /*return*/, this.redirectToUrl(invalidClaimRedirectPath, history)];
                        case 4:
