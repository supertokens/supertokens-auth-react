...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config) {
        ...
        _this.getJWTPayloadSecurely = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, supertokens_website_1.default.getJWTPayloadSecurely()];
            });
        }); };
        _this.attemptRefreshingSession = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        supertokens_website_1.default.init({
            sessionScope: config.sessionScope === undefined
                ? undefined
                : {
                    scope: config.sessionScope,
                    authDomain: config.appInfo.websiteDomain.getAsStringDangerous(),
                },
            refreshAPICustomHeaders: __assign({ rid: _this.config.recipeId }, usersHeadersForRefreshAPI),
            signoutAPICustomHeaders: __assign({ rid: _this.config.recipeId }, usersHeadersForSignoutAPI),
