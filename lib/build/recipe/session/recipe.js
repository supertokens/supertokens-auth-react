...
var Session = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                this.webJsRecipe.getAccessTokenPayloadSecurely({ userContext: userContext }),
                            ];
                        case 1:
    ...
    Session.prototype.redirectToAuthWithoutRedirectToPath = function (history, queryParams) {
        var redirectUrl = (0, utils_1.appendQueryParamsToURL)(this.config.appInfo.websiteBasePath, queryParams);
