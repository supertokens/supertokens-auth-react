                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, (0, globalClaimValidators_1.getGlobalClaimValidators)()];
                        case 2:
                            globalValidators = _e.sent();
                            return [4 /*yield*/, this.validateClaims({ userContext: userContext })];
                        case 3:
                            invalidClaims = _e.sent();
                            if (!(invalidClaims.length > 0)) return [3 /*break*/, 9];
                        ...
                        case 4:
                            ...
                            _e.label = 5;
                        case 5:
                            getRedirectionPath = function () {
                                return __awaiter(_this, void 0, void 0, function () {
                                    var callbacks, _loop_1, _i, invalidClaims_1, claim;
                                    var _a;
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                    ...
                                                    if (
                                                        ...
                                                        callbacks.push(
                                                            (_a =
                                                                validator === null || validator === void 0
                                                                    ? void 0
                                                                    : validator.onFailureRedirection) === null ||
                                                                _a === void 0
                                                                ? void 0
                                                                : _a.call(validator)
                                                        );
                                                ...
                                                return [4 /*yield*/, Promise.all(callbacks)];
                                            case 1:
                                                return [2 /*return*/, _b.sent().filter(Boolean)[0]];
                                        }
                                    });
                                });
                            };
                            return [4 /*yield*/, getRedirectionPath()];
                        case 6:
                            redirectPath = _e.sent();
                            if (!(redirectPath === undefined)) return [3 /*break*/, 8];
                            _b = (_a = superTokens_1.default.getInstanceOrThrow()).redirectToUrl;
                            return [
                                4 /*yield*/,
                                superTokens_1.default.getInstanceOrThrow().getRedirectUrl({
                                    action: "SESSION_VERIFICATION_FAILURE",
                                }),
                            ];
                        case 7:
                            return [2 /*return*/, _b.apply(_a, [_e.sent(), history])];
                        case 8:
                            return [
                                2 /*return*/,
                        ...
                        case 9:
                            return [
                                4 /*yield*/,
                                (_d =
                                    (_c = globalValidators.find(function (_a) {
                                        var onSuccessRedirection = _a.onSuccessRedirection;
                                        return (
                                            (onSuccessRedirection === null || onSuccessRedirection === void 0
                                                ? void 0
                                                : onSuccessRedirection()) !== undefined
                                        );
                                    })) === null || _c === void 0
                                        ? void 0
                                        : _c.onSuccessRedirection) === null || _d === void 0
                                    ? void 0
                                    : _d.call(_c),
                            ];
                        case 10:
                            succeededClaimValidatorRedirectString = _e.sent();
                            if (succeededClaimValidatorRedirectString) {
                                return [
                                    2 /*return*/,
                                    superTokens_1.default
                                        .getInstanceOrThrow()
                                        .redirectToUrl(succeededClaimValidatorRedirectString, history),
                                ];
                            }
                            if (!(redirectInfo === undefined)) return [3 /*break*/, 17];
                            return [
                                4 /*yield*/,
                                (0, utils_1.getLocalStorage)("supertokens-success-redirection-context"),
                            ];
                        case 11:
                            successContextStr = _e.sent();
                            if (!(successContextStr !== null)) return [3 /*break*/, 16];
                            _e.label = 12;
                        case 12:
                            _e.trys.push([12, , 13, 15]);
