...
var session_1 = __importDefault(require("supertokens-web-js/recipe/session"));
var utils_2 = require("../recipeModule/utils");
var superTokens_1 = __importDefault(require("../../superTokens"));
var session_2 = __importDefault(require("supertokens-web-js/recipe/session"));
var Session = /** @class */ (function (_super) {
    __extends(Session, _super);
    function Session(config, webJSRecipe) {
        if (webJSRecipe === void 0) {
            webJSRecipe = session_1.default;
        }
    ...
    Session.addAxiosInterceptors = function (axiosInstance, userContext) {
        return session_1.default.addAxiosInterceptors(axiosInstance, userContext);
    };
    Session.init = function (config) {
        var _this = this;
        var normalisedConfig = (0, utils_2.normaliseRecipeModuleConfig)(config);
        return {
