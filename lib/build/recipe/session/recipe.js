...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config) {
        var _this = this;
        var normalisedConfig = __assign(__assign({}, config), (0, utils_2.normaliseRecipeModuleConfig)(config));
        _this = _super.call(this, normalisedConfig) || this;
    ...
    Session.init = function (config) {
        ...
        return {
            ...
            webJS: session_1.default.init(normalisedConfig),
        };
    };
