            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 5:
                            failedClaimValidatorID_1 =
                                (_c = invalidClaims.find(function (claim) {
                                    var _a;
                                    ...
                                    return (
                                        ((_a =
                                            validator === null || validator === void 0
                                                ? void 0
                                                : validator.onFailure) === null || _a === void 0
                                            ? void 0
                                            : _a.call(validator)) !== undefined
                                    );
                                })) === null || _c === void 0
                                    ? void 0
                                    : _c.validatorId;
                            if (!(failedClaimValidatorID_1 === undefined)) return [3 /*break*/, 7];
                        ...
                        case 6:
                            return [2 /*return*/, _b.apply(_a, [_f.sent(), history])];
                        case 7:
                            return [
                                4 /*yield*/,
                                globalValidators
                                    .find(function (_a) {
                                        var id = _a.id;
                                        return id === failedClaimValidatorID_1;
                                    })
                                    .onFailure(),
                            ];
                        case 8:
                            invalidClaimRedirectPath = _f.sent();
                            return [
                                2 /*return*/,
                        ...
                        case 9:
                            return [
                                4 /*yield*/,
                                (_e =
                                    (_d = globalValidators.find(function (_a) {
                                        ...
                                        ? void 0
                                        : _d.onSuccess) === null || _e === void 0
                                    ? void 0
                                    : _e.call(_d),
                            ];
                        case 10:
                            succeededClaimValidatorRedirectString = _f.sent();
                        ...
                        case 11:
                            successContextStr = _f.sent();
                            if (!(successContextStr !== null)) return [3 /*break*/, 16];
                            _f.label = 12;
                        case 12:
                            _f.trys.push([12, , 13, 15]);
