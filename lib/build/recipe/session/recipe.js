...
var cookieHandler_1 = __importDefault(require("../../common/cookieHandler"));
var windowHandler_1 = __importDefault(require("../../common/windowHandler"));
        ...
        supertokens_website_1.default.init(
            __assign(__assign({}, config), {
                cookieHandler: function () {
                    return cookieHandler_1.default.getReferenceOrThrow().cookieHandler;
                },
                windowHandler: function () {
                    return windowHandler_1.default.getReferenceOrThrow().windowHandler;
                },
