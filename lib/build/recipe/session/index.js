...
var SessionAPIWrapper = /** @class */ (function () {
    ...
    SessionAPIWrapper.getAccessTokenPayloadSecurely = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, recipe_1.default.getInstanceOrThrow().getAccessTokenPayloadSecurely()];
            });
        });
    };
    ...
    SessionAPIWrapper.validateClaims = function (claimValidators) {
        return recipe_1.default.getInstanceOrThrow().validateClaims(claimValidators);
    };
    // have backwards compatibility to allow input as "signin" | "signup"
    SessionAPIWrapper.redirectToAuth = function (input) {
        if ((input === null || input === void 0 ? void 0 : input.redirectBack) !== true) {
            return recipe_1.default.getInstanceOrThrow().redirectToAuthWithoutRedirectToPath();
        } else {
            return recipe_1.default.getInstanceOrThrow().redirectToAuthWithRedirectToPath();
        }
    };
