...
import type { Navigate, NormalisedConfigWithAppInfoAndRecipeID, RecipeInitResult, SuccessRedirectContextInApp, SuccessRedirectContextOAuth2, UserContext } from "../../types";
...
export default class Session extends RecipeModule<unknown, unknown, unknown, NormalisedSessionConfig> {
    ...
    validateClaims: (input: {
        overrideGlobalClaimValidators?: ((globalClaimValidators: SessionClaimValidator[], userContext: UserContext) => SessionClaimValidator[]) | undefined;
        userContext: UserContext;
    ...
    validateGlobalClaimsAndHandleSuccessRedirection: (successRedirectContext: ((Omit<SuccessRedirectContextInApp, "recipeId"> | Omit<SuccessRedirectContextOAuth2, "recipeId">) & {
        recipeId: string;
        tenantIdFromQueryParams: string | undefined;
    }) | undefined, fallbackRecipeId: string, redirectToPath: string | undefined, userContext: UserContext | undefined, navigate: Navigate | undefined) => Promise<void>;
    /**
