...
exports.normaliseSessionConfigOrThrow = normaliseSessionConfigOrThrow;
 ...
 * under the License.
 */
function normaliseSessionConfigOrThrow(config) {
    var sessionScope = config.sessionScope !== undefined ? config.sessionScope : getDefaultSessionScope();
    var autoAddCredentials = config.autoAddCredentials ? config.autoAddCredentials : true;
    var refreshAPICustomHeaders = config.refreshAPICustomHeaders !== undefined ? config.refreshAPICustomHeaders : {};
