...
var Session = /*#__PURE__*/ (function(_RecipeModule) {
    ...
    function Session(config) {
        ...
        _this.getRefreshURLDomain = function() {
            return _supertokensWebsite["default"].getRefreshURLDomain();
        };

        _this.getUserId = function() {
            return _supertokensWebsite["default"].getUserId();
        };
                        ...
                        switch ((_context.prev = _context.next)) {
                            case 0:
                                return _context.abrupt(
                                    "return",
                                    _supertokensWebsite["default"].getJWTPayloadSecurely()
                                );
                        ...
                        switch ((_context2.prev = _context2.next)) {
                            case 0:
                                return _context2.abrupt(
                                    "return",
                                    _supertokensWebsite["default"].attemptRefreshingSession()
                                );
        ...
        _this.doesSessionExist = function() {
            return _supertokensWebsite["default"].doesSessionExist();
        };

        _this.setAuth0API = function(apiPath) {
            return _supertokensWebsite["default"].setAuth0API(apiPath);
        };

        _this.getAuth0API = function() {
            return _supertokensWebsite["default"].getAuth0API();
        };
    ...
    _createClass(Session, null, [
        ...
        },
        {
            ...
            value: function getInstanceOrThrow() {
                if (Session.instance === undefined) {
                    throw Error(
                        "No instance of Session found. Make sure to call the Session.init method. See https://supertokens.io/docs/emailpassword/starter-guide/frontend"
                    );
                }
        ...
        },
        {
            ...
            value: function addAxiosInterceptors(axiosInstance) {
                return _supertokensWebsite["default"].addAxiosInterceptors(axiosInstance);
            }
        },
        {
            key: "setAuth0API",
