...
var Session = /*#__PURE__*/ (function(_RecipeModule) {
    ...
    function Session(config) {
        ...
        _this.addAxiosInterceptors = function() {
            return _this.sessionSdk.addAxiosInterceptors();
        };

        _this.setAuth0API = function() {
            return _this.sessionSdk.setAuth0API();
        };
    ...
    _createClass(Session, null, [
        ...
        },
        {
            ...
            value: function addAxiosInterceptors() {
                return Session.getInstanceOrThrow().addAxiosInterceptors();
            }
        },
        {
            key: "setAuth0API",
            value: function setAuth0API() {
