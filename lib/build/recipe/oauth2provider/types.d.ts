...
import type { NormalisedBaseConfig, NormalisedGetRedirectionURLContext, SuccessRedirectContextOAuth2, UserContext } from "../../types";
import type { UserInput as RecipeModuleUserInput, NormalisedConfig as NormalisedRecipeModuleConfig } from "../recipeModule/types";
import type OverrideableBuilder from "supertokens-js-override";
import type { LoginInfo, RecipeInterface } from "supertokens-web-js/recipe/oauth2provider/types";
export declare type PreAndPostAPIHookAction = "GET_LOGIN_CHALLENGE_INFO" | "GET_REDIRECT_URL_TO_CONTINUE_OAUTH_FLOW" | "LOG_OUT";
...
export declare type NormalisedConfig = NormalisedRecipeModuleConfig<GetRedirectionURLContext, PreAndPostAPIHookAction, OnHandleEventContext> & {
    disableDefaultUI: boolean;
...
export declare type GetRedirectionURLContext = NormalisedGetRedirectionURLContext<SuccessRedirectContextOAuth2 | ContinueOAuth2AfterRefreshRedirectContext | PostOAuth2LogoutRedirectContext>;
