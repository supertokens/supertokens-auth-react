    ...
    return function (originalImp) {
        return {
            ...
            doesPhoneNumberExist: function (input) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                return [4 /*yield*/, originalImp.doesPhoneNumberExist(input)];
                            case 1:
                                return [2 /*return*/, _a.sent()];
                        }
                    });
            ...
            getLoginAttemptInfo: function (input) {
                return originalImp.getLoginAttemptInfo(input);
            },
            setLoginAttemptInfo: function (input) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, originalImp.setLoginAttemptInfo(input)];
                    });
                });
            },
