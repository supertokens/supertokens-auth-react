...
var Passwordless = /** @class */ (function (_super) {
    ...
    function Passwordless(config, recipeImpl) {
        if (recipeImpl === void 0) {
            recipeImpl = passwordless_1.default;
        }
    ...
    Passwordless.init = function (config) {
        var normalizedConfig = (0, utils_2.normalisePasswordlessConfig)(config);
        return {
            authReact: function (appInfo) {
                Passwordless.instance = new Passwordless(
                    __assign(__assign({}, normalizedConfig), { appInfo: appInfo, recipeId: Passwordless.RECIPE_ID })
                );
                return Passwordless.instance;
            },
            webJS: passwordless_1.default.init(
