...
var successScreen_1 = __importDefault(require("./components/features/successScreen"));
...
var Passwordless = /** @class */ (function (_super) {
    ...
    function Passwordless(config) {
        ...
        _this.getFeatures = function () {
            var features = {};
            if (
                _this.config.contactMethod === "EMAIL"
                    ? _this.config.emailForm.disableDefaultImplementation !== true
                    : _this.config.mobileForm.disableDefaultImplementation !== true
            ) {
            ...
            if (_this.config.linkClickedScreen.disableDefaultImplementation !== true) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(
            ...
            if (_this.config.linkClickedScreen.disableDefaultImplementation !== true) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(
                    new normalisedURLPath_1.default("/success")
                );
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: utils_1.matchRecipeIdUsingQueryParams(_this.config.recipeId),
                    component: function (props) {
                        return _this.getFeatureComponent("successScreen", props);
                    },
                };
            }
            return features;
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    if (context.action === "SUCCESS_IN_ANOTHER_TAB") {
                        resetPasswordPath = new normalisedURLPath_1.default(constants_2.DEFAULT_SUCCESS_PATH);
                        return [
                            2 /*return*/,
        ...
        _this.getFeatureComponent = function (componentName, props) {
            ...
            if (componentName === "successScreen") {
                return react_1.default.createElement(successScreen_1.default, __assign({ recipe: _this }, props));
            }
