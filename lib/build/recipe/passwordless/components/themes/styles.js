...
function getStyles(palette) {
    ...
    var passwordlessStyles = {
        generalSuccess: {
            marginBottom: "20px",
            animation: styles_1.swingIn + " 1s cubic-bezier(0.175, 0.885, 0.320, 1.275) alternate 2 both",
        },
    ...
    var recipeStyles = styles_1.getMergedStyles(emailPasswordStyles, passwordlessStyles);
