 ...
 * Component.
 */
var PasswordlessLinkEmailSent = /** @class */ (function (_super) {
    __extends(PasswordlessLinkEmailSent, _super);
    function PasswordlessLinkEmailSent(props) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                this.props.recipeImplementation.createCode({
    ...
    PasswordlessLinkEmailSent.prototype.componentWillUnmount = function () {
        if (this.state.resendNotifTimeout) {
            clearTimeout(this.state.resendNotifTimeout);
        }
    };
    PasswordlessLinkEmailSent.prototype.render = function () {
        var _this = this;
        var styles = this.context;
        var status = this.state.status;
        var resendActive = status === "EMAIL_RESENT";
        return react_1.jsx(
            "div",
            ...
            react_1.jsx(
                ...
                react_1.jsx(
                    "div",
                    { "data-supertokens": "sendCodeEmailIcon", css: styles.sendCodeEmailIcon },
                ...
                status !== "EMAIL_RESENT" &&
                    react_1.jsx(resendLinkButton_1.ResendLinkButton, {
    ...
    PasswordlessLinkEmailSent.contextType = styleContext_1.default;
    return PasswordlessLinkEmailSent;
})(react_2.PureComponent);
exports.LinkEmailSent = withOverride_1.withOverride("PasswordlessLinkEmailSent", PasswordlessLinkEmailSent);
