...
var PasswordlessLinkSent = function (props) {
    ...
    var _a = react_2.useState(props.error !== undefined ? "ERROR" : "READY"),
        status = _a[0],
        setStatus = _a[1];
    // Any because node types are included here, messing with return type of setTimeout
    var resendNotifTimeout = react_2.useRef();
    ...
    var resendEmail = react_2.useCallback(
        function () {
    ...
    return react_1.jsx(
        ...
        react_1.jsx(
            ...
            react_1.jsx(
                ...
                react_1.jsx("strong", null, props.loginAttemptInfo.contactInfo),
                props.loginAttemptInfo.contactMethod === "EMAIL"
