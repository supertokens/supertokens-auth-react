...
exports.EmailOrPhoneForm = withOverride_1.withOverride(
    ...
    function PasswordlessEmailOrPhoneForm(props) {
        ...
        var _a = react_2.useState(),
            phoneNumberInitialValue = _a[0],
            setPhoneNumberInitialValue = _a[1];
        return react_1.jsx(formBase_1.default, {
            formFields: [
                {
                    ...
                    inputComponent: phoneNumberInitialValue
                        ? phoneNumberInput_1.phoneNumberInputWithInjectedProps({
            ...
            callAPI: function (formFields) {
                return __awaiter(_this, void 0, void 0, function () {
                    var emailOrPhone, emailValidationRes, phoneValidationRes, intPhoneNumber;
                    var _a;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, validators_1.defaultEmailValidator(emailOrPhone)];
                            case 1:
