...
var phoneNumberInput_1 = __importDefault(require("./phoneNumberInput"));
exports.MobileForm = withOverride_1.withOverride("PasswordlessMobileForm", function PasswordlessMobileForm(props) {
    var _this = this;
        ...
        formFields: [
            {
                id: "phoneNumber",
                label: "Mobile",
                inputComponent: phoneNumberInput_1.default,
                optional: false,
