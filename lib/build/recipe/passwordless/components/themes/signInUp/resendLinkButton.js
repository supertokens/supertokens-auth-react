...
exports.ResendLinkButton = withOverride_1.withOverride(
    "PasswordlessResendLinkButton",
    function PasswordlessResendLinkButton(_a) {
        var loginAttemptInfo = _a.loginAttemptInfo,
            resendCodeTimeGap = _a.resendCodeTimeGap,
            onClick = _a.onClick;
        ...
        react_2.useEffect(
            function () {
                ...
                var interval = setInterval(function () {
                    var timer = loginAttemptInfo.lastResend + resendCodeTimeGap * 1000 - new Date().getTime();
                    if (timer <= 0) {
