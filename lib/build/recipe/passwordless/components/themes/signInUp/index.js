                  ...
                  featureState.loaded &&
                      react_1.jsx(
                          ...
                          activeScreen === SignInUpScreens.EmailForm
                              ? react_1.jsx(emailForm_1.EmailForm, __assign({}, commonProps))
                              : activeScreen === SignInUpScreens.PhoneForm
                              ? react_1.jsx(phoneForm_1.PhoneForm, __assign({}, commonProps))
                              : activeScreen === SignInUpScreens.EmailOrPhoneForm
                              ? react_1.jsx(emailOrPhoneForm_1.EmailOrPhoneForm, __assign({}, commonProps))
                              : activeScreen === SignInUpScreens.UserInputCodeForm
                              ? react_1.jsx(
