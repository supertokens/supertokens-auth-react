...
exports.SignInUpCodeInputHeader = withOverride_1.withOverride(
    "PasswordlessSignInUpCodeInputHeader",
    function PasswordlessSignInUpCodeInputHeader(_a) {
        var loginAttemptInfo = _a.loginAttemptInfo;
        var styles = react_2.useContext(styleContext_1.default);
        return react_1.jsx(
            react_2.Fragment,
            null,
            react_1.jsx("div", { "data-supertokens": "headerTitle", css: styles.headerTitle }, "Enter OTP"),
            react_1.jsx(
                "div",
                { "data-supertokens": "headerSubtitle", css: styles.headerSubtitle },
                "An OTP was sent to you at ",
