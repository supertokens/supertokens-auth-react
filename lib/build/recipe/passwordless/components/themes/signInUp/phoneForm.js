...
exports.PhoneForm = withOverride_1.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    var _this = this;
    var styles = react_3.useContext(styleContext_1.default);
    return react_1.jsx(
        react_2.Fragment,
        null,
        props.header,
        props.error &&
            react_1.jsx("div", { "data-supertokens": "generalError", css: styles.generalError }, props.error),
            ...
            formFields: [
                {
                    ...
                    inputComponent: phoneNumberInput_1.phoneNumberInputWithInjectedProps({
