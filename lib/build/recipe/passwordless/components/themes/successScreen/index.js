 ...
 * Component.
 */
var PasswordlessSuccessScreen = /** @class */ (function (_super) {
    __extends(PasswordlessSuccessScreen, _super);
    function PasswordlessSuccessScreen() {
    ...
    PasswordlessSuccessScreen.contextType = styleContext_1.default;
    return PasswordlessSuccessScreen;
})(react_2.PureComponent);
exports.SuccessScreen = withOverride_1.withOverride("PasswordlessSuccessScreen", PasswordlessSuccessScreen);
