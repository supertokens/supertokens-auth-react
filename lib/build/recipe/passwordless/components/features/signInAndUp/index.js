...
var componentOverrideContext_2 = require("../../../componentOverrideContext");
...
function useChildProps(recipe, dispatch, state, callingConsumeCodeRef, userContext, history) {
    var recipeImplementation = React.useMemo(
        function () {
            return recipe && getModifiedRecipeImplementation(recipe.webJSRecipe, dispatch, callingConsumeCodeRef);
        },
        [recipe]
    );
...
var SignInUpFeature = function (props) {
    var recipeComponentOverrides = (0, componentOverrideContext_2.useRecipeComponentOverrideContext)();
    var userContext = (0, usercontext_1.useUserContext)();
    var _a = (0, exports.useFeatureReducer)(props.recipe.webJSRecipe, userContext),
        state = _a[0],
        dispatch = _a[1];
    ...
    return __assign(__assign({}, originalImpl), {
        createCode: function (input) {
            return __awaiter(_this, void 0, void 0, function () {
                var contactInfo, contactMethod, additionalAttemptInfo, res, loginAttemptInfo;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            contactInfo =
                                "email" in input ? input.email : (0, min_1.formatPhoneNumberIntl)(input.phoneNumber);
