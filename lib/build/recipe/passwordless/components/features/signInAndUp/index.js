...
var SignInUp = /** @class */ (function (_super) {
    ...
    function SignInUp(props) {
            ...
            return __assign(__assign({}, _this.props.recipe.recipeImpl), {
                createCode: function (input) {
                    return __awaiter(_this, void 0, void 0, function () {
                        var contactInfo, storedContactInfo, res, loginAttemptInfo_1;
                            ...
                            switch (_a.label) {
                                case 0:
                                    if ("email" in input) {
                                        ...
                                        storedContactInfo = this.state.loginAttemptInfo.contactInfo;
                                        contactInfo = storedContactInfo;
                                    }
                                    return [4 /*yield*/, this.props.recipe.recipeImpl.createCode(input)];
                                case 1:
                                    res = _a.sent();
                                    if (!(res.status === "OK")) return [3 /*break*/, 2];
                                    ...
                                    this.setState(function (os) {
                                        return __assign(__assign({}, os), { loginAttemptInfo: loginAttemptInfo_1 });
                                    });
                                    return [3 /*break*/, 4];
                                case 2:
                                    if (!(res.status === "RESTART_FLOW_ERROR")) return [3 /*break*/, 4];
        ...
        _this.componentDidMount = function () {
            return __awaiter(_this, void 0, void 0, function () {
                var loginAttemptInfo_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this.state.error) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.props.recipe.recipeImpl.clearLoginAttemptInfo()];
                        case 1:
                            _a.sent();
                            this.setState(function (s) {
                                return __assign(__assign({}, s), { loaded: true });
                            });
                            return [3 /*break*/, 4];
                        case 2:
                            return [4 /*yield*/, this.getModifiedRecipeImplementation().getLoginAttemptInfo()];
                        case 3:
                            loginAttemptInfo_2 = _a.sent();
                            this.setState(function (s) {
        ...
        _this.render = function () {
            ...
            var isEmail = _this.props.recipe.config.contactInfoType === "EMAIL";
