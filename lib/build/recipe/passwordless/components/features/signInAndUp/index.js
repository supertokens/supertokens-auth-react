...
exports.usePasswordlessSignInAndUpFeatureReducer = function (recipeImpl) {
    var _a = React.useReducer(
            function (oldState, action) {
                switch (action.type) {
                    ...
                    case "startLogin":
                        return __assign(__assign({}, oldState), { loginAttemptInfo: action.loginAttemptInfo });
...
function usePasswordlessSignInAndUpChildProps(recipe, dispatch, state, callingConsumeCodeRef, history) {
...
exports.usePasswordlessSignInAndUpChildProps = usePasswordlessSignInAndUpChildProps;
...
var SignInUpFeature = function (props) {
    ...
    var _a = exports.usePasswordlessSignInAndUpFeatureReducer(props.recipe.recipeImpl),
        state = _a[0],
        dispatch = _a[1];
    var callingConsumeCodeRef = exports.useSuccessInAnotherTabChecker(state, dispatch);
    var childProps = usePasswordlessSignInAndUpChildProps(
        props.recipe,
        dispatch,
        state,
        ...
        react_1.jsx(
            ...
            react_1.jsx(
                ...
                props.children === undefined &&
                    react_1.jsx(signInUp_1.default, __assign({}, childProps, { dispatch: dispatch })),
                props.children &&
...
exports.default = SignInUpFeature;
