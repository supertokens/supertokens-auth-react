...
exports.useFeatureReducer = function (recipeImpl, userContext) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [
                                    4 /*yield*/,
                                    utils_2.getLoginAttemptInfoFromStorage({
...
function useChildProps(recipe, dispatch, state, callingConsumeCodeRef, history) {
    var recipeImplementation = React.useMemo(
        function () {
            return recipe && getModifiedRecipeImplementation(recipe, dispatch, callingConsumeCodeRef);
        },
        [recipe]
    );
...
exports.SignInUpFeature = function (props) {
    ...
    var _a = exports.useFeatureReducer(props.recipe.recipeImpl, userContext),
        state = _a[0],
        dispatch = _a[1];
...
function getModifiedRecipeImplementation(recipe, dispatch, callingConsumeCodeRef) {
    var _this = this;
    return __assign(__assign({}, recipe.recipeImpl), {
        createCode: function (input) {
            return __awaiter(_this, void 0, void 0, function () {
                var contactInfo, validationRes, validationRes, res, contactMethod, loginAttemptInfo;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!("email" in input)) return [3 /*break*/, 2];
                            contactInfo = input.email;
                            return [4 /*yield*/, recipe.config.validateEmailAddress(input.email)];
                        case 1:
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, recipe.config.validatePhoneNumber(input.phoneNumber)];
                        case 3:
                            validationRes = _a.sent();
                            if (validationRes !== undefined) {
                                throw new error_1.default(validationRes);
                            ...
                            _a.label = 4;
                        case 4:
                            return [4 /*yield*/, recipe.recipeImpl.createCode(input)];
                        case 5:
                            res = _a.sent();
                            ...
                            return [
                                4 /*yield*/,
                                utils_2.setLoginAttemptInfoToStorage({
        ...
        resendCode: function (input) {
            return __awaiter(_this, void 0, void 0, function () {
                var res, loginAttemptInfo, timestamp, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 8, , 9]);
                            return [4 /*yield*/, recipe.recipeImpl.resendCode(input)];
                        case 1:
                            res = _a.sent();
                        ...
                        case 5:
                            ...
                            return [
                                4 /*yield*/,
                                recipe.recipeImpl.clearLoginAttemptInfo({
                                    userContext: input.userContext,
                                }),
                            ];
                        case 6:
                        ...
                        case 8:
                            ...
                            if (error_1.default.isThisError(e_1)) {
                                dispatch({ type: "setError", error: e_1.message });
                            }
                            throw e_1;
                        case 9:
                            return [2 /*return*/];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, recipe.recipeImpl.consumeCode(input)];
                        case 1:
                            res = _a.sent();
