    ...
    function SignInUp(props) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 4:
                                    ...
                                    this.setState(function (os) {
                                        return __assign(__assign({}, os), {
                                            error: constants_2.SIGN_IN_UP_RESEND_RESTART_FLOW_ERROR,
                                            loginAttemptInfo: undefined,
                                        });
                                    });
                                    return [3 /*break*/, 6];
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    this.setState(function (os) {
                                        return __assign(__assign({}, os), {
                                            error: constants_2.SIGN_IN_UP_CODE_CONSUME_RESTART_FLOW_ERROR,
                                            loginAttemptInfo: undefined,
                                        });
                                    });
                                    return [3 /*break*/, 6];
                                case 3:
                                    if (!(res.status === "GENERAL_ERROR")) return [3 /*break*/, 4];
                                    this.setState(function (os) {
                                        return __assign(__assign({}, os), {
                                            error: res.message,
                                            loginAttemptInfo: undefined,
                                    ...
                                    return [3 /*break*/, 6];
                                case 4:
                                    if (!(res.status === "OK")) return [3 /*break*/, 6];
                                    return [4 /*yield*/, this.props.recipe.recipeImpl.clearLoginAttemptInfo()];
                                case 5:
                                    _a.sent();
                                    _a.label = 6;
        ...
        if (errorQueryParam !== null) {
            if (errorQueryParam === "signin") {
                error = constants_1.SOMETHING_WENT_WRONG_ERROR;
            } else if (errorQueryParam === "restart_link") {
                error = constants_2.SIGN_IN_UP_LINK_ERROR;
