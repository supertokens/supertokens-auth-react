    ...
    return __assign(__assign({}, recipe.recipeImpl), {
        createCode: function (input) {
            return __awaiter(_this, void 0, void 0, function () {
                var contactInfo, validationRes, validationRes, res, contactMethod, loginAttemptInfo, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 8, , 9]);
        ...
        resendCode: function (input) {
            return __awaiter(_this, void 0, void 0, function () {
                var res, loginAttemptInfo, timestamp, e_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 8, , 9]);
                        ...
                        case 8:
                            ...
                            if (error_1.default.isThisError(e_2)) {
                                dispatch({ type: "setError", error: e_2.message });
                            }
                            throw e_2;
                        case 9:
                            return [2 /*return*/];
