    ...
    function LinkClickedScreen() {
        ...
        _this.componentDidMount = function () {
            return __awaiter(_this, void 0, void 0, function () {
                var preAuthSessionId, linkCode, response, loginAttemptInfo, pathFromUrl, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            _a.sent();
                            pathFromUrl = utils_1.getRedirectToPathFromURL();
                            return [
                                2 /*return*/,
        ...
        _this.render = function () {
            ...
            var linkClickedScreen = _this.props.recipe.config.linkClickedScreen;
            var props = {
