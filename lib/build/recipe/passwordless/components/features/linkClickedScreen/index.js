...
var LinkClickedScreen = function (props) {
    ...
    var _a = react_2.useState(false),
        showButton = _a[0],
        setRequiresInteraction = _a[1];
    var consumeCodeAtMount = react_2.useCallback(
        function () {
    ...
    utils_1.useOnMountAPICall(consumeCodeAtMount, handleConsumeResp, handleConsumeError);
