...
exports.signOut =
    ...
    exports.init =
    exports.LinkClicked =
    exports.PasswordlessComponentsOverrideProvider =
...
var Wrapper = /** @class */ (function () {
                ...
                return [
                    ...
                    UtilFunctions.createCode(
                        __assign(__assign({}, input), {
                            recipeImplementation: recipe_1.default.getInstanceOrThrow().webJSRecipe,
                        })
                    ),
                ];
            });
    ...
    Wrapper.getLinkCodeFromURL = function (input) {
        return recipe_1.default.getInstanceOrThrow().webJSRecipe.getLinkCodeFromURL(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.getPreAuthSessionIdFromURL = function (input) {
        return recipe_1.default.getInstanceOrThrow().webJSRecipe.getPreAuthSessionIdFromURL(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.doesPhoneNumberExist = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.doesPhoneNumberExist(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
                        })
                    ),
    ...
    Wrapper.getLoginAttemptInfo = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.getLoginAttemptInfo(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.setLoginAttemptInfo = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.setLoginAttemptInfo(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
                        })
                    ),
    ...
    Wrapper.clearLoginAttemptInfo = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.clearLoginAttemptInfo(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
