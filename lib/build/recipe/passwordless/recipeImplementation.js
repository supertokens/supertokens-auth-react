...
var recipeImplementation_1 = __importDefault(
    require("supertokens-web-js/lib/build/recipe/passwordless/recipeImplementation")
);
function getRecipeImplementation(recipeInput) {
    var webJsImplementation = recipeImplementation_1.default(
        ...
        setLoginAttemptInfo: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [
                        2 /*return*/,
                        webJsImplementation.setLoginAttemptInfo.bind(this)({
                            attemptInfo: __assign(__assign({}, input.attemptInfo), {
