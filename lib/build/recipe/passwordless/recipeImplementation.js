    ...
    return {
        createCode: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var bodyObj, validationRes, validationRes;
                            ...
                            return [
                                ...
                                querier.post("/signinup/code", { body: JSON.stringify(bodyObj) }, function (context) {
                                    return input.config.preAPIHook(
                                        __assign(__assign({}, context), { action: "PASSWORDLESS_CREATE_CODE" })
                                    );
                                }),
                            ];
                        case 5:
                        ...
                        case 0:
                            ...
                            return [
                                ...
                                querier.post(
                                    ...
                                    function (context) {
                                        return input.config.preAPIHook(
                                            __assign(__assign({}, context), { action: "PASSWORDLESS_RESEND_CODE" })
                                        );
                                    }
                                ),
                            ];
                        ...
                        case 0:
                            ...
                            return [
                                ...
                                querier.post(
                                    ...
                                    function (context) {
                                        return input.config.preAPIHook(
                                            __assign(__assign({}, context), { action: "PASSWORDLESS_CONSUME_CODE" })
                                        );
                                    }
                                ),
                            ];
                        ...
                        case 0:
                            return [
                                ...
                                querier.get("/signup/email/exists", {}, { email: input.email }, function (context) {
                                    return input.config.preAPIHook(
                                        __assign(__assign({}, context), { action: "EMAIL_EXISTS" })
                                    );
                                }),
                            ];
                        case 1:
                        ...
                        case 0:
                            return [
                                ...
                                querier.get(
                                    ...
                                    function (context) {
                                        return input.config.preAPIHook(
                                            __assign(__assign({}, context), { action: "PHONE_NUMBER_EXISTS" })
                                        );
                                    }
                                ),
                            ];
        ...
        getLoginAttemptInfo: function () {
            var storedInfo = localStorage.getItem(constants_1.PASSWORDLESS_LOGIN_ATTEMPT_INFO_STORAGE_KEY);
            if (!storedInfo) {
                return undefined;
            }
            try {
        ...
        clearLoginAttemptInfo: function () {
            localStorage.removeItem(constants_1.PASSWORDLESS_LOGIN_ATTEMPT_INFO_STORAGE_KEY);
        },
    };
}
