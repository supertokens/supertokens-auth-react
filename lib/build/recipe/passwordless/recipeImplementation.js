...
function getRecipeImplementation(recipeInput) {
    var webJSRecipe = recipeInput.webJSRecipe;
    return {
        createCode: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJSRecipe.createCode.bind(this)(input)];
                        case 1:
                            response = _a.sent();
        ...
        resendCode: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJSRecipe.resendCode.bind(this)(input)];
                        case 1:
                            response = _a.sent();
        ...
        consumeCode: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJSRecipe.consumeCode.bind(this)(input)];
                        case 1:
                            response = _a.sent();
                            if (response.status === "RESTART_FLOW_ERROR") {
                                recipeInput.onHandleEvent({
        ...
        doesEmailExist: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJSRecipe.doesEmailExist.bind(this)(input)];
                        case 1:
        ...
        doesPhoneNumberExist: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJSRecipe.doesPhoneNumberExist.bind(this)(input)];
                        case 1:
                            return [2 /*return*/, _a.sent()];
                    }
                });
        ...
        getLoginAttemptInfo: function (input) {
            return webJSRecipe.getLoginAttemptInfo.bind(this)(input);
        },
        setLoginAttemptInfo: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, webJSRecipe.setLoginAttemptInfo.bind(this)(input)];
                });
            });
        },
