...
import type { RecipeInitResult, NormalisedConfigWithAppInfoAndRecipeID, WebJSRecipeInterface, UserContext } from "../../types";
export default class Multitenancy extends BaseRecipeModule<any, any, any, any> {
    ...
    constructor(config: NormalisedConfigWithAppInfoAndRecipeID<NormalisedConfig>, webJSRecipe?: WebJSRecipeInterface<typeof MultitenancyWebJS>);
    getCurrentDynamicLoginMethods(input: {
        userContext: UserContext;
    }): Promise<GetLoginMethodsResponseNormalized | undefined>;
    static getDynamicLoginMethods(input: Parameters<typeof MultitenancyWebJS.getLoginMethods>[0]): Promise<GetLoginMethodsResponseNormalized>;
