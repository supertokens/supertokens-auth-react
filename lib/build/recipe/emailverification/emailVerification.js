    ...
    function EmailVerification(config) {
        ...
        _this.getFeatures = function() {
            ...
            if (_this.config.mode !== "OFF" && _this.config.disableDefaultImplementation !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = emailVerification_1.default;
            }
            return features;
        };
        _this.config = utils_2.normaliseEmailVerificationFeature(config);
        return _this;
    }
    /*
     * Email Verification
    ...
    EmailVerification.init = function(config) {
        return function(appInfo) {
            EmailVerification.instance = new EmailVerification(
                __assign({}, config, { appInfo: appInfo, recipeId: config.authRecipe.recipeId })
            );
            return EmailVerification.instance;
        };
    };
    EmailVerification.signOut = function() {
        return EmailVerification.getInstanceOrThrow().config.authRecipe.signOut();
    };
    EmailVerification.isEmailVerified = function() {
