...
function EmailVerificationTheme(props) {
    ...
    if (props.hasToken === false) {
        return (React.createElement(styleContext_1.StyleProvider, { rawPalette: props.rawPalette, defaultPalette: styles_1.defaultPalette, styleFromInit: props.sendVerifyEmailScreen.styleFromInit, getDefaultStyles: styles_2.getStyles },
    ...
    return (React.createElement(styleContext_1.StyleProvider, { rawPalette: props.rawPalette, defaultPalette: styles_1.defaultPalette, styleFromInit: props.verifyEmailLinkClickedScreen.styleFromInit, getDefaultStyles: styles_2.getStyles },
