    ...
    function EmailVerification(props) {
        ...
        _this.getRecipeInstanceOrThrow = function () {
            ...
            if (!(recipe instanceof authRecipeModule_1.default)) {
                throw new Error(recipe.config.recipeId + " must be an instance of AuthRecipeModule to use EmailVerification component.");
            }
        ...
        _this.signOut = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().config.signOut()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().config.redirectToSignIn(this.props.history)];
        ...
        _this.onTokenInvalidRedirect = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, session_1.default.doesSessionExist()];
                    case 1:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().config.postVerificationRedirect(this.props.history)];
        ...
        _this.render = function () {
            ...
            var sendVerifyEmailScreen = {
                ...
                onSuccess: function () {
                    return _this.getRecipeInstanceOrThrow().config.onHandleEvent({
                        action: "VERIFY_EMAIL_SENT",
                    });
                },
                onEmailAlreadyVerified: function () {
                    return _this.getRecipeInstanceOrThrow().config.postVerificationRedirect(_this.props.history);
                },
            };
            var verifyEmailLinkClickedScreenFeature = _this.getRecipeInstanceOrThrow().config.verifyEmailLinkClickedScreen;
             ...
             * Render.
             */
            return (react_1.jsx(featureWrapper_1.default, { useShadowDom: _this.getRecipeInstanceOrThrow().config.useShadowDom },
                react_1.jsx(react_2.Fragment, null,
                    _this.props.children === undefined && (react_1.jsx(emailVerification_1.EmailVerificationTheme, { rawPalette: _this.getRecipeInstanceOrThrow().config.palette, sendVerifyEmailScreen: sendVerifyEmailScreen, verifyEmailLinkClickedScreen: verifyEmailLinkClickedScreen, hasToken: hasToken })),
