...
exports.EmailVerification = function (props) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [
                                2 /*return*/,
                                props.recipe.recipeImpl.isEmailVerified({ config: props.recipe.config }),
                            ];
                        case 3:
    ...
    var onEmailAlreadyVerified = react_2.useCallback(
        function () {
            return props.recipe.config.postVerificationRedirect(props.history);
        },
        [props.recipe, props.history]
    );
    var onContinueClicked = react_2.useCallback(
        function () {
            return props.recipe.config.postVerificationRedirect(props.history);
        },
        [props.recipe, props.history]
        ...
        react_1.jsx(
            ...
            react_1.jsx(
                ...
                props.children === undefined &&
                    react_1.jsx(emailVerification_1.EmailVerificationTheme, __assign({}, childProps)),
                props.children &&
