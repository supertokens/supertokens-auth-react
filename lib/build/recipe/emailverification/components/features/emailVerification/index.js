...
var EmailVerification = /** @class */ (function (_super) {
    ...
    function EmailVerification(props) {
        ...
        _this.getRecipeInstanceOrThrow = function () {
            if (_this.props.recipe.config.recipeId === undefined) {
                throw new Error("No recipeId props given to EmailVerification component");
            }
            var recipe = superTokens_1.default
                .getInstanceOrThrow()
                .getRecipeOrThrow(_this.props.recipe.config.recipeId);
            if (!(recipe instanceof authRecipeModule_1.default)) {
                throw new Error(
                    recipe.config.recipeId +
                        " must be an instance of AuthRecipeModule to use EmailVerification component."
                );
            }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [
                                4 /*yield*/,
                                this.getRecipeInstanceOrThrow().config.redirectToSignIn(this.props.history),
                            ];
                        case 2:
