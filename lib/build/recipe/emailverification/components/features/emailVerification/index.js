...
var EmailVerification = function (props) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                superTokens_1.default.getInstanceOrThrow().redirectToAuth({ history: props.history }),
                            ];
                        case 1:
                            _b.sent();
                            return [3 /*break*/, 4];
    ...
    var onTokenInvalidRedirect = (0, react_1.useCallback)(
        function () {
            return superTokens_1.default.getInstanceOrThrow().redirectToAuth({ history: props.history });
        },
