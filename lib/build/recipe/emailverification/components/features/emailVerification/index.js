    ...
    function EmailVerification(props) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            _a.trys.push([3, 7, , 8]);
                            return [4 /*yield*/, api_1.sendVerifyEmailAPI(this.props.recipe)];
                        case 4:
                            response = _a.sent();
                            if (!(response.status === "EMAIL_ALREADY_VERIFIED_ERROR")) return [3 /*break*/, 6];
                            return [4 /*yield*/, this.props.recipe.config.postVerificationRedirect(this.props.history)];
                        case 5:
                            return [2 /*return*/, _a.sent()];
                        case 6:
                            return [3 /*break*/, 8];
        ...
        _this.render = function () {
            ...
            var sendVerifyEmailScreen = {
                ...
                onSuccess: function () {
                    return _this.props.recipe.config.onHandleEvent({
                ...
                verifyEmailAPI: function () {
                    return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, api_1.verifyEmailAPI(this.props.recipe, this.state.token)];
                                case 1:
                                    return [2 /*return*/, _a.sent()];
                            }
                        });
