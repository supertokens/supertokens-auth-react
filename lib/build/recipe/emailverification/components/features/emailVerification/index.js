...
var EmailVerification = function (props) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [
                        ...
                        recipe_1.default
                            .getInstanceOrThrow()
                            .validateGlobalClaimsAndRedirect(undefined, userContext, props.history),
                    ];
                });
            });
        },
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            return [
                                ...
                                recipe_1.default
                                    .getInstanceOrThrow()
                                    .redirectToAuthWithoutRedirectToPath(props.history),
                            ];
                        case 1:
                            _b.sent();
                            return [3 /*break*/, 4];
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [2 /*return*/, session.redirectToAuthWithoutRedirectToPath(props.history)];
                    }
                });
            });
        },
    ...
    var onTokenInvalidRedirect = (0, react_1.useCallback)(
        function () {
            return recipe_1.default.getInstanceOrThrow().redirectToAuthWithoutRedirectToPath(props.history);
        },
