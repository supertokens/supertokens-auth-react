...
function verifyEmailAPI(recipe, token) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, recipe.httpRequest.post("/user/email/verify", {
                        body: JSON.stringify({
                            method: "token",
                            token: token,
                        }),
...
function sendVerifyEmailAPI(recipe) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, recipe.httpRequest.post("/user/email/verify/token", {}, "SEND_VERIFY_EMAIL")];
                case 1:
                    response = _a.sent();
...
function isEmailVerifiedAPI(recipe) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, recipe.httpRequest.get("/user/email/verify", {}, "IS_EMAIL_VERIFIED")];
                case 1:
                    response = _a.sent();
