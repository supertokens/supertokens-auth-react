    ...
    function EmailVerification(props) {
        ...
        _this.getRecipeInstanceOrThrow = function() {
            ...
            if (_this.props.__internal !== undefined && _this.props.__internal.instance !== undefined) {
                ...
                instance = emailVerification_1.default.getInstanceOrThrow();
            }
            return instance;
        };
            ...
            return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            return [4 /*yield*/, this.getRecipeInstanceOrThrow().config.authRecipe.signOut()];
                        case 1:
                            _a.sent();
                            return [
                                4 /*yield*/,
                                this.getRecipeInstanceOrThrow().config.authRecipe.redirect(
        ...
        _this.onTokenInvalidRedirect = function() {
            return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(session_1.default.doesSessionExist() !== true)) return [3 /*break*/, 2];
                            return [
                                4 /*yield*/,
                                this.getRecipeInstanceOrThrow().config.authRecipe.redirect(
                                    { action: "SIGN_IN_AND_UP" },
                        ...
                        case 3:
                            response = _a.sent();
                            if (!(response.status === "EMAIL_ALREADY_VERIFIED_ERROR")) return [3 /*break*/, 5];
                            return [
                                4 /*yield*/,
                                this.getRecipeInstanceOrThrow().config.authRecipe.redirect(
                                    { action: "SUCCESS" },
        ...
        _this.render = function() {
            ...
            var sendVerifyEmailScreen = {
                ...
                onEmailAlreadyVerified: function() {
                    return _this
                        ...
                        .config.authRecipe.redirect({ action: "SUCCESS" }, _this.props.history);
                }
            };
            ...
            var useShadowDom = _this.getRecipeInstanceOrThrow().config.authRecipe.config.useShadowDom;
            ...
            return react_1.jsx(
                ...
                react_1.jsx(
                    ...
                    _this.props.children === undefined &&
                        react_1.jsx(__1.EmailVerificationScreenTheme, {
                            rawPalette: _this.getRecipeInstanceOrThrow().config.authRecipe.config.palette,
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        sessionExists = session_1.default.doesSessionExist();
                        if (!(sessionExists === false && hasToken === false)) return [3 /*break*/, 2];
                        return [
                            4 /*yield*/,
                            this.getRecipeInstanceOrThrow().config.authRecipe.redirect(
                                { action: "SIGN_IN_AND_UP" },
                    ...
                    case 2:
                        _a.trys.push([2, 6, , 7]);
                        if (!(hasToken === false)) return [3 /*break*/, 5];
                        return [4 /*yield*/, api_1.sendVerifyEmailAPI(this.getRecipeInstanceOrThrow())];
                    case 3:
                        response = _a.sent();
                        if (!(response.status === "EMAIL_ALREADY_VERIFIED_ERROR")) return [3 /*break*/, 5];
