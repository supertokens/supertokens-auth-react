...
var types_1 = require("../session/types");
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.emailVerifiedGrant = new types_1.BooleanGrant("email-verified", Wrapper.isEmailVerified, function (_a) {
        var history = _a.history;
        return recipe_1.default.getInstanceOrThrow().redirect({ action: "VERIFY_EMAIL" }, history);
    });
