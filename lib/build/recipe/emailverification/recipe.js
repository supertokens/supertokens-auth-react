...
var EmailVerification = /** @class */ (function (_super) {
    ...
    function EmailVerification(config) {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.config.mode !== "OFF" && _this.config.disableDefaultImplementation !== true) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(new normalisedURLPath_1.default(constants_1.DEFAULT_VERIFY_EMAIL_PATH));
        ...
        _this.getDefaultRedirectionURL = function (context) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (context.action === "VERIFY_EMAIL") {
                    ...
                    return [2 /*return*/, this.config.appInfo.websiteBasePath.appendPath(verifyEmailPath).getAsStringDangerous() + "?rid=" + this.config.recipeId];
                }
                else {
                    return [2 /*return*/, "/"];
                }
    ...
    EmailVerification.init = function (config) {
        return function (appInfo) {
            EmailVerification.instance = new EmailVerification(__assign({}, config, { appInfo: appInfo, recipeId: EmailVerification.RECIPE_ID }));
