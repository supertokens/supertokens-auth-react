...
var EmailVerification = /** @class */ (function (_super) {
                        ...
                        ? function (userContext) {
                              return __awaiter(_this, void 0, void 0, function () {
                                  ...
                                  return __generator(this, function (_c) {
                                      switch (_c.label) {
                                          case 0:
                                              _a = utils_1.saveInvalidClaimRedirectPathInContext;
                                              _b = [userContext];
                                              return [4 /*yield*/, this.getRedirectUrl({ action: "VERIFY_EMAIL" })];
                                          case 1:
    ...
    EmailVerification.EmailVerificationClaim = new emailverification_1.EmailVerificationClaimClass(function () {
