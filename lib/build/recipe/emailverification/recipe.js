...
var emailverification_2 = __importDefault(require("supertokens-web-js/recipe/emailverification"));
...
var EmailVerification = /** @class */ (function (_super) {
    ...
    function EmailVerification(config, recipeImpl) {
        if (recipeImpl === void 0) {
            recipeImpl = emailverification_2.default;
        }
    ...
    EmailVerification.init = function (config) {
        return {
            ...
            webJS: emailverification_2.default.init(
                __assign(__assign({}, config), {
                    override: {
                        functions: function (originalImpl, builder) {
                            ...
                            if (
                                (_b = config === null || config === void 0 ? void 0 : config.override) === null ||
                                _b === void 0
                                    ? void 0
                                    : _b.functions
                            ) {
