...
function getRecipeImplementation(recipeId, appInfo) {
    ...
    return {
        ...
        isEmailVerified: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var accessTokenPayload, tokenGrant, response;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, recipe_1.default.getInstanceOrThrow().getAccessTokenPayloadSecurely()];
                        case 1:
                            accessTokenPayload = _a.sent();
                            tokenGrant = accessTokenPayload["st-grant-email-verified"];
                            if (tokenGrant) {
                                return [2 /*return*/, tokenGrant.v];
                            }
                            return [
                                4 /*yield*/,
