        ...
        verifyEmail: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJSRecipe.verifyEmail.bind(this)(__assign({}, input))];
                        case 1:
                            response = _a.sent();
        ...
        sendVerificationEmail: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJSRecipe.sendVerificationEmail.bind(this)(__assign({}, input))];
                        case 1:
                            response = _a.sent();
                            if (response.status === "OK") {
                                recipeInput.onHandleEvent({
        ...
        isEmailVerified: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, webJSRecipe.isEmailVerified.bind(this)(__assign({}, input))];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, response];
                    }
