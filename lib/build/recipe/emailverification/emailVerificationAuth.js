        ...
        function () {
            function doTask() {
                return __awaiter(this, void 0, void 0, function () {
                    var isEmailVerified_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(sessionContext.doesSessionExist && props.recipe.config.mode === "REQUIRED"))
                                    return [3 /*break*/, 4];
                                return [4 /*yield*/, props.recipe.isEmailVerified()];
                            case 1:
                                isEmailVerified_1 = _a.sent();
                                if (!(isEmailVerified_1 === false)) return [3 /*break*/, 3];
                                return [4 /*yield*/, props.recipe.redirect({ action: "VERIFY_EMAIL" }, props.history)];
                            case 2:
                                _a.sent();
                                return [3 /*break*/, 4];
                            case 3:
