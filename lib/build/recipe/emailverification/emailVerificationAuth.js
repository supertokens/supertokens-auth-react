    ...
    function EmailVerificationAuth() {
        ...
        _this.getRecipeInstanceOrThrow = function () {
            ...
            if (!(recipe instanceof authRecipeModule_1.default)) {
                throw new Error(recipe.config.recipeId + " must be an instance of AuthRecipeModule to use EmailVerificationAuth component.");
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().redirect({ action: "VERIFY_EMAIL" }, this.props.history)];
