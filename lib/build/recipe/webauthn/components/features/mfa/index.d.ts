...
export declare function useChildProps(recipe: Recipe, recipeImplementation: RecipeInterface, state: WebAuthnMFAState, dispatch: React.Dispatch<WebAuthnMFAAction>, userContext: UserContext, navigate?: Navigate): Omit<WebAuthnMFAProps, "featureState" | "dispatch">;
export declare const MFAFeature: React.FC<FeatureBaseProps<{
    recipe: Recipe;
