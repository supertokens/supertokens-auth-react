...
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    ...
    function ThirdPartyEmailPassword(config) {
        var _this = _super.call(this, config, utils_2.normaliseThirdPartyEmailPasswordConfig(config)) || this;
        /*
         * Instance methods.
         */
        _this.getFeatures = function () {
            ...
            if (_this.config.resetPasswordUsingTokenFeature.disableDefaultImplementation !== true) {
                var normalisedFullPath = _this.appInfo.websiteBasePath.appendPath(
                    new normalisedURLPath_1.default(constants_2.DEFAULT_RESET_PASSWORD_PATH)
                );
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: utils_1.matchRecipeIdUsingQueryParams(_this.recipeId),
                    rid: _this.recipeId,
            ...
            _this.config.signInAndUpFeature.providers.forEach(function (provider) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    rid: _this.recipeId,
                    matches: utils_3.matchRecipeIdUsingState(_this.recipeId),
                };
            });
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (context.action) {
                        ...
                        case "RESET_PASSWORD": {
                            resetPasswordPath = new normalisedURLPath_1.default(
                                constants_2.DEFAULT_RESET_PASSWORD_PATH
                            );
                            return [
                                2 /*return*/,
    ...
    ThirdPartyEmailPassword.signOut = function () {
        return ThirdPartyEmailPassword.getInstanceOrThrow().signOut();
    };
    ThirdPartyEmailPassword.isEmailVerified = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, ThirdPartyEmailPassword.getInstanceOrThrow().isEmailVerified()];
                    case 1:
    ...
    ThirdPartyEmailPassword.redirectToAuth = function (show) {
