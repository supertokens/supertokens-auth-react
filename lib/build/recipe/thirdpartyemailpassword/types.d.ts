...
export declare type ThirdPartyEmailPasswordUserInput = AuthRecipeModuleUserInput<
...
export declare type ThirdPartyEmailPasswordConfig = ThirdPartyEmailPasswordUserInput &
    RecipeModuleConfig<
        ThirdPartyEmailPasswordGetRedirectionURLContext,
        ThirdPartyEmailPasswordPreAPIHookContext,
        ThirdPartyEmailPasswordOnHandleEventContext
...
export declare type ThirdPartyEmailPasswordGetRedirectionURLContext =
    | EmailPasswordGetRedirectionURLContext
    | ThirdPartyGetRedirectionURLContext;
export declare type ThirdPartyEmailPasswordPreAPIHookContext =
    | EmailPasswordPreAPIHookContext
    | ThirdPartyPreAPIHookContext;
export declare type ThirdPartyEmailPasswordOnHandleEventContext =
    | ThirdPartyOnHandleEventContext
    | EmailPasswordOnHandleEventContext;
