...
function getRecipeImplementation(config, emailVerificationInstance) {
    ...
    var thirdPartyImpl = recipeImplementation_2.default(thirdPartyEmailPassword, config.recipeId);
    return {
        ...
        getSubmitPasswordTokenFromURL: function (input) {
            return emailpasswordImpl.getSubmitPasswordTokenFromURL.bind(emailPasswordImplementation_1.default(this))(
                input
            );
        },
