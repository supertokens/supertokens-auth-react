...
function getRecipeImplementation(recipeId, appInfo) {
    ...
    return {
        submitNewPassword: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, emailpasswordImpl.submitNewPassword(input)];
                });
            });
        },
        sendPasswordResetEmail: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, emailpasswordImpl.sendPasswordResetEmail(input)];
                });
            });
        },
        doesEmailExist: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, emailpasswordImpl.doesEmailExist(input)];
                });
            });
        },
        getOAuthAuthorisationURL: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, thirdPartyImpl.getOAuthAuthorisationURL(input)];
                });
            });
        },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, emailpasswordImpl.signIn(input)];
                        case 1:
                            response = _a.sent();
                            ...
                            return [3 /*break*/, 4];
                        case 2:
                            return [4 /*yield*/, emailpasswordImpl.signUp(input)];
                        case 3:
                            response = _a.sent();
                            if (response.status === "OK") {
                                return [
                        ...
                        case 4:
                            return [3 /*break*/, 7];
                        case 5:
                            return [4 /*yield*/, thirdPartyImpl.signInAndUp(input)];
                        case 6:
                            response = _a.sent();
