...
var recipe_1 = require("supertokens-web-js/recipe/thirdpartyemailpassword/recipe");
function getRecipeImplementation(recipeInput) {
    var emailpasswordImpl = (0, recipeImplementation_1.default)(
        __assign(__assign({}, recipeInput), {
            webJSRecipe: recipe_1.Recipe.getInstanceOrThrow().emailPasswordRecipe.recipeImplementation,
        })
    );
    var thirdPartyImpl = (0, recipeImplementation_2.default)(
        __assign(__assign({}, recipeInput), {
            webJSRecipe: recipe_1.Recipe.getInstanceOrThrow().thirdPartyRecipe.recipeImplementation,
        })
    );
    return {
