...
var resetPasswordUsingToken_1 = __importDefault(require("../emailpassword/components/features/resetPasswordUsingToken"));
/*
 * Class.
 */
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
     ...
     * Constructor.
     */
    function ThirdPartyEmailPassword(config) {
        var _this = _super.call(this, utils_2.normaliseThirdPartyEmailPasswordConfig(config)) || this;
        /*
         * Instance methods.
         */
        _this.getFeatures = function () {
            ...
            if (_this.config.signInAndUpFeature.disableDefaultImplementation !== true) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(new normalisedURLPath_1.default("/"));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: utils_1.matchRecipeIdUsingQueryParams(_this.config.recipeId),
                    rid: _this.config.recipeId,
                    component: signInAndUp_1.default,
                };
            }
            if (_this.config.resetPasswordUsingTokenFeature.disableDefaultImplementation !== true) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(new normalisedURLPath_1.default(constants_2.DEFAULT_RESET_PASSWORD_PATH));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: utils_1.matchRecipeIdUsingQueryParams(_this.config.recipeId),
                    rid: _this.config.recipeId,
            ...
            _this.config.signInAndUpFeature.providers.forEach(function (provider) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(new normalisedURLPath_1.default("/callback/" + provider.id));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    component: signInAndUpCallback_1.default,
                    rid: _this.config.recipeId,
                    matches: utils_3.matchRecipeIdUsingState(_this.config.recipeId),
                };
            });
        ...
        _this.getDefaultRedirectionURL = function (context) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (context.action === "GET_REDIRECT_URL") {
                    return [2 /*return*/, context.provider.getRedirectURL()];
                }
                else if (context.action === "RESET_PASSWORD") {
                    resetPasswordPath = new normalisedURLPath_1.default(constants_2.DEFAULT_RESET_PASSWORD_PATH);
                    return [2 /*return*/, this.config.appInfo.websiteBasePath.appendPath(resetPasswordPath).getAsStringDangerous() + "?rid=" + this.config.recipeId];
                }
                else {
    ...
    ThirdPartyEmailPassword.init = function (config) {
        return function (appInfo) {
            ThirdPartyEmailPassword.instance = new ThirdPartyEmailPassword(__assign({}, config, { appInfo: appInfo, recipeId: ThirdPartyEmailPassword.RECIPE_ID }));
    ...
    ThirdPartyEmailPassword.getInstanceOrThrow = function () {
        if (ThirdPartyEmailPassword.instance === undefined) {
            var error = "No instance of ThirdPartyEmailPassword found. Make sure to call the ThirdPartyEmailPassword.init method." +
