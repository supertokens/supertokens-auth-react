...
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    ...
    function ThirdPartyEmailPassword(config) {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.config.signInAndUpFeature.disableDefaultImplementation !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    component: function () {
                        return _this.getFeatureComponent("signinup");
                    },
                };
            }
        ...
        _this.getFeatureComponent = function (componentName) {
            if (componentName === "signinup") {
                return react_1.default.createElement(signInAndUp_1.default, {
                    recipeId: _this.config.recipeId,
                    emailPasswordRecipeImplementation: _this.emailPasswordRecipe.recipeImpl,
                });
            } else if (componentName === "resetpassword") {
                return _this.emailPasswordRecipe.getFeatureComponent(componentName);
            } else {
                return _this.getAuthRecipeModuleFeatureComponent(componentName);
            }
        };
