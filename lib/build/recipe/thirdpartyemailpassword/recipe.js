...
var thirdpartyemailpassword_1 = __importDefault(require("supertokens-web-js/recipe/thirdpartyemailpassword"));
var functionOverrides_1 = require("./functionOverrides");
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    ...
    function ThirdPartyEmailPassword(config, recipes) {
        ...
        _this.recipeImpl = thirdpartyemailpassword_1.default;
        _this.emailPasswordRecipe =
            recipes.emailPasswordInstance !== undefined
                ...
                : new recipe_1.default(
                      __assign(__assign({}, _this.config.emailPasswordConfig), {
                          appInfo: _this.config.appInfo,
                          recipeId: _this.config.recipeId,
                      }),
                      (0, emailPasswordImplementation_1.default)(_this.recipeImpl)
                  );
        ...
        _this.thirdPartyRecipe =
            recipes.thirdPartyInstance !== undefined
                ...
                : _this.config.thirdPartyConfig.signInAndUpFeature.providers === undefined ||
                  _this.config.thirdPartyConfig.signInAndUpFeature.providers.length === 0
                ? undefined
                : new recipe_2.default(
                      __assign(__assign({}, _this.config.thirdPartyConfig), {
                          appInfo: _this.config.appInfo,
                          recipeId: _this.config.recipeId,
                      }),
                      (0, thirdPartyImplementation_1.default)(_this.recipeImpl)
                  );
        return _this;
    }
    /*
    ...
    ThirdPartyEmailPassword.init = function (config) {
        var normalisedConfig = (0, utils_2.normaliseThirdPartyEmailPasswordConfig)(config);
        return {
            ...
            webJS: thirdpartyemailpassword_1.default.init(
                __assign(__assign({}, normalisedConfig), {
                    override: {
                        functions: function (originalImpl, builder) {
                            var functions = (0, functionOverrides_1.getFunctionOverrides)(
