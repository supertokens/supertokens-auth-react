...
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    ...
    function ThirdPartyEmailPassword(config) {
        ...
        _this.getFeatures = function () {
            var features = __assign({}, _this.emailPasswordRecipe.getFeatures(), _this.thirdPartyRecipe.getFeatures());
            ...
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (context.action === "GET_REDIRECT_URL") {
                        return [2 /*return*/, this.thirdPartyRecipe.getDefaultRedirectionURL(context)];
        ...
        _this.getFeatureComponent = function (componentName, prop) {
            if (componentName === "signinup") {
                return react_1.default.createElement(signInAndUp_1.default, __assign({ recipe: _this }, prop));
            } else if (componentName === "resetpassword") {
                return _this.emailPasswordRecipe.getFeatureComponent(componentName, prop);
            } else {
                return _this.getAuthRecipeModuleFeatureComponent(componentName, prop);
            }
        };
        _this.recipeImpl = new recipeImplementation_1.default(_this.config.recipeId, _this.config.appInfo);
        _this.emailPasswordRecipe = new recipe_1.default({
        ...
        _this.thirdPartyRecipe = new recipe_2.default({
            appInfo: _this.config.appInfo,
            recipeId: _this.config.recipeId,
            emailVerificationFeature: {
                disableDefaultImplementation: true,
    ...
    ThirdPartyEmailPassword.init = function (config) {
        return function (appInfo) {
            ThirdPartyEmailPassword.instance = new ThirdPartyEmailPassword(
                __assign({}, config, { appInfo: appInfo, recipeId: ThirdPartyEmailPassword.RECIPE_ID })
            );
