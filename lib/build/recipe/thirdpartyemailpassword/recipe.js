...
var recipe_3 = __importDefault(require("supertokens-web-js/lib/build/recipe/thirdpartyemailpassword/recipe"));
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    ...
    function ThirdPartyEmailPassword(config, recipes) {
        ...
        _this.webJsRecipe = new recipe_3.default(
            {
                ...
                override: {
                    ...
                    functions: function (_, builder) {
                        builder = builder.override(function (oI) {
                            return recipeImplementation_1.default(oI, _this.config);
                        });
                        if (_this.config.override.functions !== undefined) {
                            builder = builder.override(_this.config.override.functions);
                        }
        ...
        _this.recipeImpl = _this.webJsRecipe.recipeImplementation;
            ...
            recipes.emailPasswordInstance !== undefined
                ...
                : new recipe_1.default(
                      ...
                      },
                      {
                          ...
                          webJSEmailPasswordInstance: _this.webJsRecipe.emailPasswordRecipe,
                      }
                  );
        ...
        _this.thirdPartyRecipe =
            recipes.thirdPartyInstance !== undefined
                ...
                : new recipe_2.default(
                      ...
                      {
                          emailVerificationInstance: _this.emailVerification,
                          webJSThirdPartyInstance: _this.webJsRecipe.thirdPartyRecipe,
                      }
                  );
        return _this;
    }
