...
function normaliseThirdPartyEmailPasswordConfig(config) {
    ...
    return __assign({}, utils_3.normaliseAuthRecipeModuleConfig(config), { signInAndUpFeature: __assign({}, thirdPartyConfig.signInAndUpFeature, emailPasswordConfig.signInAndUpFeature), resetPasswordUsingTokenFeature: emailPasswordConfig.resetPasswordUsingTokenFeature, disableEmailPassword: disableEmailPassword });
}
