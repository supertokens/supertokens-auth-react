    ...
    return function (originalImp) {
        return {
            ...
            getStateAndOtherInfoFromStorage: function (input) {
                return originalImp.getStateAndOtherInfoFromStorage({
            ...
            getAuthorisationURLWithQueryParamsAndSetState: function (input) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, originalImp.getAuthorisationURLWithQueryParamsAndSetState(input)];
                    });
                });
            },
            ...
            generateStateToSendToOAuthProvider: function (input) {
                return originalImp.generateStateToSendToOAuthProvider(__assign({}, input));
            },
            ...
            doesEmailExist: function (input) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                return [4 /*yield*/, originalImp.doesEmailExist(input)];
                            case 1:
