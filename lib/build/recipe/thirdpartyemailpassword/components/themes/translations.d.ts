export declare const defaultTranslationsThirdPartyEmailPassword: {
    en: {
        ...
        EMAIL_PASSWORD_RESET_SEND_SUCCESS_FALLBACK: string;
        EMAIL_PASSWORD_RESET_SEND_SUCCESS_BEFORE_EMAIL: string;
        EMAIL_PASSWORD_RESET_SEND_SUCCESS_AFTER_EMAIL: string;
