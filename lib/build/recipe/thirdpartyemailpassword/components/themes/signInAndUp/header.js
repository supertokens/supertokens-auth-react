...
function Header(_a) {
     ...
     */
    if (isSignUp === true) {
        return react_1.jsx(signUpHeader_1.default, { onClick: function () { return setIsSignUp(false); } });
    }
    else {
        return react_1.jsx(signInHeader_1.default, { onClick: function () { return setIsSignUp(true); } });
    }
}
