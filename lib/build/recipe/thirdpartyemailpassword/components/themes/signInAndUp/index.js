    ...
    SignInAndUpTheme.prototype.render = function () {
        ...
        return (react_1.jsx("div", { "data-supertokens": "container", css: styles.container },
            react_1.jsx("div", { "data-supertokens": "row", css: styles.row },
                react_1.jsx(header_1.default, { isSignUp: this.state.isSignUp, setIsSignUp: function (isSignUp) {
                        _this.setState(function (oldState) {
                            return __assign({}, oldState, { isSignUp: isSignUp });
                        });
                    } }),
                this.props.hideThirdParty !== true && (react_1.jsx(react_2.Fragment, null,
                    react_1.jsx(signInAndUp_1.default, { history: this.props.history, recipeId: this.props.recipeId, isEmbedded: true },
                        react_1.jsx(providersForm_1.default
                        // Seed props. Real props will be given by parent feature.
                        , __assign({}, {}))))),
                this.props.hideEmailPassword !== true && this.props.hideThirdParty !== true && (react_1.jsx("div", { "data-supertokens": "thirdPartyEmailPasswordDivider", css: styles.thirdPartyEmailPasswordDivider },
                    react_1.jsx("div", { "data-supertokens": "divider", css: styles.divider }),
                    react_1.jsx("div", { "data-supertokens": "thirdPartyEmailPasswordDividerOr", css: styles.thirdPartyEmailPasswordDividerOr }, "or"),
                    react_1.jsx("div", { "data-supertokens": "divider", css: styles.divider }))),
                this.props.hideEmailPassword !== true && (react_1.jsx(signInAndUp_2.default, { history: this.props.history, recipeId: this.props.recipeId, isEmbedded: true },
                    react_1.jsx(signInAndUpForm_1.default
                    // Seed props. Real props will be given by parent feature.
...
function SignInAndUpThemeWrapper(props) {
    return (react_1.jsx(themeBase_1.ThemeBase, null,
        react_1.jsx(styleContext_1.StyleProvider, { rawPalette: props.rawPalette, defaultPalette: styles_1.defaultPalette, styleFromInit: props.styleFromInit, getDefaultStyles: styles_2.getStyles },
