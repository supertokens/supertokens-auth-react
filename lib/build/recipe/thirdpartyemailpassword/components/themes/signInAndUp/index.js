...
var SignInAndUpTheme = function (props) {
    ...
    return react_1.jsx(
        ...
        react_1.jsx(
            ...
            react_1.jsx(header_1.Header, {
                isSignUp: props.epState.isSignUp,
                setIsSignUp: function (isSignUp) {
                    return props.epDispatch({ type: isSignUp ? "setSignUp" : "setSignIn" });
                },
            }),
            props.tpState.error && react_1.jsx(generalError_1.default, { error: props.tpState.error }),
            props.thirdPartyRecipe !== undefined &&
                react_1.jsx(
                    providersForm_1.ProvidersForm,
                    __assign({}, props.tpChildProps, { featureState: props.tpState, dispatch: props.tpDispatch })
                ),
            ...
            props.emailPasswordRecipe !== undefined &&
                react_1.jsx(
                    ...
                    __assign({}, props.epChildProps, { featureState: props.epState, dispatch: props.epDispatch })
                )
        ),
