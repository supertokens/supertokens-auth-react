...
var signInAndUp_3 = require("../../../../thirdparty/components/themes/signInAndUp");
                    ...
                    react_1.jsx(
                        ...
                        _this.props.children === undefined &&
                            react_1.jsx(__1.SignInAndUpTheme, {
                                ...
                                toggleStatus: _this.toggleStatus,
                                thirdParty: react_1.jsx(
                                    ...
                                    react_1.jsx(
                                        signInAndUp_3.SignInAndUpProvidersTheme,
                                        // Seed props. Real props will be given by parent feature.
                                        __assign({}, {})
                                    )
                                ),
                                emailPassword: react_1.jsx(
                                    ...
                                    react_1.jsx(
                                        ...
                                        // Seed props. Real props will be given by parent feature.
                                        __assign({}, {}, { status: _this.state.status })
                                    )
                                )
                            }),
                        _this.props.children &&
                            React.cloneElement(_this.props.children, {
                                ...
                                providers: _this.getRecipeConfigOrThrow().signInAndUpFeature.providers,
                                signInForm: _this.getRecipeConfigOrThrow().signInAndUpFeature.signInForm,
                                signUpForm: _this.getRecipeConfigOrThrow().signInAndUpFeature.signUpForm
                            })
                    )
                )
            );
        };
        var status = _this.getRecipeConfigOrThrow().signInAndUpFeature.defaultToSignUp ? "SIGN_UP" : "SIGN_IN";
        _this.state = {
            status: status
        };
        return _this;
