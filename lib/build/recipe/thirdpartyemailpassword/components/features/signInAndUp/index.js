...
var SignInAndUp = /** @class */ (function (_super) {
    ...
    function SignInAndUp() {
        ...
        _this.render = function () {
             ...
             * Render.
             */
            var hideEmailPassword = _this.getRecipeInstanceOrThrow().config.disableEmailPassword;
            var hideThirdParty = _this.getRecipeInstanceOrThrow().config.signInAndUpFeature.providers.length === 0;
            return (react_1.jsx(featureWrapper_1.default, { useShadowDom: _this.getRecipeInstanceOrThrow().config.useShadowDom },
                react_1.jsx(react_2.Fragment, null,
                    _this.props.children === undefined && (react_1.jsx(__1.SignInAndUpTheme, { rawPalette: _this.getRecipeInstanceOrThrow().config.palette, styleFromInit: _this.getRecipeInstanceOrThrow().config.signInAndUpFeature.style, hideThirdParty: hideThirdParty, hideEmailPassword: hideEmailPassword, defaultToSignUp: _this.getRecipeInstanceOrThrow().config.signInAndUpFeature.defaultToSignUp, history: _this.props.history, recipeId: _this.getRecipeInstanceOrThrow().config.recipeId })),
                    _this.props.children &&
                        React.cloneElement(_this.props.children, {
                            ...
                            styleFromInit: _this.getRecipeInstanceOrThrow().config.signInAndUpFeature.style,
                            defaultToSignUp: _this.getRecipeInstanceOrThrow().config.signInAndUpFeature.defaultToSignUp,
                            history: _this.props.history,
                            recipeId: _this.getRecipeInstanceOrThrow().config.recipeId,
                        }))));
        };
        return _this;
    }
