...
export default class ThirdPartyEmailPasswordAPIWrapper {
    static init(config: UserInput): import("../../types").CreateRecipeFunction<GetRedirectionURLContext, PreAPIHookContext, import("../emailpassword").OnHandleEventContext, import("./types").NormalisedConfig>;
