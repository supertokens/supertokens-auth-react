...
var api_2 = require("./components/features/signOut/api");
/*
 * Class.
 */
var EmailPassword = /** @class */ (function (_super) {
    ...
    function EmailPassword(config) {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.config.signInAndUpFeature.disableDefaultImplementation !== true) {
                var normalisedFullPath = _this.getAppInfo().websiteBasePath.appendPath(new normalisedURLPath_1.default("/"));
            ...
            if (_this.config.resetPasswordUsingTokenFeature.disableDefaultImplementation !== true) {
                var normalisedFullPath = _this.getAppInfo().websiteBasePath.appendPath(new normalisedURLPath_1.default(constants_1.DEFAULT_RESET_PASSWORD_PATH));
            ...
            if (_this.config.emailVerificationFeature.disableDefaultImplementation !== true &&
                _this.config.emailVerificationFeature.mode !== constants_1.EMAIL_VERIFICATION_MODE.OFF) {
                var normalisedFullPath = _this.getAppInfo().websiteBasePath.appendPath(new normalisedURLPath_1.default(constants_1.DEFAULT_VERIFY_EMAIL_PATH));
        ...
        _this.getDefaultRedirectionURL = function (context) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (context.action) {
                    case constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.SIGN_IN_AND_UP:
                        return [2 /*return*/, this.getAppInfo().websiteBasePath.getAsStringDangerous() + "?rid=" + this.getRecipeId()];
                    case constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.VERIFY_EMAIL:
                        return [2 /*return*/, "" + this.getAppInfo().websiteBasePath.getAsStringDangerous() + constants_1.DEFAULT_VERIFY_EMAIL_PATH + "?rid=" + this.getRecipeId()];
                    case constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.RESET_PASSWORD:
                        return [2 /*return*/, "" + this.getAppInfo().websiteBasePath.getAsStringDangerous() + constants_1.DEFAULT_RESET_PASSWORD_PATH + "?rid=" + this.getRecipeId()];
                    case constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.SUCCESS:
                    default:
                        return [2 /*return*/, "/"];
                }
                return [2 /*return*/];
        ...
        _this.getSessionRecipe = function () {
            return superTokens_1.default.getInstanceOrThrow().getDefaultSessionRecipe();
        };
        ...
        _this.signOut = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, api_2.signOut(this)];
     ...
     * Email Verification
     */
    EmailPassword.prototype.isEmailVerified = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, api_1.isEmailVerifiedAPI(this)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    EmailPassword.init = function (config) {
        return function (appInfo) {
            EmailPassword.instance = new EmailPassword(__assign({}, config, { appInfo: appInfo, recipeId: EmailPassword.RECIPE_ID }));
    ...
    EmailPassword.isEmailVerified = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, EmailPassword.getInstanceOrThrow().isEmailVerified()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
