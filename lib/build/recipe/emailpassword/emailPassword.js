...
var EmailPassword = /*#__PURE__*/ (function(_RecipeModule) {
    ...
    function EmailPassword(config) {
        ...
        _this.submitNewPasswordAPI = function(requestJson, headers) {
            return _this.httpRequest.post("/user/password/reset", {
                body: JSON.stringify(requestJson),
                headers: headers
            });
        };

        _this.enterEmailAPI = function(requestJson, headers) {
            return _this.httpRequest.post("/user/password/reset/token", {
                body: JSON.stringify(requestJson),
                headers: headers
            });
        };

        _this.config = (0, _utils2.normaliseEmailPasswordConfigOrThrow)(config);
            ...
            },
            {
                ...
                value: (function() {
                    var _signInValidate = _asyncToGenerator(
                        /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(input) {
                            return regeneratorRuntime.wrap(
            ...
            },
            {
                ...
                value: (function() {
                    var _submitNewPasswordValidate = _asyncToGenerator(
                        /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(input) {
                            return regeneratorRuntime.wrap(
                    ...
                    function submitNewPasswordValidate(_x3) {
            ...
            },
            {
                ...
                value: (function() {
                    var _enterEmailValidate = _asyncToGenerator(
                        /*#__PURE__*/ regeneratorRuntime.mark(function _callee4(input) {
                            return regeneratorRuntime.wrap(
                    ...
                    function enterEmailValidate(_x4) {
