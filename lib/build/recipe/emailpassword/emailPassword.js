                    ...
                    switch (context.action) {
                        ...
                        case constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.VERIFY_EMAIL:
                            return [
                                2 /*return*/,
                                "" +
                                    this.getAppInfo().websiteBasePath.getAsStringDangerous() +
                                    constants_1.DEFAULT_VERIFY_EMAIL_PATH +
                                    "?rid=" +
                                    this.getRecipeId()
                            ];
                        case constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.RESET_PASSWORD:
                            return [
                                ...
                                "" +
                                    this.getAppInfo().websiteBasePath.getAsStringDangerous() +
                                    constants_1.DEFAULT_RESET_PASSWORD_PATH +
                                    "?rid=" +
                                    this.getRecipeId()
                            ];
        ...
        _this.signOut = function() {
            return __awaiter(_this, void 0, void 0, function() {
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, api_2.signOut(this)];
                        case 1:
