...
var EmailPassword = /*#__PURE__*/ (function(_RecipeModule) {
    ...
    function EmailPassword(config) {
        ...
        _this.redirect = /*#__PURE__*/ (function() {
            var _ref2 = _asyncToGenerator(
                /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(context) {
                    var shouldReload,
                        title,
                        history,
                        redirectUrl,
                        ...
                        function _callee2$(_context2) {
                            while (1) {
                                switch ((_context2.prev = _context2.next)) {
                                    case 0:
                                        shouldReload = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : false;
                                        title = _args2.length > 2 ? _args2[2] : undefined;
                                        history = _args2.length > 3 ? _args2[3] : undefined;
                                        _context2.next = 5;
        ...
        _this.getRedirectionURL = /*#__PURE__*/ (function() {
            var _ref3 = _asyncToGenerator(
                /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(context) {
                    var getRedirectionURL, _redirectionUrl, redirectionUrl, rid;
                        ...
                        while (1) {
                            switch ((_context3.prev = _context3.next)) {
                                case 0:
                                    ...
                                    getRedirectionURL = _this.getConfig().getRedirectionURL;
                                ...
                                case 4:
                                    _redirectionUrl = _context3.sent;

                                    if (!(_redirectionUrl !== undefined)) {
                                        _context3.next = 7;
                                        break;
                                    }

                                    return _context3.abrupt("return", _redirectionUrl);

                                case 7:
                                    // Otherwise, use default.
                                    redirectionUrl = "/";
                                    rid = _this.getRecipeId();
                                    _context3.t0 = context.action;
                                    _context3.next =
                                        _context3.t0 === _constants.GET_REDIRECTION_URL_ACTION.SUCCESS
                                            ? 12
                                            : _context3.t0 === _constants.GET_REDIRECTION_URL_ACTION.SIGN_IN_AND_UP
                                            ? 14
                                            : _context3.t0 === _constants.GET_REDIRECTION_URL_ACTION.VERIFY_EMAIL
                                            ? 16
                                            : _context3.t0 === _constants.GET_REDIRECTION_URL_ACTION.RESET_PASSWORD
                                            ? 18
                                            : 20;
                                    break;
                                ...
                                case 21:
                                    return _context3.abrupt("return", redirectionUrl);
                        ...
                        while (1) {
                            switch ((_context4.prev = _context4.next)) {
                                ...
                                case 3:
                                    ...
                                    return _context4.abrupt("return", _this.httpRequest.post("/signup", requestInit));
        ...
        _this.emailExistsAPI = /*#__PURE__*/ (function() {
            var _ref5 = _asyncToGenerator(
                /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(value, headers) {
                    var context, requestInit;
                        ...
                        while (1) {
                            switch ((_context6.prev = _context6.next)) {
                                ...
                                case 3:
                                    ...
                                    return _context6.abrupt("return", _this.httpRequest.post("/signin", requestInit));
        ...
        _this.verifyEmailAPI = /*#__PURE__*/ (function() {
            var _ref11 = _asyncToGenerator(
                /*#__PURE__*/ regeneratorRuntime.mark(function _callee11(requestJson, headers) {
                    var context, requestInit;
        ...
        _this.isEmailVerifiedAPI = /*#__PURE__*/ (function() {
            var _ref12 = _asyncToGenerator(
                /*#__PURE__*/ regeneratorRuntime.mark(function _callee12(headers) {
                    var context, requestInit;
        ...
        [
            {
                ...
                value: function onHandleEvent(context) {
                    var onHandleEvent = this.getConfig().onHandleEvent;
                                    ...
                                    while (1) {
                                        switch ((_context13.prev = _context13.next)) {
                                            ...
                                            case 2:
                                                ...
                                                return _context13.abrupt("return", response.isVerified);
            ...
            },
            {
                ...
                value: (function() {
                    var _submitNewPasswordValidate = _asyncToGenerator(
                        /*#__PURE__*/ regeneratorRuntime.mark(function _callee16(input) {
                            return regeneratorRuntime.wrap(
                    ...
                    function submitNewPasswordValidate(_x20) {
            ...
            },
            {
                ...
                value: (function() {
                    var _enterEmailValidate = _asyncToGenerator(
                        /*#__PURE__*/ regeneratorRuntime.mark(function _callee17(input) {
                            return regeneratorRuntime.wrap(
                    ...
                    function enterEmailValidate(_x21) {
