...
var _1 = require(".");
var emailVerification_1 = __importDefault(require("../emailverification/emailVerification"));
...
var api_1 = require("./components/features/signOut/api");
...
var EmailPassword = /** @class */ (function(_super) {
    ...
    function EmailPassword(config) {
        ...
        _this.getFeatures = function() {
            ...
            return __assign({}, features, emailVerification_1.default.getInstanceOrThrow().getFeatures());
        };
                    ...
                    switch (context.action) {
                        ...
                        case "VERIFY_EMAIL":
                            return [
                                2 /*return*/,
                                "" +
                                    this.appInfo.websiteBasePath.getAsStringDangerous() +
    ...
    EmailPassword.prototype.isEmailVerified = function() {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, emailVerification_1.default.isEmailVerified()];
                    case 1:
                        return [2 /*return*/, _a.sent()];
                }
            });
    ...
    EmailPassword.init = function(config) {
        return function(appInfo) {
            ...
            var emailVerificationUserInput = {};
            ...
            emailVerification_1.default.init(
                __assign({}, emailVerificationUserInput, {
