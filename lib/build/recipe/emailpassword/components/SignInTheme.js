                    ...
                    while (1) {
                        switch ((_context.prev = _context.next)) {
                            ...
                            case 4:
                                ...
                                if (result.status === _types.APIStatus.OK) {
                                ...
                                if (result.status === _types.APIStatus.FIELD_ERROR && result.fields !== undefined) {
        ...
        (0, _core.jsx)(
            ...
            (0, _core.jsx)(
                ...
                formFields.map(function(field) {
                    ...
                    if (_utils.mandatoryFormFields.includes(field.id)) {
                        type = field.id;
                    }
