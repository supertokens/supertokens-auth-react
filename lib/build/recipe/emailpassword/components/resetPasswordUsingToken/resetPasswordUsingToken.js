...
var ResetPasswordUsingToken = /*#__PURE__*/ (function(_PureComponent) {
    ...
    function ResetPasswordUsingToken(props) {
        ...
        _this.onCallSendResetEmailAPI = function(requestJson, headers) {
            // If props provided by user.
            if (_this.props.onCallSendResetEmailAPI) {
                return _this.props.onCallSendResetEmailAPI(requestJson, headers);
