...
function ResetPasswordUsingTokenTheme(props) {
    ...
    if (props.hasToken) {
        return /*#__PURE__*/ React.createElement(_submitNewPassword["default"], props.submitNewPassword);
    } // Otherwise, return EnterEmail.

    return /*#__PURE__*/ React.createElement(_enterEmail["default"], props.enterEmail);
}
