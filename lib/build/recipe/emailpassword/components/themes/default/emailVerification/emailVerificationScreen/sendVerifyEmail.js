    ...
    function SendVerifyEmailTheme(props) {
        ...
        _this.sendEmail = /*#__PURE__*/ _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee() {
                var _this$props, callAPI, onEmailAlreadyVerified, response;
                    ...
                    while (1) {
                        switch ((_context.prev = _context.next)) {
                            ...
                            case 3:
                                ...
                                if (
                                    !(response.status === _constants.API_RESPONSE_STATUS.EMAIL_ALREADY_VERIFIED_ERROR)
                                ) {
                                    _context.next = 6;
                                    break;
                                }
