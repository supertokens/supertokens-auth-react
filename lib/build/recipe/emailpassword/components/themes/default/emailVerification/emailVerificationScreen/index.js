...
function EmailVerificationTheme(props) {
    ...
    if (props.hasToken === false) {
        return (React.createElement(styleContext_1.StyleProvider, { defaultPalette: styles_1.defaultPalette, styleFromInit: props.sendVerifyEmailScreen.styleFromInit, getDefaultStyles: styles_1.getDefaultStyles },
    ...
    return (React.createElement(styleContext_1.StyleProvider, { defaultPalette: styles_1.defaultPalette, styleFromInit: props.verifyEmailLinkClickedScreen.styleFromInit, getDefaultStyles: styles_1.getDefaultStyles },
