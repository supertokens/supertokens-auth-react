 ...
 * Default styles.
 */
var slideTop = react_1.keyframes(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    0% {\n        transform: translateY(-5px);\n    }\n    100% {\n        transform: translateY(0px);\n    }\n"], ["\n    0% {\n        transform: translateY(-5px);\n    }\n    100% {\n        transform: translateY(0px);\n    }\n"])));
var swingIn = react_1.keyframes(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n0% {\n    -webkit-transform: rotateX(-100deg);\n            transform: rotateX(-100deg);\n    -webkit-transform-origin: top;\n            transform-origin: top;\n    opacity: 0;\n  }\n  100% {\n    -webkit-transform: rotateX(0deg);\n            transform: rotateX(0deg);\n    -webkit-transform-origin: top;\n            transform-origin: top;\n    opacity: 1;\n  }\n}\n@keyframes swing-in-top-fwd {\n  0% {\n    -webkit-transform: rotateX(-100deg);\n            transform: rotateX(-100deg);\n    -webkit-transform-origin: top;\n            transform-origin: top;\n    opacity: 0;\n  }\n  100% {\n    -webkit-transform: rotateX(0deg);\n            transform: rotateX(0deg);\n    -webkit-transform-origin: top;\n            transform-origin: top;\n    opacity: 1;\n  }\n"], ["\n0% {\n    -webkit-transform: rotateX(-100deg);\n            transform: rotateX(-100deg);\n    -webkit-transform-origin: top;\n            transform-origin: top;\n    opacity: 0;\n  }\n  100% {\n    -webkit-transform: rotateX(0deg);\n            transform: rotateX(0deg);\n    -webkit-transform-origin: top;\n            transform-origin: top;\n    opacity: 1;\n  }\n}\n@keyframes swing-in-top-fwd {\n  0% {\n    -webkit-transform: rotateX(-100deg);\n            transform: rotateX(-100deg);\n    -webkit-transform-origin: top;\n            transform-origin: top;\n    opacity: 0;\n  }\n  100% {\n    -webkit-transform: rotateX(0deg);\n            transform: rotateX(0deg);\n    -webkit-transform-origin: top;\n            transform-origin: top;\n    opacity: 1;\n  }\n"])));
function getDefaultStyles(palette) {
    return {
        ...
        generalError: {
            backgroundColor: chroma_js_1.default(palette.colors.error)
                .brighten(2)
                .luminance(0.9)
                .hex(),
            paddingTop: "10px",
        ...
        button: {
            ...
            color: "white",
            fontWeight: 700,
            border: "1px solid " + chroma_js_1.default(palette.colors.primary)
                .darken(0.3)
                .hex(),
            borderRadius: "8px",
            ...
            "&:active": {
                outline: "none",
                border: "none",
                backgroundColor: chroma_js_1.default(palette.colors.primary)
                    .darken(0.1)
                    .hex(),
        ...
        generalSuccess: {
            ...
            fontSize: palette.fonts.size[0],
            backgroundColor: chroma_js_1.default(palette.colors.success)
                .brighten(2)
                .luminance(0.9)
                .hex(),
            animation: swingIn + " 1s cubic-bezier(0.175, 0.885, 0.320, 1.275) both",
