 ...
 * Component.
 */
function SignInAndUpTheme(_ref) {
    var signInForm = _ref.signInForm,
        signUpForm = _ref.signUpForm,
        defaultToSignUp = _ref.defaultToSignUp;

    /*
     * State.
     */
    var _useState = (0, React.useState)(defaultToSignUp),
...
function SignInAndUpThemeWrapper(props) {
    return /*#__PURE__*/ React.createElement(
        ...
        null,
        /*#__PURE__*/ React.createElement(SignInAndUpTheme, props)
    );
}
