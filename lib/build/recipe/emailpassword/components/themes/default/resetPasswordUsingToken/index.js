...
function ResetPasswordUsingTokenTheme(props) {
    ...
    if (props.hasToken === true) {
        return (React.createElement(styleContext_1.StyleProvider, { defaultPalette: styles_1.defaultPalette, styleFromInit: props.submitNewPasswordForm.styleFromInit, getDefaultStyles: styles_1.getDefaultStyles },
            React.createElement(submitNewPassword_1.default, __assign({}, props.submitNewPasswordForm))));
    }
    // Otherwise, return EnterEmail.
    return (React.createElement(styleContext_1.StyleProvider, { defaultPalette: styles_1.defaultPalette, styleFromInit: props.enterEmailForm.styleFromInit, getDefaultStyles: styles_1.getDefaultStyles },
