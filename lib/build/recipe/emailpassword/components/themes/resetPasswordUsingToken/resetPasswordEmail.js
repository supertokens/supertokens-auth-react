...
var EmailPasswordResetPasswordEmail = function (props) {
    ...
    var getEmailSuccessText = function () {
    ...
    if (status === "SENT") {
        return react_1.jsx(
            ...
            react_1.jsx(backToSignInButton_1.default, { onClick: props.handleBackButtonClick })
        );
    }
    ...
    return react_1.jsx(
        ...
        react_1.jsx(
            ...
            react_1.jsx(
                ...
                react_1.jsx("span", { "data-supertokens": "backButtonPlaceholder", css: styles.backButtonPlaceholder })
            ),
            react_1.jsx(
                "div",
