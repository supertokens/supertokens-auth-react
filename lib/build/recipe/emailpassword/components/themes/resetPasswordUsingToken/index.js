...
function ResetPasswordUsingTokenTheme(props) {
    ...
    if (props.token !== undefined) {
        return (React.createElement(styleContext_1.StyleProvider, { rawPalette: props.rawPalette, defaultPalette: styles_2.defaultPalette, styleFromInit: props.submitNewPasswordForm.styleFromInit, getDefaultStyles: styles_1.getStyles },
            React.createElement(submitNewPassword_1.default, __assign({}, props.submitNewPasswordForm))));
    }
    // Otherwise, return EnterEmail.
    return (React.createElement(styleContext_1.StyleProvider, { rawPalette: props.rawPalette, defaultPalette: styles_2.defaultPalette, styleFromInit: props.enterEmailForm.styleFromInit, getDefaultStyles: styles_1.getStyles },
