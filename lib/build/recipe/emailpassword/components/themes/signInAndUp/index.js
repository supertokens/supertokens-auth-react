...
var SignInAndUpTheme = /** @class */ (function (_super) {
    ...
    SignInAndUpTheme.prototype.render = function () {
        ...
        if (this.state.isSignUp) {
            return (React.createElement(styleContext_1.StyleProvider, { rawPalette: this.props.rawPalette, defaultPalette: styles_1.defaultPalette, styleFromInit: this.props.signUpForm.styleFromInit, getDefaultStyles: styles_2.getStyles },
                React.createElement(signUp_1.default, __assign({}, this.props.signUpForm, { signInClicked: function () {
        ...
        return (React.createElement(styleContext_1.StyleProvider, { rawPalette: this.props.rawPalette, defaultPalette: styles_1.defaultPalette, styleFromInit: this.props.signInForm.styleFromInit, getDefaultStyles: styles_2.getStyles },
            React.createElement(signIn_1.default, __assign({}, this.props.signInForm, { signUpClicked: function () {
                    _this.setState(function (oldState) {
