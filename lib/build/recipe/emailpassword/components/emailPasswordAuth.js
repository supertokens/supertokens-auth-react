...
var EmailPasswordAuth = /*#__PURE__*/ (function(_PureComponent) {
    ...
    function EmailPasswordAuth(props) {
        ...
        _this.onCallIsEmailVerifiedAPI = /*#__PURE__*/ (function() {
            var _ref2 = _asyncToGenerator(
                /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(headers) {
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                            switch ((_context2.prev = _context2.next)) {
                                case 0:
                                    if (!_this.props.onCallIsEmailVerifiedAPI) {
                                        _context2.next = 4;
                                        break;
                                    }

                                    _context2.next = 3;
                                    return _this.props.onCallIsEmailVerifiedAPI(headers);
                                ...
                                case 4:
                                    _context2.next = 6;
                                    return _this.getRecipeInstanceOrThrow().isEmailVerifiedAPI(headers);
                        ...
                        while (1) {
                            switch ((_context3.prev = _context3.next)) {
                                case 0:
                                    _context3.prev = 0;
                                    _context3.next = 3;
                                    return _this.onCallIsEmailVerifiedAPI({
                            ...
                            case 6:
                                ...
                                (0, _utils.redirectToInApp)(
                                    ""
                                        ...
                                        .concat(_constants.DEFAULT_VERIFY_EMAIL_PATH, "?rid=emailpassword"),
                                    undefined,
                                    _this.props.history
                                );
                                return _context4.abrupt("return");
                            ...
                            function _callee5$(_context5) {
                                while (1) {
                                    switch ((_context5.prev = _context5.next)) {
                                        ...
                                        case 2:
                                            hasValidSession = _context5.sent;
                                        ...
                                        case 11:
                                            isEmailVerified = _context5.sent;
