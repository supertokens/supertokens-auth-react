...
var EmailPasswordAuth = /** @class */ (function(_super) {
    ...
    EmailPasswordAuth.prototype.componentDidMount = function() {
        return __awaiter(this, void 0, void 0, function() {
            var sessionExists, redirectToPath, isEmailVerified;
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
...
function EmailPasswordAuthWrapper(props) {
    if (superTokens_1.default.getInstanceOrThrow().reactRouterDom === undefined) {
        return React.createElement(EmailPasswordAuth, __assign({}, props));
    }
    var Component = superTokens_1.default.getInstanceOrThrow().reactRouterDom.withRouter(EmailPasswordAuth);
