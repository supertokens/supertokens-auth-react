...
var FormBase = /** @class */ (function (_super) {
    ...
    function FormBase(props) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        e.preventDefault();
                        // Set loading state.
                        this.setState(function (oldState) { return (__assign({}, oldState, { status: "LOADING" })); });
                    ...
                    case 2:
                        ...
                        if (result_1.status === "OK") {
                            // Set Success state.
                            this.setState(function (oldState) { return (__assign({}, oldState, { status: "SUCCESS" })); }, function () {
                        ...
                        if (result_1.status === "GENERAL_ERROR") {
                            this.setState(function (oldState) { return (__assign({}, oldState, { status: "GENERAL_ERROR", generalError: result_1.message })); });
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
                        this.setState(function (oldState) { return (__assign({}, oldState, { status: "GENERAL_ERROR", generalError: constants_1.SOMETHING_WENT_WRONG_ERROR })); });
                        return [3 /*break*/, 4];
        ...
        _this.state = {
            formFields: props.formFields.map(function (field) { return (__assign({}, field, { validated: false, ref: react_2.createRef() })); }),
            status: "IN_PROGRESS",
        };
        return _this;
    }
    ...
    FormBase.prototype.render = function () {
        ...
        return (react_1.jsx(react_2.Fragment, null,
            header,
            this.state.status === "GENERAL_ERROR" && (react_1.jsx("div", { "data-supertokens": "generalError", css: styles.generalError }, this.state.generalError)),
            react_1.jsx("form", { autoComplete: "on", noValidate: true, onSubmit: this.onFormSubmit },
                formFields.map(function (field) {
                    ...
                    return (react_1.jsx(_1.FormRow, { key: field.id, hasError: field.error !== undefined },
                        react_1.jsx(react_2.Fragment, null,
                            showLabels && react_1.jsx(_1.Label, { value: field.label, showIsRequired: field.showIsRequired }),
                            react_1.jsx(_1.Input, { type: type, name: field.id, validated: field.validated, placeholder: field.placeholder, ref: field.ref, autoComplete: field.autoComplete, onInputFocus: _this.handleInputFocus, onInputBlur: onInputBlur, hasError: field.error !== undefined }),
                            field.error && react_1.jsx(_1.InputError, { error: field.error }))));
                }),
                react_1.jsx(_1.FormRow, { key: "form-button" },
                    react_1.jsx(react_2.Fragment, null,
                        react_1.jsx(_1.Button, { disabled: this.state.status === "LOADING", isLoading: this.state.status === "LOADING", type: "submit", label: buttonLabel }),
                        footer)))));
    };
