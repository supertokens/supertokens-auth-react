                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            // Set loading state.
                            this.setState(function(oldState) {
                                return __assign({}, oldState, { status: constants_1.FORM_BASE_STATUS.LOADING });
                            });
                        ...
                        case 2:
                            ...
                            if (result_1.status === constants_1.FORM_BASE_API_RESPONSE.OK) {
                                ...
                                this.setState(
                                    function(oldState) {
                                        return __assign({}, oldState, { status: constants_1.FORM_BASE_STATUS.SUCCESS });
                                    },
                                    function() {
                            ...
                            if (result_1.status === constants_1.FORM_BASE_API_RESPONSE.GENERAL_ERROR) {
                                this.setState(function(oldState) {
                                    return __assign({}, oldState, {
                                        status: constants_1.FORM_BASE_STATUS.GENERAL_ERROR,
                        ...
                        case 3:
                            ...
                            this.setState(function(oldState) {
                                return __assign({}, oldState, {
                                    status: constants_1.FORM_BASE_STATUS.GENERAL_ERROR,
                                    generalError: constants_2.SOMETHING_WENT_WRONG_ERROR
                                });
                            });
                            return [3 /*break*/, 4];
                        case 4:
    ...
    FormBase.prototype.render = function() {
        ...
        return react_1.jsx(
            ...
            react_1.jsx(
                ...
                header,
                this.state.status === constants_1.FORM_BASE_STATUS.GENERAL_ERROR &&
                    react_1.jsx(
                        "div",
                    ...
                    react_1.jsx(
                        ...
                        react_1.jsx(
                            ...
                            react_1.jsx(_1.Button, {
                                disabled: this.state.status === constants_1.FORM_BASE_STATUS.LOADING,
                                isLoading: this.state.status === constants_1.FORM_BASE_STATUS.LOADING,
                                type: "submit",
                                label: buttonLabel
                            }),
                            footer
