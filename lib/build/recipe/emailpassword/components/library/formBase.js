...
exports.FormBase = function (props) {
    ...
    var onInputChange = react_3.useCallback(
        function (field) {
            updateFieldState(field.id, function (os) {
                return __assign(__assign({}, os), { value: field.value });
            });
            props.clearError();
        },
        [updateFieldState]
    ...
    var onFormSubmit = react_3.useCallback(
        function (e) {
            return __awaiter(void 0, void 0, void 0, function () {
                var apiFields, result, _i, formFields_1, field, errorFields_1, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, props.callAPI(apiFields)];
                        case 2:
                            result = _a.sent();
                            ...
                            for (_i = 0, formFields_1 = formFields; _i < formFields_1.length; _i++) {
                                ...
                                if (field.clearOnSubmit === true) {
                                    ...
                                    updateFieldState(field.id, function (os) {
                                        return __assign(__assign({}, os), { value: "" });
                                    });
                                }
                            }
                            // If successful
