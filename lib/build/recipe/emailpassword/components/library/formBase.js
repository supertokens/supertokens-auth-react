                            ...
                            while (1) {
                                switch ((_context3.prev = _context3.next)) {
                                    ...
                                    case 6:
                                        ...
                                        if (!(result.status === _constants.FORM_BASE_API_RESPONSE.OK)) {
                                            _context3.next = 10;
                                            break;
                                        }
                                    ...
                                    case 10:
                                        if (!(result.status === _constants.FORM_BASE_API_RESPONSE.FIELD_ERROR)) {
                                            _context3.next = 15;
                                            break;
                                        }
                                    ...
                                    case 15:
                                        ...
                                        if (result.status === _constants.FORM_BASE_API_RESPONSE.GENERAL_ERROR) {
                                            _this.setState(function(oldState) {
                                                return _objectSpread(
                                                    _objectSpread({}, oldState),
                                                    {},
                                    ...
                                    case 18:
                                        ...
                                        _this.setState(function(oldState) {
                                            return _objectSpread(
                                                ...
                                                {
                                                    status: _constants.FORM_BASE_STATUS.GENERAL_ERROR,
                                                    generalError: _constants2.SOMETHING_WENT_WRONG_ERROR
                                                }
                                            );
                                        });
