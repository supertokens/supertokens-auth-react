        ...
        tslib_1.__assign(
            { "data-supertokens": "backButtonContainer", css: styles.backButtonContainer },
            {
                children: (0, jsx_runtime_1.jsxs)(
                    ...
                    tslib_1.__assign(
                        {
                            "data-supertokens": "backButtonWithLeftArrow",
                            css: styles.backButtonWithLeftArrow,
                            onClick: onClick,
                        },
                        {
                            children: [
                                (0, jsx_runtime_1.jsx)(arrowLeftIcon_1.default, {
                                    color: styles.palette.colors.secondaryText,
                                }),
                                (0, jsx_runtime_1.jsx)("span", { children: t("EMAIL_PASSWORD_RESET_SIGN_IN_LINK") }),
                            ],
                        }
                    )
                ),
