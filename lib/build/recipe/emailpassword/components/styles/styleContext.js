...
function StyleProvider(_a) {
    var children = _a.children, styleFromInit = _a.styleFromInit, getDefaultStyles = _a.getDefaultStyles, defaultPalette = _a.defaultPalette;
    ...
    if (styleFromInit !== undefined) {
        ...
        Object.keys(styleFromInit).forEach(function (key) { return [
            (styles[key] = __assign({}, styles[key], styleFromInit[key]))
        ]; });
    }
    return react_1.default.createElement(StyleContext.Provider, { value: styles }, children);
}
exports.StyleProvider = StyleProvider;
exports.StyleConsumer = StyleContext.Consumer;
/*
 * Helpers
 */
