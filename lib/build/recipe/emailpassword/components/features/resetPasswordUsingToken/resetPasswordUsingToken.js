    ...
    function ResetPasswordUsingToken(props) {
                            ...
                            switch ((_context.prev = _context.next)) {
                                case 0:
                                    ...
                                    return (0, _utils.validateForm)(
                                        formFields,
                                        _this.getRecipeInstanceOrThrow().getConfig().resetPasswordUsingTokenFeature
                    ...
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                            switch ((_context2.prev = _context2.next)) {
                                ...
                                case 5:
                                    _context2.next = 7;
                                    return (0, _api.enterEmailAPI)(formFields, _this.getRecipeInstanceOrThrow());
        ...
        _this.render = function() {
            ...
            var submitNewPasswordForm = {
                ...
                onSuccess: function onSuccess() {
                    _this.getRecipeInstanceOrThrow().onHandleEvent({
                        action: _constants.EMAIL_PASSWORD_SUCCESS_ACTION.PASSWORD_RESET_SUCCESSFUL
                    });
                },
            ...
            var enterEmailForm = {
                ...
                onSuccess: function onSuccess() {
                    _this.getRecipeInstanceOrThrow().onHandleEvent({
                        action: _constants.EMAIL_PASSWORD_SUCCESS_ACTION.RESET_PASSWORD_EMAIL_SENT
                    });
                },
            ...
            return (0, _react2.jsx)(
                ...
                (0, _react2.jsx)(
                    ...
                    _this.props.children === undefined &&
                        (0, _react2.jsx)(_.ResetPasswordUsingTokenTheme, {
