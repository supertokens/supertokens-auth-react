...
var ResetPasswordUsingToken = /** @class */ (function (_super) {
    ...
    function ResetPasswordUsingToken(props) {
        ...
        _this.submitNewPassword = function (formFields) { return __awaiter(_this, void 0, void 0, function () {
            var validationErrors;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.validateForm(formFields, this.getRecipeInstanceOrThrow().getConfig().resetPasswordUsingTokenFeature.submitNewPasswordForm.formFields)];
                    case 1:
                        ...
                        return [4 /*yield*/, api_1.handleSubmitNewPasswordAPI([formFields[0]], this.getRecipeInstanceOrThrow(), this.state.token)];
                    case 2: 
        ...
        _this.enterEmail = function (formFields) { return __awaiter(_this, void 0, void 0, function () {
            var validationErrors;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.validateForm(formFields, this.getRecipeInstanceOrThrow().getConfig().resetPasswordUsingTokenFeature.enterEmailForm.formFields)];
                    case 1:
                        validationErrors = _a.sent();
                        // If errors, return.
                        if (validationErrors.length > 0) {
        ...
        _this.render = function () {
            var enterEmailFormFeature = _this.getRecipeInstanceOrThrow().getConfig().resetPasswordUsingTokenFeature
                .enterEmailForm;
            var submitNewPasswordFormFeature = _this.getRecipeInstanceOrThrow().getConfig().resetPasswordUsingTokenFeature
            ...
            var submitNewPasswordForm = {
                ...
                onSignInClicked: function () {
                    _this.getRecipeInstanceOrThrow().redirect({ action: constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.SIGN_IN_AND_UP }, _this.props.history);
                }
            };
            var enterEmailForm = {
            ...
            return (React.createElement(featureWrapper_1.default, { useShadowDom: useShadowDom },
                React.createElement(react_1.Fragment, null,
                    _this.props.children === undefined && (React.createElement(__1.ResetPasswordUsingTokenTheme, { submitNewPasswordForm: submitNewPasswordForm, enterEmailForm: enterEmailForm, hasToken: hasToken })),
