    ...
    function ResetPasswordUsingToken(props) {
        ...
        _this.submitNewPassword = function (formFields) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.validateForm(formFields, this.getRecipeInstanceOrThrow().config.resetPasswordUsingTokenFeature.submitNewPasswordForm.formFields)];
                    case 1:
        ...
        _this.enterEmail = function (formFields) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.validateForm(formFields, this.getRecipeInstanceOrThrow().config.resetPasswordUsingTokenFeature.enterEmailForm.formFields)];
                    case 1:
                        validationErrors = _a.sent();
                        // If errors, return.
                        if (validationErrors.length > 0) {
        ...
        _this.render = function () {
            ...
            var submitNewPasswordForm = {
                ...
                onSignInClicked: function () {
                    _this.getRecipeInstanceOrThrow().redirectToAuth(_this.props.history);
                },
            };
            var enterEmailForm = {
            ...
            return (react_1.jsx(featureWrapper_1.default, { isEmbedded: _this.getIsEmbedded(), useShadowDom: _this.getRecipeInstanceOrThrow().config.useShadowDom },
                react_1.jsx(react_2.Fragment, null,
                    _this.props.children === undefined && (react_1.jsx(__1.ResetPasswordUsingTokenTheme, { rawPalette: _this.getRecipeInstanceOrThrow().config.palette, submitNewPasswordForm: submitNewPasswordForm, enterEmailForm: enterEmailForm, hasToken: hasToken })),
