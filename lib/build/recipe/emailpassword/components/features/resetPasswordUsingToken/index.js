...
var ResetPasswordUsingToken = /** @class */ (function(_super) {
    ...
    function ResetPasswordUsingToken(props) {
                        ...
                        case 0:
                            return [
                                ...
                                utils_1.validateForm(
                                    formFields,
                                    emailPassword_1.default.getInstanceOrThrow().config.resetPasswordUsingTokenFeature
                        ...
                        case 1:
                            ...
                            return [
                                ...
                                api_1.handleSubmitNewPasswordAPI(
                                    [formFields[0]],
                                    emailPassword_1.default.getInstanceOrThrow(),
                                    this.state.token
                                )
                            ];
                        case 2:
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [
                                4 /*yield*/,
                                api_1.enterEmailAPI(formFields, emailPassword_1.default.getInstanceOrThrow())
                            ];
                        case 2:
                            return [2 /*return*/, _a.sent()];
                    }
        ...
        _this.render = function() {
            var enterEmailFormFeature = emailPassword_1.default.getInstanceOrThrow().config
                .resetPasswordUsingTokenFeature.enterEmailForm;
            var submitNewPasswordFormFeature = emailPassword_1.default.getInstanceOrThrow().config
            ...
            var submitNewPasswordForm = {
                ...
                onSignInClicked: function() {
                    emailPassword_1.default
                        .getInstanceOrThrow()
                        .redirect({ action: "SIGN_IN_AND_UP" }, _this.props.history);
                }
            };
            var enterEmailForm = {
