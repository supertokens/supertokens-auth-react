...
var ResetPasswordUsingToken = /** @class */ (function (_super) {
    ...
    function ResetPasswordUsingToken(props) {
        ...
        _this.render = function () {
            var enterEmailFormFeature =
                _this.getRecipeInstanceOrThrow().config.resetPasswordUsingTokenFeature.enterEmailForm;
            var submitNewPasswordFormFeature =
                _this.getRecipeInstanceOrThrow().config.resetPasswordUsingTokenFeature.submitNewPasswordForm;
