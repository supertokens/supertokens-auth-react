...
var SignInAndUp = /** @class */ (function(_super) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (
                                ...
                                context.redirectToPath = utils_1.getRedirectToPathFromURL();
                                context.action = constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.SUCCESS;
                            }
            ...
            var signInForm = {
                ...
                forgotPasswordClick: function() {
                    return _this
                        ...
                        .redirect(
                            { action: constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.RESET_PASSWORD },
                            _this.props.history
                        );
                }
            };
    ...
    SignInAndUp.prototype.setStateOnSuccessfulAPICall = function(normalisedAPIResponse) {
        this.setState(function(oldState) {
            if (
                oldState.status !== constants_1.SIGN_IN_AND_UP_STATUS.READY ||
