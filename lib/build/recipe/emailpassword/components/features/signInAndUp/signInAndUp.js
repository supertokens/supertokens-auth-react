...
var SignInAndUp = /** @class */ (function (_super) {
    ...
    function SignInAndUp(props) {
        ...
        _this.signIn = function (formFields) { return __awaiter(_this, void 0, void 0, function () {
            var validationErrors, normalisedAPIResponse;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.validateForm(formFields, this.getRecipeInstanceOrThrow().getConfig().signInAndUpFeature.signInForm.formFields)];
                    case 1:
        ...
        _this.onSignInSuccess = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.state.status !== constants_1.SIGN_IN_AND_UP_STATUS.SUCCESSFUL) {
                            return [2 /*return*/];
                        }
                        this.getRecipeInstanceOrThrow().onHandleEvent({
                            action: constants_1.EMAIL_PASSWORD_SUCCESS_ACTION.SIGN_IN_COMPLETE,
                            user: this.state.user
                        });
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().redirect({
                                action: constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.SUCCESS
                            })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
        _this.signUp = function (formFields) { return __awaiter(_this, void 0, void 0, function () {
            var validationErrors, normalisedAPIResponse;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.validateForm(formFields, this.getRecipeInstanceOrThrow().getConfig().signInAndUpFeature.signUpForm.formFields)];
                    case 1:
                        validationErrors = _a.sent();
                        // If errors, return.
                        if (validationErrors.length > 0) {
        ...
        _this.onSignUpSuccess = function () { return __awaiter(_this, void 0, void 0, function () {
            var action;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.getRecipeInstanceOrThrow().onHandleEvent({
                            action: constants_1.EMAIL_PASSWORD_SUCCESS_ACTION.SIGN_UP_COMPLETE,
                            user: this.state.user
                        });
                        action = constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.SUCCESS;
                        if (this.getRecipeInstanceOrThrow().getConfig().emailVerificationFeature.mode ===
                            constants_1.EMAIL_VERIFICATION_MODE.REQUIRED) {
                            action = constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.VERIFY_EMAIL;
                        }
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().redirect({ action: action })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.getRecipeInstanceOrThrow().onHandleEvent({
                            action: constants_1.EMAIL_PASSWORD_SUCCESS_ACTION.SESSION_ALREADY_EXISTS
                        });
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().redirect({ action: constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.SUCCESS }, this.props.history)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        this.setState(function (oldState) {
                            if (oldState.status !== constants_1.SIGN_IN_AND_UP_STATUS.LOADING) {
                                return oldState;
                            }
                            return __assign({}, oldState, { status: constants_1.SIGN_IN_AND_UP_STATUS.READY });
                        });
                        return [2 /*return*/];
                }
            });
        ...
        _this.render = function () {
            ...
            var signInForm = {
                ...
                forgotPasswordClick: function () {
                    return _this.getRecipeInstanceOrThrow().redirect({ action: constants_1.EMAIL_PASSWORD_REDIRECTION_URL_ACTION.RESET_PASSWORD }, _this.props.history, "Reset password");
                }
            };
            var signUpForm = {
            ...
            if (_this.state.status === constants_1.SIGN_IN_AND_UP_STATUS.LOADING) {
                return React.createElement(react_1.Fragment, null);
            }
            /*
             * Render.
             */
            return (React.createElement(featureWrapper_1.default, { useShadowDom: useShadowDom },
                React.createElement(react_1.Fragment, null,
                    _this.props.children === undefined && (React.createElement(__1.SignInAndUpTheme, { defaultToSignUp: signInAndUpFeature.defaultToSignUp, signInForm: signInForm, signUpForm: signUpForm })),
        ...
        _this.state = {
            status: constants_1.SIGN_IN_AND_UP_STATUS.LOADING
        };
        return _this;
    }
    SignInAndUp.prototype.setStateOnSuccessfulAPICall = function (normalisedAPIResponse) {
        this.setState(function (oldState) {
            if (oldState.status !== constants_1.SIGN_IN_AND_UP_STATUS.READY ||
                normalisedAPIResponse.status !== constants_1.FORM_BASE_API_RESPONSE.OK ||
                normalisedAPIResponse.user === undefined) {
                return oldState;
            }
            return {
                status: constants_1.SIGN_IN_AND_UP_STATUS.SUCCESSFUL,
                user: {
    ...
    SignInAndUp.prototype.getThemeSignUpFeatureFormFields = function (formFields) {
        ...
        return formFields.map(function (field) { return (__assign({}, field, { showIsRequired: (function () {
                ...
                if (field.id !== constants_1.MANDATORY_FORM_FIELDS_ID.EMAIL) {
                ...
                return function (value) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                _a.trys.push([2, 4, , 5]);
                                return [4 /*yield*/, api_1.emailExistsAPI(value, this.getRecipeInstanceOrThrow())];
