...
function signUpAPI(formFields, recipe) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, recipe.httpRequest.post("/signup", {
...
function signInAPI(formFields, recipe) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, recipe.httpRequest.post("/signin", {
                        body: JSON.stringify({ formFields: formFields }),
                    }, "SIGN_IN")];
                case 1:
                    response = _a.sent();
...
function emailExistsAPI(email, recipe) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, recipe.httpRequest.get("/signup/email/exists", {}, "EMAIL_EXISTS", {
                        email: email,
                    })];
                case 1:
                    response = _a.sent();
