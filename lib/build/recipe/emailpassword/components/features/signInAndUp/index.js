...
var SignInAndUp = /** @class */ (function(_super) {
    ...
    function SignInAndUp(props) {
                        ...
                        case 0:
                            return [
                                ...
                                utils_1.validateForm(
                                    formFields,
                                    emailPassword_1.default.getInstanceOrThrow().config.signInAndUpFeature.signInForm
                                        .formFields
                                )
                            ];
                        case 1:
                            ...
                            return [
                                4 /*yield*/,
                                api_1.signInAPI(formFields, emailPassword_1.default.getInstanceOrThrow())
                            ];
                        case 2:
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            emailPassword_1.default.getInstanceOrThrow().hooks.onHandleEvent({
                                action: "SUCCESS",
                                isNewUser: false,
                            ...
                            return [
                                4 /*yield*/,
                                emailPassword_1.default.getInstanceOrThrow().redirect(
                                    {
                                        action: "SUCCESS",
                                        isNewUser: false,
                    ...
                    switch (_a.label) {
                        case 0:
                            return [
                                ...
                                utils_1.validateForm(
                                    formFields,
                                    emailPassword_1.default.getInstanceOrThrow().config.signInAndUpFeature.signUpForm
                                        .formFields
                                )
                            ];
                        case 1:
                            ...
                            return [
                                4 /*yield*/,
                                api_1.signUpAPI(formFields, emailPassword_1.default.getInstanceOrThrow())
                            ];
                        case 2:
                            normalisedAPIResponse = _a.sent();
                            this.setStateOnSuccessfulAPICall(normalisedAPIResponse);
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (emailPassword_1.default.getInstanceOrThrow().isEmailVerificationRequired() === true) {
                            ...
                            return [
                                4 /*yield*/,
                                emailPassword_1.default.getInstanceOrThrow().redirect(context, this.props.history)
                            ];
                        case 1:
                            return [2 /*return*/, _a.sent()];
                    }
        ...
        _this.componentDidMount = function() {
            return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            sessionExists = emailPassword_1.default.getInstanceOrThrow().doesSessionExist();
                            ...
                            return [
                                4 /*yield*/,
                                emailPassword_1.default
                                    .getInstanceOrThrow()
                                    .redirect({ action: "SUCCESS", isNewUser: false }, this.props.history)
                            ];
                        case 1:
                            return [2 /*return*/, _a.sent()];
                        case 2:
        ...
        _this.render = function() {
            var signInAndUpFeature = emailPassword_1.default.getInstanceOrThrow().config.signInAndUpFeature;
            ...
            var signInForm = {
                ...
                forgotPasswordClick: function() {
                    return emailPassword_1.default
                        .getInstanceOrThrow()
                        .redirect({ action: "RESET_PASSWORD" }, _this.props.history);
                }
            };
            var signUpForm = {
            ...
            var useShadowDom = emailPassword_1.default.getInstanceOrThrow().config.useShadowDom;
                ...
                react_1.jsx(
                    ...
                    _this.props.children === undefined &&
                        react_1.jsx(__1.SignInAndUpTheme, {
                            rawPalette: emailPassword_1.default.getInstanceOrThrow().config.palette,
                            ...
                            return __generator(this, function(_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        return [
                                            4 /*yield*/,
                                            api_1.emailExistsAPI(value, emailPassword_1.default.getInstanceOrThrow())
                                        ];
                                    case 3:
                                        return [2 /*return*/, _a.sent()];
                                    case 4:
