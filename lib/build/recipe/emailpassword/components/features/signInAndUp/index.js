...
var SignInAndUp = /** @class */ (function (_super) {
    ...
    function SignInAndUp(props) {
        ...
        _this.getModifiedRecipeImplementation = function () {
            return __assign({}, _this.props.recipeImplemetation, { signIn: function (formFields, preApiHook) { return __awaiter(_this, void 0, void 0, function () {
                    var response;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.props.recipeImplemetation.signIn(formFields, preApiHook)];
                            case 1:
                                response = _a.sent();
                                this.setState(function (oldState) {
                ...
                }); }, signUp: function (formFields, preAPIHook) { return __awaiter(_this, void 0, void 0, function () {
                    var response;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.props.recipeImplemetation.signUp(formFields, preAPIHook)];
                            case 1:
                                response = _a.sent();
                                this.setState(function (oldState) {
                                    return (oldState.status !== "READY" || response.status !== "OK") ? oldState : {
                ...
                return function (value) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                _a.trys.push([2, 4, , 5]);
                                return [4 /*yield*/, this.props.recipeImplemetation.doesEmailExist(value)];
                            case 3:
                                emailExists = _a.sent();
                                if (emailExists) {
