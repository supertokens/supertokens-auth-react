...
var getModifiedEmailPasswordRecipeImplementation = function (origImpl) {
...
function useChildProps(recipe, state, dispatch, history) {
    ...
    var recipeImplementation = react_3.useMemo(
        function () {
            return recipe && getModifiedEmailPasswordRecipeImplementation(recipe.recipeImpl);
        },
        [recipe]
    );
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, recipe.emailVerification.isEmailVerified()];
                        case 2:
...
function getThemeSignUpFeatureFormFields(formFields, recipe) {
    var _this = this;
