...
var SignInAndUp = /** @class */ (function (_super) {
    ...
    function SignInAndUp(props) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                this.getRecipeInstanceOrThrow().emailVerification.redirect(
                                    {
                                        action: "VERIFY_EMAIL",
                                    },
                                    this.props.history
        ...
        _this.getModifiedRecipeImplementation = function () {
            return __assign({}, _this.props.recipeImplemetation, {
                signIn: function (formFields, preApiHook) {
                    return __awaiter(_this, void 0, void 0, function () {
                        var response;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, this.props.recipeImplemetation.signIn(formFields, preApiHook)];
                                case 1:
                                    response = _a.sent();
                                    this.setState(function (oldState) {
                ...
                signUp: function (formFields, preAPIHook) {
                    return __awaiter(_this, void 0, void 0, function () {
                        var response;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, this.props.recipeImplemetation.signUp(formFields, preAPIHook)];
                                case 1:
                                    response = _a.sent();
                                    this.setState(function (oldState) {
                                        return oldState.status !== "READY" || response.status !== "OK"
