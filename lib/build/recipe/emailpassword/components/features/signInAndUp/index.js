                ...
                signIn: function (formFields, preApiHook) {
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, this.props.recipe.recipeImpl.signIn(formFields, preApiHook)];
                                case 1:
                                    response = _a.sent();
                                    this.setState(function (oldState) {
                ...
                signUp: function (formFields, preAPIHook) {
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, this.props.recipe.recipeImpl.signUp(formFields, preAPIHook)];
                                case 1:
                                    response = _a.sent();
                                    this.setState(function (oldState) {
                                        return oldState.status !== "READY" || response.status !== "OK"
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        return [
                                            4 /*yield*/,
                                            this.props.recipe.recipeImpl.doesEmailExist(value, {
