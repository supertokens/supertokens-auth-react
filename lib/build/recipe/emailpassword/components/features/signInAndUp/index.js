    ...
    function SignInAndUp(props) {
        ...
        _this.signIn = function (formFields) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.validateForm(formFields, this.getRecipeInstanceOrThrow().config.signInAndUpFeature.signInForm.formFields)];
                    case 1:
        ...
        _this.signUp = function (formFields) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, utils_1.validateForm(formFields, this.getRecipeInstanceOrThrow().config.signInAndUpFeature.signUpForm.formFields)];
                    case 1:
                        validationErrors = _a.sent();
                        // If errors, return.
                        if (validationErrors.length > 0) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.getRecipeInstanceOrThrow().emailVerification.config.mode === "REQUIRED")) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().emailVerification.redirect({
                                action: "VERIFY_EMAIL",
                            }, this.props.history)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2: return [4 /*yield*/, this.getRecipeInstanceOrThrow().redirect({
                            redirectToPath: utils_1.getRedirectToPathFromURL(),
                            isNewUser: true,
                            action: "SUCCESS",
                        }, this.props.history)];
        ...
        _this.render = function () {
            ...
            return (react_1.jsx(featureWrapper_1.default, { useShadowDom: _this.getRecipeInstanceOrThrow().config.useShadowDom, isEmbedded: _this.getIsEmbedded() },
                react_1.jsx(react_2.Fragment, null,
                    _this.props.children === undefined && (react_1.jsx(__1.SignInAndUpTheme, { rawPalette: _this.getRecipeInstanceOrThrow().config.palette, defaultToSignUp: signInAndUpFeature.defaultToSignUp, signInForm: signInForm, signUpForm: signUpForm })),
