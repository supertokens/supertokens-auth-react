        ...
        _this.signIn = /*#__PURE__*/ (function() {
            var _ref = _asyncToGenerator(
                /*#__PURE__*/ regeneratorRuntime.mark(function _callee(formFields) {
                    var validationErrors, _yield$handleSignInAP, normalisedAPIResponse, responseJson, user;
                    ...
                    return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                            switch ((_context.prev = _context.next)) {
                                ...
                                case 7:
                                    _yield$handleSignInAP = _context.sent;
                                    normalisedAPIResponse = _yield$handleSignInAP.normalisedAPIResponse;
                                    responseJson = _yield$handleSignInAP.responseJson;
                                    ...
                                    if (responseJson !== undefined && responseJson.user !== undefined) {
                                        ...
                                        _this.setState(function() {
                                            return {
                                                status: _types.SignInAndUpStateStatus.SUBMITTED,
                                                user: user,
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch ((_context2.prev = _context2.next)) {
                            case 0:
                                if (!(_this.state.status !== _types.SignInAndUpStateStatus.SUBMITTED)) {
                                    _context2.next = 2;
                                    break;
                                }
        ...
        _this.signUp = /*#__PURE__*/ (function() {
            var _ref3 = _asyncToGenerator(
                /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(formFields) {
                    var validationErrors, _yield$handleSignUpAP, normalisedAPIResponse, responseJson, user;
                    ...
                    return regeneratorRuntime.wrap(function _callee3$(_context3) {
                        while (1) {
                            switch ((_context3.prev = _context3.next)) {
                                ...
                                case 7:
                                    _yield$handleSignUpAP = _context3.sent;
                                    normalisedAPIResponse = _yield$handleSignUpAP.normalisedAPIResponse;
                                    responseJson = _yield$handleSignUpAP.responseJson;
                    ...
                    while (1) {
                        switch ((_context8.prev = _context8.next)) {
                            ...
                            case 7:
                                _this.setState(function() {
                                    return {
                                        status: _types.SignInAndUpStateStatus.NOT_SUBMITTED
                                    };
                                });
