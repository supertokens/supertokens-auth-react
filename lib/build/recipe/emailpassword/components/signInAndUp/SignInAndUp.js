...
function SignInAndUp(props) {
    ...
    var signInAPI = /*#__PURE__*/ (function() {
        var _ref = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee(formFields) {
                var validationErrors, headers, result, _user;
                    ...
                    function _callee$(_context) {
                        while (1) {
                            switch ((_context.prev = _context.next)) {
                                case 0:
                                    _context.next = 2;
                                    return getRecipeInstanceOrThrow().signInValidate(formFields);
                                ...
                                case 14:
                                    if (!(result.status === _constants.API_RESPONSE_STATUS.WRONG_CREDENTIALS_ERROR)) {
                                        _context.next = 16;
                                        break;
                                    }
    ...
    var signUpAPI = /*#__PURE__*/ (function() {
        var _ref3 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(formFields) {
                var validationErrors, headers, result, _yield$result$json, data, _user2;
                    ...
                    function _callee3$(_context3) {
                        while (1) {
                            switch ((_context3.prev = _context3.next)) {
                                case 0:
                                    _context3.next = 2;
                                    return getRecipeInstanceOrThrow().signUpValidate(formFields);
                                ...
                                case 12:
                                    _yield$result$json = _context3.sent;
                    ...
                    while (1) {
                        switch ((_context6.prev = _context6.next)) {
                            ...
                            case 6:
                                ...
                                resetPasswordUrl = getRecipeInstanceOrThrow().getConfig().signInAndUpFeature.signInForm
                                    .resetPasswordURL;
                        ...
                        while (1) {
                            switch ((_context7.prev = _context7.next)) {
                                ...
                                case 6:
                                    ...
                                    onSuccessRedirectURL = getRecipeInstanceOrThrow().getConfig().signInAndUpFeature
    ...
    var signUpFeature = getRecipeInstanceOrThrow().getConfig().signInAndUpFeature.signUpForm;
    var signInFeature = getRecipeInstanceOrThrow().getConfig().signInAndUpFeature.signInForm;
    var defaultStyles = (0, _styles.getDefaultStyles)(getRecipeInstanceOrThrow().getConfig().palette);
    var palette = getRecipeInstanceOrThrow().getConfig().palette;
    var signInForm = {
