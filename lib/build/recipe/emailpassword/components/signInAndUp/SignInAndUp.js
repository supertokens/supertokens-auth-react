    ...
    _createClass(SignInAndUp, [
        ...
        },
        {
            ...
            value: function setStateOnSuccessfulAPICall(normalisedAPIResponse) {
                ...
                if (normalisedAPIResponse.status === _constants.API_RESPONSE_STATUS.OK && normalisedAPIResponse.user) {
                    user = {
                ...
                this.setState(function(oldState) {
                    if (oldState.status !== _types.SignInAndUpStateStatus.NOT_SUBMITTED) {
                        return oldState;
                    }
