                    ...
                    while (1) {
                        switch ((_context.prev = _context.next)) {
                            ...
                            case 7:
                                ...
                                return _context.abrupt("return", _objectSpread({}, responseJson));
                ...
                function _callee2$(_context2) {
                    while (1) {
                        switch ((_context2.prev = _context2.next)) {
                            ...
                            case 7:
                                if (
                                    !(responseJson.status === _constants2.API_RESPONSE_STATUS.WRONG_CREDENTIALS_ERROR)
                                ) {
                                    _context2.next = 9;
                                    break;
                                }
                            ...
                            case 9:
                                ...
                                return _context2.abrupt("return", _objectSpread({}, responseJson));
