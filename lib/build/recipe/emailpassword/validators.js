...
exports.defaultSignUpEmailValidator = defaultSignUpEmailValidator;
...
function defaultSignUpEmailValidator(_x2) {
    return _defaultSignUpEmailValidator.apply(this, arguments);
}
/*
...
function _defaultSignUpEmailValidator() {
    _defaultSignUpEmailValidator = _asyncToGenerator(
                ...
                while (1) {
                    switch ((_context2.prev = _context2.next)) {
                        case 0:
                            ...
                            return _context2.abrupt("return", "Email must be of type string");

                        case 2:
                            _context2.next = 4;
                            return defaultEmailValidator(value);

                        case 4:
                            defaultError = _context2.sent;
                            ...
                            return _context2.abrupt("return", defaultError);

                        case 7:
                            _context2.next = 9;
                            return _emailPassword["default"].verifyEmailExists(value);
...
function defaultPasswordValidator(_x3) {
                ...
                while (1) {
                    switch ((_context3.prev = _context3.next)) {
                        ...
                        case 4:
                            ...
                            return _context3.abrupt("return", "Password's length must be lesser than 100 characters");
                        ...
                        case 6:
                            ...
                            return _context3.abrupt("return", "Password must contain at least one alphabet");
                        ...
                        case 8:
                            ...
                            return _context3.abrupt("return", "Password must contain at least one number");
...
function defaultLoginPasswordValidator(_x4) {
                ...
                while (1) {
                    switch ((_context4.prev = _context4.next)) {
                        case 0:
                            ...
                            return _context4.abrupt("return", "Password must be of type string");
...
function _defaultValidate() {
    _defaultValidate = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(_) {
