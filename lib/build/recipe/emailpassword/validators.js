    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (value.match(defaultEmailValidatorRegexp) === null) {
                return [2 /*return*/, "Email is invalid"];
            }
...
function defaultPasswordValidator(value) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (typeof value !== "string") {
                return [2 /*return*/, "Password must be of type string"];
            }
            // length >= 8 && < 100
            // must have a number and a character
            // as per https://github.com/supertokens/supertokens-auth-react/issues/5#issuecomment-709512438
            if (value.length < 8) {
                return [2 /*return*/, "Password must contain at least 8 characters, including a number"];
            }
            if (value.length >= 100) {
                return [2 /*return*/, "Password's length must be lesser than 100 characters"];
            }
            if (value.match(/^.*[A-Za-z]+.*$/) === null) {
                return [2 /*return*/, "Password must contain at least one alphabet"];
            }
            if (value.match(/^.*[0-9]+.*$/) === null) {
                return [2 /*return*/, "Password must contain at least one number"];
            }
            return [2 /*return*/, undefined];
        });
    });
