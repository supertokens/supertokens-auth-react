...
var EmailPassword = /** @class */ (function (_super) {
    ...
    function EmailPassword(config, recipeImpl) {
        if (recipeImpl === void 0) {
            recipeImpl = emailpassword_1.default;
        }
    ...
    EmailPassword.init = function (config) {
        var normalisedConfig = (0, utils_2.normaliseEmailPasswordConfig)(config);
        return {
            authReact: function (appInfo) {
                EmailPassword.instance = new EmailPassword(
                    __assign(__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: EmailPassword.RECIPE_ID })
                );
                return EmailPassword.instance;
            },
            webJS: emailpassword_1.default.init(
