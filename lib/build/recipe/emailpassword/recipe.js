...
var EmailPassword = /** @class */ (function (_super) {
    ...
    function EmailPassword(config) {
        var _this = _super.call(this, utils_2.normaliseEmailPasswordConfig(config)) || this;
        _this.getFeatures = function () {
            ...
            if (_this.config.resetPasswordUsingTokenFeature.disableDefaultImplementation !== true) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(new normalisedURLPath_1.default(constants_1.DEFAULT_RESET_PASSWORD_PATH));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: utils_1.matchRecipeIdUsingQueryParams(_this.config.recipeId),
                    rid: _this.config.recipeId,
        ...
        _this.recipeImpl = new recipeImplementation_1.default(_this.config);
        return _this;
    }
    /*
     * Static methods.
