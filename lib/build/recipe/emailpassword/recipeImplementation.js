                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsRecipe.recipeImplementation.submitNewPassword({
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsRecipe.recipeImplementation.sendPasswordResetEmail({
                                    config: webJsRecipe.config,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsRecipe.recipeImplementation.signUp({
                                    config: webJsRecipe.config,
                                    formFields: input.formFields,
                                    userContext: input.userContext,
                                }),
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsRecipe.recipeImplementation.signIn({
                                    config: webJsRecipe.config,
                                    formFields: input.formFields,
                                    userContext: input.userContext,
                                }),
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsRecipe.recipeImplementation.doesEmailExist({
                                    config: webJsRecipe.config,
                                    email: input.email,
                                    userContext: input.userContext,
                                }),
