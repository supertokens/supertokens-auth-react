                                ...
                                querier.post(
                                    ...
                                    function (context) {
                                        return input.config.preAPIHook(
                                            __assign(__assign({}, context), { action: "SUBMIT_NEW_PASSWORD" })
                                        );
                                    }
                                ),
                            ];
                        ...
                        case 1:
                            ...
                            return [
                                ...
                                querier.post(
                                    ...
                                    function (context) {
                                        return input.config.preAPIHook(
                                            __assign(__assign({}, context), { action: "SEND_RESET_PASSWORD_EMAIL" })
                                        );
                                    }
                                ),
                            ];
                        ...
                        case 1:
                            ...
                            return [
                                ...
                                querier.post(
                                    ...
                                    function (context) {
                                        return input.config.preAPIHook(
                                            __assign(__assign({}, context), { action: "EMAIL_PASSWORD_SIGN_UP" })
                                        );
                                    }
                                ),
                            ];
                        ...
                        case 1:
                            ...
                            return [
                                ...
                                querier.post(
                                    ...
                                    function (context) {
                                        return input.config.preAPIHook(
                                            __assign(__assign({}, context), { action: "EMAIL_PASSWORD_SIGN_IN" })
                                        );
                                    }
                                ),
                            ];
