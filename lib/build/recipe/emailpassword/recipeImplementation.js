...
var RecipeImplementation = /** @class */ (function () {
    function RecipeImplementation(config) {
        var _this = this;
        this.submitNewPassword = function (formFields, token, preAPIHook) {
        ...
        this.sendPasswordResetEmail = function (formFields, preAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var validationErrors, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        this.signUp = function (formFields, preAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var validationErrors, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                utils_1.validateForm(formFields, this.config.signInAndUpFeature.signUpForm.formFields),
                            ];
                        case 1:
                            validationErrors = _a.sent();
                            if (validationErrors.length > 0) {
        ...
        this.signIn = function (formFields, preAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var validationErrors, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                utils_1.validateForm(formFields, this.config.signInAndUpFeature.signInForm.formFields),
                            ];
                        case 1:
                            validationErrors = _a.sent();
                            if (validationErrors.length > 0) {
        ...
        this.doesEmailExist = function (email, preAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                this.querier.get("/signup/email/exists", {}, { email: email }, preAPIHook),
                            ];
                        case 1:
                            response = _a.sent();
