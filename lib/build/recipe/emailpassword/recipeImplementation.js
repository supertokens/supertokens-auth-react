...
function getRecipeImplementation(webJsImplementation, authReactConfig) {
    return {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.submitNewPassword({
                                    config: input.config,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.sendPasswordResetEmail({
                                    config: input.config,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsImplementation.doesEmailExist({
                                    config: input.config,
                                    email: input.email,
                                    userContext: input.userContext,
                                }),
