...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.redirectToAuth = function (show) {
        return recipe_1.default.getInstanceOrThrow().redirectToAuthWithRedirectToPath(show);
    };
    Wrapper.EmailPasswordAuth = emailPasswordAuth_1.default;
    Wrapper.SignInAndUp = recipe_1.default.getInstanceOrThrow().getFeatureComponent("signinup");
    Wrapper.SignInAndUpTheme = signInAndUp_1.default;
    Wrapper.ResetPasswordUsingToken = recipe_1.default.getInstanceOrThrow().getFeatureComponent("resetpassword");
    Wrapper.ResetPasswordUsingTokenTheme = resetPasswordUsingToken_1.default;
    Wrapper.EmailVerification = recipe_1.default.getInstanceOrThrow().getFeatureComponent("emailverification");
