...
export declare class MultiFactorAuthClaimClass {
    ...
    readonly getValueFromPayload: (payload: any, _userContext?: UserContext) => {
        c: Record<string, number | undefined>;
        v: boolean;
    } | undefined;
    validators: Omit<MultiFactorAuthClaimClassWebJS["validators"], "hasCompletedMFARequirementsForAuth" | "hasCompletedFactors"> & {
        hasCompletedMFARequirementsForAuth: (doRedirection?: boolean, showAccessDeniedOnFailure?: boolean) => SessionClaimValidator;
    ...
    }, userContext: UserContext) => Promise<string | undefined>, onFailureRedirection?: ValidationFailureCallback);
}
