...
export declare function getAvailableFactors(factors: MFAFactorInfo, nextArrayQueryParam: string | undefined, recipe: MultiFactorAuth, userContext: UserContext): import("./types").SecondaryFactorRedirectionInfo[];
