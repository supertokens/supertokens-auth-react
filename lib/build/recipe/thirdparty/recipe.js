...
var ThirdParty = /** @class */ (function (_super) {
    ...
    function ThirdParty(config, recipeImpl) {
        if (recipeImpl === void 0) {
            recipeImpl = thirdparty_1.default;
        }
        var _this = _super.call(this, (0, utils_2.normaliseThirdPartyConfig)(config)) || this;
        _this.recipeImpl = recipeImpl;
        /*
         * Instance methods.
         */
    ...
    ThirdParty.init = function (config) {
        return {
            ...
            webJS: thirdparty_1.default.init(
