...
var ThirdParty = /** @class */ (function (_super) {
    ...
    function ThirdParty(config) {
        ...
        _this.getFeatureComponent = function (componentName, prop) {
            if (componentName === "signinup") {
                return react_1.default.createElement(
                    ...
                    __assign({ recipeId: _this.config.recipeId, recipeImplementation: _this.recipeImpl }, prop)
                );
        ...
        _this.recipeImpl = _this.config.override.functions(new recipeImplementation_1.default(_this.config));
        return _this;
    }
    /*
     * Static methods.
