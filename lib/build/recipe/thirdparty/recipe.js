...
var recipe_1 = __importDefault(require("supertokens-web-js/lib/build/recipe/thirdparty/recipe"));
/*
 * Class.
 */
var ThirdParty = /** @class */ (function (_super) {
    ...
    function ThirdParty(config, recipes) {
        ...
        _this.webJsRecipe = new recipe_1.default(
            {
            ...
            {
                emailVerification:
                    (_a = recipes.emailVerificationInstance) === null || _a === void 0 ? void 0 : _a.webJsRecipe,
            }
        );
