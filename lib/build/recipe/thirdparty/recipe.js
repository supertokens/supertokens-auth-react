    ...
    function ThirdParty(config) {
        ...
        _this.getFeatures = function () {
            ...
            _this.config.signInAndUpFeature.providers.forEach(function (provider) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    component: function () {
                        return _this.getFeatureComponent("signinupcallback");
                    },
                };
            });
        ...
        _this.getFeatureComponent = function (componentName) {
            if (componentName === "signinup") {
                return react_1.default.createElement(signInAndUp_1.default, { recipeId: _this.config.recipeId });
            } else if (componentName === "signinupcallback") {
                return react_1.default.createElement(signInAndUpCallback_1.default, {
    ...
    ThirdParty.init = function (config) {
        return function (appInfo) {
            ThirdParty.instance = new ThirdParty(
                __assign({}, config, { appInfo: appInfo, recipeId: ThirdParty.RECIPE_ID })
            );
