    ...
    function ThirdParty(config, recipes) {
        ...
        _this.getFeatureComponent = function (componentName, props) {
            if (componentName === "signinup") {
                ...
                return react_1.default.createElement(usercontext_1.UserContextContext.Consumer, null, function (value) {
                    return react_1.default.createElement(
                        signInAndUpCallback_1.default,
                        __assign({ recipe: _this }, __assign(__assign({}, props), { userContext: value }))
                    );
                });
            } else {
        ...
        var builder = new supertokens_js_override_1.default(recipeImplementation_1.default(_this.config));
