...
var ThirdParty = /** @class */ (function (_super) {
    ...
    function ThirdParty(config) {
        var _this = _super.call(this, utils_2.normaliseThirdPartyConfig(config)) || this;
        /*
         * Instance methods.
         */
        _this.getFeatures = function () {
            ...
            _this.config.signInAndUpFeature.providers.forEach(function (provider) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    rid: _this.config.recipeId,
                    matches: utils_2.matchRecipeIdUsingState(_this.config.recipeId),
                };
            });
    ...
    ThirdParty.init = function (config) {
        return function (appInfo) {
            ThirdParty.instance = new ThirdParty(__assign({}, config, { appInfo: appInfo, recipeId: ThirdParty.RECIPE_ID }));
