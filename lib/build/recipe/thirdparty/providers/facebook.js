...
var Facebook = /** @class */ (function (_super) {
    ...
    function Facebook(config) {
        ...
        _this.getLogo = function () {
            return (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "7.956", height: "17.259", viewBox: "0 0 7.956 17.259" },
                react_1.default.createElement("g", null,
                    react_1.default.createElement("g", null,
                        react_1.default.createElement("path", { fill: "#fff", d: "M45.448 30.376h-2.36v8.646h-3.575v-8.646h-1.7v-3.039h1.7v-1.966a3.353 3.353 0 0 1 3.607-3.608l2.649.011v2.949h-1.922a.728.728 0 0 0-.758.828v1.789h2.671z", transform: "translate(-6.349 -3.492) translate(6.349 3.492) translate(-37.812 -21.763)" })))));
        };
        if (config === undefined) {
            return _this;
        }
