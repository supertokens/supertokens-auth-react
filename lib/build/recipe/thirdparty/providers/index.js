...
var Provider = /** @class */ (function() {
    ...
    Provider.prototype.getRedirectURI = function() {
        var domain = thirdparty_1.default.getInstanceOrThrow().appInfo.websiteDomain.getAsStringDangerous();
        var callbackPath = new normalisedURLPath_1.default("/callback/" + this.id);
        var path = thirdparty_1.default
            .getInstanceOrThrow()
