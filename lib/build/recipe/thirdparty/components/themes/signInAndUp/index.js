 ...
 * Component.
 */
var SignInAndUpProvidersTheme = /** @class */ (function(_super) {
    __extends(SignInAndUpProvidersTheme, _super);
    /*
     * Constructor
     */
    function SignInAndUpProvidersTheme(props) {
        var _this = _super.call(this, props) || this;
        _this.signInClick = function(providerId) {
            return __awaiter(_this, void 0, void 0, function() {
                var generalError_1, e_1;
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            generalError_1 = _a.sent();
                            if (generalError_1 !== undefined) {
                                this.setState(function() {
                                    return {
                                        status: "GENERAL_ERROR",
                                        generalError: generalError_1
                                    };
                                });
                            }
                            return [3 /*break*/, 3];
        ...
        _this.render = function() {
            ...
            return react_1.jsx(
                react_2.Fragment,
                null,
                _this.state.status === "GENERAL_ERROR" &&
                    react_1.jsx(
                        "div",
                        { "data-supertokens": "generalError", css: styles.generalError },
                        _this.state.generalError
                    ),
                _this.props.providers.map(function(provider) {
                    return react_1.jsx(
                        ...
                        react_1.jsx(
                            ...
                            {
                                onClick: function() {
                                    return _this.signInClick(provider.id);
                                }
                            },
    ...
    SignInAndUpProvidersTheme.contextType = styleContext_1.default;
    return SignInAndUpProvidersTheme;
})(react_2.PureComponent);
exports.SignInAndUpProvidersTheme = SignInAndUpProvidersTheme;
    ...
    return react_1.jsx(
        ...
        react_1.jsx(
            ...
            react_1.jsx(
                ...
                react_1.jsx(SignInAndUpProvidersTheme, __assign({}, props)),
