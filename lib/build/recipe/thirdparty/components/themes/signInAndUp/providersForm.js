...
exports.ThirdPartySignInAndUpProvidersForm = function (props) {
    ...
    var _a = react_2.useState(props.error),
        error = _a[0],
        setError = _a[1];
    react_2.useEffect(
        function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            props.recipeImplementation.redirectToThirdPartyLogin({
    ...
    return react_1.jsx(
        react_2.Fragment,
        null,
        error !== undefined ? react_1.jsx(generalError_1.default, { error: error }) : null,
