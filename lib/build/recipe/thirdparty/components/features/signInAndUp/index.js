...
var SignInAndUp = /** @class */ (function(_super) {
    ...
    function SignInAndUp(props) {
        ...
        _this.componentDidMount = function() {
            return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            sessionExists = thirdparty_1.default.getInstanceOrThrow().doesSessionExist();
                            if (!sessionExists) return [3 /*break*/, 2];
                            thirdparty_1.default.getInstanceOrThrow().hooks.onHandleEvent({
                                action: "SESSION_ALREADY_EXISTS"
                            });
                            return [
                                4 /*yield*/,
                                thirdparty_1.default
                                    .getInstanceOrThrow()
        ...
        _this.signInAndUpClick = function(providerId) {
            return __awaiter(_this, void 0, void 0, function() {
                var provider, state, url, redirectToPath, urlWithState, expiresAt, value;
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            provider = thirdparty_1.default
                                .getInstanceOrThrow()
                                .config.signInAndUpFeature.providers.find(function(p) {
                            ...
                            return [
                                4 /*yield*/,
                                api_1.getOAuthAuthorisationURLAPI(
                                    provider.id,
                                    thirdparty_1.default.getInstanceOrThrow()
                                )
                            ];
                        case 1:
                            url = _a.sent().url;
                            redirectToPath = utils_1.getRedirectToPathFromURL();
                            urlWithState = utils_1.appendQueryParamsToURL(url, { state: state });
                            expiresAt = Date.now() + 1000 * 60 * 10;
                            value = JSON.stringify({
                                redirectToPath: redirectToPath,
                                state: state,
                                thirdPartyId: provider.id,
                                rid: thirdparty_1.default.getInstanceOrThrow().recipeId,
                                expiresAt: expiresAt
                            });
                            utils_1
                                .getWindowOrThrow()
        ...
        _this.render = function() {
            ...
            var signInAndUpFeature = thirdparty_1.default.getInstanceOrThrow().config.signInAndUpFeature;
            var useShadowDom = thirdparty_1.default.getInstanceOrThrow().config.useShadowDom;
            ...
            return react_1.jsx(
                ...
                react_1.jsx(
                    ...
                    {
                        rawPalette: thirdparty_1.default.getInstanceOrThrow().config.palette,
