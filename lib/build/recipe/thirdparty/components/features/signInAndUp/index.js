    ...
    function SignInAndUp(props) {
        ...
        _this.componentDidMount = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRecipeInstanceOrThrow().doesSessionExist()];
                    case 1:
                        ...
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().redirect({ action: "SUCCESS", isNewUser: false }, this.props.history)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                    case 3:
        ...
        _this.signInAndUpClick = function (providerId) { return __awaiter(_this, void 0, void 0, function () {
            var provider, state, url, redirectToPath, redirect_uri, urlWithState, expiresAt, value;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = this.getRecipeInstanceOrThrow().config.signInAndUpFeature.providers.find(function (p) { return p.id === providerId; });
                        if (provider === undefined) {
                            return [2 /*return*/, "Unknown Provider"];
                        }
                        state = provider.generateState();
                        return [4 /*yield*/, api_1.getOAuthAuthorisationURLAPI(provider.id, this.getRecipeInstanceOrThrow())];
                    case 1:
                        url = (_a.sent()).url;
                        redirectToPath = utils_1.getRedirectToPathFromURL();
                        return [4 /*yield*/, this.getRecipeInstanceOrThrow().getRedirectUrl({
                    ...
                    case 2:
                        ...
                        utils_1.getWindowOrThrow().sessionStorage.setItem(constants_1.SESSION_STORAGE_STATE_KEY, value);
        ...
        _this.render = function () {
            ...
            var providers = signInAndUpFeature.providers.map(function (provider) { return ({
                id: provider.id,
             ...
             * Render.
             */
            return (react_1.jsx(featureWrapper_1.default, { useShadowDom: _this.getRecipeInstanceOrThrow().config.useShadowDom, isEmbedded: _this.getIsEmbedded() },
                react_1.jsx(styleContext_1.StyleProvider, { rawPalette: _this.getRecipeInstanceOrThrow().config.palette, defaultPalette: styles_1.defaultPalette, styleFromInit: signInAndUpFeature.style, getDefaultStyles: styles_2.getStyles },
                    react_1.jsx(react_2.Fragment, null,
                        _this.props.children === undefined &&
                            (_this.state.status === "CUSTOM_ERROR" ? (react_1.jsx(__1.SignInAndUpTheme, { status: _this.state.status, error: _this.state.error, providers: providers, signInAndUpClick: _this.signInAndUpClick, privacyPolicyLink: signInAndUpFeature.privacyPolicyLink, termsOfServiceLink: signInAndUpFeature.termsOfServiceLink })) : (react_1.jsx(__1.SignInAndUpTheme, { status: _this.state.status, providers: providers, signInAndUpClick: _this.signInAndUpClick, privacyPolicyLink: signInAndUpFeature.privacyPolicyLink, termsOfServiceLink: signInAndUpFeature.termsOfServiceLink }))),
                        _this.props.children &&
                            React.cloneElement(_this.props.children, {
                                status: _this.state.status,
                                error: _this.state.status === "CUSTOM_ERROR" ? _this.state.error : undefined,
