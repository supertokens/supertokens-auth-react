    ...
    function SignInAndUpCallback() {
        ...
        _this.componentDidMount = function () {
            return __awaiter(_this, void 0, void 0, function () {
                var response, stateResponse, redirectToPath, isEmailVerified, ignored_1, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                ...
                                this.props.recipe.recipeImpl.signInAndUp({
                                    userContext: utils_1.getNormalisedUserContext(this.props.userContext),
                                }),
                            ];
                        case 1:
                            response = _a.sent();
                            ...
                            stateResponse = this.props.recipe.recipeImpl.getStateAndOtherInfoFromStorage({
                                userContext: utils_1.getNormalisedUserContext(this.props.userContext),
                            });
                        ...
                        case 2:
                            ...
                            return [
                                4 /*yield*/,
                                this.props.recipe.emailVerification.isEmailVerified(
                                    utils_1.getNormalisedUserContext(this.props.userContext)
                                ),
                            ];
                        case 3:
            ...
            return react_1.jsx(
                ...
                react_1.jsx(
                    featureWrapper_1.default,
                    {
                        ...
                        userContext: _this.props.userContext,
                    },
                    react_1.jsx(
