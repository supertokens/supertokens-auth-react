...
var SignInAndUpCallback = /** @class */ (function (_super) {
    ...
    function SignInAndUpCallback() {
        ...
        _this.componentDidMount = function () { return __awaiter(_this, void 0, void 0, function () {
            var providerId, oauthCallbackError, code, provider, redirectUrl, response, stateObject, redirectToPath, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        providerId = utils_1.getWindowOrThrow().location.pathname.split("/")[utils_1.getWindowOrThrow().location.pathname.split("/").length - 1];
                        oauthCallbackError = this.getOAuthCallbackError(providerId);
                        if (oauthCallbackError !== undefined) {
                            return [2 /*return*/, this.getRecipeInstanceOrThrow().redirectToAuthWithoutRedirectToPath(undefined, this.props.history, {
                    ...
                    case 2:
                        redirectUrl = _a.sent();
                        return [4 /*yield*/, api_1.signInAndUpAPI(providerId, code, this.getRecipeInstanceOrThrow(), redirectUrl)];
                    case 3:
                        response = _a.sent();
                        ...
                        if (response.status === "OK") {
                            ...
                            stateObject = utils_2.getOAuthState();
                            redirectToPath = stateObject === undefined ? undefined : stateObject.redirectToPath;
                            return [2 /*return*/, this.getRecipeInstanceOrThrow().redirect({ action: "SUCCESS", isNewUser: response.createdNewUser, redirectToPath: redirectToPath }, this.props.history)];
                        }
                        return [3 /*break*/, 5];
                    case 4:
                        e_1 = _a.sent();
        ...
        _this.render = function () {
            ...
            return (react_1.jsx(featureWrapper_1.default, { useShadowDom: _this.getRecipeInstanceOrThrow().config.useShadowDom, isEmbedded: _this.getIsEmbedded() },
                react_1.jsx(styleContext_1.StyleProvider, { rawPalette: _this.getRecipeInstanceOrThrow().config.palette, defaultPalette: styles_1.defaultPalette, getDefaultStyles: styles_2.getStyles },
