...
var SignInAndUpCallback = /** @class */ (function (_super) {
    ...
    function SignInAndUpCallback() {
        ...
        _this.componentDidMount = function () {
            return __awaiter(_this, void 0, void 0, function () {
                var userContext, response, stateResponse, redirectToPath, isEmailVerified, ignored_1, err_1;
                        ...
                        case 3:
                            ...
                            return [
                                ...
                                this.props.recipe.emailVerification.isEmailVerified(
                                    utils_1.getNormalisedUserContext(userContext)
                                ),
                            ];
                        case 4:
    ...
    SignInAndUpCallback.contextType = usercontext_1.UserContextContext;
