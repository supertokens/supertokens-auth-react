    ...
    function SignInAndUpCallback() {
        ...
        _this.componentDidMount = function() {
            return __awaiter(_this, void 0, void 0, function() {
                var providerId, oauthCallbackError, code, response, e_1;
                return __generator(this, function(_a) {
                    switch (_a.label) {
                            ...
                            if (oauthCallbackError !== undefined) {
                                return [
                                    ...
                                    thirdparty_1.default
                                        .getInstanceOrThrow()
                                        .redirect({ action: "SIGN_IN_AND_UP" }, this.props.history, {
                        ...
                        case 1:
                            ...
                            return [
                                4 /*yield*/,
                                api_1.signInAndUpAPI(providerId, code, thirdparty_1.default.getInstanceOrThrow())
                            ];
                        case 2:
                            response = _a.sent();
                            ...
                            if (response.status === "OK") {
                                thirdparty_1.default.getInstanceOrThrow().hooks.onHandleEvent({ action: "SIGN_IN" });
                                return [
                                    2 /*return*/,
                                    thirdparty_1.default
                                        .getInstanceOrThrow()
        ...
        _this.getOAuthCallbackError = function(providerIdFromPath) {
            ...
            var provider = thirdparty_1.default
                .getInstanceOrThrow()
                .config.signInAndUpFeature.providers.find(function(provider) {
                    return provider.id === stateObject.thirdPartyId;
                });
