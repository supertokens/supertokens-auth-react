    ...
    function SignInAndUpCallback() {
        ...
        _this.componentDidMount = function() {
            return __awaiter(_this, void 0, void 0, function() {
                var providerId, oauthCallbackError, code, provider, response, e_1;
                        ...
                        case 2:
                            ...
                            if (response.status === "OK") {
                                if (response.createdNewUser === true) {
                                    thirdparty_1.default
                                        .getInstanceOrThrow()
                                        .hooks.onHandleEvent({ action: "SIGN_IN_COMPLETE" });
                                } else {
                                    thirdparty_1.default
                                        .getInstanceOrThrow()
                                        .hooks.onHandleEvent({ action: "SIGN_UP_COMPLETE" });
                                }
                                return [
                                    2 /*return*/,
                                    thirdparty_1.default
