                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (oauthCallbackError !== undefined) {
                                return [
                                    2 /*return*/,
                                    this.getRecipeInstanceOrThrow().redirectToAuthWithoutRedirectToPath(
                                        undefined,
                                        this.props.history,
                                        {
                        ...
                        case 1:
                            _a.trys.push([1, 4, , 5]);
                            provider = this.getRecipeInstanceOrThrow().config.signInAndUpFeature.providers.find(
                                function (p) {
                        ...
                        case 2:
                            ...
                            return [
                                4 /*yield*/,
                                this.props.recipeImplementation.signInAndUp(providerId, code, redirectUrl),
                            ];
                        case 3:
                            response = _a.sent();
