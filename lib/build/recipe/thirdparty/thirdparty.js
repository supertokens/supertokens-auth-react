...
var ThirdParty = /** @class */ (function (_super) {
    ...
    function ThirdParty(config) {
        var _this = _super.call(this, config, utils_2.normaliseThirdPartyConfig(config)) || this;
        /*
         * Instance methods.
         */
        _this.getFeatures = function () {
            ...
            _this.config.signInAndUpFeature.providers.forEach(function (provider) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    rid: _this.recipeId,
                    matches: utils_2.matchRecipeIdUsingState(_this.recipeId),
                };
            });
    ...
    ThirdParty.signOut = function () {
        return ThirdParty.getInstanceOrThrow().signOut();
    };
    ThirdParty.isEmailVerified = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, ThirdParty.getInstanceOrThrow().isEmailVerified()];
                    case 1:
    ...
    ThirdParty.redirectToAuth = function (show) {
