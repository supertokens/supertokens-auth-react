...
function getRecipeImplementation(webJsRecipe, authReactConfig) {
    return {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsRecipe.getAuthorisationURLFromBackend({
        ...
        getStateAndOtherInfoFromStorage: function (input) {
            return webJsRecipe.getStateAndOtherInfoFromStorage({
                config: input.config,
                userContext: input.userContext,
            });
        },
        ...
        getAuthorizationURLWithQueryParamsAndSetState: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [
                        2 /*return*/,
                        webJsRecipe.getAuthorizationURLWithQueryParamsAndSetState(__assign({}, input)),
                    ];
                });
            });
        },
        ...
        generateStateToSendToOAuthProvider: function (input) {
            return webJsRecipe.generateStateToSendToOAuthProvider(
                __assign(__assign({}, input), { config: input.config })
            );
        },
