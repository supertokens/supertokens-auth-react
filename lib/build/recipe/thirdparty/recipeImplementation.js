                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsRecipe.recipeImplementation.getOAuthAuthorisationURL({
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                webJsRecipe.recipeImplementation.getThirdPartyLoginRedirectURLWithQueryParams({
                                    config: webJsRecipe.config,
                                    thirdPartyProviderId: input.thirdPartyId,
                                    thirdPartyRedirectionURL: provider.getRedirectURL(),
                                    userContext: input.userContext,
                        ...
                        case 1:
                            ...
                            utils_1.redirectWithFullPageReload(response.url);
