...
function getRecipeImplementation(webJsRecipe, recipeId) {
    return {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                webJsRecipe.recipeImplementation.getAuthorisationURLFromBackend({
        ...
        setStateAndOtherInfoToStorage: function (input) {
            return webJsRecipe.recipeImplementation.setStateAndOtherInfoToStorage({
                config: webJsRecipe.config,
                state: __assign(__assign({}, input.state), { rid: recipeId }),
                userContext: input.userContext,
            });
        },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                webJsRecipe.recipeImplementation.getAuthorizationURLWithQueryParamsAndSetState({
                                    config: webJsRecipe.config,
                                    providerId: input.thirdPartyId,
