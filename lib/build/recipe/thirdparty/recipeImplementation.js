...
function getRecipeImplementation(recipeId, appInfo) {
    ...
    return {
                                ...
                                querier.get(
                                    ...
                                    function (context) {
                                        return input.config.preAPIHook(
                                            __assign(__assign({}, context), { action: "GET_AUTHORISATION_URL" })
                                        );
                                    }
                                ),
                            ];
        ...
        signInAndUp: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var provider, stateFromStorage, code, stateFromQueryParams, redirectURI, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            return [
                                ...
                                querier.post(
                                    ...
                                    function (context) {
                                        return input.config.preAPIHook(
                                            __assign(__assign({}, context), { action: "THIRD_PARTY_SIGN_IN_UP" })
                                        );
                                    }
                                ),
                            ];
        ...
        getOAuthState: function () {
            try {
                var state = JSON.parse(utils_1.getSessionStorage("supertokens-oauth-state"));
                if (state === null) {
                    return undefined;
                }
        ...
        setOAuthState: function (state) {
            ...
            utils_1.setSessionStorage("supertokens-oauth-state", value);
        },
