...
var ThirdPartyPasswordless = /** @class */ (function (_super) {
    ...
    function ThirdPartyPasswordless(config, recipes) {
        var _this =
            _super.call(this, utils_2.normaliseThirdPartyPasswordlessConfig(config), {
        ...
        _this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : new recipe_1.default({
                      ...
                      contactMethod: _this.config.contactMethod,
                      style: _this.config.rootStyle,
                      validateEmailAddress: _this.config.validateEmailAddress,
                      validatePhoneNumber: _this.config.validatePhoneNumber,
                      ...
                      signInUpFeature: __assign(__assign({}, _this.config.signInUpFeature), {
                          emailOrPhoneFormStyle: _this.config.signInUpFeature.providerAndEmailOrPhoneFormStyle,
                      }),
                      linkClickedScreenFeature: _this.config.linkClickedScreenFeature,
                      override: {
                          functions: function () {
                              return passwordlessImplementation_1.default(_this.recipeImpl);
                          },
        ...
        _this.thirdPartyRecipe =
            recipes.thirdPartyInstance !== undefined
                ...
                : _this.config.signInUpFeature.providers === undefined ||
                  _this.config.signInUpFeature.providers.length === 0
                ? undefined
                : new recipe_2.default(
                      {
                          ...
                          palette: _this.config.palette,
                          preAPIHook: _this.config.preAPIHook,
                          signInAndUpFeature: __assign(__assign({}, _this.config.signInUpFeature), {
                              style: _this.config.signInUpFeature.providerAndEmailOrPhoneFormStyle,
                          }),
