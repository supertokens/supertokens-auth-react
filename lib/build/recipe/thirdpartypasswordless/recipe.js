...
var thirdpartypasswordless_1 = __importDefault(require("supertokens-web-js/recipe/thirdpartypasswordless"));
...
var ThirdPartyPasswordless = /** @class */ (function (_super) {
    ...
    function ThirdPartyPasswordless(config, recipes) {
        ...
        _this.recipeImpl = thirdpartypasswordless_1.default;
        _this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : new recipe_1.default(
                      __assign(__assign({}, _this.config.passwordlessConfig), {
                          appInfo: _this.config.appInfo,
                          recipeId: _this.config.recipeId,
                      }),
                      (0, passwordlessImplementation_1.default)(_this.recipeImpl)
                  );
    ...
    ThirdPartyPasswordless.init = function (config) {
        var normalizedConfig = (0, utils_2.normaliseThirdPartyPasswordlessConfig)(config);
        return {
            ...
            webJS: thirdpartypasswordless_1.default.init(
