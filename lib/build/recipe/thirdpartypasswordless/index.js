...
exports.PasswordlessLinkClicked =
    exports.signOut =
    exports.ThirdpartyPasswordlessComponentsOverrideProvider =
...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.getAuthorisationURLFromBackend = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.getAuthorisationURLFromBackend(
    ...
    Wrapper.thirdPartySignInAndUp = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.thirdPartySignInAndUp(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.getThirdPartyStateAndOtherInfoFromStorage = function (input) {
        return recipe_1.default.getInstanceOrThrow().webJSRecipe.getThirdPartyStateAndOtherInfoFromStorage(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.setThirdPartyStateAndOtherInfoToStorage = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.setThirdPartyStateAndOtherInfoToStorage(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
                        })
                    ),
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    ...
                    recipe_1.default
                        .getInstanceOrThrow()
                        .webJSRecipe.getThirdPartyAuthorisationURLWithQueryParamsAndSetState(
                            __assign(__assign({}, input), {
                                userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
                            })
                        ),
    ...
    Wrapper.generateThirdPartyStateToSendToOAuthProvider = function (input) {
        return recipe_1.default.getInstanceOrThrow().webJSRecipe.generateThirdPartyStateToSendToOAuthProvider(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.verifyAndGetThirdPartyStateOrThrowError = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.verifyAndGetThirdPartyStateOrThrowError(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
                        })
                    ),
    ...
    Wrapper.getThirdPartyAuthCodeFromURL = function (input) {
        return recipe_1.default.getInstanceOrThrow().webJSRecipe.getThirdPartyAuthCodeFromURL(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.getThirdPartyAuthErrorFromURL = function (input) {
        return recipe_1.default.getInstanceOrThrow().webJSRecipe.getThirdPartyAuthErrorFromURL(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.getThirdPartyAuthStateFromURL = function (input) {
        return recipe_1.default.getInstanceOrThrow().webJSRecipe.getThirdPartyAuthStateFromURL(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
            ...
            return __generator(this, function (_a) {
                ...
                return [
                    ...
                    PasswordlessUtilFunctions.createCode(
                        __assign(__assign({}, input), { recipeImplementation: recipe.passwordlessRecipe.webJSRecipe })
                    ),
                ];
            });
        });
    ...
    Wrapper.getPasswordlessLinkCodeFromURL = function (input) {
        return recipe_1.default.getInstanceOrThrow().webJSRecipe.getPasswordlessLinkCodeFromURL(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.getPasswordlessPreAuthSessionIdFromURL = function (input) {
        return recipe_1.default.getInstanceOrThrow().webJSRecipe.getPasswordlessPreAuthSessionIdFromURL(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.doesPasswordlessUserEmailExist = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.doesPasswordlessUserEmailExist(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
                        })
                    ),
    ...
    Wrapper.doesPasswordlessUserPhoneNumberExist = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.doesPasswordlessUserPhoneNumberExist(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
                        })
                    ),
    ...
    Wrapper.getPasswordlessLoginAttemptInfo = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.getPasswordlessLoginAttemptInfo(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.setPasswordlessLoginAttemptInfo = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.setPasswordlessLoginAttemptInfo(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.clearPasswordlessLoginAttemptInfo = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    recipe_1.default.getInstanceOrThrow().webJSRecipe.clearPasswordlessLoginAttemptInfo(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.ComponentsOverrideProvider = componentOverrideContext_1.RecipeComponentsOverrideContextProvider;
    return Wrapper;
})();
