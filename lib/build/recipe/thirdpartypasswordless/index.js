...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.thirdPartySignInAndUp = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImpl.thirdPartySignInAndUp(
            tslib_1.__assign(tslib_1.__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.setThirdPartyStateAndOtherInfoToStorage = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImpl.setThirdPartyStateAndOtherInfoToStorage(
            tslib_1.__assign(tslib_1.__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
            })
        );
    ...
    Wrapper.getThirdPartyAuthorisationURLWithQueryParamsAndSetState = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImpl.getThirdPartyAuthorisationURLWithQueryParamsAndSetState(
            tslib_1.__assign(tslib_1.__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
            })
        );
    ...
    Wrapper.verifyAndGetThirdPartyStateOrThrowError = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImpl.verifyAndGetThirdPartyStateOrThrowError(
            tslib_1.__assign(tslib_1.__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(input.userContext),
            })
        );
    ...
    Wrapper.getPasswordlessLoginAttemptInfo = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImpl.getPasswordlessLoginAttemptInfo(
            tslib_1.__assign(tslib_1.__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.setPasswordlessLoginAttemptInfo = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImpl.setPasswordlessLoginAttemptInfo(
            tslib_1.__assign(tslib_1.__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    Wrapper.clearPasswordlessLoginAttemptInfo = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImpl.clearPasswordlessLoginAttemptInfo(
            tslib_1.__assign(tslib_1.__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
