...
var recipe_1 = require("supertokens-web-js/recipe/thirdpartypasswordless/recipe");
function getRecipeImplementation(recipeInput) {
    var passwordlessImpl = (0, recipeImplementation_1.default)(
        __assign(__assign({}, recipeInput), {
            webJSRecipe: recipe_1.Recipe.getInstanceOrThrow().passwordlessRecipe.recipeImplementation,
        })
    );
