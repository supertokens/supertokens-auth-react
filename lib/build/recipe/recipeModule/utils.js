...
var storage_1 = require("supertokens-web-js/utils/storage");
function normaliseRecipeModuleConfig(config) {
    ...
    var storageHandlers = {
        sessionStorage: storage_1.getDefaultSessionStorageHandler(),
        localStorage: storage_1.getDefaultLocalStorageHandler(),
    };
