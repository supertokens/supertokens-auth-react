                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, this.redirectToUrl(redirectUrl, history)];
                    }
                });
            });
        };
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    try {
                        ...
                        origin_1 = utils_1.getOriginOfPage().getAsStringDangerous();
                        if (origin_1 !== this.config.appInfo.websiteDomain.getAsStringDangerous()) {
                            ...
                            utils_1.redirectWithFullPageReload(redirectUrl);
                            return [2 /*return*/];
                        }
                        // If history was provided, use to redirect without reloading.
                        if (history !== undefined) {
                            utils_1.redirectWithHistory(redirectUrl, history);
                            return [2 /*return*/];
                        }
                    }
