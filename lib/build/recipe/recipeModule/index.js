...
var RecipeModule = /** @class */ (function () {
    ...
    function RecipeModule(config) {
        var _this = this;
        this.redirect = function (context, history, queryParams) { return __awaiter(_this, void 0, void 0, function () {
            var redirectUrl, origin_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRedirectUrl(context)];
                    case 1:
                        redirectUrl = _a.sent();
                        ...
                        try {
                            ...
                            origin_1 = new normalisedURLDomain_1.default(utils_1.getWindowOrThrow().location.origin).getAsStringDangerous();
        ...
        this.getRedirectUrl = function (context) { return __awaiter(_this, void 0, void 0, function () {
            var redirectUrl;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.config.getRedirectionURL(context)];
                    case 1:
                        redirectUrl = _a.sent();
