...
_onHandleEvent) {
    return function (originalImp) { return (genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImp), { resyncSessionAndFetchMFAInfo: function (input) {
                        ...
                        case 2:
                            ...
                            if (stored !== null) {
                                ...
                                if (parsed.t > Date.now() - 1000) {
                                    return [2 /*return*/, genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, parsed.v), { 
...
var MultiFactorAuthClaimClass = /** @class */ (function () {
    function MultiFactorAuthClaimClass(getRecipe, getRedirectURL, onFailureRedirection) {
        var _this = this;
        this.webJSClaim = new MultiFactorAuthWebJS.MultiFactorAuthClaimClass(function () { return getRecipe().webJSRecipe; });
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            genericComponentOverrideContext.logDebugMessage("Redirecting to MFA on next array from validation failure: " + nextFactorOptions.join(", "));
                        ...
                        case 2:
                            ...
                            availableFactors = recipe
                                ...
                                .map(function (v) { return v.id; });
                            genericComponentOverrideContext.logDebugMessage("Redirecting to MFA on next array from backend: " + availableFactors.join(", "));
                            if (availableFactors.length === 1) {
                                return [2 /*return*/, getRedirectURL({ action: "GO_TO_FACTOR", factorId: availableFactors[0] }, userContext)];
                            }
                            else {
        ...
        this.validators = genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, this.webJSClaim.validators), { hasCompletedMFARequirementsForAuth: function (doRedirection, showAccessDeniedOnFailure) {
                ...
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, orig), { showAccessDeniedOnFailure: showAccessDeniedOnFailure, onFailureRedirection: onFailureRedirection !== null && onFailureRedirection !== void 0 ? onFailureRedirection : (function (_a) {
                        var reason = _a.reason, userContext = _a.userContext;
...
function normaliseMultiFactorAuthFeature(config) {
    ...
    return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, genericComponentOverrideContext.normaliseRecipeModuleConfig(config)), { disableDefaultUI: disableDefaultUI, firstFactors: config === null || config === void 0 ? void 0 : config.firstFactors, getSecondaryFactorInfo: function (orig) { return orig; }, factorChooserScreen: (_a = config.factorChooserScreen) !== null && _a !== void 0 ? _a : {}, override: override });
}
function getAvailableFactors(factors, nextArrayQueryParam, recipe, userContext) {
    genericComponentOverrideContext.logDebugMessage("getAvailableFactors: allowed to setup: ".concat(factors.allowedToSetup));
    genericComponentOverrideContext.logDebugMessage("getAvailableFactors: already setup: ".concat(factors.alreadySetup));
    genericComponentOverrideContext.logDebugMessage("getAvailableFactors: next from factorInfo: ".concat(factors.next));
    genericComponentOverrideContext.logDebugMessage("getAvailableFactors: nextArrayQueryParam: ".concat(nextArrayQueryParam));
    genericComponentOverrideContext.logDebugMessage("getAvailableFactors: secondary factors: ".concat(recipe.getSecondaryFactors(userContext).map(function (f) { return f.id; })));
...
var MultiFactorAuth = /** @class */ (function (_super) {
    ...
    function MultiFactorAuth(config, webJSRecipe) {
        if (webJSRecipe === void 0) { webJSRecipe = MultiFactorAuthWebJS__default.default; }
        var _this = _super.call(this, config) || this;
        _this.webJSRecipe = webJSRecipe;
        _this.recipeID = MultiFactorAuth.RECIPE_ID;
        _this.secondaryFactors = [];
        _this.getDefaultRedirectionURL = function (context, userContext) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            var nParam, redirectInfo;
            return genericComponentOverrideContext.__generator(this, function (_b) {
                if (context.action === "FACTOR_CHOOSER") {
                    nParam = context.nextFactorOptions && context.nextFactorOptions.length > 0
                        ? context.nextFactorOptions.join(",")
                        : undefined;
                    return [2 /*return*/, genericComponentOverrideContext.getDefaultRedirectionURLForPath(this.config, DEFAULT_FACTOR_CHOOSER_PATH, context, {
                            n: nParam,
                            stepUp: context.stepUp ? "true" : undefined,
                        })];
                }
                else if (context.action === "GO_TO_FACTOR") {
                    redirectInfo = this.getSecondaryFactors(userContext).find(function (f) { return f.id === context.factorId; });
                    if (redirectInfo !== undefined) {
                        return [2 /*return*/, genericComponentOverrideContext.getDefaultRedirectionURLForPath(this.config, redirectInfo.path, context, {
        ...
        postSuperTokensInitCallbacks.PostSuperTokensInitCallbacks.addPostInitCallback(function () {
            var defaultFactorsValidator = MultiFactorAuth.MultiFactorAuthClaim.validators.hasCompletedMFARequirementsForAuth();
    ...
    MultiFactorAuth.init = function (config) {
        return {
            ...
            authReact: function (appInfo, _, overrideMaps) {
                var normalisedConfig = normaliseMultiFactorAuthFeature(genericComponentOverrideContext.applyPlugins(MultiFactorAuth.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : []));
                MultiFactorAuth.instance = new MultiFactorAuth(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: MultiFactorAuth.RECIPE_ID }));
            ...
            webJS: function () {
                ...
                var init = MultiFactorAuthWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
    ...
    MultiFactorAuth.prototype.addMFAFactors = function (secondaryFactors) {
        this.secondaryFactors = genericComponentOverrideContext.__spreadArray(genericComponentOverrideContext.__spreadArray([], this.secondaryFactors.filter(function (factor) {
            return secondaryFactors.every(function (newFactor) { return factor.id !== newFactor.id; });
        }), true), secondaryFactors, true);
    };
    ...
    MultiFactorAuth.prototype.redirectToFactor = function (_b) {
        ...
        return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
            ...
            return genericComponentOverrideContext.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.getRedirectUrl({
                            action: "GO_TO_FACTOR",
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirectToUrl(url, navigate)];
                }
            });
        });
    };
    ...
    MultiFactorAuth.MultiFactorAuthClaim = new MultiFactorAuthClaimClass(function () { return MultiFactorAuth.getInstanceOrThrow(); }, function (context, userContext) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        return genericComponentOverrideContext.__generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, this.getInstanceOrThrow().getRedirectUrl(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, context), { tenantIdFromQueryParams: genericComponentOverrideContext.getTenantIdFromQueryParams() }), userContext)];
                case 1: return [2 /*return*/, (_b.sent()) || undefined];
            }
        });
    }); });
