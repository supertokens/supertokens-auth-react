                            ...
                            case 2:
                                ...
                                if (stored !== null) {
                                    ...
                                    if (parsed.t > Date.now() - 1000) {
                                        return [
                                            2 /*return*/,
                                            superTokens.__assign(superTokens.__assign({}, parsed.v), {
...
var MultiFactorAuthClaimClass = /** @class */ (function () {
    function MultiFactorAuthClaimClass(getRecipe, getRedirectURL, onFailureRedirection) {
        ...
        this.validators = superTokens.__assign(superTokens.__assign({}, this.webJSClaim.validators), {
            hasCompletedMFARequirementsForAuth: function (doRedirection, showAccessDeniedOnFailure) {
                ...
                return superTokens.__assign(superTokens.__assign({}, orig), {
...
var MultiFactorAuth = /** @class */ (function (_super) {
    superTokens.__extends(MultiFactorAuth, _super);
    ...
    MultiFactorAuth.MultiFactorAuthClaim = new MultiFactorAuthClaimClass(
        ...
        function (context, userContext) {
            return superTokens.__awaiter(void 0, void 0, void 0, function () {
                return superTokens.__generator(_a, function (_b) {
                    switch (_b.label) {
                        case 0:
