...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.redirectToFactor = function (factorId, redirectBack, history) {
        if (redirectBack === void 0) {
            redirectBack = true;
        }
        return recipe.MultiFactorAuth.getInstanceOrThrow().redirectToFactor(factorId, redirectBack, history);
    };
