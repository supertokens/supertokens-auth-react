...
_onHandleEvent) {
    return function (originalImp) { return (utils.__assign(utils.__assign({}, originalImp), { resyncSessionAndFetchMFAInfo: function (input) {
                        ...
                        case 2:
                            ...
                            if (stored !== null) {
                                ...
                                if (parsed.t > Date.now() - 1000) {
                                    return [2 /*return*/, utils.__assign(utils.__assign({}, parsed.v), { 
...
var MultiFactorAuthClaimClass = /** @class */ (function () {
    function MultiFactorAuthClaimClass(getRecipe, getRedirectURL, onFailureRedirection) {
                ...
                return utils.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            utils.logDebugMessage("Redirecting to MFA on next array from validation failure: " + nextFactorOptions.join(", "));
                        ...
                        case 2:
                            ...
                            availableFactors = recipe
                                ...
                                .map(function (v) { return v.id; });
                            utils.logDebugMessage("Redirecting to MFA on next array from backend: " + availableFactors.join(", "));
                            if (availableFactors.length === 1) {
                                return [2 /*return*/, getRedirectURL({ action: "GO_TO_FACTOR", factorId: availableFactors[0] }, userContext)];
                            }
                            else {
        ...
        this.validators = utils.__assign(utils.__assign({}, this.webJSClaim.validators), { hasCompletedMFARequirementsForAuth: function (doRedirection, showAccessDeniedOnFailure) {
                ...
                return utils.__assign(utils.__assign({}, orig), { showAccessDeniedOnFailure: showAccessDeniedOnFailure, onFailureRedirection: onFailureRedirection !== null && onFailureRedirection !== void 0 ? onFailureRedirection : (function (_a) {
                        var reason = _a.reason, userContext = _a.userContext;
...
function getAvailableFactors(factors, nextArrayQueryParam, recipe, userContext) {
    ...
    utils.logDebugMessage("getAvailableFactors: secondary factors: ".concat(recipe.getSecondaryFactors(userContext).map(function (f) { return f.id; })));
...
var MultiFactorAuth = /** @class */ (function (_super) {
    ...
    function MultiFactorAuth(config, webJSRecipe) {
        ...
        _this.getDefaultRedirectionURL = function (context, userContext) { return utils.__awaiter(_this, void 0, void 0, function () {
            ...
            return utils.__generator(this, function (_b) {
                if (context.action === "FACTOR_CHOOSER") {
                    nParam = context.nextFactorOptions && context.nextFactorOptions.length > 0
                        ...
                        : undefined;
                    return [2 /*return*/, utils.getDefaultRedirectionURLForPath(this.config, DEFAULT_FACTOR_CHOOSER_PATH, context, {
                            n: nParam,
                    ...
                    if (redirectInfo !== undefined) {
                        return [2 /*return*/, utils.getDefaultRedirectionURLForPath(this.config, redirectInfo.path, context, {
    ...
    MultiFactorAuth.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                MultiFactorAuth.instance = new MultiFactorAuth(utils.__assign(utils.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: MultiFactorAuth.RECIPE_ID }));
                return MultiFactorAuth.instance;
            },
            webJS: MultiFactorAuthWebJS__default.default.init(utils.__assign(utils.__assign({}, normalisedConfig), { override: {
    ...
    MultiFactorAuth.prototype.addMFAFactors = function (secondaryFactors) {
        this.secondaryFactors = utils.__spreadArray(utils.__spreadArray([], this.secondaryFactors.filter(function (factor) {
    ...
    MultiFactorAuth.MultiFactorAuthClaim = new MultiFactorAuthClaimClass(function () { return MultiFactorAuth.getInstanceOrThrow(); }, function (context, userContext) { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, this.getInstanceOrThrow().getRedirectUrl(utils.__assign(utils.__assign({}, context), { tenantIdFromQueryParams: utils.getTenantIdFromQueryParams() }), userContext)];
