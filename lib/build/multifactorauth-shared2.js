...
var MultiFactorAuth = /** @class */ (function (_super) {
    ...
    MultiFactorAuth.init = function (config) {
        ...
        return {
            ...
            webJS: MultiFactorAuthWebJS__default.default.init(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, normalisedConfig), { override: {
