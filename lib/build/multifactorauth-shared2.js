...
_onHandleEvent) {
    return function (originalImp) { return (logger.__assign(logger.__assign({}, originalImp), { resyncSessionAndFetchMFAInfo: function (input) {
                        ...
                        case 2:
                            ...
                            if (stored !== null) {
                                ...
                                if (parsed.t > Date.now() - 1000) {
                                    return [2 /*return*/, logger.__assign(logger.__assign({}, parsed.v), { 
...
var MultiFactorAuthClaimClass = /** @class */ (function () {
    function MultiFactorAuthClaimClass(getRecipe, getRedirectURL, onFailureRedirection) {
        ...
        var defaultOnFailureRedirection = function (_a) {
            ...
            return logger.__awaiter(_this, void 0, void 0, function () {
                ...
                return logger.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            logger.logDebugMessage("Redirecting to MFA on next array from validation failure: " + nextFactorOptions.join(", "));
                        ...
                        case 2:
                            ...
                            availableFactors = recipe
                                ...
                                .map(function (v) { return v.id; });
                            logger.logDebugMessage("Redirecting to MFA on next array from backend: " + availableFactors.join(", "));
                            if (availableFactors.length === 1) {
                                return [2 /*return*/, getRedirectURL({ action: "GO_TO_FACTOR", factorId: availableFactors[0] }, userContext)];
                            }
                            else {
        ...
        this.validators = logger.__assign(logger.__assign({}, this.webJSClaim.validators), { hasCompletedMFARequirementsForAuth: function (doRedirection, showAccessDeniedOnFailure) {
                ...
                return logger.__assign(logger.__assign({}, orig), { showAccessDeniedOnFailure: showAccessDeniedOnFailure, onFailureRedirection: onFailureRedirection !== null && onFailureRedirection !== void 0 ? onFailureRedirection : (function (_a) {
                        var reason = _a.reason, userContext = _a.userContext;
...
function normaliseMultiFactorAuthFeature(config) {
    ...
    var override = logger.__assign({ functions: function (originalImplementation) { return originalImplementation; } }, config.override);
    return logger.__assign(logger.__assign({}, superTokens.normaliseRecipeModuleConfig(config)), { disableDefaultUI: disableDefaultUI, firstFactors: config === null || config === void 0 ? void 0 : config.firstFactors, getSecondaryFactorInfo: function (orig) { return orig; }, factorChooserScreen: (_a = config.factorChooserScreen) !== null && _a !== void 0 ? _a : {}, override: override });
}
function getAvailableFactors(factors, nextArrayQueryParam, recipe, userContext) {
    logger.logDebugMessage("getAvailableFactors: allowed to setup: ".concat(factors.allowedToSetup));
    logger.logDebugMessage("getAvailableFactors: already setup: ".concat(factors.alreadySetup));
    logger.logDebugMessage("getAvailableFactors: next from factorInfo: ".concat(factors.next));
    logger.logDebugMessage("getAvailableFactors: nextArrayQueryParam: ".concat(nextArrayQueryParam));
    logger.logDebugMessage("getAvailableFactors: secondary factors: ".concat(recipe.getSecondaryFactors(userContext).map(function (f) { return f.id; })));
...
var MultiFactorAuth = /** @class */ (function (_super) {
    logger.__extends(MultiFactorAuth, _super);
    function MultiFactorAuth(config, webJSRecipe) {
        ...
        _this.getDefaultRedirectionURL = function (context, userContext) { return logger.__awaiter(_this, void 0, void 0, function () {
            ...
            return logger.__generator(this, function (_b) {
                if (context.action === "FACTOR_CHOOSER") {
                    nParam = context.nextFactorOptions && context.nextFactorOptions.length > 0
                        ...
                        : undefined;
                    return [2 /*return*/, superTokens.getDefaultRedirectionURLForPath(this.config, DEFAULT_FACTOR_CHOOSER_PATH, context, {
                            n: nParam,
                    ...
                    if (redirectInfo !== undefined) {
                        return [2 /*return*/, superTokens.getDefaultRedirectionURLForPath(this.config, redirectInfo.path, context, {
    ...
    MultiFactorAuth.init = function (config) {
        ...
        return {
            ...
            authReact: function (appInfo) {
                MultiFactorAuth.instance = new MultiFactorAuth(logger.__assign(logger.__assign({}, normalisedConfig), { appInfo: appInfo, recipeId: MultiFactorAuth.RECIPE_ID }));
                return MultiFactorAuth.instance;
            },
            webJS: MultiFactorAuthWebJS__default.default.init(logger.__assign(logger.__assign({}, normalisedConfig), { override: {
    ...
    MultiFactorAuth.prototype.addMFAFactors = function (secondaryFactors) {
        this.secondaryFactors = logger.__spreadArray(logger.__spreadArray([], this.secondaryFactors.filter(function (factor) {
            ...
            return logger.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (redirectBack) {
                            redirectUrl = superTokens.getCurrentNormalisedUrlPathWithQueryParamsAndFragments();
                            url = superTokens.appendQueryParamsToURL(url, { redirectToPath: redirectUrl });
                        }
                        else {
                            redirectUrl = superTokens.getRedirectToPathFromURL();
                            if (redirectUrl) {
                                url = superTokens.appendQueryParamsToURL(url, { redirectToPath: redirectUrl });
                            }
                        }
                        return [2 /*return*/, superTokens.SuperTokens.getInstanceOrThrow().redirectToUrl(url, navigate)];
                }
            });
        });
    };
    ...
    MultiFactorAuth.MultiFactorAuthClaim = new MultiFactorAuthClaimClass(function () { return MultiFactorAuth.getInstanceOrThrow(); }, function (context, userContext) { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, this.getInstanceOrThrow().getRedirectUrl(logger.__assign(logger.__assign({}, context), { tenantIdFromQueryParams: superTokens.getTenantIdFromQueryParams() }), userContext)];
