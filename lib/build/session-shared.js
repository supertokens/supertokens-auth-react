...
(function (exports) {
    ...
    __export(recipe.normalisedURLDomain);
})(normalisedURLDomain);

var NormalisedURLDomain = /*@__PURE__*/ recipe.getDefaultExportFromCjs(normalisedURLDomain);
...
(function (exports) {
    ...
    exports.__esModule = true;
    __export(recipe.normalisedURLPath);
})(normalisedURLPath);

var NormalisedURLPath = /*@__PURE__*/ recipe.getDefaultExportFromCjs(normalisedURLPath);
...
function clearQueryParams(paramNames) {
    var newURL = new URL(recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.location.getHref());
    for (var _i = 0, paramNames_1 = paramNames; _i < paramNames_1.length; _i++) {
        var param = paramNames_1[_i];
        newURL.searchParams.delete(param);
    }
    recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.history.replaceState(
        recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.history.getState(),
        "",
        recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.location.getHref()
    );
}
...
function getQueryParams(param) {
    var urlParams = new URLSearchParams(
        recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.location.getSearch()
    );
    return urlParams.get(param);
}
function getURLHash() {
    // By default it is returined with the "#" at the beginning, we cut that off here.
    return recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.location.getHash().substr(1);
}
...
function getCurrentNormalisedUrlPath() {
    return new NormalisedURLPath(
        recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.location.getPathName()
    );
}
...
function redirectWithFullPageReload(to) {
    ...
    recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.location.setHref(to);
}
...
function isIE() {
    return recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.getDocument().documentMode !== undefined;
}
function getOriginOfPage() {
    return new NormalisedURLDomain(
        recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.location.getOrigin()
    );
}
function getLocalStorage(key) {
    return __awaiter(this, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            res = recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.localStorage.getItem(key);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [
                        4 /*yield*/,
                        recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.localStorage.setItem(
                            key,
                            value
                        ),
                    ];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [
                        4 /*yield*/,
                        recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.localStorage.removeItem(
                            key
                        ),
                    ];
                case 1:
...
function getDefaultCookieScope() {
    try {
        return normaliseCookieScopeOrThrowError(
            recipe.WindowHandlerReference_1.getReferenceOrThrow().windowHandler.location.getHostName()
        );
    } catch (_a) {
        return undefined;
    }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        recipe.CookieHandlerReference_1.getReferenceOrThrow().cookieHandler.getCookie(),
                    ];
                case 1:
                    value = _a + _b.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        recipe.CookieHandlerReference_1.getReferenceOrThrow().cookieHandler.setCookie(
...
exports.PostSuperTokensInitCallbacks_1 = postSuperTokensInitCallbacks.PostSuperTokensInitCallbacks = void 0;
...
exports.PostSuperTokensInitCallbacks_1 = postSuperTokensInitCallbacks.PostSuperTokensInitCallbacks =
...
var SuperTokens = /** @class */ (function () {
    ...
    SuperTokens.init = function (config) {
        recipe.CookieHandlerReference_1.init(config.cookieHandler);
        recipe.WindowHandlerReference_1.init(config.windowHandler);
        if (SuperTokens.instance !== undefined) {
            console.warn("SuperTokens was already initialized");
            return;
        }
        SuperTokens.instance = new SuperTokens(config);
        exports.PostSuperTokensInitCallbacks_1.runPostInitCallbacks();
    };
...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config) {
        ...
        _this.webJsRecipe = new recipe.Recipe_1(
    ...
    Session.addAxiosInterceptors = function (axiosInstance, userContext) {
        return recipe.Recipe_1.addAxiosInterceptors(axiosInstance, userContext);
    };
