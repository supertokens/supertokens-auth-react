...
var SessionAuth = function (_a) {
    var _b;
    var children = _a.children,
        props = thirdparty.__rest(_a, ["children"]);
    ...
    var redirectToLogin = React.useCallback(function () {
        void thirdparty.SuperTokens.getInstanceOrThrow().redirectToAuth({ history: history, redirectBack: true });
    }, []);
                ...
                switch (_b.label) {
                    case 0:
                        if (session.current === undefined) {
                            session.current = thirdparty.Session.getInstanceOrThrow();
                        }
                        return [
                            4 /*yield*/,
                    ...
                    case 6:
                        invalidClaimRedirectToPath = thirdparty.popInvalidClaimRedirectPathFromContext(userContext);
                        _b.label = 7;
                    case 7:
                ...
                return thirdparty.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [
                                4 /*yield*/,
                                thirdparty.SuperTokens.getInstanceOrThrow().redirectToUrl(
    ...
    thirdparty.useOnMountAPICall(buildContext, setInitialContextAndMaybeRedirect);
                    ...
                    return thirdparty.__generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                invalidClaims = _b.sent();
                                setContext(
                                    thirdparty.__assign(thirdparty.__assign({}, event.sessionContext), {
                                        loading: false,
                                        invalidClaims: invalidClaims,
                                    })
                                );
                                redirectPath = thirdparty.popInvalidClaimRedirectPathFromContext(userContext);
                                if (!(props.doRedirection !== false && redirectPath)) return [3 /*break*/, 4];
                                return [
                                    4 /*yield*/,
                                    thirdparty.SuperTokens.getInstanceOrThrow().redirectToUrl(redirectPath, history),
                                ];
                            case 3:
                                _b.sent();
                                _b.label = 4;
    ...
    return jsxRuntime.jsx(SessionContext.Provider, thirdparty.__assign({ value: context }, { children: children }));
};
var SessionAuthWrapper = function (props) {
    return jsxRuntime.jsx(
        ...
        thirdparty.__assign(
            ...
            { children: jsxRuntime.jsx(SessionAuth, thirdparty.__assign({}, props)) }
        )
    );
};
