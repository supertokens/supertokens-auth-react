...
function LogoutButton(_a) {
    ...
    return jsxRuntime.jsxs(
        ...
        exports.__assign(
            ...
            {
                children: [
                    jsxRuntime.jsx(ArrowLeftIcon, { color: "rgb(var(--palette-textDisabled))" }),
...
var getFailureRedirectionInfo = function (_a) {
    var invalidClaims = _a.invalidClaims,
        ...
        userContext = _a.userContext;
    return __awaiter(void 0, void 0, void 0, function () {
        var invalidClaimsMap, globalValidators, _i, globalValidators_1, validator, claim, failureCallback, redirectPath;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
...
var SessionAuth = function (_a) {
                        ...
                        case 3:
                            if (props.useDefaultAccessDeniedScreen !== false) {
                                ...
                                return [
                                    2 /*return*/,
                                    setContext(
                                        exports.__assign(exports.__assign({}, toSetContext), { accessDenied: true })
                                    ),
                                ];
                            }
                            _a.label = 4;
    ...
    if (!context.loading && context.accessDenied) {
        return jsxRuntime.jsx(AccessDeniedScreen, {
