                ...
                switch (_b.label) {
                    case 0:
                        if (session.current === undefined) {
                            session.current = superTokens.Session.getInstanceOrThrow();
                        }
                        return [
                            4 /*yield*/,
                    ...
                    case 6:
                        invalidClaimRedirectToPath = superTokens.popInvalidClaimRedirectPathFromContext(userContext);
                        _b.label = 7;
                    case 7:
                    ...
                    return superTokens.__generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                redirectPath = superTokens.popInvalidClaimRedirectPathFromContext(userContext);
                                if (!(props.doRedirection !== false && redirectPath)) return [3 /*break*/, 4];
                                return [
                                    4 /*yield*/,
                                    superTokens.SuperTokens.getInstanceOrThrow().redirectToUrl(redirectPath, history),
                                ];
                            case 3:
                                _b.sent();
                                _b.label = 4;
