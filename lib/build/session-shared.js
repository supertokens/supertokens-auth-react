...
var getFailureRedirectionInfo = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var globalValidatorsMap, redirects, _i, invalidClaims_1, claim, validator, redirectPath;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    globalValidatorsMap = utils
                        .getGlobalClaimValidators({
                            overrideGlobalClaimValidators: overrideGlobalClaimValidators,
                            userContext: userContext,
                        })
                        .reduce(function (map, validator) {
                    ...
                    _b.label = 1;
                case 1:
                    if (!(_i < invalidClaims_1.length)) return [3 /*break*/, 4];
                    claim = invalidClaims_1[_i];
                    validator = globalValidatorsMap[claim.validatorId];
                    if (!validator.onFailureRedirection) return [3 /*break*/, 3];
                    return [
                        4 /*yield*/,
                        validator.onFailureRedirection({ reason: claim.reason, userContext: userContext }),
                    ];
                case 2:
                ...
                case 4:
                    return [
                        2 /*return*/,
                        {
                            ...
                            redirectPath: redirects.filter(function (r) {
                                return r !== undefined;
                            })[0],
                        },
                    ];
...
var ThemeBase = function (_a) {
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            ...
            jsxRuntime.jsx("style", { children: userStyles.join("\n") }),
        ],
    });
};

var AccessDeniedTheme = withOverride("SessionAccessDenied", function AccessDeniedThemeScreen(props) {
    var _a, _b;
                                ...
                                { "data-supertokens": "headerTitle" },
                                {
                                    children: [
                                        jsxRuntime.jsxs("div", {
                                            children: [
                                                "Claim ID: ",
                                                (_a = props.denialInfo) === null || _a === void 0
                                                    ? void 0
                                                    : _a.validatorId,
                                            ],
                                        }),
                                        jsxRuntime.jsxs("div", {
                                            children: [
                                                "Reason: ",
                                                (_b = props.denialInfo) === null || _b === void 0 ? void 0 : _b.reason,
                                            ],
                                        }),
                                    ],
                                }
...
var defaultTranslationsSession = {
    en: exports.__assign(exports.__assign({}, defaultTranslationsCommon.en), { ACCESS_DENIED: "Access denied" }),
};

var AccessDeniedScreen = function (props) {
    var _a = React.useState(),
        accessDenialInfo = _a[0],
        setAccessDenialInfo = _a[1];
    var recipeComponentOverrides = useContext();
    React.useEffect(function () {
        var retrieveAccessDenialInfo = function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var denialInfo;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 5:
                            ...
                            failedClaim = JSON.stringify(invalidClaims[0]);
                            return [4 /*yield*/, setLocalStorage("supertokens-access-denial-info", failedClaim)];
                        case 6:
                            _c.sent();
        ...
        _this.getFeatures = function () {
            ...
            features[normalisedFullPath.getAsStringDangerous()] = {
                ...
                component: function (props) {
                    return _this.getFeatureComponent("accessDenied", props);
                },
            };
            return features;
        };
            ...
            var featureComponents = {
                accessDenied: jsxRuntime.jsx(
                    ...
                    exports.__assign(
                        ...
                        { children: jsxRuntime.jsx(AccessDeniedScreen, exports.__assign({ recipe: _this }, props)) }
                    )
                ),
            };
