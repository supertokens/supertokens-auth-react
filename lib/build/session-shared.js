...
function RoutingComponent(props) {
    var _a;
    var stInstance = props.recipeRoutesInstance;
    var path = props.path;
...
var RecipeRoutes = /** @class */ (function () {
    ...
    RecipeRoutes.getReactRouterDomWithCustomHistory = function () {
        return RecipeRoutes.reactRouterDom;
    };
    return RecipeRoutes;
})();
...
var SessionAuth = function (_a) {
    ...
    var historyHookRef = React.useRef(
        (_b = RecipeRoutes.getReactRouterDomWithCustomHistory()) === null || _b === void 0
            ? void 0
            : _b.useHistoryCustom
    );
    var history;
