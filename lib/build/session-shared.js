...
function getRedirectToPathFromURL(_a) {
    var _b = _a === void 0 ? { includeQueryParams: false } : _a,
        includeQueryParams = _b.includeQueryParams;
    ...
    if (param === null) {
        ...
        try {
            ...
            var pathQueryParams = param.split("?")[1] ? "?".concat(param.split("?")[1]) : "";
