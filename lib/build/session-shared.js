...
var session = require("supertokens-web-js/recipe/session");
...
var BooleanClaim = /** @class */ (function (_super) {
    ...
    function BooleanClaim(config) {
        ...
        var validatorsWithCallbacks = exports.__assign({}, _this.validators);
        var _loop_1 = function (key) {
            ...
            validatorsWithCallbacks[key] = function () {
                ...
                return exports.__assign(exports.__assign({}, validator.apply(void 0, args)), {
...
var useSessionContext$1 = function () {
    var ctx = React__namespace.default.useContext(SessionContext);
...
var SessionAPIWrapper = /** @class */ (function () {
    ...
    SessionAPIWrapper.getUserId = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    Session$1.getInstanceOrThrow().getUserId({
    ...
    SessionAPIWrapper.getAccessToken = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    Session$1.getInstanceOrThrow().getAccessToken({
                        userContext: getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.getAccessTokenPayloadSecurely = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    Session$1.getInstanceOrThrow().getAccessTokenPayloadSecurely({
                        userContext: getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.attemptRefreshingSession = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Session$1.getInstanceOrThrow().attemptRefreshingSession()];
            });
        });
    };
    SessionAPIWrapper.doesSessionExist = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    Session$1.getInstanceOrThrow().doesSessionExist({
                        userContext: getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.addAxiosInterceptors = function (axiosInstance, userContext) {
        return Session$1.addAxiosInterceptors(axiosInstance, getNormalisedUserContext(userContext));
    };
    SessionAPIWrapper.signOut = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [
                    2 /*return*/,
                    Session$1.getInstanceOrThrow().signOut({
                        userContext: getNormalisedUserContext(
                            input === null || input === void 0 ? void 0 : input.userContext
                        ),
                    }),
    ...
    SessionAPIWrapper.validateClaims = function (input) {
        return Session$1.getInstanceOrThrow().validateClaims({
    ...
    SessionAPIWrapper.getInvalidClaimsFromResponse = function (input) {
        return Session$1.getInstanceOrThrow().getInvalidClaimsFromResponse(input);
    };
    SessionAPIWrapper.getClaimValue = function (input) {
        return Session$1.getInstanceOrThrow().getClaimValue({
            claim: input.claim,
            userContext: getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext),
        });
    };
    ...
    SessionAPIWrapper.AccessDenied = function (prop) {
        ...
        return Session$1.getInstanceOrThrow().getFeatureComponent("accessDenied", prop);
    };
...
var SessionAuth$1 = SessionAPIWrapper.SessionAuth;
                ...
                switch (_b.label) {
                    case 0:
                        if (session.current === undefined) {
                            session.current = Session$1.getInstanceOrThrow();
                        }
                        return [
                            4 /*yield*/,
...
exports.SessionAuth = SessionAuth$1;
