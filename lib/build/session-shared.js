                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, utils.getGlobalClaimValidators()];
                        case 2:
                            globalValidators = _c.sent();
                        ...
                        case 3:
                            ...
                            if (!(invalidClaims.length > 0)) return [3 /*break*/, 7];
                            if (!(redirectInfo !== undefined)) return [3 /*break*/, 5];
                        ...
                        case 4:
                            ...
                            _c.label = 5;
                        case 5:
                            getRedirectionPathOrRedirect = function () {
                                return __awaiter(_this, void 0, void 0, function () {
                                    var callback, _loop_1, _i, invalidClaims_1, claim, _a, _b;
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                            case 0:
                                                _loop_1 = function (claim) {
                                                    var validator = globalValidators.find(function (_a) {
                                                        var id = _a.id;
                                                        return id === claim.validatorId;
                                                    });
                                                    if (
                                                        validator === null || validator === void 0
                                                            ? void 0
                                                            : validator.onFailureRedirection
                                                    ) {
                                                        callback = validator.onFailureRedirection({
                                                ...
                                                for (
                                                    _i = 0, invalidClaims_1 = invalidClaims;
                                                    _i < invalidClaims_1.length;
                                                    _i++
                                                ) {
                                                    claim = invalidClaims_1[_i];
                                                    _loop_1(claim);
                                                }
                                            ...
                                            case 2:
                                                ...
                                                return [2 /*return*/];
                                            case 3:
                                                return [4 /*yield*/, Promise.all([callback])];
                                            case 4:
                                                return [2 /*return*/, _c.sent().filter(Boolean)[0]];
                                        }
                                    });
                                });
                            };
                            return [4 /*yield*/, getRedirectionPathOrRedirect()];
                        case 6:
                        ...
                        case 7:
                            return [
                                4 /*yield*/,
                                (_b =
                                    (_a = globalValidators.find(function (_a) {
                                        var id = _a.id,
                                            onSuccessRedirection = _a.onSuccessRedirection;
                                        return (
                                            !invalidClaimsIDs.includes(id) &&
                                            (onSuccessRedirection === null || onSuccessRedirection === void 0
                                                ? void 0
                                                : onSuccessRedirection({ userContext: userContext })) !== undefined
                                        );
                                    })) === null || _a === void 0
                                        ? void 0
                                        : _a.onSuccessRedirection) === null || _b === void 0
                                    ? void 0
                                    : _b.call(_a, { userContext: userContext }),
                            ];
                        case 8:
                            succeededClaimValidatorRedirectString = _c.sent();
...
var SessionAuth = function (_a) {
    ...
    var getRedirectPathFromInvalidClaimsOrRedirect = React.useCallback(
        function (claims) {
            return __awaiter(void 0, void 0, void 0, function () {
                var globalValidators, callback, _loop_1, _i, claims_1, claim, _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            if (!claims.length) {
                            ...
                            globalValidators = utils.getGlobalClaimValidators(props.overrideGlobalClaimValidators);
                            _loop_1 = function (claim) {
                                var validator = globalValidators.find(function (_a) {
                                    var id = _a.id;
                                    return id === claim.validatorId;
                                ...
                                if (
                                    validator === null || validator === void 0 ? void 0 : validator.onFailureRedirection
                                ) {
                                    callback = validator.onFailureRedirection({
                                        userContext: userContext,
                                        reason: claim.reason,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                getRedirectPathFromInvalidClaimsOrRedirect(toSetContext.invalidClaims),
                            ];
                        case 1:
                            redirectPath = _a.sent();
                            if (!(redirectPath !== undefined)) return [3 /*break*/, 3];
                            return [4 /*yield*/, SuperTokens.getInstanceOrThrow().redirectToUrl(redirectPath, history)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                        case 3:
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                return [4 /*yield*/, getRedirectPathFromInvalidClaimsOrRedirect(invalidClaims)];
                            case 3:
                                redirectPath = _b.sent();
                                if (!(props.doRedirection !== false && redirectPath)) return [3 /*break*/, 5];
                                return [
                                    4 /*yield*/,
                                    SuperTokens.getInstanceOrThrow().redirectToUrl(redirectPath, history),
                                ];
