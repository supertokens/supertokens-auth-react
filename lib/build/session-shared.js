...
function RoutingComponent(props) {
    ...
    var location =
        (_a = props.recipeRoutesInstance.getReactRouterDomWithCustomHistory()) === null || _a === void 0
            ? void 0
            : _a.useLocation();
    var rid = utils.getQueryParams("rid");
    ...
    if (history === undefined) {
        ...
        if (typeof rid === "string") {
            ...
            RecipeRouter.preBuiltUIList.forEach(function (c) {
                var _a;
                var routes =
                    (_a = c.getPathsToFeatureComponentWithRecipeIdMap) === null || _a === void 0
                        ? void 0
                        : _a.call(c)[normalizedPath.getAsStringDangerous()];
                var matchingRoute = routes.find(function (c) {
                    return c.matches();
                });
                if (matchingRoute !== undefined && matchedRoute_1.route === null) {
                    matchedRoute_1.recipe = c;
                    matchedRoute_1.route = matchingRoute;
                }
            });
            ...
            if (matchedRoute_1.route !== null && matchedRoute_1.recipe !== props.recipeRoutesInstance) {
                return null;
            }
        }
    }
