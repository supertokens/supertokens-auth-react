...
var SessionAuth = function (_a) {
    ...
    var children = _a.children,
        props = uiEntry.__rest(_a, ["children"]);
    ...
    var redirectToLogin = React.useCallback(function () {
        void uiEntry.SuperTokens.getInstanceOrThrow().redirectToAuth({ history: history, redirectBack: true });
    }, []);
                ...
                switch (_b.label) {
                    case 0:
                        if (session.current === undefined) {
                            session.current = uiEntry.Session.getInstanceOrThrow();
                        }
                        return [
                            4 /*yield*/,
                ...
                return uiEntry.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                uiEntry.getFailureRedirectionInfo({
                        ...
                        case 1:
                            ...
                            return [
                                4 /*yield*/,
                                uiEntry.SuperTokens.getInstanceOrThrow().redirectToUrl(
                        ...
                        case 3:
                            if (
                                ...
                                return [
                                    2 /*return*/,
                                    setContext(
                                        uiEntry.__assign(uiEntry.__assign({}, toSetContext), { accessDenied: true })
                                    ),
                                ];
                            }
                            _a.label = 4;
    ...
    uiEntry.useOnMountAPICall(buildContext, setInitialContextAndMaybeRedirect);
                    ...
                    return uiEntry.__generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 3:
                                ...
                                setContext(
                                    uiEntry.__assign(uiEntry.__assign({}, event.sessionContext), {
                                        loading: false,
                                        invalidClaims: invalidClaims,
                                    })
                                );
    ...
    if (!context.loading && context.accessDenied) {
        return jsxRuntime.jsx(uiEntry.AccessDeniedScreen, {
            recipe: uiEntry.Session.getInstanceOrThrow(),
            useComponentOverrides: uiEntry.useContext,
        });
    }
    return jsxRuntime.jsx(SessionContext.Provider, uiEntry.__assign({ value: context }, { children: children }));
};
var SessionAuthWrapper = function (props) {
    return jsxRuntime.jsx(
        ...
        uiEntry.__assign(
            ...
            { children: jsxRuntime.jsx(SessionAuth, uiEntry.__assign({}, props)) }
        )
    );
};
