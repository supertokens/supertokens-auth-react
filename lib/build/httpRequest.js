...
var HttpRequest = /** @class */ (function () {
    ...
    function HttpRequest(recipe) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                this.recipe.config.preAPIHook({ action: action, url: url, requestInit: requestInit }),
                            ];
                        case 1:
                            result = _b.sent();
        ...
        this.getFullUrl = function (pathStr, queryParams) {
            ...
            var fullUrl =
                "" +
                _this.recipe.config.appInfo.apiDomain.getAsStringDangerous() +
                _this.recipe.config.appInfo.apiBasePath.getAsStringDangerous() +
