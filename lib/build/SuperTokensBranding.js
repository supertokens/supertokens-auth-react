...
var AuthWidgetWrapper = function (props) {
    return jsxRuntime.jsx(
        ...
        thirdparty.__assign(
            ...
            { children: jsxRuntime.jsx(Redirector, thirdparty.__assign({}, props)) }
        )
    );
};
            ...
            if (sessionContext.loading === false) {
                if (sessionContext.doesSessionExist) {
                    if (props.onSessionAlreadyExists !== undefined) {
                        ...
                        void thirdparty.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(
                            {
