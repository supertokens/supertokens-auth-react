...
import type { TranslationContextType, TranslationControlEventSource, TranslationFunc, TranslationStore } from "./translationHelpers";
...
export declare const TranslationContextProvider: React.FC<PropsWithChildren<{
