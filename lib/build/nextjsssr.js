            ...
            return utils.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        cacheDurationMs = (_a = config === null || config === void 0 ? void 0 : config.cacheDurationMs) !== null && _a !== void 0 ? _a : this.defaultCacheDurationMs;
...
function jwtVerify(token, jwksUrl, config) {
    return utils.__awaiter(this, void 0, void 0, function () {
        var parts, headerB64, payloadB64, signatureB64, headerStr, header, kid, alg, jwks, matchingKey, publicKey, signatureInput, signature, algorithmsRecord, cryptoAlg, isValid, payloadStr, payload, now;
...
var SuperTokensNextjsSSRAPIWrapper = /** @class */ (function () {
     ...
     **/
    SuperTokensNextjsSSRAPIWrapper.getServerComponentSessionWithoutClaimValidation = function (cookies, requireAuth) {
        var _a;
        if (requireAuth === void 0) { requireAuth = false; }
        return utils.__awaiter(this, void 0, void 0, function () {
            var redirectPath, authPagePath, refreshLocation, _b, state, session, redirectPath_1;
                    ...
                    case 1:
                        ...
                        switch (state) {
                            ...
                            case "tokens-do-not-match":
                                ...
                                redirectPath_1 = requireAuth ? authPagePath : refreshLocation;
                                return [2 /*return*/, redirect(redirectPath_1)];
                            case "tokens-match":
     ...
     **/
    SuperTokensNextjsSSRAPIWrapper.getServerActionSessionWithoutClaimValidation = function (cookies) {
        return utils.__awaiter(this, void 0, void 0, function () {
     ...
     **/
    SuperTokensNextjsSSRAPIWrapper.getServerSidePropsSessionWithoutClaimValidation = function (request) {
        return utils.__awaiter(this, void 0, void 0, function () {
...
var getServerComponentSessionWithoutClaimValidation = SuperTokensNextjsSSRAPIWrapper.getServerComponentSessionWithoutClaimValidation;
var getServerActionSessionWithoutClaimValidation = SuperTokensNextjsSSRAPIWrapper.getServerActionSessionWithoutClaimValidation;
var getServerSidePropsSessionWithoutClaimValidation = SuperTokensNextjsSSRAPIWrapper.getServerSidePropsSessionWithoutClaimValidation;
...
function getSSRSessionState(cookies) {
    return utils.__awaiter(this, void 0, void 0, function () {
        ...
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    frontToken = getCookieValue(cookies, constants.FRONT_TOKEN_COOKIE_SESSION_COOKIE_NAME) ||
                        getCookieValue(cookies, constants.FRONT_TOKEN_HEADER_SESSION_HEADER_NAME);
                    if (!frontToken) {
                    ...
                    accessToken = getCookieValue(cookies, constants.ACCESS_TOKEN_COOKIE_SESSION_COOKIE_NAME) ||
                        getCookieValue(cookies, constants.ACCESS_TOKEN_HEADER_SESSION_COOKIE_NAME);
                    if (!accessToken) {
...
exports.getServerActionSessionWithoutClaimValidation = getServerActionSessionWithoutClaimValidation;
exports.getServerComponentSessionWithoutClaimValidation = getServerComponentSessionWithoutClaimValidation;
