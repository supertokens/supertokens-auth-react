...
var SuperTokensNextjsSSRAPIWrapper = /** @class */ (function () {
     ...
     **/
    SuperTokensNextjsSSRAPIWrapper.getSSRSession = function (cookies, redirect) {
        var _a;
...
var getSSRSession = SuperTokensNextjsSSRAPIWrapper.getSSRSession;
...
function getRefreshLocation(redirectPath) {
    ...
    return "/api/auth/session/refresh?".concat(constants.REDIRECT_PATH_PARAM_NAME, "=").concat(redirectPath);
}
    ...
    return logger.__awaiter(this, void 0, void 0, function () {
        ...
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    logger.logDebugMessage("Error while parsing access token: ".concat(err_1));
                    return [2 /*return*/, { isValid: false }];
...
exports.getSSRSession = getSSRSession;
