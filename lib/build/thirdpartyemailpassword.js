 ...
 * Component.
 */
var Header = session.withOverride("ThirdPartyEmailPasswordHeader", function ThirdPartyEmailPasswordHeader(_a) {
                                ...
                                children: [
                                    ...
                                    props.epChildProps !== undefined &&
                                        (props.epState.isSignUp
                                            ? jsxRuntime.jsx(
                                                  recipe.SignUpForm,
                                                  session.__assign({}, props.epChildProps.signUpForm, {
                                            ...
                                            : jsxRuntime.jsx(
                                                  recipe.SignInForm,
                                                  session.__assign({}, props.epChildProps.signInForm, {
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(SignInAndUpThemeWrapper, session.__assign({}, childProps)),
                                    props.children &&
...
function getRecipeImplementation(recipeInput) {
    var emailpasswordImpl = recipe.getRecipeImplementation(session.__assign({}, recipeInput));
...
function normaliseSignInUpFeatureConfig(config) {
    ...
    return session.__assign(session.__assign({}, config), {
...
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    session.__extends(ThirdPartyEmailPassword, _super);
