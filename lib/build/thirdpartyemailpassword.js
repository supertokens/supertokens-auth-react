 ...
 * Component.
 */
var Header = index.withOverride("ThirdPartyEmailPasswordHeader", function ThirdPartyEmailPasswordHeader(_a) {
     ...
     */
    if (isSignUp === true) {
        return jsxRuntime.jsx(recipe$1.SignUpHeader, {
            onClick: function () {
                return setIsSignUp(false);
            },
        });
    } else {
        return jsxRuntime.jsx(recipe$1.SignInHeader, {
            onClick: function () {
                                        ...
                                        (props.epState.isSignUp
                                            ? jsxRuntime.jsx(
                                                  ...
                                                  sessionAuth.__assign({}, props.epChildProps.signUpForm, {
                                                      footer: jsxRuntime.jsx(recipe$1.SignUpFooter, {
                                                          privacyPolicyLink:
                                            ...
                                            : jsxRuntime.jsx(
                                                  ...
                                                  sessionAuth.__assign({}, props.epChildProps.signInForm, {
                                                      footer: jsxRuntime.jsx(recipe$1.SignInFooter, {
...
var defaultTranslationsThirdPartyEmailPassword = {
    en: sessionAuth.__assign(
        sessionAuth.__assign(
            sessionAuth.__assign({}, recipe.defaultTranslationsThirdParty.en),
            recipe$1.defaultTranslationsEmailPassword.en
        ),
...
var SignInAndUp$1 = function (props) {
    var _a = recipe.useFeatureReducer(),
        tpState = _a[0],
        tpDispatch = _a[1];
    var _b = recipe$1.useFeatureReducer(props.recipe.emailPasswordRecipe),
        epState = _b[0],
        epDispatch = _b[1];
    ...
    var tpChildProps = recipe.useChildProps(props.recipe.thirdPartyRecipe);
    ...
    var epChildProps = recipe$1.useChildProps(
...
function getRecipeImplementation(recipeInput) {
    var emailpasswordImpl = recipe$1.getRecipeImplementation(sessionAuth.__assign({}, recipeInput));
    var thirdPartyImpl = recipe.getRecipeImplementation(sessionAuth.__assign({}, recipeInput));
    return {
...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.ResetPasswordUsingTokenTheme = recipe$1.ResetPasswordUsingTokenThemeWrapper;
    Wrapper.ThirdPartySignInAndUpCallbackTheme = recipe.SignInAndUpCallbackTheme;
...
exports.ResetPasswordUsingTokenTheme = recipe$1.ResetPasswordUsingTokenThemeWrapper;
exports.ThirdPartySignInAndUpCallbackTheme = recipe.SignInAndUpCallbackTheme;
