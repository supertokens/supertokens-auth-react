 ...
 * Component.
 */
var Header = querier.withOverride("ThirdPartyEmailPasswordHeader", function ThirdPartyEmailPasswordHeader(_a) {
                            ...
                            { "data-supertokens": "row" },
                            {
                                children: [
                                    ...
                                    props.commonState.error &&
                                        jsxRuntime.jsx(querier.GeneralError, { error: props.commonState.error }),
                                    ...
                                    props.epChildProps !== undefined &&
                                        (props.epState.isSignUp
                                            ? jsxRuntime.jsx(
                                                  recipe.SignUpForm,
                                                  assets.__assign({}, props.epChildProps.signUpForm, {
                                            ...
                                            : jsxRuntime.jsx(
                                                  recipe.SignInForm,
                                                  assets.__assign({}, props.epChildProps.signInForm, {
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(SignInAndUpThemeWrapper, assets.__assign({}, childProps)),
                                    props.children &&
...
function getRecipeImplementation(recipeInput) {
    var emailpasswordImpl = recipe.getRecipeImplementation(assets.__assign({}, recipeInput));
...
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    assets.__extends(ThirdPartyEmailPassword, _super);
    function ThirdPartyEmailPassword(config, recipes) {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.emailPasswordRecipe !== undefined) {
                features = assets.__assign(assets.__assign({}, features), _this.emailPasswordRecipe.getFeatures());
            }
