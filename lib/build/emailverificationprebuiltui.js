...
var EmailVerificationSendVerifyEmail = function (props) {
    ...
    superTokens.useOnMountAPICall(sendVerificationEmail, checkSendResponse, handleSendError);
...
var EmailVerificationVerifyEmailLinkClicked = function (props) {
    ...
    superTokens.useOnMountAPICall(verifyEmailOnMount, handleVerifyResp, handleError, sessionContext.loading === false);
...
var EmailVerification$1 = function (props) {
    ...
    var modifiedRecipeImplementation = React.useMemo(function () { return (logger.__assign(logger.__assign({}, props.recipe.webJSRecipe), { sendVerificationEmail: function (input) { return logger.__awaiter(void 0, void 0, void 0, function () {
            ...
            return logger.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        superTokens.clearQueryParams(["token"]);
        ...
        return logger.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    token = (_a = superTokens.getQueryParams("token")) !== null && _a !== void 0 ? _a : undefined;
    ...
    superTokens.useOnMountAPICall(fetchIsEmailVerified, checkIsEmailVerified, handleError, sessionContext.loading === false);
    ...
    var token = (_a = superTokens.getQueryParams("token")) !== null && _a !== void 0 ? _a : undefined;
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: translations.defaultTranslationsEmailVerification }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(EmailVerificationThemeWrapper, logger.__assign({}, childProps)), props.children &&
