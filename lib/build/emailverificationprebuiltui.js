...
var EmailVerificationSendVerifyEmail = function (props) {
            ...
            return uiEntry.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            uiEntry.Session.getInstanceOrThrow().doesSessionExist({ userContext: userContext }),
                        ];
                    case 1:
    ...
    uiEntry.useOnMountAPICall(sendVerificationEmail, checkSendResponse, handleSendError);
    return jsxRuntime.jsx(
        "div",
        uiEntry.__assign(
                            ...
                            uiEntry.__assign(
                                ...
                                },
                                {
                                    children: jsxRuntime.jsx(
                                        "tspan",
                                        uiEntry.__assign({ x: "0", y: "0" }, { children: "!" })
                                    ),
                                }
                            )
                        ),
...
var EmailVerificationVerifyEmailLinkClicked = function (props) {
    ...
    uiEntry.useOnMountAPICall(verifyEmailOnMount, handleVerifyResp, handleError, sessionContext.loading === false);
...
function EmailVerificationTheme(props) {
    ...
    if (props.verifyEmailLinkClickedScreen === undefined) {
        return jsxRuntime.jsx(SendVerifyEmail, uiEntry.__assign({}, props.sendVerifyEmailScreen));
    }
    // Otherwise, return VerifyEmailLinkClicked.
    return jsxRuntime.jsx(VerifyEmailLinkClicked, uiEntry.__assign({}, props.verifyEmailLinkClickedScreen));
}
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    uiEntry.__assign(
                        ...
                        { children: jsxRuntime.jsx(EmailVerificationTheme, uiEntry.__assign({}, props)) }
                    )
                ),
            }
        )
...
var EmailVerification$1 = function (props) {
    ...
    var modifiedRecipeImplementation = React.useMemo(
        function () {
            return uiEntry.__assign(uiEntry.__assign({}, props.recipe.webJSRecipe), {
                    ...
                    return uiEntry.__awaiter(void 0, void 0, void 0, function () {
                        ...
                        return uiEntry.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    response = _a.sent();
                                    uiEntry.clearQueryParams(["token"]);
                ...
                return uiEntry.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            token = (_a = uiEntry.getQueryParams("token")) !== null && _a !== void 0 ? _a : undefined;
        ...
        function () {
            return uiEntry.__awaiter(void 0, void 0, void 0, function () {
                ...
                return uiEntry.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            session = uiEntry.Session.getInstanceOrThrow();
    ...
    var token = (_a = uiEntry.getQueryParams("token")) !== null && _a !== void 0 ? _a : undefined;
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(EmailVerificationThemeWrapper, uiEntry.__assign({}, childProps)),
                                    props.children &&
...
var EmailVerificationPreBuiltUI = /** @class */ (function (_super) {
    uiEntry.__extends(EmailVerificationPreBuiltUI, _super);
