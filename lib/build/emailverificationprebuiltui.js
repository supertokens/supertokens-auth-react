...
var EmailVerificationSendVerifyEmail = function (props) {
            ...
            return thirdparty.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            thirdparty.Session.getInstanceOrThrow().doesSessionExist({ userContext: userContext }),
                        ];
                    case 1:
    ...
    thirdparty.useOnMountAPICall(sendVerificationEmail, checkSendResponse, handleSendError);
    return jsxRuntime.jsx(
        "div",
        thirdparty.__assign(
                            ...
                            thirdparty.__assign(
                                ...
                                },
                                {
                                    children: jsxRuntime.jsx(
                                        "tspan",
                                        thirdparty.__assign({ x: "0", y: "0" }, { children: "!" })
                                    ),
                                }
                            )
                        ),
...
var EmailVerificationVerifyEmailLinkClicked = function (props) {
    ...
    thirdparty.useOnMountAPICall(verifyEmailOnMount, handleVerifyResp, handleError, sessionContext.loading === false);
...
function EmailVerificationTheme(props) {
    ...
    if (props.verifyEmailLinkClickedScreen !== undefined) {
        return jsxRuntime.jsx(VerifyEmailLinkClicked, thirdparty.__assign({}, props.verifyEmailLinkClickedScreen));
    }
    ...
    if (sessionContext.loading === false && sessionContext.doesSessionExist === true) {
        return jsxRuntime.jsx(SendVerifyEmail, thirdparty.__assign({}, props.sendVerifyEmailScreen));
    }
            ...
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
                    ...
                    thirdparty.__assign(
                        ...
                        { children: jsxRuntime.jsx(EmailVerificationTheme, thirdparty.__assign({}, props)) }
                    )
                ),
            }
        )
...
var EmailVerification$1 = function (props) {
    ...
    var modifiedRecipeImplementation = React.useMemo(
        function () {
            return thirdparty.__assign(thirdparty.__assign({}, props.recipe.webJSRecipe), {
                    ...
                    return thirdparty.__awaiter(void 0, void 0, void 0, function () {
                        ...
                        return thirdparty.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    response = _a.sent();
                                    thirdparty.clearQueryParams(["token"]);
                ...
                return thirdparty.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            token =
                                (_a = thirdparty.getQueryParams("token")) !== null && _a !== void 0 ? _a : undefined;
        ...
        function () {
            return thirdparty.__awaiter(void 0, void 0, void 0, function () {
                ...
                return thirdparty.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            session = thirdparty.Session.getInstanceOrThrow();
    ...
    var token = (_a = thirdparty.getQueryParams("token")) !== null && _a !== void 0 ? _a : undefined;
...
var EmailVerificationPreBuiltUI = /** @class */ (function (_super) {
    thirdparty.__extends(EmailVerificationPreBuiltUI, _super);
                    ...
                    { userContext: props.userContext },
                    {
                        children: jsxRuntime.jsx(
                            ...
                            thirdparty.__assign(
                                ...
                                {
                                    children: jsxRuntime.jsx(userContextWrapper.UserContextContext.Consumer, {
