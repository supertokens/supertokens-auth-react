...
var EmailVerificationSendVerifyEmail = function (props) {
    ...
    var resendEmail = function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        var response, e_1;
    ...
    var logout = function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        var e_2;
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var checkSendResponse = React.useCallback(function (response) { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleSendError = React.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
...
var EmailVerificationVerifyEmailLinkClicked = function (props) {
    ...
    var verifyEmailOnMount = React.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(this, function (_a) {
    ...
    var handleVerifyResp = React.useCallback(function (response) { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(this, function (_a) {
...
function EmailVerificationTheme(props) {
    ...
    if (props.verifyEmailLinkClickedScreen !== undefined) {
        return jsxRuntime.jsx(VerifyEmailLinkClicked, logger.__assign({}, props.verifyEmailLinkClickedScreen));
    }
    ...
    if (sessionContext.loading === false && sessionContext.doesSessionExist === true) {
        return jsxRuntime.jsx(SendVerifyEmail, logger.__assign({}, props.sendVerifyEmailScreen));
    }
...
function EmailVerificationThemeWrapper(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(translations.ThemeBase, logger.__assign({ userStyles: [
                rootStyle,
            ...
            ] }, { children: jsxRuntime.jsx(EmailVerificationTheme, logger.__assign({}, props)) })) })));
}
...
var EmailVerification$1 = function (props) {
    ...
    var redirectToAuthWithHistory = React.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    var modifiedRecipeImplementation = React.useMemo(function () { return (logger.__assign(logger.__assign({}, props.recipe.webJSRecipe), { sendVerificationEmail: function (input) { return logger.__awaiter(void 0, void 0, void 0, function () {
            var response;
            return logger.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    var onSuccess = React.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(this, function (_a) {
    ...
    var fetchIsEmailVerified = React.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        var token;
        var _a;
    ...
    var checkIsEmailVerified = React.useCallback(function (isVerified) { return logger.__awaiter(void 0, void 0, void 0, function () {
        return logger.__generator(this, function (_a) {
            if (isVerified) {
    ...
    var signOut = React.useCallback(function () { return logger.__awaiter(void 0, void 0, void 0, function () {
        var session;
        return logger.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, logger.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, logger.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: translations.defaultTranslationsEmailVerification }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(EmailVerificationThemeWrapper, logger.__assign({}, childProps)), props.children &&
...
var EmailVerificationPreBuiltUI = /** @class */ (function (_super) {
    logger.__extends(EmailVerificationPreBuiltUI, _super);
    function EmailVerificationPreBuiltUI(recipeInstance) {
        ...
        _, props, useComponentOverrides) {
            ...
            return (jsxRuntime.jsx(uiEntry.UserContextWrapper, logger.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, logger.__assign({ requireAuth: false, overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(uiEntry.UserContextContext.Consumer, { children: function (value) {
                            return (jsxRuntime.jsx(EmailVerification$1, logger.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides }, logger.__assign(logger.__assign({}, props), { 
