...
var SendVerifyEmail = recipe.withOverride("EmailVerificationSendVerifyEmail", EmailVerificationSendVerifyEmail);
...
var VerifyEmailLinkClicked = recipe.withOverride(
...
var EmailVerification$1 = function (props) {
    ...
    var modifiedRecipeImplementation = React.useMemo(
        function () {
            return utils.__assign(utils.__assign({}, props.recipe.webJSRecipe), {
                    ...
                    { userContext: props.userContext },
                    {
                        children: jsxRuntime.jsx(
                            ...
                            utils.__assign(
                                ...
                                {
                                    children: jsxRuntime.jsx(recipe.UserContextContext.Consumer, {
