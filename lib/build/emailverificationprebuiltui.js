...
var EmailVerificationSendVerifyEmail = function (props) {
    ...
    var resendEmail = function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        var response, e_1;
    ...
    var logout = function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        var e_2;
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var checkSendResponse = React.useCallback(function (response) { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var handleSendError = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
...
var EmailVerificationVerifyEmailLinkClicked = function (props) {
    ...
    var verifyEmailOnMount = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
    ...
    var handleVerifyResp = React.useCallback(function (response) { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
    ...
    if (status === "INTERACTION_REQUIRED") {
        return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "container" }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "row noFormRow" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle" }, { children: t("EMAIL_VERIFICATION_LINK_CLICKED_HEADER") })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("EMAIL_VERIFICATION_LINK_CLICKED_DESC") })), jsxRuntime.jsx(button.Button, { isLoading: verifyLoading, onClick: function () { return utils.__awaiter(void 0, void 0, void 0, function () {
                            var resp, err_1;
                            return utils.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
...
function EmailVerificationThemeWrapper(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(translations.ThemeBase, utils.__assign({ userStyles: [
                rootStyle,
...
var EmailVerification$1 = function (props) {
    ...
    var redirectToAuthWithHistory = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
    ...
    var modifiedRecipeImplementation = React.useMemo(function () { return (utils.__assign(utils.__assign({}, props.recipe.webJSRecipe), { sendVerificationEmail: function (input) { return utils.__awaiter(void 0, void 0, void 0, function () {
            var response;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    var onSuccess = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
    ...
    var fetchIsEmailVerified = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        var token;
        var _a;
    ...
    var checkIsEmailVerified = React.useCallback(function (isVerified) { return utils.__awaiter(void 0, void 0, void 0, function () {
        return utils.__generator(this, function (_a) {
            if (isVerified) {
    ...
    var signOut = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        var session;
        return utils.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: translations.defaultTranslationsEmailVerification }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(EmailVerificationThemeWrapper, utils.__assign({}, childProps)), props.children &&
...
var EmailVerificationPreBuiltUI = /** @class */ (function (_super) {
    ...
    function EmailVerificationPreBuiltUI(recipeInstance) {
        ...
        _, props, useComponentOverrides) {
            if (useComponentOverrides === void 0) { useComponentOverrides = componentOverrideContext.useContext; }
            return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, utils.__assign({ requireAuth: false, overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(uiEntry.UserContextContext.Consumer, { children: function (value) {
                            return (jsxRuntime.jsx(EmailVerification$1, utils.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides }, utils.__assign(utils.__assign({}, props), { 
