            ...
            return superTokens.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            superTokens.Session.getInstanceOrThrow().doesSessionExist({ userContext: userContext }),
                        ];
                    case 1:
                            ...
                            superTokens.__assign(
                                ...
                                },
                                {
                                    children: jsxRuntime.jsx(
                                        "tspan",
                                        superTokens.__assign({ x: "0", y: "0" }, { children: "!" })
                                    ),
                                }
                            )
                        ),
...
function EmailVerificationTheme(props) {
    ...
    if (props.verifyEmailLinkClickedScreen === undefined) {
        return jsxRuntime.jsx(SendVerifyEmail, superTokens.__assign({}, props.sendVerifyEmailScreen));
    }
    // Otherwise, return VerifyEmailLinkClicked.
    return jsxRuntime.jsx(VerifyEmailLinkClicked, superTokens.__assign({}, props.verifyEmailLinkClickedScreen));
}
...
var EmailVerification$1 = function (props) {
    ...
    var modifiedRecipeImplementation = React.useMemo(
        function () {
            return superTokens.__assign(superTokens.__assign({}, props.recipe.webJSRecipe), {
                ...
                return superTokens.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            token =
                                (_a = superTokens.getQueryParams("token")) !== null && _a !== void 0 ? _a : undefined;
        ...
        function () {
            return superTokens.__awaiter(void 0, void 0, void 0, function () {
                ...
                return superTokens.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            session = superTokens.Session.getInstanceOrThrow();
...
var EmailVerificationPreBuiltUI = /** @class */ (function (_super) {
    superTokens.__extends(EmailVerificationPreBuiltUI, _super);
