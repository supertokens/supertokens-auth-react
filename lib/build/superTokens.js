...
var SuperTokens = /** @class */ (function () {
    ...
    SuperTokens.prototype.initMultitenancyWithDynamicLoginMethods = function (config) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        tenantID =
                            (_c = (_b = multitenancyInstance.config).getTenantID) === null || _c === void 0
                                ? void 0
                                : _c.call(_b);
                        return [4 /*yield*/, Multitenancy.getDynamicLoginMethods({ tenantId: tenantID })];
                    case 1:
                        tenantMethods = _d.sent();
                        hasIntersection = hasIntersectingRecipes(
                            tenantMethods,
