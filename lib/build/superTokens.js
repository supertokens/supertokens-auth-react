...
var _session = _interopRequireDefault(require("./recipe/session/session"));
...
var SuperTokens = /*#__PURE__*/ (function() {
    ...
    function SuperTokens(config) {
        ...
        this.canHandleRoute = function() {
            return _this.getRoutingComponent(true) !== undefined;
        };

        this.getRoutingComponent = function(noRedirect) {
            ...
            if (Component === undefined) {
                var basePath = _this.getAppInfo().websiteBasePath.getAsStringDangerous();

                if (normalisedPath.getAsStringDangerous().startsWith(basePath)) {
                    if (noRedirect !== true) {
                        (0, _utils.redirectToInApp)(basePath);
                    }
        ...
        this.getDefaultSessionRecipe = function() {
            return _this.getRecipeList().find(function(recipe) {
                return recipe.getRecipeId() === _session["default"].RECIPE_ID;
            });
        };
    ...
    _createClass(SuperTokens, null, [
        ...
        {
            key: "getDefaultSessionRecipe",
            value: function getDefaultSessionRecipe() {
