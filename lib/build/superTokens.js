...
var RecipeRouter = /** @class */ (function () {
    ...
    RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList = function (normalisedUrl, preBuiltUIList) {
        ...
        var componentMatchingRid = exports.__assign(
            {
        ...
        if (
            component &&
            ((_a = componentMatchingRid[component.recipeID]) === null || _a === void 0 ? void 0 : _a.enabled) === true
        ) {
            return component;
        }
        var _loop_1 = function (id) {
            ...
            if (
                ...
                ((_b = componentMatchingRid[id]) === null || _b === void 0 ? void 0 : _b.enabled) === true
            ) {
                return { value: matching };
            }
        };
        for (var id in componentMatchingRid) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        instance.dynamicLoginMethods = {
                            ...
                            emailpassword: exports.__assign(exports.__assign({}, emailPassword), { enabled: false }),
