...
function normaliseMultitenancyConfig(config) {
    return utils.__assign(utils.__assign({}, normaliseRecipeModuleConfig(config)), {
...
var getTranslationFunction = function () {
    ...
    var _a = SuperTokens.getInstanceOrThrow().languageTranslations,
        translationEventSource = _a.translationEventSource,
        userTranslationFunc = _a.userTranslationFunc,
        defaultLanguage = _a.defaultLanguage,
        userTranslationStore = _a.userTranslationStore;
    var _store = utils
        .__spreadArray(utils.__spreadArray([defaultTranslationsCommon], stores, true), [userTranslationStore], false)
        .reduce(utils.mergeObjects, {});
    ...
    var translate = function (key, replacements) {
        ...
        if (getLanguage() !== undefined) {
            ...
            return res.replace(/{(\w+)}/g, function (match, p1) {
...
var SuperTokens = /** @class */ (function () {
                        ...
                        case 0:
                            ...
                            if (options.redirectBack === true) {
                                queryParams.redirectToPath =
                                    utils.getCurrentNormalisedUrlPathWithQueryParamsAndFragments();
                            }
                            return [
                                4 /*yield*/,
                                this.getRedirectUrl(
        ...
        for (var _i = 0, plugins_1 = plugins; _i < plugins_1.length; _i++) {
            ...
            if (plugin.overrideMap !== undefined) {
                for (var _j = 0, _k = Object.keys(plugin.overrideMap); _j < _k.length; _j++) {
                    var t = _k[_j];
                    this.componentOverrides[t] = utils.__assign(
                        utils.__assign({}, this.componentOverrides[t]),
                        (_b = (_a = plugin.overrideMap[t]) === null || _a === void 0 ? void 0 : _a.components) !==
                            null && _b !== void 0
                            ? _b
                            : {}
                    );
            ...
            this.componentOverrides.authRecipe = utils.__assign(
                utils.__assign({}, (_c = this.componentOverrides.authRecipe) !== null && _c !== void 0 ? _c : {}),
                (_d = plugin.generalAuthRecipeComponentOverrides) !== null && _d !== void 0 ? _d : {}
            );
        }
    ...
    SuperTokens.init = function (config) {
        ...
        var publicConfig = utils.getPublicConfig(
            utils.__assign(utils.__assign({}, config), { appInfo: normalisedAppInfo })
        );
        var finalPluginList = [];
        if ((_b = config.experimental) === null || _b === void 0 ? void 0 : _b.plugins) {
            for (var _i = 0, _c = config.experimental.plugins; _i < _c.length; _i++) {
                ...
                if (plugin.compatibleAuthReactSDKVersions) {
                    var versionCheck = isVersionCompatible(
                    ...
                    if (!versionCheck) {
                        throw new Error(
                            "Incompatible SDK version for plugin "
                                ...
                                .concat(utils.package_version, '" not found in compatible versions: ')
                                .concat(JSON.stringify(plugin.compatibleAuthReactSDKVersions))
                        );
                    }
                }
                if (plugin.dependencies) {
                    var result = plugin.dependencies(
                        publicConfig,
                        finalPluginList.map(utils.getPublicPlugin),
                        utils.package_version
                    );
                    if (result.status === "ERROR") {
                        throw new Error(result.message);
        ...
        SuperTokensWebJS__default.default.init(
            utils.__assign(utils.__assign({}, config), {
                ...
                experimental: {
                    plugins: finalPluginList.map(function (plugin) {
                        return {
                            id: plugin.id,
        ...
        SuperTokens.instance = new SuperTokens(
            utils.__assign(utils.__assign({}, config), { recipeList: recipes }),
            finalPluginList
        );
                            ...
                            if (context.tenantIdFromQueryParams) {
                                return [
                                    ...
                                    utils.appendQueryParamsToURL(
                                        basePath,
                                        ((_b = {}),
                                        (_b[utils.TENANT_ID_QUERY_PARAM] = context.tenantIdFromQueryParams),
                                        _b)
                                    ),
                                ];
                            }
