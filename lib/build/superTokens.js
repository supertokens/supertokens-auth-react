...
var RecipeRouter = /** @class */ (function () {
    ...
    RecipeRouter.getMatchingComponentForRouteAndRecipeIdFromPreBuiltUIList = function (normalisedUrl, preBuiltUIList) {
        ...
        var dynamicLoginMethods =
            SuperTokens$1.usesDynamicLoginMethods === true
                ? Multitenancy.getInstanceOrThrow().getLoadedDynamicLoginMethods()
                : undefined;
        if (SuperTokens$1.usesDynamicLoginMethods && dynamicLoginMethods === undefined) {
            return;
        }
        ...
        if (
            ...
            ((_a = possiblyEnabledRecipes[componentMatchingRid.recipeID]) === null || _a === void 0
                ? void 0
                : _a.enabled) === true
        ) {
