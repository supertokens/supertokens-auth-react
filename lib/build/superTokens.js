                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            return [
                                2 /*return*/,
                                SuperTokens$1.getInstanceOrThrow().redirectToUrl(invalidClaimRedirectPath, history),
                            ];
                        case 5:
    ...
    var _loop_2 = function (tenantProvider) {
        ...
        if (provider !== undefined) {
            ...
            if (builtInProvidersMap[providerID]) {
                var provider_1 = builtInProvidersMap[providerID].init();
                providers.push({
                    id: tenantProvider.id,
...
var Multitenancy = /** @class */ (function (_super) {
    ...
    Multitenancy.prototype.getDynamicLoginMethods = function () {
    ...
    Multitenancy.getDynamicLoginMethods = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var instance, _a, emailPassword, passwordless;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        (_a = _b.sent()), (emailPassword = _a.emailPassword), (passwordless = _a.passwordless);
