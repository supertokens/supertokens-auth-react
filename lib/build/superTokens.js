...
var SuperTokens = /** @class */ (function() {
    ...
    function SuperTokens(config) {
        ...
        this.getRoutingComponent = function() {
            ...
            var componentWithRecipeId = _this.getMatchingComponentForRouteAndRecipeId(normalisedPath, recipeId);
            if (componentWithRecipeId === undefined) {
                return undefined;
            }
            return React.createElement(componentWithRecipeId.component, { recipeId: componentWithRecipeId.rid });
        };
        ...
        this.getDefaultSessionRecipe = function() {
            return _this.recipeList.find(function(recipe) {
