...
var SuperTokens = /** @class */ (function () {
    ...
    function SuperTokens(config) {
        ...
        this.getRoutingComponent = function () {
            ...
            return React.createElement(FeatureComponentWithRecipeId.component, { recipeId: FeatureComponentWithRecipeId.rid });
        };
        ...
        this.getMatchingComponentForRouteAndRecipeId = function (normalisedUrl) {
            ...
            var component = routeComponents.find(function (c) { return c.matches(); });
    ...
    SuperTokens.getSuperTokensRoutesForReactRouterDom = function (reactRouterDom) {
        ...
        return superTokensRoute_1.getSuperTokensRoutesForReactRouterDom();
    };
