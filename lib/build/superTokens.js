...
var SuperTokens = /** @class */ (function () {
    ...
    function SuperTokens(config) {
        var _this = this;
        this.translationEventSource = new translationHelpers_1.TranslationController();
        this.recipeList = [];
        /*
         * Instance Methods.
         */
        ...
        this.currentLanguageCookieScope =
            config.currentLanguageCookieScope !== undefined
                ? utils_1.normaliseCookieScopeOrThrowError(config.currentLanguageCookieScope)
    ...
    SuperTokens.prototype.changeLanguage = function (lang) {
        translationHelpers_1.saveCurrentLanguage(lang, this.currentLanguageCookieScope);
