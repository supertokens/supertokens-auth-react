...
var SuperTokens = /** @class */ (function () {
    ...
    SuperTokens.getSuperTokensRoutesForReactRouterDom = function (reactRouterDom) {
        ...
        if (SuperTokens.reactRouterDomIsV6) {
            ...
            SuperTokens.reactRouterDom.withRouter = function (Child) {
                return function (props) {
                    var history = superTokensRouteV6_1.useNavigateHookForRRDV6(reactRouterDom);
                    return React.createElement(Child, __assign({}, props, { history: history }));
                };
            };
