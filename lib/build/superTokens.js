...
var getSuperTokensRoutesForReactRouterDom = require("./components/superTokensRoute").getSuperTokensRoutesForReactRouterDom;
...
var SuperTokens = /** @class */ (function () {
    ...
    function SuperTokens(config) {
        ...
        if (config.recipeList === undefined || config.recipeList.length === 0) {
            throw new Error("Please provide at least one recipe to the supertokens.init function call. See https://supertokens.io/docs/emailpassword/starter-guide/frontend");
        }
