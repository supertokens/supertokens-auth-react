...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.resyncSessionAndFetchMFAInfo = function (input) {
        return recipe.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.resyncSessionAndFetchMFAInfo(utils.__assign(utils.__assign({}, input), { userContext: utils.getNormalisedUserContext(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    ...
    Wrapper.getSecondaryFactors = function (input) {
        return recipe.MultiFactorAuth.getInstanceOrThrow().getSecondaryFactors(utils.getNormalisedUserContext(input.userContext));
    };
