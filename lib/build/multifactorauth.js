...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.redirectToFactor = function (factorId, forceSetup, redirectBack, history, userContext) {
    ...
    Wrapper.redirectToFactorChooser = function (redirectBack, nextFactorOptions, history, userContext) {
        if (redirectBack === void 0) {
            redirectBack = true;
        }
