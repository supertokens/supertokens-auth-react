...
function normaliseThirdPartyPasswordlessConfig(config) {
    ...
    return sessionAuth.__assign(sessionAuth.__assign({}, authWidgetWrapper.normaliseAuthRecipe(config)), {
        ...
        passwordlessConfig: disablePasswordless
            ? undefined
            : recipe.normalisePasswordlessConfig({
 ...
 * Component.
 */
var Header = genericComponentOverrideContext.withOverride(
    "ThirdPartyPasswordlessHeader",
    function ThirdPartyPasswordlessHeader() {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.passwordlessRecipe !== undefined) {
                features = sessionAuth.__assign(
                    ...
                    _this.passwordlessRecipe.getFeatures()
                );
            }
            if (_this.thirdPartyRecipe !== undefined) {
                features = sessionAuth.__assign(
                    sessionAuth.__assign({}, features),
                    _this.thirdPartyRecipe.getFeatures()
                );
            }
            if (
                (_this.config.passwordlessConfig !== undefined &&
                    ((_a = _this.config.passwordlessConfig.signInUpFeature) === null || _a === void 0
                        ? void 0
                        : _a.disableDefaultUI) !== true) ||
                (_this.config.thirdpartyConfig !== undefined &&
                    ((_b = _this.config.thirdpartyConfig.signInAndUpFeature) === null || _b === void 0
                        ? void 0
            ...
            if (componentName === "signInUp") {
                if (props.redirectOnSessionExists !== false) {
                    ...
                    return jsxRuntime.jsx(
                        ...
                        sessionAuth.__assign(
                            { userContext: props.userContext },
                            { children: jsxRuntime.jsx(SignInAndUp$1, sessionAuth.__assign({ recipe: _this }, props)) }
                        )
                    );
                }
        ...
        _this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : new recipe.Passwordless(
                      sessionAuth.__assign(sessionAuth.__assign({}, _this.config.passwordlessConfig), {
        ...
        _this.thirdPartyRecipe =
            recipes.thirdPartyInstance !== undefined
                ...
                : new thirdparty.ThirdParty(
                      sessionAuth.__assign(sessionAuth.__assign({}, _this.config.thirdpartyConfig), {
                          appInfo: _this.config.appInfo,
                          recipeId: _this.config.recipeId,
                      }),
    ...
    Wrapper.getAuthorisationURLFromBackend = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.getAuthorisationURLFromBackend(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.thirdPartySignInAndUp = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.thirdPartySignInAndUp(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.setThirdPartyStateAndOtherInfoToStorage = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.setThirdPartyStateAndOtherInfoToStorage(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.getThirdPartyAuthorisationURLWithQueryParamsAndSetState = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.getThirdPartyAuthorisationURLWithQueryParamsAndSetState(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.verifyAndGetThirdPartyStateOrThrowError = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.verifyAndGetThirdPartyStateOrThrowError(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.doesPasswordlessUserEmailExist = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.doesPasswordlessUserEmailExist(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.doesPasswordlessUserPhoneNumberExist = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.doesPasswordlessUserPhoneNumberExist(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(input.userContext),
                        })
                    ),
    ...
    Wrapper.getPasswordlessLoginAttemptInfo = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.getPasswordlessLoginAttemptInfo(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.setPasswordlessLoginAttemptInfo = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.setPasswordlessLoginAttemptInfo(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
    ...
    Wrapper.clearPasswordlessLoginAttemptInfo = function (input) {
        return sessionAuth.__awaiter(this, void 0, void 0, function () {
            return sessionAuth.__generator(this, function (_a) {
                return [
                    2 /*return*/,
                    ThirdPartyPasswordless.getInstanceOrThrow().webJSRecipe.clearPasswordlessLoginAttemptInfo(
                        sessionAuth.__assign(sessionAuth.__assign({}, input), {
                            userContext: sessionAuth.getNormalisedUserContext(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
