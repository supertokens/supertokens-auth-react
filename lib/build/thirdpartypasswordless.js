 ...
 * Component.
 */
var Header = index.withOverride("ThirdPartyPasswordlessHeader", function ThirdPartyPasswordlessHeader() {
...
var defaultTranslationsThirdPartyPasswordless = {
    en: sessionAuth.__assign(
        sessionAuth.__assign(
            sessionAuth.__assign({}, recipe$1.defaultTranslationsThirdParty.en),
...
var SignInAndUp$1 = function (props) {
    var _a;
    var _b = recipe$1.useFeatureReducer(),
        tpState = _b[0],
        tpDispatch = _b[1];
    ...
    var tpChildProps = recipe$1.useChildProps(props.recipe.thirdPartyRecipe);
...
function getRecipeImplementation(recipeInput) {
    ...
    var thirdPartyImpl = recipe$1.getRecipeImplementation(sessionAuth.__assign({}, recipeInput));
    return {
