 ...
 * Component.
 */
var Header = session.withOverride("ThirdPartyPasswordlessHeader", function ThirdPartyPasswordlessHeader() {
...
var SignInUpTheme = function (props) {
    ...
    if (props.activeScreen === recipe.SignInUpScreens.CloseTab) {
        return jsxRuntime.jsx(recipe.CloseTabScreen, session.__assign({}, props.pwlessChildProps));
    } else if (props.activeScreen === recipe.SignInUpScreens.LinkSent) {
        return jsxRuntime.jsx(
            recipe.LinkSent,
            session.__assign({}, getCommonPwlessProps(props.pwlessChildProps, props), {
                                        ...
                                        children: [
                                            ...
                                            props.tpChildProps !== undefined &&
                                                ...
                                                jsxRuntime.jsx(
                                                    ...
                                                    session.__assign({}, props.tpChildProps, {
...
function SignInUpThemeWrapper(props) {
    ...
    return jsxRuntime.jsx(
        ...
        session.__assign(
            ...
            { children: jsxRuntime.jsx(SignInUpTheme, session.__assign({}, childProps)) }
        )
    );
}
...
var defaultTranslationsThirdPartyPasswordless = {
    en: session.__assign(
        session.__assign(
            session.__assign({}, thirdparty.defaultTranslationsThirdParty.en),
    ...
    var _d = React__namespace.useReducer(
            function (state, action) {
                switch (action.type) {
                    ...
                    case "startLogin":
                    case "resendCode":
                        return session.__assign(session.__assign({}, state), { error: undefined });
                    case "load":
                        if (action.loginAttemptInfo !== undefined) {
                            return session.__assign(session.__assign({}, state), { error: action.error });
                        }
                        return session.__assign(session.__assign({}, state), {
                            ...
                            children: jsxRuntime.jsxs(React.Fragment, {
                                children: [
                                    props.children === undefined &&
                                        jsxRuntime.jsx(SignInUpThemeWrapper, session.__assign({}, childProps)),
                                    props.children &&
...
function getRecipeImplementation(recipeInput) {
    var passwordlessImpl = recipe.getRecipeImplementation(session.__assign({}, recipeInput));
    var thirdPartyImpl = thirdparty.getRecipeImplementation(session.__assign({}, recipeInput));
    return {
    ...
    return session.__assign(session.__assign({}, utils.normaliseAuthRecipe(config)), {
        ...
        thirdpartyUserInput: disableThirdParty
            ...
            : {
                  ...
                  signInAndUpFeature: session.__assign(session.__assign({}, config.signInUpFeature), {
        ...
        passwordlessUserInput: disablePasswordless
            ...
            : {
                  ...
                  preAPIHook: config.preAPIHook,
                  useShadowDom: config.useShadowDom,
                  signInUpFeature: session.__assign(session.__assign({}, config.signInUpFeature), {
...
var ThirdPartyPasswordless = /** @class */ (function (_super) {
    session.__extends(ThirdPartyPasswordless, _super);
    function ThirdPartyPasswordless(config, recipes) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            ...
            if (_this.passwordlessRecipe !== undefined) {
                features = session.__assign(
                    session.__assign({}, features),
            ...
            return session.__assign({}, features);
        };
        ...
        _this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : new recipe.Passwordless(
                      session.__assign(session.__assign({}, _this.config.passwordlessUserInput), {
                          appInfo: _this.config.appInfo,
                          recipeId: _this.config.recipeId,
                          override: session.__assign(
                              session.__assign({}, _this.config.passwordlessUserInput.override),
                              {
                                  functions: function () {
        ...
        _this.thirdPartyRecipe =
            recipes.thirdPartyInstance !== undefined
                ...
                : new thirdparty.ThirdParty(
                      session.__assign(session.__assign({}, _this.config.thirdpartyUserInput), {
                          appInfo: _this.config.appInfo,
                          recipeId: _this.config.recipeId,
                          override: session.__assign(session.__assign({}, _this.config.thirdpartyUserInput.override), {
                              functions: function () {
