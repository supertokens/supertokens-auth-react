...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.authenticateCredentialWithSignIn = function (input) {
        return componentOverrideContext.Webauthn.getInstanceOrThrow().webJSRecipe.authenticateCredentialWithSignIn(input);
    };
    Wrapper.registerCredentialWithRecoverAccount = function (input) {
        return componentOverrideContext.Webauthn.getInstanceOrThrow().webJSRecipe.registerCredentialWithRecoverAccount(input);
    };
    ...
    Wrapper.createAndRegisterCredentialForSessionUser = function (input) {
        return componentOverrideContext.Webauthn.getInstanceOrThrow().webJSRecipe.createAndRegisterCredentialForSessionUser(input);
    };
