...
var Wrapper = /** @class */ (function () {
    ...
    Wrapper.createCredential = function (input) {
        return recipe.Webauthn.getInstanceOrThrow().webJSRecipe.createCredential(input);
    };
    ...
    Wrapper.listCredentials = function (input) {
        return recipe.Webauthn.getInstanceOrThrow().webJSRecipe.listCredentials(input);
    };
    Wrapper.removeCredential = function (input) {
        return recipe.Webauthn.getInstanceOrThrow().webJSRecipe.removeCredential(input);
    };
    Wrapper.registerCredentialWithUser = function (input) {
        return recipe.Webauthn.getInstanceOrThrow().webJSRecipe.registerCredentialWithUser(input);
    };
...
exports.registerCredentialWithUser = registerCredentialWithUser;
