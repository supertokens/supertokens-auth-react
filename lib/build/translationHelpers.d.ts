...
export declare type TranslationFunc = (key: string, params?: Record<string, string>) => string;
...
export declare function saveCurrentLanguage(language: string, cookieDomain: string): void;
