...
var EmailVerificationPreBuiltUIRoutes = /** @class */ (function (_super) {
    utils.__extends(EmailVerificationPreBuiltUIRoutes, _super);
    function EmailVerificationPreBuiltUIRoutes(recipeInstance) {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.recipeInstance.config.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(
                    new NormalisedURLPath__default.default(componentOverrideContext.DEFAULT_VERIFY_EMAIL_PATH)
                );
    ...
    EmailVerificationPreBuiltUIRoutes.init = function (recipeInstance) {
        EmailVerificationPreBuiltUIRoutes.instance = new EmailVerificationPreBuiltUIRoutes(recipeInstance);
    };
    EmailVerificationPreBuiltUIRoutes.getInstanceOrInitAndGetInstance = function () {
    ...
    EmailVerificationPreBuiltUIRoutes.canHandleRoute = function () {
        return EmailVerificationPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().canHandleRoute();
    };
    EmailVerificationPreBuiltUIRoutes.getRoutingComponent = function () {
        return EmailVerificationPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getRoutingComponent();
    };
    EmailVerificationPreBuiltUIRoutes.getFeatures = function () {
        return EmailVerificationPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatures();
    };
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    EmailVerificationPreBuiltUIRoutes.getFeatureComponent = function (_, props) {
        return EmailVerificationPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatureComponent(_, props);
    };
    EmailVerificationPreBuiltUIRoutes.getRoutes = function (reactRouterDom) {
        return _super.getRoutes.call(
            this,
            reactRouterDom,
            EmailVerificationPreBuiltUIRoutes.getInstanceOrInitAndGetInstance()
        );
    };
    EmailVerificationPreBuiltUIRoutes.EmailVerification = function (props) {
        return EmailVerificationPreBuiltUIRoutes.getInstanceOrInitAndGetInstance().getFeatureComponent(
            "emailverification",
            props
        );
    };
    EmailVerificationPreBuiltUIRoutes.EmailVerificationTheme = EmailVerificationTheme;
    return EmailVerificationPreBuiltUIRoutes;
})(sessionAuth.RecipeRoutes);

exports.EmailVerificationPreBuiltUIRoutes = EmailVerificationPreBuiltUIRoutes;
//# sourceMappingURL=emailverificationPreBuiltUIRoutes.js.map
