...
var ContinueWithPasswordlessTheme = function (props) {
    ...
    return jsxRuntime.jsx(
        ...
        superTokens.__assign(
            ...
            { children: jsxRuntime.jsx(ContinueWithPasswordlessWithOverride, superTokens.__assign({}, props)) }
        )
    );
};
...
var defaultTranslationsPasswordless = {
    en: superTokens.__assign(superTokens.__assign({}, uiEntry.defaultTranslationsCommon.en), {
    ...
    var consumeCodeAtMount = React.useCallback(
        function () {
            return superTokens.__awaiter(void 0, void 0, void 0, function () {
                ...
                var _b;
                return superTokens.__generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(
                    LinkSentWrapper,
                    superTokens.__assign({}, childProps, { userContext: props.userContext })
                ),
            props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, superTokens.__assign({}, childProps));
                    }
                    return child;
                }),
        ],
...
var MFATheme = function (_a) {
    var activeScreen = _a.activeScreen,
        ...
        onBackButtonClicked = _a.onBackButtonClicked,
        props = superTokens.__rest(_a, ["activeScreen", "featureState", "onBackButtonClicked"]);
    var t = translationContext.useTranslation();
    var commonProps = {
            ...
            switch (action.type) {
                ...
                case "resendCode":
                    ...
                    return superTokens.__assign(superTokens.__assign({}, oldState), {
                        error: undefined,
                        loginAttemptInfo: superTokens.__assign(superTokens.__assign({}, oldState.loginAttemptInfo), {
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(
                    MFAThemeWrapper,
                    superTokens.__assign({}, childProps, { featureState: state, dispatch: dispatch })
                ),
            props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
...
var SignInUpTheme$1 = function (_a) {
    ...
    return activeScreen === SignInUpScreens.EmailForm
        ...
        ? jsxRuntime.jsx(EmailOrPhoneForm, superTokens.__assign({}, commonProps))
        : null;
};
...
var SignInUpFeatureInner = function (props) {
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(SignInUpThemeWrapper$1, superTokens.__assign({}, childProps)),
            props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, superTokens.__assign({}, childProps));
...
var SignInUpTheme = function (_a) {
    ...
    return activeScreen === SignInUpEPComboScreens.EmailForm
        ? jsxRuntime.jsx(EPComboEmailForm, superTokens.__assign({}, commonProps))
        : activeScreen === SignInUpEPComboScreens.EmailOrPhoneForm
        ? jsxRuntime.jsx(EPComboEmailOrPhoneForm, superTokens.__assign({}, commonProps))
        : null;
};
                                    ...
                                    return [
                                        ...
                                        onAuthSuccess({
                                            ...
                                            recipeId: result.isEmailPassword
                                                ...
                                                : recipe$2.recipeID, // TODO: type this right
                                        }).catch(rethrowInRender),
                                    ];
                            }
                        });
...
var SignInUpEPComboFeatureInner = function (props) {
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper, superTokens.__assign({}, childProps)),
            props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, superTokens.__assign({}, childProps));
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    ...
    PasswordlessPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        var res = superTokens.__spreadArray(
                ...
                [
                    {
                        ...
                        preloadInfoAndRunChecks: function (firstFactors, userContext) {
                            ...
                            return superTokens.__awaiter(this, void 0, void 0, function () {
                                ...
                                return superTokens.__generator(this, function (_d) {
                                    switch (_d.label) {
                                        case 0:
                                            return [
                                                4 /*yield*/,
                        ...
                        component: function (_b) {
                            var preloadInfo = _b.preloadInfo,
                                props = superTokens.__rest(_b, ["preloadInfo"]);
                            return jsxRuntime.jsx(
                                LinkSentFeature,
                                superTokens.__assign({}, props, {
                                    recipe: _this.recipeInstance,
        ...
        try {
            ...
            res.push.apply(
                ...
                factorCombos
                    .map(function (combo) {
                        return superTokens.__spreadArray([types.FactorIds.EMAILPASSWORD], combo, true);
                    })
...
function getAllChoices(choices) {
    ...
    return superTokens.__spreadArray(
        superTokens.__spreadArray([], subChoices, true),
        subChoices.map(function (a) {
            return superTokens.__spreadArray([choices[0]], a, true);
        }),
        true
    );
}
