...
var ContinueWithPasswordlessTheme = function (props) {
    ...
    return jsxRuntime.jsx(
        ...
        utils.__assign(
            ...
            { children: jsxRuntime.jsx(ContinueWithPasswordlessWithOverride, utils.__assign({}, props)) }
        )
    );
};
...
function useChildProps$4(recipe, loginAttemptInfo, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    ...
    var recipeImplementation = React__namespace.useMemo(
        function () {
            return getModifiedRecipeImplementation$4(recipe.webJSRecipe, onError, rebuildAuthPage);
        },
...
var LinkSentFeatureInner = function (props) {
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(LinkSentWrapper, utils.__assign({}, childProps, { userContext: props.userContext })),
            props.children &&
...
var MFATheme = function (_a) {
    var activeScreen = _a.activeScreen,
        ...
        onBackButtonClicked = _a.onBackButtonClicked,
        props = utils.__rest(_a, ["activeScreen", "featureState", "onBackButtonClicked"]);
    var t = translationContext.useTranslation();
    var commonProps = {
                ...
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(
                            child,
                            utils.__assign(utils.__assign({}, childProps), { featureState: state, dispatch: dispatch })
                        );
                    }
                    return child;
                }),
                            ...
                            if (
                                !(
                                    ...
                                    (props.contactMethod !== loginAttemptInfo.contactMethod ||
                                        !componentOverrideContext$1.checkAdditionalLoginAttemptInfoProperties(
                                            loginAttemptInfo
                                        ))
                                )
                            )
                        ...
                        case 8:
                            ...
                            return [
                                ...
                                recipeImplementation.createCode(
                                    utils.__assign(utils.__assign({}, createCodeInfo), {
                        ...
                        case 0:
                            return [
                                ...
                                originalImpl.consumeCode(
                                    utils.__assign(utils.__assign({}, input), { shouldTryLinkingWithSessionUser: true })
                                ),
                            ];
                        case 1:
                            res = _a.sent();
                        ...
                        switch (_c.label) {
                            ...
                            case 4:
                                return [
                                    4 /*yield*/,
                                    props.recipeImplementation.createCode(
                                        utils.__assign(utils.__assign({}, contactInfo), {
                                            // shouldTryLinkingWithSessionUser is set by the fn override
                                            userContext: userContext,
                                        })
                                    ),
...
var SignInUpTheme$1 = function (_a) {
    ...
    return activeScreen === SignInUpScreens.EmailForm
        ...
        ? jsxRuntime.jsx(EmailOrPhoneForm, utils.__assign({}, commonProps))
        : null;
};
...
function useChildProps$2(
    ...
    var recipeImplementation = React__namespace.useMemo(
        function () {
            return recipe && getModifiedRecipeImplementation$2(recipe.webJSRecipe, recipe.config, rebuildAuthPage);
        },
        [recipe]
    );
    var rethrowInRender = utils.useRethrowInRender();
...
var SignInUpFeatureInner = function (props) {
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper$1, utils.__assign({}, childProps)),
            props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, utils.__assign({}, childProps));
...
var EPComboEmailForm = uiEntry.withOverride(
    ...
    function PasswordlessEPComboEmailForm(props) {
        ...
        if (!footer && props.showContinueWithPasswordlessLink) {
            footer = jsxRuntime.jsx(ContinueWithPasswordlessFooter, {
                isPhoneNumber: false,
...
var SignInUpTheme = function (_a) {
    ...
    return activeScreen === SignInUpEPComboScreens.EmailForm
        ? jsxRuntime.jsx(EPComboEmailForm, utils.__assign({}, commonProps))
        : activeScreen === SignInUpEPComboScreens.EmailOrPhoneForm
        ? jsxRuntime.jsx(EPComboEmailOrPhoneForm, utils.__assign({}, commonProps))
        : null;
};
...
function useChildProps$1(
    ...
    var recipeImplementation = React__namespace.useMemo(
        function () {
            return recipe && getModifiedRecipeImplementation$1(recipe.webJSRecipe, recipe.config, rebuildAuthPage);
        },
        [recipe]
    );
    var _a = React__namespace.useState(!recipe.config.signInUpFeature.defaultToEmail),
        isPhoneNumber = _a[0],
        setIsPhoneNumber = _a[1];
                            ...
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    if (response.status === "WRONG_CREDENTIALS_ERROR") {
                                        ...
                                        return [
                                            2 /*return*/,
                                            utils.__assign(utils.__assign({}, response), { isEmailPassword: true }),
                                        ];
                                    }
                            }
                        });
                            ...
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [
                                        4 /*yield*/,
                                        recipeImplementation.createCode(
                                            utils.__assign(utils.__assign({}, createInfo), {
                                                shouldTryLinkingWithSessionUser: false,
                                                userContext: userContext,
                                            })
                                        ),
...
var SignInUpEPComboFeatureInner = function (props) {
    ...
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper, utils.__assign({}, childProps)),
            props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, utils.__assign({}, childProps));
        ...
        children: [
            props.children === undefined &&
                jsxRuntime.jsx(
                    ...
                    utils.__assign({}, childProps, { userContext: props.userContext })
                ),
            props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
    ...
    PasswordlessPreBuiltUI.prototype.getAuthComponents = function () {
                ...
                [
                    {
                                    ...
                                    switch (_e.label) {
                                        ...
                                        case 1:
                                            ...
                                            return [
                                                4 /*yield*/,
                                                (_b =
                                                    componentOverrideContext$1.Passwordless.getInstanceOrThrow()
                                                        .webJSRecipe) === null || _b === void 0
                                                    ? void 0
                        ...
                        component: function (_b) {
                            var preloadInfo = _b.preloadInfo,
                                props = utils.__rest(_b, ["preloadInfo"]);
                            return jsxRuntime.jsx(
                                LinkSentFeature,
                                utils.__assign({}, props, {
                                    recipe: _this.recipeInstance,
        ...
        try {
            ...
            res.push.apply(
                ...
                factorCombos
                    .map(function (combo) {
                        return utils.__spreadArray([types.FactorIds.EMAILPASSWORD], combo, true);
                    })
...
function getAllChoices(choices) {
    ...
    return utils.__spreadArray(
        utils.__spreadArray([], subChoices, true),
        subChoices.map(function (a) {
            return utils.__spreadArray([choices[0]], a, true);
        }),
        true
    );
}
