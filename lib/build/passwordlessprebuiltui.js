...
var recipe$3 = require('./emailpassword-shared3.js');
require('./multifactorauth.js');
var session = require('./session.js');
var recipe$1 = require('./passwordless-shared.js');
...
var recipe$2 = require('./multifactorauth-shared2.js');
...
function useChildProps$4(recipe$1, loginAttemptInfo, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(function () { return getModifiedRecipeImplementation$4(recipe$1.webJSRecipe, onError, rebuildAuthPage); }, [recipe$1, onError, rebuildAuthPage]);
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3: return [2 /*return*/, types.Session.getInstanceOrThrow()
                                ...
                                tenantIdFromQueryParams: genericComponentOverrideContext.getTenantIdFromQueryParams(),
                            }, recipe$1.recipeID, genericComponentOverrideContext.getRedirectToPathFromURL(), userContext, navigate)
                                .catch(rethrowInRender)];
                    }
                });
            }); },
        ...
        return {
            onSuccess: function () {
                ...
                return types.Session.getInstanceOrThrow()
                    .validateGlobalClaimsAndHandleSuccessRedirection(undefined, recipe$1.recipeID, redirectToPath, userContext, navigate)
                    .catch(rethrowInRender);
            },
...
function useOnLoad(props, recipeImplementation, dispatch, userContext) {
    ...
    var fetchMFAInfo = React__namespace.useCallback(function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () { return genericComponentOverrideContext.__generator(this, function (_a) {
        return [2 /*return*/, recipe$2.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.resyncSessionAndFetchMFAInfo({ userContext: userContext })];
    }); }); }, [userContext]);
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!(loginAttemptInfo &&
                        (props.contactMethod !== loginAttemptInfo.contactMethod ||
                            !recipe$1.checkAdditionalLoginAttemptInfoProperties(loginAttemptInfo)))) return [3 /*break*/, 3];
                ...
                case 7:
                    showBackButton = mfaInfo.factors.next.length === 0 ||
                        recipe$2.getAvailableFactors(mfaInfo.factors, undefined, recipe$2.MultiFactorAuth.getInstanceOrThrow(), userContext)
                            .length !== 1;
...
function useChildProps$2(recipe$1, factorIds, onAuthSuccess, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(function () { return recipe$1 && getModifiedRecipeImplementation$2(recipe$1.webJSRecipe, recipe$1.config, rebuildAuthPage); }, [recipe$1]);
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(function () {
        var _a;
        return {
    ...
    if (props.showPasswordField) {
        formFields.push({
            ...
            labelComponent: (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "PWLESS_COMBO_PASSWORD_LABEL", "data-supertokens": "passwordInputLabel" }), jsxRuntime.jsx("a", genericComponentOverrideContext.__assign({ onClick: function () {
                            return recipe$3.EmailPassword.getInstanceOrThrow().redirect({
    ...
    return React.useMemo(function () {
        ...
        return {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, Promise.all([
                                    recipe$3.EmailPassword.getInstanceOrThrow().webJSRecipe.doesEmailExist({ email: email, userContext: userContext }),
            ...
            onPasswordSubmit: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, genericComponentOverrideContext.validateForm(formFields, recipe$3.EmailPassword.getInstanceOrThrow().config.signInAndUpFeature.signInForm.formFields)];
                        case 1:
                            ...
                            return [4 /*yield*/, recipe$3.EmailPassword.getInstanceOrThrow().webJSRecipe.signIn({
                    ...
                    switch (_b.label) {
                        ...
                        case 4: return [2 /*return*/, onAuthSuccess({
                                ...
                                newSessionCreated: session$1.loading ||
                                    ...
                                    (payloadAfterCall !== undefined &&
                                        session$1.accessTokenPayload.sessionHandle !== payloadAfterCall.sessionHandle),
                                recipeId: result.isEmailPassword ? recipe$3.EmailPassword.RECIPE_ID : recipe$1.recipeID,
                            }).catch(rethrowInRender)];
                    }
                });
            }); },
...
function useChildProps(recipe$1, loginAttemptInfo, onAuthSuccess, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(function () { return getModifiedRecipeImplementation(recipe$1.webJSRecipe, onError, rebuildAuthPage); }, [recipe$1, onError, rebuildAuthPage]);
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(function () {
        return {
            userContext: userContext,
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    ...
    function PasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            if (useComponentOverrides === void 0) { useComponentOverrides = recipe$1.useContext; }
            var features = {};
    ...
    PasswordlessPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        var res = genericComponentOverrideContext.__spreadArray(genericComponentOverrideContext.__spreadArray([
            {
                ...
                preloadInfoAndRunChecks: function (firstFactors, userContext) {
                    ...
                    return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_e) {
                            switch (_e.label) {
                                case 0: return [4 /*yield*/, recipe$1.Passwordless.getInstanceOrThrow().webJSRecipe.getLoginAttemptInfo({
                                        userContext: userContext,
                                    })];
                                case 1:
                                    ...
                                    return [4 /*yield*/, ((_b = recipe$1.Passwordless.getInstanceOrThrow().webJSRecipe) === null || _b === void 0 ? void 0 : _b.clearLoginAttemptInfo({ userContext: userContext }))];
                                case 2:
                                    _e.sent();
                                    loginAttemptInfo = undefined;
                                    return [3 /*break*/, 7];
                                case 3:
                                    ...
                                    return [4 /*yield*/, ((_c = recipe$1.Passwordless.getInstanceOrThrow().webJSRecipe) === null || _c === void 0 ? void 0 : _c.clearLoginAttemptInfo({ userContext: userContext }))];
                                case 4:
                                    _e.sent();
                                    loginAttemptInfo = undefined;
                                    return [3 /*break*/, 7];
                                case 5:
                                    if (!!recipe$1.checkAdditionalLoginAttemptInfoProperties(loginAttemptInfo)) return [3 /*break*/, 7];
                                    ...
                                    return [4 /*yield*/, ((_d = recipe$1.Passwordless.getInstanceOrThrow().webJSRecipe) === null || _d === void 0 ? void 0 : _d.clearLoginAttemptInfo({ userContext: userContext }))];
                                case 6:
                                    // If these properties are not set, it means that the user likely started logging in
                                    // using a custom UI and then switched to the pre-built UI. In that case, we should clear
                                    // the login attempt info so that the user is prompted to login again, since the pre-built UI
                ...
                component: function (_b) {
                    ...
                    return (jsxRuntime.jsx(LinkSentFeature, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe$1.useContext, loginAttemptInfo: preloadInfo }), "linkSentFullPage"));
                },
            },
            {
                type: "FULL_PAGE",
                ...
                component: function (_b) {
                    var preloadInfo = _b.preloadInfo, props = genericComponentOverrideContext.__rest(_b, ["preloadInfo"]);
                    return (jsxRuntime.jsx(UserInputCodeFeature, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe$1.useContext, loginAttemptInfo: preloadInfo }), "userInputCodeFullPage"));
                },
            }
            ...
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (React.createElement(SignInUpFeature, genericComponentOverrideContext.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: recipe$1.useContext, factorIds: factors }))); },
        }); }), true), factorCombos.map(function (factors) { return ({
            type: "SIGN_UP",
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (jsxRuntime.jsx(ContinueWithPasswordlessFeature, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, factorIds: factors, useComponentOverrides: recipe$1.useContext }), factors.join("|"))); },
        }); }), true);
        ...
        try {
            recipe$3.EmailPassword.getInstanceOrThrow();
            res.push.apply(res, factorCombos
                ...
                factorIds: factors,
                displayOrder: 3,
                component: function (props) { return (React.createElement(SignInUpEPComboFeature, genericComponentOverrideContext.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: recipe$1.useContext, factorIds: factors }))); },
            }); }));
        }
        catch (_b) {
