    ...
    PasswordlessPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        var res = utils.__spreadArray(utils.__spreadArray([
            {
                ...
                component: function (_b) {
                    ...
                    return (jsxRuntime.jsx(LinkSentFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe$2.useContext, loginAttemptInfo: preloadInfo }), "linkSentFullPage"));
                },
            },
            {
                type: "FULL_PAGE",
                ...
                component: function (_b) {
                    var preloadInfo = _b.preloadInfo, props = utils.__rest(_b, ["preloadInfo"]);
                    return (jsxRuntime.jsx(UserInputCodeFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe$2.useContext, loginAttemptInfo: preloadInfo }), "userInputCodeFullPage"));
                },
            }
            ...
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (React.createElement(SignInUpFeature, utils.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: recipe$2.useContext, factorIds: factors }))); },
        }); }), true), factorCombos.map(function (factors) { return ({
            type: "SIGN_UP",
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (jsxRuntime.jsx(ContinueWithPasswordlessFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, factorIds: factors, useComponentOverrides: recipe$2.useContext }), factors.join("|"))); },
        }); }), true);
        ...
        try {
            ...
            res.push.apply(res, factorCombos
                ...
                factorIds: factors,
                displayOrder: 3,
                component: function (props) { return (React.createElement(SignInUpEPComboFeature, utils.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: recipe$2.useContext, factorIds: factors }))); },
            }); }));
        }
        catch (_b) {
