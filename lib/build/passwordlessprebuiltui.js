                ...
                return utils.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3: return [2 /*return*/, types.Session.getInstanceOrThrow()
                                ...
                                tenantIdFromQueryParams: utils.getTenantIdFromQueryParams(),
                            }, recipe.recipeID, utils.getRedirectToPathFromURL(), userContext, navigate)
                                .catch(rethrowInRender)];
                    }
                });
            }); },
    ...
    return React.useMemo(function () {
        ...
        return {
            ...
            onPasswordSubmit: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
                ...
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, utils.validateForm(formFields, recipe$1.EmailPassword.getInstanceOrThrow().config.signInAndUpFeature.signInForm.formFields)];
                        case 1:
    ...
    PasswordlessPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        var res = utils.__spreadArray(utils.__spreadArray([
            {
                ...
                component: function (_b) {
                    ...
                    return (jsxRuntime.jsx(LinkSentFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext, loginAttemptInfo: preloadInfo }), "linkSentFullPage"));
                },
            },
            {
                type: "FULL_PAGE",
                ...
                component: function (_b) {
                    var preloadInfo = _b.preloadInfo, props = utils.__rest(_b, ["preloadInfo"]);
                    return (jsxRuntime.jsx(UserInputCodeFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext, loginAttemptInfo: preloadInfo }), "userInputCodeFullPage"));
                },
            }
            ...
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (React.createElement(SignInUpFeature, utils.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext, factorIds: factors }))); },
        }); }), true), factorCombos.map(function (factors) { return ({
            type: "SIGN_UP",
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (jsxRuntime.jsx(ContinueWithPasswordlessFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, factorIds: factors, useComponentOverrides: componentOverrideContext$1.useContext }), factors.join("|"))); },
        }); }), true);
        ...
        try {
            ...
            res.push.apply(res, factorCombos
                ...
                factorIds: factors,
                displayOrder: 3,
                component: function (props) { return (React.createElement(SignInUpEPComboFeature, utils.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext, factorIds: factors }))); },
            }); }));
        }
        catch (_b) {
