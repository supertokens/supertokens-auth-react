...
function useOnLoad(props, recipeImplementation, dispatch, userContext) {
    ...
    var fetchMFAInfo = React__namespace.useCallback(function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () { return genericComponentOverrideContext.__generator(this, function (_a) {
        return [2 /*return*/, recipe.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.resyncSessionAndFetchMFAInfo({ userContext: userContext })];
    }); }); }, [userContext]);
            ...
            switch (_c.label) {
                ...
                case 7:
                    showBackButton = mfaInfo.factors.next.length === 0 ||
                        recipe.getAvailableFactors(mfaInfo.factors, undefined, recipe.MultiFactorAuth.getInstanceOrThrow(), userContext)
                            .length !== 1;
...
function useChildProps$1(recipe, factorIds, onAuthSuccess, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(function () { return recipe && getModifiedRecipeImplementation$1(recipe.webJSRecipe, recipe.config, rebuildAuthPage); }, [recipe]);
    var _a = React__namespace.useState(!recipe.config.signInUpFeature.defaultToEmail), isPhoneNumber = _a[0], setIsPhoneNumber = _a[1];
    ...
    return React.useMemo(function () {
        ...
        return {
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, Promise.all([
                                    recipe$1.EmailPassword.getInstanceOrThrow().webJSRecipe.doesEmailExist({ email: email, userContext: userContext }),
            ...
            onPasswordSubmit: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, genericComponentOverrideContext.validateForm(formFields, recipe$1.EmailPassword.getInstanceOrThrow().config.signInAndUpFeature.signInForm.formFields)];
                        case 1:
                            ...
                            return [4 /*yield*/, recipe$1.EmailPassword.getInstanceOrThrow().webJSRecipe.signIn({
                    ...
                    switch (_b.label) {
                        ...
                        case 4: return [2 /*return*/, onAuthSuccess({
                                ...
                                newSessionCreated: session$1.loading ||
                                    ...
                                    (payloadAfterCall !== undefined &&
                                        session$1.accessTokenPayload.sessionHandle !== payloadAfterCall.sessionHandle),
                                recipeId: result.isEmailPassword ? recipe$1.EmailPassword.RECIPE_ID : recipe.recipeID,
                            }).catch(rethrowInRender)];
                    }
                });
            }); },
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    ...
    PasswordlessPreBuiltUI.languageTranslations = defaultTranslationsPasswordless;
