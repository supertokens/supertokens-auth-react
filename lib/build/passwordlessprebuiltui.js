...
function useChildProps$1(
    ...
    var recipeImplementation = React__namespace.useMemo(
        function () {
            return (
                recipe$1 && getModifiedRecipeImplementation$1(recipe$1.webJSRecipe, recipe$1.config, rebuildAuthPage)
            );
        },
        [recipe$1]
    );
    var _a = React__namespace.useState(!recipe$1.config.signInUpFeature.defaultToEmail),
        isPhoneNumber = _a[0],
        setIsPhoneNumber = _a[1];
                                ...
                                case 0:
                                    return [
                                        ...
                                        genericComponentOverrideContext.validateForm(
                                            formFields,
                                            recipe.EmailPassword.getInstanceOrThrow().config.signInAndUpFeature
