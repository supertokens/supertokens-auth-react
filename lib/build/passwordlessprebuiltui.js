                            ...
                            if (
                                !(
                                    ...
                                    (props.contactMethod !== loginAttemptInfo.contactMethod ||
                                        !recipe$1.checkAdditionalLoginAttemptInfoProperties(loginAttemptInfo))
                                )
                            )
                                return [3 /*break*/, 3];
                            return [
                            ...
                            switch (_b.label) {
                                ...
                                case 2:
                                    ...
                                    return [
                                        4 /*yield*/,
                                        Promise.all([
                                            recipe$3.EmailPassword.getInstanceOrThrow().webJSRecipe.doesEmailExist({
                                                email: email,
                                                userContext: userContext,
                                            }),
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [
                                        4 /*yield*/,
                                        recipe$3.EmailPassword.getInstanceOrThrow().webJSRecipe.signIn({
                                            formFields: formFields,
                                            shouldTryLinkingWithSessionUser: false,
                                            userContext: userContext,
                                        }),
                                    ...
                                    return [
                                        ...
                                        onAuthSuccess({
                                            ...
                                            recipeId: result.isEmailPassword
                                                ? recipe$3.EmailPassword.RECIPE_ID
                                                : recipe$1.recipeID,
                                        }).catch(rethrowInRender),
                                    ];
                            }
                                ...
                                return genericComponentOverrideContext.__generator(this, function (_e) {
                                    switch (_e.label) {
                                        case 0:
                                            return [
                                                4 /*yield*/,
                                                recipe$1.Passwordless.getInstanceOrThrow().webJSRecipe.getLoginAttemptInfo(
                                                    {
                                                        userContext: userContext,
                                                    }
                                                ),
                                        ...
                                        case 1:
                                            ...
                                            return [
                                                4 /*yield*/,
                                                (_b = recipe$1.Passwordless.getInstanceOrThrow().webJSRecipe) ===
                                                    null || _b === void 0
                                                    ? void 0
                                        ...
                                        case 3:
                                            ...
                                            return [
                                                4 /*yield*/,
                                                (_c = recipe$1.Passwordless.getInstanceOrThrow().webJSRecipe) ===
                                                    null || _c === void 0
                                                    ? void 0
                                        ...
                                        case 4:
                                            ...
                                            return [3 /*break*/, 7];
                                        case 5:
                                            if (!!recipe$1.checkAdditionalLoginAttemptInfoProperties(loginAttemptInfo))
                                                return [3 /*break*/, 7];
                                            ...
                                            return [
                                                4 /*yield*/,
                                                (_d = recipe$1.Passwordless.getInstanceOrThrow().webJSRecipe) ===
                                                    null || _d === void 0
                                                    ? void 0
