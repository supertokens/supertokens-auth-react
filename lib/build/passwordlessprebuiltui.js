...
var ContinueWithPasswordlessWithOverride = sessionprebuiltui.withOverride(
                            ...
                            children:
                                props.requireUserInteraction === true
                                    ...
                                    : jsxRuntime.jsx(
                                          ...
                                          genericComponentOverrideContext.__assign(
                                              { "data-supertokens": "spinner" },
                                              { children: jsxRuntime.jsx(sessionprebuiltui.SpinnerIcon, {}) }
                                          )
                                      ),
                        }
                    )
...
var LinkClickedScreenWithOverride = sessionprebuiltui.withOverride(
...
var defaultTranslationsPasswordless = {
    en: genericComponentOverrideContext.__assign(
        genericComponentOverrideContext.__assign({}, sessionprebuiltui.defaultTranslationsCommon.en),
        {
...
var LinkClickedScreen = function (props) {
    ...
    var userContext = sessionprebuiltui.useUserContext();
    ...
    return jsxRuntime.jsx(
        ...
        genericComponentOverrideContext.__assign(
            ...
            {
                children: jsxRuntime.jsx(
                    sessionprebuiltui.FeatureWrapper,
                    genericComponentOverrideContext.__assign(
                        {
...
var ResendButton = sessionprebuiltui.withOverride("PasswordlessResendButton", function PasswordlessResendButton(_a) {
                ...
                children: jsxRuntime.jsxs(
                    ...
                    genericComponentOverrideContext.__assign(
                        { "data-supertokens": "row" },
                        {
                            children: [
                                status === "ERROR" &&
                                    jsxRuntime.jsx(sessionprebuiltui.GeneralError, {
                                        ...
                                        },
                                        {
                                            children: jsxRuntime.jsxs(
                                                ...
                                                genericComponentOverrideContext.__assign(
                                                    ...
                                                    {
                                                        children: [
                                                            jsxRuntime.jsx(sessionprebuiltui.ArrowLeftIcon, {
                                                                color: "rgb(var(--palette-textGray))",
                                                            }),
                                                            jsxRuntime.jsx("span", {
                                                                children:
...
var LinkSent = sessionprebuiltui.withOverride("PasswordlessLinkSent", PasswordlessLinkSent);
function LinkSentWrapper(props) {
    var rootStyle = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().rootStyle;
    var activeStyle = props.config.signInUpFeature.linkSentScreenStyle;
    return jsxRuntime.jsx(
        sessionprebuiltui.UserContextWrapper,
        genericComponentOverrideContext.__assign(
            { userContext: props.userContext },
            {
                children: jsxRuntime.jsx(
...
function useChildProps$4(
    ...
    var _this = this;
    var session$1 = sessionprebuiltui.useSessionContext();
...
var EmailForm = sessionprebuiltui.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    var _this = this;
    var userContext = sessionprebuiltui.useUserContext();
...
var PhoneForm = sessionprebuiltui.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    var _this = this;
    var userContext = sessionprebuiltui.useUserContext();
    React.useEffect(function () {
...
var UserInputCodeFormFooter = sessionprebuiltui.withOverride(
...
var UserInputCodeFormHeader = sessionprebuiltui.withOverride(
        ...
        genericComponentOverrideContext.__assign(
            { "data-supertokens": "container" },
            {
                children: [
                            ...
                            { "data-supertokens": "row" },
                            {
                                children: [
                                    ...
                                    props.error !== undefined &&
                                        jsxRuntime.jsx(sessionprebuiltui.GeneralError, { error: props.error }),
                                    jsxRuntime.jsx(
                                        UserInputCodeForm,
                                        genericComponentOverrideContext.__assign({}, props)
                                    ),
                    ...
                    jsxRuntime.jsx(sessionprebuiltui.SuperTokensBranding, {}),
                ],
            }
        )
    );
};
var UserInputCodeForm = sessionprebuiltui.withOverride("PasswordlessUserInputCodeForm", function (props) {
    var _a;
    var t = translationContext.useTranslation();
    var userContext = sessionprebuiltui.useUserContext();
...
var LoadingScreen = sessionprebuiltui.withOverride("PasswordlessMFAOTPLoadingScreen", OTPLoadingScreen);

var MFAFooter = sessionprebuiltui.withOverride("PasswordlessMFAFooter", function PasswordlessMFAFooter(props) {
    var t = translationContext.useTranslation();
    return jsxRuntime.jsx(
        "div",
        genericComponentOverrideContext.__assign(
...
var MFAHeader = sessionprebuiltui.withOverride("PasswordlessMFAHeader", function PasswordlessMFAHeader(props) {
    var t = translationContext.useTranslation();
    return jsxRuntime.jsxs(React.Fragment, {
        children: [
            jsxRuntime.jsxs(
                    ...
                    { "data-supertokens": "headerTitle withBackButton pwless-mfa header" },
                    {
                        children: [
                            props.showBackButton
                                ? jsxRuntime.jsx(sessionprebuiltui.BackButton, { onClick: props.onBackButtonClicked })
                                : jsxRuntime.jsx("span", {
...
var MFAOTPFooter = sessionprebuiltui.withOverride("PasswordlessMFAOTPFooter", function PasswordlessMFAOTPFooter(_a) {
    var loginAttemptInfo = _a.loginAttemptInfo,
        recipeImplementation = _a.recipeImplementation,
...
var MFAOTPHeader = sessionprebuiltui.withOverride("PasswordlessMFAOTPHeader", function PasswordlessMFAOTPHeader(_a) {
                    ...
                    { "data-supertokens": "headerTitle withBackButton pwless-mfa otpHeader" },
                    {
                        children: [
                            showBackButton && canChangeEmail === false
                                ? jsxRuntime.jsx(sessionprebuiltui.BackButton, { onClick: onBackButtonClicked })
                                : jsxRuntime.jsx("span", {
                                      "data-supertokens": "backButtonPlaceholder backButtonCommon",
                                  }),
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    return [
                                        4 /*yield*/,
                                        sessionprebuiltui.redirectToAuth({ redirectBack: false, navigate: navigate }),
                                    ];
                                case 3:
                                    _a.sent();
                                    return [2 /*return*/];
...
var EmailOrPhoneForm = sessionprebuiltui.withOverride(
...
var EPComboEmailForm = sessionprebuiltui.withOverride(
...
var EPComboEmailOrPhoneForm = sessionprebuiltui.withOverride(
...
})(sessionprebuiltui.RecipeRouter);
