...
var EPComboEmailForm = uiEntry.withOverride("PasswordlessEPComboEmailForm", function PasswordlessEPComboEmailForm(props) {
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: formFields, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", onSuccess: props.onSuccess, callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        ...
        }); }, validateOnBlur: false, showLabels: true, footer: props.showContinueWithPasswordlessLink ? (jsxRuntime.jsx(ContinueWithPasswordlessFooter, { isPhoneNumber: false, onContinueWithPasswordlessClick: props.onContinueWithPasswordlessClick, onError: props.onError, config: props.config, validatePhoneNumber: props.validatePhoneNumber })) : undefined }));
});
...
var EPComboEmailOrPhoneForm = uiEntry.withOverride("PasswordlessEPComboEmailOrPhoneForm", function PasswordlessEPComboEmailOrPhoneForm(props) {
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: formFields, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        ...
        }); }, validateOnBlur: false, showLabels: true, onSuccess: props.onSuccess, footer: props.showContinueWithPasswordlessLink ? (jsxRuntime.jsx(ContinueWithPasswordlessFooter, { isPhoneNumber: props.isPhoneNumber, onContinueWithPasswordlessClick: props.onContinueWithPasswordlessClick, validatePhoneNumber: props.validatePhoneNumber, onError: props.onError, config: props.config })) : undefined }));
});
