...
var componentOverrideContext$1 = require('./passwordless-shared.js');
...
var ThemeBase = function (_a) {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [children, jsxRuntime.jsxs("style", { children: [styles, userStyles.join("\n")] })] }));
};

var ContinueWithPasswordless = function (props) {
    return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "continueWithPasswordlessButtonWrapper" }, { children: jsxRuntime.jsx(button.Button, { isLoading: false, onClick: function () {
                props.continueWithPasswordlessClicked();
            }, type: "button", label: "PWLESS_COMBO_CONTINUE_WITH_PASSWORDLESS_BUTTON" }) })));
};
var ContinueWithPasswordlessWithOverride = uiEntry.withOverride("PasswordlessContinueWithPasswordless", ContinueWithPasswordless);
var ContinueWithPasswordlessTheme = function (props) {
    ...
    return (jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsxRuntime.jsx(ContinueWithPasswordlessWithOverride, genericComponentOverrideContext.__assign({}, props)) })));
};

var ContinueWithPasswordlessFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, genericComponentOverrideContext.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(ContinueWithPasswordlessTheme, genericComponentOverrideContext.__assign({}, props, { continueWithPasswordlessClicked: function () { return props.setFactorList(props.factorIds); }, config: props.recipe.config })) })));
};
...
var PasswordlessLinkClickedScreen = function (props) {
    ...
    return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "container" }, { children: jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "row" }, { children: props.requireUserInteraction === true ? (jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerTitle" }, { children: t("PWLESS_LINK_CLICKED_CONTINUE_HEADER") })), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("PWLESS_LINK_CLICKED_CONTINUE_DESC") })), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "continueButtonWrapper" }, { children: jsxRuntime.jsx(button.Button, { isLoading: loading, onClick: function () {
                                setLoading(true);
                                props.consumeCode();
                            }, type: "button", label: "PWLESS_LINK_CLICKED_CONTINUE_BUTTON" }) }))] })) : (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "spinner" }, { children: jsxRuntime.jsx(uiEntry.SpinnerIcon, {}) }))) })) })));
};
var LinkClickedScreenWithOverride = uiEntry.withOverride("PasswordlessLinkClickedScreen", PasswordlessLinkClickedScreen);
var LinkClickedScreen$1 = function (props) {
    var rootStyle = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().rootStyle;
    return (jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, props.config.linkClickedScreenFeature.style] }, { children: jsxRuntime.jsx(LinkClickedScreenWithOverride, genericComponentOverrideContext.__assign({}, props)) })));
};
...
var LinkClickedScreen = function (props) {
    ...
    var consumeCodeAtMount = React.useCallback(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
        ...
        return genericComponentOverrideContext.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirectToAuth({
                ...
                case 4:
                    _c.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, types.Session.getInstanceOrThrow().getAccessTokenPayloadSecurely({
                            userContext: userContext,
                        })];
                case 5:
    ...
    var handleConsumeResp = React.useCallback(function (consumeRes) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (response.status === "RESTART_FLOW_ERROR") {
                        return [2 /*return*/, genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().redirectToAuth({
                                navigate: props.navigate,
                                queryParams: {
                                    error: "restart_link",
                                },
                ...
                case 6:
                    _b.sent();
                    return [2 /*return*/, types.Session.getInstanceOrThrow()
    ...
    var handleConsumeError = React.useCallback(function (err) {
    ...
    var childProps = {
        ...
        consumeCode: function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, genericComponentOverrideContext.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, genericComponentOverrideContext.__assign({ useShadowDom: genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsPasswordless }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(LinkClickedScreen$1, genericComponentOverrideContext.__assign({}, childProps)), props.children &&
...
var ResendButton = uiEntry.withOverride("PasswordlessResendButton", function PasswordlessResendButton(_a) {
    ...
    var t = translationContext.useTranslation();
    var getTimeLeft = React.useCallback(function () {
    ...
    return (jsxRuntime.jsx("button", genericComponentOverrideContext.__assign({ type: "button", disabled: secsUntilResend !== undefined, onClick: onClick, "data-supertokens": "link linkButton formLabelLinkBtn resendCodeBtn" }, { children: secsUntilResend !== undefined ? (jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [t("PWLESS_RESEND_BTN_DISABLED_START"), jsxRuntime.jsxs("strong", { children: [Math.floor(secsUntilResend / 60)
                            .toString()
                            .padStart(2, "0"), ":", (secsUntilResend % 60).toString().padStart(2, "0")] }), t("PWLESS_RESEND_BTN_DISABLED_END")] })) : loginAttemptInfo.contactMethod === "EMAIL" ? (t("PWLESS_RESEND_BTN_EMAIL")) : (t("PWLESS_RESEND_BTN_PHONE")) })));
});

var PasswordlessLinkSent = function (props) {
    var t = translationContext.useTranslation();
    var userContext = uiEntry.useUserContext();
    var _a = React.useState(props.error !== undefined ? "ERROR" : "READY"), status = _a[0], setStatus = _a[1];
    ...
    var resendEmail = React.useCallback(function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "container" }, { children: jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "row" }, { children: [status === "ERROR" && (jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error === undefined ? "SOMETHING_WENT_WRONG_ERROR" : props.error })), resendActive && jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "generalSuccess" }, { children: t("PWLESS_LINK_SENT_RESEND_SUCCESS") })), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "sendCodeIcon" }, { children: props.loginAttemptInfo.contactMethod === "EMAIL" ? jsxRuntime.jsx(emailLargeIcon.EmailLargeIcon, {}) : jsxRuntime.jsx(SMSLargeIcon, {}) })), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerTitle headerTinyTitle" }, { children: t("PWLESS_LINK_SENT_RESEND_TITLE") })), jsxRuntime.jsx("div", { "data-supertokens": "divider" }), jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "primaryText sendCodeText" }, { children: [props.loginAttemptInfo.contactMethod === "EMAIL"
                            ...
                            : t("PWLESS_LINK_SENT_RESEND_DESC_START_PHONE"), jsxRuntime.jsx("strong", { children: props.loginAttemptInfo.contactInfo }), props.loginAttemptInfo.contactMethod === "EMAIL"
                            ? t("PWLESS_LINK_SENT_RESEND_DESC_END_EMAIL")
                            : t("PWLESS_LINK_SENT_RESEND_DESC_END_PHONE")] })), jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "buttonWithArrow", onClick: function () {
                        return props.recipeImplementation.clearLoginAttemptInfo({
                            userContext: userContext,
                        });
                    } }, { children: jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow" }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textGray))" }), jsxRuntime.jsx("span", { children: props.loginAttemptInfo.contactMethod === "EMAIL"
                                    ? t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_EMAIL")
                                    : t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_PHONE") })] })) })), jsxRuntime.jsx(ResendButton, { loginAttemptInfo: props.loginAttemptInfo, resendEmailOrSMSGapInSeconds: props.config.signInUpFeature.resendEmailOrSMSGapInSeconds, onClick: resendEmail })] })) })));
};
...
function useChildProps$4(recipe, loginAttemptInfo, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(function () { return getModifiedRecipeImplementation$4(recipe.webJSRecipe, onError, rebuildAuthPage); }, [recipe, onError, rebuildAuthPage]);
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(function () {
        return {
            userContext: userContext,
            onSuccess: function (result) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            payloadAfterCall = undefined;
                            return [3 /*break*/, 3];
                        case 3: return [2 /*return*/, types.Session.getInstanceOrThrow()
                                .validateGlobalClaimsAndHandleSuccessRedirection({
                                action: "SUCCESS",
                                createdNewUser: result.createdNewRecipeUser && result.user.loginMethods.length === 1,
                                isNewRecipeUser: result.createdNewRecipeUser,
                                newSessionCreated: session$1.loading ||
                                    !session$1.doesSessionExist ||
                                    (payloadAfterCall !== undefined &&
                                        session$1.accessTokenPayload.sessionHandle !== payloadAfterCall.sessionHandle),
                                recipeId: recipe.recipeID,
                                tenantIdFromQueryParams: genericComponentOverrideContext.getTenantIdFromQueryParams(),
                            }, recipe.recipeID, genericComponentOverrideContext.getRedirectToPathFromURL(), userContext, navigate)
                                .catch(rethrowInRender)];
                    }
                });
            }); },
            onFetchError: function (err) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                var invalidClaims, evInstance;
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!(err.status === types.Session.getInstanceOrThrow().config.invalidClaimStatusCode)) return [3 /*break*/, 5];
                            return [4 /*yield*/, session.getInvalidClaimsFromResponse({ response: err, userContext: userContext })];
                        case 1:
                            invalidClaims = _b.sent();
                            if (!invalidClaims.some(function (i) { return i.id === emailverification.EmailVerificationClaim.id; })) return [3 /*break*/, 5];
                            _b.label = 2;
                        case 2:
                            _b.trys.push([2, 4, , 5]);
...
var LinkSentFeatureInner = function (props) {
    var childProps = useChildProps$4(props.recipe, props.loginAttemptInfo, props.error, props.onError, props.clearError, props.rebuildAuthPage, props.userContext, props.navigate);
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(LinkSentWrapper, genericComponentOverrideContext.__assign({}, childProps, { userContext: props.userContext })), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, genericComponentOverrideContext.__assign({}, childProps));
                    }
                    return child;
                })] }));
};
var LinkSentFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, genericComponentOverrideContext.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(LinkSentFeatureInner, genericComponentOverrideContext.__assign({}, props)) })));
};
function getModifiedRecipeImplementation$4(originalImpl, setError, rebuildAuthPage) {
    var _this = this;
    return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImpl), { resendCode: function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, originalImpl.setLoginAttemptInfo({
                                userContext: input.userContext,
                                attemptInfo: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, loginAttemptInfo), { shouldTryLinkingWithSessionUser: (_a = loginAttemptInfo.shouldTryLinkingWithSessionUser) !== null && _a !== void 0 ? _a : false, lastResend: timestamp }),
                            })];
                    case 3:
                        _b.sent();
                        _b.label = 4;
        ...
        }); }, consumeCode: function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            var res;
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, originalImpl.consumeCode(input)];
                    case 1:
                        res = _a.sent();
        ...
        }); }, clearLoginAttemptInfo: function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
...
function getPhoneNumberUtils() {
    return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
        ...
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, preloadPhoneNumberUtils()];
                case 1:
                    _a.sent();
...
function preloadPhoneNumberUtils() {
    if (phoneNumberUtilsImport === undefined) {
        ...
        phoneNumberUtilsImport = Promise.resolve().then(function () { return require('./utils.js'); });
...
var EmailForm = uiEntry.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    var _this = this;
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: [
            {
                id: "email",
                ...
                validate: recipe.defaultValidate,
            },
        ], buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", onSuccess: props.onSuccess, callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            ...
            return genericComponentOverrideContext.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, props.recipeImplementation.createCode({
                                email: email,
...
var intlTelInput$2 = {
  get exports(){ return intlTelInputExports$1; },
  set exports(v){ intlTelInputExports$1 = v; },
};

var intlTelInputExports = {};
var intlTelInput$1 = {
  get exports(){ return intlTelInputExports; },
  set exports(v){ intlTelInputExports = v; },
};
...
function PhoneNumberInput(_a) {
    ...
    var handleCountryChange = React.useCallback(function (ev) {
     ...
     * Render.
     */
    return (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "inputContainer" }, { children: [jsxRuntime.jsxs("style", genericComponentOverrideContext.__assign({ type: "text/css" }, { children: [phoneNumberInputLibStyles, "\n                    .iti__flag {background-image: url(\"https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.19/img/flags.png\");}\n\n                    @media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {\n                        .iti__flag {background-image: url(\"https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.19/img/flags@2x.png\");}\n                    }\n                "] })), jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "phoneInputWrapper inputWrapper ".concat(hasError ? "inputError" : "") }, { children: [jsxRuntime.jsx("input", { type: "tel", "data-supertokens": "input input-".concat(name), name: name + "_text", autoFocus: autofocus, autoComplete: autoComplete, onChange: function (ev) {
                        ...
                        }, onFocus: handleFocus, onBlur: handleBlur, ref: inputRef }), hasError === true && (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "inputAdornment inputAdornmentError" }, { children: jsxRuntime.jsx(formBase.ErrorIcon, {}) })))] }))] })));
    /* eslint-enable react/jsx-no-literals */
}
// TODO: type props
var phoneNumberInputWithInjectedProps = function (injectedProps) {
    return function (props) { return jsxRuntime.jsx(PhoneNumberInput, genericComponentOverrideContext.__assign({}, injectedProps, props)); };
};
...
var PhoneForm = uiEntry.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    ...
    var phoneInput = React.useMemo(function () {
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: [
            ...
            return genericComponentOverrideContext.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        phoneNumber = (_a = formFields.find(function (field) { return field.id === "phoneNumber"; })) === null || _a === void 0 ? void 0 : _a.value;
...
var UserInputCodeFormFooter = uiEntry.withOverride("PasswordlessUserInputCodeFormFooter", function PasswordlessUserInputCodeFormFooter(_a) {
    var loginAttemptInfo = _a.loginAttemptInfo, recipeImplementation = _a.recipeImplementation;
    var t = translationContext.useTranslation();
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsx(React.Fragment, { children: jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: function () {
                return recipeImplementation.clearLoginAttemptInfo({
                    userContext: userContext,
                });
            } }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }), loginAttemptInfo.contactMethod === "EMAIL"
                    ? t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_EMAIL")
                    : t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_PHONE")] })) }));
});

var UserInputCodeFormHeader = uiEntry.withOverride("PasswordlessUserInputCodeFormHeader", function PasswordlessUserInputCodeFormHeader(_a) {
    var loginAttemptInfo = _a.loginAttemptInfo;
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs(React.Fragment, { children: [jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerTitle" }, { children: t("PWLESS_USER_INPUT_CODE_HEADER_TITLE") })), jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: [loginAttemptInfo.flowType === "USER_INPUT_CODE"
                        ? t("PWLESS_USER_INPUT_CODE_HEADER_SUBTITLE")
                        : t("PWLESS_USER_INPUT_CODE_HEADER_SUBTITLE_LINK"), jsxRuntime.jsx("br", {}), jsxRuntime.jsx("strong", { children: loginAttemptInfo.contactInfo })] })), jsxRuntime.jsx("div", { "data-supertokens": "divider" })] }));
});
...
var UserInputCodeForm = uiEntry.withOverride("PasswordlessUserInputCodeForm", function (props) {
    ...
    var _b = React.useState(), clearResendNotifTimeout = _b[0], setClearResendNotifTimeout = _b[1];
    React.useEffect(function () {
    ...
    var resend = React.useCallback(function resend() {
        return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
            var response, generalError, e_1;
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        if (generalError !== undefined) {
                            ...
                            if (response.status === "OK") {
                                setClearResendNotifTimeout(setTimeout(function () {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [clearResendNotifTimeout !== undefined && (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "generalSuccess" }, { children: props.loginAttemptInfo.contactMethod === "EMAIL"
                    ? t("PWLESS_RESEND_SUCCESS_EMAIL")
                    : t("PWLESS_RESEND_SUCCESS_PHONE") }))), jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: [
                    {
                        id: "userInputCode",
                        label: "",
                        ...
                        placeholder: "",
                        validate: componentOverrideContext$1.userInputCodeValidate,
                    },
                ], onSuccess: props.onSuccess, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
                    var userInputCode, response;
                    var _a;
                    return genericComponentOverrideContext.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                userInputCode = (_a = formFields.find(function (field) { return field.id === "userInputCode"; })) === null || _a === void 0 ? void 0 : _a.value;
                                if (userInputCode === undefined || userInputCode.length === 0) {
                                    throw new STGeneralError__default.default("GENERAL_ERROR_OTP_UNDEFINED");
                                }
                                return [4 /*yield*/, props.recipeImplementation.consumeCode({
                ...
                }); }, validateOnBlur: false, showLabels: true, footer: (_a = props.footer) !== null && _a !== void 0 ? _a : jsxRuntime.jsx(UserInputCodeFormFooter, genericComponentOverrideContext.__assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })) })] }));
});
function UserInputCodeFormScreenWrapper(props) {
    var rootStyle = genericComponentOverrideContext.SuperTokens.getInstanceOrThrow().rootStyle;
    var activeStyle = props.config.signInUpFeature.userInputCodeFormStyle;
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(UserInputCodeFormScreen, genericComponentOverrideContext.__assign({}, props)) })) })));
}

var OTPLoadingScreen = function () {
    return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "container delayedRender pwless-mfa loadingScreen" }, { children: jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "row" }, { children: jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "spinner delayedRender" }, { children: jsxRuntime.jsx(uiEntry.SpinnerIcon, {}) })) })) })));
};
...
var MFAFooter = uiEntry.withOverride("PasswordlessMFAFooter", function PasswordlessMFAFooter(props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "footerLinkGroupVert pwless-mfa footer" }, { children: jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: props.onSignOutClicked }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }), t("PWLESS_MFA_FOOTER_LOGOUT")] })) })));
});

var MFAHeader = uiEntry.withOverride("PasswordlessMFAHeader", function PasswordlessMFAHeader(props) {
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs(React.Fragment, { children: [jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "headerTitle withBackButton pwless-mfa header" }, { children: [props.showBackButton ? (jsxRuntime.jsx(uiEntry.BackButton, { onClick: props.onBackButtonClicked })) : (jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })), props.contactMethod === "EMAIL"
                        ? t("PWLESS_MFA_HEADER_TITLE_EMAIL")
                        : t("PWLESS_MFA_HEADER_TITLE_PHONE"), jsxRuntime.jsx("span", { "data-supertokens": "backButtonPlaceholder backButtonCommon" })] })), jsxRuntime.jsx("div", { "data-supertokens": "divider" })] }));
});
...
var MFAOTPFooter = uiEntry.withOverride("PasswordlessMFAOTPFooter", function PasswordlessMFAOTPFooter(_a) {
    ...
    var t = translationContext.useTranslation();
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "footerLinkGroupVert pwless-mfa otpFooter" }, { children: [canChangeEmail && (jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "secondaryText", onClick: function () {
                    return recipeImplementation.clearLoginAttemptInfo({
                        userContext: userContext,
                    });
                } }, { children: loginAttemptInfo.contactMethod === "EMAIL"
                    ? t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_EMAIL")
                    : t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_PHONE") }))), jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: onSignOutClicked }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }), t("PWLESS_MFA_FOOTER_LOGOUT")] }))] })));
});
...
var MFATheme = function (_a) {
    var activeScreen = _a.activeScreen, featureState = _a.featureState, onBackButtonClicked = _a.onBackButtonClicked, props = genericComponentOverrideContext.__rest(_a, ["activeScreen", "featureState", "onBackButtonClicked"]);
    var t = translationContext.useTranslation();
    var commonProps = {
    ...
    return activeScreen === MFAScreens.AccessDenied ? (jsxRuntime.jsx(sessionprebuiltui.AccessDeniedScreen, { useShadowDom: false /* We set this to false, because we are already inside a shadowDom (if required) */, error: t(featureState.error) })) : (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "container pwless-mfa" }, { children: [jsxRuntime.jsx("div", genericComponentOverrideContext.__assign({ "data-supertokens": "row" }, { children: jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [activeScreen === MFAScreens.UserInputCodeForm ? (jsxRuntime.jsx(MFAOTPHeader, genericComponentOverrideContext.__assign({}, commonProps, { showBackButton: featureState.showBackButton, loginAttemptInfo: featureState.loginAttemptInfo, canChangeEmail: featureState.canChangeEmail, onBackButtonClicked: onBackButtonClicked }))) : (jsxRuntime.jsx(MFAHeader, genericComponentOverrideContext.__assign({}, commonProps, { showBackButton: featureState.showBackButton, onBackButtonClicked: onBackButtonClicked, contactMethod: activeScreen === MFAScreens.EmailForm ? "EMAIL" : "PHONE" }))), featureState.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: featureState.error }), activeScreen === MFAScreens.EmailForm ? (jsxRuntime.jsx(EmailForm, genericComponentOverrideContext.__assign({}, commonProps, { footer: jsxRuntime.jsx(MFAFooter, genericComponentOverrideContext.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked, canChangeEmail: featureState.canChangeEmail })) }))) : activeScreen === MFAScreens.PhoneForm ? (jsxRuntime.jsx(PhoneForm, genericComponentOverrideContext.__assign({}, commonProps, { footer: jsxRuntime.jsx(MFAFooter, genericComponentOverrideContext.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked, canChangeEmail: featureState.canChangeEmail })) }))) : activeScreen === MFAScreens.UserInputCodeForm ? (jsxRuntime.jsx(UserInputCodeForm, genericComponentOverrideContext.__assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo, onSuccess: props.onSuccess, footer: jsxRuntime.jsx(MFAOTPFooter, genericComponentOverrideContext.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked, canChangeEmail: featureState.canChangeEmail, loginAttemptInfo: featureState.loginAttemptInfo })) }))) : null] }) })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })));
};
function MFAThemeWrapper(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle, props.config.mfaFeature.style] }, { children: jsxRuntime.jsx(MFATheme, genericComponentOverrideContext.__assign({}, props, { activeScreen: activeScreen })) })) })));
}
    ...
    return React__namespace.useReducer(function (oldState, action) {
        switch (action.type) {
            ...
            case "resendCode":
                ...
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { error: undefined, loginAttemptInfo: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState.loginAttemptInfo), { lastResend: action.timestamp }) });
            case "restartFlow":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { error: action.error, loginAttemptInfo: undefined, showAccessDenied: !oldState.canChangeEmail });
            case "setError":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { loaded: true, error: action.error, showAccessDenied: action.showAccessDenied });
            case "startVerify":
                return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, oldState), { loaded: true, loginAttemptInfo: action.loginAttemptInfo, error: undefined });
            default:
                return oldState;
        }
    }, {
        ...
        return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, initArg), { error: error });
    });
};
function useChildProps$3(recipe, recipeImplementation, state, contactMethod, dispatch, userContext, navigate) {
    var _this = this;
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(function () {
        var _a;
        return {
            ...
            onSignOutClicked: function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, types.Session.getInstanceOrThrow().signOut({ userContext: userContext })];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, recipeImplementation.clearLoginAttemptInfo({ userContext: userContext })];
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, uiEntry.redirectToAuth({ redirectBack: false, navigate: navigate })];
                        case 3:
                            _a.sent();
                            return [2 /*return*/];
                    }
            ...
            onBackButtonClicked: function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 2:
                            ...
                            if (navigate === undefined) {
                                return [2 /*return*/, windowHandler.WindowHandlerReference.getReferenceOrThrow().windowHandler.getWindowUnsafe().history.back()];
                            }
...
var MFAFeatureInner = function (props) {
    ...
    var recipeImplementation = React__namespace.useMemo(function () { return props.recipe && getModifiedRecipeImplementation$3(props.recipe.webJSRecipe, props.recipe.config, dispatch); }, [props.recipe]);
    useOnLoad(props, recipeImplementation, dispatch, userContext);
    var childProps = useChildProps$3(props.recipe, recipeImplementation, state, props.contactMethod, dispatch, userContext, props.navigate);
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && (jsxRuntime.jsx(MFAThemeWrapper, genericComponentOverrideContext.__assign({}, childProps, { featureState: state, dispatch: dispatch }))), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, childProps), { featureState: state, dispatch: dispatch }));
                    }
                    return child;
                })] }));
};
...
function useOnLoad(props, recipeImplementation, dispatch, userContext) {
    var _this = this;
    var fetchMFAInfo = React__namespace.useCallback(function () { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () { return genericComponentOverrideContext.__generator(this, function (_a) {
        return [2 /*return*/, recipe$1.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.resyncSessionAndFetchMFAInfo({ userContext: userContext })];
    }); }); }, [userContext]);
    var handleLoadError = React__namespace.useCallback(function () { return dispatch({ type: "setError", showAccessDenied: true, error: "SOMETHING_WENT_WRONG_ERROR_RELOAD" }); }, [dispatch]);
    var onLoad = React__namespace.useCallback(function (mfaInfo) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        ...
        return genericComponentOverrideContext.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    loginAttemptInfo = _c.sent();
                    factorId = props.contactMethod === "EMAIL" ? types.FactorIds.OTP_EMAIL : types.FactorIds.OTP_PHONE;
                    if (!(loginAttemptInfo &&
                        (props.contactMethod !== loginAttemptInfo.contactMethod ||
                            !componentOverrideContext$1.checkAdditionalLoginAttemptInfoProperties(loginAttemptInfo)))) return [3 /*break*/, 3];
                ...
                case 4:
                    _c.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, types.Session.getInstanceOrThrow().validateGlobalClaimsAndHandleSuccessRedirection(undefined, props.recipe.recipeID, redirectToPath, userContext, props.navigate)];
                case 5:
                    _c.sent();
                    return [3 /*break*/, 7];
                case 6:
                ...
                case 7:
                    showBackButton = mfaInfo.factors.next.length === 0 ||
                        recipe$1.getAvailableFactors(mfaInfo.factors, undefined, recipe$1.MultiFactorAuth.getInstanceOrThrow(), userContext)
                            .length !== 1;
                ...
                case 8:
                    ...
                    return [4 /*yield*/, recipeImplementation.createCode(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, createCodeInfo), { shouldTryLinkingWithSessionUser: true, userContext: userContext }))];
                case 9:
                ...
                case 10:
                    err_1 = _c.sent();
                    if (!("status" in err_1 &&
                        err_1.status === types.Session.getInstanceOrThrow().config.invalidClaimStatusCode)) return [3 /*break*/, 15];
                    return [4 /*yield*/, session.getInvalidClaimsFromResponse({ response: err_1, userContext: userContext })];
                case 11:
                    invalidClaims = _c.sent();
                    if (!invalidClaims.some(function (i) { return i.id === emailverification.EmailVerificationClaim.id; })) return [3 /*break*/, 15];
                    _c.label = 12;
                case 12:
...
function getModifiedRecipeImplementation$3(originalImpl, config, dispatch) {
    var _this = this;
    return genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, originalImpl), { createCode: function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            ...
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, originalImpl.createCode(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, input), { shouldTryLinkingWithSessionUser: true, userContext: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, input.userContext), { additionalAttemptInfo: additionalAttemptInfo }) }))];
                    case 2:
                        res = _a.sent();
        ...
        }); }, resendCode: function (input) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            var res, loginAttemptInfo, timestamp;
            var _a;
            return genericComponentOverrideContext.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, originalImpl.setLoginAttemptInfo({
                                userContext: input.userContext,
                                attemptInfo: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, loginAttemptInfo), { shouldTryLinkingWithSessionUser: (_a = loginAttemptInfo.shouldTryLinkingWithSessionUser) !== null && _a !== void 0 ? _a : true, lastResend: timestamp }),
                            })];
                    case 3:
                        _b.sent();
            ...
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, originalImpl.consumeCode(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, input), { shouldTryLinkingWithSessionUser: true }))];
                    case 1:
                        res = _a.sent();
                        if (!(res.status === "RESTART_FLOW_ERROR")) return [3 /*break*/, 3];
                        return [4 /*yield*/, originalImpl.clearLoginAttemptInfo({
...
var EmailOrPhoneForm = uiEntry.withOverride("PasswordlessEmailOrPhoneForm", function PasswordlessEmailOrPhoneForm(props) {
    var _this = this;
    var t = translationContext.useTranslation();
    var _a = React.useState(!props.config.signInUpFeature.defaultToEmail), isPhoneNumber = _a[0], setIsPhoneNumber = _a[1];
    var userContext = uiEntry.useUserContext();
    React.useEffect(function () {
        // We preload this here, since it will be used almost for sure, but loading it
        void preloadPhoneNumberUtils();
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: isPhoneNumber
            ? [
                {
                    id: "phoneNumber",
                    label: "",
                    labelComponent: (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "PWLESS_SIGN_IN_UP_PHONE_LABEL" }), jsxRuntime.jsx("a", genericComponentOverrideContext.__assign({ onClick: function () { return setIsPhoneNumber(false); }, "data-supertokens": "link linkButton formLabelLinkBtn contactMethodSwitcher" }, { children: t("PWLESS_SIGN_IN_UP_SWITCH_TO_EMAIL") }))] }))),
                    inputComponent: phoneInput,
                    optional: false,
                    autofocus: true,
                    placeholder: "",
            ...
            : [
                {
                    id: "email",
                    label: "",
                    labelComponent: (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "PWLESS_SIGN_IN_UP_EMAIL_LABEL", "data-supertokens": "passwordInputLabel" }), jsxRuntime.jsx("a", genericComponentOverrideContext.__assign({ onClick: function () { return setIsPhoneNumber(function (v) { return !v; }); }, "data-supertokens": "link linkButton formLabelLinkBtn contactMethodSwitcher" }, { children: t("PWLESS_SIGN_IN_UP_SWITCH_TO_PHONE") }))] }))),
            ...
            return genericComponentOverrideContext.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        email = (_b = formFields.find(function (field) { return field.id === "email"; })) === null || _b === void 0 ? void 0 : _b.value;
                        if (email === undefined) {
                            throw new STGeneralError__default.default("GENERAL_ERROR_EMAIL_UNDEFINED");
                        }
                        return [4 /*yield*/, props.config.validateEmailAddress(email)];
                    case 3:
                        ...
                        _c.label = 4;
                    case 4: return [4 /*yield*/, props.recipeImplementation.createCode(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, contactInfo), { 
                            // shouldTryLinkingWithSessionUser is set by the fn override
                            userContext: userContext }))];
                    case 5:
                        response = _c.sent();
...
var SignInUpTheme$1 = function (_a) {
    var activeScreen = _a.activeScreen, props = genericComponentOverrideContext.__rest(_a, ["activeScreen"]);
    var commonProps = {
        recipeImplementation: props.recipeImplementation,
        config: props.config,
    ...
    return activeScreen === SignInUpScreens.EmailForm ? (jsxRuntime.jsx(EmailForm, genericComponentOverrideContext.__assign({}, commonProps))) : activeScreen === SignInUpScreens.PhoneForm ? (jsxRuntime.jsx(PhoneForm, genericComponentOverrideContext.__assign({}, commonProps))) : activeScreen === SignInUpScreens.EmailOrPhoneForm ? (jsxRuntime.jsx(EmailOrPhoneForm, genericComponentOverrideContext.__assign({}, commonProps))) : null;
};
function SignInUpThemeWrapper$1(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, genericComponentOverrideContext.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(SignInUpTheme$1, genericComponentOverrideContext.__assign({}, props, { activeScreen: activeScreen })) })) })));
}
...
function useChildProps$2(recipe, factorIds, onAuthSuccess, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(function () { return recipe && getModifiedRecipeImplementation$2(recipe.webJSRecipe, recipe.config, rebuildAuthPage); }, [recipe]);
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(function () {
        var _a;
        return {
...
var SignInUpFeatureInner = function (props) {
    ...
    var childProps = useChildProps$2(props.recipe, props.factorIds, props.onAuthSuccess, props.error, props.onError, props.clearError, props.rebuildAuthPage, userContext, props.navigate);
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper$1, genericComponentOverrideContext.__assign({}, childProps)), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, genericComponentOverrideContext.__assign({}, childProps));
                    }
...
var SignInUpFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, genericComponentOverrideContext.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignInUpFeatureInner, genericComponentOverrideContext.__assign({}, props)) })));
};
            ...
            return genericComponentOverrideContext.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, originalImpl.createCode(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, input), { shouldTryLinkingWithSessionUser: false, userContext: genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, input.userContext), { additionalAttemptInfo: additionalAttemptInfo }) }))];
                    case 2:
                        res = _a.sent();
                        if (res.status === "OK") {
                            rebuildAuthPage();
...
var ContinueWithPasswordlessFooter = function (_a) {
    ...
    return (jsxRuntime.jsx("a", genericComponentOverrideContext.__assign({ "data-supertokens": "link linkButton continueWithPasswordlessLink", onClick: function () { return genericComponentOverrideContext.__awaiter(void 0, void 0, void 0, function () {
...
var EPComboEmailForm = uiEntry.withOverride("PasswordlessEPComboEmailForm", function PasswordlessEPComboEmailForm(props) {
    var _this = this;
    var t = translationContext.useTranslation();
    var formFields = [
        {
    ...
    if (!footer && props.showContinueWithPasswordlessLink) {
        footer = (jsxRuntime.jsx(ContinueWithPasswordlessFooter, { isPhoneNumber: false, onContinueWithPasswordlessClick: props.onContinueWithPasswordlessClick, onError: props.onError, config: props.config, validatePhoneNumber: props.validatePhoneNumber }));
    }
    if (props.showPasswordField) {
        formFields.push({
            ...
            label: "",
            validate: componentOverrideContext$1.defaultValidate,
            labelComponent: (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "PWLESS_COMBO_PASSWORD_LABEL", "data-supertokens": "passwordInputLabel" }), jsxRuntime.jsx("a", genericComponentOverrideContext.__assign({ onClick: function () {
                            return recipe.EmailPassword.getInstanceOrThrow().redirect({
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: formFields, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", onSuccess: props.onSuccess, callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
        ...
        }); }, validateOnBlur: false, showLabels: true, footer: footer }));
});

var EPComboEmailOrPhoneForm = uiEntry.withOverride("PasswordlessEPComboEmailOrPhoneForm", function PasswordlessEPComboEmailOrPhoneForm(props) {
    var _this = this;
    var t = translationContext.useTranslation();
    React.useEffect(function () {
        // We preload this here, since it will be used almost for sure, but loading it
    ...
    var footer = props.footer;
    if (!footer && props.showContinueWithPasswordlessLink) {
        footer = (jsxRuntime.jsx(ContinueWithPasswordlessFooter, { isPhoneNumber: props.isPhoneNumber, onContinueWithPasswordlessClick: props.onContinueWithPasswordlessClick, validatePhoneNumber: props.validatePhoneNumber, onError: props.onError, config: props.config }));
    }
        ...
        ? [
            {
                id: "phoneNumber",
                label: "",
                labelComponent: (jsxRuntime.jsxs("div", genericComponentOverrideContext.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "PWLESS_SIGN_IN_UP_PHONE_LABEL" }), jsxRuntime.jsx("a", genericComponentOverrideContext.__assign({ onClick: function () { return props.setIsPhoneNumber(false); }, "data-supertokens": "link linkButton formLabelLinkBtn contactMethodSwitcher" }, { children: t("PWLESS_SIGN_IN_UP_SWITCH_TO_EMAIL") }))] }))),
                inputComponent: phoneInput,
                optional: false,
                autofocus: true,
                placeholder: "",
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: formFields, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", callAPI: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
            var phoneNumber, validationRes, email, validationRes;
            var _a, _b;
            return genericComponentOverrideContext.__generator(this, function (_c) {
                switch (_c.label) {
        ...
        }); }, validateOnBlur: false, showLabels: true, onSuccess: props.onSuccess, footer: footer }));
});
...
var SignInUpTheme = function (_a) {
    ...
    return activeScreen === SignInUpEPComboScreens.EmailForm ? (jsxRuntime.jsx(EPComboEmailForm, genericComponentOverrideContext.__assign({}, commonProps))) : activeScreen === SignInUpEPComboScreens.EmailOrPhoneForm ? (jsxRuntime.jsx(EPComboEmailOrPhoneForm, genericComponentOverrideContext.__assign({}, commonProps))) : null;
};
...
function useChildProps$1(recipe$1, factorIds, onAuthSuccess, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(function () { return recipe$1 && getModifiedRecipeImplementation$1(recipe$1.webJSRecipe, recipe$1.config, rebuildAuthPage); }, [recipe$1]);
    var _a = React__namespace.useState(!recipe$1.config.signInUpFeature.defaultToEmail), isPhoneNumber = _a[0], setIsPhoneNumber = _a[1];
    var _b = React__namespace.useState(false), showPasswordField = _b[0], setShowPasswordField = _b[1];
    var _c = React__namespace.useState(false), showContinueWithPasswordlessLink = _c[0], setShowContinueWithPasswordlessLink = _c[1];
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(function () {
        var _a;
        var isPasswordlessEmailEnabled = [types.FactorIds.LINK_EMAIL, types.FactorIds.OTP_EMAIL].some(function (id) {
        ...
        return {
            ...
            onContactInfoSubmit: function (contactInfo) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                var createRes, email, _a, epExists, pwlessExists, createRes;
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!isPhoneNumber) return [3 /*break*/, 2];
                            return [4 /*yield*/, recipeImplementation.createCode({
                        ...
                        case 2:
                            email = contactInfo;
                            if (recipe$1.config.contactMethod === "PHONE" || !isPasswordlessEmailEnabled) {
                                setShowPasswordField(true);
                                return [2 /*return*/, { status: "OK" }];
                            }
                            return [4 /*yield*/, Promise.all([
                                    recipe.EmailPassword.getInstanceOrThrow().webJSRecipe.doesEmailExist({ email: email, userContext: userContext }),
                                    recipeImplementation.doesEmailExist({ email: email, userContext: userContext }),
                                ])];
                        case 3:
            ...
            onPasswordSubmit: function (formFields) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                var validationErrors, response;
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, genericComponentOverrideContext.validateForm(formFields, recipe.EmailPassword.getInstanceOrThrow().config.signInAndUpFeature.signInForm.formFields)];
                        case 1:
                            ...
                            return [4 /*yield*/, recipe.EmailPassword.getInstanceOrThrow().webJSRecipe.signIn({
                        ...
                        case 2:
                            ...
                            if (response.status === "WRONG_CREDENTIALS_ERROR") {
                                ...
                                return [2 /*return*/, genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, response), { isEmailPassword: true })];
                            }
                    }
                });
            }); },
            onContinueWithPasswordlessClick: function (contactInfo) { return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                var createInfo, createRes;
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            createInfo = isPhoneNumber ? { phoneNumber: contactInfo } : { email: contactInfo };
                            return [4 /*yield*/, recipeImplementation.createCode(genericComponentOverrideContext.__assign(genericComponentOverrideContext.__assign({}, createInfo), { shouldTryLinkingWithSessionUser: false, userContext: userContext }))];
                        case 1:
                            createRes = _a.sent();
                ...
                return genericComponentOverrideContext.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            payloadAfterCall = undefined;
                            return [3 /*break*/, 4];
                        case 4: return [2 /*return*/, onAuthSuccess({
                                createdNewUser: result.createdNewRecipeUser && result.user.loginMethods.length === 1,
                                isNewRecipeUser: result.createdNewRecipeUser,
                                newSessionCreated: session$1.loading ||
                                    !session$1.doesSessionExist ||
                                    (payloadAfterCall !== undefined &&
                                        session$1.accessTokenPayload.sessionHandle !== payloadAfterCall.sessionHandle),
                                recipeId: result.isEmailPassword ? recipe.EmailPassword.RECIPE_ID : recipe$1.recipeID,
                            }).catch(rethrowInRender)];
                    }
                });
            }); },
            ...
            validatePhoneNumber: (_a = recipe$1.config.validatePhoneNumber) !== null && _a !== void 0 ? _a : defaultPhoneNumberValidator,
            navigate: navigate,
        };
    }, [
        error,
...
var SignInUpEPComboFeatureInner = function (props) {
    ...
    var childProps = useChildProps$1(props.recipe, props.factorIds, props.onAuthSuccess, props.error, props.onError, props.clearError, props.rebuildAuthPage, userContext, props.navigate);
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper, genericComponentOverrideContext.__assign({}, childProps)), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, genericComponentOverrideContext.__assign({}, childProps));
                    }
...
var SignInUpEPComboFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, genericComponentOverrideContext.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignInUpEPComboFeatureInner, genericComponentOverrideContext.__assign({}, props)) })));
};
...
function useChildProps(recipe, loginAttemptInfo, onAuthSuccess, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(function () { return getModifiedRecipeImplementation(recipe.webJSRecipe, onError, rebuildAuthPage); }, [recipe, onError, rebuildAuthPage]);
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(function () {
        return {
            userContext: userContext,
...
var UserInputCodeFeatureInner = function (props) {
    var childProps = useChildProps(props.recipe, props.loginAttemptInfo, props.onAuthSuccess, props.error, props.onError, props.clearError, props.rebuildAuthPage, props.userContext, props.navigate);
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && (jsxRuntime.jsx(UserInputCodeFormScreenWrapper, genericComponentOverrideContext.__assign({}, childProps, { userContext: props.userContext }))), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, genericComponentOverrideContext.__assign({}, childProps));
                    }
...
var UserInputCodeFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, genericComponentOverrideContext.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(UserInputCodeFeatureInner, genericComponentOverrideContext.__assign({}, props)) })));
};
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    ...
    function PasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            if (useComponentOverrides === void 0) { useComponentOverrides = componentOverrideContext$1.useContext; }
            var features = {};
            if (_this.recipeInstance.config.linkClickedScreenFeature.disableDefaultUI !== true) {
                var normalisedFullPath = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default("/verify"));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: genericComponentOverrideContext.matchRecipeIdUsingQueryParams(_this.recipeInstance.config.recipeId),
                    component: function (props) {
                        return _this.getFeatureComponent("linkClickedScreen", props, useComponentOverrides);
                    },
                    recipeID: componentOverrideContext$1.Passwordless.RECIPE_ID,
                };
            }
            if (_this.recipeInstance.config.mfaFeature.disableDefaultUI !== true) {
                var normalisedFullPathPhone = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default("/mfa/otp-phone"));
                features[normalisedFullPathPhone.getAsStringDangerous()] = {
                    matches: genericComponentOverrideContext.matchRecipeIdUsingQueryParams(_this.recipeInstance.config.recipeId),
                    component: function (props) { return _this.getFeatureComponent("otp-phone", props, useComponentOverrides); },
                    recipeID: componentOverrideContext$1.Passwordless.RECIPE_ID,
                };
                var normalisedFullPathEmail = _this.recipeInstance.config.appInfo.websiteBasePath.appendPath(new NormalisedURLPath__default.default("/mfa/otp-email"));
                features[normalisedFullPathEmail.getAsStringDangerous()] = {
                    matches: genericComponentOverrideContext.matchRecipeIdUsingQueryParams(_this.recipeInstance.config.recipeId),
                    component: function (props) { return _this.getFeatureComponent("otp-email", props, useComponentOverrides); },
                    recipeID: componentOverrideContext$1.Passwordless.RECIPE_ID,
                };
            }
            return features;
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "linkClickedScreen") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, genericComponentOverrideContext.__assign({ requireAuth: false, doRedirection: false }, { children: jsxRuntime.jsx(LinkClickedScreen, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })) })));
            }
            if (componentName === "otp-email") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, genericComponentOverrideContext.__assign({ overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(MFAFeature, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides, contactMethod: "EMAIL", flowType: "USER_INPUT_CODE" }, props)) })) })));
            }
            if (componentName === "otp-phone") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, genericComponentOverrideContext.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, genericComponentOverrideContext.__assign({ overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(MFAFeature, genericComponentOverrideContext.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides, contactMethod: "PHONE", flowType: "USER_INPUT_CODE" }, props)) })) })));
            }
    ...
    PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (PasswordlessPreBuiltUI.instance === undefined) {
            var recipeInstance = componentOverrideContext$1.Passwordless.getInstanceOrThrow();
    ...
    PasswordlessPreBuiltUI.getFeatureComponent = function (componentName, props, useComponentOverrides) {
        if (useComponentOverrides === void 0) { useComponentOverrides = componentOverrideContext$1.useContext; }
        return PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance().getFeatureComponent(componentName, props, useComponentOverrides);
    };
    PasswordlessPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        var res = genericComponentOverrideContext.__spreadArray(genericComponentOverrideContext.__spreadArray([
            {
                type: "FULL_PAGE",
                preloadInfoAndRunChecks: function (firstFactors, userContext) {
                    ...
                    return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_e) {
                            switch (_e.label) {
                                case 0: return [4 /*yield*/, componentOverrideContext$1.Passwordless.getInstanceOrThrow().webJSRecipe.getLoginAttemptInfo({
                                        userContext: userContext,
                                    })];
                                case 1:
                                    ...
                                    if (!(loginAttemptInfo.contactMethod === "PHONE" &&
                                        ...
                                        !firstFactors.includes(types.FactorIds.LINK_PHONE))) return [3 /*break*/, 3];
                                    return [4 /*yield*/, ((_b = componentOverrideContext$1.Passwordless.getInstanceOrThrow().webJSRecipe) === null || _b === void 0 ? void 0 : _b.clearLoginAttemptInfo({ userContext: userContext }))];
                                case 2:
                                    _e.sent();
                                    loginAttemptInfo = undefined;
                                    return [3 /*break*/, 7];
                                case 3:
                                    if (!(loginAttemptInfo.contactMethod === "EMAIL" &&
                                        !firstFactors.includes(types.FactorIds.OTP_EMAIL) &&
                                        !firstFactors.includes(types.FactorIds.LINK_EMAIL))) return [3 /*break*/, 5];
                                    return [4 /*yield*/, ((_c = componentOverrideContext$1.Passwordless.getInstanceOrThrow().webJSRecipe) === null || _c === void 0 ? void 0 : _c.clearLoginAttemptInfo({ userContext: userContext }))];
                                case 4:
                                    _e.sent();
                                    loginAttemptInfo = undefined;
                                    return [3 /*break*/, 7];
                                case 5:
                                    if (!!componentOverrideContext$1.checkAdditionalLoginAttemptInfoProperties(loginAttemptInfo)) return [3 /*break*/, 7];
                                    ...
                                    return [4 /*yield*/, ((_d = componentOverrideContext$1.Passwordless.getInstanceOrThrow().webJSRecipe) === null || _d === void 0 ? void 0 : _d.clearLoginAttemptInfo({ userContext: userContext }))];
                                case 6:
                                    // If these properties are not set, it means that the user likely started logging in
                                    // using a custom UI and then switched to the pre-built UI. In that case, we should clear
                                    // the login attempt info so that the user is prompted to login again, since the pre-built UI
                ...
                component: function (_b) {
                    var preloadInfo = _b.preloadInfo, props = genericComponentOverrideContext.__rest(_b, ["preloadInfo"]);
                    return (jsxRuntime.jsx(LinkSentFeature, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext, loginAttemptInfo: preloadInfo }), "linkSentFullPage"));
                },
            },
            {
                type: "FULL_PAGE",
                ...
                component: function (_b) {
                    var preloadInfo = _b.preloadInfo, props = genericComponentOverrideContext.__rest(_b, ["preloadInfo"]);
                    return (jsxRuntime.jsx(UserInputCodeFeature, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext, loginAttemptInfo: preloadInfo }), "userInputCodeFullPage"));
                },
            }
        ], factorCombos.map(function (factors) { return ({
            type: "SIGN_IN",
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (React.createElement(SignInUpFeature, genericComponentOverrideContext.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext, factorIds: factors }))); },
        }); }), true), factorCombos.map(function (factors) { return ({
            type: "SIGN_UP",
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (jsxRuntime.jsx(ContinueWithPasswordlessFeature, genericComponentOverrideContext.__assign({}, props, { recipe: _this.recipeInstance, factorIds: factors, useComponentOverrides: componentOverrideContext$1.useContext }), factors.join("|"))); },
        }); }), true);
        ...
        try {
            ...
            res.push.apply(res, factorCombos
                .map(function (combo) { return genericComponentOverrideContext.__spreadArray([types.FactorIds.EMAILPASSWORD], combo, true); })
                .map(function (factors) { return ({
                type: "SIGN_IN",
                factorIds: factors,
                displayOrder: 3,
                component: function (props) { return (React.createElement(SignInUpEPComboFeature, genericComponentOverrideContext.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: componentOverrideContext$1.useContext, factorIds: factors }))); },
            }); }));
        }
        catch (_b) {
...
function getAllChoices(choices) {
    ...
    return genericComponentOverrideContext.__spreadArray(genericComponentOverrideContext.__spreadArray([], subChoices, true), subChoices.map(function (a) { return genericComponentOverrideContext.__spreadArray([choices[0]], a, true); }), true);
}
