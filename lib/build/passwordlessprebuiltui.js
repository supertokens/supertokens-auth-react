...
var ContinueWithPasswordless = function (props) {
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "continueWithPasswordlessButtonWrapper" }, { children: jsxRuntime.jsx(button.Button, { isLoading: false, onClick: function () {
...
var ContinueWithPasswordlessTheme = function (props) {
    ...
    return (jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle] }, { children: jsxRuntime.jsx(ContinueWithPasswordlessWithOverride, utils.__assign({}, props)) })));
};

var ContinueWithPasswordlessFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(ContinueWithPasswordlessTheme, utils.__assign({}, props, { continueWithPasswordlessClicked: function () { return props.setFactorList(props.factorIds); }, config: props.recipe.config })) })));
};
...
var PasswordlessLinkClickedScreen = function (props) {
    ...
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "container" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "row" }, { children: props.requireUserInteraction === true ? (jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle" }, { children: t("PWLESS_LINK_CLICKED_CONTINUE_HEADER") })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: t("PWLESS_LINK_CLICKED_CONTINUE_DESC") })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "continueButtonWrapper" }, { children: jsxRuntime.jsx(button.Button, { isLoading: loading, onClick: function () {
                                setLoading(true);
                                props.consumeCode();
                            }, type: "button", label: "PWLESS_LINK_CLICKED_CONTINUE_BUTTON" }) }))] })) : (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "spinner" }, { children: jsxRuntime.jsx(uiEntry.SpinnerIcon, {}) }))) })) })));
};
...
var LinkClickedScreen = function (props) {
    ...
    var consumeCodeAtMount = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
        var preAuthSessionId, linkCode, loginAttemptInfo, payloadBeforeCall;
        var _b;
        return utils.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    preAuthSessionId = utils.getQueryParams("preAuthSessionId");
                    linkCode = utils.getURLHash();
    ...
    var handleConsumeResp = React.useCallback(function (consumeRes) { return utils.__awaiter(void 0, void 0, void 0, function () {
    ...
    utils.useOnMountAPICall(consumeCodeAtMount, handleConsumeResp, handleConsumeError);
    var recipeComponentOverrides = props.useComponentOverrides();
    var childProps = {
        recipeImplementation: props.recipe.webJSRecipe,
        config: props.recipe.config,
        requireUserInteraction: requireUserInteraction,
        consumeCode: function () { return utils.__awaiter(void 0, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsx(uiEntry.ComponentOverrideContext.Provider, utils.__assign({ value: recipeComponentOverrides }, { children: jsxRuntime.jsx(uiEntry.FeatureWrapper, utils.__assign({ useShadowDom: superTokens.SuperTokens.getInstanceOrThrow().useShadowDom, defaultStore: defaultTranslationsPasswordless }, { children: jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(LinkClickedScreen$1, utils.__assign({}, childProps)), props.children &&
...
var PasswordlessLinkSent = function (props) {
    ...
    var resendEmail = React.useCallback(function () { return utils.__awaiter(void 0, void 0, void 0, function () {
    ...
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "container" }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "row" }, { children: [status === "ERROR" && (jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error === undefined ? "SOMETHING_WENT_WRONG_ERROR" : props.error })), resendActive && jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "generalSuccess" }, { children: t("PWLESS_LINK_SENT_RESEND_SUCCESS") })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "sendCodeIcon" }, { children: props.loginAttemptInfo.contactMethod === "EMAIL" ? jsxRuntime.jsx(emailLargeIcon.EmailLargeIcon, {}) : jsxRuntime.jsx(SMSLargeIcon, {}) })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle headerTinyTitle" }, { children: t("PWLESS_LINK_SENT_RESEND_TITLE") })), jsxRuntime.jsx("div", { "data-supertokens": "divider" }), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "primaryText sendCodeText" }, { children: [props.loginAttemptInfo.contactMethod === "EMAIL"
                            ...
                            : t("PWLESS_LINK_SENT_RESEND_DESC_END_PHONE")] })), jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "buttonWithArrow", onClick: function () {
                        return props.recipeImplementation.clearLoginAttemptInfo({
                            userContext: userContext,
                        });
                    } }, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow" }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textGray))" }), jsxRuntime.jsx("span", { children: props.loginAttemptInfo.contactMethod === "EMAIL"
...
function LinkSentWrapper(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(LinkSent, utils.__assign({}, props)) })) })));
}
...
function useChildProps$4(recipe$1, loginAttemptInfo, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    ...
    return React.useMemo(function () {
        return {
            userContext: userContext,
            onSuccess: function (result) { return utils.__awaiter(_this, void 0, void 0, function () {
                ...
                return utils.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3: return [2 /*return*/, types.Session.getInstanceOrThrow()
                                ...
                                tenantIdFromQueryParams: utils.getTenantIdFromQueryParams(),
                            }, recipe$1.recipeID, utils.getRedirectToPathFromURL(), userContext, navigate)
                                .catch(rethrowInRender)];
                    }
                });
            }); },
            onFetchError: function (err) { return utils.__awaiter(_this, void 0, void 0, function () {
...
var LinkSentFeatureInner = function (props) {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(LinkSentWrapper, utils.__assign({}, childProps, { userContext: props.userContext })), props.children &&
...
var LinkSentFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(LinkSentFeatureInner, utils.__assign({}, props)) })));
};
function getModifiedRecipeImplementation$4(originalImpl, setError, rebuildAuthPage) {
    var _this = this;
    return utils.__assign(utils.__assign({}, originalImpl), { resendCode: function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, originalImpl.setLoginAttemptInfo({
                                userContext: input.userContext,
                                attemptInfo: utils.__assign(utils.__assign({}, loginAttemptInfo), { shouldTryLinkingWithSessionUser: (_a = loginAttemptInfo.shouldTryLinkingWithSessionUser) !== null && _a !== void 0 ? _a : false, lastResend: timestamp }),
                            })];
                    case 3:
                        _b.sent();
                        _b.label = 4;
        ...
        }); }, consumeCode: function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
            var res;
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
        ...
        }); }, clearLoginAttemptInfo: function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
...
function preloadPhoneNumberUtils() {
    if (phoneNumberUtilsImport === undefined) {
        ...
        phoneNumberUtilsImport = Promise.resolve().then(function () { return require('./utils2.js'); });
...
var EmailForm = uiEntry.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: [
        ...
        ], buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", onSuccess: props.onSuccess, callAPI: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
...
function PhoneNumberInput(_a) {
    ...
    React.useEffect(function () {
        if (inputRef.current !== null && itiRef.current === null) {
            ...
            var anyIti = itiRef;
            if (anyIti.isMobile) {
                var root = document.getElementById(utils.ST_ROOT_ID);
     ...
     * Render.
     */
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "inputContainer" }, { children: [jsxRuntime.jsxs("style", utils.__assign({ type: "text/css" }, { children: [phoneNumberInputLibStyles, "\n                    .iti__flag {background-image: url(\"https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.19/img/flags.png\");}\n\n                    @media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {\n                        .iti__flag {background-image: url(\"https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.19/img/flags@2x.png\");}\n                    }\n                "] })), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "phoneInputWrapper inputWrapper ".concat(hasError ? "inputError" : "") }, { children: [jsxRuntime.jsx("input", { type: "tel", "data-supertokens": "input input-".concat(name), name: name + "_text", autoFocus: autofocus, autoComplete: autoComplete, onChange: function (ev) {
                        ...
                        }, onFocus: handleFocus, onBlur: handleBlur, ref: inputRef }), hasError === true && (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "inputAdornment inputAdornmentError" }, { children: jsxRuntime.jsx(formBase.ErrorIcon, {}) })))] }))] })));
    /* eslint-enable react/jsx-no-literals */
}
// TODO: type props
var phoneNumberInputWithInjectedProps = function (injectedProps) {
    return function (props) { return jsxRuntime.jsx(PhoneNumberInput, utils.__assign({}, injectedProps, props)); };
};
...
var UserInputCodeFormFooter = uiEntry.withOverride("PasswordlessUserInputCodeFormFooter", function PasswordlessUserInputCodeFormFooter(_a) {
    ...
    var t = translationContext.useTranslation();
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsx(React.Fragment, { children: jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: function () {
...
var UserInputCodeFormHeader = uiEntry.withOverride("PasswordlessUserInputCodeFormHeader", function PasswordlessUserInputCodeFormHeader(_a) {
    ...
    var t = translationContext.useTranslation();
    return (jsxRuntime.jsxs(React.Fragment, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "headerTitle" }, { children: t("PWLESS_USER_INPUT_CODE_HEADER_TITLE") })), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "headerSubtitle secondaryText" }, { children: [loginAttemptInfo.flowType === "USER_INPUT_CODE"
...
var UserInputCodeFormScreen = function (props) {
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "container" }, { children: [jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "row" }, { children: [jsxRuntime.jsx(UserInputCodeFormHeader, utils.__assign({}, props)), props.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: props.error }), jsxRuntime.jsx(UserInputCodeForm, utils.__assign({}, props))] })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })));
};
var UserInputCodeForm = uiEntry.withOverride("PasswordlessUserInputCodeForm", function (props) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [clearResendNotifTimeout !== undefined && (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "generalSuccess" }, { children: props.loginAttemptInfo.contactMethod === "EMAIL"
                ...
                ], onSuccess: props.onSuccess, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", callAPI: function (formFields) { return utils.__awaiter(void 0, void 0, void 0, function () {
                ...
                }); }, validateOnBlur: false, showLabels: true, footer: (_a = props.footer) !== null && _a !== void 0 ? _a : jsxRuntime.jsx(UserInputCodeFormFooter, utils.__assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })) })] }));
});
function UserInputCodeFormScreenWrapper(props) {
    var rootStyle = superTokens.SuperTokens.getInstanceOrThrow().rootStyle;
    var activeStyle = props.config.signInUpFeature.userInputCodeFormStyle;
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(UserInputCodeFormScreen, utils.__assign({}, props)) })) })));
}

var OTPLoadingScreen = function () {
    return (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "container delayedRender pwless-mfa loadingScreen" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "row" }, { children: jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "spinner delayedRender" }, { children: jsxRuntime.jsx(uiEntry.SpinnerIcon, {}) })) })) })));
};
...
var MFAOTPFooter = uiEntry.withOverride("PasswordlessMFAOTPFooter", function PasswordlessMFAOTPFooter(_a) {
    ...
    var t = translationContext.useTranslation();
    var userContext = uiEntry.useUserContext();
    return (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "footerLinkGroupVert pwless-mfa otpFooter" }, { children: [canChangeEmail && (jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "secondaryText", onClick: function () {
                    return recipeImplementation.clearLoginAttemptInfo({
                        userContext: userContext,
                    });
                } }, { children: loginAttemptInfo.contactMethod === "EMAIL"
                    ? t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_EMAIL")
                    : t("PWLESS_SIGN_IN_UP_CHANGE_CONTACT_INFO_PHONE") }))), jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", onClick: onSignOutClicked }, { children: [jsxRuntime.jsx(arrowLeftIcon.ArrowLeftIcon, { color: "rgb(var(--palette-textPrimary))" }), t("PWLESS_MFA_FOOTER_LOGOUT")] }))] })));
});
...
var MFATheme = function (_a) {
    var activeScreen = _a.activeScreen, featureState = _a.featureState, onBackButtonClicked = _a.onBackButtonClicked, props = utils.__rest(_a, ["activeScreen", "featureState", "onBackButtonClicked"]);
    var t = translationContext.useTranslation();
    var commonProps = {
    ...
    return activeScreen === MFAScreens.AccessDenied ? (jsxRuntime.jsx(sessionprebuiltui.AccessDeniedScreen, { useShadowDom: false /* We set this to false, because we are already inside a shadowDom (if required) */, error: t(featureState.error) })) : (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "container pwless-mfa" }, { children: [jsxRuntime.jsx("div", utils.__assign({ "data-supertokens": "row" }, { children: jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [activeScreen === MFAScreens.UserInputCodeForm ? (jsxRuntime.jsx(MFAOTPHeader, utils.__assign({}, commonProps, { showBackButton: featureState.showBackButton, loginAttemptInfo: featureState.loginAttemptInfo, canChangeEmail: featureState.canChangeEmail, onBackButtonClicked: onBackButtonClicked }))) : (jsxRuntime.jsx(MFAHeader, utils.__assign({}, commonProps, { showBackButton: featureState.showBackButton, onBackButtonClicked: onBackButtonClicked, contactMethod: activeScreen === MFAScreens.EmailForm ? "EMAIL" : "PHONE" }))), featureState.error !== undefined && jsxRuntime.jsx(uiEntry.GeneralError, { error: featureState.error }), activeScreen === MFAScreens.EmailForm ? (jsxRuntime.jsx(EmailForm, utils.__assign({}, commonProps, { footer: jsxRuntime.jsx(MFAFooter, utils.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked, canChangeEmail: featureState.canChangeEmail })) }))) : activeScreen === MFAScreens.PhoneForm ? (jsxRuntime.jsx(PhoneForm, utils.__assign({}, commonProps, { footer: jsxRuntime.jsx(MFAFooter, utils.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked, canChangeEmail: featureState.canChangeEmail })) }))) : activeScreen === MFAScreens.UserInputCodeForm ? (jsxRuntime.jsx(UserInputCodeForm, utils.__assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo, onSuccess: props.onSuccess, footer: jsxRuntime.jsx(MFAOTPFooter, utils.__assign({}, commonProps, { onSignOutClicked: props.onSignOutClicked, canChangeEmail: featureState.canChangeEmail, loginAttemptInfo: featureState.loginAttemptInfo })) }))) : null] }) })), jsxRuntime.jsx(uiEntry.SuperTokensBranding, {})] })));
};
function MFAThemeWrapper(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle, props.config.mfaFeature.style] }, { children: jsxRuntime.jsx(MFATheme, utils.__assign({}, props, { activeScreen: activeScreen })) })) })));
}
    ...
    return React__namespace.useReducer(function (oldState, action) {
        switch (action.type) {
            ...
            case "resendCode":
                ...
                return utils.__assign(utils.__assign({}, oldState), { error: undefined, loginAttemptInfo: utils.__assign(utils.__assign({}, oldState.loginAttemptInfo), { lastResend: action.timestamp }) });
            case "restartFlow":
                return utils.__assign(utils.__assign({}, oldState), { error: action.error, loginAttemptInfo: undefined, showAccessDenied: !oldState.canChangeEmail });
            case "setError":
                return utils.__assign(utils.__assign({}, oldState), { loaded: true, error: action.error, showAccessDenied: action.showAccessDenied });
            case "startVerify":
                return utils.__assign(utils.__assign({}, oldState), { loaded: true, loginAttemptInfo: action.loginAttemptInfo, error: undefined });
            default:
                return oldState;
        }
    }, {
        ...
        var error = undefined;
        var errorQueryParam = utils.getQueryParams("error");
        if (errorQueryParam !== null) {
            error = "SOMETHING_WENT_WRONG_ERROR";
        }
        return utils.__assign(utils.__assign({}, initArg), { error: error });
    });
};
function useChildProps$3(recipe$1, recipeImplementation, state, contactMethod, dispatch, userContext, navigate) {
    ...
    return React.useMemo(function () {
        ...
        return {
            onSuccess: function () {
                var redirectToPath = utils.getRedirectToPathFromURL();
            ...
            onSignOutClicked: function () { return utils.__awaiter(_this, void 0, void 0, function () {
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
            ...
            onBackButtonClicked: function () { return utils.__awaiter(_this, void 0, void 0, function () {
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
...
var MFAFeatureInner = function (props) {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && (jsxRuntime.jsx(MFAThemeWrapper, utils.__assign({}, childProps, { featureState: state, dispatch: dispatch }))), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, utils.__assign(utils.__assign({}, childProps), { featureState: state, dispatch: dispatch }));
                    }
                    return child;
                })] }));
};
...
function useOnLoad(props, recipeImplementation, dispatch, userContext) {
    var _this = this;
    var fetchMFAInfo = React__namespace.useCallback(function () { return utils.__awaiter(_this, void 0, void 0, function () { return utils.__generator(this, function (_a) {
    ...
    var onLoad = React__namespace.useCallback(function (mfaInfo) { return utils.__awaiter(_this, void 0, void 0, function () {
        ...
        return utils.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    error = undefined;
                    errorQueryParam = utils.getQueryParams("error");
                    doSetup = utils.getQueryParams("setup");
                    stepUp = utils.getQueryParams("stepUp");
                    if (errorQueryParam !== null) {
                        error = "SOMETHING_WENT_WRONG_ERROR";
                    }
                ...
                case 8:
                    ...
                    return [4 /*yield*/, recipeImplementation.createCode(utils.__assign(utils.__assign({}, createCodeInfo), { shouldTryLinkingWithSessionUser: true, userContext: userContext }))];
                case 9:
    ...
    utils.useOnMountAPICall(fetchMFAInfo, onLoad, handleLoadError);
}
function getModifiedRecipeImplementation$3(originalImpl, config, dispatch) {
    var _this = this;
    return utils.__assign(utils.__assign({}, originalImpl), { createCode: function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
            ...
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, originalImpl.createCode(utils.__assign(utils.__assign({}, input), { shouldTryLinkingWithSessionUser: true, userContext: utils.__assign(utils.__assign({}, input.userContext), { additionalAttemptInfo: additionalAttemptInfo }) }))];
                    case 2:
                        res = _a.sent();
        ...
        }); }, resendCode: function (input) { return utils.__awaiter(_this, void 0, void 0, function () {
            var res, loginAttemptInfo, timestamp;
            var _a;
            return utils.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, originalImpl.setLoginAttemptInfo({
                                userContext: input.userContext,
                                attemptInfo: utils.__assign(utils.__assign({}, loginAttemptInfo), { shouldTryLinkingWithSessionUser: (_a = loginAttemptInfo.shouldTryLinkingWithSessionUser) !== null && _a !== void 0 ? _a : true, lastResend: timestamp }),
                            })];
                    case 3:
                        _b.sent();
            ...
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, originalImpl.consumeCode(utils.__assign(utils.__assign({}, input), { shouldTryLinkingWithSessionUser: true }))];
                    case 1:
                        res = _a.sent();
                        if (!(res.status === "RESTART_FLOW_ERROR")) return [3 /*break*/, 3];
                        return [4 /*yield*/, originalImpl.clearLoginAttemptInfo({
            ...
            return utils.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        _c.label = 4;
                    case 4: return [4 /*yield*/, props.recipeImplementation.createCode(utils.__assign(utils.__assign({}, contactInfo), { 
                            // shouldTryLinkingWithSessionUser is set by the fn override
                            userContext: userContext }))];
                    case 5:
                        response = _c.sent();
...
var SignInUpTheme$1 = function (_a) {
    var activeScreen = _a.activeScreen, props = utils.__rest(_a, ["activeScreen"]);
    var commonProps = {
        recipeImplementation: props.recipeImplementation,
        config: props.config,
    ...
    return activeScreen === SignInUpScreens.EmailForm ? (jsxRuntime.jsx(EmailForm, utils.__assign({}, commonProps))) : activeScreen === SignInUpScreens.PhoneForm ? (jsxRuntime.jsx(PhoneForm, utils.__assign({}, commonProps))) : activeScreen === SignInUpScreens.EmailOrPhoneForm ? (jsxRuntime.jsx(EmailOrPhoneForm, utils.__assign({}, commonProps))) : null;
};
function SignInUpThemeWrapper$1(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(SignInUpTheme$1, utils.__assign({}, props, { activeScreen: activeScreen })) })) })));
}
...
var SignInUpFeatureInner = function (props) {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper$1, utils.__assign({}, childProps)), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, utils.__assign({}, childProps));
                    }
...
var SignInUpFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignInUpFeatureInner, utils.__assign({}, props)) })));
};
            ...
            return utils.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, originalImpl.createCode(utils.__assign(utils.__assign({}, input), { shouldTryLinkingWithSessionUser: false, userContext: utils.__assign(utils.__assign({}, input.userContext), { additionalAttemptInfo: additionalAttemptInfo }) }))];
                    case 2:
                        res = _a.sent();
                        if (res.status === "OK") {
                            rebuildAuthPage();
...
var ContinueWithPasswordlessFooter = function (_a) {
    ...
    return (jsxRuntime.jsx("a", utils.__assign({ "data-supertokens": "link linkButton continueWithPasswordlessLink", onClick: function () { return utils.__awaiter(void 0, void 0, void 0, function () {
...
var EPComboEmailForm = uiEntry.withOverride("PasswordlessEPComboEmailForm", function PasswordlessEPComboEmailForm(props) {
    ...
    if (props.showPasswordField) {
        formFields.push({
            ...
            label: "",
            validate: recipe$1.defaultValidate,
            labelComponent: (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "PWLESS_COMBO_PASSWORD_LABEL", "data-supertokens": "passwordInputLabel" }), jsxRuntime.jsx("a", utils.__assign({ onClick: function () {
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: formFields, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", onSuccess: props.onSuccess, callAPI: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
...
var EPComboEmailOrPhoneForm = uiEntry.withOverride("PasswordlessEPComboEmailOrPhoneForm", function PasswordlessEPComboEmailOrPhoneForm(props) {
        ...
        ? [
            {
                id: "phoneNumber",
                label: "",
                labelComponent: (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "PWLESS_SIGN_IN_UP_PHONE_LABEL" }), jsxRuntime.jsx("a", utils.__assign({ onClick: function () { return props.setIsPhoneNumber(false); }, "data-supertokens": "link linkButton formLabelLinkBtn contactMethodSwitcher" }, { children: t("PWLESS_SIGN_IN_UP_SWITCH_TO_EMAIL") }))] }))),
                inputComponent: phoneInput,
                optional: false,
                autofocus: true,
                placeholder: "",
        ...
        : [
            {
                id: "email",
                label: "",
                labelComponent: (jsxRuntime.jsxs("div", utils.__assign({ "data-supertokens": "formLabelWithLinkWrapper" }, { children: [jsxRuntime.jsx(formBase.Label, { value: "PWLESS_SIGN_IN_UP_EMAIL_LABEL" }), jsxRuntime.jsx("a", utils.__assign({ onClick: function () { return props.setIsPhoneNumber(true); }, "data-supertokens": "link linkButton formLabelLinkBtn contactMethodSwitcher" }, { children: t("PWLESS_SIGN_IN_UP_SWITCH_TO_PHONE") }))] }))),
                inputComponent: undefined,
                optional: false,
                autofocus: true,
                placeholder: "",
    ...
    return (jsxRuntime.jsx(formBase.FormBase, { clearError: props.clearError, onFetchError: props.onFetchError, onError: props.onError, formFields: formFields, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", callAPI: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
            var phoneNumber, validationRes, email, validationRes;
            var _a, _b;
            return utils.__generator(this, function (_c) {
                switch (_c.label) {
...
var SignInUpTheme = function (_a) {
    ...
    return activeScreen === SignInUpEPComboScreens.EmailForm ? (jsxRuntime.jsx(EPComboEmailForm, utils.__assign({}, commonProps))) : activeScreen === SignInUpEPComboScreens.EmailOrPhoneForm ? (jsxRuntime.jsx(EPComboEmailOrPhoneForm, utils.__assign({}, commonProps))) : null;
};
function SignInUpThemeWrapper(props) {
    ...
    return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(ThemeBase, utils.__assign({ userStyles: [rootStyle, props.config.recipeRootStyle, activeStyle] }, { children: jsxRuntime.jsx(SignInUpTheme, utils.__assign({}, props, { activeScreen: activeScreen })) })) })));
}
...
function useChildProps$1(recipe$1, factorIds, onAuthSuccess, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    ...
    return React.useMemo(function () {
        ...
        return {
            ...
            onContactInfoSubmit: function (contactInfo) { return utils.__awaiter(_this, void 0, void 0, function () {
            ...
            onPasswordSubmit: function (formFields) { return utils.__awaiter(_this, void 0, void 0, function () {
                var validationErrors, response;
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, utils.validateForm(formFields, recipe$3.EmailPassword.getInstanceOrThrow().config.signInAndUpFeature.signInForm.formFields)];
                        case 1:
                        ...
                        case 2:
                            ...
                            if (response.status === "WRONG_CREDENTIALS_ERROR") {
                                ...
                                return [2 /*return*/, utils.__assign(utils.__assign({}, response), { isEmailPassword: true })];
                            }
                    }
                });
            }); },
            onContinueWithPasswordlessClick: function (contactInfo) { return utils.__awaiter(_this, void 0, void 0, function () {
                var createInfo, createRes;
                return utils.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            createInfo = isPhoneNumber ? { phoneNumber: contactInfo } : { email: contactInfo };
                            return [4 /*yield*/, recipeImplementation.createCode(utils.__assign(utils.__assign({}, createInfo), { shouldTryLinkingWithSessionUser: false, userContext: userContext }))];
                        case 1:
                            createRes = _a.sent();
...
var SignInUpEPComboFeatureInner = function (props) {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && jsxRuntime.jsx(SignInUpThemeWrapper, utils.__assign({}, childProps)), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, utils.__assign({}, childProps));
                    }
...
var SignInUpEPComboFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(SignInUpEPComboFeatureInner, utils.__assign({}, props)) })));
};
...
var UserInputCodeFeatureInner = function (props) {
    ...
    return (jsxRuntime.jsxs(React.Fragment, { children: [props.children === undefined && (jsxRuntime.jsx(UserInputCodeFormScreenWrapper, utils.__assign({}, childProps, { userContext: props.userContext }))), props.children &&
                React__namespace.Children.map(props.children, function (child) {
                    if (React__namespace.isValidElement(child)) {
                        return React__namespace.cloneElement(child, utils.__assign({}, childProps));
                    }
...
var UserInputCodeFeature = function (props) {
    var recipeComponentOverrides = props.useComponentOverrides();
    return (jsxRuntime.jsx(authCompWrapper.AuthComponentWrapper, utils.__assign({ recipeComponentOverrides: recipeComponentOverrides }, { children: jsxRuntime.jsx(UserInputCodeFeatureInner, utils.__assign({}, props)) })));
};
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    utils.__extends(PasswordlessPreBuiltUI, _super);
    function PasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatureComponent = function (componentName, props, useComponentOverrides) {
            ...
            if (componentName === "linkClickedScreen") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, utils.__assign({ requireAuth: false, doRedirection: false }, { children: jsxRuntime.jsx(LinkClickedScreen, utils.__assign({ recipe: _this.recipeInstance }, props, { useComponentOverrides: useComponentOverrides })) })) })));
            }
            if (componentName === "otp-email") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, utils.__assign({ overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(MFAFeature, utils.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides, contactMethod: "EMAIL", flowType: "USER_INPUT_CODE" }, props)) })) })));
            }
            if (componentName === "otp-phone") {
                return (jsxRuntime.jsx(uiEntry.UserContextWrapper, utils.__assign({ userContext: props.userContext }, { children: jsxRuntime.jsx(session.SessionAuth, utils.__assign({ overrideGlobalClaimValidators: function () { return []; } }, { children: jsxRuntime.jsx(MFAFeature, utils.__assign({ recipe: _this.recipeInstance, useComponentOverrides: useComponentOverrides, contactMethod: "PHONE", flowType: "USER_INPUT_CODE" }, props)) })) })));
            }
    ...
    PasswordlessPreBuiltUI.prototype.getAuthComponents = function () {
        ...
        var res = utils.__spreadArray(utils.__spreadArray([
            {
                type: "FULL_PAGE",
                ...
                component: function (_b) {
                    var preloadInfo = _b.preloadInfo, props = utils.__rest(_b, ["preloadInfo"]);
                    return (jsxRuntime.jsx(LinkSentFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe$1.useContext, loginAttemptInfo: preloadInfo }), "linkSentFullPage"));
                },
            },
            {
                type: "FULL_PAGE",
                ...
                component: function (_b) {
                    var preloadInfo = _b.preloadInfo, props = utils.__rest(_b, ["preloadInfo"]);
                    return (jsxRuntime.jsx(UserInputCodeFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, useComponentOverrides: recipe$1.useContext, loginAttemptInfo: preloadInfo }), "userInputCodeFullPage"));
                },
            }
            ...
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (React.createElement(SignInUpFeature, utils.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: recipe$1.useContext, factorIds: factors }))); },
        }); }), true), factorCombos.map(function (factors) { return ({
            type: "SIGN_UP",
            factorIds: factors,
            displayOrder: 3,
            component: function (props) { return (jsxRuntime.jsx(ContinueWithPasswordlessFeature, utils.__assign({}, props, { recipe: _this.recipeInstance, factorIds: factors, useComponentOverrides: recipe$1.useContext }), factors.join("|"))); },
        }); }), true);
        ...
        try {
            ...
            res.push.apply(res, factorCombos
                .map(function (combo) { return utils.__spreadArray([types.FactorIds.EMAILPASSWORD], combo, true); })
                .map(function (factors) { return ({
                type: "SIGN_IN",
                factorIds: factors,
                displayOrder: 3,
                component: function (props) { return (React.createElement(SignInUpEPComboFeature, utils.__assign({}, props, { key: factors.join("|"), recipe: _this.recipeInstance, useComponentOverrides: recipe$1.useContext, factorIds: factors }))); },
            }); }));
        }
        catch (_b) {
...
function getAllChoices(choices) {
    ...
    return utils.__spreadArray(utils.__spreadArray([], subChoices, true), subChoices.map(function (a) { return utils.__spreadArray([choices[0]], a, true); }), true);
}
