                        ...
                        return genericComponentOverrideContext.__generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, config.validatePhoneNumber(phoneNumber)];
                                case 1:
                                    validationRes = _c.sent();
                                    if (validationRes !== undefined) {
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    ...
    PasswordlessPreBuiltUI.SignInUpEPComboTheme = SignInUpThemeWrapper;
    PasswordlessPreBuiltUI.LinkSentTheme = LinkSentWrapper;
...
exports.LinkSentTheme = LinkSentWrapper;
...
exports.SignInUpEPComboTheme = SignInUpThemeWrapper;
