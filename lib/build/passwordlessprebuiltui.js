...
var backButton = require("./emailpassword-shared5.js");
...
var EmailForm$1 = uiEntry.withOverride("PasswordlessEmailForm", function PasswordlessEmailForm(props) {
    var _this = this;
    var userContext = uiEntry.useUserContext();
...
var PhoneForm = uiEntry.withOverride("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    ...
    React.useEffect(function () {
        ...
        void recipe$2.preloadPhoneNumberUtils();
    }, []);
        ...
        createCode: function (input) {
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                ...
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, recipe$2.getPhoneNumberUtils()];
                        case 1:
...
var EmailOrPhoneForm$1 = uiEntry.withOverride(
                    ...
                    return genericComponentOverrideContext.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, recipe$2.defaultEmailValidator(emailOrPhone)];
                            case 1:
...
var SignInUpTheme$1 = function (_a) {
    ...
    return activeScreen === SignInUpScreens.EmailForm
        ? jsxRuntime.jsx(EmailForm$1, genericComponentOverrideContext.__assign({}, commonProps))
        ...
        ? jsxRuntime.jsx(EmailOrPhoneForm$1, genericComponentOverrideContext.__assign({}, commonProps))
        : null;
};
                ...
                return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return genericComponentOverrideContext.__generator(this, function (_b) {
                        ...
                        if (props.showPasswordField) {
                            ...
                            return [
                                2 /*return*/,
                                props.onContactInfoSubmit(emailOrPhone, function (phoneNumber) {
...
var ContinueWithPasswordlessFooter = function (_a) {
    ...
    return jsxRuntime.jsxs(
        ...
        genericComponentOverrideContext.__assign(
            ...
            { children: [" ", t("PWLESS_COMBO_CONTINUE_WITH_PASSWORDLESS"), " "] }
        )
    );
};
...
var SignInUpTheme = function (_a) {
    var activeScreen = _a.activeScreen,
        props = genericComponentOverrideContext.__rest(_a, ["activeScreen"]);
    var commonProps = genericComponentOverrideContext.__assign(
        { epRecipeImplementation: recipe$1.EmailPassword.getInstanceOrThrow().webJSRecipe },
        props
    );
...
function useChildProps$1(recipe$2, factorIds, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    ...
    var _a = React__namespace.useState(false),
        showPasswordField = _a[0],
        setShowPasswordField = _a[1];
    var _b = React__namespace.useState(false),
        showContinueWithPasswordlessLink = _b[0],
        setShowContinueWithPasswordlessLink = _b[1];
    var rethrowInRender = genericComponentOverrideContext.useRethrowInRender();
    return React.useMemo(
        function () {
            return {
                ...
                onContactInfoSubmit: function (contactInfo, setPhoneNumber) {
                    return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                        var hasPhoneFactor,
                            createInfo,
                            res,
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    hasPhoneFactor =
                                        factorIds.includes(types.FactorIds.OTP_PHONE) ||
                                        factorIds.includes(types.FactorIds.LINK_PHONE);
                                    if (!hasPhoneFactor) return [3 /*break*/, 2];
                                    return [4 /*yield*/, checkContactInfo(contactInfo, recipe$2.config)];
                                case 1:
                                    res = _b.sent();
                                    if ("email" in res) {
                                        createInfo = {
                                    ...
                                    return [3 /*break*/, 4];
                                case 2:
                                    return [4 /*yield*/, recipe$2.config.validateEmailAddress(contactInfo)];
                                case 3:
                                    validationRes = _b.sent();
                                    if (validationRes !== undefined) {
                                        throw new STGeneralError__default$1.default(validationRes);
                                    }
                                    createInfo = {
                                        email: contactInfo,
                                    };
                                    _b.label = 4;
                                case 4:
                                    if (!("phoneNumber" in createInfo)) return [3 /*break*/, 6];
                                    return [
                                        4 /*yield*/,
                                        recipeImplementation.createCode(
                                            genericComponentOverrideContext.__assign(
                                ...
                                case 7:
                                    ...
                                    if (!epExists.doesExist) return [3 /*break*/, 8];
                                    // EP exists
                                    ...
                                    return [3 /*break*/, 11];
                                case 8:
                                    if (!pwlessExists.doesExist) return [3 /*break*/, 10];
                                    return [
                                        4 /*yield*/,
                                        recipeImplementation.createCode(
                                            genericComponentOverrideContext.__assign(
                                ...
                                case 0:
                                    return [
                                        ...
                                        genericComponentOverrideContext.validateForm(
                                            formFields,
                                            recipe$1.getDefaultFormFields() // TODO
                                        ),
                                    ];
                                case 1:
                ...
                onContinueWithPasswordlessClick: function (contactInfo) {
                    return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                        var hasPhoneFactor, createInfo, res, validationRes, createRes;
                        return genericComponentOverrideContext.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    hasPhoneFactor =
                                ...
                                case 1:
                                    ...
                                    if ("email" in res) {
                                        ...
                                        // TODO: bad UX
                                        throw new STGeneralError__default$1.default(res.validationRes);
                                    } else {
                                        createInfo = {
                                            phoneNumber: res.phoneNumber,
                                        };
...
function checkContactInfo(emailOrPhone, config) {
    return genericComponentOverrideContext.__awaiter(this, void 0, void 0, function () {
        var emailValidationRes, phoneValidationRes, intPhoneNumber, phoneValidationResAfterGuess;
        return genericComponentOverrideContext.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, recipe$2.defaultEmailValidator(emailOrPhone)];
                case 1:
                    ...
                    return [4 /*yield*/, config.validateEmailAddress(emailOrPhone)];
                case 2:
                    emailValidationRes = _a.sent();
                    if (emailValidationRes === undefined) {
                        return [2 /*return*/, { email: emailOrPhone }];
                    } else {
                        throw new STGeneralError__default$1.default(emailValidationRes);
                    }
                case 3:
                    return [4 /*yield*/, config.validatePhoneNumber(emailOrPhone)];
                case 4:
                    phoneValidationRes = _a.sent();
                    if (phoneValidationRes === undefined) {
                        return [2 /*return*/, { phoneNumber: emailOrPhone }];
                    }
                    return [
                        4 /*yield*/,
                ...
                case 5:
                    intPhoneNumber = _a.sent();
                    if (!intPhoneNumber) return [3 /*break*/, 7];
                    return [4 /*yield*/, config.validatePhoneNumber(intPhoneNumber)];
                case 6:
                    phoneValidationResAfterGuess = _a.sent();
                    return [2 /*return*/, { phoneNumber: emailOrPhone, validationRes: phoneValidationResAfterGuess }];
                case 7:
                    throw new STGeneralError__default$1.default(phoneValidationRes);
                case 8:
                    return [2 /*return*/];
            }
        });
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    ...
    PasswordlessPreBuiltUI.SignInUpTheme = SignInUpThemeWrapper$1;
...
exports.SignInUpTheme = SignInUpThemeWrapper$1;
