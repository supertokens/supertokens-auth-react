...
var recipe$2 = require("./emailpassword-shared3.js");
require("./multifactorauth.js");
var session = require("./session.js");
var recipe$3 = require("./passwordless-shared.js");
...
var recipe$4 = require("./multifactorauth-shared2.js");
                ...
                formFields: [
                    {
                        ...
                        placeholder: "",
                        validate: recipe$3.userInputCodeValidate,
                    },
                ],
                onSuccess: props.onSuccess,
                buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON",
        ...
        function () {
            return genericComponentOverrideContext.__awaiter(_this, void 0, void 0, function () {
                return genericComponentOverrideContext.__generator(this, function (_a) {
                    return [
                        2 /*return*/,
                        recipe$4.MultiFactorAuth.getInstanceOrThrow().webJSRecipe.resyncSessionAndFetchMFAInfo({
                            userContext: userContext,
                        }),
                    ];
                });
                    ...
                    switch (_b.label) {
                        ...
                        case 3:
                            showBackButton =
                                ...
                                recipe$4.getAvailableFactors(
                                    mfaInfo.factors,
                                    undefined,
                                    recipe$4.MultiFactorAuth.getInstanceOrThrow(),
                                    userContext
                                ).length !== 1;
                            contactInfoList =
                                (props.contactMethod === "EMAIL"
                ...
                ? [
                      {
                          ...
                          placeholder: "",
                          autoComplete: "tel",
                          validate: recipe$3.defaultValidate,
                      },
                  ]
                : [
                      {
...
function useChildProps$2(recipe, factorIds, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(
        function () {
                            ...
                            children: [
                                ...
                                jsxRuntime.jsx(
                                    ...
                                    genericComponentOverrideContext.__assign(
                                        {
                                            onClick: function () {
                                                return recipe$2.EmailPassword.getInstanceOrThrow().redirect({
...
function useChildProps$1(recipe, factorIds, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(
        function () {
                            ...
                            switch (_b.label) {
                                ...
                                case 2:
                                    ...
                                    return [
                                        4 /*yield*/,
                                        Promise.all([
                                            recipe$2.EmailPassword.getInstanceOrThrow().webJSRecipe.doesEmailExist({
                                                email: email,
                                                userContext: userContext,
                                            }),
                        ...
                        return genericComponentOverrideContext.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    return [
                                        ...
                                        genericComponentOverrideContext.validateForm(
                                            formFields,
                                            recipe$2.EmailPassword.getInstanceOrThrow().config.signInAndUpFeature
                                ...
                                case 1:
                                    ...
                                    return [
                                        4 /*yield*/,
                                        recipe$2.EmailPassword.getInstanceOrThrow().webJSRecipe.signIn({
                                            formFields: formFields,
                                            userContext: userContext,
                                        }),
                                    ];
                                            ...
                                            .validateGlobalClaimsAndHandleSuccessRedirection(
                                                {
                                                    ...
                                                    recipeId: result.isEmailPassword
                                                        ? recipe$2.EmailPassword.RECIPE_ID
                                                        : recipe.recipeID,
                                                },
...
function useChildProps(recipe, loginAttemptInfo, error, onError, clearError, rebuildAuthPage, userContext, navigate) {
    var _this = this;
    var session$1 = uiEntry.useSessionContext();
    var recipeImplementation = React__namespace.useMemo(
        function () {
...
var PasswordlessPreBuiltUI = /** @class */ (function (_super) {
    ...
    function PasswordlessPreBuiltUI(recipeInstance) {
        ...
        _this.getFeatures = function (useComponentOverrides) {
            if (useComponentOverrides === void 0) {
                useComponentOverrides = recipe$3.useContext;
            }
            var features = {};
            if (_this.recipeInstance.config.linkClickedScreenFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    recipeID: recipe$3.Passwordless.RECIPE_ID,
                };
            }
    ...
    PasswordlessPreBuiltUI.getInstanceOrInitAndGetInstance = function () {
        if (PasswordlessPreBuiltUI.instance === undefined) {
            var recipeInstance = recipe$3.Passwordless.getInstanceOrThrow();
    ...
    PasswordlessPreBuiltUI.prototype.getAuthComponents = function () {
                                ...
                                return genericComponentOverrideContext.__generator(this, function (_d) {
                                    switch (_d.label) {
                                        case 0:
                                            return [
                                                4 /*yield*/,
                                                recipe$3.Passwordless.getInstanceOrThrow().webJSRecipe.getLoginAttemptInfo(
                                                    {
                                                        userContext: userContext,
                                                    }
                                                ),
                                        ...
                                        case 1:
                                            ...
                                            return [
                                                4 /*yield*/,
                                                (_b = recipe$3.Passwordless.getInstanceOrThrow().webJSRecipe) ===
                                                    null || _b === void 0
                                                    ? void 0
                                        ...
                                        case 3:
                                            ...
                                            return [
                                                4 /*yield*/,
                                                (_c = recipe$3.Passwordless.getInstanceOrThrow().webJSRecipe) ===
                                                    null || _c === void 0
                                                    ? void 0
        ...
        try {
            recipe$2.EmailPassword.getInstanceOrThrow();
            res.push.apply(
                res,
                factorCombos
                    .map(function (combo) {
