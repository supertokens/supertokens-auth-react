...
import { EmailVerificationConfig, NormalisedEmailVerificationConfig } from "./types";

export function normaliseEmailVerificationFeature(config: EmailVerificationConfig): NormalisedEmailVerificationConfig {
