...
import SendVerifyEmailTheme from "./sendVerifyEmail";
import VerifyEmailLinkClickedTheme from "./verifyEmailLinkClicked";
...
export function EmailVerificationTheme(props: EmailVerificationThemeProps): JSX.Element {
    ...
    if (props.hasToken === false) {
        return (
            <StyleProvider
                ...
                <SendVerifyEmailTheme {...props.sendVerifyEmailScreen} />
            </StyleProvider>
        );
    }
    ...
    return (
        <StyleProvider
            ...
            getDefaultStyles={getDefaultStyles}>
            <VerifyEmailLinkClickedTheme {...props.verifyEmailLinkClickedScreen} />
        </StyleProvider>
    );
}
